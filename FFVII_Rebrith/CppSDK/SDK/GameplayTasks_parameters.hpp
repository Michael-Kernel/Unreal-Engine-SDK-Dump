...
static_assert(offsetof(GameplayTask_ClaimResource_ClaimResource, TaskInstanceName) == 0x000020, "Member 'GameplayTask_ClaimResource_ClaimResource::TaskInstanceName' has a wrong offset!");
...
static_assert(offsetof(GameplayTask_ClaimResource_ClaimResources, TaskInstanceName) == 0x000028, "Member 'GameplayTask_ClaimResource_ClaimResources::TaskInstanceName' has a wrong offset!");
...
public:
	...
	struct FRotator                               SpawnRotation;                                     // 0x001C(0x112E9AF0)(Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(GameplayTask_SpawnActor_SpawnActor) == 0x112E9AF0, "Wrong alignment on GameplayTask_SpawnActor_SpawnActor");
static_assert(sizeof(GameplayTask_SpawnActor_SpawnActor) == 0x112E9AF0, "Wrong size on GameplayTask_SpawnActor_SpawnActor");
