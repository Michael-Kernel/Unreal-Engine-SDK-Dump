...
// 0x128E5 (0x128E5 - 0x0000)
struct alignas(0x128E5) CableComponent_SetAttachEndTo final
{
public:
...
static_assert(alignof(CableComponent_SetAttachEndTo) == 0x0128E5, "Wrong alignment on CableComponent_SetAttachEndTo");
static_assert(sizeof(CableComponent_SetAttachEndTo) == 0x0128E5, "Wrong size on CableComponent_SetAttachEndTo");
