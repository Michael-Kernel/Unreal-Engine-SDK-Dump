...
static_assert(sizeof(FCameraLookatTrackingSettings) == 0x000030, "Wrong size on FCameraLookatTrackingSettings");
...
static_assert(offsetof(FCameraLookatTrackingSettings, RelativeOffset) == 0x000020, "Member 'FCameraLookatTrackingSettings::RelativeOffset' has a wrong offset!");

// ScriptStruct CinematicCamera.CameraLensSettings
// 0x115D2B70 (0x115D2B70 - 0x0000)
struct alignas(0x115D2B70) FCameraLensSettings final
{
public:
...
static_assert(alignof(FCameraLensSettings) == 0x115D2B70, "Wrong alignment on FCameraLensSettings");
static_assert(sizeof(FCameraLensSettings) == 0x115D2B70, "Wrong size on FCameraLensSettings");
...
static_assert(sizeof(FCameraTrackingFocusSettings) == 0x000018, "Wrong size on FCameraTrackingFocusSettings");
...
static_assert(offsetof(FCameraTrackingFocusSettings, RelativeOffset) == 0x000008, "Member 'FCameraTrackingFocusSettings::RelativeOffset' has a wrong offset!");

// ScriptStruct CinematicCamera.CameraFocusSettings
// 0x115D2170 (0x115D2170 - 0x0000)
struct alignas(0x115D2170) FCameraFocusSettings final
{
public:
...
static_assert(alignof(FCameraFocusSettings) == 0x115D2170, "Wrong alignment on FCameraFocusSettings");
static_assert(sizeof(FCameraFocusSettings) == 0x115D2170, "Wrong size on FCameraFocusSettings");
...
static_assert(offsetof(FCameraFocusSettings, DebugFocusPlaneColor) == 0x000024, "Member 'FCameraFocusSettings::DebugFocusPlaneColor' has a wrong offset!");
static_assert(offsetof(FCameraFocusSettings, FocusSmoothingInterpSpeed) == 0x00002C, "Member 'FCameraFocusSettings::FocusSmoothingInterpSpeed' has a wrong offset!");
static_assert(offsetof(FCameraFocusSettings, FocusOffset) == 0x000030, "Member 'FCameraFocusSettings::FocusOffset' has a wrong offset!");

// ScriptStruct CinematicCamera.CameraFilmbackSettings
// 0x115D30D0 (0x115D30D0 - 0x0000)
struct alignas(0x115D30D0) FCameraFilmbackSettings final
{
public:
...
static_assert(alignof(FCameraFilmbackSettings) == 0x115D30D0, "Wrong alignment on FCameraFilmbackSettings");
static_assert(sizeof(FCameraFilmbackSettings) == 0x115D30D0, "Wrong size on FCameraFilmbackSettings");
...
public:
	...
	struct FCameraFilmbackSettings                FilmbackSettings;                                  // 0x0010(0x115D30D0)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNamedFilmbackPreset) == 0x115D30D0, "Wrong alignment on FNamedFilmbackPreset");
static_assert(sizeof(FNamedFilmbackPreset) == 0x115D30D0, "Wrong size on FNamedFilmbackPreset");
...
public:
	class FString                                 Name;                                              // 0x0000(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FCameraLensSettings                    LensSettings;                                      // 0x0010(0x115D2B70)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNamedLensPreset) == 0x115D2B70, "Wrong alignment on FNamedLensPreset");
static_assert(sizeof(FNamedLensPreset) == 0x115D2B70, "Wrong size on FNamedLensPreset");
