...
// Enum AIModule.EInterruptAbortBehavior
// NumValues: 0x0004
enum class EInterruptAbortBehavior : uint8
{
	AlwaysAllow                              = 0,
...
// Enum AIModule.EEnvTestActorDistance
// NumValues: 0x0004
enum class EEnvTestActorDistance : uint8
{
	DistanceToActorRoot                      = 0,
	DistanceToNavigationBounds               = 1,
	DistanceToCollisionBounds                = 2,
	EEnvTestActorDistance_MAX                = 3,
};
...
// 0x115E68C0 (0x115E68C0 - 0x0000)
#pragma pack(push, 0x1)
struct alignas(0x115E68C0) FAIDataProviderValue
{
public:
...
#pragma pack(pop)
static_assert(alignof(FAIDataProviderValue) == 0x115E68C0, "Wrong alignment on FAIDataProviderValue");
static_assert(sizeof(FAIDataProviderValue) == 0x115E68C0, "Wrong size on FAIDataProviderValue");
...
// 0x0000 (0x115E68C0 - 0x115E68C0)
#pragma pack(push, 0x1)
struct alignas(0x115E68C0) FAIDataProviderTypedValue : public FAIDataProviderValue
{
public:
...
#pragma pack(pop)
static_assert(alignof(FAIDataProviderTypedValue) == 0x115E68C0, "Wrong alignment on FAIDataProviderTypedValue");
static_assert(sizeof(FAIDataProviderTypedValue) == 0x115E68C0, "Wrong size on FAIDataProviderTypedValue");
...
static_assert(sizeof(FAIStimulus) == 0x000048, "Wrong size on FAIStimulus");
...
static_assert(offsetof(FAIStimulus, Tag) == 0x000028, "Member 'FAIStimulus::Tag' has a wrong offset!");
...
static_assert(alignof(FAIDataProviderFloatValue) == 0x115E68C0, "Wrong alignment on FAIDataProviderFloatValue");
static_assert(sizeof(FAIDataProviderFloatValue) == 0x115E68C0, "Wrong size on FAIDataProviderFloatValue");
...
static_assert(alignof(FAIDataProviderBoolValue) == 0x115E68C0, "Wrong alignment on FAIDataProviderBoolValue");
static_assert(sizeof(FAIDataProviderBoolValue) == 0x115E68C0, "Wrong size on FAIDataProviderBoolValue");
...
struct alignas(0x115EBE20) FEnvNamedValue final
{
public:
...
static_assert(alignof(FEnvNamedValue) == 0x115EBE20, "Wrong alignment on FEnvNamedValue");
static_assert(sizeof(FEnvNamedValue) == 0x115EBE20, "Wrong size on FEnvNamedValue");
...
static_assert(alignof(FAIDataProviderIntValue) == 0x115E68C0, "Wrong alignment on FAIDataProviderIntValue");
static_assert(sizeof(FAIDataProviderIntValue) == 0x115E68C0, "Wrong size on FAIDataProviderIntValue");
...
public:
	...
	struct FRotator                               Offset;                                            // 0x0018(0x112E9AF0)(Edit, DisableEditOnInstance, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	EEnvDirection                                 DirMode;                                           // 0x0024(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_25[0x3];                                       // 0x0025(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FEnvDirection) == 0x112E9AF0, "Wrong alignment on FEnvDirection");
static_assert(sizeof(FEnvDirection) == 0x112E9AF0, "Wrong size on FEnvDirection");
...
static_assert(offsetof(FEnvDirection, Offset) == 0x000018, "Member 'FEnvDirection::Offset' has a wrong offset!");
static_assert(offsetof(FEnvDirection, DirMode) == 0x000024, "Member 'FEnvDirection::DirMode' has a wrong offset!");
...
static_assert(alignof(FAIDataProviderStructValue) == 0x115E68C0, "Wrong alignment on FAIDataProviderStructValue");
static_assert(sizeof(FAIDataProviderStructValue) == 0x115E68C0, "Wrong size on FAIDataProviderStructValue");
...
static_assert(alignof(FAISenseAffiliationFilter) == 0x000001, "Wrong alignment on FAISenseAffiliationFilter");
...
// 0x115E7930 (0x115E7930 - 0x0000)
struct alignas(0x115E7930) FAINoiseEvent final
{
public:
...
static_assert(alignof(FAINoiseEvent) == 0x115E7930, "Wrong alignment on FAINoiseEvent");
static_assert(sizeof(FAINoiseEvent) == 0x115E7930, "Wrong size on FAINoiseEvent");
...
public:
	...
	uint8                                         bInstanceGroupSynced : 1;                          // 0x0010(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
// 0x115E8CE0 (0x115E8CE0 - 0x0000)
struct alignas(0x115E8CE0) FBTDecoratorLogic final
{
public:
...
static_assert(alignof(FBTDecoratorLogic) == 0x115E8CE0, "Wrong alignment on FBTDecoratorLogic");
static_assert(sizeof(FBTDecoratorLogic) == 0x115E8CE0, "Wrong size on FBTDecoratorLogic");
...
static_assert(sizeof(FEnvQueryInstanceCache) == 0x0001C0, "Wrong size on FEnvQueryInstanceCache");
...
static_assert(sizeof(FEQSParametrizedQueryExecutionRequest) == 0x000058, "Wrong size on FEQSParametrizedQueryExecutionRequest");
...
// 0x115EA6E0 (0x115EA6E0 - 0x0000)
struct alignas(0x115EA6E0) FEnvQueryResult final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FEnvQueryResult) == 0x115EA6E0, "Wrong alignment on FEnvQueryResult");
static_assert(sizeof(FEnvQueryResult) == 0x115EA6E0, "Wrong size on FEnvQueryResult");
