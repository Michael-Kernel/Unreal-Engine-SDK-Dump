...
// 0x11683A60 (0x11683A60 - 0x0000)
struct alignas(0x11683A60) FStructSerializerNumericTestStruct final
{
public:
...
static_assert(alignof(FStructSerializerNumericTestStruct) == 0x11683A60, "Wrong alignment on FStructSerializerNumericTestStruct");
static_assert(sizeof(FStructSerializerNumericTestStruct) == 0x11683A60, "Wrong size on FStructSerializerNumericTestStruct");
...
// 0x11683740 (0x11683740 - 0x0000)
struct alignas(0x11683740) FStructSerializerBooleanTestStruct final
{
public:
...
static_assert(alignof(FStructSerializerBooleanTestStruct) == 0x11683740, "Wrong alignment on FStructSerializerBooleanTestStruct");
static_assert(sizeof(FStructSerializerBooleanTestStruct) == 0x11683740, "Wrong size on FStructSerializerBooleanTestStruct");
...
struct alignas(0x1EF73EE0) FStructSerializerMapTestStruct final
{
public:
...
static_assert(alignof(FStructSerializerMapTestStruct) == 0x1EF73EE0, "Wrong alignment on FStructSerializerMapTestStruct");
static_assert(sizeof(FStructSerializerMapTestStruct) == 0x1EF73EE0, "Wrong size on FStructSerializerMapTestStruct");
...
{
public:
	struct FGuid                                  Guid;                                              // 0x0000(0x112E8D20)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FRotator                               Rotator;                                           // 0x0028(0x112E9AF0)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FStructSerializerBuiltinTestStruct) == 0x112E9AF0, "Wrong alignment on FStructSerializerBuiltinTestStruct");
static_assert(sizeof(FStructSerializerBuiltinTestStruct) == 0x112E9AF0, "Wrong size on FStructSerializerBuiltinTestStruct");
...
{
public:
	struct FStructSerializerNumericTestStruct     Numerics;                                          // 0x0000(0x11683A60)(NoDestructor, NativeAccessSpecifierPublic)
	struct FStructSerializerBooleanTestStruct     Booleans;                                          // 0x0030(0x11683740)(NoDestructor, NativeAccessSpecifierPublic)
	struct FStructSerializerObjectTestStruct      Objects;                                           // 0x0038(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	struct FStructSerializerBuiltinTestStruct     Builtins;                                          // 0x0048(0x112E9AF0)(NativeAccessSpecifierPublic)
	struct FStructSerializerArrayTestStruct       Arrays;                                            // 0x00A8(0x0040)(NativeAccessSpecifierPublic)
	struct FStructSerializerMapTestStruct         Maps;                                              // 0x00E8(0x1EF73EE0)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FStructSerializerTestStruct) == 0x1EF73EE0, "Wrong alignment on FStructSerializerTestStruct");
static_assert(sizeof(FStructSerializerTestStruct) == 0x1EF73EE0, "Wrong size on FStructSerializerTestStruct");
