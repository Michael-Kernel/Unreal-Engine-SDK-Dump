...
// 0x11685BF0 (0x11685BF0 - 0x0000)
struct alignas(0x11685BF0) FClothVertBoneData final
{
public:
	uint16                                        BoneIndices[0x8];                                  // 0x0000(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         BoneWeights[0x8];                                  // 0x0010(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FClothVertBoneData) == 0x11685BF0, "Wrong alignment on FClothVertBoneData");
static_assert(sizeof(FClothVertBoneData) == 0x11685BF0, "Wrong size on FClothVertBoneData");
static_assert(offsetof(FClothVertBoneData, BoneIndices) == 0x000000, "Member 'FClothVertBoneData::BoneIndices' has a wrong offset!");
static_assert(offsetof(FClothVertBoneData, BoneWeights) == 0x000010, "Member 'FClothVertBoneData::BoneWeights' has a wrong offset!");

// ScriptStruct ClothingSystemRuntime.ClothConstraintSetup
// 0x11684FB0 (0x11684FB0 - 0x0000)
struct alignas(0x11684FB0) FClothConstraintSetup final
{
public:
...
static_assert(alignof(FClothConstraintSetup) == 0x11684FB0, "Wrong alignment on FClothConstraintSetup");
static_assert(sizeof(FClothConstraintSetup) == 0x11684FB0, "Wrong size on FClothConstraintSetup");
...
public:
	...
	struct FClothConstraintSetup                  VerticalConstraintConfig;                          // 0x0004(0x11684FB0)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FClothConstraintSetup                  HorizontalConstraintConfig;                        // 0x0014(0x11684FB0)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FClothConstraintSetup                  BendConstraintConfig;                              // 0x0024(0x11684FB0)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FClothConstraintSetup                  ShearConstraintConfig;                             // 0x0034(0x11684FB0)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FClothConfig) == 0x11684FB0, "Wrong alignment on FClothConfig");
static_assert(sizeof(FClothConfig) == 0x11684FB0, "Wrong size on FClothConfig");
...
static_assert(alignof(FClothLODData) == 0x000001, "Wrong alignment on FClothLODData");
