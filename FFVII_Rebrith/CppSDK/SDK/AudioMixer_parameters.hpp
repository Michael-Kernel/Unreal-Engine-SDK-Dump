...
// 0x18307 (0x18307 - 0x0000)
struct alignas(0x18307) AudioMixerBlueprintLibrary_GetNumberOfEntriesInSourceEffectChain final
{
public:
	const class UObject*                          WorldContextObject;                                // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundEffectSourcePresetChain*          PresetChain;                                       // 0x0008(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(AudioMixerBlueprintLibrary_GetNumberOfEntriesInSourceEffectChain) == 0x018307, "Wrong alignment on AudioMixerBlueprintLibrary_GetNumberOfEntriesInSourceEffectChain");
static_assert(sizeof(AudioMixerBlueprintLibrary_GetNumberOfEntriesInSourceEffectChain) == 0x018307, "Wrong size on AudioMixerBlueprintLibrary_GetNumberOfEntriesInSourceEffectChain");
...
// 0x18307 (0x18307 - 0x0000)
struct alignas(0x18307) AudioMixerBlueprintLibrary_RemoveSourceEffectFromPresetChain final
{
public:
	const class UObject*                          WorldContextObject;                                // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundEffectSourcePresetChain*          PresetChain;                                       // 0x0008(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(AudioMixerBlueprintLibrary_RemoveSourceEffectFromPresetChain) == 0x018307, "Wrong alignment on AudioMixerBlueprintLibrary_RemoveSourceEffectFromPresetChain");
static_assert(sizeof(AudioMixerBlueprintLibrary_RemoveSourceEffectFromPresetChain) == 0x018307, "Wrong size on AudioMixerBlueprintLibrary_RemoveSourceEffectFromPresetChain");
...
static_assert(alignof(SubmixEffectDynamicsProcessorPreset_SetSettings) == 0x000001, "Wrong alignment on SubmixEffectDynamicsProcessorPreset_SetSettings");
...
static_assert(alignof(SubmixEffectSubmixEQPreset_SetSettings) == 0x000001, "Wrong alignment on SubmixEffectSubmixEQPreset_SetSettings");
...
// 0x116886F0 (0x116886F0 - 0x0000)
struct SubmixEffectReverbPreset_SetSettings final
{
public:
	struct FSubmixEffectReverbSettings            InSettings;                                        // 0x0000(0x116886F0)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(SubmixEffectReverbPreset_SetSettings) == 0x116886F0, "Wrong alignment on SubmixEffectReverbPreset_SetSettings");
static_assert(sizeof(SubmixEffectReverbPreset_SetSettings) == 0x116886F0, "Wrong size on SubmixEffectReverbPreset_SetSettings");
...
// 0x1830A (0x1830A - 0x0000)
struct alignas(0x1830A) SubmixEffectReverbPreset_SetSettingsWithReverbEffect final
{
public:
...
static_assert(alignof(SubmixEffectReverbPreset_SetSettingsWithReverbEffect) == 0x01830A, "Wrong alignment on SubmixEffectReverbPreset_SetSettingsWithReverbEffect");
static_assert(sizeof(SubmixEffectReverbPreset_SetSettingsWithReverbEffect) == 0x01830A, "Wrong size on SubmixEffectReverbPreset_SetSettingsWithReverbEffect");
...
// 0x17633 (0x17633 - 0x0000)
struct alignas(0x17633) SynthComponent_SetSubmixSend final
{
public:
...
static_assert(alignof(SynthComponent_SetSubmixSend) == 0x017633, "Wrong alignment on SynthComponent_SetSubmixSend");
static_assert(sizeof(SynthComponent_SetSubmixSend) == 0x017633, "Wrong size on SynthComponent_SetSubmixSend");
