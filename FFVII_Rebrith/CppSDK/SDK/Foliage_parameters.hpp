...
struct alignas(0x35) FoliageStatistics_FoliageOverlappingBoxCount final
{
public:
...
static_assert(alignof(FoliageStatistics_FoliageOverlappingBoxCount) == 0x000035, "Wrong alignment on FoliageStatistics_FoliageOverlappingBoxCount");
static_assert(sizeof(FoliageStatistics_FoliageOverlappingBoxCount) == 0x000035, "Wrong size on FoliageStatistics_FoliageOverlappingBoxCount");
...
// 0xCDB1 (0xCDB1 - 0x0000)
struct alignas(0xCDB1) FoliageStatistics_FoliageOverlappingSphereCount final
{
public:
	class UObject*                                WorldContextObject;                                // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	const class UStaticMesh*                      StaticMesh;                                        // 0x0008(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FoliageStatistics_FoliageOverlappingSphereCount) == 0x00CDB1, "Wrong alignment on FoliageStatistics_FoliageOverlappingSphereCount");
static_assert(sizeof(FoliageStatistics_FoliageOverlappingSphereCount) == 0x00CDB1, "Wrong size on FoliageStatistics_FoliageOverlappingSphereCount");
...
public:
	...
	struct FHitResult                             OverlapInfo;                                       // 0x0020(0x112F5920)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(InteractiveFoliageActor_CapsuleTouched) == 0x112F5920, "Wrong alignment on InteractiveFoliageActor_CapsuleTouched");
static_assert(sizeof(InteractiveFoliageActor_CapsuleTouched) == 0x112F5920, "Wrong size on InteractiveFoliageActor_CapsuleTouched");
...
// 0x17111 (0x17111 - 0x0000)
struct alignas(0x17111) ProceduralFoliageSpawner_Simulate final
{
public:
...
static_assert(alignof(ProceduralFoliageSpawner_Simulate) == 0x017111, "Wrong alignment on ProceduralFoliageSpawner_Simulate");
static_assert(sizeof(ProceduralFoliageSpawner_Simulate) == 0x017111, "Wrong size on ProceduralFoliageSpawner_Simulate");
