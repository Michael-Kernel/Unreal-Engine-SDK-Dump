...
// 0x115E4910 (0x115E4910 - 0x0000)
struct alignas(0x115E4910) FEngineServiceAuthDeny final
{
public:
...
static_assert(alignof(FEngineServiceAuthDeny) == 0x115E4910, "Wrong alignment on FEngineServiceAuthDeny");
static_assert(sizeof(FEngineServiceAuthDeny) == 0x115E4910, "Wrong size on FEngineServiceAuthDeny");
...
// 0x115E4570 (0x115E4570 - 0x0000)
struct alignas(0x115E4570) FEngineServiceExecuteCommand final
{
public:
...
static_assert(alignof(FEngineServiceExecuteCommand) == 0x115E4570, "Wrong alignment on FEngineServiceExecuteCommand");
static_assert(sizeof(FEngineServiceExecuteCommand) == 0x115E4570, "Wrong size on FEngineServiceExecuteCommand");
...
// 0x115E4740 (0x115E4740 - 0x0000)
struct alignas(0x115E4740) FEngineServiceAuthGrant final
{
public:
	class FString                                 UserName;                                          // 0x0000(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 UserToGrant;                                       // 0x0010(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FEngineServiceAuthGrant) == 0x115E4740, "Wrong alignment on FEngineServiceAuthGrant");
static_assert(sizeof(FEngineServiceAuthGrant) == 0x115E4740, "Wrong size on FEngineServiceAuthGrant");
...
// 0x1245F (0x1245F - 0x0000)
struct alignas(0x1245F) FEngineServicePing final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FEngineServicePing) == 0x01245F, "Wrong alignment on FEngineServicePing");
static_assert(sizeof(FEngineServicePing) == 0x01245F, "Wrong size on FEngineServicePing");

// ScriptStruct EngineMessages.EngineServicePong
// 0x115E4AE0 (0x115E4AE0 - 0x0000)
struct alignas(0x115E4AE0) FEngineServicePong final
{
public:
	...
	struct FGuid                                  InstanceId;                                        // 0x0018(0x112E8D20)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 InstanceType;                                      // 0x0028(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  SessionId;                                         // 0x0038(0x112E8D20)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FEngineServicePong) == 0x115E4AE0, "Wrong alignment on FEngineServicePong");
static_assert(sizeof(FEngineServicePong) == 0x115E4AE0, "Wrong size on FEngineServicePong");
