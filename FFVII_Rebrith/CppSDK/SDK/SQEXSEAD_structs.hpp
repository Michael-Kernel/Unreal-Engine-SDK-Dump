...
// Enum SQEXSEAD.ESQEXSEAD_BGMLoadState
// NumValues: 0x0005
...
// Enum SQEXSEAD.ESQEXSEADBGMControlTypes
// NumValues: 0x000A
enum class ESQEXSEADBGMControlTypes : uint8
{
	NONE                                     = 0,
	PLAY                                     = 1,
	STOP                                     = 2,
...
// Enum SQEXSEAD.ESQEXSEADSoundOutputPort
// NumValues: 0x0006
enum class ESQEXSEADSoundOutputPort : uint8
{
	AUTO                                     = 0,
	MAIN                                     = 1,
	RESTRICTED                               = 2,
...
enum class ESQEXSEADZeroOneProperties : uint8
{
	...
	VelocityFromLocation                     = 3,
	ESQEXSEADZeroOneProperties_MAX           = 4,
};

// ScriptStruct SQEXSEAD.SQEXSEADAutoSeComponentFootInitParams
// 0x11693470 (0x11693470 - 0x0000)
struct alignas(0x11693470) FSQEXSEADAutoSeComponentFootInitParams final
{
public:
...
static_assert(alignof(FSQEXSEADAutoSeComponentFootInitParams) == 0x11693470, "Wrong alignment on FSQEXSEADAutoSeComponentFootInitParams");
static_assert(sizeof(FSQEXSEADAutoSeComponentFootInitParams) == 0x11693470, "Wrong size on FSQEXSEADAutoSeComponentFootInitParams");
...
public:
	...
	uint8                                         bFollowOwnerVisible : 1;                           // 0x0024(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
// 0x11692820 (0x11692820 - 0x0000)
struct alignas(0x11692820) FSQEXSEADAutoSeComponentBodyInitParams final
{
public:
...
static_assert(alignof(FSQEXSEADAutoSeComponentBodyInitParams) == 0x11692820, "Wrong alignment on FSQEXSEADAutoSeComponentBodyInitParams");
static_assert(sizeof(FSQEXSEADAutoSeComponentBodyInitParams) == 0x11692820, "Wrong size on FSQEXSEADAutoSeComponentBodyInitParams");
...
// 0x12DDE (0x12DDE - 0x0000)
struct alignas(0x12DDE) FSQEXSEADSoundAttachedInfo final
{
public:
	uint8                                         Pad_0[0x18];                                       // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQEXSEADSoundAttachedInfo) == 0x012DDE, "Wrong alignment on FSQEXSEADSoundAttachedInfo");
static_assert(sizeof(FSQEXSEADSoundAttachedInfo) == 0x012DDE, "Wrong size on FSQEXSEADSoundAttachedInfo");

// ScriptStruct SQEXSEAD.SQEXSEAD_Timing
// 0x86FB (0x86FB - 0x0000)
struct alignas(0x86FB) FSQEXSEAD_Timing final
{
public:
	uint8                                         Pad_0[0xC];                                        // 0x0000(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQEXSEAD_Timing) == 0x0086FB, "Wrong alignment on FSQEXSEAD_Timing");
static_assert(sizeof(FSQEXSEAD_Timing) == 0x0086FB, "Wrong size on FSQEXSEAD_Timing");

// ScriptStruct SQEXSEAD.SQEXSEADAutoSeDetectorSettingFootStep
// 0x11691EF0 (0x11691EF0 - 0x0000)
struct alignas(0x11691EF0) FSQEXSEADAutoSeDetectorSettingFootStep final
{
public:
...
static_assert(alignof(FSQEXSEADAutoSeDetectorSettingFootStep) == 0x11691EF0, "Wrong alignment on FSQEXSEADAutoSeDetectorSettingFootStep");
static_assert(sizeof(FSQEXSEADAutoSeDetectorSettingFootStep) == 0x11691EF0, "Wrong size on FSQEXSEADAutoSeDetectorSettingFootStep");
...
public:
	...
	float                                         StaySuspendTime;                                   // 0x0018(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUnreferenceAsset;                                 // 0x001C(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRestoreAfterFinish;                               // 0x001D(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E[0x2];                                       // 0x001E(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQEXSEAD_BGMOptions) == 0x000004, "Wrong alignment on FSQEXSEAD_BGMOptions");
static_assert(sizeof(FSQEXSEAD_BGMOptions) == 0x000020, "Wrong size on FSQEXSEAD_BGMOptions");
...
static_assert(offsetof(FSQEXSEAD_BGMOptions, StaySuspendTime) == 0x000018, "Member 'FSQEXSEAD_BGMOptions::StaySuspendTime' has a wrong offset!");
static_assert(offsetof(FSQEXSEAD_BGMOptions, bUnreferenceAsset) == 0x00001C, "Member 'FSQEXSEAD_BGMOptions::bUnreferenceAsset' has a wrong offset!");
static_assert(offsetof(FSQEXSEAD_BGMOptions, bRestoreAfterFinish) == 0x00001D, "Member 'FSQEXSEAD_BGMOptions::bRestoreAfterFinish' has a wrong offset!");
...
public:
	...
	struct FSQEXSEAD_BGMOptions                   SlotOption;                                        // 0x0008(0x0020)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
...
// 0x11691570 (0x11691570 - 0x0000)
struct alignas(0x11691570) FSQEXSEADAutoSeDetectorSettingSwing final
{
public:
...
static_assert(alignof(FSQEXSEADAutoSeDetectorSettingSwing) == 0x11691570, "Wrong alignment on FSQEXSEADAutoSeDetectorSettingSwing");
static_assert(sizeof(FSQEXSEADAutoSeDetectorSettingSwing) == 0x11691570, "Wrong size on FSQEXSEADAutoSeDetectorSettingSwing");
...
public:
	...
	struct FStringAssetReference                  AssetRefs[0x3F];                                   // 0x0008(0x0010)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQEXSEADSurfaceAssetReferenceRecord) == 0x000004, "Wrong alignment on FSQEXSEADSurfaceAssetReferenceRecord");
static_assert(sizeof(FSQEXSEADSurfaceAssetReferenceRecord) == 0x0003F8, "Wrong size on FSQEXSEADSurfaceAssetReferenceRecord");
...
// 0x11692200 (0x11692200 - 0x0000)
struct alignas(0x11692200) FSQEXSEADAutoSeAnalyzerSetting final
{
public:
...
static_assert(alignof(FSQEXSEADAutoSeAnalyzerSetting) == 0x11692200, "Wrong alignment on FSQEXSEADAutoSeAnalyzerSetting");
static_assert(sizeof(FSQEXSEADAutoSeAnalyzerSetting) == 0x11692200, "Wrong size on FSQEXSEADAutoSeAnalyzerSetting");
...
// 0x11691880 (0x11691880 - 0x0000)
struct alignas(0x11691880) FSQEXSEADAutoSeDetectorSettingRustle final
{
public:
...
static_assert(alignof(FSQEXSEADAutoSeDetectorSettingRustle) == 0x11691880, "Wrong alignment on FSQEXSEADAutoSeDetectorSettingRustle");
static_assert(sizeof(FSQEXSEADAutoSeDetectorSettingRustle) == 0x11691880, "Wrong size on FSQEXSEADAutoSeDetectorSettingRustle");
...
// 0x11693160 (0x11693160 - 0x0000)
struct alignas(0x11693160) FSQEXSEADAutoSeComponentArmInitParams final
{
public:
...
static_assert(alignof(FSQEXSEADAutoSeComponentArmInitParams) == 0x11693160, "Wrong alignment on FSQEXSEADAutoSeComponentArmInitParams");
static_assert(sizeof(FSQEXSEADAutoSeComponentArmInitParams) == 0x11693160, "Wrong size on FSQEXSEADAutoSeComponentArmInitParams");
...
// 0x11692E50 (0x11692E50 - 0x0000)
struct alignas(0x11692E50) FSQEXSEADAutoSeComponentWingInitParams final
{
public:
...
static_assert(alignof(FSQEXSEADAutoSeComponentWingInitParams) == 0x11692E50, "Wrong alignment on FSQEXSEADAutoSeComponentWingInitParams");
static_assert(sizeof(FSQEXSEADAutoSeComponentWingInitParams) == 0x11692E50, "Wrong size on FSQEXSEADAutoSeComponentWingInitParams");
...
public:
	...
	struct FSQEXSEADAutoSeComponentBodyInitParams Body;                                              // 0x0040(0x11692820)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FSQEXSEADAutoSeComponentInitParams) == 0x11692820, "Wrong alignment on FSQEXSEADAutoSeComponentInitParams");
static_assert(sizeof(FSQEXSEADAutoSeComponentInitParams) == 0x11692820, "Wrong size on FSQEXSEADAutoSeComponentInitParams");
...
// ScriptStruct SQEXSEAD.SQEXSEADAutoSeAssetLoaderAssets
// 0x0010 (0x0010 - 0x0000)
struct FSQEXSEADAutoSeAssetLoaderAssets final
{
public:
	TArray<class USoundBase*>                     Assets;                                            // 0x0000(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQEXSEADAutoSeAssetLoaderAssets) == 0x000008, "Wrong alignment on FSQEXSEADAutoSeAssetLoaderAssets");
static_assert(sizeof(FSQEXSEADAutoSeAssetLoaderAssets) == 0x000010, "Wrong size on FSQEXSEADAutoSeAssetLoaderAssets");
static_assert(offsetof(FSQEXSEADAutoSeAssetLoaderAssets, Assets) == 0x000000, "Member 'FSQEXSEADAutoSeAssetLoaderAssets::Assets' has a wrong offset!");
...
{
public:
	struct FStringAssetReference                  SoundAssetPaths[0xA];                              // 0x0000(0x0010)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQEXSEADAutoSeComponentAssetTableNonSurface) == 0x000001, "Wrong alignment on FSQEXSEADAutoSeComponentAssetTableNonSurface");
static_assert(sizeof(FSQEXSEADAutoSeComponentAssetTableNonSurface) == 0x0000A0, "Wrong size on FSQEXSEADAutoSeComponentAssetTableNonSurface");
...
// 0x116962A0 (0x116962A0 - 0x0000)
struct alignas(0x116962A0) FSQEXSEADSoundReference final
{
public:
	...
	uint8                                         bFollow : 1;                                       // 0x0008(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(alignof(FSQEXSEADSoundReference) == 0x116962A0, "Wrong alignment on FSQEXSEADSoundReference");
static_assert(sizeof(FSQEXSEADSoundReference) == 0x116962A0, "Wrong size on FSQEXSEADSoundReference");
...
{
public:
	struct FStringAssetReference                  SoundAssetPaths[0x6];                              // 0x0000(0x0010)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQEXSEADAutoSeComponentAssetTablePerSurface) == 0x000001, "Wrong alignment on FSQEXSEADAutoSeComponentAssetTablePerSurface");
static_assert(sizeof(FSQEXSEADAutoSeComponentAssetTablePerSurface) == 0x000060, "Wrong size on FSQEXSEADAutoSeComponentAssetTablePerSurface");
...
// 0x1242C (0x1242C - 0x0000)
struct alignas(0x1242C) FSQEXSEADSystemPerformanceInfo final
{
public:
	uint8                                         Pad_0[0x20];                                       // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQEXSEADSystemPerformanceInfo) == 0x01242C, "Wrong alignment on FSQEXSEADSystemPerformanceInfo");
static_assert(sizeof(FSQEXSEADSystemPerformanceInfo) == 0x01242C, "Wrong size on FSQEXSEADSystemPerformanceInfo");

// ScriptStruct SQEXSEAD.SQEXSEAD_BGMLocalOptions
// 0x12E13 (0x12E13 - 0x0000)
struct alignas(0x12E13) FSQEXSEAD_BGMLocalOptions final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQEXSEAD_BGMLocalOptions) == 0x012E13, "Wrong alignment on FSQEXSEAD_BGMLocalOptions");
static_assert(sizeof(FSQEXSEAD_BGMLocalOptions) == 0x012E13, "Wrong size on FSQEXSEAD_BGMLocalOptions");
...
// 0x11694B60 (0x11694B60 - 0x0000)
struct alignas(0x11694B60) FSQEXSEADAutoSeControlTrackKey final
{
public:
...
static_assert(alignof(FSQEXSEADAutoSeControlTrackKey) == 0x11694B60, "Wrong alignment on FSQEXSEADAutoSeControlTrackKey");
static_assert(sizeof(FSQEXSEADAutoSeControlTrackKey) == 0x11694B60, "Wrong size on FSQEXSEADAutoSeControlTrackKey");
...
// ScriptStruct SQEXSEAD.SQEXSEADBGMControlTrackKey
// 0x116954A0 (0x116954A0 - 0x0000)
struct alignas(0x116954A0) FSQEXSEADBGMControlTrackKey final
{
public:
	float                                         Time;                                              // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESQEXSEADBGMControlTypes                      ControlType;                                       // 0x0004(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	int32                                         SectionIndex;                                      // 0x0010(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ModeIndex;                                         // 0x0014(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSQEXSEADBGMControlTrackKey) == 0x116954A0, "Wrong alignment on FSQEXSEADBGMControlTrackKey");
static_assert(sizeof(FSQEXSEADBGMControlTrackKey) == 0x116954A0, "Wrong size on FSQEXSEADBGMControlTrackKey");
static_assert(offsetof(FSQEXSEADBGMControlTrackKey, Time) == 0x000000, "Member 'FSQEXSEADBGMControlTrackKey::Time' has a wrong offset!");
static_assert(offsetof(FSQEXSEADBGMControlTrackKey, ControlType) == 0x000004, "Member 'FSQEXSEADBGMControlTrackKey::ControlType' has a wrong offset!");
static_assert(offsetof(FSQEXSEADBGMControlTrackKey, SlotName) == 0x000008, "Member 'FSQEXSEADBGMControlTrackKey::SlotName' has a wrong offset!");
static_assert(offsetof(FSQEXSEADBGMControlTrackKey, SectionIndex) == 0x000010, "Member 'FSQEXSEADBGMControlTrackKey::SectionIndex' has a wrong offset!");
static_assert(offsetof(FSQEXSEADBGMControlTrackKey, ModeIndex) == 0x000014, "Member 'FSQEXSEADBGMControlTrackKey::ModeIndex' has a wrong offset!");

// ScriptStruct SQEXSEAD.SQEXSEADEventTrackKey
// 0x11695830 (0x11695830 - 0x0000)
struct alignas(0x11695830) FSQEXSEADEventTrackKey final
{
public:
...
static_assert(alignof(FSQEXSEADEventTrackKey) == 0x11695830, "Wrong alignment on FSQEXSEADEventTrackKey");
static_assert(sizeof(FSQEXSEADEventTrackKey) == 0x11695830, "Wrong size on FSQEXSEADEventTrackKey");
...
// 0x116965D0 (0x116965D0 - 0x0000)
struct alignas(0x116965D0) FSQEXSEADVolumeInfo final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSQEXSEADVolumeInfo) == 0x116965D0, "Wrong alignment on FSQEXSEADVolumeInfo");
static_assert(sizeof(FSQEXSEADVolumeInfo) == 0x116965D0, "Wrong size on FSQEXSEADVolumeInfo");
