...
static_assert(alignof(USteamNetConnection) == 0x1F5FEC10, "Wrong alignment on USteamNetConnection");
static_assert(sizeof(USteamNetConnection) == 0x1F5FEC10, "Wrong size on USteamNetConnection");
...
static_assert(sizeof(USteamNetDriver) == 0x000460, "Wrong size on USteamNetDriver");
