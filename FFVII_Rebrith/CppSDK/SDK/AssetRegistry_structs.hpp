...
struct alignas(0x115E3C80) FAssetData final
{
public:
...
static_assert(alignof(FAssetData) == 0x115E3C80, "Wrong alignment on FAssetData");
static_assert(sizeof(FAssetData) == 0x115E3C80, "Wrong size on FAssetData");
...
{
public:
	struct FPrimaryAssetId                        BundleScope;                                       // 0x0000(0x112EFC30)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAssetBundleEntry) == 0x112EFC30, "Wrong alignment on FAssetBundleEntry");
static_assert(sizeof(FAssetBundleEntry) == 0x112EFC30, "Wrong size on FAssetBundleEntry");
...
// 0x115E4000 (0x115E4000 - 0x0000)
struct alignas(0x115E4000) FTagAndValue final
{
public:
...
static_assert(alignof(FTagAndValue) == 0x115E4000, "Wrong alignment on FTagAndValue");
static_assert(sizeof(FTagAndValue) == 0x115E4000, "Wrong size on FTagAndValue");
