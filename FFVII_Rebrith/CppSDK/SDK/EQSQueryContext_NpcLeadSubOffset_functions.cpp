...
#include "EQSQueryContext_NpcLeadSubOffset_classes.hpp"
#include "EQSQueryContext_NpcLeadSubOffset_parameters.hpp"
...
void UEQSQueryContext_NpcLeadSubOffset_C::ProvideSingleLocation(class UObject* QuerierObject, class AActor* QuerierActor, struct FVector* ResultingLocation) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EQSQueryContext_NpcLeadSubOffset_C", "ProvideSingleLocation");

	Params::EQSQueryContext_NpcLeadSubOffset_C_ProvideSingleLocation Parms{};
