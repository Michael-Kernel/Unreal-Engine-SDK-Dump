...
public:
	...
	struct FGuid                                  InstanceId;                                        // 0x0028(0x112E8D20)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FGuid                                  SessionId;                                         // 0x0060(0x112E8D20)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FSessionServicePong) == 0x112E8D20, "Wrong alignment on FSessionServicePong");
static_assert(sizeof(FSessionServicePong) == 0x112E8D20, "Wrong size on FSessionServicePong");
...
// 0x833C (0x833C - 0x0000)
struct alignas(0x833C) FSessionServiceLogUnsubscribe final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSessionServiceLogUnsubscribe) == 0x00833C, "Wrong alignment on FSessionServiceLogUnsubscribe");
static_assert(sizeof(FSessionServiceLogUnsubscribe) == 0x00833C, "Wrong size on FSessionServiceLogUnsubscribe");

// ScriptStruct SessionMessages.SessionServiceLogSubscribe
// 0x12D61 (0x12D61 - 0x0000)
struct alignas(0x12D61) FSessionServiceLogSubscribe final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSessionServiceLogSubscribe) == 0x012D61, "Wrong alignment on FSessionServiceLogSubscribe");
static_assert(sizeof(FSessionServiceLogSubscribe) == 0x012D61, "Wrong size on FSessionServiceLogSubscribe");
...
static_assert(alignof(FSessionServiceLog) == 0x112E8D20, "Wrong alignment on FSessionServiceLog");
static_assert(sizeof(FSessionServiceLog) == 0x112E8D20, "Wrong size on FSessionServiceLog");
