...
// 0x11484730 (0x11484730 - 0x0000)
struct alignas(0x11484730) FInAppPurchaseProductInfo final
{
public:
...
static_assert(alignof(FInAppPurchaseProductInfo) == 0x11484730, "Wrong alignment on FInAppPurchaseProductInfo");
static_assert(sizeof(FInAppPurchaseProductInfo) == 0x11484730, "Wrong size on FInAppPurchaseProductInfo");
...
// 0x114852D0 (0x114852D0 - 0x0000)
struct alignas(0x114852D0) FInAppPurchaseRestoreInfo final
{
public:
	class FString                                 Identifier;                                        // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FInAppPurchaseRestoreInfo) == 0x114852D0, "Wrong alignment on FInAppPurchaseRestoreInfo");
static_assert(sizeof(FInAppPurchaseRestoreInfo) == 0x114852D0, "Wrong size on FInAppPurchaseRestoreInfo");
...
// 0x11689510 (0x11689510 - 0x0000)
struct alignas(0x11689510) FNamedInterfaceDef final
{
public:
...
static_assert(alignof(FNamedInterfaceDef) == 0x11689510, "Wrong alignment on FNamedInterfaceDef");
static_assert(sizeof(FNamedInterfaceDef) == 0x11689510, "Wrong size on FNamedInterfaceDef");
