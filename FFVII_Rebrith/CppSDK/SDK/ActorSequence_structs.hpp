...
// 0x115ED5B0 (0x115ED5B0 - 0x0000)
struct alignas(0x115ED5B0) FActorSequenceObjectReference final
{
public:
	...
	struct FGuid                                  ActorId;                                           // 0x0004(0x112E8D20)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FString                                 PathToComponent;                                   // 0x0018(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FActorSequenceObjectReference) == 0x115ED5B0, "Wrong alignment on FActorSequenceObjectReference");
static_assert(sizeof(FActorSequenceObjectReference) == 0x115ED5B0, "Wrong size on FActorSequenceObjectReference");
