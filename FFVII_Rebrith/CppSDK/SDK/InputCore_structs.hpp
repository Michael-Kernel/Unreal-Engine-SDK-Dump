...
struct alignas(0x112F6AF0) FKey final
{
public:
...
static_assert(alignof(FKey) == 0x112F6AF0, "Wrong alignment on FKey");
static_assert(sizeof(FKey) == 0x112F6AF0, "Wrong size on FKey");
