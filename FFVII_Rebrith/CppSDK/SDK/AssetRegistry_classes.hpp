...
// 0x09F0 (0x0A30 - 0x0040)
class UAssetRegistryImpl final : public UObject
{
public:
	uint8                                         Pad_40[0x9F0];                                     // 0x0040(0x09F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x000A30, "Wrong size on UAssetRegistryImpl");
...
public:
	...
	static struct FStringAssetReference ToStringReference(const struct FAssetData& InAssetData);
...
static_assert(sizeof(UAssetRegistryHelpers) == 0x000040, "Wrong size on UAssetRegistryHelpers");
...
static_assert(sizeof(IAssetRegistry) == 0x000040, "Wrong size on IAssetRegistry");
