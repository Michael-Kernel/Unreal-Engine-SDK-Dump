...
// 0x1839F (0x1839F - 0x0000)
struct alignas(0x1839F) PaperFlipbook_GetKeyFrameIndexAtTime final
{
public:
...
static_assert(alignof(PaperFlipbook_GetKeyFrameIndexAtTime) == 0x01839F, "Wrong alignment on PaperFlipbook_GetKeyFrameIndexAtTime");
static_assert(sizeof(PaperFlipbook_GetKeyFrameIndexAtTime) == 0x01839F, "Wrong size on PaperFlipbook_GetKeyFrameIndexAtTime");
...
// 0xC3F7 (0xC3F7 - 0x0000)
struct alignas(0xC3F7) PaperFlipbook_GetNumFrames final
{
public:
	int32                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperFlipbook_GetNumFrames) == 0x00C3F7, "Wrong alignment on PaperFlipbook_GetNumFrames");
static_assert(sizeof(PaperFlipbook_GetNumFrames) == 0x00C3F7, "Wrong size on PaperFlipbook_GetNumFrames");
...
// 0xC3F8 (0xC3F8 - 0x0000)
struct alignas(0xC3F8) PaperFlipbook_GetNumKeyFrames final
{
public:
	int32                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperFlipbook_GetNumKeyFrames) == 0x00C3F8, "Wrong alignment on PaperFlipbook_GetNumKeyFrames");
static_assert(sizeof(PaperFlipbook_GetNumKeyFrames) == 0x00C3F8, "Wrong size on PaperFlipbook_GetNumKeyFrames");
...
// 0xC3FB (0xC3FB - 0x0000)
struct alignas(0xC3FB) PaperFlipbook_GetTotalDuration final
{
public:
	float                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperFlipbook_GetTotalDuration) == 0x00C3FB, "Wrong alignment on PaperFlipbook_GetTotalDuration");
static_assert(sizeof(PaperFlipbook_GetTotalDuration) == 0x00C3FB, "Wrong size on PaperFlipbook_GetTotalDuration");
...
// 0xB557 (0xB557 - 0x0000)
struct alignas(0xB557) PaperFlipbookComponent_SetNewTime final
{
public:
...
static_assert(alignof(PaperFlipbookComponent_SetNewTime) == 0x00B557, "Wrong alignment on PaperFlipbookComponent_SetNewTime");
static_assert(sizeof(PaperFlipbookComponent_SetNewTime) == 0x00B557, "Wrong size on PaperFlipbookComponent_SetNewTime");
...
// 0xC407 (0xC407 - 0x0000)
struct alignas(0xC407) PaperFlipbookComponent_SetPlayRate final
{
public:
...
static_assert(alignof(PaperFlipbookComponent_SetPlayRate) == 0x00C407, "Wrong alignment on PaperFlipbookComponent_SetPlayRate");
static_assert(sizeof(PaperFlipbookComponent_SetPlayRate) == 0x00C407, "Wrong size on PaperFlipbookComponent_SetPlayRate");
...
{
public:
	struct FLinearColor                           NewColor;                                          // 0x0000(0x112EAE80)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperFlipbookComponent_SetSpriteColor) == 0x112EAE80, "Wrong alignment on PaperFlipbookComponent_SetSpriteColor");
static_assert(sizeof(PaperFlipbookComponent_SetSpriteColor) == 0x112EAE80, "Wrong size on PaperFlipbookComponent_SetSpriteColor");
...
// 0xC400 (0xC400 - 0x0000)
struct alignas(0xC400) PaperFlipbookComponent_GetFlipbookFramerate final
{
public:
	float                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperFlipbookComponent_GetFlipbookFramerate) == 0x00C400, "Wrong alignment on PaperFlipbookComponent_GetFlipbookFramerate");
static_assert(sizeof(PaperFlipbookComponent_GetFlipbookFramerate) == 0x00C400, "Wrong size on PaperFlipbookComponent_GetFlipbookFramerate");
...
// 0xC401 (0xC401 - 0x0000)
struct alignas(0xC401) PaperFlipbookComponent_GetFlipbookLength final
{
public:
	float                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperFlipbookComponent_GetFlipbookLength) == 0x00C401, "Wrong alignment on PaperFlipbookComponent_GetFlipbookLength");
static_assert(sizeof(PaperFlipbookComponent_GetFlipbookLength) == 0x00C401, "Wrong size on PaperFlipbookComponent_GetFlipbookLength");
...
// 0xB550 (0xB550 - 0x0000)
struct alignas(0xB550) PaperFlipbookComponent_GetFlipbookLengthInFrames final
{
public:
	int32                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperFlipbookComponent_GetFlipbookLengthInFrames) == 0x00B550, "Wrong alignment on PaperFlipbookComponent_GetFlipbookLengthInFrames");
static_assert(sizeof(PaperFlipbookComponent_GetFlipbookLengthInFrames) == 0x00B550, "Wrong size on PaperFlipbookComponent_GetFlipbookLengthInFrames");
...
// 0xC402 (0xC402 - 0x0000)
struct alignas(0xC402) PaperFlipbookComponent_GetPlaybackPosition final
{
public:
	float                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperFlipbookComponent_GetPlaybackPosition) == 0x00C402, "Wrong alignment on PaperFlipbookComponent_GetPlaybackPosition");
static_assert(sizeof(PaperFlipbookComponent_GetPlaybackPosition) == 0x00C402, "Wrong size on PaperFlipbookComponent_GetPlaybackPosition");
...
// 0x95C5 (0x95C5 - 0x0000)
struct alignas(0x95C5) PaperFlipbookComponent_GetPlaybackPositionInFrames final
{
public:
	int32                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperFlipbookComponent_GetPlaybackPositionInFrames) == 0x0095C5, "Wrong alignment on PaperFlipbookComponent_GetPlaybackPositionInFrames");
static_assert(sizeof(PaperFlipbookComponent_GetPlaybackPositionInFrames) == 0x0095C5, "Wrong size on PaperFlipbookComponent_GetPlaybackPositionInFrames");
...
// 0xC403 (0xC403 - 0x0000)
struct alignas(0xC403) PaperFlipbookComponent_GetPlayRate final
{
public:
	float                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperFlipbookComponent_GetPlayRate) == 0x00C403, "Wrong alignment on PaperFlipbookComponent_GetPlayRate");
static_assert(sizeof(PaperFlipbookComponent_GetPlayRate) == 0x00C403, "Wrong size on PaperFlipbookComponent_GetPlayRate");
...
// 0x0008 (0x0008 - 0x0000)
struct PaperFlipbookComponent_GetSpriteMaterial final
{
public:
...
static_assert(alignof(PaperFlipbookComponent_GetSpriteMaterial) == 0x000008, "Wrong alignment on PaperFlipbookComponent_GetSpriteMaterial");
static_assert(sizeof(PaperFlipbookComponent_GetSpriteMaterial) == 0x000008, "Wrong size on PaperFlipbookComponent_GetSpriteMaterial");
static_assert(offsetof(PaperFlipbookComponent_GetSpriteMaterial, ReturnValue) == 0x000000, "Member 'PaperFlipbookComponent_GetSpriteMaterial::ReturnValue' has a wrong offset!");
...
{
public:
	struct FTransform                             Transform;                                         // 0x0000(0x112E9D50)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FLinearColor                           Color;                                             // 0x003C(0x112EAE80)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(PaperGroupedSpriteComponent_AddInstance) == 0x112EAE80, "Wrong alignment on PaperGroupedSpriteComponent_AddInstance");
static_assert(sizeof(PaperGroupedSpriteComponent_AddInstance) == 0x112EAE80, "Wrong size on PaperGroupedSpriteComponent_AddInstance");
...
static_assert(alignof(PaperGroupedSpriteComponent_SortInstancesAlongAxis) == 0x000001, "Wrong alignment on PaperGroupedSpriteComponent_SortInstancesAlongAxis");
...
public:
	int32                                         InstanceIndex;                                     // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           NewInstanceColor;                                  // 0x0004(0x112EAE80)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(PaperGroupedSpriteComponent_UpdateInstanceColor) == 0x112EAE80, "Wrong alignment on PaperGroupedSpriteComponent_UpdateInstanceColor");
static_assert(sizeof(PaperGroupedSpriteComponent_UpdateInstanceColor) == 0x112EAE80, "Wrong size on PaperGroupedSpriteComponent_UpdateInstanceColor");
...
public:
	...
	struct FTransform                             NewInstanceTransform;                              // 0x0010(0x112E9D50)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(PaperGroupedSpriteComponent_UpdateInstanceTransform) == 0x000004, "Wrong alignment on PaperGroupedSpriteComponent_UpdateInstanceTransform");
...
// 0xA9E8 (0xA9E8 - 0x0000)
struct alignas(0xA9E8) PaperGroupedSpriteComponent_GetInstanceCount final
{
public:
	int32                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperGroupedSpriteComponent_GetInstanceCount) == 0x00A9E8, "Wrong alignment on PaperGroupedSpriteComponent_GetInstanceCount");
static_assert(sizeof(PaperGroupedSpriteComponent_GetInstanceCount) == 0x00A9E8, "Wrong size on PaperGroupedSpriteComponent_GetInstanceCount");
...
public:
	int32                                         InstanceIndex;                                     // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0xC];                                        // 0x0004(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             OutInstanceTransform;                              // 0x0010(0x112E9D50)(Parm, OutParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bWorldSpace;                                       // 0x0040(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(PaperGroupedSpriteComponent_GetInstanceTransform) == 0x000004, "Wrong alignment on PaperGroupedSpriteComponent_GetInstanceTransform");
...
public:
	...
	struct FSlateBrush                            ReturnValue;                                       // 0x0010(0x1145C4E0)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(PaperSpriteBlueprintLibrary_MakeBrushFromSprite) == 0x0000A0, "Wrong size on PaperSpriteBlueprintLibrary_MakeBrushFromSprite");
...
static_assert(alignof(PaperSpriteComponent_SetSpriteColor) == 0x112EAE80, "Wrong alignment on PaperSpriteComponent_SetSpriteColor");
static_assert(sizeof(PaperSpriteComponent_SetSpriteColor) == 0x112EAE80, "Wrong size on PaperSpriteComponent_SetSpriteColor");
...
static_assert(alignof(PaperTerrainComponent_SetTerrainColor) == 0x112EAE80, "Wrong alignment on PaperTerrainComponent_SetTerrainColor");
static_assert(sizeof(PaperTerrainComponent_SetTerrainColor) == 0x112EAE80, "Wrong size on PaperTerrainComponent_SetTerrainColor");
...
// 0x183DD (0x183DD - 0x0000)
struct alignas(0x183DD) PaperTileMapComponent_GetMapSize final
{
public:
...
static_assert(alignof(PaperTileMapComponent_GetMapSize) == 0x0183DD, "Wrong alignment on PaperTileMapComponent_GetMapSize");
static_assert(sizeof(PaperTileMapComponent_GetMapSize) == 0x0183DD, "Wrong size on PaperTileMapComponent_GetMapSize");
...
// 0x183E5 (0x183E5 - 0x0000)
struct alignas(0x183E5) PaperTileMapComponent_ResizeMap final
{
public:
...
static_assert(alignof(PaperTileMapComponent_ResizeMap) == 0x0183E5, "Wrong alignment on PaperTileMapComponent_ResizeMap");
static_assert(sizeof(PaperTileMapComponent_ResizeMap) == 0x0183E5, "Wrong size on PaperTileMapComponent_ResizeMap");
...
static_assert(alignof(PaperTileMapComponent_SetLayerColor) == 0x112EAE80, "Wrong alignment on PaperTileMapComponent_SetLayerColor");
static_assert(sizeof(PaperTileMapComponent_SetLayerColor) == 0x112EAE80, "Wrong size on PaperTileMapComponent_SetLayerColor");
...
public:
	...
	struct FPaperTileInfo                         NewValue;                                          // 0x0010(0x1168CD60)(Parm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperTileMapComponent_SetTile) == 0x1168CD60, "Wrong alignment on PaperTileMapComponent_SetTile");
static_assert(sizeof(PaperTileMapComponent_SetTile) == 0x1168CD60, "Wrong size on PaperTileMapComponent_SetTile");
...
static_assert(alignof(PaperTileMapComponent_SetTileMapColor) == 0x112EAE80, "Wrong alignment on PaperTileMapComponent_SetTileMapColor");
static_assert(sizeof(PaperTileMapComponent_SetTileMapColor) == 0x112EAE80, "Wrong size on PaperTileMapComponent_SetTileMapColor");
...
public:
	int32                                         Layer;                                             // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           ReturnValue;                                       // 0x0004(0x112EAE80)(Parm, OutParm, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperTileMapComponent_GetLayerColor) == 0x112EAE80, "Wrong alignment on PaperTileMapComponent_GetLayerColor");
static_assert(sizeof(PaperTileMapComponent_GetLayerColor) == 0x112EAE80, "Wrong size on PaperTileMapComponent_GetLayerColor");
...
public:
	...
	int32                                         Layer;                                             // 0x0008(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPaperTileInfo                         ReturnValue;                                       // 0x0010(0x1168CD60)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperTileMapComponent_GetTile) == 0x1168CD60, "Wrong alignment on PaperTileMapComponent_GetTile");
static_assert(sizeof(PaperTileMapComponent_GetTile) == 0x1168CD60, "Wrong size on PaperTileMapComponent_GetTile");
...
{
public:
	struct FLinearColor                           ReturnValue;                                       // 0x0000(0x112EAE80)(Parm, OutParm, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PaperTileMapComponent_GetTileMapColor) == 0x112EAE80, "Wrong alignment on PaperTileMapComponent_GetTileMapColor");
static_assert(sizeof(PaperTileMapComponent_GetTileMapColor) == 0x112EAE80, "Wrong size on PaperTileMapComponent_GetTileMapColor");
...
{
public:
	struct FPaperTileInfo                         Tile;                                              // 0x0000(0x1168CD60)(Parm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(TileMapBlueprintLibrary_BreakTile) == 0x1168CD60, "Wrong alignment on TileMapBlueprintLibrary_BreakTile");
static_assert(sizeof(TileMapBlueprintLibrary_BreakTile) == 0x1168CD60, "Wrong size on TileMapBlueprintLibrary_BreakTile");
...
public:
	struct FPaperTileInfo                         Tile;                                              // 0x0000(0x1168CD60)(Parm, NoDestructor, NativeAccessSpecifierPublic)
	struct FTransform                             ReturnValue;                                       // 0x0010(0x112E9D50)(Parm, OutParm, ReturnParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(TileMapBlueprintLibrary_GetTileTransform) == 0x1168CD60, "Wrong alignment on TileMapBlueprintLibrary_GetTileTransform");
static_assert(sizeof(TileMapBlueprintLibrary_GetTileTransform) == 0x1168CD60, "Wrong size on TileMapBlueprintLibrary_GetTileTransform");
...
static_assert(alignof(TileMapBlueprintLibrary_GetTileUserData) == 0x1168CD60, "Wrong alignment on TileMapBlueprintLibrary_GetTileUserData");
static_assert(sizeof(TileMapBlueprintLibrary_GetTileUserData) == 0x1168CD60, "Wrong size on TileMapBlueprintLibrary_GetTileUserData");
...
public:
	...
	struct FPaperTileInfo                         ReturnValue;                                       // 0x0018(0x1168CD60)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(TileMapBlueprintLibrary_MakeTile) == 0x1168CD60, "Wrong alignment on TileMapBlueprintLibrary_MakeTile");
static_assert(sizeof(TileMapBlueprintLibrary_MakeTile) == 0x1168CD60, "Wrong size on TileMapBlueprintLibrary_MakeTile");
