...
static_assert(alignof(FProcMeshTangent) == 0x000001, "Wrong alignment on FProcMeshTangent");
...
public:
	...
	struct FVector2D                              UV0;                                               // 0x002C(0x112E95F0)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FProcMeshVertex) == 0x112E95F0, "Wrong alignment on FProcMeshVertex");
static_assert(sizeof(FProcMeshVertex) == 0x112E95F0, "Wrong size on FProcMeshVertex");
