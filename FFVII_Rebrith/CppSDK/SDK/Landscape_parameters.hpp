...
// 0xB51D (0xB51D - 0x0000)
struct alignas(0xB51D) LandscapeProxy_ChangeLODDistanceFactor final
{
public:
...
static_assert(alignof(LandscapeProxy_ChangeLODDistanceFactor) == 0x00B51D, "Wrong alignment on LandscapeProxy_ChangeLODDistanceFactor");
static_assert(sizeof(LandscapeProxy_ChangeLODDistanceFactor) == 0x00B51D, "Wrong size on LandscapeProxy_ChangeLODDistanceFactor");
