...
// 0xDD97 (0xDD97 - 0x0000)
struct alignas(0xDD97) FGizmoSelectData final
{
public:
	uint8                                         Pad_0[0x50];                                       // 0x0000(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGizmoSelectData) == 0x00DD97, "Wrong alignment on FGizmoSelectData");
static_assert(sizeof(FGizmoSelectData) == 0x00DD97, "Wrong size on FGizmoSelectData");
...
// 0x12141 (0x12141 - 0x0000)
struct alignas(0x12141) FLandscapeEditorLayerSettings final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLandscapeEditorLayerSettings) == 0x012141, "Wrong alignment on FLandscapeEditorLayerSettings");
static_assert(sizeof(FLandscapeEditorLayerSettings) == 0x012141, "Wrong size on FLandscapeEditorLayerSettings");
...
public:
	...
	struct FFloatInterval                         ScaleX;                                            // 0x0024(0x112F06E0)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFloatInterval                         ScaleY;                                            // 0x002C(0x112F06E0)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFloatInterval                         ScaleZ;                                            // 0x0034(0x112F06E0)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FLightingChannels                      LightingChannels;                                  // 0x003F(0x0003)(Edit, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	bool                                          bReceivesDecals;                                   // 0x0042(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_43[0x5];                                       // 0x0043(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGrassVariety) == 0x112F06E0, "Wrong alignment on FGrassVariety");
static_assert(sizeof(FGrassVariety) == 0x112F06E0, "Wrong size on FGrassVariety");
...
static_assert(offsetof(FGrassVariety, bReceivesDecals) == 0x000042, "Member 'FGrassVariety::bReceivesDecals' has a wrong offset!");

// ScriptStruct Landscape.LandscapeInfoLayerSettings
// 0x115A34E0 (0x115A34E0 - 0x0000)
struct alignas(0x115A34E0) FLandscapeInfoLayerSettings final
{
public:
...
static_assert(alignof(FLandscapeInfoLayerSettings) == 0x115A34E0, "Wrong alignment on FLandscapeInfoLayerSettings");
static_assert(sizeof(FLandscapeInfoLayerSettings) == 0x115A34E0, "Wrong size on FLandscapeInfoLayerSettings");
...
// 0x12140 (0x12140 - 0x0000)
struct alignas(0x12140) FLandscapeImportLayerInfo final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLandscapeImportLayerInfo) == 0x012140, "Wrong alignment on FLandscapeImportLayerInfo");
static_assert(sizeof(FLandscapeImportLayerInfo) == 0x012140, "Wrong size on FLandscapeImportLayerInfo");
...
// 0x115A45B0 (0x115A45B0 - 0x0000)
struct alignas(0x115A45B0) FLandscapeSplineSegmentConnection final
{
public:
...
static_assert(alignof(FLandscapeSplineSegmentConnection) == 0x115A45B0, "Wrong alignment on FLandscapeSplineSegmentConnection");
static_assert(sizeof(FLandscapeSplineSegmentConnection) == 0x115A45B0, "Wrong size on FLandscapeSplineSegmentConnection");
...
// 0x5F7E (0x5F7E - 0x0000)
struct alignas(0x5F7E) FForeignWorldSplineData final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FForeignWorldSplineData) == 0x005F7E, "Wrong alignment on FForeignWorldSplineData");
static_assert(sizeof(FForeignWorldSplineData) == 0x005F7E, "Wrong size on FForeignWorldSplineData");

// ScriptStruct Landscape.LandscapeSplineInterpPoint
// 0x115A4820 (0x115A4820 - 0x0000)
struct alignas(0x115A4820) FLandscapeSplineInterpPoint final
{
public:
...
static_assert(alignof(FLandscapeSplineInterpPoint) == 0x115A4820, "Wrong alignment on FLandscapeSplineInterpPoint");
static_assert(sizeof(FLandscapeSplineInterpPoint) == 0x115A4820, "Wrong size on FLandscapeSplineInterpPoint");
...
// 0x5F85 (0x5F85 - 0x0000)
struct alignas(0x5F85) FForeignSplineSegmentData final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FForeignSplineSegmentData) == 0x005F85, "Wrong alignment on FForeignSplineSegmentData");
static_assert(sizeof(FForeignSplineSegmentData) == 0x005F85, "Wrong size on FForeignSplineSegmentData");

// ScriptStruct Landscape.ForeignControlPointData
// 0x12143 (0x12143 - 0x0000)
struct alignas(0x12143) FForeignControlPointData final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FForeignControlPointData) == 0x012143, "Wrong alignment on FForeignControlPointData");
static_assert(sizeof(FForeignControlPointData) == 0x012143, "Wrong size on FForeignControlPointData");
...
public:
	...
	struct FVector2D                              CenterAdjust;                                      // 0x001C(0x112E95F0)(Edit, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FLandscapeSplineMeshEntry) == 0x112E95F0, "Wrong alignment on FLandscapeSplineMeshEntry");
static_assert(sizeof(FLandscapeSplineMeshEntry) == 0x112E95F0, "Wrong size on FLandscapeSplineMeshEntry");
...
public:
	...
	struct FExpressionInput                       Input;                                             // 0x0010(0x112F2730)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FGrassInput) == 0x112F2730, "Wrong alignment on FGrassInput");
static_assert(sizeof(FGrassInput) == 0x112F2730, "Wrong size on FGrassInput");
...
// 0x115A4F00 (0x115A4F00 - 0x0000)
struct alignas(0x115A4F00) FLayerBlendInput final
{
public:
	...
	struct FExpressionInput                       LayerInput;                                        // 0x0010(0x112F2730)(NativeAccessSpecifierPublic)
	struct FExpressionInput                       HeightInput;                                       // 0x0048(0x112F2730)(NativeAccessSpecifierPublic)
...
static_assert(alignof(FLayerBlendInput) == 0x115A4F00, "Wrong alignment on FLayerBlendInput");
static_assert(sizeof(FLayerBlendInput) == 0x115A4F00, "Wrong size on FLayerBlendInput");
