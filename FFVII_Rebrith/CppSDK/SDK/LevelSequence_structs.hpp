...
// 0x115EE220 (0x115EE220 - 0x0000)
struct alignas(0x115EE220) FLevelSequenceBindingReference final
{
public:
...
static_assert(alignof(FLevelSequenceBindingReference) == 0x115EE220, "Wrong alignment on FLevelSequenceBindingReference");
static_assert(sizeof(FLevelSequenceBindingReference) == 0x115EE220, "Wrong size on FLevelSequenceBindingReference");
...
static_assert(offsetof(FLevelSequenceBindingReference, ObjectPath) == 0x000010, "Member 'FLevelSequenceBindingReference::ObjectPath' has a wrong offset!");

// ScriptStruct LevelSequence.BoundActorProxy
// 0x124BC (0x124BC - 0x0000)
struct alignas(0x124BC) FBoundActorProxy final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBoundActorProxy) == 0x0124BC, "Wrong alignment on FBoundActorProxy");
static_assert(sizeof(FBoundActorProxy) == 0x0124BC, "Wrong size on FBoundActorProxy");
...
struct alignas(0x1F5FEC10) FLevelSequenceBindingReferences final
{
public:
...
static_assert(alignof(FLevelSequenceBindingReferences) == 0x1F5FEC10, "Wrong alignment on FLevelSequenceBindingReferences");
static_assert(sizeof(FLevelSequenceBindingReferences) == 0x1F5FEC10, "Wrong size on FLevelSequenceBindingReferences");
...
// 0x6A38 (0x6A38 - 0x0000)
struct alignas(0x6A38) FLevelSequenceObjectReferenceMap final
{
public:
	uint8                                         Pad_0[0x50];                                       // 0x0000(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLevelSequenceObjectReferenceMap) == 0x006A38, "Wrong alignment on FLevelSequenceObjectReferenceMap");
static_assert(sizeof(FLevelSequenceObjectReferenceMap) == 0x006A38, "Wrong size on FLevelSequenceObjectReferenceMap");

// ScriptStruct LevelSequence.LevelSequenceLegacyObjectReference
// 0x124BE (0x124BE - 0x0000)
struct alignas(0x124BE) FLevelSequenceLegacyObjectReference final
{
public:
	uint8                                         Pad_0[0x20];                                       // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLevelSequenceLegacyObjectReference) == 0x0124BE, "Wrong alignment on FLevelSequenceLegacyObjectReference");
static_assert(sizeof(FLevelSequenceLegacyObjectReference) == 0x0124BE, "Wrong size on FLevelSequenceLegacyObjectReference");

// ScriptStruct LevelSequence.LevelSequenceSnapshotSettings
// 0x115EE9C0 (0x115EE9C0 - 0x0000)
struct alignas(0x115EE9C0) FLevelSequenceSnapshotSettings final
{
public:
...
static_assert(alignof(FLevelSequenceSnapshotSettings) == 0x115EE9C0, "Wrong alignment on FLevelSequenceSnapshotSettings");
static_assert(sizeof(FLevelSequenceSnapshotSettings) == 0x115EE9C0, "Wrong size on FLevelSequenceSnapshotSettings");
...
public:
	...
	struct FLevelSequenceSnapshotSettings         Settings;                                          // 0x0048(0x115EE9C0)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FLevelSequencePlayerSnapshot) == 0x115EE9C0, "Wrong alignment on FLevelSequencePlayerSnapshot");
static_assert(sizeof(FLevelSequencePlayerSnapshot) == 0x115EE9C0, "Wrong size on FLevelSequencePlayerSnapshot");
