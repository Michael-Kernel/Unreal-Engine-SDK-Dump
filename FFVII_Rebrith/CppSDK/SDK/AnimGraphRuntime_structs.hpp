...
// 0x112E8CF0 (0x112E8D20 - 0x0030)
struct FAnimNode_LayeredBoneBlend final : public FAnimNode_Base
{
public:
	struct FPoseLink                              BasePose;                                          // 0x0030(0x112BD)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FGuid                                  SkeletonGuid;                                      // 0x0090(0x112E8D20)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGuid                                  VirtualBoneGuid;                                   // 0x00A0(0x112E8D20)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
};
static_assert(alignof(FAnimNode_LayeredBoneBlend) == 0x112E8D20, "Wrong alignment on FAnimNode_LayeredBoneBlend");
static_assert(sizeof(FAnimNode_LayeredBoneBlend) == 0x112E8D20, "Wrong size on FAnimNode_LayeredBoneBlend");
...
struct alignas(0x11498FB0) FAnimNode_SkeletalControlBase : public FAnimNode_Base
{
public:
	struct FComponentSpacePoseLink                ComponentPose;                                     // 0x0030(0x1129E)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
#pragma pack(pop)
static_assert(alignof(FAnimNode_SkeletalControlBase) == 0x11498FB0, "Wrong alignment on FAnimNode_SkeletalControlBase");
static_assert(sizeof(FAnimNode_SkeletalControlBase) == 0x11498FB0, "Wrong size on FAnimNode_SkeletalControlBase");
...
static_assert(alignof(FReferenceBoneFrame) == 0x000001, "Wrong alignment on FReferenceBoneFrame");
...
// 0x12AA70 (0x115C3A20 - 0x11498FB0)
...
public:
	...
	struct FAnimCurveParam                        Curve;                                             // 0x00E0(0x115C3A20)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAnimNode_TwistCorrectiveNode) == 0x115C3A20, "Wrong alignment on FAnimNode_TwistCorrectiveNode");
static_assert(sizeof(FAnimNode_TwistCorrectiveNode) == 0x115C3A20, "Wrong size on FAnimNode_TwistCorrectiveNode");
...
// 0x0000 (0x115AF870 - 0x115AF870)
#pragma pack(push, 0x1)
struct alignas(0x115AF870) FAnimNode_PoseHandler : public FAnimNode_AssetPlayerBase
{
public:
...
#pragma pack(pop)
static_assert(alignof(FAnimNode_PoseHandler) == 0x115AF870, "Wrong alignment on FAnimNode_PoseHandler");
static_assert(sizeof(FAnimNode_PoseHandler) == 0x115AF870, "Wrong size on FAnimNode_PoseHandler");
...
static_assert(alignof(FBlendBoneByChannelEntry) == 0x000001, "Wrong alignment on FBlendBoneByChannelEntry");
...
// 0x1226B (0x1226B - 0x0000)
struct alignas(0x1226B) FIKChainLink final
{
public:
	uint8                                         Pad_0[0x1C];                                       // 0x0000(0x001C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FIKChainLink) == 0x01226B, "Wrong alignment on FIKChainLink");
static_assert(sizeof(FIKChainLink) == 0x01226B, "Wrong size on FIKChainLink");
...
public:
	...
	struct FTransform                             PlaneTransform;                                    // 0x0020(0x112E9D50)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAnimPhysPlanarLimit) == 0x000001, "Wrong alignment on FAnimPhysPlanarLimit");
...
public:
	...
	struct FInputScaleBias                        AlphaScaleBias;                                    // 0x0054(0x11498FB0)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAnimNode_MultiWayBlend) == 0x11498FB0, "Wrong alignment on FAnimNode_MultiWayBlend");
static_assert(sizeof(FAnimNode_MultiWayBlend) == 0x11498FB0, "Wrong size on FAnimNode_MultiWayBlend");
...
static_assert(alignof(FAnimNode_AnimDynamics) == 0x11498FB0, "Wrong alignment on FAnimNode_AnimDynamics");
static_assert(sizeof(FAnimNode_AnimDynamics) == 0x11498FB0, "Wrong size on FAnimNode_AnimDynamics");
...
// 0x0000 (0x115AF870 - 0x115AF870)
#pragma pack(push, 0x1)
struct alignas(0x115AF870) FAnimNode_BlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
public:
...
#pragma pack(pop)
static_assert(alignof(FAnimNode_BlendSpacePlayer) == 0x115AF870, "Wrong alignment on FAnimNode_BlendSpacePlayer");
static_assert(sizeof(FAnimNode_BlendSpacePlayer) == 0x115AF870, "Wrong size on FAnimNode_BlendSpacePlayer");
...
{
public:
	struct FPoseLink                              BasePose;                                          // 0x0128(0x112BD)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FTransform                             SocketLocalTransform;                              // 0x0190(0x112E9D50)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FTransform                             PivotSocketLocalTransform;                         // 0x01E0(0x112E9D50)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAnimNode_AimOffsetLookAt) == 0x115AF870, "Wrong alignment on FAnimNode_AimOffsetLookAt");
static_assert(sizeof(FAnimNode_AimOffsetLookAt) == 0x115AF870, "Wrong size on FAnimNode_AimOffsetLookAt");
...
static_assert(offsetof(FAnimNode_AimOffsetLookAt, bIsLODEnabled) == 0x000144, "Member 'FAnimNode_AimOffsetLookAt::bIsLODEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, LookAtLocation) == 0x000148, "Member 'FAnimNode_AimOffsetLookAt::LookAtLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SourceSocketName) == 0x000158, "Member 'FAnimNode_AimOffsetLookAt::SourceSocketName' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, PivotSocketName) == 0x000160, "Member 'FAnimNode_AimOffsetLookAt::PivotSocketName' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SocketAxis) == 0x000168, "Member 'FAnimNode_AimOffsetLookAt::SocketAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, Alpha) == 0x000174, "Member 'FAnimNode_AimOffsetLookAt::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SocketBoneReference) == 0x000178, "Member 'FAnimNode_AimOffsetLookAt::SocketBoneReference' has a wrong offset!");
...
// 0x115C1B90 (0x115C1B90 - 0x0000)
struct alignas(0x115C1B90) FSplineIKCachedBoneData final
{
public:
...
static_assert(alignof(FSplineIKCachedBoneData) == 0x115C1B90, "Wrong alignment on FSplineIKCachedBoneData");
static_assert(sizeof(FSplineIKCachedBoneData) == 0x115C1B90, "Wrong size on FSplineIKCachedBoneData");
...
{
public:
	struct FPoseLink                              SourcePose;                                        // 0x00A0(0x112BD)(Edit, BlueprintVisible, EditFixedSize, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_PoseBlendNode) == 0x115AF870, "Wrong alignment on FAnimNode_PoseBlendNode");
static_assert(sizeof(FAnimNode_PoseBlendNode) == 0x115AF870, "Wrong size on FAnimNode_PoseBlendNode");
...
// 0x60CD (0x60CD - 0x0000)
struct alignas(0x60CD) FIKChain final
{
public:
	uint8                                         Pad_0[0x30];                                       // 0x0000(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FIKChain) == 0x0060CD, "Wrong alignment on FIKChain");
static_assert(sizeof(FIKChain) == 0x0060CD, "Wrong size on FIKChain");
...
{
public:
	struct FPoseLink                              InputPose;                                         // 0x0030(0x112BD)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FInputScaleBias                        AlphaScaleBias;                                    // 0x0098(0x11498FB0)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_ScaleChainLength) == 0x11498FB0, "Wrong alignment on FAnimNode_ScaleChainLength");
static_assert(sizeof(FAnimNode_ScaleChainLength) == 0x11498FB0, "Wrong size on FAnimNode_ScaleChainLength");
...
// 0x115BE170 (0x115BE170 - 0x0000)
struct alignas(0x115BE170) FRBFParams final
{
public:
...
static_assert(alignof(FRBFParams) == 0x115BE170, "Wrong alignment on FRBFParams");
static_assert(sizeof(FRBFParams) == 0x115BE170, "Wrong size on FRBFParams");
...
static_assert(alignof(FAnimNode_RefPose) == 0x000001, "Wrong alignment on FAnimNode_RefPose");
...
// 0x115B3560 (0x115B3590 - 0x0030)
struct alignas(0x115B3590) FAnimNode_ApplyAdditive final : public FAnimNode_Base
{
public:
	struct FPoseLink                              Base;                                              // 0x0030(0x112BD)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FPoseLink                              Additive;                                          // 0x0048(0x112BD)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FInputScaleBias                        AlphaScaleBias;                                    // 0x0064(0x11498FB0)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_ApplyAdditive) == 0x115B3590, "Wrong alignment on FAnimNode_ApplyAdditive");
static_assert(sizeof(FAnimNode_ApplyAdditive) == 0x115B3590, "Wrong size on FAnimNode_ApplyAdditive");
...
{
public:
	struct FPoseLink                              A;                                                 // 0x0030(0x112BD)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FPoseLink                              B;                                                 // 0x0048(0x112BD)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	float                                         Alpha;                                             // 0x0060(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FInputScaleBias                        AlphaScaleBias;                                    // 0x0064(0x11498FB0)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_BlendBoneByChannel) == 0x11498FB0, "Wrong alignment on FAnimNode_BlendBoneByChannel");
static_assert(sizeof(FAnimNode_BlendBoneByChannel) == 0x11498FB0, "Wrong size on FAnimNode_BlendBoneByChannel");
...
static_assert(alignof(FAnimNode_CurveSource) == 0x0112BD, "Wrong alignment on FAnimNode_CurveSource");
static_assert(sizeof(FAnimNode_CurveSource) == 0x0112BD, "Wrong size on FAnimNode_CurveSource");
...
static_assert(alignof(FAnimNode_BlendSpaceEvaluator) == 0x115AF870, "Wrong alignment on FAnimNode_BlendSpaceEvaluator");
static_assert(sizeof(FAnimNode_BlendSpaceEvaluator) == 0x115AF870, "Wrong size on FAnimNode_BlendSpaceEvaluator");
...
static_assert(alignof(FAnimNode_RotationMultiplier) == 0x11498FB0, "Wrong alignment on FAnimNode_RotationMultiplier");
static_assert(sizeof(FAnimNode_RotationMultiplier) == 0x11498FB0, "Wrong size on FAnimNode_RotationMultiplier");
...
static_assert(alignof(FAnimNode_BoneDrivenController) == 0x11498FB0, "Wrong alignment on FAnimNode_BoneDrivenController");
static_assert(sizeof(FAnimNode_BoneDrivenController) == 0x11498FB0, "Wrong size on FAnimNode_BoneDrivenController");
...
static_assert(alignof(FConstraint) == 0x000001, "Wrong alignment on FConstraint");
...
static_assert(alignof(FAnimNode_Constraint) == 0x11498FB0, "Wrong alignment on FAnimNode_Constraint");
static_assert(sizeof(FAnimNode_Constraint) == 0x11498FB0, "Wrong size on FAnimNode_Constraint");
...
static_assert(alignof(FAnimNode_SequenceEvaluator) == 0x115AF870, "Wrong alignment on FAnimNode_SequenceEvaluator");
static_assert(sizeof(FAnimNode_SequenceEvaluator) == 0x115AF870, "Wrong size on FAnimNode_SequenceEvaluator");
...
// 0x115C1520 (0x115C1550 - 0x0030)
struct alignas(0x115C1550) FAnimNode_Slot final : public FAnimNode_Base
{
public:
	struct FPoseLink                              Source;                                            // 0x0030(0x112BD)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_Slot) == 0x115C1550, "Wrong alignment on FAnimNode_Slot");
static_assert(sizeof(FAnimNode_Slot) == 0x115C1550, "Wrong size on FAnimNode_Slot");
...
static_assert(alignof(FAnimNode_CopyBone) == 0x11498FB0, "Wrong alignment on FAnimNode_CopyBone");
static_assert(sizeof(FAnimNode_CopyBone) == 0x11498FB0, "Wrong size on FAnimNode_CopyBone");
...
static_assert(alignof(FAnimNode_SpringBone) == 0x11498FB0, "Wrong alignment on FAnimNode_SpringBone");
static_assert(sizeof(FAnimNode_SpringBone) == 0x11498FB0, "Wrong size on FAnimNode_SpringBone");
...
// 0x11E3F0 (0x115B73A0 - 0x11498FB0)
struct alignas(0x115B73A0) FAnimNode_CopyBoneDelta final : public FAnimNode_SkeletalControlBase
{
public:
	struct FBoneReference                         SourceBone;                                        // 0x0070(0x0018)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FBoneReference                         TargetBone;                                        // 0x0088(0x0018)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_CopyBoneDelta) == 0x115B73A0, "Wrong alignment on FAnimNode_CopyBoneDelta");
static_assert(sizeof(FAnimNode_CopyBoneDelta) == 0x115B73A0, "Wrong size on FAnimNode_CopyBoneDelta");
...
{
public:
	struct FTransform                             EffectorTransform;                                 // 0x0070(0x112E9D50)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_Fabrik) == 0x11498FB0, "Wrong alignment on FAnimNode_Fabrik");
static_assert(sizeof(FAnimNode_Fabrik) == 0x11498FB0, "Wrong size on FAnimNode_Fabrik");
...
static_assert(offsetof(FAnimNode_Fabrik, EffectorRotationSource) == 0x0000C0, "Member 'FAnimNode_Fabrik::EffectorRotationSource' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, TipBone) == 0x0000C8, "Member 'FAnimNode_Fabrik::TipBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, RootBone) == 0x0000E0, "Member 'FAnimNode_Fabrik::RootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, Precision) == 0x0000F8, "Member 'FAnimNode_Fabrik::Precision' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, MaxIterations) == 0x0000FC, "Member 'FAnimNode_Fabrik::MaxIterations' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, bEnableDebugDraw) == 0x000100, "Member 'FAnimNode_Fabrik::bEnableDebugDraw' has a wrong offset!");

// ScriptStruct AnimGraphRuntime.AnimNode_HandIKRetargeting
// 0x11F5E0 (0x115B8590 - 0x11498FB0)
struct alignas(0x115B8590) FAnimNode_HandIKRetargeting final : public FAnimNode_SkeletalControlBase
{
public:
...
static_assert(alignof(FAnimNode_HandIKRetargeting) == 0x115B8590, "Wrong alignment on FAnimNode_HandIKRetargeting");
static_assert(sizeof(FAnimNode_HandIKRetargeting) == 0x115B8590, "Wrong size on FAnimNode_HandIKRetargeting");
...
static_assert(alignof(FAnimLegIKData) == 0x000001, "Wrong alignment on FAnimLegIKData");
...
static_assert(alignof(FAnimNode_LegIK) == 0x11498FB0, "Wrong alignment on FAnimNode_LegIK");
static_assert(sizeof(FAnimNode_LegIK) == 0x11498FB0, "Wrong size on FAnimNode_LegIK");
...
public:
	...
	struct FAlphaBlend                            BlendIn;                                           // 0x0020(0x115432E0)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRandomPlayerSequenceEntry) == 0x115432E0, "Wrong alignment on FRandomPlayerSequenceEntry");
static_assert(sizeof(FRandomPlayerSequenceEntry) == 0x115432E0, "Wrong size on FRandomPlayerSequenceEntry");
...
// 0x115BAE10 (0x115BAE10 - 0x0000)
struct alignas(0x115BAE10) FSocketReference final
{
public:
...
static_assert(alignof(FSocketReference) == 0x115BAE10, "Wrong alignment on FSocketReference");
static_assert(sizeof(FSocketReference) == 0x115BAE10, "Wrong size on FSocketReference");
...
public:
	...
	struct FSocketReference                       SocketReference;                                   // 0x0020(0x115BAE10)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FTargetReference) == 0x115BAE10, "Wrong alignment on FTargetReference");
static_assert(sizeof(FTargetReference) == 0x115BAE10, "Wrong size on FTargetReference");
static_assert(offsetof(FTargetReference, bUseSocket) == 0x000000, "Member 'FTargetReference::bUseSocket' has a wrong offset!");
static_assert(offsetof(FTargetReference, BoneReference) == 0x000008, "Member 'FTargetReference::BoneReference' has a wrong offset!");
static_assert(offsetof(FTargetReference, SocketReference) == 0x000020, "Member 'FTargetReference::SocketReference' has a wrong offset!");

// ScriptStruct AnimGraphRuntime.AnimNode_LookAt
// 0x1215C0 (0x115BA570 - 0x11498FB0)
struct alignas(0x115BA570) FAnimNode_LookAt final : public FAnimNode_SkeletalControlBase
{
public:
	struct FBoneReference                         BoneToModify;                                      // 0x0070(0x0018)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FTargetReference                       LookAtTarget;                                      // 0x00B0(0x115BAE10)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_LookAt) == 0x115BA570, "Wrong alignment on FAnimNode_LookAt");
static_assert(sizeof(FAnimNode_LookAt) == 0x115BA570, "Wrong size on FAnimNode_LookAt");
...
public:
	...
	struct FRotator                               MeshToComponent;                                   // 0x0050(0x112E9AF0)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAnimNode_RotateRootBone) == 0x112E9AF0, "Wrong alignment on FAnimNode_RotateRootBone");
static_assert(sizeof(FAnimNode_RotateRootBone) == 0x112E9AF0, "Wrong size on FAnimNode_RotateRootBone");
...
public:
	...
	struct FRotator                               TargetRotation;                                    // 0x000C(0x112E9AF0)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPoseDriverTransform) == 0x112E9AF0, "Wrong alignment on FPoseDriverTransform");
static_assert(sizeof(FPoseDriverTransform) == 0x112E9AF0, "Wrong size on FPoseDriverTransform");
...
// 0x115BD770 (0x115BD770 - 0x0000)
struct alignas(0x115BD770) FPoseDriverTarget final
{
public:
	TArray<struct FPoseDriverTransform>           BoneTransforms;                                    // 0x0000(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FRotator                               TargetRotation;                                    // 0x0010(0x112E9AF0)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FRichCurve                             CustomCurve;                                       // 0x0028(0x11102)(Edit, NativeAccessSpecifierPublic)
...
static_assert(alignof(FPoseDriverTarget) == 0x115BD770, "Wrong alignment on FPoseDriverTarget");
static_assert(sizeof(FPoseDriverTarget) == 0x115BD770, "Wrong size on FPoseDriverTarget");
...
static_assert(alignof(FAnimNode_MakeDynamicAdditive) == 0x0112BD, "Wrong alignment on FAnimNode_MakeDynamicAdditive");
static_assert(sizeof(FAnimNode_MakeDynamicAdditive) == 0x0112BD, "Wrong size on FAnimNode_MakeDynamicAdditive");
...
public:
	...
	struct FRotator                               Rotation;                                          // 0x0094(0x112E9AF0)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_ModifyBone) == 0x11498FB0, "Wrong alignment on FAnimNode_ModifyBone");
static_assert(sizeof(FAnimNode_ModifyBone) == 0x11498FB0, "Wrong size on FAnimNode_ModifyBone");
...
// 0x115BBD00 (0x115BBD30 - 0x0030)
struct alignas(0x115BBD30) FAnimNode_ModifyCurve final : public FAnimNode_Base
{
public:
	struct FPoseLink                              SourcePose;                                        // 0x0030(0x112BD)(Edit, BlueprintVisible, EditFixedSize, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_ModifyCurve) == 0x115BBD30, "Wrong alignment on FAnimNode_ModifyCurve");
static_assert(sizeof(FAnimNode_ModifyCurve) == 0x115BBD30, "Wrong size on FAnimNode_ModifyCurve");
...
public:
	...
	struct FAlphaBlend                            TwistBlend;                                        // 0x00C8(0x115432E0)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FSplineCurves                          BoneSpline;                                        // 0x0178(0x112EDAF0)(NativeAccessSpecifierPrivate)
...
static_assert(alignof(FAnimNode_SplineIK) == 0x115432E0, "Wrong alignment on FAnimNode_SplineIK");
static_assert(sizeof(FAnimNode_SplineIK) == 0x115432E0, "Wrong size on FAnimNode_SplineIK");
...
public:
	...
	struct FRotator                               Rotation;                                          // 0x0098(0x112E9AF0)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                Scale;                                             // 0x00A4(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAnimNode_ObserveBone) == 0x11498FB0, "Wrong alignment on FAnimNode_ObserveBone");
static_assert(sizeof(FAnimNode_ObserveBone) == 0x11498FB0, "Wrong size on FAnimNode_ObserveBone");
...
// 0xD830 (0x115BD0A0 - 0x115AF870)
struct alignas(0x115BD0A0) FAnimNode_PoseByName final : public FAnimNode_PoseHandler
{
public:
...
static_assert(alignof(FAnimNode_PoseByName) == 0x115BD0A0, "Wrong alignment on FAnimNode_PoseByName");
static_assert(sizeof(FAnimNode_PoseByName) == 0x115BD0A0, "Wrong size on FAnimNode_PoseByName");
...
public:
	...
	struct FRBFParams                             RBFParams;                                         // 0x00F8(0x115BE170)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_PoseDriver) == 0x115BE170, "Wrong alignment on FAnimNode_PoseDriver");
static_assert(sizeof(FAnimNode_PoseDriver) == 0x115BE170, "Wrong size on FAnimNode_PoseDriver");
...
static_assert(alignof(FAnimNode_PoseSnapshot) == 0x000004, "Wrong alignment on FAnimNode_PoseSnapshot");
...
// 0x12277 (0x122A7 - 0x0030)
struct alignas(0x122A7) FAnimNode_MeshSpaceRefPose final : public FAnimNode_Base
{
};
static_assert(alignof(FAnimNode_MeshSpaceRefPose) == 0x0122A7, "Wrong alignment on FAnimNode_MeshSpaceRefPose");
static_assert(sizeof(FAnimNode_MeshSpaceRefPose) == 0x0122A7, "Wrong size on FAnimNode_MeshSpaceRefPose");
...
{
public:
	struct FPoseLink                              Result;                                            // 0x0030(0x112BD)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAnimNode_Root) == 0x0112BD, "Wrong alignment on FAnimNode_Root");
static_assert(sizeof(FAnimNode_Root) == 0x0112BD, "Wrong size on FAnimNode_Root");
static_assert(offsetof(FAnimNode_Root, Result) == 0x000030, "Member 'FAnimNode_Root::Result' has a wrong offset!");

// ScriptStruct AnimGraphRuntime.AnimNode_RotationOffsetBlendSpace
// 0x10C50 (0x115C04C0 - 0x115AF870)
struct alignas(0x115C04C0) FAnimNode_RotationOffsetBlendSpace final : public FAnimNode_BlendSpacePlayer
{
public:
	struct FPoseLink                              BasePose;                                          // 0x0128(0x112BD)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         LODThreshold;                                      // 0x0140(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FInputScaleBias                        AlphaScaleBias;                                    // 0x014C(0x11498FB0)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_RotationOffsetBlendSpace) == 0x115C04C0, "Wrong alignment on FAnimNode_RotationOffsetBlendSpace");
static_assert(sizeof(FAnimNode_RotationOffsetBlendSpace) == 0x115C04C0, "Wrong size on FAnimNode_RotationOffsetBlendSpace");
...
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, LODThreshold) == 0x000140, "Member 'FAnimNode_RotationOffsetBlendSpace::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, bIsLODEnabled) == 0x000144, "Member 'FAnimNode_RotationOffsetBlendSpace::bIsLODEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, Alpha) == 0x000148, "Member 'FAnimNode_RotationOffsetBlendSpace::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBias) == 0x00014C, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, ActualAlpha) == 0x000154, "Member 'FAnimNode_RotationOffsetBlendSpace::ActualAlpha' has a wrong offset!");
...
public:
	...
	struct FRuntimeFloatCurve                     TrailRelaxationSpeed;                              // 0x0098(0x11102)(Edit, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_Trail) == 0x11498FB0, "Wrong alignment on FAnimNode_Trail");
static_assert(sizeof(FAnimNode_Trail) == 0x11498FB0, "Wrong size on FAnimNode_Trail");
...
static_assert(alignof(FAnimNode_TwoBoneIK) == 0x11498FB0, "Wrong alignment on FAnimNode_TwoBoneIK");
static_assert(sizeof(FAnimNode_TwoBoneIK) == 0x11498FB0, "Wrong size on FAnimNode_TwoBoneIK");
static_assert(offsetof(FAnimNode_TwoBoneIK, IKBone) == 0x000070, "Member 'FAnimNode_TwoBoneIK::IKBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorLocation) == 0x000088, "Member 'FAnimNode_TwoBoneIK::EffectorLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetLocation) == 0x000094, "Member 'FAnimNode_TwoBoneIK::JointTargetLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorSpaceBoneName) == 0x0000A0, "Member 'FAnimNode_TwoBoneIK::EffectorSpaceBoneName' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, StretchLimits) == 0x0000AC, "Member 'FAnimNode_TwoBoneIK::StretchLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, StartStretchRatio) == 0x0000B4, "Member 'FAnimNode_TwoBoneIK::StartStretchRatio' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, MaxStretchScale) == 0x0000B8, "Member 'FAnimNode_TwoBoneIK::MaxStretchScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorLocationSpace) == 0x0000BC, "Member 'FAnimNode_TwoBoneIK::EffectorLocationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetLocationSpace) == 0x0000BD, "Member 'FAnimNode_TwoBoneIK::JointTargetLocationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetSpaceBoneName) == 0x0000C0, "Member 'FAnimNode_TwoBoneIK::JointTargetSpaceBoneName' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, bAllowTwist) == 0x0000C8, "Member 'FAnimNode_TwoBoneIK::bAllowTwist' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, TwistAxis) == 0x0000CC, "Member 'FAnimNode_TwoBoneIK::TwistAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, bNoTwist) == 0x0000DC, "Member 'FAnimNode_TwoBoneIK::bNoTwist' has a wrong offset!");
...
static_assert(alignof(FAnimNode_TwoWayBlend) == 0x11498FB0, "Wrong alignment on FAnimNode_TwoWayBlend");
static_assert(sizeof(FAnimNode_TwoWayBlend) == 0x11498FB0, "Wrong size on FAnimNode_TwoWayBlend");
...
// 0x5C68 (0x6140 - 0x04D8)
struct alignas(0x6140) FAnimSequencerInstanceProxy final : public FAnimInstanceProxy
{
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x006140, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x006140, "Wrong size on FAnimSequencerInstanceProxy");
...
public:
	...
	struct FRichCurve                             CustomCurve;                                       // 0x0018(0x11102)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRBFTarget) == 0x011102, "Wrong alignment on FRBFTarget");
static_assert(sizeof(FRBFTarget) == 0x011102, "Wrong size on FRBFTarget");
