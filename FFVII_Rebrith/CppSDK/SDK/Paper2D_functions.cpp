...
class UMaterialInterface* UPaperFlipbookComponent::GetSpriteMaterial() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PaperFlipbookComponent", "GetSpriteMaterial");

	Params::PaperFlipbookComponent_GetSpriteMaterial Parms{};
