...
static_assert(sizeof(UMovieSceneMediaTrack) == 0x000070, "Wrong size on UMovieSceneMediaTrack");
static_assert(offsetof(UMovieSceneMediaTrack, MediaSections) == 0x000060, "Member 'UMovieSceneMediaTrack::MediaSections' has a wrong offset!");
