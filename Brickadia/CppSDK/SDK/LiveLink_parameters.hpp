...
static_assert(alignof(LiveLinkBlueprintLibrary_GetLiveLinkSubjectState) == 0x000004, "Wrong alignment on LiveLinkBlueprintLibrary_GetLiveLinkSubjectState");
static_assert(sizeof(LiveLinkBlueprintLibrary_GetLiveLinkSubjectState) == 0x00000C, "Wrong size on LiveLinkBlueprintLibrary_GetLiveLinkSubjectState");
static_assert(offsetof(LiveLinkBlueprintLibrary_GetLiveLinkSubjectState, SubjectName) == 0x000000, "Member 'LiveLinkBlueprintLibrary_GetLiveLinkSubjectState::SubjectName' has a wrong offset!");
static_assert(offsetof(LiveLinkBlueprintLibrary_GetLiveLinkSubjectState, ReturnValue) == 0x000008, "Member 'LiveLinkBlueprintLibrary_GetLiveLinkSubjectState::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(LiveLinkBlueprintLibrary_GetSourceTypeFromGuid, SourceGuid) == 0x000000, "Member 'LiveLinkBlueprintLibrary_GetSourceTypeFromGuid::SourceGuid' has a wrong offset!");
static_assert(offsetof(LiveLinkBlueprintLibrary_GetSourceTypeFromGuid, ReturnValue) == 0x000010, "Member 'LiveLinkBlueprintLibrary_GetSourceTypeFromGuid::ReturnValue' has a wrong offset!");
...
public:
	class FName                                   SubjectName;                                       // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTimecode                              SceneTime;                                         // 0x0008(0x0018)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(LiveLinkComponent_GetSubjectDataAtSceneTime) == 0x000040, "Wrong size on LiveLinkComponent_GetSubjectDataAtSceneTime");
...
static_assert(offsetof(LiveLinkComponent_GetSubjectDataAtSceneTime, bSuccess) == 0x000020, "Member 'LiveLinkComponent_GetSubjectDataAtSceneTime::bSuccess' has a wrong offset!");
static_assert(offsetof(LiveLinkComponent_GetSubjectDataAtSceneTime, SubjectFrameHandle) == 0x000028, "Member 'LiveLinkComponent_GetSubjectDataAtSceneTime::SubjectFrameHandle' has a wrong offset!");
...
static_assert(offsetof(LiveLinkMessageBusFinder_ConnectToProvider, SourceHandle) == 0x000090, "Member 'LiveLinkMessageBusFinder_ConnectToProvider::SourceHandle' has a wrong offset!");
...
static_assert(offsetof(LiveLinkPreset_ApplyToClientLatent, WorldContextObject) == 0x000000, "Member 'LiveLinkPreset_ApplyToClientLatent::WorldContextObject' has a wrong offset!");
static_assert(offsetof(LiveLinkPreset_ApplyToClientLatent, LatentInfo) == 0x000008, "Member 'LiveLinkPreset_ApplyToClientLatent::LatentInfo' has a wrong offset!");
