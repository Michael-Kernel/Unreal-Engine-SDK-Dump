...
static_assert(sizeof(AchievementBlueprintLibrary_GetCachedAchievementDescription) == 0x000058, "Wrong size on AchievementBlueprintLibrary_GetCachedAchievementDescription");
...
static_assert(offsetof(AchievementBlueprintLibrary_GetCachedAchievementDescription, LockedDescription) == 0x000030, "Member 'AchievementBlueprintLibrary_GetCachedAchievementDescription::LockedDescription' has a wrong offset!");
static_assert(offsetof(AchievementBlueprintLibrary_GetCachedAchievementDescription, UnlockedDescription) == 0x000040, "Member 'AchievementBlueprintLibrary_GetCachedAchievementDescription::UnlockedDescription' has a wrong offset!");
static_assert(offsetof(AchievementBlueprintLibrary_GetCachedAchievementDescription, bHidden) == 0x000050, "Member 'AchievementBlueprintLibrary_GetCachedAchievementDescription::bHidden' has a wrong offset!");
...
static_assert(alignof(AchievementWriteCallbackProxy_WriteProgress) == 0x000008, "Wrong alignment on AchievementWriteCallbackProxy_WriteProgress");
...
static_assert(offsetof(AchievementWriteCallbackProxy_WriteProgress, WorldContextObject) == 0x000000, "Member 'AchievementWriteCallbackProxy_WriteProgress::WorldContextObject' has a wrong offset!");
static_assert(offsetof(AchievementWriteCallbackProxy_WriteProgress, PlayerController) == 0x000008, "Member 'AchievementWriteCallbackProxy_WriteProgress::PlayerController' has a wrong offset!");
static_assert(offsetof(AchievementWriteCallbackProxy_WriteProgress, AchievementName) == 0x000010, "Member 'AchievementWriteCallbackProxy_WriteProgress::AchievementName' has a wrong offset!");
static_assert(offsetof(AchievementWriteCallbackProxy_WriteProgress, Progress) == 0x000020, "Member 'AchievementWriteCallbackProxy_WriteProgress::Progress' has a wrong offset!");
static_assert(offsetof(AchievementWriteCallbackProxy_WriteProgress, UserTag) == 0x000024, "Member 'AchievementWriteCallbackProxy_WriteProgress::UserTag' has a wrong offset!");
static_assert(offsetof(AchievementWriteCallbackProxy_WriteProgress, ReturnValue) == 0x000028, "Member 'AchievementWriteCallbackProxy_WriteProgress::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(CreateSessionCallbackProxy_CreateSession, bUseLobbiesIfAvailable) == 0x000015, "Member 'CreateSessionCallbackProxy_CreateSession::bUseLobbiesIfAvailable' has a wrong offset!");
...
static_assert(offsetof(FindSessionsCallbackProxy_FindSessions, bUseLobbies) == 0x000015, "Member 'FindSessionsCallbackProxy_FindSessions::bUseLobbies' has a wrong offset!");
...
static_assert(offsetof(LeaderboardQueryCallbackProxy_CreateProxyObjectForIntQuery, ReturnValue) == 0x000018, "Member 'LeaderboardQueryCallbackProxy_CreateProxyObjectForIntQuery::ReturnValue' has a wrong offset!");
