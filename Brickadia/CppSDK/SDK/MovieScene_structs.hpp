...
static_assert(offsetof(FMovieSceneTimeWarpClamp, Max) == 0x000000, "Member 'FMovieSceneTimeWarpClamp::Max' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneTimeWarpClampFloat, Max) == 0x000000, "Member 'FMovieSceneTimeWarpClampFloat::Max' has a wrong offset!");
