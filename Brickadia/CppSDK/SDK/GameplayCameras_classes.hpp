...
static_assert(sizeof(UControllerGameplayCameraEvaluationComponent) == 0x0000D0, "Wrong size on UControllerGameplayCameraEvaluationComponent");
static_assert(offsetof(UControllerGameplayCameraEvaluationComponent, CameraSystemHost) == 0x0000C8, "Member 'UControllerGameplayCameraEvaluationComponent::CameraSystemHost' has a wrong offset!");
...
static_assert(sizeof(AGameplayCameraActor) == 0x0002B8, "Wrong size on AGameplayCameraActor");
static_assert(offsetof(AGameplayCameraActor, CameraComponent) == 0x0002B0, "Member 'AGameplayCameraActor::CameraComponent' has a wrong offset!");
...
static_assert(sizeof(AGameplayCameraSystemActor) == 0x0002B8, "Wrong size on AGameplayCameraSystemActor");
static_assert(offsetof(AGameplayCameraSystemActor, CameraSystemComponent) == 0x0002B0, "Member 'AGameplayCameraSystemActor::CameraSystemComponent' has a wrong offset!");
...
public:
	TArray<class UInputAction*>                   AxisActions;                                       // 0x00A8(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	float                                         AxisActionAngularSpeedThreshold;                   // 0x00B8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AxisActionMagnitudeThreshold;                      // 0x00BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAutoReceiveInput                             AutoActivateForPlayer;                             // 0x00C0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C1[0x7];                                       // 0x00C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class APlayerController*                      PlayerController;                                  // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UGameplayCameraSystemHost*              CameraSystemHost;                                  // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGameplayControlRotationComponent) == 0x0000E8, "Wrong size on UGameplayControlRotationComponent");
static_assert(offsetof(UGameplayControlRotationComponent, AxisActions) == 0x0000A8, "Member 'UGameplayControlRotationComponent::AxisActions' has a wrong offset!");
static_assert(offsetof(UGameplayControlRotationComponent, AxisActionAngularSpeedThreshold) == 0x0000B8, "Member 'UGameplayControlRotationComponent::AxisActionAngularSpeedThreshold' has a wrong offset!");
static_assert(offsetof(UGameplayControlRotationComponent, AxisActionMagnitudeThreshold) == 0x0000BC, "Member 'UGameplayControlRotationComponent::AxisActionMagnitudeThreshold' has a wrong offset!");
static_assert(offsetof(UGameplayControlRotationComponent, AutoActivateForPlayer) == 0x0000C0, "Member 'UGameplayControlRotationComponent::AutoActivateForPlayer' has a wrong offset!");
static_assert(offsetof(UGameplayControlRotationComponent, PlayerController) == 0x0000C8, "Member 'UGameplayControlRotationComponent::PlayerController' has a wrong offset!");
static_assert(offsetof(UGameplayControlRotationComponent, CameraSystemHost) == 0x0000D0, "Member 'UGameplayControlRotationComponent::CameraSystemHost' has a wrong offset!");
