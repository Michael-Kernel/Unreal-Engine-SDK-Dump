...
static_assert(offsetof(UAISenseConfig_Touch, DetectionByAffiliation) == 0x000048, "Member 'UAISenseConfig_Touch::DetectionByAffiliation' has a wrong offset!");
...
static_assert(sizeof(UBlackboardKeyType_Struct) == 0x000050, "Wrong size on UBlackboardKeyType_Struct");
static_assert(offsetof(UBlackboardKeyType_Struct, DefaultValue) == 0x000030, "Member 'UBlackboardKeyType_Struct::DefaultValue' has a wrong offset!");
static_assert(offsetof(UBlackboardKeyType_Struct, Value) == 0x000040, "Member 'UBlackboardKeyType_Struct::Value' has a wrong offset!");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"GeneratedNavLinksProxy">();
	}
...
static_assert(alignof(UGeneratedNavLinksProxy) == 0x000008, "Wrong alignment on UGeneratedNavLinksProxy");
static_assert(sizeof(UGeneratedNavLinksProxy) == 0x000050, "Wrong size on UGeneratedNavLinksProxy");
static_assert(offsetof(UGeneratedNavLinksProxy, OnSmartLinkReached) == 0x000040, "Member 'UGeneratedNavLinksProxy::OnSmartLinkReached' has a wrong offset!");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"ValueOrBBKeyBlueprintUtility">();
	}
...
static_assert(alignof(UValueOrBBKeyBlueprintUtility) == 0x000008, "Wrong alignment on UValueOrBBKeyBlueprintUtility");
static_assert(sizeof(UValueOrBBKeyBlueprintUtility) == 0x000028, "Wrong size on UValueOrBBKeyBlueprintUtility");
...
{
public:
	class APawn*                                  ControlledPawn;                                    // 0x00A8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FPawnActionStack>               ActionStacks;                                      // 0x00B0(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FPawnActionEvent>               ActionEvents;                                      // 0x00C0(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	class UPawnAction*                            CurrentAction;                                     // 0x00D0(0x0008)(ZeroConstructor, Transient, Deprecated, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UPawnActionsComponent) == 0x0000E0, "Wrong size on UPawnActionsComponent");
static_assert(offsetof(UPawnActionsComponent, ControlledPawn) == 0x0000A8, "Member 'UPawnActionsComponent::ControlledPawn' has a wrong offset!");
static_assert(offsetof(UPawnActionsComponent, ActionStacks) == 0x0000B0, "Member 'UPawnActionsComponent::ActionStacks' has a wrong offset!");
static_assert(offsetof(UPawnActionsComponent, ActionEvents) == 0x0000C0, "Member 'UPawnActionsComponent::ActionEvents' has a wrong offset!");
static_assert(offsetof(UPawnActionsComponent, CurrentAction) == 0x0000D0, "Member 'UPawnActionsComponent::CurrentAction' has a wrong offset!");
...
static_assert(sizeof(AAIController) == 0x0003E8, "Wrong size on AAIController");
static_assert(offsetof(AAIController, PathFollowingComponent) == 0x000398, "Member 'AAIController::PathFollowingComponent' has a wrong offset!");
static_assert(offsetof(AAIController, BrainComponent) == 0x0003A0, "Member 'AAIController::BrainComponent' has a wrong offset!");
static_assert(offsetof(AAIController, PerceptionComponent) == 0x0003A8, "Member 'AAIController::PerceptionComponent' has a wrong offset!");
static_assert(offsetof(AAIController, ActionsComp) == 0x0003B0, "Member 'AAIController::ActionsComp' has a wrong offset!");
static_assert(offsetof(AAIController, Blackboard) == 0x0003B8, "Member 'AAIController::Blackboard' has a wrong offset!");
static_assert(offsetof(AAIController, CachedGameplayTasksComponent) == 0x0003C0, "Member 'AAIController::CachedGameplayTasksComponent' has a wrong offset!");
static_assert(offsetof(AAIController, DefaultNavigationFilterClass) == 0x0003C8, "Member 'AAIController::DefaultNavigationFilterClass' has a wrong offset!");
static_assert(offsetof(AAIController, ReceiveMoveCompleted) == 0x0003D0, "Member 'AAIController::ReceiveMoveCompleted' has a wrong offset!");
...
static_assert(sizeof(UBTTask_FinishWithResult) == 0x000098, "Wrong size on UBTTask_FinishWithResult");
...
{
public:
	uint8                                         bAutoRegisterAsSource : 1;                         // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, Config, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class UAISense>>           RegisterAsSourceForSenses;                         // 0x00B0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAIPerceptionStimuliSourceComponent) == 0x0000C0, "Wrong size on UAIPerceptionStimuliSourceComponent");
static_assert(offsetof(UAIPerceptionStimuliSourceComponent, RegisterAsSourceForSenses) == 0x0000B0, "Member 'UAIPerceptionStimuliSourceComponent::RegisterAsSourceForSenses' has a wrong offset!");
...
public:
	...
	struct FValueOrBBKey_Class                    FilterClass;                                       // 0x00A8(0x0020)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UBTTask_MoveTo, FilterClass) == 0x0000A8, "Member 'UBTTask_MoveTo::FilterClass' has a wrong offset!");
static_assert(offsetof(UBTTask_MoveTo, ObservedBlackboardValueTolerance) == 0x0000C8, "Member 'UBTTask_MoveTo::ObservedBlackboardValueTolerance' has a wrong offset!");
static_assert(offsetof(UBTTask_MoveTo, bAllowStrafe) == 0x0000D8, "Member 'UBTTask_MoveTo::bAllowStrafe' has a wrong offset!");
static_assert(offsetof(UBTTask_MoveTo, bAllowPartialPath) == 0x0000E8, "Member 'UBTTask_MoveTo::bAllowPartialPath' has a wrong offset!");
static_assert(offsetof(UBTTask_MoveTo, bTrackMovingGoal) == 0x0000F8, "Member 'UBTTask_MoveTo::bTrackMovingGoal' has a wrong offset!");
static_assert(offsetof(UBTTask_MoveTo, bRequireNavigableEndLocation) == 0x000108, "Member 'UBTTask_MoveTo::bRequireNavigableEndLocation' has a wrong offset!");
static_assert(offsetof(UBTTask_MoveTo, bProjectGoalLocation) == 0x000118, "Member 'UBTTask_MoveTo::bProjectGoalLocation' has a wrong offset!");
static_assert(offsetof(UBTTask_MoveTo, bReachTestIncludesAgentRadius) == 0x000128, "Member 'UBTTask_MoveTo::bReachTestIncludesAgentRadius' has a wrong offset!");
static_assert(offsetof(UBTTask_MoveTo, bReachTestIncludesGoalRadius) == 0x000138, "Member 'UBTTask_MoveTo::bReachTestIncludesGoalRadius' has a wrong offset!");
static_assert(offsetof(UBTTask_MoveTo, bStartFromPreviousPath) == 0x000148, "Member 'UBTTask_MoveTo::bStartFromPreviousPath' has a wrong offset!");
...
public:
	...
	class UBlackboardComponent*                   BlackboardComp;                                    // 0x00B0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class AAIController*                          AIOwner;                                           // 0x00B8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBrainComponent) == 0x000100, "Wrong size on UBrainComponent");
static_assert(offsetof(UBrainComponent, BlackboardComp) == 0x0000B0, "Member 'UBrainComponent::BlackboardComp' has a wrong offset!");
static_assert(offsetof(UBrainComponent, AIOwner) == 0x0000B8, "Member 'UBrainComponent::AIOwner' has a wrong offset!");
...
public:
	...
	TArray<class UBTNode*>                        NodeInstances;                                     // 0x0120(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_130[0x148];                                    // 0x0130(0x0148)(Fixing Size After Last Property [ Dumper-7 ])
	class UBehaviorTree*                          DefaultBehaviorTreeAsset;                          // 0x0278(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UBehaviorTreeComponent, NodeInstances) == 0x000120, "Member 'UBehaviorTreeComponent::NodeInstances' has a wrong offset!");
...
{
public:
	TArray<class UAISenseConfig*>                 SensesConfig;                                      // 0x00A8(0x0010)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TSubclassOf<class UAISense>                   DominantSense;                                     // 0x00B8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TMulticastInlineDelegate<void(const TArray<class AActor*>& UpdatedActors)> OnPerceptionUpdated;                               // 0x0158(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class AActor* Actor)> OnTargetPerceptionForgotten;                       // 0x0168(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class AActor* Actor, const struct FAIStimulus& Stimulus)> OnTargetPerceptionUpdated;                         // 0x0178(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FActorPerceptionUpdateInfo& UpdateInfo)> OnTargetPerceptionInfoUpdated;                     // 0x0188(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAIPerceptionComponent, SensesConfig) == 0x0000A8, "Member 'UAIPerceptionComponent::SensesConfig' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, DominantSense) == 0x0000B8, "Member 'UAIPerceptionComponent::DominantSense' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, AIOwner) == 0x0000D0, "Member 'UAIPerceptionComponent::AIOwner' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OnPerceptionUpdated) == 0x000158, "Member 'UAIPerceptionComponent::OnPerceptionUpdated' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OnTargetPerceptionForgotten) == 0x000168, "Member 'UAIPerceptionComponent::OnTargetPerceptionForgotten' has a wrong offset!");
...
{
public:
	class UBrainComponent*                        BrainComp;                                         // 0x00A8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UBlackboardData*                        DefaultBlackboardAsset;                            // 0x00B0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UBlackboardData*                        BlackboardAsset;                                   // 0x00B8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_C0[0x20];                                      // 0x00C0(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UBlackboardKeyType*>             KeyInstances;                                      // 0x00E0(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UBlackboardComponent, BrainComp) == 0x0000A8, "Member 'UBlackboardComponent::BrainComp' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, DefaultBlackboardAsset) == 0x0000B0, "Member 'UBlackboardComponent::DefaultBlackboardAsset' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, BlackboardAsset) == 0x0000B8, "Member 'UBlackboardComponent::BlackboardAsset' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, KeyInstances) == 0x0000E0, "Member 'UBlackboardComponent::KeyInstances' has a wrong offset!");
...
static_assert(offsetof(UBlackboardKeyType_Bool, bDefaultValue) == 0x000030, "Member 'UBlackboardKeyType_Bool::bDefaultValue' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UObject>                    DefaultValue;                                      // 0x0038(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UBlackboardKeyType_Class, DefaultValue) == 0x000038, "Member 'UBlackboardKeyType_Class::DefaultValue' has a wrong offset!");
...
static_assert(offsetof(UBlackboardKeyType_Enum, DefaultValue) == 0x000048, "Member 'UBlackboardKeyType_Enum::DefaultValue' has a wrong offset!");
...
public:
	TSubclassOf<class UObject>                    BaseClass;                                         // 0x0030(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoClear, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UObject*                                DefaultValue;                                      // 0x0038(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UBlackboardKeyType_Object, DefaultValue) == 0x000038, "Member 'UBlackboardKeyType_Object::DefaultValue' has a wrong offset!");
...
static_assert(sizeof(UAISense_Touch) == 0x0000D8, "Wrong size on UAISense_Touch");
...
static_assert(sizeof(UBlackboardKeyType_Rotator) == 0x000050, "Wrong size on UBlackboardKeyType_Rotator");
...
static_assert(offsetof(UBlackboardKeyType_Rotator, bUseDefaultValue) == 0x000048, "Member 'UBlackboardKeyType_Rotator::bUseDefaultValue' has a wrong offset!");
...
static_assert(sizeof(UBlackboardKeyType_Vector) == 0x000050, "Wrong size on UBlackboardKeyType_Vector");
...
static_assert(offsetof(UBlackboardKeyType_Vector, bUseDefaultValue) == 0x000048, "Member 'UBlackboardKeyType_Vector::bUseDefaultValue' has a wrong offset!");
...
{
public:
	float                                         HearingThreshold;                                  // 0x00A8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LOSHearingThreshold;                               // 0x00AC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SightRadius;                                       // 0x00B0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SensingInterval;                                   // 0x00B4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HearingMaxSoundAge;                                // 0x00B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bEnableSensingUpdates : 1;                         // 0x00BC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOnlySensePlayers : 1;                             // 0x00BC(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSeePawns : 1;                                     // 0x00BC(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHearNoises : 1;                                   // 0x00BC(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_BD[0xB];                                       // 0x00BD(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(class APawn* Pawn)> OnSeePawn;                                         // 0x00C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class APawn* Instigator, const struct FVector& Location, float Volume)> OnHearNoise;                                       // 0x00D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	float                                         PeripheralVisionAngle;                             // 0x00E8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         PeripheralVisionCosine;                            // 0x00EC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UPawnSensingComponent) == 0x0000F0, "Wrong size on UPawnSensingComponent");
static_assert(offsetof(UPawnSensingComponent, HearingThreshold) == 0x0000A8, "Member 'UPawnSensingComponent::HearingThreshold' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, LOSHearingThreshold) == 0x0000AC, "Member 'UPawnSensingComponent::LOSHearingThreshold' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, SightRadius) == 0x0000B0, "Member 'UPawnSensingComponent::SightRadius' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, SensingInterval) == 0x0000B4, "Member 'UPawnSensingComponent::SensingInterval' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, HearingMaxSoundAge) == 0x0000B8, "Member 'UPawnSensingComponent::HearingMaxSoundAge' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, OnSeePawn) == 0x0000C8, "Member 'UPawnSensingComponent::OnSeePawn' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, OnHearNoise) == 0x0000D8, "Member 'UPawnSensingComponent::OnHearNoise' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, PeripheralVisionAngle) == 0x0000E8, "Member 'UPawnSensingComponent::PeripheralVisionAngle' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, PeripheralVisionCosine) == 0x0000EC, "Member 'UPawnSensingComponent::PeripheralVisionCosine' has a wrong offset!");
...
static_assert(offsetof(UBTDecorator_ConeCheck, ConeDirection) == 0x0000A0, "Member 'UBTDecorator_ConeCheck::ConeDirection' has a wrong offset!");
static_assert(offsetof(UBTDecorator_ConeCheck, Observed) == 0x0000C8, "Member 'UBTDecorator_ConeCheck::Observed' has a wrong offset!");
...
public:
	...
	struct FValueOrBBKey_Class                    FilterClass;                                       // 0x00E8(0x0020)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBTDecorator_DoesPathExist) == 0x000108, "Wrong size on UBTDecorator_DoesPathExist");
...
static_assert(offsetof(UBTDecorator_DoesPathExist, PathQueryType) == 0x0000C0, "Member 'UBTDecorator_DoesPathExist::PathQueryType' has a wrong offset!");
static_assert(offsetof(UBTDecorator_DoesPathExist, FilterClass) == 0x0000E8, "Member 'UBTDecorator_DoesPathExist::FilterClass' has a wrong offset!");
...
static_assert(sizeof(UBTDecorator_IsAtLocation) == 0x0000F8, "Wrong size on UBTDecorator_IsAtLocation");
...
static_assert(offsetof(UBTDecorator_IsAtLocation, bUseNavAgentGoalLocation) == 0x0000D8, "Member 'UBTDecorator_IsAtLocation::bUseNavAgentGoalLocation' has a wrong offset!");
static_assert(offsetof(UBTDecorator_IsAtLocation, bPathFindingBasedTest) == 0x0000E8, "Member 'UBTDecorator_IsAtLocation::bPathFindingBasedTest' has a wrong offset!");
...
{
public:
	struct FValueOrBBKey_Class                    TestClass;                                         // 0x0090(0x0020)(Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBTDecorator_IsBBEntryOfClass) == 0x0000B0, "Wrong size on UBTDecorator_IsBBEntryOfClass");
...
static_assert(sizeof(UBTDecorator_KeepInCone) == 0x0000D0, "Wrong size on UBTDecorator_KeepInCone");
...
static_assert(offsetof(UBTDecorator_KeepInCone, Observed) == 0x0000A0, "Member 'UBTDecorator_KeepInCone::Observed' has a wrong offset!");
...
static_assert(sizeof(UBTDecorator_Loop) == 0x000090, "Wrong size on UBTDecorator_Loop");
static_assert(offsetof(UBTDecorator_Loop, NumLoops) == 0x000068, "Member 'UBTDecorator_Loop::NumLoops' has a wrong offset!");
static_assert(offsetof(UBTDecorator_Loop, bInfiniteLoop) == 0x000078, "Member 'UBTDecorator_Loop::bInfiniteLoop' has a wrong offset!");
static_assert(offsetof(UBTDecorator_Loop, InfiniteLoopTimeoutTime) == 0x00007C, "Member 'UBTDecorator_Loop::InfiniteLoopTimeoutTime' has a wrong offset!");
...
static_assert(sizeof(UBTDecorator_SetTagCooldown) == 0x000090, "Wrong size on UBTDecorator_SetTagCooldown");
...
static_assert(offsetof(UBTDecorator_TagCooldown, bActivatesCooldown) == 0x000090, "Member 'UBTDecorator_TagCooldown::bActivatesCooldown' has a wrong offset!");
...
static_assert(offsetof(UBTTask_GameplayTaskBase, bWaitForGameplayTask) == 0x000070, "Member 'UBTTask_GameplayTaskBase::bWaitForGameplayTask' has a wrong offset!");
...
{
public:
	struct FValueOrBBKey_Object                   AnimationToPlay;                                   // 0x0070(0x0020)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UBehaviorTreeComponent*                 MyOwnerComp;                                       // 0x00B0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USkeletalMeshComponent*                 CachedSkelMesh;                                    // 0x00B8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBTTask_PlayAnimation) == 0x0000E0, "Wrong size on UBTTask_PlayAnimation");
...
static_assert(offsetof(UBTTask_PlayAnimation, bLooping) == 0x000090, "Member 'UBTTask_PlayAnimation::bLooping' has a wrong offset!");
static_assert(offsetof(UBTTask_PlayAnimation, bNonBlocking) == 0x0000A0, "Member 'UBTTask_PlayAnimation::bNonBlocking' has a wrong offset!");
static_assert(offsetof(UBTTask_PlayAnimation, MyOwnerComp) == 0x0000B0, "Member 'UBTTask_PlayAnimation::MyOwnerComp' has a wrong offset!");
static_assert(offsetof(UBTTask_PlayAnimation, CachedSkelMesh) == 0x0000B8, "Member 'UBTTask_PlayAnimation::CachedSkelMesh' has a wrong offset!");
...
{
public:
	struct FValueOrBBKey_Object                   SoundToPlay;                                       // 0x0070(0x0020)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBTTask_RotateToFaceBBEntry) == 0x0000A8, "Wrong size on UBTTask_RotateToFaceBBEntry");
...
static_assert(sizeof(UBTTask_SetTagCooldown) == 0x000098, "Wrong size on UBTTask_SetTagCooldown");
...
static_assert(offsetof(UBTTask_Wait, RandomDeviation) == 0x000080, "Member 'UBTTask_Wait::RandomDeviation' has a wrong offset!");
...
static_assert(sizeof(ADetourCrowdAIController) == 0x0003E8, "Wrong size on ADetourCrowdAIController");
...
public:
	...
	class UEnvQuery*                              QueryTemplate;                                     // 0x0650(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AEQSTestingPawn) == 0x0006F0, "Wrong size on AEQSTestingPawn");
static_assert(offsetof(AEQSTestingPawn, QueryTemplate) == 0x000650, "Member 'AEQSTestingPawn::QueryTemplate' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryParams) == 0x000658, "Member 'AEQSTestingPawn::QueryParams' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryConfig) == 0x000668, "Member 'AEQSTestingPawn::QueryConfig' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, TimeLimitPerStep) == 0x000678, "Member 'AEQSTestingPawn::TimeLimitPerStep' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, StepToDebugDraw) == 0x00067C, "Member 'AEQSTestingPawn::StepToDebugDraw' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, HighlightMode) == 0x000680, "Member 'AEQSTestingPawn::HighlightMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryingMode) == 0x000688, "Member 'AEQSTestingPawn::QueryingMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, NavAgentProperties) == 0x000690, "Member 'AEQSTestingPawn::NavAgentProperties' has a wrong offset!");
...
static_assert(offsetof(UEnvQueryGenerator_BlueprintBase, Context) == 0x000060, "Member 'UEnvQueryGenerator_BlueprintBase::Context' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_BlueprintBase, GeneratedItemType) == 0x000068, "Member 'UEnvQueryGenerator_BlueprintBase::GeneratedItemType' has a wrong offset!");
...
static_assert(offsetof(UEnvQueryGenerator_OnCircle, PointOnCircleSpacingMethod) == 0x0000C8, "Member 'UEnvQueryGenerator_OnCircle::PointOnCircleSpacingMethod' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, SpaceBetween) == 0x0000D0, "Member 'UEnvQueryGenerator_OnCircle::SpaceBetween' has a wrong offset!");
...
static_assert(sizeof(AGridPathAIController) == 0x0003E8, "Wrong size on AGridPathAIController");
...
public:
	...
	class UNavMovementComponent*                  MovementComp;                                      // 0x00E0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UPathFollowingComponent) == 0x0002F8, "Wrong size on UPathFollowingComponent");
static_assert(offsetof(UPathFollowingComponent, MovementComp) == 0x0000E0, "Member 'UPathFollowingComponent::MovementComp' has a wrong offset!");
...
static_assert(sizeof(UCrowdFollowingComponent) == 0x000348, "Wrong size on UCrowdFollowingComponent");
static_assert(offsetof(UCrowdFollowingComponent, CrowdAgentMoveDirection) == 0x000310, "Member 'UCrowdFollowingComponent::CrowdAgentMoveDirection' has a wrong offset!");
...
static_assert(sizeof(UGridPathFollowingComponent) == 0x000328, "Wrong size on UGridPathFollowingComponent");
static_assert(offsetof(UGridPathFollowingComponent, GridManager) == 0x0002F8, "Member 'UGridPathFollowingComponent::GridManager' has a wrong offset!");
...
public:
	...
	class UNavLinkCustomComponent*                SmartLinkComp;                                     // 0x02E0(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
