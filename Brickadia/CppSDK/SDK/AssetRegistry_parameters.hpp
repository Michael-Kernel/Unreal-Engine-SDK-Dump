...
static_assert(alignof(AssetRegistryHelpers_SortByAssetName) == 0x000008, "Wrong alignment on AssetRegistryHelpers_SortByAssetName");
static_assert(sizeof(AssetRegistryHelpers_SortByAssetName) == 0x000018, "Wrong size on AssetRegistryHelpers_SortByAssetName");
static_assert(offsetof(AssetRegistryHelpers_SortByAssetName, Assets) == 0x000000, "Member 'AssetRegistryHelpers_SortByAssetName::Assets' has a wrong offset!");
static_assert(offsetof(AssetRegistryHelpers_SortByAssetName, SortOrder) == 0x000010, "Member 'AssetRegistryHelpers_SortByAssetName::SortOrder' has a wrong offset!");
...
static_assert(alignof(AssetRegistryHelpers_SortByPredicate) == 0x000008, "Wrong alignment on AssetRegistryHelpers_SortByPredicate");
static_assert(sizeof(AssetRegistryHelpers_SortByPredicate) == 0x000028, "Wrong size on AssetRegistryHelpers_SortByPredicate");
static_assert(offsetof(AssetRegistryHelpers_SortByPredicate, Assets) == 0x000000, "Member 'AssetRegistryHelpers_SortByPredicate::Assets' has a wrong offset!");
static_assert(offsetof(AssetRegistryHelpers_SortByPredicate, SortingPredicate) == 0x000010, "Member 'AssetRegistryHelpers_SortByPredicate::SortingPredicate' has a wrong offset!");
static_assert(offsetof(AssetRegistryHelpers_SortByPredicate, SortOrder) == 0x000020, "Member 'AssetRegistryHelpers_SortByPredicate::SortOrder' has a wrong offset!");
...
static_assert(alignof(AssetRegistry_GetInMemoryAssets) == 0x000008, "Wrong alignment on AssetRegistry_GetInMemoryAssets");
static_assert(sizeof(AssetRegistry_GetInMemoryAssets) == 0x000168, "Wrong size on AssetRegistry_GetInMemoryAssets");
static_assert(offsetof(AssetRegistry_GetInMemoryAssets, Filter) == 0x000000, "Member 'AssetRegistry_GetInMemoryAssets::Filter' has a wrong offset!");
static_assert(offsetof(AssetRegistry_GetInMemoryAssets, OutAssetData) == 0x000150, "Member 'AssetRegistry_GetInMemoryAssets::OutAssetData' has a wrong offset!");
static_assert(offsetof(AssetRegistry_GetInMemoryAssets, bSkipARFilteredAssets) == 0x000160, "Member 'AssetRegistry_GetInMemoryAssets::bSkipARFilteredAssets' has a wrong offset!");
static_assert(offsetof(AssetRegistry_GetInMemoryAssets, ReturnValue) == 0x000161, "Member 'AssetRegistry_GetInMemoryAssets::ReturnValue' has a wrong offset!");
