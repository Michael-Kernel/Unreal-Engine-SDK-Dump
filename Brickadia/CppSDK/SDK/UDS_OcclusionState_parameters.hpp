...
public:
	...
	struct FLinearColor                           K2Node_MakeStruct_None;                            // 0x0048(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UDS_OcclusionState_C_Directional_Vector_Mask, K2Node_MakeStruct_None) == 0x000048, "Member 'UDS_OcclusionState_C_Directional_Vector_Mask::K2Node_MakeStruct_None' has a wrong offset!");
