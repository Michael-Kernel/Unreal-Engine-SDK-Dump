...
static_assert(sizeof(AConstraintsActor) == 0x0002B8, "Wrong size on AConstraintsActor");
static_assert(offsetof(AConstraintsActor, ConstraintsManager) == 0x0002B0, "Member 'AConstraintsActor::ConstraintsManager' has a wrong offset!");
