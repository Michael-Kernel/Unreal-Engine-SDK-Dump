...
static_assert(sizeof(UClothingAssetCommon) == 0x0000E8, "Wrong size on UClothingAssetCommon");
...
static_assert(offsetof(UClothLODDataCommon_Legacy, CollisionData) == 0x000158, "Member 'UClothLODDataCommon_Legacy::CollisionData' has a wrong offset!");
