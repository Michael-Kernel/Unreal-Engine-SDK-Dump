...
static_assert(alignof(Weather_Override_Volume_C_Client_Runtime_Startup) == 0x000008, "Wrong alignment on Weather_Override_Volume_C_Client_Runtime_Startup");
static_assert(sizeof(Weather_Override_Volume_C_Client_Runtime_Startup) == 0x000010, "Wrong size on Weather_Override_Volume_C_Client_Runtime_Startup");
static_assert(offsetof(Weather_Override_Volume_C_Client_Runtime_Startup, Runtime_Spline_Points_0) == 0x000000, "Member 'Weather_Override_Volume_C_Client_Runtime_Startup::Runtime_Spline_Points_0' has a wrong offset!");
...
public:
	...
	struct FVector                                CallFunc_Divide_VectorVector_ReturnValue;          // 0x0108(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_GetSplineLength_ReturnValue;              // 0x0170(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_GetActorScale3D_ReturnValue) == 0x0000F0, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_GetActorScale3D_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_Divide_VectorVector_ReturnValue) == 0x000108, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_Divide_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_Divide_DoubleDouble_ReturnValue_1) == 0x000120, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_Divide_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_GetDisplayName_ReturnValue) == 0x000128, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_Replace_ReturnValue) == 0x000138, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_Replace_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_SelectString_ReturnValue) == 0x000148, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_SelectString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_Divide_DoubleDouble_ReturnValue_2) == 0x000158, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_Divide_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_SelectString_ReturnValue_1) == 0x000160, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_SelectString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_GetSplineLength_ReturnValue) == 0x000170, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_GetSplineLength_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_Divide_DoubleDouble_ReturnValue_3) == 0x000178, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_Divide_DoubleDouble_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_FFloor_ReturnValue) == 0x000180, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_FFloor_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_Conv_IntToDouble_ReturnValue_1) == 0x000188, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_Conv_IntToDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000190, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_Divide_DoubleDouble_ReturnValue_4) == 0x000198, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_Divide_DoubleDouble_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels, CallFunc_Multiply_IntFloat_ReturnValue) == 0x0001A0, "Member 'Weather_Override_Volume_C_Construct_Editor_Only_Weather_Labels::CallFunc_Multiply_IntFloat_ReturnValue' has a wrong offset!");
...
public:
	...
	struct FCanvasUVTri                           K2Node_MakeStruct_None;                            // 0x0120(0x0090)(ZeroConstructor, NoDestructor)
...
static_assert(offsetof(Weather_Override_Volume_C_Create_Canvas_Space_Triangles, K2Node_MakeStruct_None) == 0x000120, "Member 'Weather_Override_Volume_C_Create_Canvas_Space_Triangles::K2Node_MakeStruct_None' has a wrong offset!");
...
static_assert(sizeof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume) == 0x000108, "Wrong size on Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume");
...
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_HasAuthority_ReturnValue) == 0x000004, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_IsComponentTickEnabled_ReturnValue) == 0x000005, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_IsComponentTickEnabled_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Not_PreBool_ReturnValue) == 0x000006, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_CustomEvent_New_Weather_Type) == 0x000020, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_CustomEvent_New_Weather_Type' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_CustomEvent_Time_to_Transition_to_New_Weather__Seconds_) == 0x000028, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_CustomEvent_Time_to_Transition_to_New_Weather__Seconds_' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_NotEqual_ByteByte_ReturnValue) == 0x000030, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_NotEqual_ByteByte_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Not_PreBool_ReturnValue_1) == 0x000040, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_IsValid_ReturnValue) == 0x000054, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_Event_EndPlayReason) == 0x000055, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_Event_EndPlayReason' has a wrong offset!");
...
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x000069, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, Temp_bool_Variable) == 0x00006A, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::Temp_bool_Variable' has a wrong offset!");
...
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_HasAuthority_ReturnValue_1) == 0x0000A8, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_HasAuthority_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_NotEqual_ByteByte_ReturnValue_1) == 0x0000A9, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_NotEqual_ByteByte_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Array_RemoveItem_ReturnValue) == 0x0000AA, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Array_RemoveItem_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_FMax_ReturnValue_2) == 0x0000C0, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_FMax_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_GetActorOfClass_ReturnValue) == 0x0000C8, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_GetActorOfClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_IsValid_ReturnValue_1) == 0x0000D0, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_CreateDelegate_OutputDelegate) == 0x0000D4, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_NotEqual_ByteByte_ReturnValue_2) == 0x0000E4, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_NotEqual_ByteByte_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0000E5, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Not_PreBool_ReturnValue_3) == 0x0000E6, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Not_PreBool_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Not_PreBool_ReturnValue_4) == 0x0000E7, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Not_PreBool_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_IsValid_ReturnValue_2) == 0x0000E8, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_EqualEqual_DoubleDouble_ReturnValue) == 0x0000E9, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_EqualEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Not_PreBool_ReturnValue_5) == 0x0000EA, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Not_PreBool_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_CustomEvent_Runtime_Spline_Points) == 0x0000F0, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_CustomEvent_Runtime_Spline_Points' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_IsServer_ReturnValue) == 0x000100, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_IsServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Not_PreBool_ReturnValue_6) == 0x000101, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Not_PreBool_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_IsServer_ReturnValue_1) == 0x000102, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_IsServer_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Array_IsNotEmpty_ReturnValue) == 0x000103, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Array_IsNotEmpty_ReturnValue' has a wrong offset!");
...
static_assert(alignof(Weather_Override_Volume_C_Get_Random_Weather_Mode) == 0x000001, "Wrong alignment on Weather_Override_Volume_C_Get_Random_Weather_Mode");
static_assert(sizeof(Weather_Override_Volume_C_Get_Random_Weather_Mode) == 0x000001, "Wrong size on Weather_Override_Volume_C_Get_Random_Weather_Mode");
static_assert(offsetof(Weather_Override_Volume_C_Get_Random_Weather_Mode, Mode) == 0x000000, "Member 'Weather_Override_Volume_C_Get_Random_Weather_Mode::Mode' has a wrong offset!");
...
static_assert(alignof(Weather_Override_Volume_C_Get_Random_Weather_Probability_Maps) == 0x000008, "Wrong alignment on Weather_Override_Volume_C_Get_Random_Weather_Probability_Maps");
static_assert(sizeof(Weather_Override_Volume_C_Get_Random_Weather_Probability_Maps) == 0x000140, "Wrong size on Weather_Override_Volume_C_Get_Random_Weather_Probability_Maps");
static_assert(offsetof(Weather_Override_Volume_C_Get_Random_Weather_Probability_Maps, Spring) == 0x000000, "Member 'Weather_Override_Volume_C_Get_Random_Weather_Probability_Maps::Spring' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Get_Random_Weather_Probability_Maps, Summer) == 0x000050, "Member 'Weather_Override_Volume_C_Get_Random_Weather_Probability_Maps::Summer' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Get_Random_Weather_Probability_Maps, Autumn) == 0x0000A0, "Member 'Weather_Override_Volume_C_Get_Random_Weather_Probability_Maps::Autumn' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Get_Random_Weather_Probability_Maps, Winter) == 0x0000F0, "Member 'Weather_Override_Volume_C_Get_Random_Weather_Probability_Maps::Winter' has a wrong offset!");
...
static_assert(alignof(Weather_Override_Volume_C_Get_Season_Temperature_Ranges) == 0x000008, "Wrong alignment on Weather_Override_Volume_C_Get_Season_Temperature_Ranges");
static_assert(sizeof(Weather_Override_Volume_C_Get_Season_Temperature_Ranges) == 0x000040, "Wrong size on Weather_Override_Volume_C_Get_Season_Temperature_Ranges");
static_assert(offsetof(Weather_Override_Volume_C_Get_Season_Temperature_Ranges, Spring) == 0x000000, "Member 'Weather_Override_Volume_C_Get_Season_Temperature_Ranges::Spring' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Get_Season_Temperature_Ranges, Summer) == 0x000010, "Member 'Weather_Override_Volume_C_Get_Season_Temperature_Ranges::Summer' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Get_Season_Temperature_Ranges, Autumn) == 0x000020, "Member 'Weather_Override_Volume_C_Get_Season_Temperature_Ranges::Autumn' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Get_Season_Temperature_Ranges, Winter) == 0x000030, "Member 'Weather_Override_Volume_C_Get_Season_Temperature_Ranges::Winter' has a wrong offset!");
...
public:
	...
	struct FUDW_WOV_State                         K2Node_MakeStruct_None;                            // 0x0160(0x00D0)(HasGetValueTypeHash)
};
...
static_assert(offsetof(Weather_Override_Volume_C_Get_State_for_Saving, K2Node_MakeStruct_None) == 0x000160, "Member 'Weather_Override_Volume_C_Get_State_for_Saving::K2Node_MakeStruct_None' has a wrong offset!");
...
static_assert(alignof(Weather_Override_Volume_C_Initialize_Random_Weather_Component) == 0x000004, "Wrong alignment on Weather_Override_Volume_C_Initialize_Random_Weather_Component");
static_assert(sizeof(Weather_Override_Volume_C_Initialize_Random_Weather_Component) == 0x000010, "Wrong size on Weather_Override_Volume_C_Initialize_Random_Weather_Component");
static_assert(offsetof(Weather_Override_Volume_C_Initialize_Random_Weather_Component, K2Node_CreateDelegate_OutputDelegate) == 0x000000, "Member 'Weather_Override_Volume_C_Initialize_Random_Weather_Component::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(Weather_Override_Volume_C_Initialize_Spline_Data, CallFunc_Array_Length_ReturnValue) == 0x000070, "Member 'Weather_Override_Volume_C_Initialize_Spline_Data::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Initialize_Spline_Data, CallFunc_Array_Length_ReturnValue_1) == 0x000074, "Member 'Weather_Override_Volume_C_Initialize_Spline_Data::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Initialize_Spline_Data, CallFunc_Greater_IntInt_ReturnValue) == 0x000078, "Member 'Weather_Override_Volume_C_Initialize_Spline_Data::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
...
public:
	...
	struct FLinearColor                           K2Node_MakeStruct_None;                            // 0x0090(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Weather_Override_Volume_C_Scale_And_Place_Vertex_in_Canvas_Space, K2Node_MakeStruct_None) == 0x000090, "Member 'Weather_Override_Volume_C_Scale_And_Place_Vertex_in_Canvas_Space::K2Node_MakeStruct_None' has a wrong offset!");
