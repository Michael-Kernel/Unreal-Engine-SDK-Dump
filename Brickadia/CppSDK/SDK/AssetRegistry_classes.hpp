...
// 0x1130 (0x1158 - 0x0028)
class UAssetRegistryImpl final : public UObject
{
public:
	uint8                                         Pad_28[0x1130];                                    // 0x0028(0x1130)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x001158, "Wrong size on UAssetRegistryImpl");
