...
{
public:
	class UComputeGraph*                          ComputeGraph;                                      // 0x00A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FComputeGraphInstance                  ComputeGraphInstance;                              // 0x00B0(0x0018)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UComputeGraphComponent) == 0x0000C8, "Wrong size on UComputeGraphComponent");
static_assert(offsetof(UComputeGraphComponent, ComputeGraph) == 0x0000A8, "Member 'UComputeGraphComponent::ComputeGraph' has a wrong offset!");
static_assert(offsetof(UComputeGraphComponent, ComputeGraphInstance) == 0x0000B0, "Member 'UComputeGraphComponent::ComputeGraphInstance' has a wrong offset!");
