...
{
public:
	class UGroomComponent*                        GroomComponent;                                    // 0x02B0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AGroomActor) == 0x0002B8, "Wrong size on AGroomActor");
static_assert(offsetof(AGroomActor, GroomComponent) == 0x0002B0, "Member 'AGroomActor::GroomComponent' has a wrong offset!");
...
public:
	...
	class UGroomAsset*                            GroomAsset;                                        // 0x0508(0x0008)(Edit, BlueprintVisible, ZeroConstructor, Interp, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGroomCache*                            GroomCache;                                        // 0x0510(0x0008)(Edit, BlueprintVisible, ZeroConstructor, Interp, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UNiagaraComponent*>              NiagaraComponents;                                 // 0x0518(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
	class USkeletalMesh*                          SourceSkeletalMesh;                                // 0x0528(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGroomBindingAsset*                     BindingAsset;                                      // 0x0530(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Interp, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPhysicsAsset*                          PhysicsAsset;                                      // 0x0538(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_540[0x10];                                     // 0x0540(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHairSimulationSettings                SimulationSettings;                                // 0x0550(0x0090)(Edit, BlueprintVisible, Interp, NativeAccessSpecifierPublic)
	class UMeshDeformer*                          MeshDeformer;                                      // 0x05E0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshDeformerInstance*                  MeshDeformerInstance;                              // 0x05E8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshDeformerInstanceSettings*          MeshDeformerInstanceSettings;                      // 0x05F0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Strands_DebugMaterial;                             // 0x05F8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Strands_DefaultMaterial;                           // 0x0600(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Cards_DefaultMaterial;                             // 0x0608(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Meshes_DefaultMaterial;                            // 0x0610(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraSystem*                         AngularSpringsSystem;                              // 0x0618(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraSystem*                         CosseratRodsSystem;                                // 0x0620(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AttachmentName;                                    // 0x0628(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Interp, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_638[0x88];                                     // 0x0638(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FHairGroupDesc>                 GroomGroupsDesc;                                   // 0x06C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bUseCards;                                         // 0x06D0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRunning;                                          // 0x06D1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bLooping;                                          // 0x06D2(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bManualTick;                                       // 0x06D3(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         ElapsedTime;                                       // 0x06D4(0x0004)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_6D8[0x48];                                     // 0x06D8(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UGroomComponent) == 0x000720, "Wrong size on UGroomComponent");
static_assert(offsetof(UGroomComponent, GroomAsset) == 0x000508, "Member 'UGroomComponent::GroomAsset' has a wrong offset!");
static_assert(offsetof(UGroomComponent, GroomCache) == 0x000510, "Member 'UGroomComponent::GroomCache' has a wrong offset!");
static_assert(offsetof(UGroomComponent, NiagaraComponents) == 0x000518, "Member 'UGroomComponent::NiagaraComponents' has a wrong offset!");
static_assert(offsetof(UGroomComponent, SourceSkeletalMesh) == 0x000528, "Member 'UGroomComponent::SourceSkeletalMesh' has a wrong offset!");
static_assert(offsetof(UGroomComponent, BindingAsset) == 0x000530, "Member 'UGroomComponent::BindingAsset' has a wrong offset!");
static_assert(offsetof(UGroomComponent, PhysicsAsset) == 0x000538, "Member 'UGroomComponent::PhysicsAsset' has a wrong offset!");
static_assert(offsetof(UGroomComponent, SimulationSettings) == 0x000550, "Member 'UGroomComponent::SimulationSettings' has a wrong offset!");
static_assert(offsetof(UGroomComponent, MeshDeformer) == 0x0005E0, "Member 'UGroomComponent::MeshDeformer' has a wrong offset!");
static_assert(offsetof(UGroomComponent, MeshDeformerInstance) == 0x0005E8, "Member 'UGroomComponent::MeshDeformerInstance' has a wrong offset!");
static_assert(offsetof(UGroomComponent, MeshDeformerInstanceSettings) == 0x0005F0, "Member 'UGroomComponent::MeshDeformerInstanceSettings' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Strands_DebugMaterial) == 0x0005F8, "Member 'UGroomComponent::Strands_DebugMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Strands_DefaultMaterial) == 0x000600, "Member 'UGroomComponent::Strands_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Cards_DefaultMaterial) == 0x000608, "Member 'UGroomComponent::Cards_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Meshes_DefaultMaterial) == 0x000610, "Member 'UGroomComponent::Meshes_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, AngularSpringsSystem) == 0x000618, "Member 'UGroomComponent::AngularSpringsSystem' has a wrong offset!");
static_assert(offsetof(UGroomComponent, CosseratRodsSystem) == 0x000620, "Member 'UGroomComponent::CosseratRodsSystem' has a wrong offset!");
static_assert(offsetof(UGroomComponent, AttachmentName) == 0x000628, "Member 'UGroomComponent::AttachmentName' has a wrong offset!");
static_assert(offsetof(UGroomComponent, GroomGroupsDesc) == 0x0006C0, "Member 'UGroomComponent::GroomGroupsDesc' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bUseCards) == 0x0006D0, "Member 'UGroomComponent::bUseCards' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bRunning) == 0x0006D1, "Member 'UGroomComponent::bRunning' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bLooping) == 0x0006D2, "Member 'UGroomComponent::bLooping' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bManualTick) == 0x0006D3, "Member 'UGroomComponent::bManualTick' has a wrong offset!");
static_assert(offsetof(UGroomComponent, ElapsedTime) == 0x0006D4, "Member 'UGroomComponent::ElapsedTime' has a wrong offset!");
