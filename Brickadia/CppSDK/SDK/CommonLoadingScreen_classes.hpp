...
// Class CommonLoadingScreen.CommonLoadingScreenWidget
// 0x0000 (0x02D0 - 0x02D0)
class UCommonLoadingScreenWidget : public UUserWidget
{
public:
...
public:
	...
	{
		return StaticClassImpl<"CommonLoadingScreenWidget">();
	}
	static class UCommonLoadingScreenWidget* GetDefaultObj()
	{
		return GetDefaultObjImpl<UCommonLoadingScreenWidget>();
	}
};
static_assert(alignof(UCommonLoadingScreenWidget) == 0x000008, "Wrong alignment on UCommonLoadingScreenWidget");
static_assert(sizeof(UCommonLoadingScreenWidget) == 0x0002D0, "Wrong size on UCommonLoadingScreenWidget");
...
public:
	...
	class UUserWidget*                            LoadingScreenInstance;                             // 0x0050(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ULoadingScreenManager) == 0x0000B8, "Wrong size on ULoadingScreenManager");
static_assert(offsetof(ULoadingScreenManager, LoadingScreenInstance) == 0x000050, "Member 'ULoadingScreenManager::LoadingScreenInstance' has a wrong offset!");
