...
static_assert(alignof(FTypedElementAssetDataReferencedOptions) == 0x000001, "Wrong alignment on FTypedElementAssetDataReferencedOptions");
static_assert(sizeof(FTypedElementAssetDataReferencedOptions) == 0x000001, "Wrong size on FTypedElementAssetDataReferencedOptions");
static_assert(offsetof(FTypedElementAssetDataReferencedOptions, bOnlyTopLevelAsset) == 0x000000, "Member 'FTypedElementAssetDataReferencedOptions::bOnlyTopLevelAsset' has a wrong offset!");
