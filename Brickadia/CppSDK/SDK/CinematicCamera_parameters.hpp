...
static_assert(sizeof(CineCameraComponent_SetFilmback) == 0x000014, "Wrong size on CineCameraComponent_SetFilmback");
...
static_assert(alignof(CineCameraComponent_GetHorizontalProjectionOffset) == 0x000004, "Wrong alignment on CineCameraComponent_GetHorizontalProjectionOffset");
static_assert(sizeof(CineCameraComponent_GetHorizontalProjectionOffset) == 0x000004, "Wrong size on CineCameraComponent_GetHorizontalProjectionOffset");
static_assert(offsetof(CineCameraComponent_GetHorizontalProjectionOffset, ReturnValue) == 0x000000, "Member 'CineCameraComponent_GetHorizontalProjectionOffset::ReturnValue' has a wrong offset!");
...
static_assert(alignof(CineCameraComponent_GetVerticalProjectionOffset) == 0x000004, "Wrong alignment on CineCameraComponent_GetVerticalProjectionOffset");
static_assert(sizeof(CineCameraComponent_GetVerticalProjectionOffset) == 0x000004, "Wrong size on CineCameraComponent_GetVerticalProjectionOffset");
static_assert(offsetof(CineCameraComponent_GetVerticalProjectionOffset, ReturnValue) == 0x000000, "Member 'CineCameraComponent_GetVerticalProjectionOffset::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(CineCameraSettings_GetFilmbackPresetByName) == 0x000028, "Wrong size on CineCameraSettings_GetFilmbackPresetByName");
...
static_assert(offsetof(CineCameraSettings_GetFilmbackPresetByName, ReturnValue) == 0x000024, "Member 'CineCameraSettings_GetFilmbackPresetByName::ReturnValue' has a wrong offset!");
