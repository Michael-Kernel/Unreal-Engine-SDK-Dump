...
static_assert(offsetof(UFFXFSR3Settings, bUseDistortionTexture) == 0x000048, "Member 'UFFXFSR3Settings::bUseDistortionTexture' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, bD3D12AsyncInterpolation) == 0x000049, "Member 'UFFXFSR3Settings::bD3D12AsyncInterpolation' has a wrong offset!");
static_assert(offsetof(UFFXFSR3Settings, bD3D12AsyncPresent) == 0x00004A, "Member 'UFFXFSR3Settings::bD3D12AsyncPresent' has a wrong offset!");
