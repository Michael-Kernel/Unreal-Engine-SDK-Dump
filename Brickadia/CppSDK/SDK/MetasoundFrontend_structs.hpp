...
static_assert(alignof(FNodeTemplateGenerateInterfaceParams) == 0x000008, "Wrong alignment on FNodeTemplateGenerateInterfaceParams");
static_assert(sizeof(FNodeTemplateGenerateInterfaceParams) == 0x000020, "Wrong size on FNodeTemplateGenerateInterfaceParams");
static_assert(offsetof(FNodeTemplateGenerateInterfaceParams, InputsToConnect) == 0x000000, "Member 'FNodeTemplateGenerateInterfaceParams::InputsToConnect' has a wrong offset!");
static_assert(offsetof(FNodeTemplateGenerateInterfaceParams, OutputsToConnect) == 0x000010, "Member 'FNodeTemplateGenerateInterfaceParams::OutputsToConnect' has a wrong offset!");
...
static_assert(alignof(FMetaSoundFrontendGraphComment) == 0x000001, "Wrong alignment on FMetaSoundFrontendGraphComment");
static_assert(sizeof(FMetaSoundFrontendGraphComment) == 0x000001, "Wrong size on FMetaSoundFrontendGraphComment");
...
static_assert(alignof(FMetasoundFrontendGraphStyle) == 0x000001, "Wrong alignment on FMetasoundFrontendGraphStyle");
static_assert(sizeof(FMetasoundFrontendGraphStyle) == 0x000001, "Wrong size on FMetasoundFrontendGraphStyle");
...
static_assert(sizeof(FMetasoundFrontendGraph) == 0x000040, "Wrong size on FMetasoundFrontendGraph");
...
static_assert(offsetof(FMetasoundFrontendGraph, PageID) == 0x000030, "Member 'FMetasoundFrontendGraph::PageID' has a wrong offset!");
...
static_assert(alignof(FMetasoundFrontendClassInputDefault) == 0x000008, "Wrong alignment on FMetasoundFrontendClassInputDefault");
static_assert(sizeof(FMetasoundFrontendClassInputDefault) == 0x000068, "Wrong size on FMetasoundFrontendClassInputDefault");
static_assert(offsetof(FMetasoundFrontendClassInputDefault, Literal) == 0x000000, "Member 'FMetasoundFrontendClassInputDefault::Literal' has a wrong offset!");
static_assert(offsetof(FMetasoundFrontendClassInputDefault, PageID) == 0x000058, "Member 'FMetasoundFrontendClassInputDefault::PageID' has a wrong offset!");
...
static_assert(sizeof(FMetasoundFrontendClassInput) == 0x000048, "Wrong size on FMetasoundFrontendClassInput");
static_assert(offsetof(FMetasoundFrontendClassInput, Defaults) == 0x000038, "Member 'FMetasoundFrontendClassInput::Defaults' has a wrong offset!");
...
{
public:
	TArray<struct FMetasoundFrontendGraph>        PagedGraphs;                                       // 0x0090(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FMetasoundFrontendGraphClass) == 0x0000F8, "Wrong size on FMetasoundFrontendGraphClass");
static_assert(offsetof(FMetasoundFrontendGraphClass, PagedGraphs) == 0x000090, "Member 'FMetasoundFrontendGraphClass::PagedGraphs' has a wrong offset!");
static_assert(offsetof(FMetasoundFrontendGraphClass, PresetOptions) == 0x0000A0, "Member 'FMetasoundFrontendGraphClass::PresetOptions' has a wrong offset!");
...
static_assert(sizeof(FMetasoundFrontendDocument) == 0x000190, "Wrong size on FMetasoundFrontendDocument");
...
static_assert(offsetof(FMetasoundFrontendDocument, Subgraphs) == 0x000168, "Member 'FMetasoundFrontendDocument::Subgraphs' has a wrong offset!");
static_assert(offsetof(FMetasoundFrontendDocument, Dependencies) == 0x000178, "Member 'FMetasoundFrontendDocument::Dependencies' has a wrong offset!");
static_assert(offsetof(FMetasoundFrontendDocument, IdCounter) == 0x000188, "Member 'FMetasoundFrontendDocument::IdCounter' has a wrong offset!");
...
static_assert(sizeof(FMetaSoundFrontendDocumentBuilder) == 0x000048, "Wrong size on FMetaSoundFrontendDocumentBuilder");
...
static_assert(offsetof(FMetaSoundFrontendDocumentBuilder, BuildPageID) == 0x000018, "Member 'FMetaSoundFrontendDocumentBuilder::BuildPageID' has a wrong offset!");
