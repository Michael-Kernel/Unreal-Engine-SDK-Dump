...
static_assert(offsetof(UUDS_Weather_Settings_C, Sky_Modifier) == 0x000080, "Member 'UUDS_Weather_Settings_C::Sky_Modifier' has a wrong offset!");
static_assert(offsetof(UUDS_Weather_Settings_C, Icon_Texture) == 0x000088, "Member 'UUDS_Weather_Settings_C::Icon_Texture' has a wrong offset!");
static_assert(offsetof(UUDS_Weather_Settings_C, User_Friendly_Name) == 0x0000B0, "Member 'UUDS_Weather_Settings_C::User_Friendly_Name' has a wrong offset!");
static_assert(offsetof(UUDS_Weather_Settings_C, State_Sources) == 0x0000C0, "Member 'UUDS_Weather_Settings_C::State_Sources' has a wrong offset!");
