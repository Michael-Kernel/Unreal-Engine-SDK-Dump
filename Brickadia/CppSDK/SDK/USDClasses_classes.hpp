...
{
public:
	struct FVector                                BoundsMin;                                         // 0x04C8(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                BoundsMax;                                         // 0x04E0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EUsdDrawMode                                  DrawMode;                                          // 0x04F8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           BoundsColor;                                       // 0x04FC(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EUsdModelCardGeometry                         CardGeometry;                                      // 0x050C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             CardTextureXPos;                                   // 0x0510(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             CardTextureYPos;                                   // 0x0518(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             CardTextureZPos;                                   // 0x0520(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             CardTextureXNeg;                                   // 0x0528(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             CardTextureYNeg;                                   // 0x0530(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             CardTextureZNeg;                                   // 0x0538(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UMaterialInstance*>              MaterialInstances;                                 // 0x0540(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	int32                                         AuthoredFaces;                                     // 0x0550(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UUsdDrawModeComponent) == 0x000560, "Wrong size on UUsdDrawModeComponent");
static_assert(offsetof(UUsdDrawModeComponent, BoundsMin) == 0x0004C8, "Member 'UUsdDrawModeComponent::BoundsMin' has a wrong offset!");
static_assert(offsetof(UUsdDrawModeComponent, BoundsMax) == 0x0004E0, "Member 'UUsdDrawModeComponent::BoundsMax' has a wrong offset!");
static_assert(offsetof(UUsdDrawModeComponent, DrawMode) == 0x0004F8, "Member 'UUsdDrawModeComponent::DrawMode' has a wrong offset!");
static_assert(offsetof(UUsdDrawModeComponent, BoundsColor) == 0x0004FC, "Member 'UUsdDrawModeComponent::BoundsColor' has a wrong offset!");
static_assert(offsetof(UUsdDrawModeComponent, CardGeometry) == 0x00050C, "Member 'UUsdDrawModeComponent::CardGeometry' has a wrong offset!");
static_assert(offsetof(UUsdDrawModeComponent, CardTextureXPos) == 0x000510, "Member 'UUsdDrawModeComponent::CardTextureXPos' has a wrong offset!");
static_assert(offsetof(UUsdDrawModeComponent, CardTextureYPos) == 0x000518, "Member 'UUsdDrawModeComponent::CardTextureYPos' has a wrong offset!");
static_assert(offsetof(UUsdDrawModeComponent, CardTextureZPos) == 0x000520, "Member 'UUsdDrawModeComponent::CardTextureZPos' has a wrong offset!");
static_assert(offsetof(UUsdDrawModeComponent, CardTextureXNeg) == 0x000528, "Member 'UUsdDrawModeComponent::CardTextureXNeg' has a wrong offset!");
static_assert(offsetof(UUsdDrawModeComponent, CardTextureYNeg) == 0x000530, "Member 'UUsdDrawModeComponent::CardTextureYNeg' has a wrong offset!");
static_assert(offsetof(UUsdDrawModeComponent, CardTextureZNeg) == 0x000538, "Member 'UUsdDrawModeComponent::CardTextureZNeg' has a wrong offset!");
static_assert(offsetof(UUsdDrawModeComponent, MaterialInstances) == 0x000540, "Member 'UUsdDrawModeComponent::MaterialInstances' has a wrong offset!");
static_assert(offsetof(UUsdDrawModeComponent, AuthoredFaces) == 0x000550, "Member 'UUsdDrawModeComponent::AuthoredFaces' has a wrong offset!");
