...
public:
	...
	struct FLinearColor                           K2Node_MakeStruct_None;                            // 0x0060(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UDS_RenderTarget_State_C_Set_Location, K2Node_MakeStruct_None) == 0x000060, "Member 'UDS_RenderTarget_State_C_Set_Location::K2Node_MakeStruct_None' has a wrong offset!");
