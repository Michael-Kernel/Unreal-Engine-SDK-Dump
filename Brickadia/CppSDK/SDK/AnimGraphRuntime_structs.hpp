...
static_assert(offsetof(FAnimNode_PoseBlendNode, BlendOption) == 0x0000B0, "Member 'FAnimNode_PoseBlendNode::BlendOption' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseBlendNode, CustomCurve) == 0x0000B8, "Member 'FAnimNode_PoseBlendNode::CustomCurve' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_LayeredBoneBlend) == 0x0000E8, "Wrong size on FAnimNode_LayeredBoneBlend");
...
static_assert(offsetof(FAnimNode_LayeredBoneBlend, PerBoneBlendWeights) == 0x000088, "Member 'FAnimNode_LayeredBoneBlend::PerBoneBlendWeights' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, SkeletonGuid) == 0x0000B8, "Member 'FAnimNode_LayeredBoneBlend::SkeletonGuid' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, VirtualBoneGuid) == 0x0000C8, "Member 'FAnimNode_LayeredBoneBlend::VirtualBoneGuid' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, LODThreshold) == 0x0000DC, "Member 'FAnimNode_LayeredBoneBlend::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, bMeshSpaceRotationBlend) == 0x0000E0, "Member 'FAnimNode_LayeredBoneBlend::bMeshSpaceRotationBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, bMeshSpaceScaleBlend) == 0x0000E1, "Member 'FAnimNode_LayeredBoneBlend::bMeshSpaceScaleBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, CurveBlendOption) == 0x0000E2, "Member 'FAnimNode_LayeredBoneBlend::CurveBlendOption' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, bBlendRootMotionBasedOnRootBone) == 0x0000E3, "Member 'FAnimNode_LayeredBoneBlend::bBlendRootMotionBasedOnRootBone' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_30E[0x552];                                    // 0x030E(0x0552)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_RigidBody) == 0x000010, "Wrong alignment on FAnimNode_RigidBody");
static_assert(sizeof(FAnimNode_RigidBody) == 0x000860, "Wrong size on FAnimNode_RigidBody");
...
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, bOverridePositionWhenJoiningSyncGroupAsLeader) == 0x000071, "Member 'FAnimNode_BlendSpacePlayer_Standalone::bOverridePositionWhenJoiningSyncGroupAsLeader' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, Method) == 0x000072, "Member 'FAnimNode_BlendSpacePlayer_Standalone::Method' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, bIgnoreForRelevancyTest) == 0x000073, "Member 'FAnimNode_BlendSpacePlayer_Standalone::bIgnoreForRelevancyTest' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_PoseDriver) == 0x0001A8, "Wrong size on FAnimNode_PoseDriver");
...
static_assert(offsetof(FAnimNode_PoseDriver, SourceBones) == 0x0000B0, "Member 'FAnimNode_PoseDriver::SourceBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, EvalSpaceBone) == 0x0000C0, "Member 'FAnimNode_PoseDriver::EvalSpaceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, bEvalFromRefPose) == 0x0000D0, "Member 'FAnimNode_PoseDriver::bEvalFromRefPose' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_PoseDriver, DriveSource) == 0x000130, "Member 'FAnimNode_PoseDriver::DriveSource' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, DriveOutput) == 0x000131, "Member 'FAnimNode_PoseDriver::DriveOutput' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, LODThreshold) == 0x000174, "Member 'FAnimNode_PoseDriver::LODThreshold' has a wrong offset!");
...
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000C00, "Wrong size on FAnimSequencerInstanceProxy");
