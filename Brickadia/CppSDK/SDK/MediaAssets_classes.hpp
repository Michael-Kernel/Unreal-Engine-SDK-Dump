...
static_assert(sizeof(UMediaComponent) == 0x0000B8, "Wrong size on UMediaComponent");
static_assert(offsetof(UMediaComponent, MediaTexture) == 0x0000A8, "Member 'UMediaComponent::MediaTexture' has a wrong offset!");
static_assert(offsetof(UMediaComponent, MediaPlayer) == 0x0000B0, "Member 'UMediaComponent::MediaPlayer' has a wrong offset!");
