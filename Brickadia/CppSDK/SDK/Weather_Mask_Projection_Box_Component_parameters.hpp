...
public:
	...
	struct FHitResult                             CallFunc_LineTraceSingleForObjects_OutHit;         // 0x0318(0x00F0)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                          CallFunc_LineTraceSingleForObjects_ReturnValue;    // 0x0408(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Calculate_Masking_At_Location, CallFunc_LineTraceSingleForObjects_ReturnValue) == 0x000408, "Member 'Weather_Mask_Projection_Box_Component_C_Calculate_Masking_At_Location::CallFunc_LineTraceSingleForObjects_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing) == 0x0000F8, "Wrong size on Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing");
...
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_BreakVector2D_X) == 0x000058, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_BreakVector2D_X' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_BreakVector2D_Y) == 0x000060, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_BreakVector2D_Y' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_Divide_DoubleDouble_ReturnValue_1) == 0x000068, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_Divide_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_BreakVector2D_X_1) == 0x000070, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_BreakVector2D_X_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_BreakVector2D_Y_1) == 0x000078, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_BreakVector2D_Y_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_Divide_DoubleDouble_ReturnValue_2) == 0x000080, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_Divide_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_Divide_DoubleDouble_ReturnValue_3) == 0x000088, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_Divide_DoubleDouble_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_SafeDivide_ReturnValue) == 0x000090, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_SafeDivide_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x000098, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_CreateDynamicMaterialInstance_ReturnValue_1) == 0x0000B0, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_CreateDynamicMaterialInstance_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_BreakVector_X_1) == 0x0000B8, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_BreakVector_X_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_BreakVector_Y_1) == 0x0000C0, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_BreakVector_Y_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_BreakVector_Z_1) == 0x0000C8, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_BreakVector_Z_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_Not_PreBool_ReturnValue_1) == 0x0000D0, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_SetScalarParameterValue_Value_ImplicitCast) == 0x0000D4, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_SetScalarParameterValue_Value_ImplicitCast' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_SetScalarParameterValue_Value_ImplicitCast_1) == 0x0000D8, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_SetScalarParameterValue_Value_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_SetScalarParameterValue_Value_ImplicitCast_2) == 0x0000DC, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_SetScalarParameterValue_Value_ImplicitCast_2' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_SetScalarParameterValue_Value_ImplicitCast_3) == 0x0000E0, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_SetScalarParameterValue_Value_ImplicitCast_3' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_SetScalarParameterValue_Value_ImplicitCast_4) == 0x0000E4, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_SetScalarParameterValue_Value_ImplicitCast_4' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_SetScalarParameterValue_Value_ImplicitCast_5) == 0x0000E8, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_SetScalarParameterValue_Value_ImplicitCast_5' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_SetScalarParameterValue_Value_ImplicitCast_6) == 0x0000EC, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_SetScalarParameterValue_Value_ImplicitCast_6' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_SetScalarParameterValue_Value_ImplicitCast_7) == 0x0000F0, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_SetScalarParameterValue_Value_ImplicitCast_7' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing, CallFunc_SetScalarParameterValue_Value_ImplicitCast_8) == 0x0000F4, "Member 'Weather_Mask_Projection_Box_Component_C_Prepare_for_Drawing::CallFunc_SetScalarParameterValue_Value_ImplicitCast_8' has a wrong offset!");
...
public:
	...
	double                                        CallFunc_BreakRotator_Roll;                        // 0x0058(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_BreakRotator_Pitch;                       // 0x0060(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_BreakRotator_Yaw;                         // 0x0068(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             CallFunc_K2_SetWorldTransform_SweepHitResult;      // 0x0188(0x00F0)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	int32                                         CallFunc_FTrunc_ReturnValue_1;                     // 0x032C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Clamp_ReturnValue;                        // 0x0330(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Clamp_ReturnValue_1;                      // 0x0334(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_VariableSet_OrthoWidth_ImplicitCast;        // 0x0338(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, Y_Resolution) == 0x000000, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::Y_Resolution' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_CreateRenderTarget2D_ReturnValue) == 0x000008, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_CreateRenderTarget2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_BreakVector_X) == 0x000010, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_BreakVector_X' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_BreakVector_Y) == 0x000018, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_BreakVector_Y' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_BreakVector_Z) == 0x000020, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_BreakVector_Z' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_K2_GetComponentRotation_ReturnValue) == 0x000028, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_K2_GetComponentRotation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x000040, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_BreakRotator_Roll) == 0x000058, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_BreakRotator_Roll' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_BreakRotator_Pitch) == 0x000060, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_BreakRotator_Pitch' has a wrong offset!");
...
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_Conv_DoubleToVector_ReturnValue) == 0x000088, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_Conv_DoubleToVector_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_Multiply_VectorVector_ReturnValue_1) == 0x000278, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_Multiply_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_Add_VectorVector_ReturnValue_2) == 0x000290, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_Add_VectorVector_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_Conv_IntToVector_ReturnValue) == 0x0002A8, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_Conv_IntToVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_IsValid_ReturnValue) == 0x0002C0, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_Conv_DoubleToVector_ReturnValue_1) == 0x0002C8, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_Conv_DoubleToVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_Divide_VectorVector_ReturnValue) == 0x0002E0, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_Divide_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_Divide_VectorVector_ReturnValue_1) == 0x0002F8, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_Divide_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_BreakVector_X_1) == 0x000310, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_BreakVector_X_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_BreakVector_Y_1) == 0x000318, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_BreakVector_Y_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_BreakVector_Z_1) == 0x000320, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_BreakVector_Z_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_FTrunc_ReturnValue) == 0x000328, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_FTrunc_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_FTrunc_ReturnValue_1) == 0x00032C, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_FTrunc_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_Clamp_ReturnValue) == 0x000330, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_Clamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, CallFunc_Clamp_ReturnValue_1) == 0x000334, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::CallFunc_Clamp_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Capture, K2Node_VariableSet_OrthoWidth_ImplicitCast) == 0x000338, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Capture::K2Node_VariableSet_OrthoWidth_ImplicitCast' has a wrong offset!");
...
static_assert(alignof(Weather_Mask_Projection_Box_Component_C_Update_Mask_Values) == 0x000004, "Wrong alignment on Weather_Mask_Projection_Box_Component_C_Update_Mask_Values");
static_assert(sizeof(Weather_Mask_Projection_Box_Component_C_Update_Mask_Values) == 0x000008, "Wrong size on Weather_Mask_Projection_Box_Component_C_Update_Mask_Values");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Mask_Values, CallFunc_SetScalarParameterValue_Value_ImplicitCast) == 0x000000, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Mask_Values::CallFunc_SetScalarParameterValue_Value_ImplicitCast' has a wrong offset!");
static_assert(offsetof(Weather_Mask_Projection_Box_Component_C_Update_Mask_Values, CallFunc_SetScalarParameterValue_Value_ImplicitCast_1) == 0x000004, "Member 'Weather_Mask_Projection_Box_Component_C_Update_Mask_Values::CallFunc_SetScalarParameterValue_Value_ImplicitCast_1' has a wrong offset!");
