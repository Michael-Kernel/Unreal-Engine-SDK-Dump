...
public:
	...
	TArray<class UMovieSceneLiveLinkSubSection*>  SubSections;                                       // 0x0140(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneLiveLinkSection) == 0x000238, "Wrong size on UMovieSceneLiveLinkSection");
...
static_assert(offsetof(UMovieSceneLiveLinkSection, ChannelMask) == 0x000130, "Member 'UMovieSceneLiveLinkSection::ChannelMask' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, SubSections) == 0x000140, "Member 'UMovieSceneLiveLinkSection::SubSections' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, SubjectName) == 0x000160, "Member 'UMovieSceneLiveLinkSection::SubjectName' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, TemplateToPush) == 0x000168, "Member 'UMovieSceneLiveLinkSection::TemplateToPush' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, RefSkeleton) == 0x0001F8, "Member 'UMovieSceneLiveLinkSection::RefSkeleton' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, CurveNames) == 0x000218, "Member 'UMovieSceneLiveLinkSection::CurveNames' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, PropertyFloatChannels) == 0x000228, "Member 'UMovieSceneLiveLinkSection::PropertyFloatChannels' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneLiveLinkTrack) == 0x000138, "Wrong size on UMovieSceneLiveLinkTrack");
static_assert(offsetof(UMovieSceneLiveLinkTrack, TrackRole) == 0x000130, "Member 'UMovieSceneLiveLinkTrack::TrackRole' has a wrong offset!");
