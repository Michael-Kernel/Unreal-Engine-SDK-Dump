...
public:
	...
	class UObject*                                ResourceObject;                                    // 0x0038(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(FSlateBrush, TintColor) == 0x000008, "Member 'FSlateBrush::TintColor' has a wrong offset!");
static_assert(offsetof(FSlateBrush, DrawAs) == 0x00001C, "Member 'FSlateBrush::DrawAs' has a wrong offset!");
static_assert(offsetof(FSlateBrush, Tiling) == 0x00001D, "Member 'FSlateBrush::Tiling' has a wrong offset!");
static_assert(offsetof(FSlateBrush, Mirroring) == 0x00001E, "Member 'FSlateBrush::Mirroring' has a wrong offset!");
static_assert(offsetof(FSlateBrush, ImageType) == 0x00001F, "Member 'FSlateBrush::ImageType' has a wrong offset!");
static_assert(offsetof(FSlateBrush, ImageSize) == 0x000020, "Member 'FSlateBrush::ImageSize' has a wrong offset!");
static_assert(offsetof(FSlateBrush, Margin) == 0x000028, "Member 'FSlateBrush::Margin' has a wrong offset!");
static_assert(offsetof(FSlateBrush, ResourceObject) == 0x000038, "Member 'FSlateBrush::ResourceObject' has a wrong offset!");
...
static_assert(offsetof(FSlateBrush, ResourceName) == 0x0000A8, "Member 'FSlateBrush::ResourceName' has a wrong offset!");
...
static_assert(sizeof(FScrollBoxStyle) == 0x0002F0, "Wrong size on FScrollBoxStyle");
...
static_assert(offsetof(FScrollBoxStyle, HorizontalScrolledContentPadding) == 0x0002D0, "Member 'FScrollBoxStyle::HorizontalScrolledContentPadding' has a wrong offset!");
static_assert(offsetof(FScrollBoxStyle, VerticalScrolledContentPadding) == 0x0002E0, "Member 'FScrollBoxStyle::VerticalScrolledContentPadding' has a wrong offset!");
...
static_assert(offsetof(FFontOutlineSettings, bMiteredCorners) == 0x000004, "Member 'FFontOutlineSettings::bMiteredCorners' has a wrong offset!");
static_assert(offsetof(FFontOutlineSettings, bSeparateFillAlpha) == 0x000005, "Member 'FFontOutlineSettings::bSeparateFillAlpha' has a wrong offset!");
static_assert(offsetof(FFontOutlineSettings, bApplyOutlineToDropShadows) == 0x000006, "Member 'FFontOutlineSettings::bApplyOutlineToDropShadows' has a wrong offset!");
...
static_assert(sizeof(FSlateFontInfo) == 0x000060, "Wrong size on FSlateFontInfo");
...
static_assert(offsetof(FSlateFontInfo, bForceMonospaced) == 0x000055, "Member 'FSlateFontInfo::bForceMonospaced' has a wrong offset!");
static_assert(offsetof(FSlateFontInfo, bMaterialIsStencil) == 0x000056, "Member 'FSlateFontInfo::bMaterialIsStencil' has a wrong offset!");
static_assert(offsetof(FSlateFontInfo, MonospacedWidth) == 0x000058, "Member 'FSlateFontInfo::MonospacedWidth' has a wrong offset!");
...
static_assert(offsetof(FTextBlockStyle, ColorAndOpacity) == 0x000068, "Member 'FTextBlockStyle::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, ShadowOffset) == 0x00007C, "Member 'FTextBlockStyle::ShadowOffset' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, ShadowColorAndOpacity) == 0x000084, "Member 'FTextBlockStyle::ShadowColorAndOpacity' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, SelectedBackgroundColor) == 0x000094, "Member 'FTextBlockStyle::SelectedBackgroundColor' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, HighlightColor) == 0x0000A8, "Member 'FTextBlockStyle::HighlightColor' has a wrong offset!");
...
static_assert(sizeof(FEditableTextBoxStyle) == 0x000C80, "Wrong size on FEditableTextBoxStyle");
...
static_assert(offsetof(FEditableTextBoxStyle, TextStyle) == 0x0002E0, "Member 'FEditableTextBoxStyle::TextStyle' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, ForegroundColor) == 0x0005C0, "Member 'FEditableTextBoxStyle::ForegroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, BackgroundColor) == 0x0005D4, "Member 'FEditableTextBoxStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, ReadOnlyForegroundColor) == 0x0005E8, "Member 'FEditableTextBoxStyle::ReadOnlyForegroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, FocusedForegroundColor) == 0x0005FC, "Member 'FEditableTextBoxStyle::FocusedForegroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, HScrollBarPadding) == 0x000610, "Member 'FEditableTextBoxStyle::HScrollBarPadding' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, VScrollBarPadding) == 0x000620, "Member 'FEditableTextBoxStyle::VScrollBarPadding' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, ScrollBarStyle) == 0x000630, "Member 'FEditableTextBoxStyle::ScrollBarStyle' has a wrong offset!");
...
static_assert(sizeof(FTableRowStyle) == 0x000B50, "Wrong size on FTableRowStyle");
...
static_assert(offsetof(FTableRowStyle, bUseParentRowBrush) == 0x000380, "Member 'FTableRowStyle::bUseParentRowBrush' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, ParentRowBackgroundBrush) == 0x000390, "Member 'FTableRowStyle::ParentRowBackgroundBrush' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, ParentRowBackgroundHoveredBrush) == 0x000440, "Member 'FTableRowStyle::ParentRowBackgroundHoveredBrush' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, EvenRowBackgroundHoveredBrush) == 0x0004F0, "Member 'FTableRowStyle::EvenRowBackgroundHoveredBrush' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, EvenRowBackgroundBrush) == 0x0005A0, "Member 'FTableRowStyle::EvenRowBackgroundBrush' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, OddRowBackgroundHoveredBrush) == 0x000650, "Member 'FTableRowStyle::OddRowBackgroundHoveredBrush' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, OddRowBackgroundBrush) == 0x000700, "Member 'FTableRowStyle::OddRowBackgroundBrush' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, TextColor) == 0x0007B0, "Member 'FTableRowStyle::TextColor' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, SelectedTextColor) == 0x0007C4, "Member 'FTableRowStyle::SelectedTextColor' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, DropIndicator_Above) == 0x0007E0, "Member 'FTableRowStyle::DropIndicator_Above' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, DropIndicator_Onto) == 0x000890, "Member 'FTableRowStyle::DropIndicator_Onto' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, DropIndicator_Below) == 0x000940, "Member 'FTableRowStyle::DropIndicator_Below' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, ActiveHighlightedBrush) == 0x0009F0, "Member 'FTableRowStyle::ActiveHighlightedBrush' has a wrong offset!");
static_assert(offsetof(FTableRowStyle, InactiveHighlightedBrush) == 0x000AA0, "Member 'FTableRowStyle::InactiveHighlightedBrush' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            MenuShadowBrush;                                   // 0x0500(0x00B0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FMargin                                MenuBorderPadding;                                 // 0x05B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                ContentPadding;                                    // 0x05C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                DownArrowPadding;                                  // 0x05D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	EVerticalAlignment                            DownArrowAlign;                                    // 0x05E0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5E1[0x3];                                      // 0x05E1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMargin                                MenuShadowPadding;                                 // 0x05E4(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                MenuShadowOuterPadding;                            // 0x05F4(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FComboButtonStyle) == 0x000610, "Wrong size on FComboButtonStyle");
...
static_assert(offsetof(FComboButtonStyle, MenuShadowBrush) == 0x000500, "Member 'FComboButtonStyle::MenuShadowBrush' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, MenuBorderPadding) == 0x0005B0, "Member 'FComboButtonStyle::MenuBorderPadding' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, ContentPadding) == 0x0005C0, "Member 'FComboButtonStyle::ContentPadding' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, DownArrowPadding) == 0x0005D0, "Member 'FComboButtonStyle::DownArrowPadding' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, DownArrowAlign) == 0x0005E0, "Member 'FComboButtonStyle::DownArrowAlign' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, MenuShadowPadding) == 0x0005E4, "Member 'FComboButtonStyle::MenuShadowPadding' has a wrong offset!");
static_assert(offsetof(FComboButtonStyle, MenuShadowOuterPadding) == 0x0005F4, "Member 'FComboButtonStyle::MenuShadowOuterPadding' has a wrong offset!");
...
public:
	...
	struct FSlateSound                            PressedSlateSound;                                 // 0x0620(0x0018)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FSlateSound                            SelectionChangeSlateSound;                         // 0x0638(0x0018)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                ContentPadding;                                    // 0x0650(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                MenuRowPadding;                                    // 0x0660(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FComboBoxStyle) == 0x000010, "Wrong alignment on FComboBoxStyle");
static_assert(sizeof(FComboBoxStyle) == 0x000670, "Wrong size on FComboBoxStyle");
...
static_assert(offsetof(FComboBoxStyle, PressedSlateSound) == 0x000620, "Member 'FComboBoxStyle::PressedSlateSound' has a wrong offset!");
static_assert(offsetof(FComboBoxStyle, SelectionChangeSlateSound) == 0x000638, "Member 'FComboBoxStyle::SelectionChangeSlateSound' has a wrong offset!");
static_assert(offsetof(FComboBoxStyle, ContentPadding) == 0x000650, "Member 'FComboBoxStyle::ContentPadding' has a wrong offset!");
static_assert(offsetof(FComboBoxStyle, MenuRowPadding) == 0x000660, "Member 'FComboBoxStyle::MenuRowPadding' has a wrong offset!");
...
static_assert(offsetof(FEditableTextStyle, ColorAndOpacity) == 0x000068, "Member 'FEditableTextStyle::ColorAndOpacity' has a wrong offset!");
...
static_assert(offsetof(FFontSdfSettings, BasePpem) == 0x000000, "Member 'FFontSdfSettings::BasePpem' has a wrong offset!");
...
static_assert(offsetof(FCompositeFont, bEnableAscentDescentOverride) == 0x000038, "Member 'FCompositeFont::bEnableAscentDescentOverride' has a wrong offset!");
...
static_assert(sizeof(FInlineEditableTextBlockStyle) == 0x000F70, "Wrong size on FInlineEditableTextBlockStyle");
...
static_assert(offsetof(FInlineEditableTextBlockStyle, TextStyle) == 0x000C90, "Member 'FInlineEditableTextBlockStyle::TextStyle' has a wrong offset!");
...
static_assert(sizeof(FSearchBoxStyle) == 0x000FE0, "Wrong size on FSearchBoxStyle");
static_assert(offsetof(FSearchBoxStyle, TextBoxStyle) == 0x000010, "Member 'FSearchBoxStyle::TextBoxStyle' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ActiveFontInfo) == 0x000C90, "Member 'FSearchBoxStyle::ActiveFontInfo' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, UpArrowImage) == 0x000CF0, "Member 'FSearchBoxStyle::UpArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, DownArrowImage) == 0x000DA0, "Member 'FSearchBoxStyle::DownArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, GlassImage) == 0x000E50, "Member 'FSearchBoxStyle::GlassImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ClearImage) == 0x000F00, "Member 'FSearchBoxStyle::ClearImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ImagePadding) == 0x000FB0, "Member 'FSearchBoxStyle::ImagePadding' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ImageSizeOverride) == 0x000FC0, "Member 'FSearchBoxStyle::ImageSizeOverride' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, bLeftAlignButtons) == 0x000FD8, "Member 'FSearchBoxStyle::bLeftAlignButtons' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, bLeftAlignSearchResultButtons) == 0x000FD9, "Member 'FSearchBoxStyle::bLeftAlignSearchResultButtons' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, bLeftAlignGlassImageAndClearButton) == 0x000FDA, "Member 'FSearchBoxStyle::bLeftAlignGlassImageAndClearButton' has a wrong offset!");
...
public:
	...
	struct FComboButtonStyle                      ComboButtonStyle;                                  // 0x1AD0(0x0610)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FButtonStyle                           SettingsButtonStyle;                               // 0x20E0(0x0370)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FComboButtonStyle                      SettingsComboButton;                               // 0x2450(0x0610)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FCheckBoxStyle                         SettingsToggleButton;                              // 0x2A60(0x0950)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FButtonStyle                           ButtonStyle;                                       // 0x33B0(0x0370)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FMargin                                LabelPadding;                                      // 0x3720(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         UniformBlockWidth;                                 // 0x3730(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         UniformBlockHeight;                                // 0x3734(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumColumns;                                        // 0x3738(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMargin                                IconPadding;                                       // 0x373C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                SeparatorPadding;                                  // 0x374C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         SeparatorThickness;                                // 0x375C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMargin                                ComboButtonPadding;                                // 0x3760(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                ButtonPadding;                                     // 0x3770(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                CheckBoxPadding;                                   // 0x3780(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                BlockPadding;                                      // 0x3790(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                IndentedBlockPadding;                              // 0x37A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                BackgroundPadding;                                 // 0x37B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FDeprecateSlateVector2D                IconSize;                                          // 0x37C0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowLabels;                                       // 0x37C8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_37C9[0x3];                                     // 0x37C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ButtonContentMaxWidth;                             // 0x37CC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ButtonContentFillWidth;                            // 0x37D0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMargin                                IconPaddingWithVisibleLabel;                       // 0x37D4(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                IconPaddingWithCollapsedLabel;                     // 0x37E4(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	TOptional<EVerticalAlignment>                 VerticalAlignmentOverride;                         // 0x37F4(0x0002)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_37F6[0xA];                                     // 0x37F6(0x000A)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FToolBarStyle) == 0x000010, "Wrong alignment on FToolBarStyle");
static_assert(sizeof(FToolBarStyle) == 0x003800, "Wrong size on FToolBarStyle");
...
static_assert(offsetof(FToolBarStyle, ToggleButton) == 0x001180, "Member 'FToolBarStyle::ToggleButton' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ComboButtonStyle) == 0x001AD0, "Member 'FToolBarStyle::ComboButtonStyle' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SettingsButtonStyle) == 0x0020E0, "Member 'FToolBarStyle::SettingsButtonStyle' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SettingsComboButton) == 0x002450, "Member 'FToolBarStyle::SettingsComboButton' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SettingsToggleButton) == 0x002A60, "Member 'FToolBarStyle::SettingsToggleButton' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonStyle) == 0x0033B0, "Member 'FToolBarStyle::ButtonStyle' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, LabelPadding) == 0x003720, "Member 'FToolBarStyle::LabelPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, UniformBlockWidth) == 0x003730, "Member 'FToolBarStyle::UniformBlockWidth' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, UniformBlockHeight) == 0x003734, "Member 'FToolBarStyle::UniformBlockHeight' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, NumColumns) == 0x003738, "Member 'FToolBarStyle::NumColumns' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconPadding) == 0x00373C, "Member 'FToolBarStyle::IconPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SeparatorPadding) == 0x00374C, "Member 'FToolBarStyle::SeparatorPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SeparatorThickness) == 0x00375C, "Member 'FToolBarStyle::SeparatorThickness' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ComboButtonPadding) == 0x003760, "Member 'FToolBarStyle::ComboButtonPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonPadding) == 0x003770, "Member 'FToolBarStyle::ButtonPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, CheckBoxPadding) == 0x003780, "Member 'FToolBarStyle::CheckBoxPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, BlockPadding) == 0x003790, "Member 'FToolBarStyle::BlockPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IndentedBlockPadding) == 0x0037A0, "Member 'FToolBarStyle::IndentedBlockPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, BackgroundPadding) == 0x0037B0, "Member 'FToolBarStyle::BackgroundPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconSize) == 0x0037C0, "Member 'FToolBarStyle::IconSize' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, bShowLabels) == 0x0037C8, "Member 'FToolBarStyle::bShowLabels' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonContentMaxWidth) == 0x0037CC, "Member 'FToolBarStyle::ButtonContentMaxWidth' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonContentFillWidth) == 0x0037D0, "Member 'FToolBarStyle::ButtonContentFillWidth' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconPaddingWithVisibleLabel) == 0x0037D4, "Member 'FToolBarStyle::IconPaddingWithVisibleLabel' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconPaddingWithCollapsedLabel) == 0x0037E4, "Member 'FToolBarStyle::IconPaddingWithCollapsedLabel' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, VerticalAlignmentOverride) == 0x0037F4, "Member 'FToolBarStyle::VerticalAlignmentOverride' has a wrong offset!");
