...
static_assert(offsetof(TimeManagementBlueprintLibrary_Conv_TimecodeToString, bForceSignDisplay) == 0x000018, "Member 'TimeManagementBlueprintLibrary_Conv_TimecodeToString::bForceSignDisplay' has a wrong offset!");
static_assert(offsetof(TimeManagementBlueprintLibrary_Conv_TimecodeToString, ReturnValue) == 0x000020, "Member 'TimeManagementBlueprintLibrary_Conv_TimecodeToString::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(TimeManagementBlueprintLibrary_GetTimecode) == 0x000018, "Wrong size on TimeManagementBlueprintLibrary_GetTimecode");
