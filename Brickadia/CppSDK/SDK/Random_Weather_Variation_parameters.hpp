...
static_assert(alignof(Random_Weather_Variation_C_Bind_to_UDS) == 0x000008, "Wrong alignment on Random_Weather_Variation_C_Bind_to_UDS");
static_assert(sizeof(Random_Weather_Variation_C_Bind_to_UDS) == 0x000040, "Wrong size on Random_Weather_Variation_C_Bind_to_UDS");
...
static_assert(offsetof(Random_Weather_Variation_C_Bind_to_UDS, K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface) == 0x000020, "Member 'Random_Weather_Variation_C_Bind_to_UDS::K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Bind_to_UDS, K2Node_DynamicCast_bSuccess) == 0x000030, "Member 'Random_Weather_Variation_C_Bind_to_UDS::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Bind_to_UDS, CallFunc_Get_UDW_Current_UDS_Reference_UDS) == 0x000038, "Member 'Random_Weather_Variation_C_Bind_to_UDS::CallFunc_Get_UDW_Current_UDS_Reference_UDS' has a wrong offset!");
...
static_assert(sizeof(Random_Weather_Variation_C_Change_to_Next_Random_Weather_Type) == 0x000088, "Wrong size on Random_Weather_Variation_C_Change_to_Next_Random_Weather_Type");
...
static_assert(offsetof(Random_Weather_Variation_C_Change_to_Next_Random_Weather_Type, CallFunc_Greater_IntInt_ReturnValue) == 0x000018, "Member 'Random_Weather_Variation_C_Change_to_Next_Random_Weather_Type::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Change_to_Next_Random_Weather_Type, CallFunc_Array_Get_Item) == 0x000020, "Member 'Random_Weather_Variation_C_Change_to_Next_Random_Weather_Type::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Change_to_Next_Random_Weather_Type, CallFunc_Array_IsNotEmpty_ReturnValue) == 0x000028, "Member 'Random_Weather_Variation_C_Change_to_Next_Random_Weather_Type::CallFunc_Array_IsNotEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Change_to_Next_Random_Weather_Type, CallFunc_Create_Composite_Probability_Map_Out) == 0x000030, "Member 'Random_Weather_Variation_C_Change_to_Next_Random_Weather_Type::CallFunc_Create_Composite_Probability_Map_Out' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Change_to_Next_Random_Weather_Type, CallFunc_Select_Random_Weather_Type_Out) == 0x000080, "Member 'Random_Weather_Variation_C_Change_to_Next_Random_Weather_Type::CallFunc_Select_Random_Weather_Type_Out' has a wrong offset!");
...
static_assert(alignof(Random_Weather_Variation_C_Check_For_Client_Startup) == 0x000008, "Wrong alignment on Random_Weather_Variation_C_Check_For_Client_Startup");
static_assert(sizeof(Random_Weather_Variation_C_Check_For_Client_Startup) == 0x000010, "Wrong size on Random_Weather_Variation_C_Check_For_Client_Startup");
static_assert(offsetof(Random_Weather_Variation_C_Check_For_Client_Startup, CallFunc_K2_SetTimerForNextTick_ReturnValue) == 0x000000, "Member 'Random_Weather_Variation_C_Check_For_Client_Startup::CallFunc_K2_SetTimerForNextTick_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Check_For_Client_Startup, CallFunc_IsValid_ReturnValue) == 0x000008, "Member 'Random_Weather_Variation_C_Check_For_Client_Startup::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(Random_Weather_Variation_C_Check_For_Season_Instant_Refresh) == 0x000088, "Wrong size on Random_Weather_Variation_C_Check_For_Season_Instant_Refresh");
...
static_assert(offsetof(Random_Weather_Variation_C_Check_For_Season_Instant_Refresh, K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface) == 0x000008, "Member 'Random_Weather_Variation_C_Check_For_Season_Instant_Refresh::K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Check_For_Season_Instant_Refresh, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'Random_Weather_Variation_C_Check_For_Season_Instant_Refresh::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Check_For_Season_Instant_Refresh, CallFunc_Get_Current_Season_Season) == 0x000020, "Member 'Random_Weather_Variation_C_Check_For_Season_Instant_Refresh::CallFunc_Get_Current_Season_Season' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Check_For_Season_Instant_Refresh, CallFunc_FFloor_ReturnValue) == 0x000028, "Member 'Random_Weather_Variation_C_Check_For_Season_Instant_Refresh::CallFunc_FFloor_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Check_For_Season_Instant_Refresh, CallFunc_Get_Season_Probability_Map_Map) == 0x000030, "Member 'Random_Weather_Variation_C_Check_For_Season_Instant_Refresh::CallFunc_Get_Season_Probability_Map_Map' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Check_For_Season_Instant_Refresh, CallFunc_Map_Contains_ReturnValue) == 0x000080, "Member 'Random_Weather_Variation_C_Check_For_Season_Instant_Refresh::CallFunc_Map_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Check_For_Season_Instant_Refresh, CallFunc_Not_PreBool_ReturnValue) == 0x000081, "Member 'Random_Weather_Variation_C_Check_For_Season_Instant_Refresh::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(Random_Weather_Variation_C_Create_Composite_Probability_Map) == 0x0002F0, "Wrong size on Random_Weather_Variation_C_Create_Composite_Probability_Map");
...
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, Individual_Seasons) == 0x000050, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::Individual_Seasons' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, Season_Probability_Totals) == 0x000060, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::Season_Probability_Totals' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, Composite_Map) == 0x000070, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::Composite_Map' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, Temp_int_Loop_Counter_Variable) == 0x0000C0, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, Temp_int_Array_Index_Variable) == 0x0000C4, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Add_IntInt_ReturnValue) == 0x0000C8, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, Temp_int_Loop_Counter_Variable_1) == 0x0000CC, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Add_IntInt_ReturnValue_1) == 0x0000D0, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, Temp_int_Array_Index_Variable_1) == 0x0000D4, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, Temp_int_Variable) == 0x0000D8, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Get_Season_Probability_Map_Map) == 0x0000E0, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Get_Season_Probability_Map_Map' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Map_Keys_Keys) == 0x000130, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Map_Keys_Keys' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000140, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Array_Get_Item) == 0x000148, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Map_Find_Value) == 0x000150, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Map_Find_ReturnValue) == 0x000158, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Array_Length_ReturnValue) == 0x00015C, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Less_IntInt_ReturnValue) == 0x000164, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface) == 0x000168, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, K2Node_DynamicCast_bSuccess) == 0x000178, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Get_Current_Season_Season) == 0x000180, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Get_Current_Season_Season' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Array_Get_Item_1) == 0x000188, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_FFloor_ReturnValue) == 0x000190, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_FFloor_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x000194, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Get_Season_Probability_Map_Map_1) == 0x000198, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Get_Season_Probability_Map_Map_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x0001E8, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface_1) == 0x0001F0, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, K2Node_DynamicCast_bSuccess_1) == 0x000200, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Get_Individual_Season_Floats_Out) == 0x000208, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Get_Individual_Season_Floats_Out' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Array_Get_Item_2) == 0x000218, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_SafeDivide_ReturnValue) == 0x000220, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_SafeDivide_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, Temp_int_Variable_1) == 0x000228, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::Temp_int_Variable_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, K2Node_MakeArray_Array) == 0x000230, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Array_Get_Item_3) == 0x000240, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Array_Get_Item_3' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Greater_DoubleDouble_ReturnValue_1) == 0x000248, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Greater_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Get_Season_Probability_Map_Map_2) == 0x000250, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Get_Season_Probability_Map_Map_2' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Map_Values_Values) == 0x0002A0, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Map_Values_Values' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Array_Get_Item_4) == 0x0002B0, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Array_Get_Item_4' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Array_Length_ReturnValue_1) == 0x0002B8, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_LessEqual_IntInt_ReturnValue_1) == 0x0002BC, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_LessEqual_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Less_IntInt_ReturnValue_1) == 0x0002BD, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Add_IntInt_ReturnValue_3) == 0x0002C0, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Add_IntInt_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Array_Get_Item_5) == 0x0002C8, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Array_Get_Item_5' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Add_DoubleDouble_ReturnValue) == 0x0002D0, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Map_Find_Value_1) == 0x0002D8, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Map_Find_Value_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Map_Find_ReturnValue_1) == 0x0002E0, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Map_Find_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Create_Composite_Probability_Map, CallFunc_Add_DoubleDouble_ReturnValue_1) == 0x0002E8, "Member 'Random_Weather_Variation_C_Create_Composite_Probability_Map::CallFunc_Add_DoubleDouble_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation) == 0x000030, "Wrong size on Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation");
...
static_assert(offsetof(Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation, K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface) == 0x000008, "Member 'Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation::K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation, CallFunc_Get_Weather_Speed_Out) == 0x000020, "Member 'Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation::CallFunc_Get_Weather_Speed_Out' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation, K2Node_Event_DeltaSeconds) == 0x000028, "Member 'Random_Weather_Variation_C_ExecuteUbergraph_Random_Weather_Variation::K2Node_Event_DeltaSeconds' has a wrong offset!");
...
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Percent_FloatFloat_ReturnValue) == 0x000008, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Percent_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000010, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_SafeDivide_ReturnValue) == 0x000018, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_SafeDivide_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Conv_IntToDouble_ReturnValue) == 0x000020, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_FClamp_ReturnValue) == 0x000028, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_FClamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000030, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Subtract_DoubleDouble_ReturnValue) == 0x000038, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Subtract_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000040, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Percent_FloatFloat_ReturnValue_1) == 0x000048, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Percent_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Divide_DoubleDouble_ReturnValue_1) == 0x000050, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Divide_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_FMax_ReturnValue) == 0x000058, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_FMax_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_SafeDivide_ReturnValue_1) == 0x000060, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_SafeDivide_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_FClamp_ReturnValue_1) == 0x000068, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_FClamp_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Random_Weather_Mode_Mode) == 0x000070, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Random_Weather_Mode_Mode' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_FMax_ReturnValue_1) == 0x000078, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_FMax_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, K2Node_SwitchEnum_CmpSuccess) == 0x000080, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x000081, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_SelectFloat_ReturnValue) == 0x000088, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_SelectFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Multiply_DoubleDouble_ReturnValue_1) == 0x000090, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Multiply_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Divide_DoubleDouble_ReturnValue_2) == 0x000098, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Divide_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Multiply_DoubleDouble_ReturnValue_2) == 0x0000A0, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Multiply_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Add_DoubleDouble_ReturnValue_1) == 0x0000A8, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Add_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_FClamp_ReturnValue_2) == 0x0000B0, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_FClamp_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Current_Lerp_Alpha, CallFunc_Divide_DoubleDouble_A_ImplicitCast) == 0x0000B8, "Member 'Random_Weather_Variation_C_Get_Current_Lerp_Alpha::CallFunc_Divide_DoubleDouble_A_ImplicitCast' has a wrong offset!");
...
public:
	...
	TScriptInterface<class IUDW_and_Weather_Override_Volume_Interface_C> K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface; // 0x0060(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TScriptInterface<class IUDW_and_Weather_Override_Volume_Interface_C> K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface_1; // 0x0208(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Random_Weather_Variation_C_Get_Season_Probability_Map) == 0x0003B0, "Wrong size on Random_Weather_Variation_C_Get_Season_Probability_Map");
...
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface) == 0x000060, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, K2Node_DynamicCast_bSuccess) == 0x000070, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, CallFunc_Get_Random_Weather_Probability_Maps_Spring) == 0x000078, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::CallFunc_Get_Random_Weather_Probability_Maps_Spring' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, CallFunc_Get_Random_Weather_Probability_Maps_Summer) == 0x0000C8, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::CallFunc_Get_Random_Weather_Probability_Maps_Summer' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, CallFunc_Get_Random_Weather_Probability_Maps_Autumn) == 0x000118, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::CallFunc_Get_Random_Weather_Probability_Maps_Autumn' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, CallFunc_Get_Random_Weather_Probability_Maps_Winter) == 0x000168, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::CallFunc_Get_Random_Weather_Probability_Maps_Winter' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, K2Node_Select_Default) == 0x0001B8, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface_1) == 0x000208, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, K2Node_DynamicCast_bSuccess_1) == 0x000218, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, CallFunc_Get_Random_Weather_Probability_Maps_Spring_1) == 0x000220, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::CallFunc_Get_Random_Weather_Probability_Maps_Spring_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, CallFunc_Get_Random_Weather_Probability_Maps_Summer_1) == 0x000270, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::CallFunc_Get_Random_Weather_Probability_Maps_Summer_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, CallFunc_Get_Random_Weather_Probability_Maps_Autumn_1) == 0x0002C0, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::CallFunc_Get_Random_Weather_Probability_Maps_Autumn_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, CallFunc_Get_Random_Weather_Probability_Maps_Winter_1) == 0x000310, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::CallFunc_Get_Random_Weather_Probability_Maps_Winter_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Get_Season_Probability_Map, K2Node_Select_Default_1) == 0x000360, "Member 'Random_Weather_Variation_C_Get_Season_Probability_Map::K2Node_Select_Default_1' has a wrong offset!");
...
public:
	...
	struct FRandomWeatherVariation_State          K2Node_MakeStruct_None;                            // 0x0040(0x0040)(HasGetValueTypeHash)
	...
	struct FRandomWeatherVariation_State          K2Node_MakeStruct_None_1;                          // 0x0088(0x0040)(HasGetValueTypeHash)
};
...
static_assert(offsetof(Random_Weather_Variation_C_Get_State_for_Saving, K2Node_MakeStruct_None) == 0x000040, "Member 'Random_Weather_Variation_C_Get_State_for_Saving::K2Node_MakeStruct_None' has a wrong offset!");
...
static_assert(offsetof(Random_Weather_Variation_C_Get_State_for_Saving, K2Node_MakeStruct_None_1) == 0x000088, "Member 'Random_Weather_Variation_C_Get_State_for_Saving::K2Node_MakeStruct_None_1' has a wrong offset!");
...
static_assert(offsetof(Random_Weather_Variation_C_Hourly, CallFunc_HasAuthority_ReturnValue) == 0x000010, "Member 'Random_Weather_Variation_C_Hourly::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Hourly, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000011, "Member 'Random_Weather_Variation_C_Hourly::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Hourly, CallFunc_Random_Weather_Mode_Mode) == 0x000012, "Member 'Random_Weather_Variation_C_Hourly::CallFunc_Random_Weather_Mode_Mode' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Hourly, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000013, "Member 'Random_Weather_Variation_C_Hourly::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Random_Weather_Variation_C_Increment_Change_Timer, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000018, "Member 'Random_Weather_Variation_C_Increment_Change_Timer::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Change_Timer, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x000019, "Member 'Random_Weather_Variation_C_Increment_Change_Timer::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Random_Weather_Variation_C_Increment_Change_Timer, CallFunc_Multiply_DoubleDouble_A_ImplicitCast) == 0x000028, "Member 'Random_Weather_Variation_C_Increment_Change_Timer::CallFunc_Multiply_DoubleDouble_A_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(Random_Weather_Variation_C_Increment_Random_Weather) == 0x000040, "Wrong size on Random_Weather_Variation_C_Increment_Random_Weather");
...
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_NotEqual_ObjectObject_ReturnValue) == 0x000008, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_NotEqual_ObjectObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_GetGameTimeInSeconds_ReturnValue) == 0x000010, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_GetGameTimeInSeconds_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_Less_DoubleDouble_ReturnValue) == 0x000020, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_Less_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_Less_DoubleDouble_ReturnValue_1) == 0x000021, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_Less_DoubleDouble_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_BooleanOR_ReturnValue) == 0x000023, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_IsValid_ReturnValue_1) == 0x000025, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_BooleanAND_ReturnValue_1) == 0x000026, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface) == 0x000028, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, K2Node_DynamicCast_bSuccess) == 0x000038, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Increment_Random_Weather, CallFunc_Interpolate_Weather_State_Success) == 0x000039, "Member 'Random_Weather_Variation_C_Increment_Random_Weather::CallFunc_Interpolate_Weather_State_Success' has a wrong offset!");
...
public:
	...
	TScriptInterface<class IUDW_and_Weather_Override_Volume_Interface_C> K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface; // 0x0068(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TScriptInterface<class IUDW_and_Weather_Override_Volume_Interface_C> K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface_1; // 0x0098(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Random_Weather_Variation_C_Instant_Material_Update) == 0x0000C0, "Wrong size on Random_Weather_Variation_C_Instant_Material_Update");
static_assert(offsetof(Random_Weather_Variation_C_Instant_Material_Update, K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface) == 0x000000, "Member 'Random_Weather_Variation_C_Instant_Material_Update::K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Instant_Material_Update, K2Node_DynamicCast_bSuccess) == 0x000010, "Member 'Random_Weather_Variation_C_Instant_Material_Update::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Instant_Material_Update, CallFunc_Get_Local_Weather_Source_Objects_Map) == 0x000018, "Member 'Random_Weather_Variation_C_Instant_Material_Update::CallFunc_Get_Local_Weather_Source_Objects_Map' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Instant_Material_Update, K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface) == 0x000068, "Member 'Random_Weather_Variation_C_Instant_Material_Update::K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Instant_Material_Update, K2Node_DynamicCast_bSuccess_1) == 0x000078, "Member 'Random_Weather_Variation_C_Instant_Material_Update::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Instant_Material_Update, K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface_1) == 0x000080, "Member 'Random_Weather_Variation_C_Instant_Material_Update::K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Instant_Material_Update, K2Node_DynamicCast_bSuccess_2) == 0x000090, "Member 'Random_Weather_Variation_C_Instant_Material_Update::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Instant_Material_Update, K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface_1) == 0x000098, "Member 'Random_Weather_Variation_C_Instant_Material_Update::K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Instant_Material_Update, K2Node_DynamicCast_bSuccess_3) == 0x0000A8, "Member 'Random_Weather_Variation_C_Instant_Material_Update::K2Node_DynamicCast_bSuccess_3' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Instant_Material_Update, CallFunc_Map_Find_Value) == 0x0000B0, "Member 'Random_Weather_Variation_C_Instant_Material_Update::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Instant_Material_Update, CallFunc_Map_Find_ReturnValue) == 0x0000B8, "Member 'Random_Weather_Variation_C_Instant_Material_Update::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Instant_Material_Update, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x0000B9, "Member 'Random_Weather_Variation_C_Instant_Material_Update::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
...
public:
	...
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TScriptInterface<class IUDW_and_Weather_Override_Volume_Interface_C> K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface_1; // 0x0020(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(Random_Weather_Variation_C_Random_Weather_Mode) == 0x000008, "Wrong alignment on Random_Weather_Variation_C_Random_Weather_Mode");
static_assert(sizeof(Random_Weather_Variation_C_Random_Weather_Mode) == 0x000038, "Wrong size on Random_Weather_Variation_C_Random_Weather_Mode");
...
static_assert(offsetof(Random_Weather_Variation_C_Random_Weather_Mode, K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface) == 0x000008, "Member 'Random_Weather_Variation_C_Random_Weather_Mode::K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Random_Weather_Mode, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'Random_Weather_Variation_C_Random_Weather_Mode::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Random_Weather_Mode, K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface_1) == 0x000020, "Member 'Random_Weather_Variation_C_Random_Weather_Mode::K2Node_DynamicCast_AsUDW__And_Weather_Override_Volume_Interface_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Random_Weather_Mode, K2Node_DynamicCast_bSuccess_1) == 0x000030, "Member 'Random_Weather_Variation_C_Random_Weather_Mode::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Random_Weather_Mode, CallFunc_Get_Random_Weather_Mode_Mode) == 0x000031, "Member 'Random_Weather_Variation_C_Random_Weather_Mode::CallFunc_Get_Random_Weather_Mode_Mode' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Random_Weather_Mode, CallFunc_Get_Random_Weather_Mode_Mode_1) == 0x000032, "Member 'Random_Weather_Variation_C_Random_Weather_Mode::CallFunc_Get_Random_Weather_Mode_Mode_1' has a wrong offset!");
...
static_assert(offsetof(Random_Weather_Variation_C_Set_New_Random_Interval_Timer, CallFunc_Random_Value_in_Float_Range_Structure_Out) == 0x000000, "Member 'Random_Weather_Variation_C_Set_New_Random_Interval_Timer::CallFunc_Random_Value_in_Float_Range_Structure_Out' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Set_New_Random_Interval_Timer, CallFunc_Map_Find_Value) == 0x000008, "Member 'Random_Weather_Variation_C_Set_New_Random_Interval_Timer::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Set_New_Random_Interval_Timer, CallFunc_Map_Find_ReturnValue) == 0x000010, "Member 'Random_Weather_Variation_C_Set_New_Random_Interval_Timer::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Set_New_Random_Interval_Timer, CallFunc_FMax_ReturnValue) == 0x000018, "Member 'Random_Weather_Variation_C_Set_New_Random_Interval_Timer::CallFunc_FMax_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Set_New_Random_Interval_Timer, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000020, "Member 'Random_Weather_Variation_C_Set_New_Random_Interval_Timer::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation) == 0x000108, "Wrong size on Random_Weather_Variation_C_Start_Up_Random_Weather_Variation");
...
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, Random_Forecast_Steps_0) == 0x000020, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::Random_Forecast_Steps_0' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, Blend_Season_Probabillities_0) == 0x000024, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::Blend_Season_Probabillities_0' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, Avoid_Extreme_Cloud_Coverage_Shifts_0) == 0x000025, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::Avoid_Extreme_Cloud_Coverage_Shifts_0' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, Avoid_Repeating_Weather_Types_0) == 0x000026, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::Avoid_Repeating_Weather_Types_0' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, Avoid_Changing_From_Snow_To_Rain_0) == 0x000027, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::Avoid_Changing_From_Snow_To_Rain_0' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, Extreme_Cloud_Coverage_Shift_Threshold_0) == 0x000028, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::Extreme_Cloud_Coverage_Shift_Threshold_0' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, Transition_Length_0) == 0x000030, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::Transition_Length_0' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, Weather_Specific_Interval_Multipliers_0) == 0x000038, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::Weather_Specific_Interval_Multipliers_0' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, Change_Interval_0) == 0x000088, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::Change_Interval_0' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, Random_Weather_Change_Hour_0) == 0x000098, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::Random_Weather_Change_Hour_0' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, Material_Manager) == 0x0000A0, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::Material_Manager' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, Random_Stream_0) == 0x0000A8, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::Random_Stream_0' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, CallFunc_GetOwner_ReturnValue) == 0x0000B0, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, CallFunc_HasAuthority_ReturnValue) == 0x0000B8, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, CallFunc_K2_SetTimerForNextTick_ReturnValue) == 0x0000C0, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::CallFunc_K2_SetTimerForNextTick_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, CallFunc_IsServer_ReturnValue) == 0x0000C8, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::CallFunc_IsServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, CallFunc_SpawnObject_ReturnValue) == 0x0000D0, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::CallFunc_SpawnObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, CallFunc_IsDedicatedServer_ReturnValue) == 0x0000D8, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface) == 0x0000E0, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::K2Node_DynamicCast_AsUltra_Dynamic_Weather_Interface' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, K2Node_DynamicCast_bSuccess) == 0x0000F0, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, CallFunc_Get_UDW_Current_UDS_Reference_UDS) == 0x0000F8, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::CallFunc_Get_UDW_Current_UDS_Reference_UDS' has a wrong offset!");
static_assert(offsetof(Random_Weather_Variation_C_Start_Up_Random_Weather_Variation, CallFunc_K2_SetTimer_ReturnValue) == 0x000100, "Member 'Random_Weather_Variation_C_Start_Up_Random_Weather_Variation::CallFunc_K2_SetTimer_ReturnValue' has a wrong offset!");
