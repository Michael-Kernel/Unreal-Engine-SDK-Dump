...
void UWeatherMask_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WeatherMask_C", "ReceiveTick");

	Params::WeatherMask_C_ReceiveTick Parms{};
...
void UWeatherMask_C::Tick_Fade(double Delta)
{
	static class UFunction* Func = nullptr;
	...
	Params::WeatherMask_C_Tick_Fade Parms{};
