...
static_assert(sizeof(UltraDynamicSky_Functions_C_Apply_Saved_UDS_and_UDW_State_·_𝖴𝖣𝖲) == 0x000238, "Wrong size on UltraDynamicSky_Functions_C_Apply_Saved_UDS_and_UDW_State_·_𝖴𝖣𝖲");
...
static_assert(offsetof(UltraDynamicSky_Functions_C_Apply_Saved_UDS_and_UDW_State_·_𝖴𝖣𝖲, __WorldContext) == 0x000220, "Member 'UltraDynamicSky_Functions_C_Apply_Saved_UDS_and_UDW_State_·_𝖴𝖣𝖲::__WorldContext' has a wrong offset!");
static_assert(offsetof(UltraDynamicSky_Functions_C_Apply_Saved_UDS_and_UDW_State_·_𝖴𝖣𝖲, CallFunc_Get_Ultra_Dynamic_Sky_UDS) == 0x000228, "Member 'UltraDynamicSky_Functions_C_Apply_Saved_UDS_and_UDW_State_·_𝖴𝖣𝖲::CallFunc_Get_Ultra_Dynamic_Sky_UDS' has a wrong offset!");
static_assert(offsetof(UltraDynamicSky_Functions_C_Apply_Saved_UDS_and_UDW_State_·_𝖴𝖣𝖲, CallFunc_Get_Ultra_Dynamic_Sky_Valid) == 0x000230, "Member 'UltraDynamicSky_Functions_C_Apply_Saved_UDS_and_UDW_State_·_𝖴𝖣𝖲::CallFunc_Get_Ultra_Dynamic_Sky_Valid' has a wrong offset!");
...
static_assert(sizeof(UltraDynamicSky_Functions_C_Create_UDS_and_UDW_State_for_Saving_·_𝖴𝖣𝖲) == 0x000458, "Wrong size on UltraDynamicSky_Functions_C_Create_UDS_and_UDW_State_for_Saving_·_𝖴𝖣𝖲");
...
static_assert(offsetof(UltraDynamicSky_Functions_C_Create_UDS_and_UDW_State_for_Saving_·_𝖴𝖣𝖲, CallFunc_Get_Ultra_Dynamic_Sky_UDS) == 0x000228, "Member 'UltraDynamicSky_Functions_C_Create_UDS_and_UDW_State_for_Saving_·_𝖴𝖣𝖲::CallFunc_Get_Ultra_Dynamic_Sky_UDS' has a wrong offset!");
static_assert(offsetof(UltraDynamicSky_Functions_C_Create_UDS_and_UDW_State_for_Saving_·_𝖴𝖣𝖲, CallFunc_Get_Ultra_Dynamic_Sky_Valid) == 0x000230, "Member 'UltraDynamicSky_Functions_C_Create_UDS_and_UDW_State_for_Saving_·_𝖴𝖣𝖲::CallFunc_Get_Ultra_Dynamic_Sky_Valid' has a wrong offset!");
static_assert(offsetof(UltraDynamicSky_Functions_C_Create_UDS_and_UDW_State_for_Saving_·_𝖴𝖣𝖲, CallFunc_Create_UDS_and_UDW_State_for_Saving_Packaged_State) == 0x000238, "Member 'UltraDynamicSky_Functions_C_Create_UDS_and_UDW_State_for_Saving_·_𝖴𝖣𝖲::CallFunc_Create_UDS_and_UDW_State_for_Saving_Packaged_State' has a wrong offset!");
...
static_assert(sizeof(UltraDynamicSky_Functions_C_Get_TimeCode_·_𝖴𝖣𝖲) == 0x000048, "Wrong size on UltraDynamicSky_Functions_C_Get_TimeCode_·_𝖴𝖣𝖲");
