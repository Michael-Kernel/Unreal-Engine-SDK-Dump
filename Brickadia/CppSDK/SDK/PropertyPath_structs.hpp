...
public:
	...
	class UStruct*                                struct_0;                                          // 0x0010(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(FPropertyPathSegment, struct_0) == 0x000010, "Member 'FPropertyPathSegment::struct_0' has a wrong offset!");
