...
static_assert(offsetof(WeatherMask_C_Editor_Update, CallFunc_Not_PreBool_ReturnValue) == 0x000002, "Member 'WeatherMask_C_Editor_Update::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WeatherMask_C_Editor_Update, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'WeatherMask_C_Editor_Update::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Editor_Update, CallFunc_Runtime_or_Initializing_ReturnValue) == 0x000011, "Member 'WeatherMask_C_Editor_Update::CallFunc_Runtime_or_Initializing_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Editor_Update, CallFunc_Not_PreBool_ReturnValue_1) == 0x000012, "Member 'WeatherMask_C_Editor_Update::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Editor_Update, CallFunc_BooleanAND_ReturnValue) == 0x000013, "Member 'WeatherMask_C_Editor_Update::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
public:
	...
	double                                        CallFunc_Tick_Fade_Delta_ImplicitCast;             // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WeatherMask_C_ExecuteUbergraph_WeatherMask) == 0x000048, "Wrong size on WeatherMask_C_ExecuteUbergraph_WeatherMask");
...
static_assert(offsetof(WeatherMask_C_ExecuteUbergraph_WeatherMask, K2Node_Event_DeltaSeconds) == 0x000004, "Member 'WeatherMask_C_ExecuteUbergraph_WeatherMask::K2Node_Event_DeltaSeconds' has a wrong offset!");
...
static_assert(offsetof(WeatherMask_C_ExecuteUbergraph_WeatherMask, CallFunc_Tick_Fade_Delta_ImplicitCast) == 0x000040, "Member 'WeatherMask_C_ExecuteUbergraph_WeatherMask::CallFunc_Tick_Fade_Delta_ImplicitCast' has a wrong offset!");
...
static_assert(alignof(WeatherMask_C_Fade_Mask_Over_Time) == 0x000008, "Wrong alignment on WeatherMask_C_Fade_Mask_Over_Time");
static_assert(sizeof(WeatherMask_C_Fade_Mask_Over_Time) == 0x000020, "Wrong size on WeatherMask_C_Fade_Mask_Over_Time");
static_assert(offsetof(WeatherMask_C_Fade_Mask_Over_Time, Fade_Duration_0) == 0x000000, "Member 'WeatherMask_C_Fade_Mask_Over_Time::Fade_Duration_0' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Fade_Mask_Over_Time, Param_Dust_0) == 0x000008, "Member 'WeatherMask_C_Fade_Mask_Over_Time::Param_Dust_0' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Fade_Mask_Over_Time, New_Mask_Wetness) == 0x000010, "Member 'WeatherMask_C_Fade_Mask_Over_Time::New_Mask_Wetness' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Fade_Mask_Over_Time, CallFunc_FMax_ReturnValue) == 0x000018, "Member 'WeatherMask_C_Fade_Mask_Over_Time::CallFunc_FMax_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WeatherMask_C_Get_Brush_Yaw, CallFunc_BreakRotator_Pitch) == 0x000028, "Member 'WeatherMask_C_Get_Brush_Yaw::CallFunc_BreakRotator_Pitch' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Get_Brush_Yaw, CallFunc_BreakRotator_Yaw) == 0x000030, "Member 'WeatherMask_C_Get_Brush_Yaw::CallFunc_BreakRotator_Yaw' has a wrong offset!");
...
// Function WeatherMask.WeatherMask_C.ReceiveTick
// 0x0004 (0x0004 - 0x0000)
struct WeatherMask_C_ReceiveTick final
{
public:
	float                                         DeltaSeconds;                                      // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WeatherMask_C_ReceiveTick) == 0x000004, "Wrong alignment on WeatherMask_C_ReceiveTick");
static_assert(sizeof(WeatherMask_C_ReceiveTick) == 0x000004, "Wrong size on WeatherMask_C_ReceiveTick");
static_assert(offsetof(WeatherMask_C_ReceiveTick, DeltaSeconds) == 0x000000, "Member 'WeatherMask_C_ReceiveTick::DeltaSeconds' has a wrong offset!");
...
static_assert(alignof(WeatherMask_C_Tick_Fade) == 0x000008, "Wrong alignment on WeatherMask_C_Tick_Fade");
static_assert(sizeof(WeatherMask_C_Tick_Fade) == 0x000040, "Wrong size on WeatherMask_C_Tick_Fade");
static_assert(offsetof(WeatherMask_C_Tick_Fade, Delta) == 0x000000, "Member 'WeatherMask_C_Tick_Fade::Delta' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Tick_Fade, Alpha) == 0x000008, "Member 'WeatherMask_C_Tick_Fade::Alpha' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Tick_Fade, CallFunc_GreaterEqual_DoubleDouble_ReturnValue) == 0x000010, "Member 'WeatherMask_C_Tick_Fade::CallFunc_GreaterEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Tick_Fade, CallFunc_Lerp_ReturnValue) == 0x000018, "Member 'WeatherMask_C_Tick_Fade::CallFunc_Lerp_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Tick_Fade, CallFunc_Lerp_ReturnValue_1) == 0x000020, "Member 'WeatherMask_C_Tick_Fade::CallFunc_Lerp_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Tick_Fade, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000028, "Member 'WeatherMask_C_Tick_Fade::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Tick_Fade, CallFunc_FClamp_ReturnValue) == 0x000030, "Member 'WeatherMask_C_Tick_Fade::CallFunc_FClamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Tick_Fade, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000038, "Member 'WeatherMask_C_Tick_Fade::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
