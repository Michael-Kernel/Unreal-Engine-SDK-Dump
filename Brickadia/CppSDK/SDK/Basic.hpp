...
namespace Offsets
{
	constexpr int32 GObjects          = 0x084567F8;
	constexpr int32 AppendString      = 0x00248CB0;
	constexpr int32 GNames            = 0x00000000;
	constexpr int32 GWorld            = 0x0864F2E0;
	constexpr int32 ProcessEvent      = 0x00504140;
...
static_assert(sizeof(FTextData) == 0x000028, "Wrong size on FTextData");
static_assert(offsetof(FTextData, TextSource) == 0x000018, "Member 'FTextData::TextSource' has a wrong offset!");
}
