...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"ComponentBoundTransformProxy">();
	}
...
static_assert(alignof(UComponentBoundTransformProxy) == 0x000010, "Wrong alignment on UComponentBoundTransformProxy");
static_assert(sizeof(UComponentBoundTransformProxy) == 0x0001C0, "Wrong size on UComponentBoundTransformProxy");
...
// 0x0000 (0x0028 - 0x0028)
class IGizmoBaseComponentInterface final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"GizmoBaseComponentInterface">();
	}
...
static_assert(alignof(IGizmoBaseComponentInterface) == 0x000008, "Wrong alignment on IGizmoBaseComponentInterface");
static_assert(sizeof(IGizmoBaseComponentInterface) == 0x000028, "Wrong size on IGizmoBaseComponentInterface");
...
public:
	...
	struct FLinearColor                           Color;                                             // 0x04D0(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HoverSizeMultiplier;                               // 0x04E0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PixelHitDistanceThreshold;                         // 0x04E4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4E8[0x8];                                      // 0x04E8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UGizmoViewContext*                      GizmoViewContext;                                  // 0x04F0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UGizmoBaseComponent, Color) == 0x0004D0, "Member 'UGizmoBaseComponent::Color' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, HoverSizeMultiplier) == 0x0004E0, "Member 'UGizmoBaseComponent::HoverSizeMultiplier' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, PixelHitDistanceThreshold) == 0x0004E4, "Member 'UGizmoBaseComponent::PixelHitDistanceThreshold' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, GizmoViewContext) == 0x0004F0, "Member 'UGizmoBaseComponent::GizmoViewContext' has a wrong offset!");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"SimpleLambdaInteractiveGizmoBuilder">();
	}
...
static_assert(alignof(USimpleLambdaInteractiveGizmoBuilder) == 0x000008, "Wrong alignment on USimpleLambdaInteractiveGizmoBuilder");
static_assert(sizeof(USimpleLambdaInteractiveGizmoBuilder) == 0x000070, "Wrong size on USimpleLambdaInteractiveGizmoBuilder");
...
static_assert(sizeof(AInternalToolFrameworkActor) == 0x0002B8, "Wrong size on AInternalToolFrameworkActor");
static_assert(offsetof(AInternalToolFrameworkActor, bIsSelectableInEditor) == 0x0002B0, "Member 'AInternalToolFrameworkActor::bIsSelectableInEditor' has a wrong offset!");
...
class alignas(0x10) UInteractiveToolsContext : public UObject
{
public:
...
// 0x0000 (0x0028 - 0x0028)
class IInteractiveToolShutdownQueryAPI final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"InteractiveToolShutdownQueryAPI">();
	}
...
static_assert(alignof(IInteractiveToolShutdownQueryAPI) == 0x000008, "Wrong alignment on IInteractiveToolShutdownQueryAPI");
static_assert(sizeof(IInteractiveToolShutdownQueryAPI) == 0x000028, "Wrong size on IInteractiveToolShutdownQueryAPI");
...
// 0x0000 (0x0028 - 0x0028)
class IInteractiveToolManageGeometrySelectionAPI final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(alignof(IInteractiveToolManageGeometrySelectionAPI) == 0x000008, "Wrong alignment on IInteractiveToolManageGeometrySelectionAPI");
static_assert(sizeof(IInteractiveToolManageGeometrySelectionAPI) == 0x000028, "Wrong size on IInteractiveToolManageGeometrySelectionAPI");
...
static_assert(sizeof(UGizmoUniformScaleParameterSource) == 0x0001F0, "Wrong size on UGizmoUniformScaleParameterSource");
static_assert(offsetof(UGizmoUniformScaleParameterSource, AxisSource) == 0x0000D0, "Member 'UGizmoUniformScaleParameterSource::AxisSource' has a wrong offset!");
static_assert(offsetof(UGizmoUniformScaleParameterSource, TransformSource) == 0x0000E0, "Member 'UGizmoUniformScaleParameterSource::TransformSource' has a wrong offset!");
static_assert(offsetof(UGizmoUniformScaleParameterSource, ScaleMultiplier) == 0x0000F0, "Member 'UGizmoUniformScaleParameterSource::ScaleMultiplier' has a wrong offset!");
static_assert(offsetof(UGizmoUniformScaleParameterSource, Parameter) == 0x0000F8, "Member 'UGizmoUniformScaleParameterSource::Parameter' has a wrong offset!");
static_assert(offsetof(UGizmoUniformScaleParameterSource, LastChange) == 0x000108, "Member 'UGizmoUniformScaleParameterSource::LastChange' has a wrong offset!");
static_assert(offsetof(UGizmoUniformScaleParameterSource, CurScaleOrigin) == 0x000128, "Member 'UGizmoUniformScaleParameterSource::CurScaleOrigin' has a wrong offset!");
static_assert(offsetof(UGizmoUniformScaleParameterSource, CurScaleNormal) == 0x000140, "Member 'UGizmoUniformScaleParameterSource::CurScaleNormal' has a wrong offset!");
static_assert(offsetof(UGizmoUniformScaleParameterSource, CurScaleAxisX) == 0x000158, "Member 'UGizmoUniformScaleParameterSource::CurScaleAxisX' has a wrong offset!");
static_assert(offsetof(UGizmoUniformScaleParameterSource, CurScaleAxisY) == 0x000170, "Member 'UGizmoUniformScaleParameterSource::CurScaleAxisY' has a wrong offset!");
static_assert(offsetof(UGizmoUniformScaleParameterSource, InitialTransform) == 0x000190, "Member 'UGizmoUniformScaleParameterSource::InitialTransform' has a wrong offset!");
...
static_assert(sizeof(UGizmoAxisScaleParameterSource) == 0x0001A0, "Wrong size on UGizmoAxisScaleParameterSource");
static_assert(offsetof(UGizmoAxisScaleParameterSource, AxisSource) == 0x0000D0, "Member 'UGizmoAxisScaleParameterSource::AxisSource' has a wrong offset!");
static_assert(offsetof(UGizmoAxisScaleParameterSource, TransformSource) == 0x0000E0, "Member 'UGizmoAxisScaleParameterSource::TransformSource' has a wrong offset!");
static_assert(offsetof(UGizmoAxisScaleParameterSource, ScaleMultiplier) == 0x0000F0, "Member 'UGizmoAxisScaleParameterSource::ScaleMultiplier' has a wrong offset!");
static_assert(offsetof(UGizmoAxisScaleParameterSource, bClampToZero) == 0x0000F4, "Member 'UGizmoAxisScaleParameterSource::bClampToZero' has a wrong offset!");
static_assert(offsetof(UGizmoAxisScaleParameterSource, Parameter) == 0x0000F8, "Member 'UGizmoAxisScaleParameterSource::Parameter' has a wrong offset!");
static_assert(offsetof(UGizmoAxisScaleParameterSource, LastChange) == 0x0000FC, "Member 'UGizmoAxisScaleParameterSource::LastChange' has a wrong offset!");
static_assert(offsetof(UGizmoAxisScaleParameterSource, CurScaleAxis) == 0x000108, "Member 'UGizmoAxisScaleParameterSource::CurScaleAxis' has a wrong offset!");
static_assert(offsetof(UGizmoAxisScaleParameterSource, CurScaleOrigin) == 0x000120, "Member 'UGizmoAxisScaleParameterSource::CurScaleOrigin' has a wrong offset!");
static_assert(offsetof(UGizmoAxisScaleParameterSource, InitialTransform) == 0x000140, "Member 'UGizmoAxisScaleParameterSource::InitialTransform' has a wrong offset!");
...
static_assert(sizeof(UGizmoPlaneScaleParameterSource) == 0x000270, "Wrong size on UGizmoPlaneScaleParameterSource");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, AxisSource) == 0x000150, "Member 'UGizmoPlaneScaleParameterSource::AxisSource' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, TransformSource) == 0x000160, "Member 'UGizmoPlaneScaleParameterSource::TransformSource' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, ScaleMultiplier) == 0x000170, "Member 'UGizmoPlaneScaleParameterSource::ScaleMultiplier' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, bUseEqualScaling) == 0x000174, "Member 'UGizmoPlaneScaleParameterSource::bUseEqualScaling' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, bClampToZero) == 0x000175, "Member 'UGizmoPlaneScaleParameterSource::bClampToZero' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, Parameter) == 0x000178, "Member 'UGizmoPlaneScaleParameterSource::Parameter' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, LastChange) == 0x000188, "Member 'UGizmoPlaneScaleParameterSource::LastChange' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, CurScaleOrigin) == 0x0001A8, "Member 'UGizmoPlaneScaleParameterSource::CurScaleOrigin' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, CurScaleNormal) == 0x0001C0, "Member 'UGizmoPlaneScaleParameterSource::CurScaleNormal' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, CurScaleAxisX) == 0x0001D8, "Member 'UGizmoPlaneScaleParameterSource::CurScaleAxisX' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, CurScaleAxisY) == 0x0001F0, "Member 'UGizmoPlaneScaleParameterSource::CurScaleAxisY' has a wrong offset!");
static_assert(offsetof(UGizmoPlaneScaleParameterSource, InitialTransform) == 0x000210, "Member 'UGizmoPlaneScaleParameterSource::InitialTransform' has a wrong offset!");
...
public:
	...
	class USingleClickInputBehavior*              ClickBehavior;                                     // 0x0070(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"SimpleSingleClickGizmo">();
	}
...
static_assert(alignof(USimpleSingleClickGizmo) == 0x000008, "Wrong alignment on USimpleSingleClickGizmo");
static_assert(sizeof(USimpleSingleClickGizmo) == 0x000078, "Wrong size on USimpleSingleClickGizmo");
static_assert(offsetof(USimpleSingleClickGizmo, HitTarget) == 0x000060, "Member 'USimpleSingleClickGizmo::HitTarget' has a wrong offset!");
static_assert(offsetof(USimpleSingleClickGizmo, ClickBehavior) == 0x000070, "Member 'USimpleSingleClickGizmo::ClickBehavior' has a wrong offset!");
...
static_assert(offsetof(UGizmoObjectModifyStateTarget, TransactionManager) == 0x000048, "Member 'UGizmoObjectModifyStateTarget::TransactionManager' has a wrong offset!");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"ToolsContextCursorAPI">();
	}
...
static_assert(alignof(UToolsContextCursorAPI) == 0x000008, "Wrong alignment on UToolsContextCursorAPI");
static_assert(sizeof(UToolsContextCursorAPI) == 0x000030, "Wrong size on UToolsContextCursorAPI");
...
public:
	...
	class UGizmoViewContext*                      GizmoViewContext;                                  // 0x05A0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPrimitiveComponent*                    SubstituteInteractionComponent;                    // 0x05A8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMaterialInterface*                     HoverOverrideMaterial;                             // 0x05B0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_5B8[0x18];                                     // 0x05B8(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"ViewAdjustedStaticMeshGizmoComponent">();
	}
...
static_assert(alignof(UViewAdjustedStaticMeshGizmoComponent) == 0x000010, "Wrong alignment on UViewAdjustedStaticMeshGizmoComponent");
static_assert(sizeof(UViewAdjustedStaticMeshGizmoComponent) == 0x0005D0, "Wrong size on UViewAdjustedStaticMeshGizmoComponent");
static_assert(offsetof(UViewAdjustedStaticMeshGizmoComponent, GizmoViewContext) == 0x0005A0, "Member 'UViewAdjustedStaticMeshGizmoComponent::GizmoViewContext' has a wrong offset!");
static_assert(offsetof(UViewAdjustedStaticMeshGizmoComponent, SubstituteInteractionComponent) == 0x0005A8, "Member 'UViewAdjustedStaticMeshGizmoComponent::SubstituteInteractionComponent' has a wrong offset!");
static_assert(offsetof(UViewAdjustedStaticMeshGizmoComponent, HoverOverrideMaterial) == 0x0005B0, "Member 'UViewAdjustedStaticMeshGizmoComponent::HoverOverrideMaterial' has a wrong offset!");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"DoubleClickInputBehavior">();
	}
...
static_assert(alignof(UDoubleClickInputBehavior) == 0x000008, "Wrong alignment on UDoubleClickInputBehavior");
static_assert(sizeof(UDoubleClickInputBehavior) == 0x000130, "Wrong size on UDoubleClickInputBehavior");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"LocalDoubleClickInputBehavior">();
	}
...
static_assert(alignof(ULocalDoubleClickInputBehavior) == 0x000008, "Wrong alignment on ULocalDoubleClickInputBehavior");
static_assert(sizeof(ULocalDoubleClickInputBehavior) == 0x000200, "Wrong size on ULocalDoubleClickInputBehavior");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"KeyInputBehavior">();
	}
...
static_assert(alignof(UKeyInputBehavior) == 0x000008, "Wrong alignment on UKeyInputBehavior");
static_assert(sizeof(UKeyInputBehavior) == 0x000110, "Wrong size on UKeyInputBehavior");
...
static_assert(sizeof(UMouseHoverBehavior) == 0x0000E0, "Wrong size on UMouseHoverBehavior");
...
static_assert(sizeof(ULocalMouseHoverBehavior) == 0x000220, "Wrong size on ULocalMouseHoverBehavior");
...
static_assert(sizeof(UMultiClickSequenceInputBehavior) == 0x000170, "Wrong size on UMultiClickSequenceInputBehavior");
...
static_assert(offsetof(UBrushStampIndicator, BrushStrength) == 0x000044, "Member 'UBrushStampIndicator::BrushStrength' has a wrong offset!");
...
static_assert(offsetof(UBrushStampIndicator, bScaleNormalByStrength) == 0x00007A, "Member 'UBrushStampIndicator::bScaleNormalByStrength' has a wrong offset!");
...
static_assert(sizeof(AGizmoActor) == 0x0002B8, "Wrong size on AGizmoActor");
...
{
public:
	class UPrimitiveComponent*                    TranslateX;                                        // 0x02B8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateY;                                        // 0x02C0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateZ;                                        // 0x02C8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateYZ;                                       // 0x02D0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateXZ;                                       // 0x02D8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    TranslateXY;                                       // 0x02E0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotateX;                                           // 0x02E8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotateY;                                           // 0x02F0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotateZ;                                           // 0x02F8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    RotationSphere;                                    // 0x0300(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    UniformScale;                                      // 0x0308(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    AxisScaleX;                                        // 0x0310(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    AxisScaleY;                                        // 0x0318(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    AxisScaleZ;                                        // 0x0320(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    PlaneScaleYZ;                                      // 0x0328(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    PlaneScaleXZ;                                      // 0x0330(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPrimitiveComponent*                    PlaneScaleXY;                                      // 0x0338(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ACombinedTransformGizmoActor) == 0x000340, "Wrong size on ACombinedTransformGizmoActor");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateX) == 0x0002B8, "Member 'ACombinedTransformGizmoActor::TranslateX' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateY) == 0x0002C0, "Member 'ACombinedTransformGizmoActor::TranslateY' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateZ) == 0x0002C8, "Member 'ACombinedTransformGizmoActor::TranslateZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateYZ) == 0x0002D0, "Member 'ACombinedTransformGizmoActor::TranslateYZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateXZ) == 0x0002D8, "Member 'ACombinedTransformGizmoActor::TranslateXZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, TranslateXY) == 0x0002E0, "Member 'ACombinedTransformGizmoActor::TranslateXY' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, RotateX) == 0x0002E8, "Member 'ACombinedTransformGizmoActor::RotateX' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, RotateY) == 0x0002F0, "Member 'ACombinedTransformGizmoActor::RotateY' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, RotateZ) == 0x0002F8, "Member 'ACombinedTransformGizmoActor::RotateZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, RotationSphere) == 0x000300, "Member 'ACombinedTransformGizmoActor::RotationSphere' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, UniformScale) == 0x000308, "Member 'ACombinedTransformGizmoActor::UniformScale' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, AxisScaleX) == 0x000310, "Member 'ACombinedTransformGizmoActor::AxisScaleX' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, AxisScaleY) == 0x000318, "Member 'ACombinedTransformGizmoActor::AxisScaleY' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, AxisScaleZ) == 0x000320, "Member 'ACombinedTransformGizmoActor::AxisScaleZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, PlaneScaleYZ) == 0x000328, "Member 'ACombinedTransformGizmoActor::PlaneScaleYZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, PlaneScaleXZ) == 0x000330, "Member 'ACombinedTransformGizmoActor::PlaneScaleXZ' has a wrong offset!");
static_assert(offsetof(ACombinedTransformGizmoActor, PlaneScaleXY) == 0x000338, "Member 'ACombinedTransformGizmoActor::PlaneScaleXY' has a wrong offset!");
...
static_assert(offsetof(UCombinedTransformGizmo, bSnapToScaleGrid) == 0x000081, "Member 'UCombinedTransformGizmo::bSnapToScaleGrid' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, bUseContextCoordinateSystem) == 0x000082, "Member 'UCombinedTransformGizmo::bUseContextCoordinateSystem' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, CurrentCoordinateSystem) == 0x000083, "Member 'UCombinedTransformGizmo::CurrentCoordinateSystem' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, bUseContextGizmoMode) == 0x000084, "Member 'UCombinedTransformGizmo::bUseContextGizmoMode' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, ActiveGizmoMode) == 0x000085, "Member 'UCombinedTransformGizmo::ActiveGizmoMode' has a wrong offset!");
...
{
public:
	struct FVector                                Direction;                                         // 0x0500(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Gap;                                               // 0x0518(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Length;                                            // 0x051C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Thickness;                                         // 0x0520(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGizmoArrowComponent, Gap) == 0x000518, "Member 'UGizmoArrowComponent::Gap' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Length) == 0x00051C, "Member 'UGizmoArrowComponent::Length' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Thickness) == 0x000520, "Member 'UGizmoArrowComponent::Thickness' has a wrong offset!");
...
{
public:
	struct FVector                                Origin;                                            // 0x0500(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_518[0x8];                                      // 0x0518(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FQuat                                  Rotation;                                          // 0x0520(0x0020)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Dimensions;                                        // 0x0540(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bRemoveHiddenLines;                                // 0x055C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableAxisFlip;                                   // 0x055D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_55E[0x2];                                      // 0x055E(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UGizmoBoxComponent) == 0x000560, "Wrong size on UGizmoBoxComponent");
...
static_assert(offsetof(UGizmoBoxComponent, Dimensions) == 0x000540, "Member 'UGizmoBoxComponent::Dimensions' has a wrong offset!");
static_assert(offsetof(UGizmoBoxComponent, LineThickness) == 0x000558, "Member 'UGizmoBoxComponent::LineThickness' has a wrong offset!");
static_assert(offsetof(UGizmoBoxComponent, bRemoveHiddenLines) == 0x00055C, "Member 'UGizmoBoxComponent::bRemoveHiddenLines' has a wrong offset!");
static_assert(offsetof(UGizmoBoxComponent, bEnableAxisFlip) == 0x00055D, "Member 'UGizmoBoxComponent::bEnableAxisFlip' has a wrong offset!");
...
{
public:
	struct FVector                                Normal;                                            // 0x0500(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	int32                                         NumSides;                                          // 0x0520(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bViewAligned;                                      // 0x0524(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDrawFullCircle;                                   // 0x0525(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOnlyAllowFrontFacingHits;                         // 0x0526(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_527[0x9];                                      // 0x0527(0x0009)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UGizmoCircleComponent, Radius) == 0x000518, "Member 'UGizmoCircleComponent::Radius' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, Thickness) == 0x00051C, "Member 'UGizmoCircleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, NumSides) == 0x000520, "Member 'UGizmoCircleComponent::NumSides' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bViewAligned) == 0x000524, "Member 'UGizmoCircleComponent::bViewAligned' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bDrawFullCircle) == 0x000525, "Member 'UGizmoCircleComponent::bDrawFullCircle' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bOnlyAllowFrontFacingHits) == 0x000526, "Member 'UGizmoCircleComponent::bOnlyAllowFrontFacingHits' has a wrong offset!");
...
// 0x0068 (0x0090 - 0x0028)
class alignas(0x10) UGizmoElementHitMultiTarget : public UObject
{
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UGizmoElementBase*                      GizmoElement;                                      // 0x0030(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(UGizmoElementLineStrip) == 0x000008, "Wrong alignment on UGizmoElementLineStrip");
static_assert(sizeof(UGizmoElementLineStrip) == 0x0001C8, "Wrong size on UGizmoElementLineStrip");
static_assert(offsetof(UGizmoElementLineStrip, Vertices) == 0x000158, "Member 'UGizmoElementLineStrip::Vertices' has a wrong offset!");
static_assert(offsetof(UGizmoElementLineStrip, base) == 0x000168, "Member 'UGizmoElementLineStrip::base' has a wrong offset!");
static_assert(offsetof(UGizmoElementLineStrip, UpDirection) == 0x000180, "Member 'UGizmoElementLineStrip::UpDirection' has a wrong offset!");
static_assert(offsetof(UGizmoElementLineStrip, SideDirection) == 0x000198, "Member 'UGizmoElementLineStrip::SideDirection' has a wrong offset!");
static_assert(offsetof(UGizmoElementLineStrip, bDrawLineStrip) == 0x0001B0, "Member 'UGizmoElementLineStrip::bDrawLineStrip' has a wrong offset!");
...
static_assert(alignof(UGizmoElementSphere) == 0x000008, "Wrong alignment on UGizmoElementSphere");
static_assert(sizeof(UGizmoElementSphere) == 0x000128, "Wrong size on UGizmoElementSphere");
static_assert(offsetof(UGizmoElementSphere, Center) == 0x000108, "Member 'UGizmoElementSphere::Center' has a wrong offset!");
static_assert(offsetof(UGizmoElementSphere, Radius) == 0x000120, "Member 'UGizmoElementSphere::Radius' has a wrong offset!");
static_assert(offsetof(UGizmoElementSphere, NumSides) == 0x000124, "Member 'UGizmoElementSphere::NumSides' has a wrong offset!");
...
static_assert(alignof(UGizmoElementTriangleList) == 0x000008, "Wrong alignment on UGizmoElementTriangleList");
static_assert(sizeof(UGizmoElementTriangleList) == 0x000170, "Wrong size on UGizmoElementTriangleList");
static_assert(offsetof(UGizmoElementTriangleList, Vertices) == 0x000108, "Member 'UGizmoElementTriangleList::Vertices' has a wrong offset!");
static_assert(offsetof(UGizmoElementTriangleList, base) == 0x000118, "Member 'UGizmoElementTriangleList::base' has a wrong offset!");
static_assert(offsetof(UGizmoElementTriangleList, UpDirection) == 0x000130, "Member 'UGizmoElementTriangleList::UpDirection' has a wrong offset!");
static_assert(offsetof(UGizmoElementTriangleList, SideDirection) == 0x000148, "Member 'UGizmoElementTriangleList::SideDirection' has a wrong offset!");
...
public:
	struct FVector                                Normal;                                            // 0x0500(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HandleSize;                                        // 0x0518(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Thickness;                                         // 0x051C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Direction;                                         // 0x0520(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Length;                                            // 0x0538(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bImageScale;                                       // 0x053C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGizmoLineHandleComponent) == 0x000540, "Wrong size on UGizmoLineHandleComponent");
...
static_assert(offsetof(UGizmoLineHandleComponent, HandleSize) == 0x000518, "Member 'UGizmoLineHandleComponent::HandleSize' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Thickness) == 0x00051C, "Member 'UGizmoLineHandleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Direction) == 0x000520, "Member 'UGizmoLineHandleComponent::Direction' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Length) == 0x000538, "Member 'UGizmoLineHandleComponent::Length' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, bImageScale) == 0x00053C, "Member 'UGizmoLineHandleComponent::bImageScale' has a wrong offset!");
...
{
public:
	struct FVector                                DirectionX;                                        // 0x0500(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                DirectionY;                                        // 0x0518(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOrientYAccordingToCamera;                         // 0x0530(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_531[0x3];                                      // 0x0531(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         OffsetX;                                           // 0x0534(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         OffsetY;                                           // 0x0538(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LengthX;                                           // 0x053C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LengthY;                                           // 0x0540(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         SegmentFlags;                                      // 0x0548(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGizmoRectangleComponent) == 0x000550, "Wrong size on UGizmoRectangleComponent");
...
static_assert(offsetof(UGizmoRectangleComponent, DirectionY) == 0x000518, "Member 'UGizmoRectangleComponent::DirectionY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, bOrientYAccordingToCamera) == 0x000530, "Member 'UGizmoRectangleComponent::bOrientYAccordingToCamera' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, OffsetX) == 0x000534, "Member 'UGizmoRectangleComponent::OffsetX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, OffsetY) == 0x000538, "Member 'UGizmoRectangleComponent::OffsetY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, LengthX) == 0x00053C, "Member 'UGizmoRectangleComponent::LengthX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, LengthY) == 0x000540, "Member 'UGizmoRectangleComponent::LengthY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, Thickness) == 0x000544, "Member 'UGizmoRectangleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, SegmentFlags) == 0x000548, "Member 'UGizmoRectangleComponent::SegmentFlags' has a wrong offset!");
...
{
public:
	class UGizmoLineHandleComponent*              UpIntervalComponent;                               // 0x02B8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGizmoLineHandleComponent*              DownIntervalComponent;                             // 0x02C0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGizmoLineHandleComponent*              ForwardIntervalComponent;                          // 0x02C8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(AIntervalGizmoActor, UpIntervalComponent) == 0x0002B8, "Member 'AIntervalGizmoActor::UpIntervalComponent' has a wrong offset!");
static_assert(offsetof(AIntervalGizmoActor, DownIntervalComponent) == 0x0002C0, "Member 'AIntervalGizmoActor::DownIntervalComponent' has a wrong offset!");
static_assert(offsetof(AIntervalGizmoActor, ForwardIntervalComponent) == 0x0002C8, "Member 'AIntervalGizmoActor::ForwardIntervalComponent' has a wrong offset!");
...
static_assert(sizeof(UPlanePositionGizmo) == 0x0002B0, "Wrong size on UPlanePositionGizmo");
...
static_assert(offsetof(UScalableSphereGizmo, Radius) == 0x000098, "Member 'UScalableSphereGizmo::Radius' has a wrong offset!");
static_assert(offsetof(UScalableSphereGizmo, bIsHovering) == 0x00009C, "Member 'UScalableSphereGizmo::bIsHovering' has a wrong offset!");
static_assert(offsetof(UScalableSphereGizmo, bIsDragging) == 0x00009D, "Member 'UScalableSphereGizmo::bIsDragging' has a wrong offset!");
static_assert(offsetof(UScalableSphereGizmo, ActiveTarget) == 0x0000A0, "Member 'UScalableSphereGizmo::ActiveTarget' has a wrong offset!");
static_assert(offsetof(UScalableSphereGizmo, ActiveAxis) == 0x0000A8, "Member 'UScalableSphereGizmo::ActiveAxis' has a wrong offset!");
static_assert(offsetof(UScalableSphereGizmo, DragStartWorldPosition) == 0x0000C0, "Member 'UScalableSphereGizmo::DragStartWorldPosition' has a wrong offset!");
static_assert(offsetof(UScalableSphereGizmo, DragCurrentPositionProjected) == 0x0000D8, "Member 'UScalableSphereGizmo::DragCurrentPositionProjected' has a wrong offset!");
static_assert(offsetof(UScalableSphereGizmo, InteractionStartParameter) == 0x0000F0, "Member 'UScalableSphereGizmo::InteractionStartParameter' has a wrong offset!");
...
static_assert(offsetof(UGizmoTransformChangeStateTarget, TransactionManager) == 0x000048, "Member 'UGizmoTransformChangeStateTarget::TransactionManager' has a wrong offset!");
...
static_assert(sizeof(UInteractiveToolManager) == 0x0001B0, "Wrong size on UInteractiveToolManager");
...
static_assert(offsetof(UInteractiveToolManager, ToolBuilders) == 0x000100, "Member 'UInteractiveToolManager::ToolBuilders' has a wrong offset!");
