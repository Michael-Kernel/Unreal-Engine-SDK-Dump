...
public:
	...
	class UTexture2D*                             BakedTexture;                                      // 0x0050(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FShallowWaterSimulationGrid) == 0x000008, "Wrong alignment on FShallowWaterSimulationGrid");
static_assert(sizeof(FShallowWaterSimulationGrid) == 0x000058, "Wrong size on FShallowWaterSimulationGrid");
static_assert(offsetof(FShallowWaterSimulationGrid, ArrayValues) == 0x000000, "Member 'FShallowWaterSimulationGrid::ArrayValues' has a wrong offset!");
static_assert(offsetof(FShallowWaterSimulationGrid, NumCells) == 0x000010, "Member 'FShallowWaterSimulationGrid::NumCells' has a wrong offset!");
static_assert(offsetof(FShallowWaterSimulationGrid, position) == 0x000018, "Member 'FShallowWaterSimulationGrid::position' has a wrong offset!");
static_assert(offsetof(FShallowWaterSimulationGrid, Size) == 0x000030, "Member 'FShallowWaterSimulationGrid::Size' has a wrong offset!");
static_assert(offsetof(FShallowWaterSimulationGrid, Dx) == 0x000040, "Member 'FShallowWaterSimulationGrid::Dx' has a wrong offset!");
static_assert(offsetof(FShallowWaterSimulationGrid, BakedTexture) == 0x000050, "Member 'FShallowWaterSimulationGrid::BakedTexture' has a wrong offset!");
...
static_assert(sizeof(FWaterBodyWeightmapSettings) == 0x000040, "Wrong size on FWaterBodyWeightmapSettings");
...
static_assert(offsetof(FWaterBodyWeightmapSettings, TextureTiling) == 0x000030, "Member 'FWaterBodyWeightmapSettings::TextureTiling' has a wrong offset!");
static_assert(offsetof(FWaterBodyWeightmapSettings, TextureInfluence) == 0x000034, "Member 'FWaterBodyWeightmapSettings::TextureInfluence' has a wrong offset!");
static_assert(offsetof(FWaterBodyWeightmapSettings, Midpoint) == 0x000038, "Member 'FWaterBodyWeightmapSettings::Midpoint' has a wrong offset!");
static_assert(offsetof(FWaterBodyWeightmapSettings, FinalOpacity) == 0x00003C, "Member 'FWaterBodyWeightmapSettings::FinalOpacity' has a wrong offset!");
...
public:
	...
	struct FPostProcessSettings                   PostProcessSettings;                               // 0x0010(0x0700)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     UnderwaterPostProcessMaterial;                     // 0x0710(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FUnderwaterPostProcessSettings) == 0x000720, "Wrong size on FUnderwaterPostProcessSettings");
...
static_assert(offsetof(FUnderwaterPostProcessSettings, UnderwaterPostProcessMaterial) == 0x000710, "Member 'FUnderwaterPostProcessSettings::UnderwaterPostProcessMaterial' has a wrong offset!");
...
static_assert(offsetof(FWaterBrushEffectDisplacement, Midpoint) == 0x000030, "Member 'FWaterBrushEffectDisplacement::Midpoint' has a wrong offset!");
static_assert(offsetof(FWaterBrushEffectDisplacement, Channel) == 0x000034, "Member 'FWaterBrushEffectDisplacement::Channel' has a wrong offset!");
static_assert(offsetof(FWaterBrushEffectDisplacement, WeightmapInfluence) == 0x000044, "Member 'FWaterBrushEffectDisplacement::WeightmapInfluence' has a wrong offset!");
...
static_assert(sizeof(FWaterBrushEffects) == 0x000080, "Wrong size on FWaterBrushEffects");
...
static_assert(offsetof(FWaterBrushEffects, SmoothBlending) == 0x000060, "Member 'FWaterBrushEffects::SmoothBlending' has a wrong offset!");
static_assert(offsetof(FWaterBrushEffects, Terracing) == 0x000068, "Member 'FWaterBrushEffects::Terracing' has a wrong offset!");
...
public:
	...
	int32                                         Priority;                                          // 0x0098(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWaterBodyHeightmapSettings) == 0x000008, "Wrong alignment on FWaterBodyHeightmapSettings");
static_assert(sizeof(FWaterBodyHeightmapSettings) == 0x0000A0, "Wrong size on FWaterBodyHeightmapSettings");
...
static_assert(offsetof(FWaterBodyHeightmapSettings, Priority) == 0x000098, "Member 'FWaterBodyHeightmapSettings::Priority' has a wrong offset!");
