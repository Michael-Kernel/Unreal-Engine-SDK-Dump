...
public:
	...
	struct FRigPhysicsSolverID                    ReturnValue;                                       // 0x000C(0x0010)(Parm, OutParm, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ControlRig_AddPhysicsSolver) == 0x000004, "Wrong alignment on ControlRig_AddPhysicsSolver");
static_assert(sizeof(ControlRig_AddPhysicsSolver) == 0x00001C, "Wrong size on ControlRig_AddPhysicsSolver");
static_assert(offsetof(ControlRig_AddPhysicsSolver, InName) == 0x000000, "Member 'ControlRig_AddPhysicsSolver::InName' has a wrong offset!");
static_assert(offsetof(ControlRig_AddPhysicsSolver, bSetupUndo) == 0x000008, "Member 'ControlRig_AddPhysicsSolver::bSetupUndo' has a wrong offset!");
static_assert(offsetof(ControlRig_AddPhysicsSolver, bPrintPythonCommand) == 0x000009, "Member 'ControlRig_AddPhysicsSolver::bPrintPythonCommand' has a wrong offset!");
static_assert(offsetof(ControlRig_AddPhysicsSolver, ReturnValue) == 0x00000C, "Member 'ControlRig_AddPhysicsSolver::ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigBoneElement                        ReturnValue;                                       // 0x0010(0x0118)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(RigHierarchy_FindBone_ForBlueprintOnly) == 0x000008, "Wrong alignment on RigHierarchy_FindBone_ForBlueprintOnly");
static_assert(sizeof(RigHierarchy_FindBone_ForBlueprintOnly) == 0x000128, "Wrong size on RigHierarchy_FindBone_ForBlueprintOnly");
...
public:
	struct FRigElementKey                         InKey;                                             // 0x0000(0x000C)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigControlElement                     ReturnValue;                                       // 0x0010(0x0500)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(RigHierarchy_FindControl_ForBlueprintOnly) == 0x000510, "Wrong size on RigHierarchy_FindControl_ForBlueprintOnly");
...
static_assert(sizeof(RigHierarchy_FindNull_ForBlueprintOnly) == 0x000220, "Wrong size on RigHierarchy_FindNull_ForBlueprintOnly");
...
static_assert(alignof(RigHierarchy_GetPhysicsKeys) == 0x000008, "Wrong alignment on RigHierarchy_GetPhysicsKeys");
static_assert(sizeof(RigHierarchy_GetPhysicsKeys) == 0x000018, "Wrong size on RigHierarchy_GetPhysicsKeys");
static_assert(offsetof(RigHierarchy_GetPhysicsKeys, bTraverse) == 0x000000, "Member 'RigHierarchy_GetPhysicsKeys::bTraverse' has a wrong offset!");
static_assert(offsetof(RigHierarchy_GetPhysicsKeys, ReturnValue) == 0x000008, "Member 'RigHierarchy_GetPhysicsKeys::ReturnValue' has a wrong offset!");
...
static_assert(alignof(ModularRigController_DeselectModule) == 0x000008, "Wrong alignment on ModularRigController_DeselectModule");
static_assert(sizeof(ModularRigController_DeselectModule) == 0x000018, "Wrong size on ModularRigController_DeselectModule");
static_assert(offsetof(ModularRigController_DeselectModule, InModulePath) == 0x000000, "Member 'ModularRigController_DeselectModule::InModulePath' has a wrong offset!");
static_assert(offsetof(ModularRigController_DeselectModule, ReturnValue) == 0x000010, "Member 'ModularRigController_DeselectModule::ReturnValue' has a wrong offset!");
...
static_assert(alignof(ModularRigController_SelectModule) == 0x000008, "Wrong alignment on ModularRigController_SelectModule");
static_assert(sizeof(ModularRigController_SelectModule) == 0x000018, "Wrong size on ModularRigController_SelectModule");
static_assert(offsetof(ModularRigController_SelectModule, InModulePath) == 0x000000, "Member 'ModularRigController_SelectModule::InModulePath' has a wrong offset!");
static_assert(offsetof(ModularRigController_SelectModule, InSelected) == 0x000010, "Member 'ModularRigController_SelectModule::InSelected' has a wrong offset!");
static_assert(offsetof(ModularRigController_SelectModule, ReturnValue) == 0x000011, "Member 'ModularRigController_SelectModule::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ModularRigController_SetModuleSelection, InModulePaths) == 0x000000, "Member 'ModularRigController_SetModuleSelection::InModulePaths' has a wrong offset!");
...
static_assert(offsetof(ModularRigController_SwapModuleClass, InModulePath) == 0x000000, "Member 'ModularRigController_SwapModuleClass::InModulePath' has a wrong offset!");
static_assert(offsetof(ModularRigController_SwapModuleClass, InNewClass) == 0x000010, "Member 'ModularRigController_SwapModuleClass::InNewClass' has a wrong offset!");
static_assert(offsetof(ModularRigController_SwapModuleClass, bSetupUndo) == 0x000018, "Member 'ModularRigController_SwapModuleClass::bSetupUndo' has a wrong offset!");
static_assert(offsetof(ModularRigController_SwapModuleClass, ReturnValue) == 0x000019, "Member 'ModularRigController_SwapModuleClass::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(RigHierarchyController_AddAvailableSpace) == 0x00001C, "Wrong size on RigHierarchyController_AddAvailableSpace");
...
static_assert(offsetof(RigHierarchyController_AddAvailableSpace, bSetupUndo) == 0x000018, "Member 'RigHierarchyController_AddAvailableSpace::bSetupUndo' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddAvailableSpace, bPrintPythonCommand) == 0x000019, "Member 'RigHierarchyController_AddAvailableSpace::bPrintPythonCommand' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddAvailableSpace, ReturnValue) == 0x00001A, "Member 'RigHierarchyController_AddAvailableSpace::ReturnValue' has a wrong offset!");
...
static_assert(alignof(RigHierarchyController_AddChannelHost) == 0x000004, "Wrong alignment on RigHierarchyController_AddChannelHost");
...
public:
	class FName                                   InName;                                            // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigElementKey                         InParent;                                          // 0x0008(0x000C)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigPhysicsSolverID                    InSolver;                                          // 0x0014(0x0010)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigPhysicsSettings                    InSettings;                                        // 0x0024(0x0004)(Parm, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FRigElementKey                         ReturnValue;                                       // 0x0094(0x000C)(Parm, OutParm, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(RigHierarchyController_AddPhysicsElement) == 0x000010, "Wrong alignment on RigHierarchyController_AddPhysicsElement");
static_assert(sizeof(RigHierarchyController_AddPhysicsElement) == 0x0000A0, "Wrong size on RigHierarchyController_AddPhysicsElement");
static_assert(offsetof(RigHierarchyController_AddPhysicsElement, InName) == 0x000000, "Member 'RigHierarchyController_AddPhysicsElement::InName' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddPhysicsElement, InParent) == 0x000008, "Member 'RigHierarchyController_AddPhysicsElement::InParent' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddPhysicsElement, InSolver) == 0x000014, "Member 'RigHierarchyController_AddPhysicsElement::InSolver' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddPhysicsElement, InSettings) == 0x000024, "Member 'RigHierarchyController_AddPhysicsElement::InSettings' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddPhysicsElement, InLocalTransform) == 0x000030, "Member 'RigHierarchyController_AddPhysicsElement::InLocalTransform' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddPhysicsElement, bSetupUndo) == 0x000090, "Member 'RigHierarchyController_AddPhysicsElement::bSetupUndo' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddPhysicsElement, bPrintPythonCommand) == 0x000091, "Member 'RigHierarchyController_AddPhysicsElement::bPrintPythonCommand' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddPhysicsElement, ReturnValue) == 0x000094, "Member 'RigHierarchyController_AddPhysicsElement::ReturnValue' has a wrong offset!");
...
static_assert(alignof(RigHierarchyController_RemoveAvailableSpace) == 0x000004, "Wrong alignment on RigHierarchyController_RemoveAvailableSpace");
...
static_assert(alignof(RigHierarchyController_RemoveChannelHost) == 0x000004, "Wrong alignment on RigHierarchyController_RemoveChannelHost");
