...
{
public:
	class UStruct*                                struct_0;                                          // 0x0000(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FStateTreeExternalDataDesc, struct_0) == 0x000000, "Member 'FStateTreeExternalDataDesc::struct_0' has a wrong offset!");
...
static_assert(offsetof(FStateTreeBindableStructDesc, struct_0) == 0x000000, "Member 'FStateTreeBindableStructDesc::struct_0' has a wrong offset!");
