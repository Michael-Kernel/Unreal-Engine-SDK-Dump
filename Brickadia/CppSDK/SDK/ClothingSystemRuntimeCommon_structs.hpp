...
static_assert(offsetof(FClothLODDataCommon, bUseMultipleInfluences) == 0x000128, "Member 'FClothLODDataCommon::bUseMultipleInfluences' has a wrong offset!");
static_assert(offsetof(FClothLODDataCommon, SkinningKernelRadius) == 0x00012C, "Member 'FClothLODDataCommon::SkinningKernelRadius' has a wrong offset!");
static_assert(offsetof(FClothLODDataCommon, bSmoothTransition) == 0x000130, "Member 'FClothLODDataCommon::bSmoothTransition' has a wrong offset!");
