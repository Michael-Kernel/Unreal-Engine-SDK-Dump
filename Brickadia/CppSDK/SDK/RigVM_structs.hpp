...
static_assert(sizeof(FRigVMGraphFunctionIdentifier) == 0x000050, "Wrong size on FRigVMGraphFunctionIdentifier");
...
static_assert(offsetof(FRigVMGraphFunctionIdentifier, LibraryNodePath) == 0x000020, "Member 'FRigVMGraphFunctionIdentifier::LibraryNodePath' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionIdentifier, HostObject) == 0x000030, "Member 'FRigVMGraphFunctionIdentifier::HostObject' has a wrong offset!");
...
static_assert(alignof(FRigVMTag) == 0x000008, "Wrong alignment on FRigVMTag");
static_assert(sizeof(FRigVMTag) == 0x000040, "Wrong size on FRigVMTag");
static_assert(offsetof(FRigVMTag, Name) == 0x000000, "Member 'FRigVMTag::Name' has a wrong offset!");
static_assert(offsetof(FRigVMTag, Label) == 0x000008, "Member 'FRigVMTag::Label' has a wrong offset!");
static_assert(offsetof(FRigVMTag, Tooltip) == 0x000018, "Member 'FRigVMTag::Tooltip' has a wrong offset!");
static_assert(offsetof(FRigVMTag, Color) == 0x000028, "Member 'FRigVMTag::Color' has a wrong offset!");
static_assert(offsetof(FRigVMTag, bShowInUserInterface) == 0x000038, "Member 'FRigVMTag::bShowInUserInterface' has a wrong offset!");
static_assert(offsetof(FRigVMTag, bMarksSubjectAsInvalid) == 0x000039, "Member 'FRigVMTag::bMarksSubjectAsInvalid' has a wrong offset!");
...
static_assert(alignof(FRigVMVariant) == 0x000008, "Wrong alignment on FRigVMVariant");
static_assert(sizeof(FRigVMVariant) == 0x000020, "Wrong size on FRigVMVariant");
static_assert(offsetof(FRigVMVariant, Guid) == 0x000000, "Member 'FRigVMVariant::Guid' has a wrong offset!");
static_assert(offsetof(FRigVMVariant, Tags) == 0x000010, "Member 'FRigVMVariant::Tags' has a wrong offset!");
...
static_assert(alignof(FRigVMPinCategory) == 0x000008, "Wrong alignment on FRigVMPinCategory");
static_assert(sizeof(FRigVMPinCategory) == 0x000028, "Wrong size on FRigVMPinCategory");
static_assert(offsetof(FRigVMPinCategory, Path) == 0x000000, "Member 'FRigVMPinCategory::Path' has a wrong offset!");
static_assert(offsetof(FRigVMPinCategory, Elements) == 0x000010, "Member 'FRigVMPinCategory::Elements' has a wrong offset!");
static_assert(offsetof(FRigVMPinCategory, bExpandedByDefault) == 0x000020, "Member 'FRigVMPinCategory::bExpandedByDefault' has a wrong offset!");
...
static_assert(alignof(FRigVMNodeLayout) == 0x000008, "Wrong alignment on FRigVMNodeLayout");
static_assert(sizeof(FRigVMNodeLayout) == 0x0000B0, "Wrong size on FRigVMNodeLayout");
static_assert(offsetof(FRigVMNodeLayout, Categories) == 0x000000, "Member 'FRigVMNodeLayout::Categories' has a wrong offset!");
static_assert(offsetof(FRigVMNodeLayout, PinIndexInCategory) == 0x000010, "Member 'FRigVMNodeLayout::PinIndexInCategory' has a wrong offset!");
static_assert(offsetof(FRigVMNodeLayout, DisplayNames) == 0x000060, "Member 'FRigVMNodeLayout::DisplayNames' has a wrong offset!");
...
static_assert(sizeof(FRigVMGraphFunctionHeader) == 0x0001F8, "Wrong size on FRigVMGraphFunctionHeader");
...
static_assert(offsetof(FRigVMGraphFunctionHeader, Variant) == 0x000050, "Member 'FRigVMGraphFunctionHeader::Variant' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Name) == 0x000070, "Member 'FRigVMGraphFunctionHeader::Name' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, NodeTitle) == 0x000078, "Member 'FRigVMGraphFunctionHeader::NodeTitle' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, NodeColor) == 0x000088, "Member 'FRigVMGraphFunctionHeader::NodeColor' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Tooltip) == 0x000098, "Member 'FRigVMGraphFunctionHeader::Tooltip' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Description) == 0x0000A8, "Member 'FRigVMGraphFunctionHeader::Description' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Category) == 0x0000B8, "Member 'FRigVMGraphFunctionHeader::Category' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Keywords) == 0x0000C8, "Member 'FRigVMGraphFunctionHeader::Keywords' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Arguments) == 0x0000D8, "Member 'FRigVMGraphFunctionHeader::Arguments' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Dependencies) == 0x0000E8, "Member 'FRigVMGraphFunctionHeader::Dependencies' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, ExternalVariables) == 0x000138, "Member 'FRigVMGraphFunctionHeader::ExternalVariables' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Layout) == 0x000148, "Member 'FRigVMGraphFunctionHeader::Layout' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_IsHostBeingDebugged) == 0x000008, "Wrong alignment on FRigVMFunction_IsHostBeingDebugged");
static_assert(sizeof(FRigVMFunction_IsHostBeingDebugged) == 0x000010, "Wrong size on FRigVMFunction_IsHostBeingDebugged");
static_assert(offsetof(FRigVMFunction_IsHostBeingDebugged, Result) == 0x000008, "Member 'FRigVMFunction_IsHostBeingDebugged::Result' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_MathFloatRound, int_0) == 0x000010, "Member 'FRigVMFunction_MathFloatRound::int_0' has a wrong offset!");
...
static_assert(sizeof(FRigVMStructMutable) == 0x000120, "Wrong size on FRigVMStructMutable");
...
static_assert(sizeof(FRigVMFunction_DebugBaseMutable) == 0x000120, "Wrong size on FRigVMFunction_DebugBaseMutable");
...
static_assert(sizeof(FRigVMFunction_MathMutableBase) == 0x000120, "Wrong size on FRigVMFunction_MathMutableBase");
...
static_assert(sizeof(FRigVMFunction_Sequence) == 0x000340, "Wrong size on FRigVMFunction_Sequence");
...
static_assert(offsetof(FRigVMFunction_Sequence, A) == 0x000120, "Member 'FRigVMFunction_Sequence::A' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_Sequence, B) == 0x000230, "Member 'FRigVMFunction_Sequence::B' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_SimBaseMutable) == 0x000120, "Wrong size on FRigVMFunction_SimBaseMutable");
...
static_assert(sizeof(FRigVMGraphFunctionData) == 0x000440, "Wrong size on FRigVMGraphFunctionData");
static_assert(offsetof(FRigVMGraphFunctionData, Header) == 0x000000, "Member 'FRigVMGraphFunctionData::Header' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionData, CompilationData) == 0x0001F8, "Member 'FRigVMGraphFunctionData::CompilationData' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionData, SerializedCollapsedNode) == 0x000430, "Member 'FRigVMGraphFunctionData::SerializedCollapsedNode' has a wrong offset!");
...
static_assert(alignof(FRigVMDispatch_ArrayInit) == 0x000008, "Wrong alignment on FRigVMDispatch_ArrayInit");
static_assert(sizeof(FRigVMDispatch_ArrayInit) == 0x000070, "Wrong size on FRigVMDispatch_ArrayInit");
...
static_assert(alignof(FRigVMTrait) == 0x000008, "Wrong alignment on FRigVMTrait");
static_assert(sizeof(FRigVMTrait) == 0x000018, "Wrong size on FRigVMTrait");
static_assert(offsetof(FRigVMTrait, Name) == 0x000008, "Member 'FRigVMTrait::Name' has a wrong offset!");
...
static_assert(alignof(FRigVMVariantRef) == 0x000008, "Wrong alignment on FRigVMVariantRef");
static_assert(sizeof(FRigVMVariantRef) == 0x000040, "Wrong size on FRigVMVariantRef");
static_assert(offsetof(FRigVMVariantRef, ObjectPath) == 0x000000, "Member 'FRigVMVariantRef::ObjectPath' has a wrong offset!");
static_assert(offsetof(FRigVMVariantRef, Variant) == 0x000020, "Member 'FRigVMVariantRef::Variant' has a wrong offset!");
...
static_assert(alignof(FRigVMSetupTraitsOp) == 0x000002, "Wrong alignment on FRigVMSetupTraitsOp");
static_assert(sizeof(FRigVMSetupTraitsOp) == 0x000008, "Wrong size on FRigVMSetupTraitsOp");
...
static_assert(sizeof(FRigVMFunction_DebugLineNoSpace) == 0x0001E0, "Wrong size on FRigVMFunction_DebugLineNoSpace");
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, A) == 0x000120, "Member 'FRigVMFunction_DebugLineNoSpace::A' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, B) == 0x000138, "Member 'FRigVMFunction_DebugLineNoSpace::B' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, Color) == 0x000150, "Member 'FRigVMFunction_DebugLineNoSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, Thickness) == 0x000160, "Member 'FRigVMFunction_DebugLineNoSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, WorldOffset) == 0x000170, "Member 'FRigVMFunction_DebugLineNoSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineNoSpace, bEnabled) == 0x0001D0, "Member 'FRigVMFunction_DebugLineNoSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugLineStripNoSpace) == 0x0001C0, "Wrong size on FRigVMFunction_DebugLineStripNoSpace");
static_assert(offsetof(FRigVMFunction_DebugLineStripNoSpace, Points) == 0x000120, "Member 'FRigVMFunction_DebugLineStripNoSpace::Points' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStripNoSpace, Color) == 0x000130, "Member 'FRigVMFunction_DebugLineStripNoSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStripNoSpace, Thickness) == 0x000140, "Member 'FRigVMFunction_DebugLineStripNoSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStripNoSpace, WorldOffset) == 0x000150, "Member 'FRigVMFunction_DebugLineStripNoSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStripNoSpace, bEnabled) == 0x0001B0, "Member 'FRigVMFunction_DebugLineStripNoSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugPointMutable) == 0x0001D0, "Wrong size on FRigVMFunction_DebugPointMutable");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Vector) == 0x000120, "Member 'FRigVMFunction_DebugPointMutable::Vector' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Mode) == 0x000138, "Member 'FRigVMFunction_DebugPointMutable::Mode' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Color) == 0x00013C, "Member 'FRigVMFunction_DebugPointMutable::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Scale) == 0x00014C, "Member 'FRigVMFunction_DebugPointMutable::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Thickness) == 0x000150, "Member 'FRigVMFunction_DebugPointMutable::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, Space) == 0x000154, "Member 'FRigVMFunction_DebugPointMutable::Space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, WorldOffset) == 0x000160, "Member 'FRigVMFunction_DebugPointMutable::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, bEnabled) == 0x0001C0, "Member 'FRigVMFunction_DebugPointMutable::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugRectangle) == 0x000210, "Wrong size on FRigVMFunction_DebugRectangle");
static_assert(offsetof(FRigVMFunction_DebugRectangle, Transform) == 0x000120, "Member 'FRigVMFunction_DebugRectangle::Transform' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangle, Color) == 0x000180, "Member 'FRigVMFunction_DebugRectangle::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangle, Scale) == 0x000190, "Member 'FRigVMFunction_DebugRectangle::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangle, Thickness) == 0x000194, "Member 'FRigVMFunction_DebugRectangle::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangle, Space) == 0x000198, "Member 'FRigVMFunction_DebugRectangle::Space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangle, WorldOffset) == 0x0001A0, "Member 'FRigVMFunction_DebugRectangle::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangle, bEnabled) == 0x000200, "Member 'FRigVMFunction_DebugRectangle::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugRectangleNoSpace) == 0x000210, "Wrong size on FRigVMFunction_DebugRectangleNoSpace");
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, Transform) == 0x000120, "Member 'FRigVMFunction_DebugRectangleNoSpace::Transform' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, Color) == 0x000180, "Member 'FRigVMFunction_DebugRectangleNoSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, Scale) == 0x000190, "Member 'FRigVMFunction_DebugRectangleNoSpace::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, Thickness) == 0x000194, "Member 'FRigVMFunction_DebugRectangleNoSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, WorldOffset) == 0x0001A0, "Member 'FRigVMFunction_DebugRectangleNoSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugRectangleNoSpace, bEnabled) == 0x000200, "Member 'FRigVMFunction_DebugRectangleNoSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugArc) == 0x000220, "Wrong size on FRigVMFunction_DebugArc");
static_assert(offsetof(FRigVMFunction_DebugArc, Transform) == 0x000120, "Member 'FRigVMFunction_DebugArc::Transform' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, Color) == 0x000180, "Member 'FRigVMFunction_DebugArc::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, Radius) == 0x000190, "Member 'FRigVMFunction_DebugArc::Radius' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, MinimumDegrees) == 0x000194, "Member 'FRigVMFunction_DebugArc::MinimumDegrees' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, MaximumDegrees) == 0x000198, "Member 'FRigVMFunction_DebugArc::MaximumDegrees' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, Thickness) == 0x00019C, "Member 'FRigVMFunction_DebugArc::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, Detail) == 0x0001A0, "Member 'FRigVMFunction_DebugArc::Detail' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, Space) == 0x0001A4, "Member 'FRigVMFunction_DebugArc::Space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, WorldOffset) == 0x0001B0, "Member 'FRigVMFunction_DebugArc::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArc, bEnabled) == 0x000210, "Member 'FRigVMFunction_DebugArc::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugArcNoSpace) == 0x000220, "Wrong size on FRigVMFunction_DebugArcNoSpace");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, Transform) == 0x000120, "Member 'FRigVMFunction_DebugArcNoSpace::Transform' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, Color) == 0x000180, "Member 'FRigVMFunction_DebugArcNoSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, Radius) == 0x000190, "Member 'FRigVMFunction_DebugArcNoSpace::Radius' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, MinimumDegrees) == 0x000194, "Member 'FRigVMFunction_DebugArcNoSpace::MinimumDegrees' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, MaximumDegrees) == 0x000198, "Member 'FRigVMFunction_DebugArcNoSpace::MaximumDegrees' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, Thickness) == 0x00019C, "Member 'FRigVMFunction_DebugArcNoSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, Detail) == 0x0001A0, "Member 'FRigVMFunction_DebugArcNoSpace::Detail' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, WorldOffset) == 0x0001B0, "Member 'FRigVMFunction_DebugArcNoSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugArcNoSpace, bEnabled) == 0x000210, "Member 'FRigVMFunction_DebugArcNoSpace::bEnabled' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_DebugBoxNoSpace) == 0x000010, "Wrong alignment on FRigVMFunction_DebugBoxNoSpace");
static_assert(sizeof(FRigVMFunction_DebugBoxNoSpace) == 0x0001E0, "Wrong size on FRigVMFunction_DebugBoxNoSpace");
static_assert(offsetof(FRigVMFunction_DebugBoxNoSpace, Box) == 0x000120, "Member 'FRigVMFunction_DebugBoxNoSpace::Box' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugBoxNoSpace, Color) == 0x000158, "Member 'FRigVMFunction_DebugBoxNoSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugBoxNoSpace, Thickness) == 0x000168, "Member 'FRigVMFunction_DebugBoxNoSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugBoxNoSpace, WorldOffset) == 0x000170, "Member 'FRigVMFunction_DebugBoxNoSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugBoxNoSpace, bEnabled) == 0x0001D0, "Member 'FRigVMFunction_DebugBoxNoSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugTransformMutableNoSpace) == 0x000210, "Wrong size on FRigVMFunction_DebugTransformMutableNoSpace");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, Transform) == 0x000120, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::Transform' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, Mode) == 0x000180, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::Mode' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, Color) == 0x000184, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, Thickness) == 0x000194, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, Scale) == 0x000198, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, WorldOffset) == 0x0001A0, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutableNoSpace, bEnabled) == 0x000200, "Member 'FRigVMFunction_DebugTransformMutableNoSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugTransformArrayMutableNoSpace) == 0x0001D0, "Wrong size on FRigVMFunction_DebugTransformArrayMutableNoSpace");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, Transforms) == 0x000120, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::Transforms' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, ParentIndices) == 0x000130, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::ParentIndices' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, Mode) == 0x000140, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::Mode' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, Color) == 0x000144, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, Thickness) == 0x000154, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, Scale) == 0x000158, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, WorldOffset) == 0x000160, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutableNoSpace, bEnabled) == 0x0001C0, "Member 'FRigVMFunction_DebugTransformArrayMutableNoSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_ForLoopCount) == 0x000250, "Wrong size on FRigVMFunction_ForLoopCount");
static_assert(offsetof(FRigVMFunction_ForLoopCount, BlockToRun) == 0x000120, "Member 'FRigVMFunction_ForLoopCount::BlockToRun' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Count) == 0x000128, "Member 'FRigVMFunction_ForLoopCount::Count' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Index) == 0x00012C, "Member 'FRigVMFunction_ForLoopCount::Index' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Ratio) == 0x000130, "Member 'FRigVMFunction_ForLoopCount::Ratio' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Completed) == 0x000140, "Member 'FRigVMFunction_ForLoopCount::Completed' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_UserDefinedEvent) == 0x000130, "Wrong size on FRigVMFunction_UserDefinedEvent");
...
static_assert(offsetof(FRigVMFunction_UserDefinedEvent, EventName) == 0x000120, "Member 'FRigVMFunction_UserDefinedEvent::EventName' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathBoxBase) == 0x000008, "Wrong alignment on FRigVMFunction_MathBoxBase");
static_assert(sizeof(FRigVMFunction_MathBoxBase) == 0x000008, "Wrong size on FRigVMFunction_MathBoxBase");
...
static_assert(alignof(FRigVMFunction_MathBoxFromArray) == 0x000008, "Wrong alignment on FRigVMFunction_MathBoxFromArray");
static_assert(sizeof(FRigVMFunction_MathBoxFromArray) == 0x0000B0, "Wrong size on FRigVMFunction_MathBoxFromArray");
static_assert(offsetof(FRigVMFunction_MathBoxFromArray, Array) == 0x000008, "Member 'FRigVMFunction_MathBoxFromArray::Array' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxFromArray, Box) == 0x000018, "Member 'FRigVMFunction_MathBoxFromArray::Box' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxFromArray, Minimum) == 0x000050, "Member 'FRigVMFunction_MathBoxFromArray::Minimum' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxFromArray, Maximum) == 0x000068, "Member 'FRigVMFunction_MathBoxFromArray::Maximum' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxFromArray, Center) == 0x000080, "Member 'FRigVMFunction_MathBoxFromArray::Center' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxFromArray, Size) == 0x000098, "Member 'FRigVMFunction_MathBoxFromArray::Size' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathBoxIsValid) == 0x000008, "Wrong alignment on FRigVMFunction_MathBoxIsValid");
static_assert(sizeof(FRigVMFunction_MathBoxIsValid) == 0x000048, "Wrong size on FRigVMFunction_MathBoxIsValid");
static_assert(offsetof(FRigVMFunction_MathBoxIsValid, Box) == 0x000008, "Member 'FRigVMFunction_MathBoxIsValid::Box' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxIsValid, Valid) == 0x000040, "Member 'FRigVMFunction_MathBoxIsValid::Valid' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathBoxGetCenter) == 0x000008, "Wrong alignment on FRigVMFunction_MathBoxGetCenter");
static_assert(sizeof(FRigVMFunction_MathBoxGetCenter) == 0x000058, "Wrong size on FRigVMFunction_MathBoxGetCenter");
static_assert(offsetof(FRigVMFunction_MathBoxGetCenter, Box) == 0x000008, "Member 'FRigVMFunction_MathBoxGetCenter::Box' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxGetCenter, Center) == 0x000040, "Member 'FRigVMFunction_MathBoxGetCenter::Center' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathBoxGetSize) == 0x000008, "Wrong alignment on FRigVMFunction_MathBoxGetSize");
static_assert(sizeof(FRigVMFunction_MathBoxGetSize) == 0x000070, "Wrong size on FRigVMFunction_MathBoxGetSize");
static_assert(offsetof(FRigVMFunction_MathBoxGetSize, Box) == 0x000008, "Member 'FRigVMFunction_MathBoxGetSize::Box' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxGetSize, Size) == 0x000040, "Member 'FRigVMFunction_MathBoxGetSize::Size' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxGetSize, Extent) == 0x000058, "Member 'FRigVMFunction_MathBoxGetSize::Extent' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathBoxShift) == 0x000008, "Wrong alignment on FRigVMFunction_MathBoxShift");
static_assert(sizeof(FRigVMFunction_MathBoxShift) == 0x000090, "Wrong size on FRigVMFunction_MathBoxShift");
static_assert(offsetof(FRigVMFunction_MathBoxShift, Box) == 0x000008, "Member 'FRigVMFunction_MathBoxShift::Box' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxShift, Amount) == 0x000040, "Member 'FRigVMFunction_MathBoxShift::Amount' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxShift, Result) == 0x000058, "Member 'FRigVMFunction_MathBoxShift::Result' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathBoxMoveTo) == 0x000008, "Wrong alignment on FRigVMFunction_MathBoxMoveTo");
static_assert(sizeof(FRigVMFunction_MathBoxMoveTo) == 0x000090, "Wrong size on FRigVMFunction_MathBoxMoveTo");
static_assert(offsetof(FRigVMFunction_MathBoxMoveTo, Box) == 0x000008, "Member 'FRigVMFunction_MathBoxMoveTo::Box' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxMoveTo, Center) == 0x000040, "Member 'FRigVMFunction_MathBoxMoveTo::Center' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxMoveTo, Result) == 0x000058, "Member 'FRigVMFunction_MathBoxMoveTo::Result' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathBoxExpand) == 0x000008, "Wrong alignment on FRigVMFunction_MathBoxExpand");
static_assert(sizeof(FRigVMFunction_MathBoxExpand) == 0x000090, "Wrong size on FRigVMFunction_MathBoxExpand");
static_assert(offsetof(FRigVMFunction_MathBoxExpand, Box) == 0x000008, "Member 'FRigVMFunction_MathBoxExpand::Box' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxExpand, Amount) == 0x000040, "Member 'FRigVMFunction_MathBoxExpand::Amount' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxExpand, Result) == 0x000058, "Member 'FRigVMFunction_MathBoxExpand::Result' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathBoxTransform) == 0x000010, "Wrong alignment on FRigVMFunction_MathBoxTransform");
static_assert(sizeof(FRigVMFunction_MathBoxTransform) == 0x0000E0, "Wrong size on FRigVMFunction_MathBoxTransform");
static_assert(offsetof(FRigVMFunction_MathBoxTransform, Box) == 0x000008, "Member 'FRigVMFunction_MathBoxTransform::Box' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxTransform, Transform) == 0x000040, "Member 'FRigVMFunction_MathBoxTransform::Transform' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxTransform, Result) == 0x0000A0, "Member 'FRigVMFunction_MathBoxTransform::Result' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathBoxGetDistance) == 0x000008, "Wrong alignment on FRigVMFunction_MathBoxGetDistance");
static_assert(sizeof(FRigVMFunction_MathBoxGetDistance) == 0x000060, "Wrong size on FRigVMFunction_MathBoxGetDistance");
static_assert(offsetof(FRigVMFunction_MathBoxGetDistance, Box) == 0x000008, "Member 'FRigVMFunction_MathBoxGetDistance::Box' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxGetDistance, position) == 0x000040, "Member 'FRigVMFunction_MathBoxGetDistance::position' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxGetDistance, Square) == 0x000058, "Member 'FRigVMFunction_MathBoxGetDistance::Square' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxGetDistance, Valid) == 0x000059, "Member 'FRigVMFunction_MathBoxGetDistance::Valid' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxGetDistance, Distance) == 0x00005C, "Member 'FRigVMFunction_MathBoxGetDistance::Distance' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathBoxIsInside) == 0x000008, "Wrong alignment on FRigVMFunction_MathBoxIsInside");
static_assert(sizeof(FRigVMFunction_MathBoxIsInside) == 0x000060, "Wrong size on FRigVMFunction_MathBoxIsInside");
static_assert(offsetof(FRigVMFunction_MathBoxIsInside, Box) == 0x000008, "Member 'FRigVMFunction_MathBoxIsInside::Box' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxIsInside, position) == 0x000040, "Member 'FRigVMFunction_MathBoxIsInside::position' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxIsInside, Result) == 0x000058, "Member 'FRigVMFunction_MathBoxIsInside::Result' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathBoxGetVolume) == 0x000008, "Wrong alignment on FRigVMFunction_MathBoxGetVolume");
static_assert(sizeof(FRigVMFunction_MathBoxGetVolume) == 0x000048, "Wrong size on FRigVMFunction_MathBoxGetVolume");
static_assert(offsetof(FRigVMFunction_MathBoxGetVolume, Box) == 0x000008, "Member 'FRigVMFunction_MathBoxGetVolume::Box' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathBoxGetVolume, Volume) == 0x000040, "Member 'FRigVMFunction_MathBoxGetVolume::Volume' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_MathTransformMutableBase) == 0x000120, "Wrong size on FRigVMFunction_MathTransformMutableBase");
...
static_assert(offsetof(FRigVMFunction_MathDoubleFloor, int_0) == 0x000018, "Member 'FRigVMFunction_MathDoubleFloor::int_0' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_MathDoubleCeil, int_0) == 0x000018, "Member 'FRigVMFunction_MathDoubleCeil::int_0' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_MathDoubleRound, int_0) == 0x000018, "Member 'FRigVMFunction_MathDoubleRound::int_0' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathDoubleToFloat) == 0x000008, "Wrong alignment on FRigVMFunction_MathDoubleToFloat");
static_assert(sizeof(FRigVMFunction_MathDoubleToFloat) == 0x000018, "Wrong size on FRigVMFunction_MathDoubleToFloat");
static_assert(offsetof(FRigVMFunction_MathDoubleToFloat, Value) == 0x000008, "Member 'FRigVMFunction_MathDoubleToFloat::Value' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathDoubleToFloat, Result) == 0x000010, "Member 'FRigVMFunction_MathDoubleToFloat::Result' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_MathFloatCeil, int_0) == 0x000010, "Member 'FRigVMFunction_MathFloatCeil::int_0' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_MathFloatFloor, int_0) == 0x000010, "Member 'FRigVMFunction_MathFloatFloor::int_0' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathFloatToDouble) == 0x000008, "Wrong alignment on FRigVMFunction_MathFloatToDouble");
static_assert(sizeof(FRigVMFunction_MathFloatToDouble) == 0x000018, "Wrong size on FRigVMFunction_MathFloatToDouble");
static_assert(offsetof(FRigVMFunction_MathFloatToDouble, Value) == 0x000008, "Member 'FRigVMFunction_MathFloatToDouble::Value' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathFloatToDouble, Result) == 0x000010, "Member 'FRigVMFunction_MathFloatToDouble::Result' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_ControlFlowBranch) == 0x000470, "Wrong size on FRigVMFunction_ControlFlowBranch");
...
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, Condition) == 0x000120, "Member 'FRigVMFunction_ControlFlowBranch::Condition' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, TRUE_0) == 0x000130, "Member 'FRigVMFunction_ControlFlowBranch::TRUE_0' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, FALSE_0) == 0x000240, "Member 'FRigVMFunction_ControlFlowBranch::FALSE_0' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, Completed) == 0x000350, "Member 'FRigVMFunction_ControlFlowBranch::Completed' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, BlockToRun) == 0x000460, "Member 'FRigVMFunction_ControlFlowBranch::BlockToRun' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_MathTransformAccumulateArray) == 0x0001B0, "Wrong size on FRigVMFunction_MathTransformAccumulateArray");
static_assert(offsetof(FRigVMFunction_MathTransformAccumulateArray, Transforms) == 0x000120, "Member 'FRigVMFunction_MathTransformAccumulateArray::Transforms' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathTransformAccumulateArray, TargetSpace) == 0x000130, "Member 'FRigVMFunction_MathTransformAccumulateArray::TargetSpace' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathTransformAccumulateArray, Root) == 0x000140, "Member 'FRigVMFunction_MathTransformAccumulateArray::Root' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_MathTransformAccumulateArray, ParentIndices) == 0x0001A0, "Member 'FRigVMFunction_MathTransformAccumulateArray::ParentIndices' has a wrong offset!");
