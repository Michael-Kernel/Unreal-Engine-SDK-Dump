...
static_assert(sizeof(FIrisFastArraySerializer) == 0x000128, "Wrong size on FIrisFastArraySerializer");
static_assert(offsetof(FIrisFastArraySerializer, ChangeMaskStorage) == 0x000114, "Member 'FIrisFastArraySerializer::ChangeMaskStorage' has a wrong offset!");
