...
static_assert(sizeof(FRichTextStyleRow) == 0x0002F0, "Wrong size on FRichTextStyleRow");
...
static_assert(offsetof(FGameViewportWidgetSlot, bAutoRemoveOnWorldRemoved) == 0x000044, "Member 'FGameViewportWidgetSlot::bAutoRemoveOnWorldRemoved' has a wrong offset!");
...
static_assert(sizeof(FWidgetStateBitfield) == 0x000008, "Wrong size on FWidgetStateBitfield");
...
public:
	...
	class UUIComponent*                           Component;                                         // 0x0008(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FUIComponentTarget) == 0x000008, "Wrong alignment on FUIComponentTarget");
static_assert(sizeof(FUIComponentTarget) == 0x000010, "Wrong size on FUIComponentTarget");
static_assert(offsetof(FUIComponentTarget, TargetName) == 0x000000, "Member 'FUIComponentTarget::TargetName' has a wrong offset!");
static_assert(offsetof(FUIComponentTarget, Component) == 0x000008, "Member 'FUIComponentTarget::Component' has a wrong offset!");
...
static_assert(offsetof(FWidgetAnimationBinding, DynamicBinding) == 0x000028, "Member 'FWidgetAnimationBinding::DynamicBinding' has a wrong offset!");
...
public:
	...
	class USlatePostBufferProcessorUpdater*       PostParamUpdater;                                  // 0x0008(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSlatePostBufferUpdateInfo) == 0x000008, "Wrong alignment on FSlatePostBufferUpdateInfo");
static_assert(sizeof(FSlatePostBufferUpdateInfo) == 0x000010, "Wrong size on FSlatePostBufferUpdateInfo");
static_assert(offsetof(FSlatePostBufferUpdateInfo, BufferToUpdate) == 0x000000, "Member 'FSlatePostBufferUpdateInfo::BufferToUpdate' has a wrong offset!");
static_assert(offsetof(FSlatePostBufferUpdateInfo, PostParamUpdater) == 0x000008, "Member 'FSlatePostBufferUpdateInfo::PostParamUpdater' has a wrong offset!");
...
static_assert(sizeof(FRichImageRow) == 0x0000C0, "Wrong size on FRichImageRow");
