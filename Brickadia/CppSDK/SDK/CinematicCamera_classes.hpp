...
{
public:
	struct FCameraLookatTrackingSettings          LookatTrackingSettings;                            // 0x09E0(0x0068)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ACineCameraActor) == 0x000A60, "Wrong size on ACineCameraActor");
