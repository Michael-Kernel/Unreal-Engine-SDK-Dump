...
static_assert(alignof(FMovieSceneDirectorBlueprintConditionPayloadVariable) == 0x000008, "Wrong alignment on FMovieSceneDirectorBlueprintConditionPayloadVariable");
static_assert(sizeof(FMovieSceneDirectorBlueprintConditionPayloadVariable) == 0x000030, "Wrong size on FMovieSceneDirectorBlueprintConditionPayloadVariable");
static_assert(offsetof(FMovieSceneDirectorBlueprintConditionPayloadVariable, ObjectValue) == 0x000000, "Member 'FMovieSceneDirectorBlueprintConditionPayloadVariable::ObjectValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneDirectorBlueprintConditionPayloadVariable, Value) == 0x000020, "Member 'FMovieSceneDirectorBlueprintConditionPayloadVariable::Value' has a wrong offset!");
...
static_assert(alignof(FMovieSceneDirectorBlueprintConditionData) == 0x000008, "Wrong alignment on FMovieSceneDirectorBlueprintConditionData");
static_assert(sizeof(FMovieSceneDirectorBlueprintConditionData) == 0x000028, "Wrong size on FMovieSceneDirectorBlueprintConditionData");
static_assert(offsetof(FMovieSceneDirectorBlueprintConditionData, Function) == 0x000000, "Member 'FMovieSceneDirectorBlueprintConditionData::Function' has a wrong offset!");
static_assert(offsetof(FMovieSceneDirectorBlueprintConditionData, ConditionContextProperty) == 0x000008, "Member 'FMovieSceneDirectorBlueprintConditionData::ConditionContextProperty' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneParticleChannel) == 0x000110, "Wrong size on FMovieSceneParticleChannel");
...
static_assert(sizeof(FMovieSceneParticleSectionTemplate) == 0x000130, "Wrong size on FMovieSceneParticleSectionTemplate");
...
public:
	...
	class UMirrorDataTable*                       MirrorDataTable;                                   // 0x0030(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FMovieSceneSkeletalAnimationParams) == 0x000158, "Wrong size on FMovieSceneSkeletalAnimationParams");
...
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, PlayRate) == 0x000018, "Member 'FMovieSceneSkeletalAnimationParams::PlayRate' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, SlotName) == 0x000024, "Member 'FMovieSceneSkeletalAnimationParams::SlotName' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, MirrorDataTable) == 0x000030, "Member 'FMovieSceneSkeletalAnimationParams::MirrorDataTable' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, Weight) == 0x000038, "Member 'FMovieSceneSkeletalAnimationParams::Weight' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, bSkipAnimNotifiers) == 0x000148, "Member 'FMovieSceneSkeletalAnimationParams::bSkipAnimNotifiers' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, bForceCustomMode) == 0x000149, "Member 'FMovieSceneSkeletalAnimationParams::bForceCustomMode' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, SwapRootBone) == 0x00014A, "Member 'FMovieSceneSkeletalAnimationParams::SwapRootBone' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, StartOffset) == 0x00014C, "Member 'FMovieSceneSkeletalAnimationParams::StartOffset' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, EndOffset) == 0x000150, "Member 'FMovieSceneSkeletalAnimationParams::EndOffset' has a wrong offset!");
