...
void AUltra_Dynamic_Weather_C::Func_Dust_0(const struct FVector& Location, double Size, double Depth_Fraction)
{
	static class UFunction* Func = nullptr;
...
// const struct FUDW_WeatherState_Structure&struct_0                                               (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AUltra_Dynamic_Weather_C::Copy_Weather_State_Structure_to_Object(class UUDS_Weather_Settings_C* State, const struct FUDW_WeatherState_Structure& struct_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.State = State;
	Parms.struct_0 = std::move(struct_0);
