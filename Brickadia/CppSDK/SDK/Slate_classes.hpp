...
static_assert(sizeof(UButtonWidgetStyle) == 0x0003A0, "Wrong size on UButtonWidgetStyle");
...
static_assert(sizeof(UCheckBoxWidgetStyle) == 0x000980, "Wrong size on UCheckBoxWidgetStyle");
...
{
public:
	struct FComboBoxStyle                         ComboBoxStyle;                                     // 0x0030(0x0670)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComboBoxWidgetStyle) == 0x0006A0, "Wrong size on UComboBoxWidgetStyle");
...
{
public:
	struct FComboButtonStyle                      ComboButtonStyle;                                  // 0x0030(0x0610)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComboButtonWidgetStyle) == 0x000640, "Wrong size on UComboButtonWidgetStyle");
...
static_assert(sizeof(UEditableTextBoxWidgetStyle) == 0x000CB0, "Wrong size on UEditableTextBoxWidgetStyle");
...
static_assert(sizeof(UEditableTextWidgetStyle) == 0x0002C0, "Wrong size on UEditableTextWidgetStyle");
...
static_assert(sizeof(UProgressWidgetStyle) == 0x000260, "Wrong size on UProgressWidgetStyle");
...
static_assert(sizeof(UScrollBarWidgetStyle) == 0x000680, "Wrong size on UScrollBarWidgetStyle");
...
static_assert(sizeof(UScrollBoxWidgetStyle) == 0x000320, "Wrong size on UScrollBoxWidgetStyle");
...
static_assert(sizeof(USpinBoxWidgetStyle) == 0x000550, "Wrong size on USpinBoxWidgetStyle");
