...
static_assert(sizeof(ALevelSequenceActor) == 0x000358, "Wrong size on ALevelSequenceActor");
static_assert(offsetof(ALevelSequenceActor, PlaybackSettings) == 0x0002C8, "Member 'ALevelSequenceActor::PlaybackSettings' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, SequencePlayer) == 0x0002F0, "Member 'ALevelSequenceActor::SequencePlayer' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, LevelSequenceAsset) == 0x0002F8, "Member 'ALevelSequenceActor::LevelSequenceAsset' has a wrong offset!");
...
static_assert(offsetof(ALevelSequenceActor, WorldPartitionResolveData) == 0x000334, "Member 'ALevelSequenceActor::WorldPartitionResolveData' has a wrong offset!");
...
{
public:
	struct FLevelSequencePlayerSnapshot           FrameInformation;                                  // 0x02D0(0x00A8)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ULevelSequenceBurnIn) == 0x000380, "Wrong size on ULevelSequenceBurnIn");
static_assert(offsetof(ULevelSequenceBurnIn, FrameInformation) == 0x0002D0, "Member 'ULevelSequenceBurnIn::FrameInformation' has a wrong offset!");
static_assert(offsetof(ULevelSequenceBurnIn, LevelSequenceActor) == 0x000378, "Member 'ULevelSequenceBurnIn::LevelSequenceActor' has a wrong offset!");
