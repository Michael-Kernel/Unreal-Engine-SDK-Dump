...
// ScriptStruct ClothingSystemRuntimeInterface.ClothCollisionPrim_Triangles
// 0x0010 (0x0010 - 0x0000)
struct FClothCollisionPrim_Triangles final
{
public:
	TArray<struct FVector>                        Vertices;                                          // 0x0000(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FClothCollisionPrim_Triangles) == 0x000008, "Wrong alignment on FClothCollisionPrim_Triangles");
static_assert(sizeof(FClothCollisionPrim_Triangles) == 0x000010, "Wrong size on FClothCollisionPrim_Triangles");
static_assert(offsetof(FClothCollisionPrim_Triangles, Vertices) == 0x000000, "Member 'FClothCollisionPrim_Triangles::Vertices' has a wrong offset!");
...
public:
	...
	TArray<struct FClothCollisionPrim_Triangles>  Triangles;                                         // 0x0040(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FClothCollisionData) == 0x000008, "Wrong alignment on FClothCollisionData");
static_assert(sizeof(FClothCollisionData) == 0x000050, "Wrong size on FClothCollisionData");
...
static_assert(offsetof(FClothCollisionData, Triangles) == 0x000040, "Member 'FClothCollisionData::Triangles' has a wrong offset!");
