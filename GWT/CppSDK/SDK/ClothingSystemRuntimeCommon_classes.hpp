...
{
public:
	bool                                          bFallOnVanishing;                                  // 0x0028(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UClothConfigCommon, bFallOnVanishing) == 0x000028, "Member 'UClothConfigCommon::bFallOnVanishing' has a wrong offset!");
...
public:
	...
	struct FClothPhysicalMeshData                 ClothPhysicalMeshData;                             // 0x0030(0x0148)(NativeAccessSpecifierPublic)
	struct FClothCollisionData                    CollisionData;                                     // 0x0178(0x0050)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UClothLODDataCommon_Legacy) == 0x0001E8, "Wrong size on UClothLODDataCommon_Legacy");
...
static_assert(offsetof(UClothLODDataCommon_Legacy, CollisionData) == 0x000178, "Member 'UClothLODDataCommon_Legacy::CollisionData' has a wrong offset!");
