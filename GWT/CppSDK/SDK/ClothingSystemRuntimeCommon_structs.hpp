...
public:
	...
	bool                                          bFallOnVanishing;                                  // 0x00D4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FClothConfig_Legacy) == 0x0000D8, "Wrong size on FClothConfig_Legacy");
...
static_assert(offsetof(FClothConfig_Legacy, bFallOnVanishing) == 0x0000D4, "Member 'FClothConfig_Legacy::bFallOnVanishing' has a wrong offset!");
...
public:
	...
	TMap<uint32, uint32>                          ModelIndexMap;                                     // 0x00B8(0x0050)(Edit, NativeAccessSpecifierPublic)
	TArray<float>                                 MaxDistances;                                      // 0x0108(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
	TArray<float>                                 BackstopDistances;                                 // 0x0118(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
	TArray<float>                                 BackstopRadiuses;                                  // 0x0128(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
	TArray<float>                                 AnimDriveMultipliers;                              // 0x0138(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
};
static_assert(alignof(FClothPhysicalMeshData) == 0x000008, "Wrong alignment on FClothPhysicalMeshData");
static_assert(sizeof(FClothPhysicalMeshData) == 0x000148, "Wrong size on FClothPhysicalMeshData");
...
static_assert(offsetof(FClothPhysicalMeshData, ModelIndexMap) == 0x0000B8, "Member 'FClothPhysicalMeshData::ModelIndexMap' has a wrong offset!");
static_assert(offsetof(FClothPhysicalMeshData, MaxDistances) == 0x000108, "Member 'FClothPhysicalMeshData::MaxDistances' has a wrong offset!");
static_assert(offsetof(FClothPhysicalMeshData, BackstopDistances) == 0x000118, "Member 'FClothPhysicalMeshData::BackstopDistances' has a wrong offset!");
static_assert(offsetof(FClothPhysicalMeshData, BackstopRadiuses) == 0x000128, "Member 'FClothPhysicalMeshData::BackstopRadiuses' has a wrong offset!");
static_assert(offsetof(FClothPhysicalMeshData, AnimDriveMultipliers) == 0x000138, "Member 'FClothPhysicalMeshData::AnimDriveMultipliers' has a wrong offset!");
...
{
public:
	struct FClothPhysicalMeshData                 PhysicalMeshData;                                  // 0x0000(0x0148)(Edit, NativeAccessSpecifierPublic)
	struct FClothCollisionData                    CollisionData;                                     // 0x0148(0x0050)(Edit, NativeAccessSpecifierPublic)
	bool                                          bUseMultipleInfluences;                            // 0x0198(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_199[0x3];                                      // 0x0199(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SkinningKernelRadius;                              // 0x019C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FClothLODDataCommon) == 0x0001C0, "Wrong size on FClothLODDataCommon");
...
static_assert(offsetof(FClothLODDataCommon, CollisionData) == 0x000148, "Member 'FClothLODDataCommon::CollisionData' has a wrong offset!");
static_assert(offsetof(FClothLODDataCommon, bUseMultipleInfluences) == 0x000198, "Member 'FClothLODDataCommon::bUseMultipleInfluences' has a wrong offset!");
static_assert(offsetof(FClothLODDataCommon, SkinningKernelRadius) == 0x00019C, "Member 'FClothLODDataCommon::SkinningKernelRadius' has a wrong offset!");
...
// ScriptStruct ClothingSystemRuntimeCommon.FabricData
// 0x0098 (0x0098 - 0x0000)
struct FFabricData final
{
public:
	uint8                                         Version;                                           // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        NumParticles;                                      // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<uint32>                                PhaseIndices;                                      // 0x0008(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 PhaseTypes;                                        // 0x0018(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<uint32>                                Sets;                                              // 0x0028(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                 Restvalues;                                        // 0x0038(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                 StiffnessValues;                                   // 0x0048(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<uint32>                                Indices;                                           // 0x0058(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<uint32>                                Anchors;                                           // 0x0068(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                 TetherLengths;                                     // 0x0078(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<uint32>                                Triangles;                                         // 0x0088(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFabricData) == 0x000008, "Wrong alignment on FFabricData");
static_assert(sizeof(FFabricData) == 0x000098, "Wrong size on FFabricData");
static_assert(offsetof(FFabricData, Version) == 0x000000, "Member 'FFabricData::Version' has a wrong offset!");
static_assert(offsetof(FFabricData, NumParticles) == 0x000004, "Member 'FFabricData::NumParticles' has a wrong offset!");
static_assert(offsetof(FFabricData, PhaseIndices) == 0x000008, "Member 'FFabricData::PhaseIndices' has a wrong offset!");
static_assert(offsetof(FFabricData, PhaseTypes) == 0x000018, "Member 'FFabricData::PhaseTypes' has a wrong offset!");
static_assert(offsetof(FFabricData, Sets) == 0x000028, "Member 'FFabricData::Sets' has a wrong offset!");
static_assert(offsetof(FFabricData, Restvalues) == 0x000038, "Member 'FFabricData::Restvalues' has a wrong offset!");
static_assert(offsetof(FFabricData, StiffnessValues) == 0x000048, "Member 'FFabricData::StiffnessValues' has a wrong offset!");
static_assert(offsetof(FFabricData, Indices) == 0x000058, "Member 'FFabricData::Indices' has a wrong offset!");
static_assert(offsetof(FFabricData, Anchors) == 0x000068, "Member 'FFabricData::Anchors' has a wrong offset!");
static_assert(offsetof(FFabricData, TetherLengths) == 0x000078, "Member 'FFabricData::TetherLengths' has a wrong offset!");
static_assert(offsetof(FFabricData, Triangles) == 0x000088, "Member 'FFabricData::Triangles' has a wrong offset!");
