...
public:
	...
	class FString                                 PrefabHash;                                        // 0x00A0(0x0010)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         NumActors;                                         // 0x00B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                PrefabPivot;                                       // 0x00B4(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UPrefabAsset) == 0x0000C0, "Wrong size on UPrefabAsset");
...
static_assert(offsetof(UPrefabAsset, PrefabHash) == 0x0000A0, "Member 'UPrefabAsset::PrefabHash' has a wrong offset!");
static_assert(offsetof(UPrefabAsset, NumActors) == 0x0000B0, "Member 'UPrefabAsset::NumActors' has a wrong offset!");
static_assert(offsetof(UPrefabAsset, PrefabPivot) == 0x0000B4, "Member 'UPrefabAsset::PrefabPivot' has a wrong offset!");
...
{
public:
	class UPrefabAsset*                           Parent;                                            // 0x00C0(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPrefabVariantAsset) == 0x0000C8, "Wrong size on UPrefabVariantAsset");
static_assert(offsetof(UPrefabVariantAsset, Parent) == 0x0000C0, "Member 'UPrefabVariantAsset::Parent' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_CE[0x1];                                       // 0x00CE(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPrefabToolSettings) == 0x000100, "Wrong size on UPrefabToolSettings");
...
static_assert(offsetof(UPrefabToolSettings, UITheme) == 0x000040, "Member 'UPrefabToolSettings::UITheme' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bUpdateAllPrefabActorsWhenOpenMap) == 0x000044, "Member 'UPrefabToolSettings::bUpdateAllPrefabActorsWhenOpenMap' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bCheckPrefabChangeBeforeUpdateAllPrefabActorsWhenOpenMap) == 0x000045, "Member 'UPrefabToolSettings::bCheckPrefabChangeBeforeUpdateAllPrefabActorsWhenOpenMap' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bUpdateAllPrefabActorsWhenApply) == 0x000046, "Member 'UPrefabToolSettings::bUpdateAllPrefabActorsWhenApply' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bApplyToNestedPrefab) == 0x000047, "Member 'UPrefabToolSettings::bApplyToNestedPrefab' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bEnableApplyFromDisconnectedPrefabActor) == 0x000048, "Member 'UPrefabToolSettings::bEnableApplyFromDisconnectedPrefabActor' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bAutoAddRemoveVariantActorPrefix) == 0x000049, "Member 'UPrefabToolSettings::bAutoAddRemoveVariantActorPrefix' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, VariantActorPrefix) == 0x000050, "Member 'UPrefabToolSettings::VariantActorPrefix' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bEnablePrefabComponentVisualizer) == 0x000060, "Member 'UPrefabToolSettings::bEnablePrefabComponentVisualizer' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, PrefabComponentVisualizerType) == 0x000061, "Member 'UPrefabToolSettings::PrefabComponentVisualizerType' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bDisplayPrefabComponentVisualizerEvenNotSelected) == 0x000062, "Member 'UPrefabToolSettings::bDisplayPrefabComponentVisualizerEvenNotSelected' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, PrefabViewVisualizerColor) == 0x000064, "Member 'UPrefabToolSettings::PrefabViewVisualizerColor' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, TargetActorColor) == 0x000068, "Member 'UPrefabToolSettings::TargetActorColor' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, UnLockedConnectedColor) == 0x00006C, "Member 'UPrefabToolSettings::UnLockedConnectedColor' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, LockedConnectedColor) == 0x000070, "Member 'UPrefabToolSettings::LockedConnectedColor' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, UnLockedDisConnectedColor) == 0x000074, "Member 'UPrefabToolSettings::UnLockedDisConnectedColor' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, LockedDisConnectedColor) == 0x000078, "Member 'UPrefabToolSettings::LockedDisConnectedColor' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, UnLockedNoPrefabAssignedColor) == 0x00007C, "Member 'UPrefabToolSettings::UnLockedNoPrefabAssignedColor' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, LockedNoPrefabAssignedColor) == 0x000080, "Member 'UPrefabToolSettings::LockedNoPrefabAssignedColor' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, PrefabMaterialPath) == 0x000088, "Member 'UPrefabToolSettings::PrefabMaterialPath' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bShadedPrefabViewVisualizer) == 0x0000C8, "Member 'UPrefabToolSettings::bShadedPrefabViewVisualizer' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bLockPrefabSelectionByDefault) == 0x0000C9, "Member 'UPrefabToolSettings::bLockPrefabSelectionByDefault' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bDisableLockPrefabSelectionFeature) == 0x0000CA, "Member 'UPrefabToolSettings::bDisableLockPrefabSelectionFeature' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bForceApplyPerInstanceVertexColor) == 0x0000CB, "Member 'UPrefabToolSettings::bForceApplyPerInstanceVertexColor' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bHideChildActorsInPIEIfHiddenInEditor) == 0x0000CC, "Member 'UPrefabToolSettings::bHideChildActorsInPIEIfHiddenInEditor' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bCanToggleChildActorVisibilityInPIE) == 0x0000CD, "Member 'UPrefabToolSettings::bCanToggleChildActorVisibilityInPIE' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bIgnoreLayersInPrefab) == 0x0000CF, "Member 'UPrefabToolSettings::bIgnoreLayersInPrefab' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bSupportGenerateBlueprint) == 0x0000D0, "Member 'UPrefabToolSettings::bSupportGenerateBlueprint' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bHarvestComponentsWhenGeneratingBlueprint) == 0x0000D1, "Member 'UPrefabToolSettings::bHarvestComponentsWhenGeneratingBlueprint' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bUseActorNameAsVariableNameWhenGeneratingBlueprint) == 0x0000D2, "Member 'UPrefabToolSettings::bUseActorNameAsVariableNameWhenGeneratingBlueprint' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bForceMobilityToMovableWhenGeneratingBlueprint) == 0x0000D3, "Member 'UPrefabToolSettings::bForceMobilityToMovableWhenGeneratingBlueprint' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, IgnoreActorClassesWhenGeneratingBlueprint) == 0x0000D8, "Member 'UPrefabToolSettings::IgnoreActorClassesWhenGeneratingBlueprint' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, IgnoreActorTagsWhenGeneratingBlueprint) == 0x0000E8, "Member 'UPrefabToolSettings::IgnoreActorTagsWhenGeneratingBlueprint' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bFlashPrefabWindowForTargetPrefabActor) == 0x0000F8, "Member 'UPrefabToolSettings::bFlashPrefabWindowForTargetPrefabActor' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bEnablePrefabTextEditor) == 0x0000F9, "Member 'UPrefabToolSettings::bEnablePrefabTextEditor' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bDebugMode) == 0x0000FA, "Member 'UPrefabToolSettings::bDebugMode' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bDisableThumbnailRender) == 0x0000FB, "Member 'UPrefabToolSettings::bDisableThumbnailRender' has a wrong offset!");
static_assert(offsetof(UPrefabToolSettings, bShowPrefabInstanceTagInPrefabToolWindow) == 0x0000FC, "Member 'UPrefabToolSettings::bShowPrefabInstanceTagInPrefabToolWindow' has a wrong offset!");
