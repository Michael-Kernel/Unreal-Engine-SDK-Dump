...
static_assert(sizeof(UFaceFXActor) == 0x000080, "Wrong size on UFaceFXActor");
static_assert(offsetof(UFaceFXActor, PlatformData) == 0x000028, "Member 'UFaceFXActor::PlatformData' has a wrong offset!");
static_assert(offsetof(UFaceFXActor, ActorData) == 0x000038, "Member 'UFaceFXActor::ActorData' has a wrong offset!");
static_assert(offsetof(UFaceFXActor, Animations) == 0x000068, "Member 'UFaceFXActor::Animations' has a wrong offset!");
static_assert(offsetof(UFaceFXActor, BlendMode) == 0x000078, "Member 'UFaceFXActor::BlendMode' has a wrong offset!");
...
static_assert(sizeof(UFaceFXAnim) == 0x000120, "Wrong size on UFaceFXAnim");
static_assert(offsetof(UFaceFXAnim, PlatformData) == 0x000028, "Member 'UFaceFXAnim::PlatformData' has a wrong offset!");
static_assert(offsetof(UFaceFXAnim, AnimData) == 0x000038, "Member 'UFaceFXAnim::AnimData' has a wrong offset!");
static_assert(offsetof(UFaceFXAnim, ID) == 0x000048, "Member 'UFaceFXAnim::ID' has a wrong offset!");
static_assert(offsetof(UFaceFXAnim, Audio) == 0x000058, "Member 'UFaceFXAnim::Audio' has a wrong offset!");
static_assert(offsetof(UFaceFXAnim, AudioAkEvent) == 0x000080, "Member 'UFaceFXAnim::AudioAkEvent' has a wrong offset!");
static_assert(offsetof(UFaceFXAnim, AudioAkEventStop) == 0x0000A8, "Member 'UFaceFXAnim::AudioAkEventStop' has a wrong offset!");
static_assert(offsetof(UFaceFXAnim, AudioAkEventPause) == 0x0000D0, "Member 'UFaceFXAnim::AudioAkEventPause' has a wrong offset!");
static_assert(offsetof(UFaceFXAnim, AudioAkEventResume) == 0x0000F8, "Member 'UFaceFXAnim::AudioAkEventResume' has a wrong offset!");
...
{
public:
	struct FFaceFXSkelMeshComponentId             SkelMeshComponentId;                               // 0x00E8(0x000C)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	struct FFaceFXAnimId                          AnimationId;                                       // 0x00F4(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_104[0x4];                                      // 0x0104(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class UFaceFXAnim>             Animation;                                         // 0x0108(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         StartOffset;                                       // 0x0130(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         EndOffset;                                         // 0x0134(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bIsAnimationDurationLoaded : 1;                    // 0x0138(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_139[0x3];                                      // 0x0139(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         AnimationDuration;                                 // 0x013C(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFaceFXAnimationSection) == 0x000140, "Wrong size on UFaceFXAnimationSection");
static_assert(offsetof(UFaceFXAnimationSection, SkelMeshComponentId) == 0x0000E8, "Member 'UFaceFXAnimationSection::SkelMeshComponentId' has a wrong offset!");
static_assert(offsetof(UFaceFXAnimationSection, AnimationId) == 0x0000F4, "Member 'UFaceFXAnimationSection::AnimationId' has a wrong offset!");
static_assert(offsetof(UFaceFXAnimationSection, Animation) == 0x000108, "Member 'UFaceFXAnimationSection::Animation' has a wrong offset!");
static_assert(offsetof(UFaceFXAnimationSection, StartOffset) == 0x000130, "Member 'UFaceFXAnimationSection::StartOffset' has a wrong offset!");
static_assert(offsetof(UFaceFXAnimationSection, EndOffset) == 0x000134, "Member 'UFaceFXAnimationSection::EndOffset' has a wrong offset!");
static_assert(offsetof(UFaceFXAnimationSection, AnimationDuration) == 0x00013C, "Member 'UFaceFXAnimationSection::AnimationDuration' has a wrong offset!");
...
static_assert(sizeof(UFaceFXAnimationTrack) == 0x0000A8, "Wrong size on UFaceFXAnimationTrack");
static_assert(offsetof(UFaceFXAnimationTrack, AnimationSections) == 0x000098, "Member 'UFaceFXAnimationTrack::AnimationSections' has a wrong offset!");
...
static_assert(sizeof(UFaceFXBlueprintLibrary) == 0x000028, "Wrong size on UFaceFXBlueprintLibrary");
...
public:
	...
	class UFaceFXActor*                           FaceFXActor;                                       // 0x00A8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_B0[0xD0];                                      // 0x00B0(0x00D0)(Fixing Size After Last Property [ Dumper-7 ])
	class UFaceFXAnim*                            CurrentAnim;                                       // 0x0180(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFaceFXCharacter) == 0x000190, "Wrong size on UFaceFXCharacter");
static_assert(offsetof(UFaceFXCharacter, FaceFXActor) == 0x0000A8, "Member 'UFaceFXCharacter::FaceFXActor' has a wrong offset!");
static_assert(offsetof(UFaceFXCharacter, CurrentAnim) == 0x000180, "Member 'UFaceFXCharacter::CurrentAnim' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnPlaybackAudioStart;                              // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPlaybackStopped;                                 // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAnimationEvent;                                  // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TArray<struct FFaceFXEntry>                   Entries;                                           // 0x00E0(0x0010)(ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFaceFXComponent) == 0x0000F8, "Wrong size on UFaceFXComponent");
static_assert(offsetof(UFaceFXComponent, OnPlaybackAudioStart) == 0x0000B0, "Member 'UFaceFXComponent::OnPlaybackAudioStart' has a wrong offset!");
static_assert(offsetof(UFaceFXComponent, OnPlaybackStopped) == 0x0000C0, "Member 'UFaceFXComponent::OnPlaybackStopped' has a wrong offset!");
static_assert(offsetof(UFaceFXComponent, OnAnimationEvent) == 0x0000D0, "Member 'UFaceFXComponent::OnAnimationEvent' has a wrong offset!");
static_assert(offsetof(UFaceFXComponent, Entries) == 0x0000E0, "Member 'UFaceFXComponent::Entries' has a wrong offset!");
...
static_assert(sizeof(UFaceFXConfig) == 0x000030, "Wrong size on UFaceFXConfig");
static_assert(offsetof(UFaceFXConfig, DefaultBlendMode) == 0x000028, "Member 'UFaceFXConfig::DefaultBlendMode' has a wrong offset!");
