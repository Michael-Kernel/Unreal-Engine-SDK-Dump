...
static_assert(sizeof(MatineeCameraShake_BlueprintUpdateCameraShake) == 0x000C50, "Wrong size on MatineeCameraShake_BlueprintUpdateCameraShake");
...
static_assert(offsetof(MatineeCameraShake_BlueprintUpdateCameraShake, ModifiedPOV) == 0x000630, "Member 'MatineeCameraShake_BlueprintUpdateCameraShake::ModifiedPOV' has a wrong offset!");
