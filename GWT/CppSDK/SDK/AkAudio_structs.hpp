...
// Enum AkAudio.AkChangeRoomType
// NumValues: 0x0004
enum class EAkChangeRoomType : uint8
{
	Always                                   = 0,
	Once                                     = 1,
	SameDefaultListener                      = 2,
	AkChangeRoomType_MAX                     = 3,
};

// Enum AkAudio.AkComponentOcclusionCollisionChannelType
// NumValues: 0x0004
enum class EAkComponentOcclusionCollisionChannelType : uint8
{
	Sound                                    = 0,
	SoundNoOcclusion                         = 1,
	SoundObject                              = 2,
	AkComponentOcclusionCollisionChannelType_MAX = 3,
};

// Enum AkAudio.AkGameObjType
// NumValues: 0x0003
enum class EAkGameObjType : uint8
{
	AkGameObjType_Global                     = 0,
	AkGameObjType_UI                         = 1,
	AkGameObjType_MAX                        = 2,
};

// Enum AkAudio.AkLanguageType
// NumValues: 0x0003
enum class EAkLanguageType : uint8
{
	SFX                                      = 0,
	Language                                 = 1,
	AkLanguageType_MAX                       = 2,
};
...
static_assert(alignof(FAkAdvancedSpatialAudioSettings) == 0x000004, "Wrong alignment on FAkAdvancedSpatialAudioSettings");
static_assert(sizeof(FAkAdvancedSpatialAudioSettings) == 0x000008, "Wrong size on FAkAdvancedSpatialAudioSettings");
static_assert(offsetof(FAkAdvancedSpatialAudioSettings, DiffractionShadowAttenuationFactor) == 0x000000, "Member 'FAkAdvancedSpatialAudioSettings::DiffractionShadowAttenuationFactor' has a wrong offset!");
static_assert(offsetof(FAkAdvancedSpatialAudioSettings, DiffractionShadowDegrees) == 0x000004, "Member 'FAkAdvancedSpatialAudioSettings::DiffractionShadowDegrees' has a wrong offset!");
...
static_assert(sizeof(FAkAdvancedInitializationSettings) == 0x000034, "Wrong size on FAkAdvancedInitializationSettings");
...
static_assert(offsetof(FAkAdvancedInitializationSettings, SpatialAudioSettings) == 0x00002C, "Member 'FAkAdvancedInitializationSettings::SpatialAudioSettings' has a wrong offset!");
...
static_assert(offsetof(FAkAdvancedInitializationSettingsWithMultiCoreRendering, EnableMultiCoreRendering) == 0x000034, "Member 'FAkAdvancedInitializationSettingsWithMultiCoreRendering::EnableMultiCoreRendering' has a wrong offset!");
...
// ScriptStruct AkAudio.AkDynamicDialogueNodeInfo
// 0x0018 (0x0018 - 0x0000)
struct alignas(0x08) FAkDynamicDialogueNodeInfo final
{
public:
	uint8                                         Pad_0[0x18];                                       // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAkDynamicDialogueNodeInfo) == 0x000008, "Wrong alignment on FAkDynamicDialogueNodeInfo");
static_assert(sizeof(FAkDynamicDialogueNodeInfo) == 0x000018, "Wrong size on FAkDynamicDialogueNodeInfo");
...
static_assert(sizeof(FAkGeometrySurfaceOverride) == 0x000010, "Wrong size on FAkGeometrySurfaceOverride");
...
static_assert(offsetof(FAkHololensAdvancedInitializationSettings, AudioAPI) == 0x000038, "Member 'FAkHololensAdvancedInitializationSettings::AudioAPI' has a wrong offset!");
static_assert(offsetof(FAkHololensAdvancedInitializationSettings, GlobalFocus) == 0x00003C, "Member 'FAkHololensAdvancedInitializationSettings::GlobalFocus' has a wrong offset!");
static_assert(offsetof(FAkHololensAdvancedInitializationSettings, UseHeadMountedDisplayAudioDevice) == 0x00003D, "Member 'FAkHololensAdvancedInitializationSettings::UseHeadMountedDisplayAudioDevice' has a wrong offset!");
...
static_assert(offsetof(FAkSpatialAudioSettings, DiffractionFlags) == 0x000004, "Member 'FAkSpatialAudioSettings::DiffractionFlags' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, MovementThreshold) == 0x000008, "Member 'FAkSpatialAudioSettings::MovementThreshold' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, NumberOfPrimaryRays) == 0x00000C, "Member 'FAkSpatialAudioSettings::NumberOfPrimaryRays' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, ReflectionOrder) == 0x000010, "Member 'FAkSpatialAudioSettings::ReflectionOrder' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, EnableDiffractionOnReflections) == 0x000014, "Member 'FAkSpatialAudioSettings::EnableDiffractionOnReflections' has a wrong offset!");
static_assert(offsetof(FAkSpatialAudioSettings, EnableDirectPathDiffraction) == 0x000015, "Member 'FAkSpatialAudioSettings::EnableDirectPathDiffraction' has a wrong offset!");
...
static_assert(offsetof(FAkSpatialAudioSettings, EnableTransmission) == 0x00001C, "Member 'FAkSpatialAudioSettings::EnableTransmission' has a wrong offset!");
...
static_assert(sizeof(FAkPS4AdvancedInitializationSettings) == 0x000040, "Wrong size on FAkPS4AdvancedInitializationSettings");
static_assert(offsetof(FAkPS4AdvancedInitializationSettings, ACPBatchBufferSize) == 0x000038, "Member 'FAkPS4AdvancedInitializationSettings::ACPBatchBufferSize' has a wrong offset!");
static_assert(offsetof(FAkPS4AdvancedInitializationSettings, UseHardwareCodecLowLatencyMode) == 0x00003C, "Member 'FAkPS4AdvancedInitializationSettings::UseHardwareCodecLowLatencyMode' has a wrong offset!");
...
public:
	...
	uint16                                        MaxNumAudioOut2Ports;                              // 0x003A(0x0002)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint16                                        MaxNumAudioOut2ObjectPorts;                        // 0x003C(0x0002)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3E[0x2];                                       // 0x003E(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FAkPS5AdvancedInitializationSettings) == 0x000040, "Wrong size on FAkPS5AdvancedInitializationSettings");
...
static_assert(offsetof(FAkPS5AdvancedInitializationSettings, MaxNumAudioOut2Ports) == 0x00003A, "Member 'FAkPS5AdvancedInitializationSettings::MaxNumAudioOut2Ports' has a wrong offset!");
static_assert(offsetof(FAkPS5AdvancedInitializationSettings, MaxNumAudioOut2ObjectPorts) == 0x00003C, "Member 'FAkPS5AdvancedInitializationSettings::MaxNumAudioOut2ObjectPorts' has a wrong offset!");
...
static_assert(offsetof(FAkPoly, Occlusion) == 0x000008, "Member 'FAkPoly::Occlusion' has a wrong offset!");
static_assert(offsetof(FAkPoly, EnableSurface) == 0x00000C, "Member 'FAkPoly::EnableSurface' has a wrong offset!");
...
static_assert(offsetof(FAkWindowsAdvancedInitializationSettings, AudioAPI) == 0x000038, "Member 'FAkWindowsAdvancedInitializationSettings::AudioAPI' has a wrong offset!");
static_assert(offsetof(FAkWindowsAdvancedInitializationSettings, GlobalFocus) == 0x00003C, "Member 'FAkWindowsAdvancedInitializationSettings::GlobalFocus' has a wrong offset!");
static_assert(offsetof(FAkWindowsAdvancedInitializationSettings, UseHeadMountedDisplayAudioDevice) == 0x00003D, "Member 'FAkWindowsAdvancedInitializationSettings::UseHeadMountedDisplayAudioDevice' has a wrong offset!");
...
static_assert(offsetof(FAkWinGDKAdvancedInitializationSettings, AudioAPI) == 0x000038, "Member 'FAkWinGDKAdvancedInitializationSettings::AudioAPI' has a wrong offset!");
static_assert(offsetof(FAkWinGDKAdvancedInitializationSettings, GlobalFocus) == 0x00003C, "Member 'FAkWinGDKAdvancedInitializationSettings::GlobalFocus' has a wrong offset!");
static_assert(offsetof(FAkWinGDKAdvancedInitializationSettings, UseHeadMountedDisplayAudioDevice) == 0x00003D, "Member 'FAkWinGDKAdvancedInitializationSettings::UseHeadMountedDisplayAudioDevice' has a wrong offset!");
...
static_assert(alignof(FAkXboxOneGDKApuHeapInitializationSettings) == 0x000004, "Wrong alignment on FAkXboxOneGDKApuHeapInitializationSettings");
static_assert(sizeof(FAkXboxOneGDKApuHeapInitializationSettings) == 0x000008, "Wrong size on FAkXboxOneGDKApuHeapInitializationSettings");
static_assert(offsetof(FAkXboxOneGDKApuHeapInitializationSettings, CachedSize) == 0x000000, "Member 'FAkXboxOneGDKApuHeapInitializationSettings::CachedSize' has a wrong offset!");
static_assert(offsetof(FAkXboxOneGDKApuHeapInitializationSettings, NonCachedSize) == 0x000004, "Member 'FAkXboxOneGDKApuHeapInitializationSettings::NonCachedSize' has a wrong offset!");
...
static_assert(alignof(FAkXboxOneGDKAdvancedInitializationSettings) == 0x000004, "Wrong alignment on FAkXboxOneGDKAdvancedInitializationSettings");
static_assert(sizeof(FAkXboxOneGDKAdvancedInitializationSettings) == 0x00003C, "Wrong size on FAkXboxOneGDKAdvancedInitializationSettings");
static_assert(offsetof(FAkXboxOneGDKAdvancedInitializationSettings, MaximumNumberOfXMAVoices) == 0x000038, "Member 'FAkXboxOneGDKAdvancedInitializationSettings::MaximumNumberOfXMAVoices' has a wrong offset!");
static_assert(offsetof(FAkXboxOneGDKAdvancedInitializationSettings, UseHardwareCodecLowLatencyMode) == 0x00003A, "Member 'FAkXboxOneGDKAdvancedInitializationSettings::UseHardwareCodecLowLatencyMode' has a wrong offset!");
...
static_assert(sizeof(FAkXboxOneAdvancedInitializationSettings) == 0x00003C, "Wrong size on FAkXboxOneAdvancedInitializationSettings");
static_assert(offsetof(FAkXboxOneAdvancedInitializationSettings, MaximumNumberOfXMAVoices) == 0x000038, "Member 'FAkXboxOneAdvancedInitializationSettings::MaximumNumberOfXMAVoices' has a wrong offset!");
static_assert(offsetof(FAkXboxOneAdvancedInitializationSettings, UseHardwareCodecLowLatencyMode) == 0x00003A, "Member 'FAkXboxOneAdvancedInitializationSettings::UseHardwareCodecLowLatencyMode' has a wrong offset!");
