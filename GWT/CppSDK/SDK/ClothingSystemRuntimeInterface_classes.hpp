...
public:
	...
	TMap<uint32, uint32>                          ModelIndexMap;                                     // 0x0090(0x0050)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UClothPhysicalMeshDataBase_Legacy) == 0x000130, "Wrong size on UClothPhysicalMeshDataBase_Legacy");
...
static_assert(offsetof(UClothPhysicalMeshDataBase_Legacy, ModelIndexMap) == 0x000090, "Member 'UClothPhysicalMeshDataBase_Legacy::ModelIndexMap' has a wrong offset!");
