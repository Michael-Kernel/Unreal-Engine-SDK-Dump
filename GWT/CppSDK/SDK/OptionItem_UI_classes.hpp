...
// WidgetBlueprintGeneratedClass OptionItem_UI.OptionItem_UI_C
// 0x0070 (0x04C0 - 0x0450)
class UOptionItem_UI_C final : public USnfOptionItemBaseWidget
{
public:
...
public:
	...
	void ExecuteUbergraph_OptionItem_UI(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"OptionItem_UI_C">();
	}
	static class UOptionItem_UI_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UOptionItem_UI_C>();
	}
};
static_assert(alignof(UOptionItem_UI_C) == 0x000008, "Wrong alignment on UOptionItem_UI_C");
static_assert(sizeof(UOptionItem_UI_C) == 0x0004C0, "Wrong size on UOptionItem_UI_C");
static_assert(offsetof(UOptionItem_UI_C, UberGraphFrame) == 0x000450, "Member 'UOptionItem_UI_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UOptionItem_UI_C, SelectAnim) == 0x000458, "Member 'UOptionItem_UI_C::SelectAnim' has a wrong offset!");
static_assert(offsetof(UOptionItem_UI_C, AddPlus) == 0x000460, "Member 'UOptionItem_UI_C::AddPlus' has a wrong offset!");
static_assert(offsetof(UOptionItem_UI_C, AddMinus) == 0x000468, "Member 'UOptionItem_UI_C::AddMinus' has a wrong offset!");
static_assert(offsetof(UOptionItem_UI_C, ChangeIcon) == 0x000470, "Member 'UOptionItem_UI_C::ChangeIcon' has a wrong offset!");
static_assert(offsetof(UOptionItem_UI_C, Left) == 0x000478, "Member 'UOptionItem_UI_C::Left' has a wrong offset!");
static_assert(offsetof(UOptionItem_UI_C, Right) == 0x000480, "Member 'UOptionItem_UI_C::Right' has a wrong offset!");
static_assert(offsetof(UOptionItem_UI_C, SliderBarImage) == 0x000488, "Member 'UOptionItem_UI_C::SliderBarImage' has a wrong offset!");
static_assert(offsetof(UOptionItem_UI_C, SliderCircle) == 0x000490, "Member 'UOptionItem_UI_C::SliderCircle' has a wrong offset!");
static_assert(offsetof(UOptionItem_UI_C, SliderOverlayBase) == 0x000498, "Member 'UOptionItem_UI_C::SliderOverlayBase' has a wrong offset!");
static_assert(offsetof(UOptionItem_UI_C, SliderTextBlock_0) == 0x0004A0, "Member 'UOptionItem_UI_C::SliderTextBlock_0' has a wrong offset!");
static_assert(offsetof(UOptionItem_UI_C, SliderTextOverlay) == 0x0004A8, "Member 'UOptionItem_UI_C::SliderTextOverlay' has a wrong offset!");
static_assert(offsetof(UOptionItem_UI_C, TitleText_0) == 0x0004B0, "Member 'UOptionItem_UI_C::TitleText_0' has a wrong offset!");
static_assert(offsetof(UOptionItem_UI_C, ValueText_0) == 0x0004B8, "Member 'UOptionItem_UI_C::ValueText_0' has a wrong offset!");
