...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05D2BCA0;
	constexpr int32 AppendString      = 0x0096302C;
	constexpr int32 GNames            = 0x05EF1580;
	constexpr int32 GWorld            = 0x05EE1BE8;
	constexpr int32 ProcessEvent      = 0x00921170;
