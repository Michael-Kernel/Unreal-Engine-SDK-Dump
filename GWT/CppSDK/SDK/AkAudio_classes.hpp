...
// 0x0450 (0x0670 - 0x0220)
class UAkComponent : public UAkGameObject
{
public:
	class FString                                 WwiseDeviceName;                                   // 0x0218(0x0010)(Edit, BlueprintVisible, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AudioDeviceName;                                   // 0x0228(0x0010)(Edit, BlueprintVisible, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_238[0x8];                                      // 0x0238(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bUseSpatialAudio;                                  // 0x0240(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_241[0x7];                                      // 0x0241(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	ECollisionChannel                             OcclusionCollisionChannel;                         // 0x0248(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_249[0x3];                                      // 0x0249(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         EnableSpotReflectors : 1;                          // 0x024C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	int32                                         EarlyReflectionOrder;                              // 0x0268(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	int32                                         DiffractionMaxEdges;                               // 0x0278(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         DiffractionMaxPaths;                               // 0x027C(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                         DrawFirstOrderReflections : 1;                     // 0x0284(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         DrawSecondOrderReflections : 1;                    // 0x0284(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         DrawHigherOrderReflections : 1;                    // 0x0284(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         DrawDiffraction : 1;                               // 0x0284(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	uint8                                         Pad_295[0x16B];                                    // 0x0295(0x016B)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          SetComponentTickEnabledWhenPlayingOnly;            // 0x0400(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_401[0x7];                                      // 0x0401(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnEventMusicSyncDispatcher_Bar;                    // 0x0408(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnEventMusicSyncDispatcher_Beat;                   // 0x0418(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnEventMusicSyncDispatcher_Entry;                  // 0x0428(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnEventMusicSyncDispatcher_Exit;                   // 0x0438(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnEventMusicSyncDispatcher_Point;                  // 0x0448(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnEventMusicSyncDispatcher_UserCue;                // 0x0458(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnEventMusicSyncDispatcher_UserCueWithString;      // 0x0468(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnEventMusicSyncDispatcher_Grid;                   // 0x0478(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMIDIEventDispatcher_NoteOn;                      // 0x0488(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMIDIEventDispatcher_NoteOff;                     // 0x0498(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMIDIEventDispatcher_Cc;                          // 0x04A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMIDIEventDispatcher_PitchBend;                   // 0x04B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMIDIEventDispatcher_NoteAfiterTouch;             // 0x04C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMIDIEventDispatcher_ChanAfterTouch;              // 0x04D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMIDIEventDispatcher_ProgramChange;               // 0x04E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMIDIEventDispatcher_SysEx;                       // 0x04F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMIDIEventDispatcher_Escape;                      // 0x0508(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMIDIEventDispatcher_Meta;                        // 0x0518(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_528[0x28];                                     // 0x0528(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         RoomComponentRefreshInterval;                      // 0x0550(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_554[0x1];                                      // 0x0554(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	EAkChangeRoomType                             ChangeRoomType;                                    // 0x0555(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_556[0x102];                                    // 0x0556(0x0102)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UAkLateReverbComponent*>         M_CurrentLateReverbComponents;                     // 0x0658(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
public:
	...
	bool Pause(class UAkAudioEvent* AkEvent, int32 FadeTimeMs);
	...
	int32 PostAkEventCullDistance(class UAkAudioEvent* AkEvent);
	int32 PostAkEventWithMusicCallback(class UAkAudioEvent* AkEvent);
	...
	int32 PostAssociatedAkEventCullDistance(int32 CallbackMask, const TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)>& PostEventCallback);
	void PostTrigger(class UAkTrigger* TriggerValue, const class FString& Trigger);
	bool Resume(class UAkAudioEvent* AkEvent, int32 FadeTimeMs);
	bool Seek(float Percent, class UAkAudioEvent* AkEvent, const class FString& In_EventName);
...
static_assert(sizeof(UAkComponent) == 0x000670, "Wrong size on UAkComponent");
static_assert(offsetof(UAkComponent, WwiseDeviceName) == 0x000218, "Member 'UAkComponent::WwiseDeviceName' has a wrong offset!");
static_assert(offsetof(UAkComponent, AudioDeviceName) == 0x000228, "Member 'UAkComponent::AudioDeviceName' has a wrong offset!");
static_assert(offsetof(UAkComponent, bUseSpatialAudio) == 0x000240, "Member 'UAkComponent::bUseSpatialAudio' has a wrong offset!");
static_assert(offsetof(UAkComponent, OcclusionCollisionChannel) == 0x000248, "Member 'UAkComponent::OcclusionCollisionChannel' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionAuxBus) == 0x000250, "Member 'UAkComponent::EarlyReflectionAuxBus' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionAuxBusName) == 0x000258, "Member 'UAkComponent::EarlyReflectionAuxBusName' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionOrder) == 0x000268, "Member 'UAkComponent::EarlyReflectionOrder' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionBusSendGain) == 0x00026C, "Member 'UAkComponent::EarlyReflectionBusSendGain' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionMaxPathLength) == 0x000270, "Member 'UAkComponent::EarlyReflectionMaxPathLength' has a wrong offset!");
static_assert(offsetof(UAkComponent, RoomReverbAuxBusGain) == 0x000274, "Member 'UAkComponent::RoomReverbAuxBusGain' has a wrong offset!");
static_assert(offsetof(UAkComponent, DiffractionMaxEdges) == 0x000278, "Member 'UAkComponent::DiffractionMaxEdges' has a wrong offset!");
static_assert(offsetof(UAkComponent, DiffractionMaxPaths) == 0x00027C, "Member 'UAkComponent::DiffractionMaxPaths' has a wrong offset!");
static_assert(offsetof(UAkComponent, DiffractionMaxPathLength) == 0x000280, "Member 'UAkComponent::DiffractionMaxPathLength' has a wrong offset!");
static_assert(offsetof(UAkComponent, StopWhenOwnerDestroyed) == 0x000288, "Member 'UAkComponent::StopWhenOwnerDestroyed' has a wrong offset!");
static_assert(offsetof(UAkComponent, AttenuationScalingFactor) == 0x00028C, "Member 'UAkComponent::AttenuationScalingFactor' has a wrong offset!");
static_assert(offsetof(UAkComponent, OcclusionRefreshInterval) == 0x000290, "Member 'UAkComponent::OcclusionRefreshInterval' has a wrong offset!");
static_assert(offsetof(UAkComponent, bUseReverbVolumes) == 0x000294, "Member 'UAkComponent::bUseReverbVolumes' has a wrong offset!");
static_assert(offsetof(UAkComponent, SetComponentTickEnabledWhenPlayingOnly) == 0x000400, "Member 'UAkComponent::SetComponentTickEnabledWhenPlayingOnly' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnEventMusicSyncDispatcher_Bar) == 0x000408, "Member 'UAkComponent::OnEventMusicSyncDispatcher_Bar' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnEventMusicSyncDispatcher_Beat) == 0x000418, "Member 'UAkComponent::OnEventMusicSyncDispatcher_Beat' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnEventMusicSyncDispatcher_Entry) == 0x000428, "Member 'UAkComponent::OnEventMusicSyncDispatcher_Entry' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnEventMusicSyncDispatcher_Exit) == 0x000438, "Member 'UAkComponent::OnEventMusicSyncDispatcher_Exit' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnEventMusicSyncDispatcher_Point) == 0x000448, "Member 'UAkComponent::OnEventMusicSyncDispatcher_Point' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnEventMusicSyncDispatcher_UserCue) == 0x000458, "Member 'UAkComponent::OnEventMusicSyncDispatcher_UserCue' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnEventMusicSyncDispatcher_UserCueWithString) == 0x000468, "Member 'UAkComponent::OnEventMusicSyncDispatcher_UserCueWithString' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnEventMusicSyncDispatcher_Grid) == 0x000478, "Member 'UAkComponent::OnEventMusicSyncDispatcher_Grid' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnMIDIEventDispatcher_NoteOn) == 0x000488, "Member 'UAkComponent::OnMIDIEventDispatcher_NoteOn' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnMIDIEventDispatcher_NoteOff) == 0x000498, "Member 'UAkComponent::OnMIDIEventDispatcher_NoteOff' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnMIDIEventDispatcher_Cc) == 0x0004A8, "Member 'UAkComponent::OnMIDIEventDispatcher_Cc' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnMIDIEventDispatcher_PitchBend) == 0x0004B8, "Member 'UAkComponent::OnMIDIEventDispatcher_PitchBend' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnMIDIEventDispatcher_NoteAfiterTouch) == 0x0004C8, "Member 'UAkComponent::OnMIDIEventDispatcher_NoteAfiterTouch' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnMIDIEventDispatcher_ChanAfterTouch) == 0x0004D8, "Member 'UAkComponent::OnMIDIEventDispatcher_ChanAfterTouch' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnMIDIEventDispatcher_ProgramChange) == 0x0004E8, "Member 'UAkComponent::OnMIDIEventDispatcher_ProgramChange' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnMIDIEventDispatcher_SysEx) == 0x0004F8, "Member 'UAkComponent::OnMIDIEventDispatcher_SysEx' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnMIDIEventDispatcher_Escape) == 0x000508, "Member 'UAkComponent::OnMIDIEventDispatcher_Escape' has a wrong offset!");
static_assert(offsetof(UAkComponent, OnMIDIEventDispatcher_Meta) == 0x000518, "Member 'UAkComponent::OnMIDIEventDispatcher_Meta' has a wrong offset!");
static_assert(offsetof(UAkComponent, RoomComponentRefreshInterval) == 0x000550, "Member 'UAkComponent::RoomComponentRefreshInterval' has a wrong offset!");
static_assert(offsetof(UAkComponent, ChangeRoomType) == 0x000555, "Member 'UAkComponent::ChangeRoomType' has a wrong offset!");
static_assert(offsetof(UAkComponent, M_CurrentLateReverbComponents) == 0x000658, "Member 'UAkComponent::M_CurrentLateReverbComponents' has a wrong offset!");
...
{
public:
	EAkAcousticPortalState                        InitialState;                                      // 0x0260(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_261[0x3];                                      // 0x0261(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ObstructionRefreshInterval;                        // 0x0264(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECollisionChannel                             ObstructionCollisionChannel;                       // 0x0268(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_269[0x3];                                      // 0x0269(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TickInterval;                                      // 0x026C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CullingDistance;                                   // 0x0270(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_274[0x8];                                      // 0x0274(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bFindFrontRoomWhenBeginPlay;                       // 0x027C(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFindBackRoomWhenBeginPlay;                        // 0x027D(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_27E[0x2];                                      // 0x027E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class UAkRoomComponent*                       FrontRoomCmp;                                      // 0x0280(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAkRoomComponent*                       BackRoomCmp;                                       // 0x0288(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAkAcousticPortal) == 0x000318, "Wrong size on AAkAcousticPortal");
static_assert(offsetof(AAkAcousticPortal, InitialState) == 0x000260, "Member 'AAkAcousticPortal::InitialState' has a wrong offset!");
static_assert(offsetof(AAkAcousticPortal, ObstructionRefreshInterval) == 0x000264, "Member 'AAkAcousticPortal::ObstructionRefreshInterval' has a wrong offset!");
static_assert(offsetof(AAkAcousticPortal, ObstructionCollisionChannel) == 0x000268, "Member 'AAkAcousticPortal::ObstructionCollisionChannel' has a wrong offset!");
static_assert(offsetof(AAkAcousticPortal, TickInterval) == 0x00026C, "Member 'AAkAcousticPortal::TickInterval' has a wrong offset!");
static_assert(offsetof(AAkAcousticPortal, CullingDistance) == 0x000270, "Member 'AAkAcousticPortal::CullingDistance' has a wrong offset!");
static_assert(offsetof(AAkAcousticPortal, bFindFrontRoomWhenBeginPlay) == 0x00027C, "Member 'AAkAcousticPortal::bFindFrontRoomWhenBeginPlay' has a wrong offset!");
static_assert(offsetof(AAkAcousticPortal, bFindBackRoomWhenBeginPlay) == 0x00027D, "Member 'AAkAcousticPortal::bFindBackRoomWhenBeginPlay' has a wrong offset!");
static_assert(offsetof(AAkAcousticPortal, FrontRoomCmp) == 0x000280, "Member 'AAkAcousticPortal::FrontRoomCmp' has a wrong offset!");
static_assert(offsetof(AAkAcousticPortal, BackRoomCmp) == 0x000288, "Member 'AAkAcousticPortal::BackRoomCmp' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_23A[0x2E];                                     // 0x023A(0x002E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AAkAmbientSound) == 0x000268, "Wrong size on AAkAmbientSound");
...
public:
	...
	TMap<class FName, float>                      PerLanguageDurationMax;                            // 0x0290(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkAudioEventData) == 0x0002E0, "Wrong size on UAkAudioEventData");
...
static_assert(offsetof(UAkAudioEventData, PerLanguageDurationMax) == 0x000290, "Member 'UAkAudioEventData::PerLanguageDurationMax' has a wrong offset!");
...
{
public:
	bool                                          Decode;                                            // 0x0050(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAkLanguageType                               LanguageType;                                      // 0x0051(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AutoLoad;                                          // 0x0052(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkAudioBank, Decode) == 0x000050, "Member 'UAkAudioBank::Decode' has a wrong offset!");
static_assert(offsetof(UAkAudioBank, LanguageType) == 0x000051, "Member 'UAkAudioBank::LanguageType' has a wrong offset!");
static_assert(offsetof(UAkAudioBank, AutoLoad) == 0x000052, "Member 'UAkAudioBank::AutoLoad' has a wrong offset!");
...
public:
	...
	float                                         MaxAttenuationRadius_;                             // 0x00B8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IsInfinite_;                                       // 0x00BC(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_BD[0x3];                                       // 0x00BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinimumDuration_;                                  // 0x00C0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaximumDuration_;                                  // 0x00C4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FName, float>                      PerLanguageDurationMax_;                           // 0x00C8(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	TMap<class FName, float>                      PerLanguageDurationMin_;                           // 0x0118(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
...
public:
	...
	const TMap<class FName, float> GetPerLanguageDurationMax() const;
	const TMap<class FName, float> GetPerLanguageDurationMin() const;
...
static_assert(sizeof(UAkAudioEvent) == 0x000170, "Wrong size on UAkAudioEvent");
...
static_assert(offsetof(UAkAudioEvent, MaxAttenuationRadius_) == 0x0000B8, "Member 'UAkAudioEvent::MaxAttenuationRadius_' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, IsInfinite_) == 0x0000BC, "Member 'UAkAudioEvent::IsInfinite_' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, MinimumDuration_) == 0x0000C0, "Member 'UAkAudioEvent::MinimumDuration_' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, MaximumDuration_) == 0x0000C4, "Member 'UAkAudioEvent::MaximumDuration_' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, PerLanguageDurationMax_) == 0x0000C8, "Member 'UAkAudioEvent::PerLanguageDurationMax_' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, PerLanguageDurationMin_) == 0x000118, "Member 'UAkAudioEvent::PerLanguageDurationMin_' has a wrong offset!");
...
static_assert(sizeof(UAkAudioInputComponent) == 0x0006A0, "Wrong size on UAkAudioInputComponent");
...
public:
	...
	float                                         MaxAttenuationRadius;                              // 0x0058(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkChinookPlatformInfo) == 0x000070, "Wrong size on UAkChinookPlatformInfo");
...
static_assert(sizeof(UAkMPXPlatformInfo) == 0x000070, "Wrong size on UAkMPXPlatformInfo");
...
// Class AkAudio.AkDynamicDialogueEvent
// 0x0008 (0x0048 - 0x0040)
class UAkDynamicDialogueEvent final : public UAkAudioType
{
public:
	class UAkAudioBank*                           RequiredBank;                                      // 0x0040(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AkDynamicDialogueEvent">();
	}
	static class UAkDynamicDialogueEvent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAkDynamicDialogueEvent>();
	}
};
static_assert(alignof(UAkDynamicDialogueEvent) == 0x000008, "Wrong alignment on UAkDynamicDialogueEvent");
static_assert(sizeof(UAkDynamicDialogueEvent) == 0x000048, "Wrong size on UAkDynamicDialogueEvent");
static_assert(offsetof(UAkDynamicDialogueEvent, RequiredBank) == 0x000040, "Member 'UAkDynamicDialogueEvent::RequiredBank' has a wrong offset!");
...
public:
	...
	static bool GetCollisionChannel(EAkComponentOcclusionCollisionChannelType Type, ECollisionChannel* CollisionChannel);
	...
	static float GetSourcePlayPosition(int32 PlayingID, bool bExtrapolate);
	...
	static bool IsPlayingByPlayingID(int32 PlayingID);
	...
	static int32 PostEventGlobal(class UAkAudioEvent* AkEvent, EAkGameObjType Type);
	static int32 PostEventGlobalWithCallback(class UAkAudioEvent* AkEvent, int32 CallbackMask, const TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)>& PostEventCallback, EAkGameObjType Type);
	...
	static void SeekOnEvent(const class FString& In_EventName, class AActor* In_pActor, float In_fPercent, bool In_bSeekToNearestMarker, int32 InPlayingID);
	static void SeekOnEventByPosition(const class FString& In_EventName, class AActor* In_pActor, int32 In_PositionMsec, bool In_bSeekToNearestMarker, int32 InPlayingID);
	static void SeekOnEventGlobal(const class FString& In_EventName, float In_fPercent, bool In_bSeekToNearestMarker, int32 InPlayingID);
	static void SeekOnEventGlobalByPosition(const class FString& In_EventName, int32 In_PositionMsec, bool In_bSeekToNearestMarker, int32 InPlayingID);
	...
	static void SetRTPCValueGlobal(class FName RTPC, float Value, int32 InterpolationTimeMs, EAkGameObjType Type);
	...
	static void SetUpdateListenerPosition(bool bEnable);
	...
	static void StopPlayingID(int32 PlayingID, int32 FadeOutTimeMs);
...
{
public:
	EAkMeshType                                   MeshType;                                          // 0x01F8(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1F9[0x3];                                      // 0x01F9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         LOD;                                               // 0x01FC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WeldingThreshold;                                  // 0x0200(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_204[0x4];                                      // 0x0204(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class UMaterialInterface*, struct FAkGeometrySurfaceOverride> StaticMeshSurfaceOverride;                         // 0x0208(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FAkGeometrySurfaceOverride             CollisionMeshSurfaceOverride;                      // 0x0258(0x0010)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkGeometryComponent) == 0x000330, "Wrong size on UAkGeometryComponent");
static_assert(offsetof(UAkGeometryComponent, MeshType) == 0x0001F8, "Member 'UAkGeometryComponent::MeshType' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, LOD) == 0x0001FC, "Member 'UAkGeometryComponent::LOD' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, WeldingThreshold) == 0x000200, "Member 'UAkGeometryComponent::WeldingThreshold' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, StaticMeshSurfaceOverride) == 0x000208, "Member 'UAkGeometryComponent::StaticMeshSurfaceOverride' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, CollisionMeshSurfaceOverride) == 0x000258, "Member 'UAkGeometryComponent::CollisionMeshSurfaceOverride' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, AssociatedRoom) == 0x000270, "Member 'UAkGeometryComponent::AssociatedRoom' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, GeometryData) == 0x000288, "Member 'UAkGeometryComponent::GeometryData' has a wrong offset!");
...
public:
	...
	class FString                                 AuxBusName;                                        // 0x0208(0x0010)(Edit, BlueprintVisible, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkLateReverbComponent) == 0x000240, "Wrong size on UAkLateReverbComponent");
static_assert(offsetof(UAkLateReverbComponent, AuxBus) == 0x000200, "Member 'UAkLateReverbComponent::AuxBus' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, AuxBusName) == 0x000208, "Member 'UAkLateReverbComponent::AuxBusName' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, SendLevel) == 0x000218, "Member 'UAkLateReverbComponent::SendLevel' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, FadeRate) == 0x00021C, "Member 'UAkLateReverbComponent::FadeRate' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, Priority) == 0x000220, "Member 'UAkLateReverbComponent::Priority' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, NextLowerPriorityComponent) == 0x000228, "Member 'UAkLateReverbComponent::NextLowerPriorityComponent' has a wrong offset!");
...
static_assert(sizeof(UAkLuminPlatformInfo) == 0x000070, "Wrong size on UAkLuminPlatformInfo");
...
static_assert(sizeof(UAkPellegrinoPlatformInfo) == 0x000070, "Wrong size on UAkPellegrinoPlatformInfo");
...
static_assert(sizeof(UAkDPXPlatformInfo) == 0x000070, "Wrong size on UAkDPXPlatformInfo");
...
public:
	...
	struct FAkCommonInitializationSettings        CommonSettings;                                    // 0x0030(0x0060)(Edit, Config, NativeAccessSpecifierPublic)
	struct FAkCommunicationSettingsWithSystemInitialization CommunicationSettings;                             // 0x0090(0x0028)(Edit, Config, NativeAccessSpecifierPublic)
	struct FAkPS5AdvancedInitializationSettings   AdvancedSettings;                                  // 0x00B8(0x0040)(Edit, Config, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkPS5InitializationSettings) == 0x0000F8, "Wrong size on UAkPS5InitializationSettings");
...
static_assert(sizeof(UAkDPXInitializationSettings) == 0x0000F8, "Wrong size on UAkDPXInitializationSettings");
...
{
public:
	uint8                                         bEnable : 1;                                       // 0x0218(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	float                                         AuxSendLevel;                                      // 0x0230(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AutoPost;                                          // 0x0234(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, SimpleDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_235[0xB];                                      // 0x0235(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         EnvEventsFadeOutTime;                              // 0x0240(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IgnoreEnvEvents;                                   // 0x0244(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_245[0x3];                                      // 0x0245(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UAkAudioEvent*>                  EnvEvents;                                         // 0x0248(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class UAkAudioEvent*>                  InEvents;                                          // 0x0258(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class UAkAudioEvent*>                  OutEvents;                                         // 0x0268(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkRoomComponent) == 0x000280, "Wrong size on UAkRoomComponent");
static_assert(offsetof(UAkRoomComponent, NextLowerPriorityComponent) == 0x000220, "Member 'UAkRoomComponent::NextLowerPriorityComponent' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, Priority) == 0x000228, "Member 'UAkRoomComponent::Priority' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, WallOcclusion) == 0x00022C, "Member 'UAkRoomComponent::WallOcclusion' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, AuxSendLevel) == 0x000230, "Member 'UAkRoomComponent::AuxSendLevel' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, AutoPost) == 0x000234, "Member 'UAkRoomComponent::AutoPost' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, EnvEventsFadeOutTime) == 0x000240, "Member 'UAkRoomComponent::EnvEventsFadeOutTime' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, IgnoreEnvEvents) == 0x000244, "Member 'UAkRoomComponent::IgnoreEnvEvents' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, EnvEvents) == 0x000248, "Member 'UAkRoomComponent::EnvEvents' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, InEvents) == 0x000258, "Member 'UAkRoomComponent::InEvents' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, OutEvents) == 0x000268, "Member 'UAkRoomComponent::OutEvents' has a wrong offset!");
...
public:
	...
	ECollisionChannel                             DefaultAkSphereComponent2OcclusionCollisionChannel; // 0x0139(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_13A[0x2];                                      // 0x013A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   DefaultSpatialAudioVolumeCollisionProfileName;     // 0x013C(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECollisionChannel                             DefaultAcousticPortalObstructionCollisionChannel;  // 0x0144(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_145[0x3];                                      // 0x0145(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   DefaultAcousticPortalCollisionProfileName;         // 0x0148(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECollisionChannel                             DefaultakMPLOcclusionCollisionChannel;             // 0x0150(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECollisionChannel                             OcclusionCollisionChannelSound;                    // 0x0151(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECollisionChannel                             OcclusionCollisionChannelSoundNoOcclusion;         // 0x0152(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECollisionChannel                             OcclusionCollisionChannelSoundObject;              // 0x0153(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FFR;                                               // 0x0154(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FSR;                                               // 0x0158(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FSBR;                                              // 0x015C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         FFHeight;                                          // 0x0160(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PrepareBankPoolSizeMB;                             // 0x0164(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FSoftObjectPath>                ResidentBanks;                                     // 0x0168(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	bool                                          bCreateListenerForPlayerCameraManagerOnly;         // 0x0178(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_179[0x3];                                      // 0x0179(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TpsListenerCoef;                                   // 0x017C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RoomRefreshInterval;                               // 0x0180(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         UpdateRoomMinimumDistanceSquared;                  // 0x0184(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHapticFeedbackWithMotionEnabled;                  // 0x0188(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_189[0x7];                                      // 0x0189(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 MotionDeviceStateGroupe;                           // 0x0190(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 HapticFeedbackStateON;                             // 0x01A0(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 HapticFeedbackStateOFF;                            // 0x01B0(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkSettings) == 0x0001C0, "Wrong size on UAkSettings");
...
static_assert(offsetof(UAkSettings, SplitSwitchContainerMedia) == 0x0000A8, "Member 'UAkSettings::SplitSwitchContainerMedia' has a wrong offset!");
static_assert(offsetof(UAkSettings, SplitMediaPerFolder) == 0x0000A9, "Member 'UAkSettings::SplitMediaPerFolder' has a wrong offset!");
static_assert(offsetof(UAkSettings, UseEventBasedPackaging) == 0x0000AA, "Member 'UAkSettings::UseEventBasedPackaging' has a wrong offset!");
static_assert(offsetof(UAkSettings, EnableAutomaticAssetSynchronization) == 0x0000AB, "Member 'UAkSettings::EnableAutomaticAssetSynchronization' has a wrong offset!");
static_assert(offsetof(UAkSettings, CommandletCommitMessage) == 0x0000B0, "Member 'UAkSettings::CommandletCommitMessage' has a wrong offset!");
static_assert(offsetof(UAkSettings, UnrealCultureToWwiseCulture) == 0x0000C0, "Member 'UAkSettings::UnrealCultureToWwiseCulture' has a wrong offset!");
static_assert(offsetof(UAkSettings, AskedToUseNewAssetManagement) == 0x000110, "Member 'UAkSettings::AskedToUseNewAssetManagement' has a wrong offset!");
static_assert(offsetof(UAkSettings, bEnableMultiCoreRendering) == 0x000111, "Member 'UAkSettings::bEnableMultiCoreRendering' has a wrong offset!");
static_assert(offsetof(UAkSettings, MigratedEnableMultiCoreRendering) == 0x000112, "Member 'UAkSettings::MigratedEnableMultiCoreRendering' has a wrong offset!");
static_assert(offsetof(UAkSettings, FixupRedirectorsDuringMigration) == 0x000113, "Member 'UAkSettings::FixupRedirectorsDuringMigration' has a wrong offset!");
static_assert(offsetof(UAkSettings, WwiseWindowsInstallationPath) == 0x000118, "Member 'UAkSettings::WwiseWindowsInstallationPath' has a wrong offset!");
static_assert(offsetof(UAkSettings, WwiseMacInstallationPath) == 0x000128, "Member 'UAkSettings::WwiseMacInstallationPath' has a wrong offset!");
static_assert(offsetof(UAkSettings, DefaultAkSphereComponent2OcclusionCollisionChannel) == 0x000139, "Member 'UAkSettings::DefaultAkSphereComponent2OcclusionCollisionChannel' has a wrong offset!");
static_assert(offsetof(UAkSettings, DefaultSpatialAudioVolumeCollisionProfileName) == 0x00013C, "Member 'UAkSettings::DefaultSpatialAudioVolumeCollisionProfileName' has a wrong offset!");
static_assert(offsetof(UAkSettings, DefaultAcousticPortalObstructionCollisionChannel) == 0x000144, "Member 'UAkSettings::DefaultAcousticPortalObstructionCollisionChannel' has a wrong offset!");
static_assert(offsetof(UAkSettings, DefaultAcousticPortalCollisionProfileName) == 0x000148, "Member 'UAkSettings::DefaultAcousticPortalCollisionProfileName' has a wrong offset!");
static_assert(offsetof(UAkSettings, DefaultakMPLOcclusionCollisionChannel) == 0x000150, "Member 'UAkSettings::DefaultakMPLOcclusionCollisionChannel' has a wrong offset!");
static_assert(offsetof(UAkSettings, OcclusionCollisionChannelSound) == 0x000151, "Member 'UAkSettings::OcclusionCollisionChannelSound' has a wrong offset!");
static_assert(offsetof(UAkSettings, OcclusionCollisionChannelSoundNoOcclusion) == 0x000152, "Member 'UAkSettings::OcclusionCollisionChannelSoundNoOcclusion' has a wrong offset!");
static_assert(offsetof(UAkSettings, OcclusionCollisionChannelSoundObject) == 0x000153, "Member 'UAkSettings::OcclusionCollisionChannelSoundObject' has a wrong offset!");
static_assert(offsetof(UAkSettings, FFR) == 0x000154, "Member 'UAkSettings::FFR' has a wrong offset!");
static_assert(offsetof(UAkSettings, FSR) == 0x000158, "Member 'UAkSettings::FSR' has a wrong offset!");
static_assert(offsetof(UAkSettings, FSBR) == 0x00015C, "Member 'UAkSettings::FSBR' has a wrong offset!");
static_assert(offsetof(UAkSettings, FFHeight) == 0x000160, "Member 'UAkSettings::FFHeight' has a wrong offset!");
static_assert(offsetof(UAkSettings, PrepareBankPoolSizeMB) == 0x000164, "Member 'UAkSettings::PrepareBankPoolSizeMB' has a wrong offset!");
static_assert(offsetof(UAkSettings, ResidentBanks) == 0x000168, "Member 'UAkSettings::ResidentBanks' has a wrong offset!");
static_assert(offsetof(UAkSettings, bCreateListenerForPlayerCameraManagerOnly) == 0x000178, "Member 'UAkSettings::bCreateListenerForPlayerCameraManagerOnly' has a wrong offset!");
static_assert(offsetof(UAkSettings, TpsListenerCoef) == 0x00017C, "Member 'UAkSettings::TpsListenerCoef' has a wrong offset!");
static_assert(offsetof(UAkSettings, RoomRefreshInterval) == 0x000180, "Member 'UAkSettings::RoomRefreshInterval' has a wrong offset!");
static_assert(offsetof(UAkSettings, UpdateRoomMinimumDistanceSquared) == 0x000184, "Member 'UAkSettings::UpdateRoomMinimumDistanceSquared' has a wrong offset!");
static_assert(offsetof(UAkSettings, bHapticFeedbackWithMotionEnabled) == 0x000188, "Member 'UAkSettings::bHapticFeedbackWithMotionEnabled' has a wrong offset!");
static_assert(offsetof(UAkSettings, MotionDeviceStateGroupe) == 0x000190, "Member 'UAkSettings::MotionDeviceStateGroupe' has a wrong offset!");
static_assert(offsetof(UAkSettings, HapticFeedbackStateON) == 0x0001A0, "Member 'UAkSettings::HapticFeedbackStateON' has a wrong offset!");
static_assert(offsetof(UAkSettings, HapticFeedbackStateOFF) == 0x0001B0, "Member 'UAkSettings::HapticFeedbackStateOFF' has a wrong offset!");
...
public:
	...
	class UAkVolumeSpeakerComponent*              VolumeSpeaker;                                     // 0x0278(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAkSpatialAudioVolume) == 0x000280, "Wrong size on AAkSpatialAudioVolume");
...
static_assert(offsetof(AAkSpatialAudioVolume, VolumeSpeaker) == 0x000278, "Member 'AAkSpatialAudioVolume::VolumeSpeaker' has a wrong offset!");
...
{
public:
	uint8                                         bEnableSurfaceReflectors : 1;                      // 0x01F8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1F9[0x7];                                      // 0x01F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FAkPoly>                        AcousticPolys;                                     // 0x0200(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         bEnableDiffraction : 1;                            // 0x0210(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableDiffractionOnBoundaryEdges : 1;             // 0x0210(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(UAkSurfaceReflectorSetComponent, AcousticPolys) == 0x000200, "Member 'UAkSurfaceReflectorSetComponent::AcousticPolys' has a wrong offset!");
static_assert(offsetof(UAkSurfaceReflectorSetComponent, AssociatedRoom) == 0x000218, "Member 'UAkSurfaceReflectorSetComponent::AssociatedRoom' has a wrong offset!");
...
static_assert(sizeof(UAkSwitchInitializationSettings) == 0x0000F8, "Wrong size on UAkSwitchInitializationSettings");
...
// Class AkAudio.AkSAVBox
// 0x0000 (0x0230 - 0x0230)
class AAkSAVBox final : public ATriggerBox
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AkSAVBox">();
	}
	static class AAkSAVBox* GetDefaultObj()
	{
		return GetDefaultObjImpl<AAkSAVBox>();
	}
};
static_assert(alignof(AAkSAVBox) == 0x000008, "Wrong alignment on AAkSAVBox");
static_assert(sizeof(AAkSAVBox) == 0x000230, "Wrong size on AAkSAVBox");

// Class AkAudio.AkPortalBox
// 0x0000 (0x0230 - 0x0230)
class AAkPortalBox final : public ATriggerBox
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AkPortalBox">();
	}
	static class AAkPortalBox* GetDefaultObj()
	{
		return GetDefaultObjImpl<AAkPortalBox>();
	}
};
static_assert(alignof(AAkPortalBox) == 0x000008, "Wrong alignment on AAkPortalBox");
static_assert(sizeof(AAkPortalBox) == 0x000230, "Wrong size on AAkPortalBox");

// Class AkAudio.AkBoxComponent
// 0x0000 (0x0480 - 0x0480)
class UAkBoxComponent : public UBoxComponent
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AkBoxComponent">();
	}
	static class UAkBoxComponent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAkBoxComponent>();
	}
};
static_assert(alignof(UAkBoxComponent) == 0x000010, "Wrong alignment on UAkBoxComponent");
static_assert(sizeof(UAkBoxComponent) == 0x000480, "Wrong size on UAkBoxComponent");

// Class AkAudio.AkSAVBoxComponent
// 0x0000 (0x0480 - 0x0480)
class UAkSAVBoxComponent final : public UAkBoxComponent
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AkSAVBoxComponent">();
	}
	static class UAkSAVBoxComponent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAkSAVBoxComponent>();
	}
};
static_assert(alignof(UAkSAVBoxComponent) == 0x000010, "Wrong alignment on UAkSAVBoxComponent");
static_assert(sizeof(UAkSAVBoxComponent) == 0x000480, "Wrong size on UAkSAVBoxComponent");

// Class AkAudio.AkPortalBoxComponent
// 0x0000 (0x0480 - 0x0480)
class UAkPortalBoxComponent final : public UAkBoxComponent
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AkPortalBoxComponent">();
	}
	static class UAkPortalBoxComponent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAkPortalBoxComponent>();
	}
};
static_assert(alignof(UAkPortalBoxComponent) == 0x000010, "Wrong alignment on UAkPortalBoxComponent");
static_assert(sizeof(UAkPortalBoxComponent) == 0x000480, "Wrong size on UAkPortalBoxComponent");
...
// Class AkAudio.AkVolumeSpeakerComponent
// 0x0090 (0x0290 - 0x0200)
class UAkVolumeSpeakerComponent final : public USceneComponent
{
public:
	uint8                                         bEnable : 1;                                       // 0x01F8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1F9[0x3];                                      // 0x01F9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         InsideTickInterval;                                // 0x01FC(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         OutsideTickInterval;                               // 0x0200(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_204[0x4];                                      // 0x0204(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UAkAudioEvent*>                  Events;                                            // 0x0208(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         AttenuationScalingFactor;                          // 0x0218(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         OcclusionRefreshInterval;                          // 0x021C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	EAkChangeRoomType                             ChangeRoomType;                                    // 0x0221(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_222[0x2];                                      // 0x0222(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         FadeOutMsWhenStopped;                              // 0x0224(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_228[0x50];                                     // 0x0228(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	class UAkComponent*                           Ak;                                                // 0x0278(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AkVolumeSpeakerComponent">();
	}
	static class UAkVolumeSpeakerComponent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAkVolumeSpeakerComponent>();
	}
};
static_assert(alignof(UAkVolumeSpeakerComponent) == 0x000010, "Wrong alignment on UAkVolumeSpeakerComponent");
static_assert(sizeof(UAkVolumeSpeakerComponent) == 0x000290, "Wrong size on UAkVolumeSpeakerComponent");
static_assert(offsetof(UAkVolumeSpeakerComponent, InsideTickInterval) == 0x0001FC, "Member 'UAkVolumeSpeakerComponent::InsideTickInterval' has a wrong offset!");
static_assert(offsetof(UAkVolumeSpeakerComponent, OutsideTickInterval) == 0x000200, "Member 'UAkVolumeSpeakerComponent::OutsideTickInterval' has a wrong offset!");
static_assert(offsetof(UAkVolumeSpeakerComponent, Events) == 0x000208, "Member 'UAkVolumeSpeakerComponent::Events' has a wrong offset!");
static_assert(offsetof(UAkVolumeSpeakerComponent, AttenuationScalingFactor) == 0x000218, "Member 'UAkVolumeSpeakerComponent::AttenuationScalingFactor' has a wrong offset!");
static_assert(offsetof(UAkVolumeSpeakerComponent, OcclusionRefreshInterval) == 0x00021C, "Member 'UAkVolumeSpeakerComponent::OcclusionRefreshInterval' has a wrong offset!");
static_assert(offsetof(UAkVolumeSpeakerComponent, OcclusionCollisionChannel) == 0x000220, "Member 'UAkVolumeSpeakerComponent::OcclusionCollisionChannel' has a wrong offset!");
static_assert(offsetof(UAkVolumeSpeakerComponent, ChangeRoomType) == 0x000221, "Member 'UAkVolumeSpeakerComponent::ChangeRoomType' has a wrong offset!");
static_assert(offsetof(UAkVolumeSpeakerComponent, FadeOutMsWhenStopped) == 0x000224, "Member 'UAkVolumeSpeakerComponent::FadeOutMsWhenStopped' has a wrong offset!");
static_assert(offsetof(UAkVolumeSpeakerComponent, Ak) == 0x000278, "Member 'UAkVolumeSpeakerComponent::Ak' has a wrong offset!");

// Class AkAudio.AkVolumeSpeaker
// 0x0008 (0x0268 - 0x0260)
class AAkVolumeSpeaker final : public AVolume
{
public:
	class UAkVolumeSpeakerComponent*              AkVolumeSpeakerComponent;                          // 0x0260(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AkVolumeSpeaker">();
	}
	static class AAkVolumeSpeaker* GetDefaultObj()
	{
		return GetDefaultObjImpl<AAkVolumeSpeaker>();
	}
};
static_assert(alignof(AAkVolumeSpeaker) == 0x000008, "Wrong alignment on AAkVolumeSpeaker");
static_assert(sizeof(AAkVolumeSpeaker) == 0x000268, "Wrong size on AAkVolumeSpeaker");
static_assert(offsetof(AAkVolumeSpeaker, AkVolumeSpeakerComponent) == 0x000260, "Member 'AAkVolumeSpeaker::AkVolumeSpeakerComponent' has a wrong offset!");
...
static_assert(sizeof(UAkXboxOneInitializationSettings) == 0x000100, "Wrong size on UAkXboxOneInitializationSettings");
...
// Class AkAudio.AnimNotify_PlaySound_TngAkEvent
// 0x0020 (0x0058 - 0x0038)
class UAnimNotify_PlaySound_TngAkEvent final : public UAnimNotify
{
public:
	class UAkAudioEvent*                          Event;                                             // 0x0038(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFollow;                                           // 0x0040(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoDestroy;                                      // 0x0041(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bIgnorePostEventWhenCalledFromADistance;           // 0x004C(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4D[0xB];                                       // 0x004D(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AnimNotify_PlaySound_TngAkEvent">();
	}
	static class UAnimNotify_PlaySound_TngAkEvent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAnimNotify_PlaySound_TngAkEvent>();
	}
};
static_assert(alignof(UAnimNotify_PlaySound_TngAkEvent) == 0x000008, "Wrong alignment on UAnimNotify_PlaySound_TngAkEvent");
static_assert(sizeof(UAnimNotify_PlaySound_TngAkEvent) == 0x000058, "Wrong size on UAnimNotify_PlaySound_TngAkEvent");
static_assert(offsetof(UAnimNotify_PlaySound_TngAkEvent, Event) == 0x000038, "Member 'UAnimNotify_PlaySound_TngAkEvent::Event' has a wrong offset!");
static_assert(offsetof(UAnimNotify_PlaySound_TngAkEvent, bFollow) == 0x000040, "Member 'UAnimNotify_PlaySound_TngAkEvent::bFollow' has a wrong offset!");
static_assert(offsetof(UAnimNotify_PlaySound_TngAkEvent, bAutoDestroy) == 0x000041, "Member 'UAnimNotify_PlaySound_TngAkEvent::bAutoDestroy' has a wrong offset!");
static_assert(offsetof(UAnimNotify_PlaySound_TngAkEvent, AttachName) == 0x000044, "Member 'UAnimNotify_PlaySound_TngAkEvent::AttachName' has a wrong offset!");
static_assert(offsetof(UAnimNotify_PlaySound_TngAkEvent, bIgnorePostEventWhenCalledFromADistance) == 0x00004C, "Member 'UAnimNotify_PlaySound_TngAkEvent::bIgnorePostEventWhenCalledFromADistance' has a wrong offset!");
