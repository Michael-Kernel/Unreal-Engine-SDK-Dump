...
static_assert(sizeof(FAnimNode_SkeletalControlBase) == 0x0000F0, "Wrong size on FAnimNode_SkeletalControlBase");
...
static_assert(offsetof(FAnimNode_SkeletalControlBase, LODThreshold) == 0x000040, "Member 'FAnimNode_SkeletalControlBase::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, ActualAlpha) == 0x000044, "Member 'FAnimNode_SkeletalControlBase::ActualAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, AlphaInputType) == 0x000048, "Member 'FAnimNode_SkeletalControlBase::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, bAlphaBoolEnabled) == 0x000049, "Member 'FAnimNode_SkeletalControlBase::bAlphaBoolEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, Alpha) == 0x00004C, "Member 'FAnimNode_SkeletalControlBase::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, AlphaScaleBias) == 0x000050, "Member 'FAnimNode_SkeletalControlBase::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, AlphaBoolBlend) == 0x000058, "Member 'FAnimNode_SkeletalControlBase::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, AlphaCurveName) == 0x0000A8, "Member 'FAnimNode_SkeletalControlBase::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, AlphaScaleBiasClamp) == 0x0000B0, "Member 'FAnimNode_SkeletalControlBase::AlphaScaleBiasClamp' has a wrong offset!");
...
public:
	...
	int32                                         NumSolverIterationsPreUpdate;                      // 0x01C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumSolverIterationsPostUpdate;                     // 0x01C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_AnimDynamics) == 0x0003A0, "Wrong size on FAnimNode_AnimDynamics");
static_assert(offsetof(FAnimNode_AnimDynamics, SimulationSpace) == 0x0000F0, "Member 'FAnimNode_AnimDynamics::SimulationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, RelativeSpaceBone) == 0x0000F8, "Member 'FAnimNode_AnimDynamics::RelativeSpaceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bChain) == 0x000110, "Member 'FAnimNode_AnimDynamics::bChain' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, BoundBone) == 0x000118, "Member 'FAnimNode_AnimDynamics::BoundBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ChainEnd) == 0x000130, "Member 'FAnimNode_AnimDynamics::ChainEnd' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, BoxExtents) == 0x000148, "Member 'FAnimNode_AnimDynamics::BoxExtents' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, LocalJointOffset) == 0x000154, "Member 'FAnimNode_AnimDynamics::LocalJointOffset' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, GravityScale) == 0x000160, "Member 'FAnimNode_AnimDynamics::GravityScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, GravityOverride) == 0x000164, "Member 'FAnimNode_AnimDynamics::GravityOverride' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bUseGravityOverride) == 0x000170, "Member 'FAnimNode_AnimDynamics::bUseGravityOverride' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bLinearSpring) == 0x000171, "Member 'FAnimNode_AnimDynamics::bLinearSpring' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bAngularSpring) == 0x000172, "Member 'FAnimNode_AnimDynamics::bAngularSpring' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, LinearSpringConstant) == 0x000174, "Member 'FAnimNode_AnimDynamics::LinearSpringConstant' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, AngularSpringConstant) == 0x000178, "Member 'FAnimNode_AnimDynamics::AngularSpringConstant' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bEnableWind) == 0x00017C, "Member 'FAnimNode_AnimDynamics::bEnableWind' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bWindWasEnabled) == 0x00017D, "Member 'FAnimNode_AnimDynamics::bWindWasEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, WindScale) == 0x000180, "Member 'FAnimNode_AnimDynamics::WindScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ComponentLinearAccScale) == 0x000184, "Member 'FAnimNode_AnimDynamics::ComponentLinearAccScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ComponentLinearVelScale) == 0x000190, "Member 'FAnimNode_AnimDynamics::ComponentLinearVelScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ComponentAppliedLinearAccClamp) == 0x00019C, "Member 'FAnimNode_AnimDynamics::ComponentAppliedLinearAccClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bOverrideLinearDamping) == 0x0001A8, "Member 'FAnimNode_AnimDynamics::bOverrideLinearDamping' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, LinearDampingOverride) == 0x0001AC, "Member 'FAnimNode_AnimDynamics::LinearDampingOverride' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bOverrideAngularDamping) == 0x0001B0, "Member 'FAnimNode_AnimDynamics::bOverrideAngularDamping' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, AngularDampingOverride) == 0x0001B4, "Member 'FAnimNode_AnimDynamics::AngularDampingOverride' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bOverrideAngularBias) == 0x0001B8, "Member 'FAnimNode_AnimDynamics::bOverrideAngularBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, AngularBiasOverride) == 0x0001BC, "Member 'FAnimNode_AnimDynamics::AngularBiasOverride' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bDoUpdate) == 0x0001C0, "Member 'FAnimNode_AnimDynamics::bDoUpdate' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bDoEval) == 0x0001C1, "Member 'FAnimNode_AnimDynamics::bDoEval' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, NumSolverIterationsPreUpdate) == 0x0001C4, "Member 'FAnimNode_AnimDynamics::NumSolverIterationsPreUpdate' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, NumSolverIterationsPostUpdate) == 0x0001C8, "Member 'FAnimNode_AnimDynamics::NumSolverIterationsPostUpdate' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ConstraintSetup) == 0x0001CC, "Member 'FAnimNode_AnimDynamics::ConstraintSetup' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bUsePlanarLimit) == 0x000228, "Member 'FAnimNode_AnimDynamics::bUsePlanarLimit' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_AnimDynamics, bUseSphericalLimits) == 0x000240, "Member 'FAnimNode_AnimDynamics::bUseSphericalLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, SphericalLimits) == 0x000248, "Member 'FAnimNode_AnimDynamics::SphericalLimits' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_AnimDynamics, SphereCollisionRadius) == 0x00025C, "Member 'FAnimNode_AnimDynamics::SphereCollisionRadius' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ExternalForce) == 0x000260, "Member 'FAnimNode_AnimDynamics::ExternalForce' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_LookAt) == 0x000220, "Wrong size on FAnimNode_LookAt");
static_assert(offsetof(FAnimNode_LookAt, BoneToModify) == 0x0000F0, "Member 'FAnimNode_LookAt::BoneToModify' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAtBone) == 0x000108, "Member 'FAnimNode_LookAt::LookAtBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAtSocket) == 0x000120, "Member 'FAnimNode_LookAt::LookAtSocket' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAtTarget) == 0x000130, "Member 'FAnimNode_LookAt::LookAtTarget' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAtLocation) == 0x000190, "Member 'FAnimNode_LookAt::LookAtLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAtAxis) == 0x00019C, "Member 'FAnimNode_LookAt::LookAtAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, CustomLookAtAxis) == 0x0001A0, "Member 'FAnimNode_LookAt::CustomLookAtAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAt_Axis) == 0x0001AC, "Member 'FAnimNode_LookAt::LookAt_Axis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, bUseLookUpAxis) == 0x0001BC, "Member 'FAnimNode_LookAt::bUseLookUpAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookUpAxis) == 0x0001BD, "Member 'FAnimNode_LookAt::LookUpAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, CustomLookUpAxis) == 0x0001C0, "Member 'FAnimNode_LookAt::CustomLookUpAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookUp_Axis) == 0x0001CC, "Member 'FAnimNode_LookAt::LookUp_Axis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAtClamp) == 0x0001DC, "Member 'FAnimNode_LookAt::LookAtClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, InterpolationType) == 0x0001E0, "Member 'FAnimNode_LookAt::InterpolationType' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, InterpolationTime) == 0x0001E4, "Member 'FAnimNode_LookAt::InterpolationTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, InterpolationTriggerThreashold) == 0x0001E8, "Member 'FAnimNode_LookAt::InterpolationTriggerThreashold' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_BlendBoneByChannel) == 0x000090, "Wrong size on FAnimNode_BlendBoneByChannel");
static_assert(offsetof(FAnimNode_BlendBoneByChannel, A) == 0x000030, "Member 'FAnimNode_BlendBoneByChannel::A' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendBoneByChannel, B) == 0x000040, "Member 'FAnimNode_BlendBoneByChannel::B' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_BlendBoneByChannel, AlphaScaleBias) == 0x000054, "Member 'FAnimNode_BlendBoneByChannel::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendBoneByChannel, BoneDefinitions) == 0x000060, "Member 'FAnimNode_BlendBoneByChannel::BoneDefinitions' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendBoneByChannel, TransformsSpace) == 0x000070, "Member 'FAnimNode_BlendBoneByChannel::TransformsSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendBoneByChannel, InternalBlendAlpha) == 0x000074, "Member 'FAnimNode_BlendBoneByChannel::InternalBlendAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendBoneByChannel, bBIsRelevant) == 0x000078, "Member 'FAnimNode_BlendBoneByChannel::bBIsRelevant' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendBoneByChannel, ValidBoneEntries) == 0x000080, "Member 'FAnimNode_BlendBoneByChannel::ValidBoneEntries' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_BlendSpacePlayer, bResetPlayTimeWhenBlendSpaceChanges) == 0x000078, "Member 'FAnimNode_BlendSpacePlayer::bResetPlayTimeWhenBlendSpaceChanges' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, BlendFilter) == 0x000080, "Member 'FAnimNode_BlendSpacePlayer::BlendFilter' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, BlendSampleDataCache) == 0x000110, "Member 'FAnimNode_BlendSpacePlayer::BlendSampleDataCache' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_BoneDrivenController) == 0x000168, "Wrong size on FAnimNode_BoneDrivenController");
static_assert(offsetof(FAnimNode_BoneDrivenController, SourceBone) == 0x0000F0, "Member 'FAnimNode_BoneDrivenController::SourceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, SourceComponent) == 0x000108, "Member 'FAnimNode_BoneDrivenController::SourceComponent' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, DrivingCurve) == 0x000110, "Member 'FAnimNode_BoneDrivenController::DrivingCurve' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, Multiplier) == 0x000118, "Member 'FAnimNode_BoneDrivenController::Multiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, bUseRange) == 0x00011C, "Member 'FAnimNode_BoneDrivenController::bUseRange' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, RangeMin) == 0x000120, "Member 'FAnimNode_BoneDrivenController::RangeMin' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, RangeMax) == 0x000124, "Member 'FAnimNode_BoneDrivenController::RangeMax' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, RemappedMin) == 0x000128, "Member 'FAnimNode_BoneDrivenController::RemappedMin' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, RemappedMax) == 0x00012C, "Member 'FAnimNode_BoneDrivenController::RemappedMax' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, DestinationMode) == 0x000130, "Member 'FAnimNode_BoneDrivenController::DestinationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, ParameterName) == 0x000138, "Member 'FAnimNode_BoneDrivenController::ParameterName' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, TargetBone) == 0x000140, "Member 'FAnimNode_BoneDrivenController::TargetBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, TargetComponent) == 0x000158, "Member 'FAnimNode_BoneDrivenController::TargetComponent' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, ModificationMode) == 0x000160, "Member 'FAnimNode_BoneDrivenController::ModificationMode' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_BlendListBase) == 0x0000D8, "Wrong size on FAnimNode_BlendListBase");
...
{
public:
	bool                                          bActiveValue;                                      // 0x00D8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D9[0x7];                                       // 0x00D9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_BlendListByBool) == 0x000008, "Wrong alignment on FAnimNode_BlendListByBool");
static_assert(sizeof(FAnimNode_BlendListByBool) == 0x0000E0, "Wrong size on FAnimNode_BlendListByBool");
static_assert(offsetof(FAnimNode_BlendListByBool, bActiveValue) == 0x0000D8, "Member 'FAnimNode_BlendListByBool::bActiveValue' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_SplineIK) == 0x000290, "Wrong size on FAnimNode_SplineIK");
static_assert(offsetof(FAnimNode_SplineIK, StartBone) == 0x0000F0, "Member 'FAnimNode_SplineIK::StartBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, EndBone) == 0x000108, "Member 'FAnimNode_SplineIK::EndBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, BoneAxis) == 0x000120, "Member 'FAnimNode_SplineIK::BoneAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, bAutoCalculateSpline) == 0x000121, "Member 'FAnimNode_SplineIK::bAutoCalculateSpline' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, PointCount) == 0x000124, "Member 'FAnimNode_SplineIK::PointCount' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, ControlPoints) == 0x000128, "Member 'FAnimNode_SplineIK::ControlPoints' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, Roll) == 0x000138, "Member 'FAnimNode_SplineIK::Roll' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, TwistStart) == 0x00013C, "Member 'FAnimNode_SplineIK::TwistStart' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, TwistEnd) == 0x000140, "Member 'FAnimNode_SplineIK::TwistEnd' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, TwistBlend) == 0x000148, "Member 'FAnimNode_SplineIK::TwistBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, Stretch) == 0x000180, "Member 'FAnimNode_SplineIK::Stretch' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, Offset) == 0x000184, "Member 'FAnimNode_SplineIK::Offset' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, BoneSpline) == 0x0001F8, "Member 'FAnimNode_SplineIK::BoneSpline' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, OriginalSplineLength) == 0x000258, "Member 'FAnimNode_SplineIK::OriginalSplineLength' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, CachedBoneReferences) == 0x000260, "Member 'FAnimNode_SplineIK::CachedBoneReferences' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, CachedBoneLengths) == 0x000270, "Member 'FAnimNode_SplineIK::CachedBoneLengths' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, CachedOffsetRotations) == 0x000280, "Member 'FAnimNode_SplineIK::CachedOffsetRotations' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_AimOffsetLookAt) == 0x000210, "Wrong size on FAnimNode_AimOffsetLookAt");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, BasePose) == 0x000128, "Member 'FAnimNode_AimOffsetLookAt::BasePose' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_AimOffsetLookAt, PivotSocketName) == 0x000158, "Member 'FAnimNode_AimOffsetLookAt::PivotSocketName' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SocketAxis) == 0x000160, "Member 'FAnimNode_AimOffsetLookAt::SocketAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, Alpha) == 0x00016C, "Member 'FAnimNode_AimOffsetLookAt::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SocketBoneReference) == 0x000170, "Member 'FAnimNode_AimOffsetLookAt::SocketBoneReference' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SocketLocalTransform) == 0x000190, "Member 'FAnimNode_AimOffsetLookAt::SocketLocalTransform' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, PivotSocketBoneReference) == 0x0001C0, "Member 'FAnimNode_AimOffsetLookAt::PivotSocketBoneReference' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, PivotSocketLocalTransform) == 0x0001E0, "Member 'FAnimNode_AimOffsetLookAt::PivotSocketLocalTransform' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ObserveBone) == 0x000130, "Wrong size on FAnimNode_ObserveBone");
static_assert(offsetof(FAnimNode_ObserveBone, BoneToObserve) == 0x0000F0, "Member 'FAnimNode_ObserveBone::BoneToObserve' has a wrong offset!");
static_assert(offsetof(FAnimNode_ObserveBone, DisplaySpace) == 0x000108, "Member 'FAnimNode_ObserveBone::DisplaySpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_ObserveBone, bRelativeToRefPose) == 0x000109, "Member 'FAnimNode_ObserveBone::bRelativeToRefPose' has a wrong offset!");
static_assert(offsetof(FAnimNode_ObserveBone, Translation) == 0x00010C, "Member 'FAnimNode_ObserveBone::Translation' has a wrong offset!");
static_assert(offsetof(FAnimNode_ObserveBone, Rotation) == 0x000118, "Member 'FAnimNode_ObserveBone::Rotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_ObserveBone, Scale) == 0x000124, "Member 'FAnimNode_ObserveBone::Scale' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_PoseDriver, bOnlyDriveSelectedBones) == 0x0000B0, "Member 'FAnimNode_PoseDriver::bOnlyDriveSelectedBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, OnlyDriveBones) == 0x0000B8, "Member 'FAnimNode_PoseDriver::OnlyDriveBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, EvalSpaceBone) == 0x0000C8, "Member 'FAnimNode_PoseDriver::EvalSpaceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, RBFParams) == 0x0000E0, "Member 'FAnimNode_PoseDriver::RBFParams' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, DriveSource) == 0x0000F0, "Member 'FAnimNode_PoseDriver::DriveSource' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, DriveOutput) == 0x0000F1, "Member 'FAnimNode_PoseDriver::DriveOutput' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, PoseTargets) == 0x0000F8, "Member 'FAnimNode_PoseDriver::PoseTargets' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, SourceBone) == 0x000108, "Member 'FAnimNode_PoseDriver::SourceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, TwistAxis) == 0x000120, "Member 'FAnimNode_PoseDriver::TwistAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, Type) == 0x000121, "Member 'FAnimNode_PoseDriver::Type' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, RadialScaling) == 0x000124, "Member 'FAnimNode_PoseDriver::RadialScaling' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_CopyBoneDelta) == 0x000130, "Wrong size on FAnimNode_CopyBoneDelta");
static_assert(offsetof(FAnimNode_CopyBoneDelta, SourceBone) == 0x0000F0, "Member 'FAnimNode_CopyBoneDelta::SourceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, TargetBone) == 0x000108, "Member 'FAnimNode_CopyBoneDelta::TargetBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, bCopyTranslation) == 0x000120, "Member 'FAnimNode_CopyBoneDelta::bCopyTranslation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, bCopyRotation) == 0x000121, "Member 'FAnimNode_CopyBoneDelta::bCopyRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, bCopyScale) == 0x000122, "Member 'FAnimNode_CopyBoneDelta::bCopyScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, CopyMode) == 0x000123, "Member 'FAnimNode_CopyBoneDelta::CopyMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, TranslationMultiplier) == 0x000124, "Member 'FAnimNode_CopyBoneDelta::TranslationMultiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, RotationMultiplier) == 0x000128, "Member 'FAnimNode_CopyBoneDelta::RotationMultiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, ScaleMultiplier) == 0x00012C, "Member 'FAnimNode_CopyBoneDelta::ScaleMultiplier' has a wrong offset!");
...
public:
	...
	bool                                          bIgnoreAdditiveCurve;                              // 0x0064(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAnimAlphaInputType                           AlphaInputType;                                    // 0x0065(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAlphaBoolEnabled;                                 // 0x0066(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_ApplyAdditive) == 0x0000F0, "Wrong size on FAnimNode_ApplyAdditive");
static_assert(offsetof(FAnimNode_ApplyAdditive, Base) == 0x000030, "Member 'FAnimNode_ApplyAdditive::Base' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, Additive) == 0x000040, "Member 'FAnimNode_ApplyAdditive::Additive' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, Alpha) == 0x000050, "Member 'FAnimNode_ApplyAdditive::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, AlphaScaleBias) == 0x000054, "Member 'FAnimNode_ApplyAdditive::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, LODThreshold) == 0x00005C, "Member 'FAnimNode_ApplyAdditive::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, ActualAlpha) == 0x000060, "Member 'FAnimNode_ApplyAdditive::ActualAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, bIgnoreAdditiveCurve) == 0x000064, "Member 'FAnimNode_ApplyAdditive::bIgnoreAdditiveCurve' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, AlphaInputType) == 0x000065, "Member 'FAnimNode_ApplyAdditive::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, bAlphaBoolEnabled) == 0x000066, "Member 'FAnimNode_ApplyAdditive::bAlphaBoolEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, AlphaBoolBlend) == 0x000068, "Member 'FAnimNode_ApplyAdditive::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, AlphaCurveName) == 0x0000B8, "Member 'FAnimNode_ApplyAdditive::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, AlphaScaleBiasClamp) == 0x0000C0, "Member 'FAnimNode_ApplyAdditive::AlphaScaleBiasClamp' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_Root) == 0x000040, "Wrong size on FAnimNode_Root");
...
static_assert(sizeof(FAnimNode_ApplyLimits) == 0x000110, "Wrong size on FAnimNode_ApplyLimits");
static_assert(offsetof(FAnimNode_ApplyLimits, AngularRangeLimits) == 0x0000F0, "Member 'FAnimNode_ApplyLimits::AngularRangeLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyLimits, AngularOffsets) == 0x000100, "Member 'FAnimNode_ApplyLimits::AngularOffsets' has a wrong offset!");
...
{
public:
	TArray<int32>                                 EnumToPoseIndex;                                   // 0x00D8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         ActiveEnumValue;                                   // 0x00E8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E9[0x7];                                       // 0x00E9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_BlendListByEnum) == 0x000008, "Wrong alignment on FAnimNode_BlendListByEnum");
static_assert(sizeof(FAnimNode_BlendListByEnum) == 0x0000F0, "Wrong size on FAnimNode_BlendListByEnum");
static_assert(offsetof(FAnimNode_BlendListByEnum, EnumToPoseIndex) == 0x0000D8, "Member 'FAnimNode_BlendListByEnum::EnumToPoseIndex' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendListByEnum, ActiveEnumValue) == 0x0000E8, "Member 'FAnimNode_BlendListByEnum::ActiveEnumValue' has a wrong offset!");
...
static_assert(sizeof(FAnimLegIKData) == 0x0000B0, "Wrong size on FAnimLegIKData");
...
static_assert(sizeof(FAnimNode_LegIK) == 0x000120, "Wrong size on FAnimNode_LegIK");
static_assert(offsetof(FAnimNode_LegIK, ReachPrecision) == 0x0000F0, "Member 'FAnimNode_LegIK::ReachPrecision' has a wrong offset!");
static_assert(offsetof(FAnimNode_LegIK, MaxIterations) == 0x0000F4, "Member 'FAnimNode_LegIK::MaxIterations' has a wrong offset!");
static_assert(offsetof(FAnimNode_LegIK, LegsDefinition) == 0x0000F8, "Member 'FAnimNode_LegIK::LegsDefinition' has a wrong offset!");
static_assert(offsetof(FAnimNode_LegIK, LegsData) == 0x000108, "Member 'FAnimNode_LegIK::LegsData' has a wrong offset!");
...
{
public:
	int32                                         ActiveChildIndex;                                  // 0x00D8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_DC[0x4];                                       // 0x00DC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_BlendListByInt) == 0x000008, "Wrong alignment on FAnimNode_BlendListByInt");
static_assert(sizeof(FAnimNode_BlendListByInt) == 0x0000E0, "Wrong size on FAnimNode_BlendListByInt");
static_assert(offsetof(FAnimNode_BlendListByInt, ActiveChildIndex) == 0x0000D8, "Member 'FAnimNode_BlendListByInt::ActiveChildIndex' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ResetRoot) == 0x000100, "Wrong size on FAnimNode_ResetRoot");
...
static_assert(sizeof(FAnimNode_LayeredBoneBlend) == 0x0000D8, "Wrong size on FAnimNode_LayeredBoneBlend");
...
static_assert(offsetof(FAnimNode_LayeredBoneBlend, BlendPoses) == 0x000040, "Member 'FAnimNode_LayeredBoneBlend::BlendPoses' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, LayerSetup) == 0x000050, "Member 'FAnimNode_LayeredBoneBlend::LayerSetup' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, BlendWeights) == 0x000060, "Member 'FAnimNode_LayeredBoneBlend::BlendWeights' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, bMeshSpaceRotationBlend) == 0x000070, "Member 'FAnimNode_LayeredBoneBlend::bMeshSpaceRotationBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, CurveBlendOption) == 0x000071, "Member 'FAnimNode_LayeredBoneBlend::CurveBlendOption' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, bBlendRootMotionBasedOnRootBone) == 0x000072, "Member 'FAnimNode_LayeredBoneBlend::bBlendRootMotionBasedOnRootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, bHasRelevantPoses) == 0x000073, "Member 'FAnimNode_LayeredBoneBlend::bHasRelevantPoses' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, LODThreshold) == 0x000074, "Member 'FAnimNode_LayeredBoneBlend::LODThreshold' has a wrong offset!");
...
public:
	...
	int32                                         MaxIterations;                                     // 0x0194(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_CCDIK) == 0x0001B0, "Wrong size on FAnimNode_CCDIK");
static_assert(offsetof(FAnimNode_CCDIK, EffectorLocation) == 0x0000F0, "Member 'FAnimNode_CCDIK::EffectorLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, EffectorLocationSpace) == 0x0000FC, "Member 'FAnimNode_CCDIK::EffectorLocationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, EffectorTarget) == 0x000100, "Member 'FAnimNode_CCDIK::EffectorTarget' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, TipBone) == 0x000160, "Member 'FAnimNode_CCDIK::TipBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, RootBone) == 0x000178, "Member 'FAnimNode_CCDIK::RootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, Precision) == 0x000190, "Member 'FAnimNode_CCDIK::Precision' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, MaxIterations) == 0x000194, "Member 'FAnimNode_CCDIK::MaxIterations' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, bStartFromTail) == 0x000198, "Member 'FAnimNode_CCDIK::bStartFromTail' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, bEnableRotationLimit) == 0x000199, "Member 'FAnimNode_CCDIK::bEnableRotationLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, RotationLimitPerJoints) == 0x0001A0, "Member 'FAnimNode_CCDIK::RotationLimitPerJoints' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_Constraint) == 0x000138, "Wrong size on FAnimNode_Constraint");
static_assert(offsetof(FAnimNode_Constraint, BoneToModify) == 0x0000F0, "Member 'FAnimNode_Constraint::BoneToModify' has a wrong offset!");
static_assert(offsetof(FAnimNode_Constraint, ConstraintSetup) == 0x000108, "Member 'FAnimNode_Constraint::ConstraintSetup' has a wrong offset!");
static_assert(offsetof(FAnimNode_Constraint, ConstraintWeights) == 0x000118, "Member 'FAnimNode_Constraint::ConstraintWeights' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_CopyBone) == 0x000128, "Wrong size on FAnimNode_CopyBone");
static_assert(offsetof(FAnimNode_CopyBone, SourceBone) == 0x0000F0, "Member 'FAnimNode_CopyBone::SourceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBone, TargetBone) == 0x000108, "Member 'FAnimNode_CopyBone::TargetBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBone, bCopyTranslation) == 0x000120, "Member 'FAnimNode_CopyBone::bCopyTranslation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBone, bCopyRotation) == 0x000121, "Member 'FAnimNode_CopyBone::bCopyRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBone, bCopyScale) == 0x000122, "Member 'FAnimNode_CopyBone::bCopyScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBone, ControlSpace) == 0x000123, "Member 'FAnimNode_CopyBone::ControlSpace' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_PoseByName) == 0x0000A0, "Wrong size on FAnimNode_PoseByName");
...
static_assert(sizeof(FAnimNode_CurveSource) == 0x000060, "Wrong size on FAnimNode_CurveSource");
...
static_assert(offsetof(FAnimNode_CurveSource, SourceBinding) == 0x000040, "Member 'FAnimNode_CurveSource::SourceBinding' has a wrong offset!");
static_assert(offsetof(FAnimNode_CurveSource, Alpha) == 0x000048, "Member 'FAnimNode_CurveSource::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_CurveSource, CurveSource) == 0x000050, "Member 'FAnimNode_CurveSource::CurveSource' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_Fabrik, EffectorTransformSpace) == 0x000120, "Member 'FAnimNode_Fabrik::EffectorTransformSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, EffectorTransformBone) == 0x000128, "Member 'FAnimNode_Fabrik::EffectorTransformBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, EffectorTarget) == 0x000140, "Member 'FAnimNode_Fabrik::EffectorTarget' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, EffectorRotationSource) == 0x0001A0, "Member 'FAnimNode_Fabrik::EffectorRotationSource' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, TipBone) == 0x0001A8, "Member 'FAnimNode_Fabrik::TipBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, RootBone) == 0x0001C0, "Member 'FAnimNode_Fabrik::RootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, Precision) == 0x0001D8, "Member 'FAnimNode_Fabrik::Precision' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, MaxIterations) == 0x0001DC, "Member 'FAnimNode_Fabrik::MaxIterations' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, bEnableDebugDraw) == 0x0001E0, "Member 'FAnimNode_Fabrik::bEnableDebugDraw' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ModifyBone) == 0x000138, "Wrong size on FAnimNode_ModifyBone");
static_assert(offsetof(FAnimNode_ModifyBone, BoneToModify) == 0x0000F0, "Member 'FAnimNode_ModifyBone::BoneToModify' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, Translation) == 0x000108, "Member 'FAnimNode_ModifyBone::Translation' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, Rotation) == 0x000114, "Member 'FAnimNode_ModifyBone::Rotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, Scale) == 0x000120, "Member 'FAnimNode_ModifyBone::Scale' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, TranslationMode) == 0x00012C, "Member 'FAnimNode_ModifyBone::TranslationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, RotationMode) == 0x00012D, "Member 'FAnimNode_ModifyBone::RotationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, ScaleMode) == 0x00012E, "Member 'FAnimNode_ModifyBone::ScaleMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, TranslationSpace) == 0x00012F, "Member 'FAnimNode_ModifyBone::TranslationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, RotationSpace) == 0x000130, "Member 'FAnimNode_ModifyBone::RotationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, ScaleSpace) == 0x000131, "Member 'FAnimNode_ModifyBone::ScaleSpace' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_HandIKRetargeting) == 0x000168, "Wrong size on FAnimNode_HandIKRetargeting");
static_assert(offsetof(FAnimNode_HandIKRetargeting, RightHandFK) == 0x0000F0, "Member 'FAnimNode_HandIKRetargeting::RightHandFK' has a wrong offset!");
static_assert(offsetof(FAnimNode_HandIKRetargeting, LeftHandFK) == 0x000108, "Member 'FAnimNode_HandIKRetargeting::LeftHandFK' has a wrong offset!");
static_assert(offsetof(FAnimNode_HandIKRetargeting, RightHandIK) == 0x000120, "Member 'FAnimNode_HandIKRetargeting::RightHandIK' has a wrong offset!");
static_assert(offsetof(FAnimNode_HandIKRetargeting, LeftHandIK) == 0x000138, "Member 'FAnimNode_HandIKRetargeting::LeftHandIK' has a wrong offset!");
static_assert(offsetof(FAnimNode_HandIKRetargeting, IKBonesToMove) == 0x000150, "Member 'FAnimNode_HandIKRetargeting::IKBonesToMove' has a wrong offset!");
static_assert(offsetof(FAnimNode_HandIKRetargeting, HandFKWeight) == 0x000160, "Member 'FAnimNode_HandIKRetargeting::HandFKWeight' has a wrong offset!");
...
static_assert(sizeof(FIKChain) == 0x000040, "Wrong size on FIKChain");
...
static_assert(sizeof(FAnimNode_MakeDynamicAdditive) == 0x000058, "Wrong size on FAnimNode_MakeDynamicAdditive");
...
static_assert(offsetof(FAnimNode_MakeDynamicAdditive, Additive) == 0x000040, "Member 'FAnimNode_MakeDynamicAdditive::Additive' has a wrong offset!");
static_assert(offsetof(FAnimNode_MakeDynamicAdditive, bMeshSpaceAdditive) == 0x000050, "Member 'FAnimNode_MakeDynamicAdditive::bMeshSpaceAdditive' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ModifyCurve) == 0x000080, "Wrong size on FAnimNode_ModifyCurve");
...
static_assert(offsetof(FAnimNode_ModifyCurve, ApplyMode) == 0x000040, "Member 'FAnimNode_ModifyCurve::ApplyMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyCurve, CurveValues) == 0x000048, "Member 'FAnimNode_ModifyCurve::CurveValues' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyCurve, LastCurveValues) == 0x000058, "Member 'FAnimNode_ModifyCurve::LastCurveValues' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyCurve, CurveNames) == 0x000068, "Member 'FAnimNode_ModifyCurve::CurveNames' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyCurve, Alpha) == 0x000078, "Member 'FAnimNode_ModifyCurve::Alpha' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_RotationOffsetBlendSpace) == 0x0001E0, "Wrong size on FAnimNode_RotationOffsetBlendSpace");
...
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaInputType) == 0x00013D, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaInputType' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, bAlphaBoolEnabled) == 0x000150, "Member 'FAnimNode_RotationOffsetBlendSpace::bAlphaBoolEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaBoolBlend) == 0x000158, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaCurveName) == 0x0001A8, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBiasClamp) == 0x0001B0, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBiasClamp' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_Slot, SlotName) == 0x000040, "Member 'FAnimNode_Slot::SlotName' has a wrong offset!");
static_assert(offsetof(FAnimNode_Slot, bAlwaysUpdateSourcePose) == 0x000048, "Member 'FAnimNode_Slot::bAlwaysUpdateSourcePose' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_RotateRootBone) == 0x0000C0, "Wrong size on FAnimNode_RotateRootBone");
...
static_assert(offsetof(FAnimNode_RotateRootBone, Pitch) == 0x000040, "Member 'FAnimNode_RotateRootBone::Pitch' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotateRootBone, Yaw) == 0x000044, "Member 'FAnimNode_RotateRootBone::Yaw' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotateRootBone, PitchScaleBiasClamp) == 0x000048, "Member 'FAnimNode_RotateRootBone::PitchScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotateRootBone, YawScaleBiasClamp) == 0x000078, "Member 'FAnimNode_RotateRootBone::YawScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotateRootBone, MeshToComponent) == 0x0000A8, "Member 'FAnimNode_RotateRootBone::MeshToComponent' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotateRootBone, ActualPitch) == 0x0000B4, "Member 'FAnimNode_RotateRootBone::ActualPitch' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotateRootBone, ActualYaw) == 0x0000B8, "Member 'FAnimNode_RotateRootBone::ActualYaw' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_RotationMultiplier) == 0x000128, "Wrong size on FAnimNode_RotationMultiplier");
static_assert(offsetof(FAnimNode_RotationMultiplier, TargetBone) == 0x0000F0, "Member 'FAnimNode_RotationMultiplier::TargetBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationMultiplier, SourceBone) == 0x000108, "Member 'FAnimNode_RotationMultiplier::SourceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationMultiplier, Multiplier) == 0x000120, "Member 'FAnimNode_RotationMultiplier::Multiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationMultiplier, RotationAxisToRefer) == 0x000124, "Member 'FAnimNode_RotationMultiplier::RotationAxisToRefer' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationMultiplier, bIsAdditive) == 0x000125, "Member 'FAnimNode_RotationMultiplier::bIsAdditive' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ScaleChainLength) == 0x0000B0, "Wrong size on FAnimNode_ScaleChainLength");
...
static_assert(offsetof(FAnimNode_ScaleChainLength, DefaultChainLength) == 0x000040, "Member 'FAnimNode_ScaleChainLength::DefaultChainLength' has a wrong offset!");
static_assert(offsetof(FAnimNode_ScaleChainLength, ChainStartBone) == 0x000048, "Member 'FAnimNode_ScaleChainLength::ChainStartBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_ScaleChainLength, ChainEndBone) == 0x000060, "Member 'FAnimNode_ScaleChainLength::ChainEndBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_ScaleChainLength, ChainInitialLength) == 0x000078, "Member 'FAnimNode_ScaleChainLength::ChainInitialLength' has a wrong offset!");
static_assert(offsetof(FAnimNode_ScaleChainLength, TargetLocation) == 0x00007C, "Member 'FAnimNode_ScaleChainLength::TargetLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_ScaleChainLength, Alpha) == 0x000088, "Member 'FAnimNode_ScaleChainLength::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_ScaleChainLength, ActualAlpha) == 0x00008C, "Member 'FAnimNode_ScaleChainLength::ActualAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_ScaleChainLength, AlphaScaleBias) == 0x000090, "Member 'FAnimNode_ScaleChainLength::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_ScaleChainLength, bBoneIndicesCached) == 0x000098, "Member 'FAnimNode_ScaleChainLength::bBoneIndicesCached' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_123[0x35];                                     // 0x0123(0x0035)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FAnimNode_SpringBone, SpringBone) == 0x0000F0, "Member 'FAnimNode_SpringBone::SpringBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bLimitDisplacement) == 0x000108, "Member 'FAnimNode_SpringBone::bLimitDisplacement' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, MaxDisplacement) == 0x00010C, "Member 'FAnimNode_SpringBone::MaxDisplacement' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, SpringStiffness) == 0x000110, "Member 'FAnimNode_SpringBone::SpringStiffness' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, SpringDamping) == 0x000114, "Member 'FAnimNode_SpringBone::SpringDamping' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, ErrorResetThresh) == 0x000118, "Member 'FAnimNode_SpringBone::ErrorResetThresh' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bNoZSpring) == 0x00011C, "Member 'FAnimNode_SpringBone::bNoZSpring' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bTranslateX) == 0x00011D, "Member 'FAnimNode_SpringBone::bTranslateX' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bTranslateY) == 0x00011E, "Member 'FAnimNode_SpringBone::bTranslateY' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bTranslateZ) == 0x00011F, "Member 'FAnimNode_SpringBone::bTranslateZ' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bRotateX) == 0x000120, "Member 'FAnimNode_SpringBone::bRotateX' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bRotateY) == 0x000121, "Member 'FAnimNode_SpringBone::bRotateY' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bRotateZ) == 0x000122, "Member 'FAnimNode_SpringBone::bRotateZ' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_StateResult) == 0x000040, "Wrong size on FAnimNode_StateResult");
...
static_assert(sizeof(FAnimNode_Trail) == 0x000280, "Wrong size on FAnimNode_Trail");
static_assert(offsetof(FAnimNode_Trail, TrailBone) == 0x0000F0, "Member 'FAnimNode_Trail::TrailBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, ChainLength) == 0x000108, "Member 'FAnimNode_Trail::ChainLength' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, ChainBoneAxis) == 0x00010C, "Member 'FAnimNode_Trail::ChainBoneAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, UnwindingSize) == 0x000110, "Member 'FAnimNode_Trail::UnwindingSize' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, RelaxationSpeedScale) == 0x000114, "Member 'FAnimNode_Trail::RelaxationSpeedScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, TrailRelaxationSpeed) == 0x000118, "Member 'FAnimNode_Trail::TrailRelaxationSpeed' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, RelaxationSpeedScaleInputProcessor) == 0x000190, "Member 'FAnimNode_Trail::RelaxationSpeedScaleInputProcessor' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, RotationLimits) == 0x0001C0, "Member 'FAnimNode_Trail::RotationLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, RotationOffsets) == 0x0001D0, "Member 'FAnimNode_Trail::RotationOffsets' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, PlanarLimits) == 0x0001E0, "Member 'FAnimNode_Trail::PlanarLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, StretchLimit) == 0x0001F0, "Member 'FAnimNode_Trail::StretchLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, FakeVelocity) == 0x0001F4, "Member 'FAnimNode_Trail::FakeVelocity' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, BaseJoint) == 0x000200, "Member 'FAnimNode_Trail::BaseJoint' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, LastBoneRotationAnimAlphaBlend) == 0x000218, "Member 'FAnimNode_Trail::LastBoneRotationAnimAlphaBlend' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_TwistCorrectiveNode) == 0x000178, "Wrong size on FAnimNode_TwistCorrectiveNode");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, BaseFrame) == 0x0000F0, "Member 'FAnimNode_TwistCorrectiveNode::BaseFrame' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, TwistFrame) == 0x000118, "Member 'FAnimNode_TwistCorrectiveNode::TwistFrame' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, TwistPlaneNormalAxis) == 0x000140, "Member 'FAnimNode_TwistCorrectiveNode::TwistPlaneNormalAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, RangeMax) == 0x000150, "Member 'FAnimNode_TwistCorrectiveNode::RangeMax' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, RemappedMin) == 0x000154, "Member 'FAnimNode_TwistCorrectiveNode::RemappedMin' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, RemappedMax) == 0x000158, "Member 'FAnimNode_TwistCorrectiveNode::RemappedMax' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, Curve) == 0x000160, "Member 'FAnimNode_TwistCorrectiveNode::Curve' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_TwoBoneIK, IKBone) == 0x0000F0, "Member 'FAnimNode_TwoBoneIK::IKBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, StartStretchRatio) == 0x00010C, "Member 'FAnimNode_TwoBoneIK::StartStretchRatio' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, MaxStretchScale) == 0x000110, "Member 'FAnimNode_TwoBoneIK::MaxStretchScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, StretchLimits) == 0x000114, "Member 'FAnimNode_TwoBoneIK::StretchLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorLocationSpace) == 0x000120, "Member 'FAnimNode_TwoBoneIK::EffectorLocationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorSpaceBoneName) == 0x000128, "Member 'FAnimNode_TwoBoneIK::EffectorSpaceBoneName' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorLocation) == 0x000130, "Member 'FAnimNode_TwoBoneIK::EffectorLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorTarget) == 0x000140, "Member 'FAnimNode_TwoBoneIK::EffectorTarget' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetLocationSpace) == 0x0001A0, "Member 'FAnimNode_TwoBoneIK::JointTargetLocationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetLocation) == 0x0001A4, "Member 'FAnimNode_TwoBoneIK::JointTargetLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetSpaceBoneName) == 0x0001B0, "Member 'FAnimNode_TwoBoneIK::JointTargetSpaceBoneName' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_TwoBoneIK, bAllowTwist) == 0x000220, "Member 'FAnimNode_TwoBoneIK::bAllowTwist' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, TwistAxis) == 0x000224, "Member 'FAnimNode_TwoBoneIK::TwistAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, bNoTwist) == 0x000234, "Member 'FAnimNode_TwoBoneIK::bNoTwist' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_TwoWayBlend) == 0x0000F8, "Wrong size on FAnimNode_TwoWayBlend");
static_assert(offsetof(FAnimNode_TwoWayBlend, A) == 0x000030, "Member 'FAnimNode_TwoWayBlend::A' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, B) == 0x000040, "Member 'FAnimNode_TwoWayBlend::B' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, AlphaInputType) == 0x000050, "Member 'FAnimNode_TwoWayBlend::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, Alpha) == 0x000054, "Member 'FAnimNode_TwoWayBlend::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, AlphaScaleBias) == 0x000058, "Member 'FAnimNode_TwoWayBlend::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, bAlphaBoolEnabled) == 0x000060, "Member 'FAnimNode_TwoWayBlend::bAlphaBoolEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, AlphaBoolBlend) == 0x000068, "Member 'FAnimNode_TwoWayBlend::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, AlphaCurveName) == 0x0000B8, "Member 'FAnimNode_TwoWayBlend::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, AlphaScaleBiasClamp) == 0x0000C0, "Member 'FAnimNode_TwoWayBlend::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, InternalBlendAlpha) == 0x0000F0, "Member 'FAnimNode_TwoWayBlend::InternalBlendAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, bAIsRelevant) == 0x0000F4, "Member 'FAnimNode_TwoWayBlend::bAIsRelevant' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, bBIsRelevant) == 0x0000F5, "Member 'FAnimNode_TwoWayBlend::bBIsRelevant' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, bResetChildOnActivation) == 0x0000F6, "Member 'FAnimNode_TwoWayBlend::bResetChildOnActivation' has a wrong offset!");

// ScriptStruct AnimGraphRuntime.AnimationPlayInSequence
// 0x0010 (0x0010 - 0x0000)
struct FAnimationPlayInSequence final
{
public:
	class UAnimSequenceBase*                      Animation;                                         // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Offset;                                            // 0x0008(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         BlendWeight;                                       // 0x000C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAnimationPlayInSequence) == 0x000008, "Wrong alignment on FAnimationPlayInSequence");
static_assert(sizeof(FAnimationPlayInSequence) == 0x000010, "Wrong size on FAnimationPlayInSequence");
static_assert(offsetof(FAnimationPlayInSequence, Animation) == 0x000000, "Member 'FAnimationPlayInSequence::Animation' has a wrong offset!");
static_assert(offsetof(FAnimationPlayInSequence, Offset) == 0x000008, "Member 'FAnimationPlayInSequence::Offset' has a wrong offset!");
static_assert(offsetof(FAnimationPlayInSequence, BlendWeight) == 0x00000C, "Member 'FAnimationPlayInSequence::BlendWeight' has a wrong offset!");
...
{
public:
	uint8                                         Pad_590[0x220];                                    // 0x0590(0x0220)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x0007B0, "Wrong size on FAnimSequencerInstanceProxy");
