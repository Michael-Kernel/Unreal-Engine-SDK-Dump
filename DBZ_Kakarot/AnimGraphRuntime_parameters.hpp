...
// Function AnimGraphRuntime.AnimSequencerInstance_AnimBP.IsSequencerPlaying
// 0x0001 (0x0001 - 0x0000)
struct AnimSequencerInstance_AnimBP_IsSequencerPlaying final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AnimSequencerInstance_AnimBP_IsSequencerPlaying) == 0x000001, "Wrong alignment on AnimSequencerInstance_AnimBP_IsSequencerPlaying");
static_assert(sizeof(AnimSequencerInstance_AnimBP_IsSequencerPlaying) == 0x000001, "Wrong size on AnimSequencerInstance_AnimBP_IsSequencerPlaying");
static_assert(offsetof(AnimSequencerInstance_AnimBP_IsSequencerPlaying, ReturnValue) == 0x000000, "Member 'AnimSequencerInstance_AnimBP_IsSequencerPlaying::ReturnValue' has a wrong offset!");
