...
public:
	...
	class UAtomComponent*                         CallFunc_SpawnSoundAttached_ReturnValue;           // 0x0018(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(PlayAtomCue_C_Received_Notify) == 0x000028, "Wrong size on PlayAtomCue_C_Received_Notify");
...
static_assert(offsetof(PlayAtomCue_C_Received_Notify, CallFunc_SpawnSoundAttached_ReturnValue) == 0x000018, "Member 'PlayAtomCue_C_Received_Notify::CallFunc_SpawnSoundAttached_ReturnValue' has a wrong offset!");
