...
bool UAnimSequencerInstance_AnimBP::IsSequencerPlaying() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AnimSequencerInstance_AnimBP", "IsSequencerPlaying");

	Params::AnimSequencerInstance_AnimBP_IsSequencerPlaying Parms{};
