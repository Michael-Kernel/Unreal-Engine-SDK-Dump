...
static_assert(sizeof(UAnimCustomInstance) == 0x000360, "Wrong size on UAnimCustomInstance");

// Class AnimGraphRuntime.AnimSequencerInstance_AnimBP
// 0x0028 (0x0388 - 0x0360)
#pragma pack(push, 0x1)
class alignas(0x08) UAnimSequencerInstance_AnimBP : public UAnimInstance
{
public:
	TArray<struct FAnimationPlayInSequence>       AnimsInSequencer;                                  // 0x0360(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FAnimationPlayInSequence               MainAnimation;                                     // 0x0370(0x0010)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AnimSequencerInstance_AnimBP">();
	}
	static class UAnimSequencerInstance_AnimBP* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAnimSequencerInstance_AnimBP>();
	}
};
#pragma pack(pop)
static_assert(alignof(UAnimSequencerInstance_AnimBP) == 0x000008, "Wrong alignment on UAnimSequencerInstance_AnimBP");
static_assert(sizeof(UAnimSequencerInstance_AnimBP) == 0x000388, "Wrong size on UAnimSequencerInstance_AnimBP");
static_assert(offsetof(UAnimSequencerInstance_AnimBP, AnimsInSequencer) == 0x000360, "Member 'UAnimSequencerInstance_AnimBP::AnimsInSequencer' has a wrong offset!");
static_assert(offsetof(UAnimSequencerInstance_AnimBP, MainAnimation) == 0x000370, "Member 'UAnimSequencerInstance_AnimBP::MainAnimation' has a wrong offset!");
...
static_assert(sizeof(UAnimSequencerInstance) == 0x000360, "Wrong size on UAnimSequencerInstance");
