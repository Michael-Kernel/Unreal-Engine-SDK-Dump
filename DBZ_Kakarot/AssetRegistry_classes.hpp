...
{
public:
	uint8                                         Pad_28[0x6E8];                                     // 0x0028(0x06E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x000710, "Wrong size on UAssetRegistryImpl");
