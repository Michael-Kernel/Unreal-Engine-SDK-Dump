...
static_assert(sizeof(AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToHEIF) == 0x000018, "Wrong size on AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToHEIF");
...
static_assert(offsetof(AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToHEIF, ReturnValue) == 0x000010, "Member 'AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToHEIF::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToJPEG) == 0x000018, "Wrong size on AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToJPEG");
...
static_assert(offsetof(AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToJPEG, ReturnValue) == 0x000010, "Member 'AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToJPEG::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToPNG) == 0x000018, "Wrong size on AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToPNG");
...
static_assert(offsetof(AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToPNG, ReturnValue) == 0x000010, "Member 'AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToPNG::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToTIFF) == 0x000018, "Wrong size on AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToTIFF");
...
static_assert(offsetof(AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToTIFF, ReturnValue) == 0x000010, "Member 'AppleImageUtilsBaseAsyncTaskBlueprintProxy_CreateProxyObjectForConvertToTIFF::ReturnValue' has a wrong offset!");
