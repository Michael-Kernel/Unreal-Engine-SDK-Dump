...
#include "BP_GM_Delivery_Kryll_classes.hpp"
#include "BP_GM_Delivery_Kryll_parameters.hpp"
...
void UBP_GM_Delivery_Kryll_C::K2_GrenadeInitialized(class AGrenade* Grenade, class AGrenadeMod* GrenadeMod) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GM_Delivery_Kryll_C", "K2_GrenadeInitialized");

	Params::BP_GM_Delivery_Kryll_C_K2_GrenadeInitialized Parms{};
