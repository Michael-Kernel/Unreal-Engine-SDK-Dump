...
static_assert(sizeof(FMovieSceneGeometryCacheParams) == 0x000028, "Wrong size on FMovieSceneGeometryCacheParams");
static_assert(offsetof(FMovieSceneGeometryCacheParams, GeometryCache) == 0x000000, "Member 'FMovieSceneGeometryCacheParams::GeometryCache' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneGeometryCacheParams, PlayRate) == 0x000020, "Member 'FMovieSceneGeometryCacheParams::PlayRate' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneGeometryCacheSectionTemplateParameters) == 0x000038, "Wrong size on FMovieSceneGeometryCacheSectionTemplateParameters");
static_assert(offsetof(FMovieSceneGeometryCacheSectionTemplateParameters, SectionStartTime) == 0x000030, "Member 'FMovieSceneGeometryCacheSectionTemplateParameters::SectionStartTime' has a wrong offset!");
static_assert(offsetof(FMovieSceneGeometryCacheSectionTemplateParameters, SectionEndTime) == 0x000034, "Member 'FMovieSceneGeometryCacheSectionTemplateParameters::SectionEndTime' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneGeometryCacheSectionTemplate) == 0x000058, "Wrong size on FMovieSceneGeometryCacheSectionTemplate");
