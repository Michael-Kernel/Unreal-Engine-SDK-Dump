...
static_assert(sizeof(UAppleVisionDetectFacesAsyncTaskBlueprintProxy) == 0x000078, "Wrong size on UAppleVisionDetectFacesAsyncTaskBlueprintProxy");
...
static_assert(offsetof(UAppleVisionDetectFacesAsyncTaskBlueprintProxy, OnFailure) == 0x000040, "Member 'UAppleVisionDetectFacesAsyncTaskBlueprintProxy::OnFailure' has a wrong offset!");
static_assert(offsetof(UAppleVisionDetectFacesAsyncTaskBlueprintProxy, FaceDetectionResult) == 0x000060, "Member 'UAppleVisionDetectFacesAsyncTaskBlueprintProxy::FaceDetectionResult' has a wrong offset!");
