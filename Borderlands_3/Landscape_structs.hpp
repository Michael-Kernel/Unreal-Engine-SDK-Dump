...
// NumValues: 0x0004
enum class ELandscapeLayerAutoPaintType : uint8
{
	LSLAPT_None                              = 0,
...
// NumValues: 0x0007
enum class ELandscapeAutoPaintActorState : uint8
{
	LAPS_None                                = 0,
	LAPS_NoAutoPaint                         = 1,
...
// NumValues: 0x0007
enum class ELandscapeAutoPaintOperation : uint8
{
	LAPO_None                                = 0,
...
public:
	...
	bool                                          bUseAsOccluder;                                    // 0x0041(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCastDynamicShadow;                                // 0x0042(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bKeepInstanceBufferCPUCopy;                        // 0x0043(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FGrassVariety, bUseAsOccluder) == 0x000041, "Member 'FGrassVariety::bUseAsOccluder' has a wrong offset!");
static_assert(offsetof(FGrassVariety, bCastDynamicShadow) == 0x000042, "Member 'FGrassVariety::bCastDynamicShadow' has a wrong offset!");
static_assert(offsetof(FGrassVariety, bKeepInstanceBufferCPUCopy) == 0x000043, "Member 'FGrassVariety::bKeepInstanceBufferCPUCopy' has a wrong offset!");
...
// 0x0038 (0x0038 - 0x0000)
struct FAutoPaintLayerInput final
{
public:
...
static_assert(alignof(FAutoPaintLayerInput) == 0x000008, "Wrong alignment on FAutoPaintLayerInput");
static_assert(sizeof(FAutoPaintLayerInput) == 0x000038, "Wrong size on FAutoPaintLayerInput");
static_assert(offsetof(FAutoPaintLayerInput, LayerName) == 0x000000, "Member 'FAutoPaintLayerInput::LayerName' has a wrong offset!");
static_assert(offsetof(FAutoPaintLayerInput, Input) == 0x000008, "Member 'FAutoPaintLayerInput::Input' has a wrong offset!");
...
static_assert(sizeof(FGrassInput) == 0x000040, "Wrong size on FGrassInput");
...
public:
	...
	struct FVector                                ConstLayerInput;                                   // 0x0074(0x000C)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FLayerBlendInput, HeightInput) == 0x000040, "Member 'FLayerBlendInput::HeightInput' has a wrong offset!");
static_assert(offsetof(FLayerBlendInput, PreviewWeight) == 0x000070, "Member 'FLayerBlendInput::PreviewWeight' has a wrong offset!");
static_assert(offsetof(FLayerBlendInput, ConstLayerInput) == 0x000074, "Member 'FLayerBlendInput::ConstLayerInput' has a wrong offset!");
