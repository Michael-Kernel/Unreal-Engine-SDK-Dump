...
public:
	...
	const class UGFxMoviePlayer*                  MoviePlayer;                                       // 0x0018(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	const class UGFxMoviePlayer*                  ReturnValue;                                       // 0x0028(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(GFxMoviePlayer_OpenMovie, bRefresh) == 0x000021, "Member 'GFxMoviePlayer_OpenMovie::bRefresh' has a wrong offset!");
...
struct GFxMoviePlayer_IsPaused final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(GFxMoviePlayer_IsPaused) == 0x000001, "Wrong alignment on GFxMoviePlayer_IsPaused");
static_assert(sizeof(GFxMoviePlayer_IsPaused) == 0x000001, "Wrong size on GFxMoviePlayer_IsPaused");
static_assert(offsetof(GFxMoviePlayer_IsPaused, ReturnValue) == 0x000000, "Member 'GFxMoviePlayer_IsPaused::ReturnValue' has a wrong offset!");

// Function ScaleformUI.GFxMoviePlayer.IsVisible
// 0x0001 (0x0001 - 0x0000)
struct GFxMoviePlayer_IsVisible final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(GFxMoviePlayer_IsVisible) == 0x000001, "Wrong alignment on GFxMoviePlayer_IsVisible");
static_assert(sizeof(GFxMoviePlayer_IsVisible) == 0x000001, "Wrong size on GFxMoviePlayer_IsVisible");
static_assert(offsetof(GFxMoviePlayer_IsVisible, ReturnValue) == 0x000000, "Member 'GFxMoviePlayer_IsVisible::ReturnValue' has a wrong offset!");
...
// 0x0004 (0x0004 - 0x0000)
struct GFxMoviePlayer_OnGameTick final
{
public:
	float                                         DeltaTime;                                         // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(GFxMoviePlayer_OnGameTick) == 0x000004, "Wrong alignment on GFxMoviePlayer_OnGameTick");
static_assert(sizeof(GFxMoviePlayer_OnGameTick) == 0x000004, "Wrong size on GFxMoviePlayer_OnGameTick");
static_assert(offsetof(GFxMoviePlayer_OnGameTick, DeltaTime) == 0x000000, "Member 'GFxMoviePlayer_OnGameTick::DeltaTime' has a wrong offset!");
...
static_assert(sizeof(GFxMoviePlayer_SetExternalTexture) == 0x000018, "Wrong size on GFxMoviePlayer_SetExternalTexture");
...
// 0x0001 (0x0001 - 0x0000)
struct GFxMoviePlayer_SetVisible final
{
public:
	bool                                          bVisible;                                          // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(GFxMoviePlayer_SetVisible) == 0x000001, "Wrong alignment on GFxMoviePlayer_SetVisible");
static_assert(sizeof(GFxMoviePlayer_SetVisible) == 0x000001, "Wrong size on GFxMoviePlayer_SetVisible");
static_assert(offsetof(GFxMoviePlayer_SetVisible, bVisible) == 0x000000, "Member 'GFxMoviePlayer_SetVisible::bVisible' has a wrong offset!");
...
static_assert(alignof(GFxObject_GetDisplayInfo) == 0x000004, "Wrong alignment on GFxObject_GetDisplayInfo");
...
static_assert(alignof(GFxObject_SetDisplayInfo) == 0x000004, "Wrong alignment on GFxObject_SetDisplayInfo");
...
{
public:
	const class UGFxMoviePlayer*                  MoviePlayer;                                       // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// 0x0028 (0x0028 - 0x0000)
struct ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass final
{
public:
	...
	TSubclassOf<class UGFxMoviePlayer>            GFxMoviePlayerClass;                               // 0x0018(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass) == 0x000008, "Wrong alignment on ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass");
static_assert(sizeof(ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass) == 0x000028, "Wrong size on ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass");
static_assert(offsetof(ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass, WorldContextObject) == 0x000000, "Member 'ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass::WorldContextObject' has a wrong offset!");
static_assert(offsetof(ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass, FoundGFxMoviePlayer) == 0x000008, "Member 'ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass::FoundGFxMoviePlayer' has a wrong offset!");
static_assert(offsetof(ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass, GFxMoviePlayerClass) == 0x000018, "Member 'ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass::GFxMoviePlayerClass' has a wrong offset!");
static_assert(offsetof(ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass, VisibleOnly) == 0x000020, "Member 'ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass::VisibleOnly' has a wrong offset!");
