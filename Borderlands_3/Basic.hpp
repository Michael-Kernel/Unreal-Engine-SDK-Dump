...
namespace Offsets
{
	constexpr int32 GObjects          = 0x069E91B0;
	constexpr int32 AppendString      = 0x0169C320;
	constexpr int32 GNames            = 0x069E45E8;
	constexpr int32 GWorld            = 0x065270D0;
	constexpr int32 ProcessEvent      = 0x01793BA0;
