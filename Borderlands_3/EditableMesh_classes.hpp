...
{
public:
	uint8                                         Pad_28[0xD50];                                     // 0x0028(0x0D50)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_D8C[0xF8];                                     // 0x0D8C(0x00F8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E8C[0x1E4];                                    // 0x0E8C(0x01E4)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEditableMesh) == 0x001070, "Wrong size on UEditableMesh");
static_assert(offsetof(UEditableMesh, Adapters) == 0x000D78, "Member 'UEditableMesh::Adapters' has a wrong offset!");
static_assert(offsetof(UEditableMesh, TextureCoordinateCount) == 0x000D88, "Member 'UEditableMesh::TextureCoordinateCount' has a wrong offset!");
static_assert(offsetof(UEditableMesh, PendingCompactCounter) == 0x000E84, "Member 'UEditableMesh::PendingCompactCounter' has a wrong offset!");
static_assert(offsetof(UEditableMesh, SubdivisionCount) == 0x000E88, "Member 'UEditableMesh::SubdivisionCount' has a wrong offset!");
