...
#include "ShieldAug_SlideKick_FrozenHeart_classes.hpp"
#include "ShieldAug_SlideKick_FrozenHeart_parameters.hpp"
...
void UShieldAug_SlideKick_FrozenHeart_C::K2_OnCausedDamage(class AShield* Shield, struct FAugmentData& StackData, class AActor* DamageInstigator, float Damage, const class UGbxDamageType* DamageType, const class UDamageSource* DamageSource, class AActor* DamagedActor, const struct FCausedDamageDetails& Details) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ShieldAug_SlideKick_FrozenHeart_C", "K2_OnCausedDamage");

	Params::ShieldAug_SlideKick_FrozenHeart_C_K2_OnCausedDamage Parms{};
