...
#include "BP_Challenge_ValentinesDayEvent_Tier4_classes.hpp"
#include "BP_Challenge_ValentinesDayEvent_Tier4_parameters.hpp"
...
void UBP_Challenge_ValentinesDayEvent_Tier4_C::ExecuteUbergraph_BP_Challenge_ValentinesDayEvent_Tier4(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Challenge_ValentinesDayEvent_Tier4_C", "ExecuteUbergraph_BP_Challenge_ValentinesDayEvent_Tier4");

	Params::BP_Challenge_ValentinesDayEvent_Tier4_C_ExecuteUbergraph_BP_Challenge_ValentinesDayEvent_Tier4 Parms{};
...
void UBP_Challenge_ValentinesDayEvent_Tier4_C::CompletedChallenge(const class AGbxPlayerController* CompletedPlayer)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Challenge_ValentinesDayEvent_Tier4_C", "CompletedChallenge");

	Params::BP_Challenge_ValentinesDayEvent_Tier4_C_CompletedChallenge Parms{};
...
void UBP_Challenge_ValentinesDayEvent_Tier4_C::OnInitChallengeInstance(class UChallengesComponent* OwningChallenges, class AGbxCharacter* AssociatedCharacter)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_Challenge_ValentinesDayEvent_Tier4_C", "OnInitChallengeInstance");

	Params::BP_Challenge_ValentinesDayEvent_Tier4_C_OnInitChallengeInstance Parms{};
...
void UBP_Challenge_ValentinesDayEvent_Tier4_C::PlayCompletionAudio(class AGbxPlayerController* InputPin, bool* PlayedAudio)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_Challenge_ValentinesDayEvent_Tier4_C", "PlayCompletionAudio");

	Params::BP_Challenge_ValentinesDayEvent_Tier4_C_PlayCompletionAudio Parms{};
