...
#include "Challenge_Crew_DLC1_parameters.hpp"
...
void UChallenge_Crew_DLC1_C::ExecuteUbergraph_Challenge_Crew_DLC1(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Crew_DLC1_C", "ExecuteUbergraph_Challenge_Crew_DLC1");

	Params::Challenge_Crew_DLC1_C_ExecuteUbergraph_Challenge_Crew_DLC1 Parms{};
...
void UChallenge_Crew_DLC1_C::CompletedChallenge(const class AGbxPlayerController* CompletedPlayer)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Crew_DLC1_C", "CompletedChallenge");

	Params::Challenge_Crew_DLC1_C_CompletedChallenge Parms{};
...
void UChallenge_Crew_DLC1_C::OnChallengeActivated()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Crew_DLC1_C", "OnChallengeActivated");
...
void UChallenge_Crew_DLC1_C::OnInitChallengeInstance(class UChallengesComponent* OwningChallenges, class AGbxCharacter* AssociatedCharacter)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Crew_DLC1_C", "OnInitChallengeInstance");

	Params::Challenge_Crew_DLC1_C_OnInitChallengeInstance Parms{};
...
void UChallenge_Crew_DLC1_C::PlayCompletionAudio(const class AGbxPlayerController* InputPin, bool* PlayedAudio)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Crew_DLC1_C", "PlayCompletionAudio");

	Params::Challenge_Crew_DLC1_C_PlayCompletionAudio Parms{};
...
void UChallenge_Crew_DLC1_C::ShowTutorialPopup(class UGameInstance* GameInstance, class AOakPlayerController* TargetPlayer)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Crew_DLC1_C", "ShowTutorialPopup");

	Params::Challenge_Crew_DLC1_C_ShowTutorialPopup Parms{};
...
void UChallenge_Crew_DLC1_C::PlayActivationAudio()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Crew_DLC1_C", "PlayActivationAudio");
