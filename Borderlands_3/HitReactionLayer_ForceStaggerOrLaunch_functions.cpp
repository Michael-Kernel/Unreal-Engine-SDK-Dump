...
#include "HitReactionLayer_ForceStaggerOrLaunch_classes.hpp"
#include "HitReactionLayer_ForceStaggerOrLaunch_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_ForceStaggerOrLaunch_C::EvaluateTag(class UDamageComponent* Receiver, class UDamageCauserComponent* Causer, float DamageAmount, const class UGbxDamageType* DamageType, const class UDamageSource* DamageSource, class UHitRegionData* HitRegion, float Force, class UHitReactionTag* PreviousTag) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HitReactionLayer_ForceStaggerOrLaunch_C", "EvaluateTag");

	Params::HitReactionLayer_ForceStaggerOrLaunch_C_EvaluateTag Parms{};
