...
#include "DamageData_BloodyHarvestGhost_classes.hpp"
#include "DamageData_BloodyHarvestGhost_parameters.hpp"
...
void UDamageData_BloodyHarvestGhost_C::OnHitAnyAttitude(class AActor* DamageInstigator, class AActor* DamageCauser, class AActor* DamageTarget, const struct FDamageDataEventDetails& Details) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DamageData_BloodyHarvestGhost_C", "OnHitAnyAttitude");

	Params::DamageData_BloodyHarvestGhost_C_OnHitAnyAttitude Parms{};
