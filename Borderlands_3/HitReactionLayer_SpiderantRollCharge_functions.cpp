...
#include "HitReactionLayer_SpiderantRollCharge_classes.hpp"
#include "HitReactionLayer_SpiderantRollCharge_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_SpiderantRollCharge_C::EvaluateTag(class UDamageComponent* Receiver, class UDamageCauserComponent* Causer, float DamageAmount, const class UGbxDamageType* DamageType, const class UDamageSource* DamageSource, class UHitRegionData* HitRegion, float Force, class UHitReactionTag* PreviousTag) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HitReactionLayer_SpiderantRollCharge_C", "EvaluateTag");

	Params::HitReactionLayer_SpiderantRollCharge_C_EvaluateTag Parms{};
