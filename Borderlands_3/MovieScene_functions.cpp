...
void UMovieSceneSequencePlayer::SetEnableUpdateRateOptimizations(bool Enable)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("MovieSceneSequencePlayer", "SetEnableUpdateRateOptimizations");

	Params::MovieSceneSequencePlayer_SetEnableUpdateRateOptimizations Parms{};
...
bool UMovieSceneSequencePlayer::GetEnableUpdateRateOptimizations() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MovieSceneSequencePlayer", "GetEnableUpdateRateOptimizations");

	Params::MovieSceneSequencePlayer_GetEnableUpdateRateOptimizations Parms{};
