...
#include "Challenge_Melee_BladedKills_classes.hpp"
#include "Challenge_Melee_BladedKills_parameters.hpp"
...
void UChallenge_Melee_BladedKills_C::CheckKillCondition(class UDamageComponent* DamageReceiver, struct FCausedDeathDetails& DeathDetails)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Melee_BladedKills_C", "CheckKillCondition");

	Params::Challenge_Melee_BladedKills_C_CheckKillCondition Parms{};
...
void UChallenge_Melee_BladedKills_C::OnInitChallengeInstance(class UChallengesComponent* OwningChallenges, class AGbxCharacter* AssociatedCharacter) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Melee_BladedKills_C", "OnInitChallengeInstance");

	Params::Challenge_Melee_BladedKills_C_OnInitChallengeInstance Parms{};
