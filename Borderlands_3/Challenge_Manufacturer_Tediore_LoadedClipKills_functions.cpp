...
#include "Challenge_Manufacturer_Tediore_LoadedClipKills_classes.hpp"
#include "Challenge_Manufacturer_Tediore_LoadedClipKills_parameters.hpp"
...
void UChallenge_Manufacturer_Tediore_LoadedClipKills_C::CheckKillCondition(class UDamageComponent* DamageReceiver, struct FCausedDeathDetails& DeathDetails)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Manufacturer_Tediore_LoadedClipKills_C", "CheckKillCondition");

	Params::Challenge_Manufacturer_Tediore_LoadedClipKills_C_CheckKillCondition Parms{};
...
void UChallenge_Manufacturer_Tediore_LoadedClipKills_C::OnInitChallengeInstance(class UChallengesComponent* OwningChallenges, class AGbxCharacter* AssociatedCharacter) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Manufacturer_Tediore_LoadedClipKills_C", "OnInitChallengeInstance");

	Params::Challenge_Manufacturer_Tediore_LoadedClipKills_C_OnInitChallengeInstance Parms{};
