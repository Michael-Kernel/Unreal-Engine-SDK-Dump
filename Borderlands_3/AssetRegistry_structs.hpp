...
public:
	...
	bool                                          bExcludeLocalizedAssets;                           // 0x00E3(0x0001)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FARFilter, bExcludeLocalizedAssets) == 0x0000E3, "Member 'FARFilter::bExcludeLocalizedAssets' has a wrong offset!");
...
public:
	...
	struct FDateTime                              AssetDateModified;                                 // 0x0050(0x0008)(BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAssetData) == 0x000008, "Wrong alignment on FAssetData");
static_assert(sizeof(FAssetData) == 0x000058, "Wrong size on FAssetData");
...
static_assert(offsetof(FAssetData, AssetDateModified) == 0x000050, "Member 'FAssetData::AssetDateModified' has a wrong offset!");
