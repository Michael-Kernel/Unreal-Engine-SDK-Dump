...
#include "AIAction_PetShared_classes.hpp"
#include "AIAction_PetShared_parameters.hpp"
...
void UAIAction_PetShared_C::ExecuteUbergraph_AIAction_PetShared(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AIAction_PetShared_C", "ExecuteUbergraph_AIAction_PetShared");

	Params::AIAction_PetShared_C_ExecuteUbergraph_AIAction_PetShared Parms{};
...
void UAIAction_PetShared_C::ResetPetInteract(class AGbxCharacter* NewChar)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AIAction_PetShared_C", "ResetPetInteract");

	Params::AIAction_PetShared_C_ResetPetInteract Parms{};
...
void UAIAction_PetShared_C::BndEvt__PlayGbxAction_OnStartedEventBP_AIActionBlueprintDelegate__DelegateSignature_AIAction_PetShared(class AGbxAIController* AIController, class AGbxCharacter* Character, const struct FAIActionBlueprintContext& Context)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AIAction_PetShared_C", "BndEvt__PlayGbxAction_OnStartedEventBP_AIActionBlueprintDelegate__DelegateSignature_AIAction_PetShared");

	Params::AIAction_PetShared_C_BndEvt__PlayGbxAction_OnStartedEventBP_AIActionBlueprintDelegate__DelegateSignature_AIAction_PetShared Parms{};
...
void UAIAction_PetShared_C::BndEvt__PlayGbxAction_OnStoppedEventBP_AIActionBlueprintResultDelegate__DelegateSignature_AIAction_PetShared(class AGbxAIController* AIController, class AGbxCharacter* Character, const struct FAIActionBlueprintContext& Context, EAIActionResult Result)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AIAction_PetShared_C", "BndEvt__PlayGbxAction_OnStoppedEventBP_AIActionBlueprintResultDelegate__DelegateSignature_AIAction_PetShared");

	Params::AIAction_PetShared_C_BndEvt__PlayGbxAction_OnStoppedEventBP_AIActionBlueprintResultDelegate__DelegateSignature_AIAction_PetShared Parms{};
