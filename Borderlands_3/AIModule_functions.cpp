...
// class UBlackboardKeyType*               KeyType                                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// uint8                                   ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

uint8 UBlackboardComponent::AddRuntimeKey(class FName KeyName, class UBlackboardKeyType* KeyType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BlackboardComponent", "AddRuntimeKey");

	Params::BlackboardComponent_AddRuntimeKey Parms{};
...
bool UBlackboardComponent::HasValue(const class FName& KeyName) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BlackboardComponent", "HasValue");

	Params::BlackboardComponent_HasValue Parms{};
