...
class UMission_MoneyBackGuarantee_C final : public UBP_OakMission_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Mission_MoneyBackGuarantee_C;       // 0x0510(0x0008)(Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_Mission_MoneyBackGuarantee(int32 EntryPoint);
	...
	void OBJ_FireGun(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_FireGun(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Update_Cannon_Breadcrumb03(class UObject* Context);
	void OBJ_GoToCannon_Breadcrumb03(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void OBJ_PayForGun(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void OBJ_GoToCannon(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void OBJ_GoToCannon_Breadcrumb02(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void OBJ_GoToCannon_Breadcrumb01(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Update_HitStickly(class UObject* Context);
	void OBJ_HitStickly(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void OBJ_TalkToOfficer(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_CollectShell(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void OBJ_ConfrontConman02(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Update_ConfrontConman02(class UObject* Context);
	void SET_ConfrontConman02(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void OBJINVIS_OpenSticklysRoom(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Update_PickupGun(class UObject* Context);
	void SET_PickUpGun(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void OBJ_PickUpGun(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Update_GoToMine04(class UObject* Context);
	void OBJ_GoToMine04(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Set_ConfrontOfficer(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Update_GoToMine03(class UObject* Context);
	void OBJ_GoToMine03(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Update_GoToMine(class UObject* Context);
	void OBJ_GoToMine(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void OBJ_GoToMine02(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void OBJ_GoToMine01(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void OBJ_ConfrontOfficer(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Update_FindClue01(class UObject* Context);
	void OBJ_FindClue01(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Update_FindClue02(class UObject* Context);
	void OBJ_Clue02(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_FindClue01(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Update_FindGun_Breadcrumb03(class UObject* Context);
	void OBJ_FindGun_Breadcrumb03(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Update_FindGun(class UObject* Context);
	void OBJ_FindGun(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void OBJ_FindGun_Breadcrumb02(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void OBJ_FindGun_Breadcrumb01(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void OBJ_INVGunFireSequnece(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void OBJ_CollectRefund(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_CollectRefund(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void OBJ_LoadGun(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void OBJ_ReturnToFort(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void OBJ_CollectShell(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_FreeOfficer(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void OBJ_FreeOfficer(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void OBJ_FindOfficer(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_FindOfficer(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void OBJ_ClearFort(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void OBJ_FindFort(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Mission_MoneyBackGuarantee_C">();
	}
	static class UMission_MoneyBackGuarantee_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMission_MoneyBackGuarantee_C>();
	}
};
static_assert(alignof(UMission_MoneyBackGuarantee_C) == 0x000008, "Wrong alignment on UMission_MoneyBackGuarantee_C");
static_assert(sizeof(UMission_MoneyBackGuarantee_C) == 0x0006D8, "Wrong size on UMission_MoneyBackGuarantee_C");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, UberGraphFrame_Mission_MoneyBackGuarantee_C) == 0x000510, "Member 'UMission_MoneyBackGuarantee_C::UberGraphFrame_Mission_MoneyBackGuarantee_C' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_PayForGun_ObjSetVar) == 0x000518, "Member 'UMission_MoneyBackGuarantee_C::SET_PayForGun_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_PayForGun_ObjVar) == 0x000520, "Member 'UMission_MoneyBackGuarantee_C::OBJ_PayForGun_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, Set_ConfrontOfficer_ObjSetVar) == 0x000528, "Member 'UMission_MoneyBackGuarantee_C::Set_ConfrontOfficer_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_ConfrontOfficer_ObjVar) == 0x000530, "Member 'UMission_MoneyBackGuarantee_C::OBJ_ConfrontOfficer_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_FindFort_ObjSetVar) == 0x000538, "Member 'UMission_MoneyBackGuarantee_C::SET_FindFort_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_FindFort_ObjVar) == 0x000540, "Member 'UMission_MoneyBackGuarantee_C::OBJ_FindFort_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, Set_ClearTheFort_ObjSetVar) == 0x000548, "Member 'UMission_MoneyBackGuarantee_C::Set_ClearTheFort_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_ClearFort_ObjVar) == 0x000550, "Member 'UMission_MoneyBackGuarantee_C::OBJ_ClearFort_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_FindOfficer_ObjSetVar) == 0x000558, "Member 'UMission_MoneyBackGuarantee_C::SET_FindOfficer_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_FindOfficer_ObjVar) == 0x000560, "Member 'UMission_MoneyBackGuarantee_C::OBJ_FindOfficer_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_FreeOfficer_ObjSetVar) == 0x000568, "Member 'UMission_MoneyBackGuarantee_C::SET_FreeOfficer_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_FreeOfficer_ObjVar) == 0x000570, "Member 'UMission_MoneyBackGuarantee_C::OBJ_FreeOfficer_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_CollectShell_ObjVar) == 0x000578, "Member 'UMission_MoneyBackGuarantee_C::OBJ_CollectShell_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_ReturnToFort_ObjSetVar) == 0x000580, "Member 'UMission_MoneyBackGuarantee_C::SET_ReturnToFort_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_ReturnToFort_ObjVar) == 0x000588, "Member 'UMission_MoneyBackGuarantee_C::OBJ_ReturnToFort_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_LoadGun_ObjSetVar) == 0x000590, "Member 'UMission_MoneyBackGuarantee_C::SET_LoadGun_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_LoadGun_ObjVar) == 0x000598, "Member 'UMission_MoneyBackGuarantee_C::OBJ_LoadGun_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_CollectRefund_ObjSetVar) == 0x0005A0, "Member 'UMission_MoneyBackGuarantee_C::SET_CollectRefund_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_CollectRefund_ObjVar) == 0x0005A8, "Member 'UMission_MoneyBackGuarantee_C::OBJ_CollectRefund_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_DefeatAmbush_ObjSetVar) == 0x0005B0, "Member 'UMission_MoneyBackGuarantee_C::SET_DefeatAmbush_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_DefeatAmbush_ObjVar) == 0x0005B8, "Member 'UMission_MoneyBackGuarantee_C::OBJ_DefeatAmbush_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, Set_BreakIntoFort_ObjSetVar) == 0x0005C0, "Member 'UMission_MoneyBackGuarantee_C::Set_BreakIntoFort_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_INVGunFireSequnece_ObjVar) == 0x0005C8, "Member 'UMission_MoneyBackGuarantee_C::OBJ_INVGunFireSequnece_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_FireGunsequence_ObjSetVar) == 0x0005D0, "Member 'UMission_MoneyBackGuarantee_C::SET_FireGunsequence_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_FindGun_Breadcrumb01_ObjVar) == 0x0005D8, "Member 'UMission_MoneyBackGuarantee_C::OBJ_FindGun_Breadcrumb01_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_FindGun_Breadcrumb02_ObjVar) == 0x0005E0, "Member 'UMission_MoneyBackGuarantee_C::OBJ_FindGun_Breadcrumb02_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_FindGun_ObjSetVar) == 0x0005E8, "Member 'UMission_MoneyBackGuarantee_C::SET_FindGun_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_FindGun_ObjVar) == 0x0005F0, "Member 'UMission_MoneyBackGuarantee_C::OBJ_FindGun_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_FindGun_Breadcrumb03_ObjVar) == 0x0005F8, "Member 'UMission_MoneyBackGuarantee_C::OBJ_FindGun_Breadcrumb03_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_FindClue01_ObjSetVar) == 0x000600, "Member 'UMission_MoneyBackGuarantee_C::SET_FindClue01_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_Clue02_ObjVar) == 0x000608, "Member 'UMission_MoneyBackGuarantee_C::OBJ_Clue02_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_FindClue01_ObjVar) == 0x000610, "Member 'UMission_MoneyBackGuarantee_C::OBJ_FindClue01_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_FindClue02_ObjSetVar) == 0x000618, "Member 'UMission_MoneyBackGuarantee_C::SET_FindClue02_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_GoToMine_ObjSetVar) == 0x000620, "Member 'UMission_MoneyBackGuarantee_C::SET_GoToMine_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_GoToMine_ObjVar) == 0x000628, "Member 'UMission_MoneyBackGuarantee_C::OBJ_GoToMine_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_GoToMine01_ObjVar) == 0x000630, "Member 'UMission_MoneyBackGuarantee_C::OBJ_GoToMine01_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_GoToMine02_ObjVar) == 0x000638, "Member 'UMission_MoneyBackGuarantee_C::OBJ_GoToMine02_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_GoToMine03_ObjVar) == 0x000640, "Member 'UMission_MoneyBackGuarantee_C::OBJ_GoToMine03_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_GoToMine04_ObjVar) == 0x000648, "Member 'UMission_MoneyBackGuarantee_C::OBJ_GoToMine04_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_PickUpGun_ObjSetVar) == 0x000650, "Member 'UMission_MoneyBackGuarantee_C::SET_PickUpGun_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_PickUpGun_ObjVar) == 0x000658, "Member 'UMission_MoneyBackGuarantee_C::OBJ_PickUpGun_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJINVIS_OpenSticklysRoom_ObjVar) == 0x000660, "Member 'UMission_MoneyBackGuarantee_C::OBJINVIS_OpenSticklysRoom_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_ConfrontConman02_ObjSetVar) == 0x000668, "Member 'UMission_MoneyBackGuarantee_C::SET_ConfrontConman02_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_ConfrontConman02_ObjVar) == 0x000670, "Member 'UMission_MoneyBackGuarantee_C::OBJ_ConfrontConman02_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_CollectShell_ObjSetVar) == 0x000678, "Member 'UMission_MoneyBackGuarantee_C::SET_CollectShell_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_TalkToOfficer_ObjSetVar) == 0x000680, "Member 'UMission_MoneyBackGuarantee_C::SET_TalkToOfficer_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_TalkToOfficer_ObjVar) == 0x000688, "Member 'UMission_MoneyBackGuarantee_C::OBJ_TalkToOfficer_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_HitStickly_ObjSetVar) == 0x000690, "Member 'UMission_MoneyBackGuarantee_C::SET_HitStickly_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_HitStickly_ObjVar) == 0x000698, "Member 'UMission_MoneyBackGuarantee_C::OBJ_HitStickly_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_GoToCannon_ObjSetVar) == 0x0006A0, "Member 'UMission_MoneyBackGuarantee_C::SET_GoToCannon_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_GoToCannon_ObjVar) == 0x0006A8, "Member 'UMission_MoneyBackGuarantee_C::OBJ_GoToCannon_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_GoToCannon_Breadcrumb01_ObjVar) == 0x0006B0, "Member 'UMission_MoneyBackGuarantee_C::OBJ_GoToCannon_Breadcrumb01_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_GoToCannon_Breadcrumb02_ObjVar) == 0x0006B8, "Member 'UMission_MoneyBackGuarantee_C::OBJ_GoToCannon_Breadcrumb02_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, SET_FireGun_ObjSetVar) == 0x0006C0, "Member 'UMission_MoneyBackGuarantee_C::SET_FireGun_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_FireGun_ObjVar) == 0x0006C8, "Member 'UMission_MoneyBackGuarantee_C::OBJ_FireGun_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_MoneyBackGuarantee_C, OBJ_GoToCannon_Breadcrumb03_ObjVar) == 0x0006D0, "Member 'UMission_MoneyBackGuarantee_C::OBJ_GoToCannon_Breadcrumb03_ObjVar' has a wrong offset!");
