...
static_assert(alignof(FPolygonHoleVertices) == 0x000008, "Wrong alignment on FPolygonHoleVertices");
static_assert(sizeof(FPolygonHoleVertices) == 0x000010, "Wrong size on FPolygonHoleVertices");
static_assert(offsetof(FPolygonHoleVertices, HoleVertices) == 0x000000, "Member 'FPolygonHoleVertices::HoleVertices' has a wrong offset!");
...
static_assert(alignof(FVerticesForEdge) == 0x000004, "Wrong alignment on FVerticesForEdge");
static_assert(sizeof(FVerticesForEdge) == 0x00000C, "Wrong size on FVerticesForEdge");
static_assert(offsetof(FVerticesForEdge, EdgeID) == 0x000000, "Member 'FVerticesForEdge::EdgeID' has a wrong offset!");
static_assert(offsetof(FVerticesForEdge, NewVertexID0) == 0x000004, "Member 'FVerticesForEdge::NewVertexID0' has a wrong offset!");
static_assert(offsetof(FVerticesForEdge, NewVertexID1) == 0x000008, "Member 'FVerticesForEdge::NewVertexID1' has a wrong offset!");
...
static_assert(sizeof(FPolygonToCreate) == 0x000030, "Wrong size on FPolygonToCreate");
...
static_assert(offsetof(FPolygonToCreate, PolygonHoles) == 0x000018, "Member 'FPolygonToCreate::PolygonHoles' has a wrong offset!");
static_assert(offsetof(FPolygonToCreate, OriginalPolygonID) == 0x000028, "Member 'FPolygonToCreate::OriginalPolygonID' has a wrong offset!");
static_assert(offsetof(FPolygonToCreate, PolygonEdgeHardness) == 0x00002C, "Member 'FPolygonToCreate::PolygonEdgeHardness' has a wrong offset!");
...
static_assert(sizeof(FEdgeToCreate) == 0x000030, "Wrong size on FEdgeToCreate");
...
static_assert(offsetof(FEdgeToCreate, ConnectedPolygons) == 0x000008, "Member 'FEdgeToCreate::ConnectedPolygons' has a wrong offset!");
static_assert(offsetof(FEdgeToCreate, EdgeAttributes) == 0x000018, "Member 'FEdgeToCreate::EdgeAttributes' has a wrong offset!");
static_assert(offsetof(FEdgeToCreate, OriginalEdgeID) == 0x000028, "Member 'FEdgeToCreate::OriginalEdgeID' has a wrong offset!");
...
public:
	...
	struct FColor                                 GbxVertexColor;                                    // 0x0018(0x0004)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                VertexNormal;                                      // 0x001C(0x000C)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                VertexTangent;                                     // 0x0028(0x000C)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         VertexBinormalSign;                                // 0x0034(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSubdividedQuadVertex) == 0x000004, "Wrong alignment on FSubdividedQuadVertex");
static_assert(sizeof(FSubdividedQuadVertex) == 0x000038, "Wrong size on FSubdividedQuadVertex");
...
static_assert(offsetof(FSubdividedQuadVertex, GbxVertexColor) == 0x000018, "Member 'FSubdividedQuadVertex::GbxVertexColor' has a wrong offset!");
static_assert(offsetof(FSubdividedQuadVertex, VertexNormal) == 0x00001C, "Member 'FSubdividedQuadVertex::VertexNormal' has a wrong offset!");
static_assert(offsetof(FSubdividedQuadVertex, VertexTangent) == 0x000028, "Member 'FSubdividedQuadVertex::VertexTangent' has a wrong offset!");
static_assert(offsetof(FSubdividedQuadVertex, VertexBinormalSign) == 0x000034, "Member 'FSubdividedQuadVertex::VertexBinormalSign' has a wrong offset!");
...
public:
	...
	struct FSubdividedQuadVertex                  QuadVertex1;                                       // 0x0038(0x0038)(BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FSubdividedQuadVertex                  QuadVertex2;                                       // 0x0070(0x0038)(BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FSubdividedQuadVertex                  QuadVertex3;                                       // 0x00A8(0x0038)(BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSubdividedQuad) == 0x000004, "Wrong alignment on FSubdividedQuad");
static_assert(sizeof(FSubdividedQuad) == 0x0000E0, "Wrong size on FSubdividedQuad");
static_assert(offsetof(FSubdividedQuad, QuadVertex0) == 0x000000, "Member 'FSubdividedQuad::QuadVertex0' has a wrong offset!");
static_assert(offsetof(FSubdividedQuad, QuadVertex1) == 0x000038, "Member 'FSubdividedQuad::QuadVertex1' has a wrong offset!");
static_assert(offsetof(FSubdividedQuad, QuadVertex2) == 0x000070, "Member 'FSubdividedQuad::QuadVertex2' has a wrong offset!");
static_assert(offsetof(FSubdividedQuad, QuadVertex3) == 0x0000A8, "Member 'FSubdividedQuad::QuadVertex3' has a wrong offset!");
