...
#include "Challenge_Manufacturer_Vladof_Bipod_classes.hpp"
#include "Challenge_Manufacturer_Vladof_Bipod_parameters.hpp"
...
void UChallenge_Manufacturer_Vladof_Bipod_C::CheckKillCondition(class UDamageComponent* DamageReceiver, struct FCausedDeathDetails& DeathDetails)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Manufacturer_Vladof_Bipod_C", "CheckKillCondition");

	Params::Challenge_Manufacturer_Vladof_Bipod_C_CheckKillCondition Parms{};
...
void UChallenge_Manufacturer_Vladof_Bipod_C::CheckForBipodUnderbarrel(class AOakWeapon* Weapon, bool* CorrectUnderbarrel)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Manufacturer_Vladof_Bipod_C", "CheckForBipodUnderbarrel");

	Params::Challenge_Manufacturer_Vladof_Bipod_C_CheckForBipodUnderbarrel Parms{};
...
void UChallenge_Manufacturer_Vladof_Bipod_C::OnInitChallengeInstance(class UChallengesComponent* OwningChallenges, class AGbxCharacter* AssociatedCharacter) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Manufacturer_Vladof_Bipod_C", "OnInitChallengeInstance");

	Params::Challenge_Manufacturer_Vladof_Bipod_C_OnInitChallengeInstance Parms{};
