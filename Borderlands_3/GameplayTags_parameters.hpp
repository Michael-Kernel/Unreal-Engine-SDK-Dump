...
static_assert(alignof(BlueprintGameplayTagLibrary_EqualEqual_GameplayTag) == 0x000008, "Wrong alignment on BlueprintGameplayTagLibrary_EqualEqual_GameplayTag");
...
static_assert(alignof(BlueprintGameplayTagLibrary_GetTagName) == 0x000008, "Wrong alignment on BlueprintGameplayTagLibrary_GetTagName");
...
static_assert(alignof(BlueprintGameplayTagLibrary_MatchesTag) == 0x000008, "Wrong alignment on BlueprintGameplayTagLibrary_MatchesTag");
...
static_assert(alignof(BlueprintGameplayTagLibrary_NotEqual_GameplayTag) == 0x000008, "Wrong alignment on BlueprintGameplayTagLibrary_NotEqual_GameplayTag");
