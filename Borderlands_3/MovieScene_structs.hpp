...
static_assert(sizeof(FMovieSceneEditorData) == 0x000090, "Wrong size on FMovieSceneEditorData");
...
static_assert(offsetof(FMovieSceneEditorData, WorkingRange) == 0x000070, "Member 'FMovieSceneEditorData::WorkingRange' has a wrong offset!");
static_assert(offsetof(FMovieSceneEditorData, ViewRange) == 0x000080, "Member 'FMovieSceneEditorData::ViewRange' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneSequencePlaybackSettings) == 0x000048, "Wrong size on FMovieSceneSequencePlaybackSettings");
...
static_assert(offsetof(FMovieSceneSequencePlaybackSettings, bPauseAtEnd) == 0x000016, "Member 'FMovieSceneSequencePlaybackSettings::bPauseAtEnd' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneSequencePlaybackSettings, bAllowUpdateRateOptimizations) == 0x000040, "Member 'FMovieSceneSequencePlaybackSettings::bAllowUpdateRateOptimizations' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneSpawnable, LevelName) == 0x000080, "Member 'FMovieSceneSpawnable::LevelName' has a wrong offset!");
