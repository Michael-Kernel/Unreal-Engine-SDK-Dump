...
#include "Proj_NPC_Explosive_Grenade_classes.hpp"
#include "Proj_NPC_Explosive_Grenade_parameters.hpp"
...
void AProj_NPC_Explosive_Grenade_C::UserConstructionScript()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Proj_NPC_Explosive_Grenade_C", "UserConstructionScript");
...
void AProj_NPC_Explosive_Grenade_C::ReceiveBeginPlay()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Proj_NPC_Explosive_Grenade_C", "ReceiveBeginPlay");
...
void AProj_NPC_Explosive_Grenade_C::OnExplode()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Proj_NPC_Explosive_Grenade_C", "OnExplode");
...
void AProj_NPC_Explosive_Grenade_C::OnBounce(const struct FHitResult& Hit, const struct FVector& ImpactVelocity)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Proj_NPC_Explosive_Grenade_C", "OnBounce");

	Params::Proj_NPC_Explosive_Grenade_C_OnBounce Parms{};
...
void AProj_NPC_Explosive_Grenade_C::HNT_Throw()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Proj_NPC_Explosive_Grenade_C", "HNT_Throw");
...
void AProj_NPC_Explosive_Grenade_C::HNT_Prime()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Proj_NPC_Explosive_Grenade_C", "HNT_Prime");
...
void AProj_NPC_Explosive_Grenade_C::HNT_Drop()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Proj_NPC_Explosive_Grenade_C", "HNT_Drop");
...
void AProj_NPC_Explosive_Grenade_C::BndEvt__MolotovMesh_K2Node_ComponentBoundEvent_5_ComponentHitSignature__DelegateSignature_Proj_PsychoMale_Shared_Molotov(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Proj_NPC_Explosive_Grenade_C", "BndEvt__MolotovMesh_K2Node_ComponentBoundEvent_5_ComponentHitSignature__DelegateSignature_Proj_PsychoMale_Shared_Molotov");

	Params::Proj_NPC_Explosive_Grenade_C_BndEvt__MolotovMesh_K2Node_ComponentBoundEvent_5_ComponentHitSignature__DelegateSignature_Proj_PsychoMale_Shared_Molotov Parms{};
...
void AProj_NPC_Explosive_Grenade_C::BndEvt__GbxProjectileMovement_K2Node_ComponentBoundEvent_4_OnProjectileStopDelegate__DelegateSignature_Proj_PsychoMale_Shared_ThrownExplosive_Grenade(const struct FHitResult& ImpactResult)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Proj_NPC_Explosive_Grenade_C", "BndEvt__GbxProjectileMovement_K2Node_ComponentBoundEvent_4_OnProjectileStopDelegate__DelegateSignature_Proj_PsychoMale_Shared_ThrownExplosive_Grenade");

	Params::Proj_NPC_Explosive_Grenade_C_BndEvt__GbxProjectileMovement_K2Node_ComponentBoundEvent_4_OnProjectileStopDelegate__DelegateSignature_Proj_PsychoMale_Shared_ThrownExplosive_Grenade Parms{};
...
void AProj_NPC_Explosive_Grenade_C::ExecuteUbergraph_Proj_NPC_Explosive_Grenade(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Proj_NPC_Explosive_Grenade_C", "ExecuteUbergraph_Proj_NPC_Explosive_Grenade");

	Params::Proj_NPC_Explosive_Grenade_C_ExecuteUbergraph_Proj_NPC_Explosive_Grenade Parms{};
