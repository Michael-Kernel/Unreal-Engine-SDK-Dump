...
#include "BP_GM_Payload_Ringer_classes.hpp"
#include "BP_GM_Payload_Ringer_parameters.hpp"
...
void UBP_GM_Payload_Ringer_C::K2_GrenadeBeginPlay(class AGrenade* Grenade, class AGrenadeMod* GrenadeMod, struct FPayloadInstanceData& InstanceData) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GM_Payload_Ringer_C", "K2_GrenadeBeginPlay");

	Params::BP_GM_Payload_Ringer_C_K2_GrenadeBeginPlay Parms{};
