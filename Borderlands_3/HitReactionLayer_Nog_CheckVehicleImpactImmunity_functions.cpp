...
#include "HitReactionLayer_Nog_CheckVehicleImpactImmunity_classes.hpp"
#include "HitReactionLayer_Nog_CheckVehicleImpactImmunity_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_Nog_CheckVehicleImpactImmunity_C::EvaluateTag(class UDamageComponent* Receiver, class UDamageCauserComponent* Causer, float DamageAmount, const class UGbxDamageType* DamageType, const class UDamageSource* DamageSource, class UHitRegionData* HitRegion, float Force, class UHitReactionTag* PreviousTag) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HitReactionLayer_Nog_CheckVehicleImpactImmunity_C", "EvaluateTag");

	Params::HitReactionLayer_Nog_CheckVehicleImpactImmunity_C_EvaluateTag Parms{};
