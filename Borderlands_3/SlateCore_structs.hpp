...
public:
	...
	struct FVector2D                              ShadowOffset;                                      // 0x0080(0x0008)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           ShadowColorAndOpacity;                             // 0x0088(0x0010)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateColor                            SelectedBackgroundColor;                           // 0x0098(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FLinearColor                           HighlightColor;                                    // 0x00C0(0x0010)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateBrush                            HighlightShape;                                    // 0x00D0(0x0088)(Edit, BlueprintVisible, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FSlateBrush                            UnderlineBrush;                                    // 0x0158(0x0088)(Edit, BlueprintVisible, AdvancedDisplay, NativeAccessSpecifierPublic)
};
static_assert(alignof(FTextBlockStyle) == 0x000008, "Wrong alignment on FTextBlockStyle");
static_assert(sizeof(FTextBlockStyle) == 0x0001E0, "Wrong size on FTextBlockStyle");
...
static_assert(offsetof(FTextBlockStyle, UnderlineBrush) == 0x000158, "Member 'FTextBlockStyle::UnderlineBrush' has a wrong offset!");
...
public:
	...
	struct FTextBlockStyle                        TextStyle;                                         // 0x0280(0x01E0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FMargin                                Padding;                                           // 0x0460(0x0010)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FHyperlinkStyle) == 0x000008, "Wrong alignment on FHyperlinkStyle");
static_assert(sizeof(FHyperlinkStyle) == 0x000470, "Wrong size on FHyperlinkStyle");
...
static_assert(offsetof(FHyperlinkStyle, Padding) == 0x000460, "Member 'FHyperlinkStyle::Padding' has a wrong offset!");
...
public:
	...
	struct FMargin                                HScrollBarPadding;                                 // 0x0300(0x0010)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                VScrollBarPadding;                                 // 0x0310(0x0010)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	struct FTextBlockStyle                        TitleTextStyle;                                    // 0x09E8(0x01E0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ActiveTitleBrush;                                  // 0x0BC8(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            InactiveTitleBrush;                                // 0x0C50(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            FlashTitleBrush;                                   // 0x0CD8(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            BackgroundColor;                                   // 0x0D60(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            OutlineBrush;                                      // 0x0D88(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            OutlineColor;                                      // 0x0E10(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BorderBrush;                                       // 0x0E38(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BackgroundBrush;                                   // 0x0EC0(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ChildBackgroundBrush;                              // 0x0F48(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWindowStyle) == 0x000008, "Wrong alignment on FWindowStyle");
static_assert(sizeof(FWindowStyle) == 0x000FD0, "Wrong size on FWindowStyle");
...
static_assert(offsetof(FWindowStyle, ActiveTitleBrush) == 0x000BC8, "Member 'FWindowStyle::ActiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, InactiveTitleBrush) == 0x000C50, "Member 'FWindowStyle::InactiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, FlashTitleBrush) == 0x000CD8, "Member 'FWindowStyle::FlashTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundColor) == 0x000D60, "Member 'FWindowStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineBrush) == 0x000D88, "Member 'FWindowStyle::OutlineBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineColor) == 0x000E10, "Member 'FWindowStyle::OutlineColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BorderBrush) == 0x000E38, "Member 'FWindowStyle::BorderBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundBrush) == 0x000EC0, "Member 'FWindowStyle::BackgroundBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, ChildBackgroundBrush) == 0x000F48, "Member 'FWindowStyle::ChildBackgroundBrush' has a wrong offset!");
...
static_assert(sizeof(FSliderStyle) == 0x000230, "Wrong size on FSliderStyle");
static_assert(offsetof(FSliderStyle, NormalBarImage) == 0x000008, "Member 'FSliderStyle::NormalBarImage' has a wrong offset!");
static_assert(offsetof(FSliderStyle, DisabledBarImage) == 0x000090, "Member 'FSliderStyle::DisabledBarImage' has a wrong offset!");
static_assert(offsetof(FSliderStyle, NormalThumbImage) == 0x000118, "Member 'FSliderStyle::NormalThumbImage' has a wrong offset!");
static_assert(offsetof(FSliderStyle, DisabledThumbImage) == 0x0001A0, "Member 'FSliderStyle::DisabledThumbImage' has a wrong offset!");
static_assert(offsetof(FSliderStyle, BarThickness) == 0x000228, "Member 'FSliderStyle::BarThickness' has a wrong offset!");
...
static_assert(sizeof(FVolumeControlStyle) == 0x0004E0, "Wrong size on FVolumeControlStyle");
...
static_assert(offsetof(FVolumeControlStyle, HighVolumeImage) == 0x000238, "Member 'FVolumeControlStyle::HighVolumeImage' has a wrong offset!");
static_assert(offsetof(FVolumeControlStyle, MidVolumeImage) == 0x0002C0, "Member 'FVolumeControlStyle::MidVolumeImage' has a wrong offset!");
static_assert(offsetof(FVolumeControlStyle, LowVolumeImage) == 0x000348, "Member 'FVolumeControlStyle::LowVolumeImage' has a wrong offset!");
static_assert(offsetof(FVolumeControlStyle, NoVolumeImage) == 0x0003D0, "Member 'FVolumeControlStyle::NoVolumeImage' has a wrong offset!");
static_assert(offsetof(FVolumeControlStyle, MutedImage) == 0x000458, "Member 'FVolumeControlStyle::MutedImage' has a wrong offset!");
...
public:
	...
	struct FMargin                                ImagePadding;                                      // 0x0A68(0x0010)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	struct FTextBlockStyle                        TextStyle;                                         // 0x07F8(0x01E0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FInlineEditableTextBlockStyle) == 0x000008, "Wrong alignment on FInlineEditableTextBlockStyle");
static_assert(sizeof(FInlineEditableTextBlockStyle) == 0x0009D8, "Wrong size on FInlineEditableTextBlockStyle");
