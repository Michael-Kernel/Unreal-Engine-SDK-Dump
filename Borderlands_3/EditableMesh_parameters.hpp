...
static_assert(alignof(EditableMesh_CreateMissingPolygonHoleEdges) == 0x000008, "Wrong alignment on EditableMesh_CreateMissingPolygonHoleEdges");
static_assert(sizeof(EditableMesh_CreateMissingPolygonHoleEdges) == 0x000018, "Wrong size on EditableMesh_CreateMissingPolygonHoleEdges");
static_assert(offsetof(EditableMesh_CreateMissingPolygonHoleEdges, PolygonID) == 0x000000, "Member 'EditableMesh_CreateMissingPolygonHoleEdges::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_CreateMissingPolygonHoleEdges, HoleNumber) == 0x000004, "Member 'EditableMesh_CreateMissingPolygonHoleEdges::HoleNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_CreateMissingPolygonHoleEdges, OutNewEdgeIDs) == 0x000008, "Member 'EditableMesh_CreateMissingPolygonHoleEdges::OutNewEdgeIDs' has a wrong offset!");
...
static_assert(alignof(EditableMesh_InsertPolygonPerimeterVertices) == 0x000008, "Wrong alignment on EditableMesh_InsertPolygonPerimeterVertices");
static_assert(sizeof(EditableMesh_InsertPolygonPerimeterVertices) == 0x000018, "Wrong size on EditableMesh_InsertPolygonPerimeterVertices");
static_assert(offsetof(EditableMesh_InsertPolygonPerimeterVertices, PolygonID) == 0x000000, "Member 'EditableMesh_InsertPolygonPerimeterVertices::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_InsertPolygonPerimeterVertices, InsertBeforeVertexNumber) == 0x000004, "Member 'EditableMesh_InsertPolygonPerimeterVertices::InsertBeforeVertexNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_InsertPolygonPerimeterVertices, VerticesToInsert) == 0x000008, "Member 'EditableMesh_InsertPolygonPerimeterVertices::VerticesToInsert' has a wrong offset!");
...
static_assert(alignof(EditableMesh_RemovePolygonPerimeterVertices) == 0x000004, "Wrong alignment on EditableMesh_RemovePolygonPerimeterVertices");
static_assert(sizeof(EditableMesh_RemovePolygonPerimeterVertices) == 0x000010, "Wrong size on EditableMesh_RemovePolygonPerimeterVertices");
static_assert(offsetof(EditableMesh_RemovePolygonPerimeterVertices, PolygonID) == 0x000000, "Member 'EditableMesh_RemovePolygonPerimeterVertices::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_RemovePolygonPerimeterVertices, FirstVertexNumberToRemove) == 0x000004, "Member 'EditableMesh_RemovePolygonPerimeterVertices::FirstVertexNumberToRemove' has a wrong offset!");
static_assert(offsetof(EditableMesh_RemovePolygonPerimeterVertices, NumVerticesToRemove) == 0x000008, "Member 'EditableMesh_RemovePolygonPerimeterVertices::NumVerticesToRemove' has a wrong offset!");
static_assert(offsetof(EditableMesh_RemovePolygonPerimeterVertices, bDeleteOrphanedVertexInstances) == 0x00000C, "Member 'EditableMesh_RemovePolygonPerimeterVertices::bDeleteOrphanedVertexInstances' has a wrong offset!");
...
static_assert(alignof(EditableMesh_SetEdgesVertices) == 0x000008, "Wrong alignment on EditableMesh_SetEdgesVertices");
static_assert(sizeof(EditableMesh_SetEdgesVertices) == 0x000010, "Wrong size on EditableMesh_SetEdgesVertices");
static_assert(offsetof(EditableMesh_SetEdgesVertices, VerticesForEdges) == 0x000000, "Member 'EditableMesh_SetEdgesVertices::VerticesForEdges' has a wrong offset!");
...
static_assert(alignof(EditableMesh_ComputeBarycentricWeightForPointOnPolygon) == 0x000004, "Wrong alignment on EditableMesh_ComputeBarycentricWeightForPointOnPolygon");
static_assert(sizeof(EditableMesh_ComputeBarycentricWeightForPointOnPolygon) == 0x00002C, "Wrong size on EditableMesh_ComputeBarycentricWeightForPointOnPolygon");
static_assert(offsetof(EditableMesh_ComputeBarycentricWeightForPointOnPolygon, PolygonID) == 0x000000, "Member 'EditableMesh_ComputeBarycentricWeightForPointOnPolygon::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_ComputeBarycentricWeightForPointOnPolygon, PointOnPolygon) == 0x000004, "Member 'EditableMesh_ComputeBarycentricWeightForPointOnPolygon::PointOnPolygon' has a wrong offset!");
static_assert(offsetof(EditableMesh_ComputeBarycentricWeightForPointOnPolygon, OutTriangle) == 0x000010, "Member 'EditableMesh_ComputeBarycentricWeightForPointOnPolygon::OutTriangle' has a wrong offset!");
static_assert(offsetof(EditableMesh_ComputeBarycentricWeightForPointOnPolygon, OutTriangleVertexWeights) == 0x00001C, "Member 'EditableMesh_ComputeBarycentricWeightForPointOnPolygon::OutTriangleVertexWeights' has a wrong offset!");
static_assert(offsetof(EditableMesh_ComputeBarycentricWeightForPointOnPolygon, ReturnValue) == 0x000028, "Member 'EditableMesh_ComputeBarycentricWeightForPointOnPolygon::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FPlane                                 ReturnValue;                                       // 0x0010(0x0010)(Parm, OutParm, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(alignof(EditableMesh_ComputePolygonTriangulation) == 0x000008, "Wrong alignment on EditableMesh_ComputePolygonTriangulation");
static_assert(sizeof(EditableMesh_ComputePolygonTriangulation) == 0x000018, "Wrong size on EditableMesh_ComputePolygonTriangulation");
static_assert(offsetof(EditableMesh_ComputePolygonTriangulation, PolygonID) == 0x000000, "Member 'EditableMesh_ComputePolygonTriangulation::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_ComputePolygonTriangulation, OutTriangles) == 0x000008, "Member 'EditableMesh_ComputePolygonTriangulation::OutTriangles' has a wrong offset!");
...
static_assert(alignof(EditableMesh_FindPolygonHoleEdgeNumberForVertices) == 0x000004, "Wrong alignment on EditableMesh_FindPolygonHoleEdgeNumberForVertices");
static_assert(sizeof(EditableMesh_FindPolygonHoleEdgeNumberForVertices) == 0x000014, "Wrong size on EditableMesh_FindPolygonHoleEdgeNumberForVertices");
static_assert(offsetof(EditableMesh_FindPolygonHoleEdgeNumberForVertices, PolygonID) == 0x000000, "Member 'EditableMesh_FindPolygonHoleEdgeNumberForVertices::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_FindPolygonHoleEdgeNumberForVertices, HoleNumber) == 0x000004, "Member 'EditableMesh_FindPolygonHoleEdgeNumberForVertices::HoleNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_FindPolygonHoleEdgeNumberForVertices, EdgeVertexID0) == 0x000008, "Member 'EditableMesh_FindPolygonHoleEdgeNumberForVertices::EdgeVertexID0' has a wrong offset!");
static_assert(offsetof(EditableMesh_FindPolygonHoleEdgeNumberForVertices, EdgeVertexID1) == 0x00000C, "Member 'EditableMesh_FindPolygonHoleEdgeNumberForVertices::EdgeVertexID1' has a wrong offset!");
static_assert(offsetof(EditableMesh_FindPolygonHoleEdgeNumberForVertices, ReturnValue) == 0x000010, "Member 'EditableMesh_FindPolygonHoleEdgeNumberForVertices::ReturnValue' has a wrong offset!");
...
static_assert(alignof(EditableMesh_FindPolygonHoleVertexNumberForVertex) == 0x000004, "Wrong alignment on EditableMesh_FindPolygonHoleVertexNumberForVertex");
static_assert(sizeof(EditableMesh_FindPolygonHoleVertexNumberForVertex) == 0x000010, "Wrong size on EditableMesh_FindPolygonHoleVertexNumberForVertex");
static_assert(offsetof(EditableMesh_FindPolygonHoleVertexNumberForVertex, PolygonID) == 0x000000, "Member 'EditableMesh_FindPolygonHoleVertexNumberForVertex::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_FindPolygonHoleVertexNumberForVertex, HoleNumber) == 0x000004, "Member 'EditableMesh_FindPolygonHoleVertexNumberForVertex::HoleNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_FindPolygonHoleVertexNumberForVertex, VertexID) == 0x000008, "Member 'EditableMesh_FindPolygonHoleVertexNumberForVertex::VertexID' has a wrong offset!");
static_assert(offsetof(EditableMesh_FindPolygonHoleVertexNumberForVertex, ReturnValue) == 0x00000C, "Member 'EditableMesh_FindPolygonHoleVertexNumberForVertex::ReturnValue' has a wrong offset!");
...
static_assert(alignof(EditableMesh_GetPolygonHoleCount) == 0x000004, "Wrong alignment on EditableMesh_GetPolygonHoleCount");
static_assert(sizeof(EditableMesh_GetPolygonHoleCount) == 0x000008, "Wrong size on EditableMesh_GetPolygonHoleCount");
static_assert(offsetof(EditableMesh_GetPolygonHoleCount, PolygonID) == 0x000000, "Member 'EditableMesh_GetPolygonHoleCount::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleCount, ReturnValue) == 0x000004, "Member 'EditableMesh_GetPolygonHoleCount::ReturnValue' has a wrong offset!");
...
static_assert(alignof(EditableMesh_GetPolygonHoleEdge) == 0x000004, "Wrong alignment on EditableMesh_GetPolygonHoleEdge");
static_assert(sizeof(EditableMesh_GetPolygonHoleEdge) == 0x000010, "Wrong size on EditableMesh_GetPolygonHoleEdge");
static_assert(offsetof(EditableMesh_GetPolygonHoleEdge, PolygonID) == 0x000000, "Member 'EditableMesh_GetPolygonHoleEdge::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleEdge, HoleNumber) == 0x000004, "Member 'EditableMesh_GetPolygonHoleEdge::HoleNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleEdge, HoleEdgeNumber) == 0x000008, "Member 'EditableMesh_GetPolygonHoleEdge::HoleEdgeNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleEdge, ReturnValue) == 0x00000C, "Member 'EditableMesh_GetPolygonHoleEdge::ReturnValue' has a wrong offset!");
...
static_assert(alignof(EditableMesh_GetPolygonHoleEdgeCount) == 0x000004, "Wrong alignment on EditableMesh_GetPolygonHoleEdgeCount");
static_assert(sizeof(EditableMesh_GetPolygonHoleEdgeCount) == 0x00000C, "Wrong size on EditableMesh_GetPolygonHoleEdgeCount");
static_assert(offsetof(EditableMesh_GetPolygonHoleEdgeCount, PolygonID) == 0x000000, "Member 'EditableMesh_GetPolygonHoleEdgeCount::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleEdgeCount, HoleNumber) == 0x000004, "Member 'EditableMesh_GetPolygonHoleEdgeCount::HoleNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleEdgeCount, ReturnValue) == 0x000008, "Member 'EditableMesh_GetPolygonHoleEdgeCount::ReturnValue' has a wrong offset!");
...
static_assert(alignof(EditableMesh_GetPolygonHoleEdges) == 0x000008, "Wrong alignment on EditableMesh_GetPolygonHoleEdges");
static_assert(sizeof(EditableMesh_GetPolygonHoleEdges) == 0x000018, "Wrong size on EditableMesh_GetPolygonHoleEdges");
static_assert(offsetof(EditableMesh_GetPolygonHoleEdges, PolygonID) == 0x000000, "Member 'EditableMesh_GetPolygonHoleEdges::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleEdges, HoleNumber) == 0x000004, "Member 'EditableMesh_GetPolygonHoleEdges::HoleNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleEdges, OutHoleEdgeIDs) == 0x000008, "Member 'EditableMesh_GetPolygonHoleEdges::OutHoleEdgeIDs' has a wrong offset!");
...
static_assert(alignof(EditableMesh_GetPolygonHoleVertex) == 0x000004, "Wrong alignment on EditableMesh_GetPolygonHoleVertex");
static_assert(sizeof(EditableMesh_GetPolygonHoleVertex) == 0x000010, "Wrong size on EditableMesh_GetPolygonHoleVertex");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertex, PolygonID) == 0x000000, "Member 'EditableMesh_GetPolygonHoleVertex::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertex, HoleNumber) == 0x000004, "Member 'EditableMesh_GetPolygonHoleVertex::HoleNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertex, PolygonVertexNumber) == 0x000008, "Member 'EditableMesh_GetPolygonHoleVertex::PolygonVertexNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertex, ReturnValue) == 0x00000C, "Member 'EditableMesh_GetPolygonHoleVertex::ReturnValue' has a wrong offset!");
...
static_assert(alignof(EditableMesh_GetPolygonHoleVertexCount) == 0x000004, "Wrong alignment on EditableMesh_GetPolygonHoleVertexCount");
static_assert(sizeof(EditableMesh_GetPolygonHoleVertexCount) == 0x00000C, "Wrong size on EditableMesh_GetPolygonHoleVertexCount");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertexCount, PolygonID) == 0x000000, "Member 'EditableMesh_GetPolygonHoleVertexCount::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertexCount, HoleNumber) == 0x000004, "Member 'EditableMesh_GetPolygonHoleVertexCount::HoleNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertexCount, ReturnValue) == 0x000008, "Member 'EditableMesh_GetPolygonHoleVertexCount::ReturnValue' has a wrong offset!");
...
static_assert(alignof(EditableMesh_GetPolygonHoleVertexInstance) == 0x000004, "Wrong alignment on EditableMesh_GetPolygonHoleVertexInstance");
static_assert(sizeof(EditableMesh_GetPolygonHoleVertexInstance) == 0x000010, "Wrong size on EditableMesh_GetPolygonHoleVertexInstance");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertexInstance, PolygonID) == 0x000000, "Member 'EditableMesh_GetPolygonHoleVertexInstance::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertexInstance, HoleNumber) == 0x000004, "Member 'EditableMesh_GetPolygonHoleVertexInstance::HoleNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertexInstance, PolygonVertexNumber) == 0x000008, "Member 'EditableMesh_GetPolygonHoleVertexInstance::PolygonVertexNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertexInstance, ReturnValue) == 0x00000C, "Member 'EditableMesh_GetPolygonHoleVertexInstance::ReturnValue' has a wrong offset!");
...
static_assert(alignof(EditableMesh_GetPolygonHoleVertexInstances) == 0x000008, "Wrong alignment on EditableMesh_GetPolygonHoleVertexInstances");
static_assert(sizeof(EditableMesh_GetPolygonHoleVertexInstances) == 0x000018, "Wrong size on EditableMesh_GetPolygonHoleVertexInstances");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertexInstances, PolygonID) == 0x000000, "Member 'EditableMesh_GetPolygonHoleVertexInstances::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertexInstances, HoleNumber) == 0x000004, "Member 'EditableMesh_GetPolygonHoleVertexInstances::HoleNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertexInstances, OutHoleVertexInstanceIDs) == 0x000008, "Member 'EditableMesh_GetPolygonHoleVertexInstances::OutHoleVertexInstanceIDs' has a wrong offset!");
...
static_assert(alignof(EditableMesh_GetPolygonHoleVertices) == 0x000008, "Wrong alignment on EditableMesh_GetPolygonHoleVertices");
static_assert(sizeof(EditableMesh_GetPolygonHoleVertices) == 0x000018, "Wrong size on EditableMesh_GetPolygonHoleVertices");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertices, PolygonID) == 0x000000, "Member 'EditableMesh_GetPolygonHoleVertices::PolygonID' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertices, HoleNumber) == 0x000004, "Member 'EditableMesh_GetPolygonHoleVertices::HoleNumber' has a wrong offset!");
static_assert(offsetof(EditableMesh_GetPolygonHoleVertices, OutHoleVertexIDs) == 0x000008, "Member 'EditableMesh_GetPolygonHoleVertices::OutHoleVertexIDs' has a wrong offset!");
...
static_assert(sizeof(EditableMesh_GetPolygonTriangulatedTriangle) == 0x000014, "Wrong size on EditableMesh_GetPolygonTriangulatedTriangle");
