...
// 0x0010 (0x0010 - 0x0000)
struct MediaPlayer_SetAudioSinkProvider final
{
public:
	TScriptInterface<class IMediaAudioSinkProviderInterface> NewSinkProvider;                                   // 0x0000(0x0010)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, NativeAccessSpecifierPublic)
};
static_assert(alignof(MediaPlayer_SetAudioSinkProvider) == 0x000008, "Wrong alignment on MediaPlayer_SetAudioSinkProvider");
static_assert(sizeof(MediaPlayer_SetAudioSinkProvider) == 0x000010, "Wrong size on MediaPlayer_SetAudioSinkProvider");
static_assert(offsetof(MediaPlayer_SetAudioSinkProvider, NewSinkProvider) == 0x000000, "Member 'MediaPlayer_SetAudioSinkProvider::NewSinkProvider' has a wrong offset!");
...
static_assert(sizeof(MediaSoundComponent_BP_GetAttenuationSettingsToApply) == 0x0002B0, "Wrong size on MediaSoundComponent_BP_GetAttenuationSettingsToApply");
...
static_assert(offsetof(MediaSoundComponent_BP_GetAttenuationSettingsToApply, ReturnValue) == 0x0002A8, "Member 'MediaSoundComponent_BP_GetAttenuationSettingsToApply::ReturnValue' has a wrong offset!");
