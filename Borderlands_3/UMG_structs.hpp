...
static_assert(sizeof(FRichTextStyleRow) == 0x0001E8, "Wrong size on FRichTextStyleRow");
...
static_assert(sizeof(FWidgetNavigationData) == 0x000028, "Wrong size on FWidgetNavigationData");
