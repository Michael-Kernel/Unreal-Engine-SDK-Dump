...
class UMission_ItsAlive2_C final : public UBP_OakMission_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Mission_ItsAlive2_C;                // 0x0510(0x0008)(Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_Mission_ItsAlive2(int32 EntryPoint);
	void Obj_ExtraReward(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_INV_LootAcidHeavy_ForWaypoint(class UObject* Context);
	void Obj_INV_LootAcidHeavy_ForWaypoint(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_INV_LootedFlashTrooper_ForWaypoint(class UObject* Context);
	void Obj_INV_LootFlashTrooper_ForWaypoint(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_INV_PowerUpSequence(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_LootedAIChip(class UObject* Context);
	void Obj_LootAIChip(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Set_LootAIChip(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void MCE_FAKELootBatteries(class UObject* Context);
	void Obj_FAKELootBatteries(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Set_FAKEBatteries(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_FAKELootHumanLegs(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_FAKELootHumanLegs(class UObject* Context);
	void Set_FAKELootHumanLegs(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_FAKELootRevolvers(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_FAKELootShotgun(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Set_FAKELootShotgun(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_FAKELootNogs(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_FAKELootJetpacks(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_PutInAIChip(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_TurnedOnPower(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_PushLoot2(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_PlaceLoot2(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_PushLoot1(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_PlaceLoot1(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_ReturnToResearchCenter(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_LootAcidHeavy(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_LootFlashTrooper(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_GoToMaliwanCamp(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Mission_ItsAlive2_C">();
	}
	static class UMission_ItsAlive2_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMission_ItsAlive2_C>();
	}
};
static_assert(alignof(UMission_ItsAlive2_C) == 0x000008, "Wrong alignment on UMission_ItsAlive2_C");
static_assert(sizeof(UMission_ItsAlive2_C) == 0x000668, "Wrong size on UMission_ItsAlive2_C");
static_assert(offsetof(UMission_ItsAlive2_C, UberGraphFrame_Mission_ItsAlive2_C) == 0x000510, "Member 'UMission_ItsAlive2_C::UberGraphFrame_Mission_ItsAlive2_C' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_GoToMaliwanCamp_ObjSetVar) == 0x000518, "Member 'UMission_ItsAlive2_C::Set_GoToMaliwanCamp_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_GoToMaliwanCamp_ObjVar) == 0x000520, "Member 'UMission_ItsAlive2_C::Obj_GoToMaliwanCamp_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_FAKELootRevolvers_ObjSetVar) == 0x000528, "Member 'UMission_ItsAlive2_C::Set_FAKELootRevolvers_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_FAKELootJetpacks_ObjSetVar) == 0x000530, "Member 'UMission_ItsAlive2_C::Set_FAKELootJetpacks_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_FAKELootJetpacks_ObjVar) == 0x000538, "Member 'UMission_ItsAlive2_C::Obj_FAKELootJetpacks_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_LootFlashTrooper_ObjSetVar) == 0x000540, "Member 'UMission_ItsAlive2_C::Set_LootFlashTrooper_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_LootFlashTrooper_ObjVar) == 0x000548, "Member 'UMission_ItsAlive2_C::Obj_LootFlashTrooper_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_FAKELootNogs_ObjSetVar) == 0x000550, "Member 'UMission_ItsAlive2_C::Set_FAKELootNogs_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_FAKELootNogs_ObjVar) == 0x000558, "Member 'UMission_ItsAlive2_C::Obj_FAKELootNogs_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_FAKELootShotgun_ObjSetVar) == 0x000560, "Member 'UMission_ItsAlive2_C::Set_FAKELootShotgun_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_FAKELootShotgun_ObjVar) == 0x000568, "Member 'UMission_ItsAlive2_C::Obj_FAKELootShotgun_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_LootAcidHeavy_ObjSetVar) == 0x000570, "Member 'UMission_ItsAlive2_C::Set_LootAcidHeavy_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_LootAcidHeavy_ObjVar) == 0x000578, "Member 'UMission_ItsAlive2_C::Obj_LootAcidHeavy_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_ReturnToResearchCenter_ObjSetVar) == 0x000580, "Member 'UMission_ItsAlive2_C::Set_ReturnToResearchCenter_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_ReturnToResearchCenter_ObjVar) == 0x000588, "Member 'UMission_ItsAlive2_C::Obj_ReturnToResearchCenter_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_PlaceLoot1_ObjSetVar) == 0x000590, "Member 'UMission_ItsAlive2_C::Set_PlaceLoot1_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_PlaceLoot1_ObjVar) == 0x000598, "Member 'UMission_ItsAlive2_C::Obj_PlaceLoot1_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_PushLoot1_ObjSetVar) == 0x0005A0, "Member 'UMission_ItsAlive2_C::Set_PushLoot1_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_PushLoot1_ObjVar) == 0x0005A8, "Member 'UMission_ItsAlive2_C::Obj_PushLoot1_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_PlaceLoot2_ObjSetVar) == 0x0005B0, "Member 'UMission_ItsAlive2_C::Set_PlaceLoot2_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_PlaceLoot2_ObjVar) == 0x0005B8, "Member 'UMission_ItsAlive2_C::Obj_PlaceLoot2_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_PushLoot2_ObjSetVar) == 0x0005C0, "Member 'UMission_ItsAlive2_C::Set_PushLoot2_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_PushLoot2_ObjVar) == 0x0005C8, "Member 'UMission_ItsAlive2_C::Obj_PushLoot2_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_TurnOnPower_ObjSetVar) == 0x0005D0, "Member 'UMission_ItsAlive2_C::Set_TurnOnPower_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_TurnedOnPower_ObjVar) == 0x0005D8, "Member 'UMission_ItsAlive2_C::Obj_TurnedOnPower_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_PutInAIChip_ObjSetVar) == 0x0005E0, "Member 'UMission_ItsAlive2_C::Set_PutInAIChip_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_PutInAIChip_ObjVar) == 0x0005E8, "Member 'UMission_ItsAlive2_C::Obj_PutInAIChip_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_KillBot_ObjSetVar) == 0x0005F0, "Member 'UMission_ItsAlive2_C::Set_KillBot_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_KillBot_ObjVar) == 0x0005F8, "Member 'UMission_ItsAlive2_C::Obj_KillBot_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_FAKELootRevolvers_ObjVar) == 0x000600, "Member 'UMission_ItsAlive2_C::Obj_FAKELootRevolvers_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_FAKELootHumanLegs_ObjSetVar) == 0x000608, "Member 'UMission_ItsAlive2_C::Set_FAKELootHumanLegs_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_FAKELootHumanLegs_ObjVar) == 0x000610, "Member 'UMission_ItsAlive2_C::Obj_FAKELootHumanLegs_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_FAKEBatteries_ObjSetVar) == 0x000618, "Member 'UMission_ItsAlive2_C::Set_FAKEBatteries_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_FAKELootBatteries_ObjVar) == 0x000620, "Member 'UMission_ItsAlive2_C::Obj_FAKELootBatteries_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Set_LootAIChip_ObjSetVar) == 0x000628, "Member 'UMission_ItsAlive2_C::Set_LootAIChip_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_LootAIChip_ObjVar) == 0x000630, "Member 'UMission_ItsAlive2_C::Obj_LootAIChip_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_INV_PowerUpSequence_ObjVar) == 0x000638, "Member 'UMission_ItsAlive2_C::Obj_INV_PowerUpSequence_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_INV_LootFlashTrooper_ForWaypoint_ObjVar) == 0x000640, "Member 'UMission_ItsAlive2_C::Obj_INV_LootFlashTrooper_ForWaypoint_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_INV_LootAcidHeavy_ForWaypoint_ObjVar) == 0x000648, "Member 'UMission_ItsAlive2_C::Obj_INV_LootAcidHeavy_ForWaypoint_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, CombatConversation) == 0x000650, "Member 'UMission_ItsAlive2_C::CombatConversation' has a wrong offset!");
static_assert(offsetof(UMission_ItsAlive2_C, Obj_ExtraReward_ObjVar) == 0x000660, "Member 'UMission_ItsAlive2_C::Obj_ExtraReward_ObjVar' has a wrong offset!");
