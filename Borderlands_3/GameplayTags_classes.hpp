...
static_assert(sizeof(UGameplayTagsManager) == 0x000190, "Wrong size on UGameplayTagsManager");
...
static_assert(offsetof(UGameplayTagsManager, RestrictedGameplayTagTables) == 0x000120, "Member 'UGameplayTagsManager::RestrictedGameplayTagTables' has a wrong offset!");
static_assert(offsetof(UGameplayTagsManager, GameplayTagTables) == 0x000130, "Member 'UGameplayTagsManager::GameplayTagTables' has a wrong offset!");
...
static_assert(sizeof(UGameplayTagsSettings) == 0x0000B0, "Wrong size on UGameplayTagsSettings");
...
static_assert(offsetof(UGameplayTagsSettings, RestrictedConfigFiles) == 0x0000A0, "Member 'UGameplayTagsSettings::RestrictedConfigFiles' has a wrong offset!");
