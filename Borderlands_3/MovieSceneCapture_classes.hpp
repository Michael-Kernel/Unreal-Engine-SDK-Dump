...
public:
	...
	uint8                                         Pad_C0[0x120];                                     // 0x00C0(0x0120)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneCapture) == 0x0001E0, "Wrong size on UMovieSceneCapture");
...
public:
	...
	uint8                                         Pad_1E1[0xB];                                      // 0x01E1(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULevelCapture) == 0x000200, "Wrong size on ULevelCapture");
static_assert(offsetof(ULevelCapture, bAutoStartCapture) == 0x0001E0, "Member 'ULevelCapture::bAutoStartCapture' has a wrong offset!");
static_assert(offsetof(ULevelCapture, PrerequisiteActorId) == 0x0001EC, "Member 'ULevelCapture::PrerequisiteActorId' has a wrong offset!");
