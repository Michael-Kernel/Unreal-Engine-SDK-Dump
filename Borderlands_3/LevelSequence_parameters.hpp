...
static_assert(sizeof(LevelSequencePlayer_CreateLevelSequencePlayer) == 0x000068, "Wrong size on LevelSequencePlayer_CreateLevelSequencePlayer");
...
static_assert(offsetof(LevelSequencePlayer_CreateLevelSequencePlayer, OutActor) == 0x000058, "Member 'LevelSequencePlayer_CreateLevelSequencePlayer::OutActor' has a wrong offset!");
static_assert(offsetof(LevelSequencePlayer_CreateLevelSequencePlayer, ReturnValue) == 0x000060, "Member 'LevelSequencePlayer_CreateLevelSequencePlayer::ReturnValue' has a wrong offset!");
