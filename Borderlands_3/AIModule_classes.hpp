...
{
public:
	uint8                                         Pad_508[0x38];                                     // 0x0508(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bStopAILogicOnUnposses : 1;                        // 0x0540(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bLOSflag : 1;                                      // 0x0540(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSkipExtraLOSChecks : 1;                           // 0x0540(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAllowStrafe : 1;                                  // 0x0540(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bWantsPlayerState : 1;                             // 0x0540(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSetControlRotationFromPawnOrientation : 1;        // 0x0540(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	TSubclassOf<class UNavigationQueryFilter>     DefaultNavigationFilterClass;                      // 0x0578(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	UMulticastDelegateProperty_                   ReceiveMoveCompleted;                              // 0x0580(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAIController) == 0x000598, "Wrong size on AAIController");
static_assert(offsetof(AAIController, PathFollowingComponent) == 0x000548, "Member 'AAIController::PathFollowingComponent' has a wrong offset!");
static_assert(offsetof(AAIController, BrainComponent) == 0x000550, "Member 'AAIController::BrainComponent' has a wrong offset!");
static_assert(offsetof(AAIController, PerceptionComponent) == 0x000558, "Member 'AAIController::PerceptionComponent' has a wrong offset!");
static_assert(offsetof(AAIController, ActionsComp) == 0x000560, "Member 'AAIController::ActionsComp' has a wrong offset!");
static_assert(offsetof(AAIController, Blackboard) == 0x000568, "Member 'AAIController::Blackboard' has a wrong offset!");
static_assert(offsetof(AAIController, CachedGameplayTasksComponent) == 0x000570, "Member 'AAIController::CachedGameplayTasksComponent' has a wrong offset!");
static_assert(offsetof(AAIController, DefaultNavigationFilterClass) == 0x000578, "Member 'AAIController::DefaultNavigationFilterClass' has a wrong offset!");
static_assert(offsetof(AAIController, ReceiveMoveCompleted) == 0x000580, "Member 'AAIController::ReceiveMoveCompleted' has a wrong offset!");
...
static_assert(sizeof(AGridPathAIController) == 0x000598, "Wrong size on AGridPathAIController");
...
static_assert(sizeof(UEnvQueryNode) == 0x000040, "Wrong size on UEnvQueryNode");
static_assert(offsetof(UEnvQueryNode, VerNum) == 0x000028, "Member 'UEnvQueryNode::VerNum' has a wrong offset!");
static_assert(offsetof(UEnvQueryNode, ContextTypes) == 0x000030, "Member 'UEnvQueryNode::ContextTypes' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UEnvQueryItemType>          ItemType;                                          // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bAutoSortTests : 1;                                // 0x0058(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(UEnvQueryGenerator) == 0x000060, "Wrong size on UEnvQueryGenerator");
static_assert(offsetof(UEnvQueryGenerator, OptionName) == 0x000040, "Member 'UEnvQueryGenerator::OptionName' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator, ItemType) == 0x000050, "Member 'UEnvQueryGenerator::ItemType' has a wrong offset!");
...
static_assert(offsetof(UEnvQueryGenerator_ProjectedPoints, ProjectionData) == 0x000060, "Member 'UEnvQueryGenerator_ProjectedPoints::ProjectionData' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_ProjectedPoints, bCaresAboutHotSpots) == 0x000090, "Member 'UEnvQueryGenerator_ProjectedPoints::bCaresAboutHotSpots' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryGenerator_PathingGrid) == 0x000168, "Wrong size on UEnvQueryGenerator_PathingGrid");
...
public:
	...
	uint8                                         Pad_E4[0x9C];                                      // 0x00E4(0x009C)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAIPerceptionSystem) == 0x0001E0, "Wrong size on UAIPerceptionSystem");
static_assert(offsetof(UAIPerceptionSystem, Senses) == 0x0000D0, "Member 'UAIPerceptionSystem::Senses' has a wrong offset!");
static_assert(offsetof(UAIPerceptionSystem, PerceptionAgingRate) == 0x0000E0, "Member 'UAIPerceptionSystem::PerceptionAgingRate' has a wrong offset!");
static_assert(offsetof(UAIPerceptionSystem, PerceptionSourceWhitelist) == 0x000180, "Member 'UAIPerceptionSystem::PerceptionSourceWhitelist' has a wrong offset!");
static_assert(offsetof(UAIPerceptionSystem, PerceptionSourceBlacklist) == 0x000190, "Member 'UAIPerceptionSystem::PerceptionSourceBlacklist' has a wrong offset!");
static_assert(offsetof(UAIPerceptionSystem, MustHaveAssociatedCharacter) == 0x0001A0, "Member 'UAIPerceptionSystem::MustHaveAssociatedCharacter' has a wrong offset!");
...
static_assert(sizeof(UBrainComponent) == 0x0001D8, "Wrong size on UBrainComponent");
static_assert(offsetof(UBrainComponent, BlackboardComp) == 0x000180, "Member 'UBrainComponent::BlackboardComp' has a wrong offset!");
static_assert(offsetof(UBrainComponent, AIOwner) == 0x000188, "Member 'UBrainComponent::AIOwner' has a wrong offset!");
...
static_assert(sizeof(UAISense) == 0x000098, "Wrong size on UAISense");
...
public:
	...
	TSubclassOf<class UNavigationQueryFilter>     FilterClass;                                       // 0x00A0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         bObserveBlackboardValue : 1;                       // 0x00AC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bAllowStrafe : 1;                                  // 0x00AC(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bAllowPartialPath : 1;                             // 0x00AC(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bTrackMovingGoal : 1;                              // 0x00AC(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bProjectGoalLocation : 1;                          // 0x00AC(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bReachTestIncludesAgentRadius : 1;                 // 0x00AC(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bReachTestIncludesGoalRadius : 1;                  // 0x00AC(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bStopOnOverlap : 1;                                // 0x00AC(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (Edit, DisableEditOnTemplate, EditConst, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bStopOnOverlapNeedsUpdate : 1;                     // 0x00AD(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
{
public:
	int32                                         TestOrder;                                         // 0x0040(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_1B9[0xF];                                      // 0x01B9(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bWorkOnFloatValues : 1;                            // 0x01C8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(UEnvQueryTest) == 0x0001D8, "Wrong size on UEnvQueryTest");
static_assert(offsetof(UEnvQueryTest, TestOrder) == 0x000040, "Member 'UEnvQueryTest::TestOrder' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, TestPurpose) == 0x000044, "Member 'UEnvQueryTest::TestPurpose' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, TestComment) == 0x000048, "Member 'UEnvQueryTest::TestComment' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, MultipleContextFilterOp) == 0x000058, "Member 'UEnvQueryTest::MultipleContextFilterOp' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, MultipleContextScoreOp) == 0x000059, "Member 'UEnvQueryTest::MultipleContextScoreOp' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, FilterType) == 0x00005A, "Member 'UEnvQueryTest::FilterType' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, BoolValue) == 0x000060, "Member 'UEnvQueryTest::BoolValue' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, FloatValueMin) == 0x000090, "Member 'UEnvQueryTest::FloatValueMin' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, FloatValueMax) == 0x0000C0, "Member 'UEnvQueryTest::FloatValueMax' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ScoringEquation) == 0x0000F1, "Member 'UEnvQueryTest::ScoringEquation' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ClampMinType) == 0x0000F2, "Member 'UEnvQueryTest::ClampMinType' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ClampMaxType) == 0x0000F3, "Member 'UEnvQueryTest::ClampMaxType' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, NormalizationType) == 0x0000F4, "Member 'UEnvQueryTest::NormalizationType' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ScoreClampMin) == 0x0000F8, "Member 'UEnvQueryTest::ScoreClampMin' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ScoreClampMax) == 0x000128, "Member 'UEnvQueryTest::ScoreClampMax' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ScoringFactor) == 0x000158, "Member 'UEnvQueryTest::ScoringFactor' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, ReferenceValue) == 0x000188, "Member 'UEnvQueryTest::ReferenceValue' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, bDefineReferenceValue) == 0x0001B8, "Member 'UEnvQueryTest::bDefineReferenceValue' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest, CopiedFrom) == 0x0001D0, "Member 'UEnvQueryTest::CopiedFrom' has a wrong offset!");
...
public:
	...
	int32                                         StepToDebugDraw;                                   // 0x0934(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         bDrawLabels : 1;                                   // 0x093C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDrawFailedItems : 1;                              // 0x093C(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReRunQueryOnlyOnFinishedMove : 1;                 // 0x093C(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bShouldBeVisibleInGame : 1;                        // 0x093C(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bTickDuringGame : 1;                               // 0x093C(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	uint8                                         bDrawTraces : 1;                                   // 0x0978(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_979[0x27];                                     // 0x0979(0x0027)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AEQSTestingPawn) == 0x0009A0, "Wrong size on AEQSTestingPawn");
static_assert(offsetof(AEQSTestingPawn, QueryTemplate) == 0x0008B8, "Member 'AEQSTestingPawn::QueryTemplate' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryParams) == 0x0008C0, "Member 'AEQSTestingPawn::QueryParams' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryConfig) == 0x0008D0, "Member 'AEQSTestingPawn::QueryConfig' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryContexts) == 0x0008E0, "Member 'AEQSTestingPawn::QueryContexts' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, TimeLimitPerStep) == 0x000930, "Member 'AEQSTestingPawn::TimeLimitPerStep' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, StepToDebugDraw) == 0x000934, "Member 'AEQSTestingPawn::StepToDebugDraw' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, HighlightMode) == 0x000938, "Member 'AEQSTestingPawn::HighlightMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryingMode) == 0x000940, "Member 'AEQSTestingPawn::QueryingMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, NavAgentProperties) == 0x000948, "Member 'AEQSTestingPawn::NavAgentProperties' has a wrong offset!");
...
static_assert(sizeof(UAISense_Hearing) == 0x000100, "Wrong size on UAISense_Hearing");
static_assert(offsetof(UAISense_Hearing, NoiseEvents) == 0x000098, "Member 'UAISense_Hearing::NoiseEvents' has a wrong offset!");
static_assert(offsetof(UAISense_Hearing, SpeedOfSoundSq) == 0x0000A8, "Member 'UAISense_Hearing::SpeedOfSoundSq' has a wrong offset!");
...
static_assert(sizeof(UAISenseBlueprintListener) == 0x0000E0, "Wrong size on UAISenseBlueprintListener");
...
static_assert(offsetof(UBTService_RunEQS, bClearEntryOnFailure) == 0x0000F0, "Member 'UBTService_RunEQS::bClearEntryOnFailure' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Overlap) == 0x0001F8, "Wrong size on UEnvQueryTest_Overlap");
...
{
public:
	uint8                                         bAutoRegisterAsSource : 1;                         // 0x0178(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, Config, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_179[0x7];                                      // 0x0179(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class UAISense>>           RegisterAsSourceForSenses;                         // 0x0180(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAIPerceptionStimuliSourceComponent) == 0x000190, "Wrong size on UAIPerceptionStimuliSourceComponent");
static_assert(offsetof(UAIPerceptionStimuliSourceComponent, RegisterAsSourceForSenses) == 0x000180, "Member 'UAIPerceptionStimuliSourceComponent::RegisterAsSourceForSenses' has a wrong offset!");
...
static_assert(sizeof(UBehaviorTreeComponent) == 0x000328, "Wrong size on UBehaviorTreeComponent");
static_assert(offsetof(UBehaviorTreeComponent, NodeInstances) == 0x0001F8, "Member 'UBehaviorTreeComponent::NodeInstances' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Trace) == 0x0002A0, "Wrong size on UEnvQueryTest_Trace");
...
static_assert(sizeof(UAISystem) == 0x000128, "Wrong size on UAISystem");
static_assert(offsetof(UAISystem, PerceptionSystemClassName) == 0x000050, "Member 'UAISystem::PerceptionSystemClassName' has a wrong offset!");
static_assert(offsetof(UAISystem, HotSpotManagerClassName) == 0x000068, "Member 'UAISystem::HotSpotManagerClassName' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UAISense>                   DominantSense;                                     // 0x0188(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TScriptInterface<class IGenericTeamAgentInterface> OwnerTeamAgent;                                    // 0x01A8(0x0010)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_1BD[0x7B];                                     // 0x01BD(0x007B)(Fixing Size After Last Property [ Dumper-7 ])
	UMulticastDelegateProperty_                   OnPerceptionUpdated;                               // 0x0238(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastDelegateProperty_                   OnTargetPerceptionUpdated;                         // 0x0248(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAIPerceptionComponent) == 0x000270, "Wrong size on UAIPerceptionComponent");
static_assert(offsetof(UAIPerceptionComponent, SensesConfig) == 0x000178, "Member 'UAIPerceptionComponent::SensesConfig' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, DominantSense) == 0x000188, "Member 'UAIPerceptionComponent::DominantSense' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, AIOwner) == 0x0001A0, "Member 'UAIPerceptionComponent::AIOwner' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OwnerTeamAgent) == 0x0001A8, "Member 'UAIPerceptionComponent::OwnerTeamAgent' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, bOwnerIsStationary) == 0x0001BC, "Member 'UAIPerceptionComponent::bOwnerIsStationary' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OnPerceptionUpdated) == 0x000238, "Member 'UAIPerceptionComponent::OnPerceptionUpdated' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OnTargetPerceptionUpdated) == 0x000248, "Member 'UAIPerceptionComponent::OnTargetPerceptionUpdated' has a wrong offset!");
...
{
public:
	TSubclassOf<class UUserDefinedStruct>         ListenerDataType;                                  // 0x0098(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAISense_Blueprint) == 0x0000C0, "Wrong size on UAISense_Blueprint");
static_assert(offsetof(UAISense_Blueprint, ListenerDataType) == 0x000098, "Member 'UAISense_Blueprint::ListenerDataType' has a wrong offset!");
static_assert(offsetof(UAISense_Blueprint, ListenerContainer) == 0x0000A0, "Member 'UAISense_Blueprint::ListenerContainer' has a wrong offset!");
static_assert(offsetof(UAISense_Blueprint, UnprocessedEvents) == 0x0000B0, "Member 'UAISense_Blueprint::UnprocessedEvents' has a wrong offset!");
...
static_assert(sizeof(UAISense_Damage) == 0x0000A8, "Wrong size on UAISense_Damage");
static_assert(offsetof(UAISense_Damage, RegisteredEvents) == 0x000098, "Member 'UAISense_Damage::RegisteredEvents' has a wrong offset!");
...
static_assert(sizeof(UAISense_Prediction) == 0x0000A8, "Wrong size on UAISense_Prediction");
static_assert(offsetof(UAISense_Prediction, RegisteredEvents) == 0x000098, "Member 'UAISense_Prediction::RegisteredEvents' has a wrong offset!");
...
{
public:
	uint8                                         Pad_98[0xB0];                                      // 0x0098(0x00B0)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAISense_Team) == 0x0000A8, "Wrong size on UAISense_Team");
static_assert(offsetof(UAISense_Team, RegisteredEvents) == 0x000098, "Member 'UAISense_Team::RegisteredEvents' has a wrong offset!");
...
static_assert(sizeof(UAISense_Touch) == 0x0000A8, "Wrong size on UAISense_Touch");
static_assert(offsetof(UAISense_Touch, RegisteredEvents) == 0x000098, "Member 'UAISense_Touch::RegisteredEvents' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1B8[0xB8];                                     // 0x01B8(0x00B8)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool HasValue(const class FName& KeyName) const;
...
static_assert(sizeof(UBlackboardComponent) == 0x000280, "Wrong size on UBlackboardComponent");
static_assert(offsetof(UBlackboardComponent, BrainComp) == 0x000178, "Member 'UBlackboardComponent::BrainComp' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, BlackboardAsset) == 0x000180, "Member 'UBlackboardComponent::BlackboardAsset' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, KeyInstances) == 0x0001A8, "Member 'UBlackboardComponent::KeyInstances' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, RuntimeKeys) == 0x000270, "Member 'UBlackboardComponent::RuntimeKeys' has a wrong offset!");
...
static_assert(offsetof(UBlackboardKeyType_Bool, DefaultValue) == 0x000030, "Member 'UBlackboardKeyType_Bool::DefaultValue' has a wrong offset!");
...
static_assert(offsetof(UBlackboardKeyType_Float, DefaultValue) == 0x000030, "Member 'UBlackboardKeyType_Float::DefaultValue' has a wrong offset!");
...
{
public:
	int32                                         DefaultValue;                                      // 0x0030(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UBlackboardKeyType_Int, DefaultValue) == 0x000030, "Member 'UBlackboardKeyType_Int::DefaultValue' has a wrong offset!");
...
static_assert(offsetof(UBlackboardKeyType_Name, DefaultValue) == 0x000030, "Member 'UBlackboardKeyType_Name::DefaultValue' has a wrong offset!");
...
static_assert(sizeof(UBlackboardKeyType_Rotator) == 0x000040, "Wrong size on UBlackboardKeyType_Rotator");
static_assert(offsetof(UBlackboardKeyType_Rotator, DefaultValue) == 0x000030, "Member 'UBlackboardKeyType_Rotator::DefaultValue' has a wrong offset!");
static_assert(offsetof(UBlackboardKeyType_Rotator, bUseDefaultValue) == 0x00003C, "Member 'UBlackboardKeyType_Rotator::bUseDefaultValue' has a wrong offset!");
...
static_assert(sizeof(UBlackboardKeyType_String) == 0x000050, "Wrong size on UBlackboardKeyType_String");
...
static_assert(offsetof(UBlackboardKeyType_String, DefaultValue) == 0x000040, "Member 'UBlackboardKeyType_String::DefaultValue' has a wrong offset!");
...
static_assert(sizeof(UBlackboardKeyType_Vector) == 0x000040, "Wrong size on UBlackboardKeyType_Vector");
static_assert(offsetof(UBlackboardKeyType_Vector, DefaultValue) == 0x000030, "Member 'UBlackboardKeyType_Vector::DefaultValue' has a wrong offset!");
static_assert(offsetof(UBlackboardKeyType_Vector, bUseDefaultValue) == 0x00003C, "Member 'UBlackboardKeyType_Vector::bUseDefaultValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1E0[0x170];                                    // 0x01E0(0x0170)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPathFollowingComponent) == 0x000350, "Wrong size on UPathFollowingComponent");
static_assert(offsetof(UPathFollowingComponent, MovementComp) == 0x0001C8, "Member 'UPathFollowingComponent::MovementComp' has a wrong offset!");
static_assert(offsetof(UPathFollowingComponent, MyNavData) == 0x0001D8, "Member 'UPathFollowingComponent::MyNavData' has a wrong offset!");
...
static_assert(sizeof(UCrowdFollowingComponent) == 0x0003A0, "Wrong size on UCrowdFollowingComponent");
...
static_assert(offsetof(UCrowdFollowingComponent, CharacterMovement) == 0x000368, "Member 'UCrowdFollowingComponent::CharacterMovement' has a wrong offset!");
static_assert(offsetof(UCrowdFollowingComponent, AvoidanceGroup) == 0x000370, "Member 'UCrowdFollowingComponent::AvoidanceGroup' has a wrong offset!");
static_assert(offsetof(UCrowdFollowingComponent, GroupsToAvoid) == 0x000374, "Member 'UCrowdFollowingComponent::GroupsToAvoid' has a wrong offset!");
static_assert(offsetof(UCrowdFollowingComponent, GroupsToIgnore) == 0x000378, "Member 'UCrowdFollowingComponent::GroupsToIgnore' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_71[0x67];                                      // 0x0071(0x0067)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCrowdManager) == 0x0000D8, "Wrong size on UCrowdManager");
...
static_assert(sizeof(ADetourCrowdAIController) == 0x000598, "Wrong size on ADetourCrowdAIController");
...
static_assert(sizeof(UEnvQuery) == 0x000098, "Wrong size on UEnvQuery");
...
static_assert(offsetof(UEnvQuery, ContextTypes) == 0x000048, "Member 'UEnvQuery::ContextTypes' has a wrong offset!");
...
{
public:
	TSubclassOf<class AActor>                     SearchedActorClass;                                // 0x0060(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UEnvQueryGenerator_ActorsOfClass, SearchedActorClass) == 0x000060, "Member 'UEnvQueryGenerator_ActorsOfClass::SearchedActorClass' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_ActorsOfClass, GenerateOnlyActorsInRadius) == 0x000068, "Member 'UEnvQueryGenerator_ActorsOfClass::GenerateOnlyActorsInRadius' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_ActorsOfClass, SearchRadius) == 0x000098, "Member 'UEnvQueryGenerator_ActorsOfClass::SearchRadius' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UEnvQueryContext>           Context;                                           // 0x0078(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UEnvQueryItemType>          GeneratedItemType;                                 // 0x0080(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UEnvQueryGenerator_BlueprintBase, GeneratorsActionDescription) == 0x000060, "Member 'UEnvQueryGenerator_BlueprintBase::GeneratorsActionDescription' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_BlueprintBase, Context) == 0x000078, "Member 'UEnvQueryGenerator_BlueprintBase::Context' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_BlueprintBase, GeneratedItemType) == 0x000080, "Member 'UEnvQueryGenerator_BlueprintBase::GeneratedItemType' has a wrong offset!");
...
public:
	...
	uint8                                         bAllowDifferentItemTypes : 1;                      // 0x0070(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHasMatchingItemType : 1;                          // 0x0070(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_71[0x7];                                       // 0x0071(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UEnvQueryItemType>          ForcedItemType;                                    // 0x0078(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEnvQueryGenerator_Composite) == 0x000080, "Wrong size on UEnvQueryGenerator_Composite");
static_assert(offsetof(UEnvQueryGenerator_Composite, Generators) == 0x000060, "Member 'UEnvQueryGenerator_Composite::Generators' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Composite, ForcedItemType) == 0x000078, "Member 'UEnvQueryGenerator_Composite::ForcedItemType' has a wrong offset!");
...
{
public:
	TSubclassOf<class UEnvQueryContext>           QueryContext;                                      // 0x0060(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UEnvQueryGenerator_CurrentLocation) == 0x000068, "Wrong size on UEnvQueryGenerator_CurrentLocation");
static_assert(offsetof(UEnvQueryGenerator_CurrentLocation, QueryContext) == 0x000060, "Member 'UEnvQueryGenerator_CurrentLocation::QueryContext' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UEnvQueryContext>           Center;                                            // 0x01B0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bDefineArc : 1;                                    // 0x01B8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(UEnvQueryGenerator_Donut) == 0x000250, "Wrong size on UEnvQueryGenerator_Donut");
...
static_assert(offsetof(UEnvQueryGenerator_Donut, ArcAngle) == 0x000178, "Member 'UEnvQueryGenerator_Donut::ArcAngle' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, bUseSpiralPattern) == 0x0001A8, "Member 'UEnvQueryGenerator_Donut::bUseSpiralPattern' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, Center) == 0x0001B0, "Member 'UEnvQueryGenerator_Donut::Center' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, NumberOfLayers) == 0x0001C0, "Member 'UEnvQueryGenerator_Donut::NumberOfLayers' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, HighestLayerHeight) == 0x0001F0, "Member 'UEnvQueryGenerator_Donut::HighestLayerHeight' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_Donut, LowestLayerHeight) == 0x000220, "Member 'UEnvQueryGenerator_Donut::LowestLayerHeight' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UEnvQueryContext>           CircleCenter;                                      // 0x0188(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEnvQueryGenerator_OnCircle) == 0x000200, "Wrong size on UEnvQueryGenerator_OnCircle");
...
static_assert(offsetof(UEnvQueryGenerator_OnCircle, AngleRadians) == 0x000180, "Member 'UEnvQueryGenerator_OnCircle::AngleRadians' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, CircleCenter) == 0x000188, "Member 'UEnvQueryGenerator_OnCircle::CircleCenter' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, bIgnoreAnyContextActorsWhenGeneratingCircle) == 0x000190, "Member 'UEnvQueryGenerator_OnCircle::bIgnoreAnyContextActorsWhenGeneratingCircle' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, CircleCenterZOffset) == 0x000198, "Member 'UEnvQueryGenerator_OnCircle::CircleCenterZOffset' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, TraceData) == 0x0001C8, "Member 'UEnvQueryGenerator_OnCircle::TraceData' has a wrong offset!");
...
// 0x0000 (0x0030 - 0x0030)
class UEnvQueryItemType_Component final : public UEnvQueryItemType_ActorBase
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"EnvQueryItemType_Component">();
	}
...
static_assert(alignof(UEnvQueryItemType_Component) == 0x000008, "Wrong alignment on UEnvQueryItemType_Component");
static_assert(sizeof(UEnvQueryItemType_Component) == 0x000030, "Wrong size on UEnvQueryItemType_Component");
...
static_assert(offsetof(UEnvQueryManager, InstanceCache) == 0x0000A0, "Member 'UEnvQueryManager::InstanceCache' has a wrong offset!");
static_assert(offsetof(UEnvQueryManager, AdditionalTestsCache) == 0x0000B0, "Member 'UEnvQueryManager::AdditionalTestsCache' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Distance) == 0x0001F0, "Wrong size on UEnvQueryTest_Distance");
...
static_assert(offsetof(UEnvQueryTest_Distance, DistanceThreshold) == 0x0001E8, "Member 'UEnvQueryTest_Distance::DistanceThreshold' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Dot) == 0x000220, "Wrong size on UEnvQueryTest_Dot");
static_assert(offsetof(UEnvQueryTest_Dot, LineA) == 0x0001D8, "Member 'UEnvQueryTest_Dot::LineA' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, LineB) == 0x0001F8, "Member 'UEnvQueryTest_Dot::LineB' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, TestMode) == 0x000218, "Member 'UEnvQueryTest_Dot::TestMode' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, bAbsoluteValue) == 0x000219, "Member 'UEnvQueryTest_Dot::bAbsoluteValue' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_GameplayTags) == 0x000248, "Wrong size on UEnvQueryTest_GameplayTags");
...
static_assert(offsetof(UEnvQueryTest_GameplayTags, bPassIfNoTags) == 0x000220, "Member 'UEnvQueryTest_GameplayTags::bPassIfNoTags' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, bUpdatedToUseQuery) == 0x000221, "Member 'UEnvQueryTest_GameplayTags::bUpdatedToUseQuery' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, TagsToMatch) == 0x000222, "Member 'UEnvQueryTest_GameplayTags::TagsToMatch' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Pathfinding) == 0x000250, "Wrong size on UEnvQueryTest_Pathfinding");
...
static_assert(sizeof(UEnvQueryTest_PathfindingBatch) == 0x000280, "Wrong size on UEnvQueryTest_PathfindingBatch");
...
static_assert(sizeof(UEnvQueryTest_Project) == 0x000208, "Wrong size on UEnvQueryTest_Project");
...
static_assert(sizeof(UEnvQueryTest_Random) == 0x0001D8, "Wrong size on UEnvQueryTest_Random");
...
static_assert(sizeof(UEQSRenderingComponent) == 0x000730, "Wrong size on UEQSRenderingComponent");
...
static_assert(sizeof(UGridPathFollowingComponent) == 0x000380, "Wrong size on UGridPathFollowingComponent");
static_assert(offsetof(UGridPathFollowingComponent, GridManager) == 0x000350, "Member 'UGridPathFollowingComponent::GridManager' has a wrong offset!");
...
public:
	...
	UMulticastDelegateProperty_                   OnSmartLinkReached;                                // 0x0498(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ANavLinkProxy) == 0x0004A8, "Wrong size on ANavLinkProxy");
static_assert(offsetof(ANavLinkProxy, PointLinks) == 0x000468, "Member 'ANavLinkProxy::PointLinks' has a wrong offset!");
static_assert(offsetof(ANavLinkProxy, SegmentLinks) == 0x000478, "Member 'ANavLinkProxy::SegmentLinks' has a wrong offset!");
static_assert(offsetof(ANavLinkProxy, SmartLinkComp) == 0x000488, "Member 'ANavLinkProxy::SmartLinkComp' has a wrong offset!");
static_assert(offsetof(ANavLinkProxy, bSmartLinkIsRelevant) == 0x000490, "Member 'ANavLinkProxy::bSmartLinkIsRelevant' has a wrong offset!");
static_assert(offsetof(ANavLinkProxy, OnSmartLinkReached) == 0x000498, "Member 'ANavLinkProxy::OnSmartLinkReached' has a wrong offset!");
...
static_assert(sizeof(UPawnActionsComponent) == 0x0001B0, "Wrong size on UPawnActionsComponent");
static_assert(offsetof(UPawnActionsComponent, ControlledPawn) == 0x000178, "Member 'UPawnActionsComponent::ControlledPawn' has a wrong offset!");
static_assert(offsetof(UPawnActionsComponent, ActionStacks) == 0x000180, "Member 'UPawnActionsComponent::ActionStacks' has a wrong offset!");
static_assert(offsetof(UPawnActionsComponent, ActionEvents) == 0x000190, "Member 'UPawnActionsComponent::ActionEvents' has a wrong offset!");
static_assert(offsetof(UPawnActionsComponent, CurrentAction) == 0x0001A0, "Member 'UPawnActionsComponent::CurrentAction' has a wrong offset!");
...
public:
	...
	uint8                                         bEnableSensingUpdates : 1;                         // 0x018C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOnlySensePlayers : 1;                             // 0x018C(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSeePawns : 1;                                     // 0x018C(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHearNoises : 1;                                   // 0x018C(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_18D[0xB];                                      // 0x018D(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	UMulticastDelegateProperty_                   OnSeePawn;                                         // 0x0198(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastDelegateProperty_                   OnHearNoise;                                       // 0x01A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPawnSensingComponent) == 0x0001C0, "Wrong size on UPawnSensingComponent");
static_assert(offsetof(UPawnSensingComponent, HearingThreshold) == 0x000178, "Member 'UPawnSensingComponent::HearingThreshold' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, LOSHearingThreshold) == 0x00017C, "Member 'UPawnSensingComponent::LOSHearingThreshold' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, SightRadius) == 0x000180, "Member 'UPawnSensingComponent::SightRadius' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, SensingInterval) == 0x000184, "Member 'UPawnSensingComponent::SensingInterval' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, HearingMaxSoundAge) == 0x000188, "Member 'UPawnSensingComponent::HearingMaxSoundAge' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, OnSeePawn) == 0x000198, "Member 'UPawnSensingComponent::OnSeePawn' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, OnHearNoise) == 0x0001A8, "Member 'UPawnSensingComponent::OnHearNoise' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, PeripheralVisionAngle) == 0x0001B8, "Member 'UPawnSensingComponent::PeripheralVisionAngle' has a wrong offset!");
static_assert(offsetof(UPawnSensingComponent, PeripheralVisionCosine) == 0x0001BC, "Member 'UPawnSensingComponent::PeripheralVisionCosine' has a wrong offset!");
