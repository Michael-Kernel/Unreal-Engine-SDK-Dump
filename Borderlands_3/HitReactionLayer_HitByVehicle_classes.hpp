...
class UHitReactionLayer_HitByVehicle_C final : public UHitReactionLayer_Blueprint
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"HitReactionLayer_HitByVehicle_C">();
	}
	static class UHitReactionLayer_HitByVehicle_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UHitReactionLayer_HitByVehicle_C>();
	}
};
static_assert(alignof(UHitReactionLayer_HitByVehicle_C) == 0x000008, "Wrong alignment on UHitReactionLayer_HitByVehicle_C");
static_assert(sizeof(UHitReactionLayer_HitByVehicle_C) == 0x000030, "Wrong size on UHitReactionLayer_HitByVehicle_C");
