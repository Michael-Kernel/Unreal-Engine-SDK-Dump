...
// 0x00A8 (0x00A8 - 0x0000)
struct FActorParameterNameAndChannel final
{
public:
	class FName                                   ParameterName;                                     // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieSceneActorReferenceData          Channel;                                           // 0x0008(0x00A0)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FActorParameterNameAndChannel) == 0x000008, "Wrong alignment on FActorParameterNameAndChannel");
static_assert(sizeof(FActorParameterNameAndChannel) == 0x0000A8, "Wrong size on FActorParameterNameAndChannel");
static_assert(offsetof(FActorParameterNameAndChannel, ParameterName) == 0x000000, "Member 'FActorParameterNameAndChannel::ParameterName' has a wrong offset!");
static_assert(offsetof(FActorParameterNameAndChannel, Channel) == 0x000008, "Member 'FActorParameterNameAndChannel::Channel' has a wrong offset!");
...
public:
	...
	TArray<struct FActorParameterNameAndChannel>  Actors;                                            // 0x0050(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
};
...
static_assert(offsetof(FMovieSceneParameterSectionTemplate, Actors) == 0x000050, "Member 'FMovieSceneParameterSectionTemplate::Actors' has a wrong offset!");
...
struct FMovieSceneFeedbackSectionTemplate final : public FMovieSceneEvalTemplate
{
public:
	struct FMovieSceneFloatChannel                FloatCurve;                                        // 0x0020(0x00A0)(NativeAccessSpecifierPrivate)
	bool                                          bAffectsCoarseMotor;                               // 0x00C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAffectsFineMotor;                                 // 0x00C1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAffectsRightTrigger;                              // 0x00C2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAffectsLeftTrigger;                               // 0x00C3(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C4[0x4];                                       // 0x00C4(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieSceneFeedbackSectionTemplate) == 0x000008, "Wrong alignment on FMovieSceneFeedbackSectionTemplate");
static_assert(sizeof(FMovieSceneFeedbackSectionTemplate) == 0x0000C8, "Wrong size on FMovieSceneFeedbackSectionTemplate");
static_assert(offsetof(FMovieSceneFeedbackSectionTemplate, FloatCurve) == 0x000020, "Member 'FMovieSceneFeedbackSectionTemplate::FloatCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneFeedbackSectionTemplate, bAffectsCoarseMotor) == 0x0000C0, "Member 'FMovieSceneFeedbackSectionTemplate::bAffectsCoarseMotor' has a wrong offset!");
static_assert(offsetof(FMovieSceneFeedbackSectionTemplate, bAffectsFineMotor) == 0x0000C1, "Member 'FMovieSceneFeedbackSectionTemplate::bAffectsFineMotor' has a wrong offset!");
static_assert(offsetof(FMovieSceneFeedbackSectionTemplate, bAffectsRightTrigger) == 0x0000C2, "Member 'FMovieSceneFeedbackSectionTemplate::bAffectsRightTrigger' has a wrong offset!");
static_assert(offsetof(FMovieSceneFeedbackSectionTemplate, bAffectsLeftTrigger) == 0x0000C3, "Member 'FMovieSceneFeedbackSectionTemplate::bAffectsLeftTrigger' has a wrong offset!");
...
public:
	...
	bool                                          bOverrideSlotName;                                 // 0x0020(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneFloatChannel                Weight;                                            // 0x0028(0x00A0)(NativeAccessSpecifierPublic)
	bool                                          bSkipAnimNotifiers;                                // 0x00C8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FMovieSceneSkeletalAnimationParams) == 0x0000D0, "Wrong size on FMovieSceneSkeletalAnimationParams");
...
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, bOverrideSlotName) == 0x000020, "Member 'FMovieSceneSkeletalAnimationParams::bOverrideSlotName' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneEventSectionTemplate, EventReceivers) == 0x0000A8, "Member 'FMovieSceneEventSectionTemplate::EventReceivers' has a wrong offset!");
...
struct FMovieSceneGbxPlayRateSectionTemplate final : public FMovieSceneEvalTemplate
{
public:
	struct FMovieSceneFloatChannel                PlayRateCurve;                                     // 0x0020(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneBoolChannel                 FrameSnappingCurve;                                // 0x00C0(0x0090)(NativeAccessSpecifierPrivate)
};
static_assert(alignof(FMovieSceneGbxPlayRateSectionTemplate) == 0x000008, "Wrong alignment on FMovieSceneGbxPlayRateSectionTemplate");
static_assert(sizeof(FMovieSceneGbxPlayRateSectionTemplate) == 0x000150, "Wrong size on FMovieSceneGbxPlayRateSectionTemplate");
static_assert(offsetof(FMovieSceneGbxPlayRateSectionTemplate, PlayRateCurve) == 0x000020, "Member 'FMovieSceneGbxPlayRateSectionTemplate::PlayRateCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneGbxPlayRateSectionTemplate, FrameSnappingCurve) == 0x0000C0, "Member 'FMovieSceneGbxPlayRateSectionTemplate::FrameSnappingCurve' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneSkeletalAnimationSectionTemplateParameters) == 0x0000D8, "Wrong size on FMovieSceneSkeletalAnimationSectionTemplateParameters");
static_assert(offsetof(FMovieSceneSkeletalAnimationSectionTemplateParameters, SectionStartTime) == 0x0000D0, "Member 'FMovieSceneSkeletalAnimationSectionTemplateParameters::SectionStartTime' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationSectionTemplateParameters, SectionEndTime) == 0x0000D4, "Member 'FMovieSceneSkeletalAnimationSectionTemplateParameters::SectionEndTime' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneSkeletalAnimationSectionTemplate) == 0x0000F8, "Wrong size on FMovieSceneSkeletalAnimationSectionTemplate");
