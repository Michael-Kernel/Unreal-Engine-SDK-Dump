...
public:
	...
	uint8                                         bDeprecatedSpringOffsetMode : 1;                   // 0x0218(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	int32                                         LowForwardSpeedSubStepCount;                       // 0x027C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         HighForwardSpeedSubStepCount;                      // 0x0280(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         bUseRVOAvoidance : 1;                              // 0x02B0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	int32                                         AvoidanceUID;                                      // 0x02C8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         bRawHandbrakeInput : 1;                            // 0x0310(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bRawGearUpInput : 1;                               // 0x0310(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bRawGearDownInput : 1;                             // 0x0310(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	...
	uint8                                         bWasAvoidanceUpdated : 1;                          // 0x0350(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_351[0x27];                                     // 0x0351(0x0027)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWheeledVehicleMovementComponent) == 0x000458, "Wrong size on UWheeledVehicleMovementComponent");
static_assert(offsetof(UWheeledVehicleMovementComponent, WheelSetups) == 0x000220, "Member 'UWheeledVehicleMovementComponent::WheelSetups' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, Mass) == 0x000230, "Member 'UWheeledVehicleMovementComponent::Mass' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, DragCoefficient) == 0x000234, "Member 'UWheeledVehicleMovementComponent::DragCoefficient' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ChassisWidth) == 0x000238, "Member 'UWheeledVehicleMovementComponent::ChassisWidth' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ChassisHeight) == 0x00023C, "Member 'UWheeledVehicleMovementComponent::ChassisHeight' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, bReverseAsBrake) == 0x000240, "Member 'UWheeledVehicleMovementComponent::bReverseAsBrake' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ReverseAsBrakeTimeBeforeReverse) == 0x000244, "Member 'UWheeledVehicleMovementComponent::ReverseAsBrakeTimeBeforeReverse' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, bBrakeWhenReleasingReverse) == 0x000248, "Member 'UWheeledVehicleMovementComponent::bBrakeWhenReleasingReverse' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, DragArea) == 0x00024C, "Member 'UWheeledVehicleMovementComponent::DragArea' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, EstimatedMaxEngineSpeed) == 0x000250, "Member 'UWheeledVehicleMovementComponent::EstimatedMaxEngineSpeed' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, MaxEngineRPM) == 0x000254, "Member 'UWheeledVehicleMovementComponent::MaxEngineRPM' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, DebugDragMagnitude) == 0x000258, "Member 'UWheeledVehicleMovementComponent::DebugDragMagnitude' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, InertiaTensorScale) == 0x00025C, "Member 'UWheeledVehicleMovementComponent::InertiaTensorScale' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, MinNormalizedTireLoad) == 0x000268, "Member 'UWheeledVehicleMovementComponent::MinNormalizedTireLoad' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, MinNormalizedTireLoadFiltered) == 0x00026C, "Member 'UWheeledVehicleMovementComponent::MinNormalizedTireLoadFiltered' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, MaxNormalizedTireLoad) == 0x000270, "Member 'UWheeledVehicleMovementComponent::MaxNormalizedTireLoad' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, MaxNormalizedTireLoadFiltered) == 0x000274, "Member 'UWheeledVehicleMovementComponent::MaxNormalizedTireLoadFiltered' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ThresholdLongitudinalSpeed) == 0x000278, "Member 'UWheeledVehicleMovementComponent::ThresholdLongitudinalSpeed' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, LowForwardSpeedSubStepCount) == 0x00027C, "Member 'UWheeledVehicleMovementComponent::LowForwardSpeedSubStepCount' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, HighForwardSpeedSubStepCount) == 0x000280, "Member 'UWheeledVehicleMovementComponent::HighForwardSpeedSubStepCount' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, Wheels) == 0x000288, "Member 'UWheeledVehicleMovementComponent::Wheels' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RVOAvoidanceRadius) == 0x0002B4, "Member 'UWheeledVehicleMovementComponent::RVOAvoidanceRadius' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RVOAvoidanceHeight) == 0x0002B8, "Member 'UWheeledVehicleMovementComponent::RVOAvoidanceHeight' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, AvoidanceConsiderationRadius) == 0x0002BC, "Member 'UWheeledVehicleMovementComponent::AvoidanceConsiderationRadius' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RVOSteeringStep) == 0x0002C0, "Member 'UWheeledVehicleMovementComponent::RVOSteeringStep' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RVOThrottleStep) == 0x0002C4, "Member 'UWheeledVehicleMovementComponent::RVOThrottleStep' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, AvoidanceUID) == 0x0002C8, "Member 'UWheeledVehicleMovementComponent::AvoidanceUID' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, AvoidanceGroup) == 0x0002CC, "Member 'UWheeledVehicleMovementComponent::AvoidanceGroup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, GroupsToAvoid) == 0x0002D0, "Member 'UWheeledVehicleMovementComponent::GroupsToAvoid' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, GroupsToIgnore) == 0x0002D4, "Member 'UWheeledVehicleMovementComponent::GroupsToIgnore' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, AvoidanceWeight) == 0x0002D8, "Member 'UWheeledVehicleMovementComponent::AvoidanceWeight' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, PendingLaunchVelocity) == 0x0002DC, "Member 'UWheeledVehicleMovementComponent::PendingLaunchVelocity' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ReplicatedState) == 0x0002EC, "Member 'UWheeledVehicleMovementComponent::ReplicatedState' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RawSteeringInput) == 0x000304, "Member 'UWheeledVehicleMovementComponent::RawSteeringInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RawThrottleInput) == 0x000308, "Member 'UWheeledVehicleMovementComponent::RawThrottleInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RawBrakeInput) == 0x00030C, "Member 'UWheeledVehicleMovementComponent::RawBrakeInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, SteeringInput) == 0x000314, "Member 'UWheeledVehicleMovementComponent::SteeringInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ThrottleInput) == 0x000318, "Member 'UWheeledVehicleMovementComponent::ThrottleInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, BrakeInput) == 0x00031C, "Member 'UWheeledVehicleMovementComponent::BrakeInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, HandbrakeInput) == 0x000320, "Member 'UWheeledVehicleMovementComponent::HandbrakeInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, IdleBrakeInput) == 0x000324, "Member 'UWheeledVehicleMovementComponent::IdleBrakeInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, StopThreshold) == 0x000328, "Member 'UWheeledVehicleMovementComponent::StopThreshold' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, WrongDirectionThreshold) == 0x00032C, "Member 'UWheeledVehicleMovementComponent::WrongDirectionThreshold' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ThrottleInputRate) == 0x000330, "Member 'UWheeledVehicleMovementComponent::ThrottleInputRate' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, BrakeInputRate) == 0x000338, "Member 'UWheeledVehicleMovementComponent::BrakeInputRate' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, HandbrakeInputRate) == 0x000340, "Member 'UWheeledVehicleMovementComponent::HandbrakeInputRate' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, SteeringInputRate) == 0x000348, "Member 'UWheeledVehicleMovementComponent::SteeringInputRate' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, OverrideController) == 0x000378, "Member 'UWheeledVehicleMovementComponent::OverrideController' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, bAutoBrake) == 0x000420, "Member 'UWheeledVehicleMovementComponent::bAutoBrake' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, bDisableBrake) == 0x000421, "Member 'UWheeledVehicleMovementComponent::bDisableBrake' has a wrong offset!");
...
static_assert(sizeof(USimpleWheeledVehicleMovementComponent) == 0x000458, "Wrong size on USimpleWheeledVehicleMovementComponent");
...
// 0x06F8 (0x0B38 - 0x0440)
#pragma pack(push, 0x1)
class alignas(0x08) UVehicleAnimInstance : public UAnimInstance
{
public:
	uint8                                         Pad_440[0x6F0];                                    // 0x0440(0x06F0)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UVehicleAnimInstance) == 0x000B38, "Wrong size on UVehicleAnimInstance");
static_assert(offsetof(UVehicleAnimInstance, WheeledVehicleMovementComponent) == 0x000B30, "Member 'UVehicleAnimInstance::WheeledVehicleMovementComponent' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_AC[0x64];                                      // 0x00AC(0x0064)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UVehicleWheel) == 0x000110, "Wrong size on UVehicleWheel");
static_assert(offsetof(UVehicleWheel, CollisionMesh) == 0x000028, "Member 'UVehicleWheel::CollisionMesh' has a wrong offset!");
static_assert(offsetof(UVehicleWheel, WheelCollisionPhysMat) == 0x000030, "Member 'UVehicleWheel::WheelCollisionPhysMat' has a wrong offset!");
static_assert(offsetof(UVehicleWheel, bDontCreateShape) == 0x000038, "Member 'UVehicleWheel::bDontCreateShape' has a wrong offset!");
static_assert(offsetof(UVehicleWheel, bAutoAdjustCollisionSize) == 0x000039, "Member 'UVehicleWheel::bAutoAdjustCollisionSize' has a wrong offset!");
static_assert(offsetof(UVehicleWheel, Offset) == 0x00003C, "Member 'UVehicleWheel::Offset' has a wrong offset!");
static_assert(offsetof(UVehicleWheel, ShapeRadius) == 0x000048, "Member 'UVehicleWheel::ShapeRadius' has a wrong offset!");
static_assert(offsetof(UVehicleWheel, ShapeWidth) == 0x00004C, "Member 'UVehicleWheel::ShapeWidth' has a wrong offset!");
static_assert(offsetof(UVehicleWheel, Mass) == 0x000050, "Member 'UVehicleWheel::Mass' has a wrong offset!");
static_assert(offsetof(UVehicleWheel, DampingRate) == 0x000054, "Member 'UVehicleWheel::DampingRate' has a wrong offset!");
static_assert(offsetof(UVehicleWheel, SteerAngle) == 0x000058, "Member 'UVehicleWheel::SteerAngle' has a wrong offset!");
static_assert(offsetof(UVehicleWheel, bAffectedByHandbrake) == 0x00005C, "Member 'UVehicleWheel::bAffectedByHandbrake' has a wrong offset!");
...
static_assert(sizeof(AWheeledVehicle) == 0x0004D0, "Wrong size on AWheeledVehicle");
static_assert(offsetof(AWheeledVehicle, Mesh) == 0x0004C0, "Member 'AWheeledVehicle::Mesh' has a wrong offset!");
static_assert(offsetof(AWheeledVehicle, VehicleMovement) == 0x0004C8, "Member 'AWheeledVehicle::VehicleMovement' has a wrong offset!");
...
static_assert(sizeof(UWheeledVehicleMovementComponent4W) == 0x0005B8, "Wrong size on UWheeledVehicleMovementComponent4W");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, EngineSetup) == 0x000458, "Member 'UWheeledVehicleMovementComponent4W::EngineSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, DifferentialSetup) == 0x0004E8, "Member 'UWheeledVehicleMovementComponent4W::DifferentialSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, TransmissionSetup) == 0x000508, "Member 'UWheeledVehicleMovementComponent4W::TransmissionSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, SteeringCurve) == 0x000538, "Member 'UWheeledVehicleMovementComponent4W::SteeringCurve' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, AckermannAccuracy) == 0x0005B0, "Member 'UWheeledVehicleMovementComponent4W::AckermannAccuracy' has a wrong offset!");
