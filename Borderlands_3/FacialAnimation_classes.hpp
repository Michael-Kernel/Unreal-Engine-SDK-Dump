...
public:
	...
	uint8                                         Pad_6F4[0x2C];                                     // 0x06F4(0x002C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAudioCurveSourceComponent) == 0x000720, "Wrong size on UAudioCurveSourceComponent");
static_assert(offsetof(UAudioCurveSourceComponent, CurveSourceBindingName) == 0x0006E8, "Member 'UAudioCurveSourceComponent::CurveSourceBindingName' has a wrong offset!");
static_assert(offsetof(UAudioCurveSourceComponent, CurveSyncOffset) == 0x0006F0, "Member 'UAudioCurveSourceComponent::CurveSyncOffset' has a wrong offset!");
