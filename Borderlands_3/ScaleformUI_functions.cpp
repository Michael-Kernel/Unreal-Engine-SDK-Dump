...
// const class UGFxMoviePlayer*            ReturnValue                                            (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

const class UGFxMoviePlayer* UGFxMoviePlayer::OpenMovie(class USwfMovie* SwfMovie, class UObject* ExternalScriptInterface, class UTextureRenderTarget2D* RenderToTexture, const class UGFxMoviePlayer* MoviePlayer, bool DisplayWithHudOff, bool bRefresh)
{
...
struct FASColorTransform UGFxMoviePlayer::GetColorTransform(const class FString& MovieClipName) const
{
	static class UFunction* Func = nullptr;
...
struct FASDisplayInfo UGFxMoviePlayer::GetDisplayInfo(const class FString& MovieClipName) const
{
	static class UFunction* Func = nullptr;
...
struct FTransform UGFxMoviePlayer::GetDisplayTransform(const class FString& MovieClipName) const
{
	static class UFunction* Func = nullptr;
...
class UGFxObject* UGFxMoviePlayer::GetMovieClip(const class FString& MovieClipName) const
{
	static class UFunction* Func = nullptr;
...
struct FASPerspectiveTransform UGFxMoviePlayer::GetPerspective3D() const
{
	static class UFunction* Func = nullptr;
...
bool UGFxMoviePlayer::GetPosition(const class FString& MovieClipName, float* X, float* Y) const
{
	static class UFunction* Func = nullptr;
...
bool UGFxMoviePlayer::GetScale(const class FString& MovieClipName, float* XScale, float* YScale) const
{
	static class UFunction* Func = nullptr;
...
struct FASValue UGFxMoviePlayer::GetVariableValue(const class FString& MovieClipName, const class FString& MemberName) const
{
	static class UFunction* Func = nullptr;
...
TArray<struct FASValue> UGFxMoviePlayer::GetVariableValueArray(const class FString& MovieClipName, const class FString& MemberName) const
{
	static class UFunction* Func = nullptr;
...
struct FTransform UGFxMoviePlayer::GetView3D() const
{
	static class UFunction* Func = nullptr;
...
bool UGFxMoviePlayer::GetVisibility(const class FString& MovieClipName) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::GotoAndPlay(const class FString& MovieClipName, const class FString& Frame) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::GotoAndPlayI(const class FString& MovieClipName, int32 Frame) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::GotoAndStop(const class FString& MovieClipName, const class FString& Frame) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::GotoAndStopI(const class FString& MovieClipName, int32 Frame) const
{
	static class UFunction* Func = nullptr;
...
struct FASValue UGFxMoviePlayer::Invoke(const class FString& MovieClipName, const class FString& FunctionName, const TArray<struct FASValue>& Params_0) const
{
	static class UFunction* Func = nullptr;
...
bool UGFxMoviePlayer::IsPaused() const
{
	...
	Params::GFxMoviePlayer_IsPaused Parms{};
...
bool UGFxMoviePlayer::IsVisible() const
{
	...
	Params::GFxMoviePlayer_IsVisible Parms{};
...
void UGFxMoviePlayer::OnGameTick(float DeltaTime) const
{
	...
	Params::GFxMoviePlayer_OnGameTick Parms{};
...
void UGFxMoviePlayer::ReceiveGFxCommand(const class FString& Command, const class FString& Arguments) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetAlignment(EGFxAlign Align) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetCaptureKeys(const TArray<struct FKey>& Keys) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetColorTransform(const class FString& MovieClipName, const struct FASColorTransform& UnrealColorTransform) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetDisplayInfo(const class FString& MovieClipName, const struct FASDisplayInfo& Info) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetDisplayTransform(const class FString& MovieClipName, const struct FTransform& DisplayTransform) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetExternalTexture(const class FString& Resource, class UTexture* Texture) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetFocusIgnoreKeys(const TArray<struct FKey>& Keys) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetPerspective3D(const struct FASPerspectiveTransform& PerspectiveTransform) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetPosition(const class FString& MovieClipName, float X, float Y) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetScale(const class FString& MovieClipName, float XScale, float YScale) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetTimingMode(EGFxTimingMode TimingMode) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetVariableValue(const class FString& MovieClipName, const class FString& MemberName, const struct FASValue& Value) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetVariableValueArray(const class FString& MovieClipName, const class FString& MemberName, const TArray<struct FASValue>& Value) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetView3D(const struct FTransform& ViewTransform) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetViewScaleMode(EGFxScaleMode ScaleMode) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetVisibility(const class FString& MovieClipName, bool bVisible) const
{
	static class UFunction* Func = nullptr;
...
void UGFxMoviePlayer::SetVisible(bool bVisible) const
{
	...
	Params::GFxMoviePlayer_SetVisible Parms{};
...
void UGFxObject::SetMemberValueArray(const class UGFxMoviePlayer* MoviePlayer, const class FString& MemberName, const TArray<struct FASValue>& Input)
{
	static class UFunction* Func = nullptr;
...
void UScaleformBlueprintLibrary::CloseMovie(const class UGFxMoviePlayer* MoviePlayer)
{
	static class UFunction* Func = nullptr;
...
void UScaleformBlueprintLibrary::GetAllGFxMoviePlayerOfClass(class UObject* WorldContextObject, const TArray<class UGFxMoviePlayer*>* FoundGFxMoviePlayer, TSubclassOf<class UGFxMoviePlayer> GFxMoviePlayerClass, bool VisibleOnly)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("ScaleformBlueprintLibrary", "GetAllGFxMoviePlayerOfClass");

	Params::ScaleformBlueprintLibrary_GetAllGFxMoviePlayerOfClass Parms{};
...
class UGFxObject* UScaleformBlueprintLibrary::GetMember(const class UGFxMoviePlayer* MoviePlayer, const class FString& MemberName)
{
	static class UFunction* Func = nullptr;
...
class UGFxObject* UScaleformBlueprintLibrary::GetMovieClip(const class UGFxMoviePlayer* MoviePlayer, const class FString& MovieClipName)
{
	static class UFunction* Func = nullptr;
...
class UGFxObject* UScaleformBlueprintLibrary::GetVariable(const class UGFxMoviePlayer* MoviePlayer, const class FString& VariablePath)
{
	static class UFunction* Func = nullptr;
...
struct FASValue UScaleformBlueprintLibrary::Invoke(const class UGFxMoviePlayer* MoviePlayer, const class FString& FunctionName, const TArray<struct FASValue>& Params_0)
{
	static class UFunction* Func = nullptr;
...
struct FASValue UScaleformBlueprintLibrary::InvokeNoParams(const class UGFxMoviePlayer* MoviePlayer, const class FString& FunctionName)
{
	static class UFunction* Func = nullptr;
...
const class UGFxMoviePlayer* UScaleformBlueprintLibrary::OpenMovie(class USwfMovie* Movie, class UObject* ExternalInterface, class UTextureRenderTarget2D* RenderTexture, const class UGFxMoviePlayer* MoviePlayer, bool DisplayWithHudOff, bool StartPaused)
{
	static class UFunction* Func = nullptr;
