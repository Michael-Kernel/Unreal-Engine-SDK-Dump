...
#include "HitReactionLayer_Nog_DroneShieldCheck_classes.hpp"
#include "HitReactionLayer_Nog_DroneShieldCheck_parameters.hpp"
...
void UHitReactionLayer_Nog_DroneShieldCheck_C::CalcHealthPercent(class UOakDamageComponent* Receiver, float Damage_Amount, float* Damage_Percent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HitReactionLayer_Nog_DroneShieldCheck_C", "CalcHealthPercent");

	Params::HitReactionLayer_Nog_DroneShieldCheck_C_CalcHealthPercent Parms{};
