...
// 0x0118 (0x0628 - 0x0510)
class UMission_CreatureSlaughter_C final : public UOakMissionCircleOfSlaughter
{
public:
	...
	int32                                         RoundCounter;                                      // 0x0530(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	void ExecuteUbergraph_Mission_CreatureSlaughter(int32 EntryPoint);
	...
	void Obj_INVIS_Assemble_5(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_INVIS_Assemble_4(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_INVIS_Assemble_3(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_INVIS_Assemble_2(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_INVIS_Assemble_1(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Mission_CreatureSlaughter_C">();
	}
	static class UMission_CreatureSlaughter_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMission_CreatureSlaughter_C>();
	}
};
static_assert(alignof(UMission_CreatureSlaughter_C) == 0x000008, "Wrong alignment on UMission_CreatureSlaughter_C");
static_assert(sizeof(UMission_CreatureSlaughter_C) == 0x000628, "Wrong size on UMission_CreatureSlaughter_C");
static_assert(offsetof(UMission_CreatureSlaughter_C, UberGraphFrame) == 0x000510, "Member 'UMission_CreatureSlaughter_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, SlaughterGameMode) == 0x000518, "Member 'UMission_CreatureSlaughter_C::SlaughterGameMode' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Set_Round1_ObjSetVar) == 0x000520, "Member 'UMission_CreatureSlaughter_C::Set_Round1_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_Rounds_ObjVar) == 0x000528, "Member 'UMission_CreatureSlaughter_C::Obj_Rounds_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, RoundCounter) == 0x000530, "Member 'UMission_CreatureSlaughter_C::RoundCounter' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_INVIS_Assemble_1_ObjVar) == 0x000538, "Member 'UMission_CreatureSlaughter_C::Obj_INVIS_Assemble_1_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_StartRound_1_ObjVar) == 0x000540, "Member 'UMission_CreatureSlaughter_C::Obj_StartRound_1_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_CompleteWave_1_ObjVar) == 0x000548, "Member 'UMission_CreatureSlaughter_C::Obj_CompleteWave_1_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Set_Round2_ObjSetVar) == 0x000550, "Member 'UMission_CreatureSlaughter_C::Set_Round2_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_INVIS_Assemble_2_ObjVar) == 0x000558, "Member 'UMission_CreatureSlaughter_C::Obj_INVIS_Assemble_2_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_StartRound_2_ObjVar) == 0x000560, "Member 'UMission_CreatureSlaughter_C::Obj_StartRound_2_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_CompleteWave_2_ObjVar) == 0x000568, "Member 'UMission_CreatureSlaughter_C::Obj_CompleteWave_2_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Set_Round3_ObjSetVar) == 0x000570, "Member 'UMission_CreatureSlaughter_C::Set_Round3_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_INVIS_Assemble_3_ObjVar) == 0x000578, "Member 'UMission_CreatureSlaughter_C::Obj_INVIS_Assemble_3_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_StartRound_3_ObjVar) == 0x000580, "Member 'UMission_CreatureSlaughter_C::Obj_StartRound_3_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Set_Round4_ObjSetVar) == 0x000588, "Member 'UMission_CreatureSlaughter_C::Set_Round4_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_INVIS_Assemble_4_ObjVar) == 0x000590, "Member 'UMission_CreatureSlaughter_C::Obj_INVIS_Assemble_4_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_StartRound_4_ObjVar) == 0x000598, "Member 'UMission_CreatureSlaughter_C::Obj_StartRound_4_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Set_Round5_ObjSetVar) == 0x0005A0, "Member 'UMission_CreatureSlaughter_C::Set_Round5_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_INVIS_Assemble_5_ObjVar) == 0x0005A8, "Member 'UMission_CreatureSlaughter_C::Obj_INVIS_Assemble_5_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_CompleteWave_3_ObjVar) == 0x0005B0, "Member 'UMission_CreatureSlaughter_C::Obj_CompleteWave_3_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_CompleteWave_4_ObjVar) == 0x0005B8, "Member 'UMission_CreatureSlaughter_C::Obj_CompleteWave_4_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_StartRound_5_ObjVar) == 0x0005C0, "Member 'UMission_CreatureSlaughter_C::Obj_StartRound_5_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_CompleteWave_5_ObjVar) == 0x0005C8, "Member 'UMission_CreatureSlaughter_C::Obj_CompleteWave_5_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Set_TurnIn_ObjSetVar) == 0x0005D0, "Member 'UMission_CreatureSlaughter_C::Set_TurnIn_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_TurnIn_ObjVar) == 0x0005D8, "Member 'UMission_CreatureSlaughter_C::Obj_TurnIn_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_OptionalObjective_Round1_ObjVar) == 0x0005E0, "Member 'UMission_CreatureSlaughter_C::Obj_OptionalObjective_Round1_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_OptionalObjective_Round2_ObjVar) == 0x0005E8, "Member 'UMission_CreatureSlaughter_C::Obj_OptionalObjective_Round2_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_OptionalObjective_Round3_ObjVar) == 0x0005F0, "Member 'UMission_CreatureSlaughter_C::Obj_OptionalObjective_Round3_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_OptionalObjective_Round4_ObjVar) == 0x0005F8, "Member 'UMission_CreatureSlaughter_C::Obj_OptionalObjective_Round4_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_OptionalObjective_Round5_ObjVar) == 0x000600, "Member 'UMission_CreatureSlaughter_C::Obj_OptionalObjective_Round5_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Slaughter_Game_State) == 0x000608, "Member 'UMission_CreatureSlaughter_C::Slaughter_Game_State' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Obj_INVIS_PlayersDiedinRound_ObjVar) == 0x000610, "Member 'UMission_CreatureSlaughter_C::Obj_INVIS_PlayersDiedinRound_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Torgue_VO_Slaughter_Start) == 0x000618, "Member 'UMission_CreatureSlaughter_C::Torgue_VO_Slaughter_Start' has a wrong offset!");
static_assert(offsetof(UMission_CreatureSlaughter_C, Player_Used_Button_CS) == 0x000624, "Member 'UMission_CreatureSlaughter_C::Player_Used_Button_CS' has a wrong offset!");
