...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// TScriptInterface<class IMediaAudioSinkProviderInterface>NewSinkProvider                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, NativeAccessSpecifierPublic)

void UMediaPlayer::SetAudioSinkProvider(TScriptInterface<class IMediaAudioSinkProviderInterface> NewSinkProvider)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MediaPlayer", "SetAudioSinkProvider");

	Params::MediaPlayer_SetAudioSinkProvider Parms{};

	Parms.NewSinkProvider = NewSinkProvider;
...
// Parameters:
// struct FTimespan                        TimeDelay_0                                            (Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
