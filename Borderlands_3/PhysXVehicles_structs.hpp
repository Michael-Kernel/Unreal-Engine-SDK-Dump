...
static_assert(sizeof(FAnimNode_WheelHandler) == 0x000158, "Wrong size on FAnimNode_WheelHandler");
...
struct FStartVehicleUpdatesTickFunction final : public FTickFunction
{
public:
	uint8                                         Pad_50[0x8];                                       // 0x0050(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FStartVehicleUpdatesTickFunction) == 0x000008, "Wrong alignment on FStartVehicleUpdatesTickFunction");
static_assert(sizeof(FStartVehicleUpdatesTickFunction) == 0x000058, "Wrong size on FStartVehicleUpdatesTickFunction");
...
static_assert(sizeof(FVehicleAnimInstanceProxy) == 0x0006E0, "Wrong size on FVehicleAnimInstanceProxy");
...
static_assert(sizeof(FWheelSetup) == 0x000038, "Wrong size on FWheelSetup");
