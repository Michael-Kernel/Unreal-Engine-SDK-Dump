...
#include "HitReactionLayer_ForceFlinch_classes.hpp"
#include "HitReactionLayer_ForceFlinch_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_ForceFlinch_C::EvaluateTag(class UDamageComponent* Receiver, class UDamageCauserComponent* Causer, float DamageAmount, const class UGbxDamageType* DamageType, const class UDamageSource* DamageSource, class UHitRegionData* HitRegion, float Force, class UHitReactionTag* PreviousTag) const
{
	...
	Params::HitReactionLayer_ForceFlinch_C_EvaluateTag Parms{};
