...
class UMission_PandorasNextTopMouthpiece_C final : public UBP_OakMission_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Mission_PandorasNextTopMouthpiece_C; // 0x0510(0x0008)(Transient, DuplicateTransient)
	...
	int32                                         TrophyLineCount;                                   // 0x05A8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	void ExecuteUbergraph_Mission_PandorasNextTopMouthpiece(int32 EntryPoint);
	void MCE_PuttergunkDoorOpen(class UObject* Context);
	void Obj_LootClan3Treasure_Nag(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_FindSecretStash(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_TurnInVaughn(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_PlayOrgan(class UObject* Context);
	void Set_PlayOrgan(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_PlayOrgan(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_DepositTrophies(class UObject* Context);
	void Obj_DepositTrophies(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_StopPandorasNextTopMouthpiece(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_BringTrophiestoHBC(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_LootClan3Treasure(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_BlowUpWarPigsWarPig(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Set_ProveWorthy(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_StealBanner(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Set_FindEntryRequirements(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_FindEntryRequirements(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Mission_PandorasNextTopMouthpiece_C">();
	}
	static class UMission_PandorasNextTopMouthpiece_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMission_PandorasNextTopMouthpiece_C>();
	}
};
static_assert(alignof(UMission_PandorasNextTopMouthpiece_C) == 0x000008, "Wrong alignment on UMission_PandorasNextTopMouthpiece_C");
static_assert(sizeof(UMission_PandorasNextTopMouthpiece_C) == 0x0005C8, "Wrong size on UMission_PandorasNextTopMouthpiece_C");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, UberGraphFrame_Mission_PandorasNextTopMouthpiece_C) == 0x000510, "Member 'UMission_PandorasNextTopMouthpiece_C::UberGraphFrame_Mission_PandorasNextTopMouthpiece_C' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Set_FindEntryRequirements_ObjSetVar) == 0x000518, "Member 'UMission_PandorasNextTopMouthpiece_C::Set_FindEntryRequirements_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Obj_FindEntryRequirements_ObjVar) == 0x000520, "Member 'UMission_PandorasNextTopMouthpiece_C::Obj_FindEntryRequirements_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Set_ProveWorthy_ObjSetVar) == 0x000528, "Member 'UMission_PandorasNextTopMouthpiece_C::Set_ProveWorthy_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Obj_StealBanner_ObjVar) == 0x000530, "Member 'UMission_PandorasNextTopMouthpiece_C::Obj_StealBanner_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Obj_BlowUpWarPigsWarPig_ObjVar) == 0x000538, "Member 'UMission_PandorasNextTopMouthpiece_C::Obj_BlowUpWarPigsWarPig_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Obj_LootClan3Treasure_ObjVar) == 0x000540, "Member 'UMission_PandorasNextTopMouthpiece_C::Obj_LootClan3Treasure_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Set_BringTrophiesToHBC_ObjSetVar) == 0x000548, "Member 'UMission_PandorasNextTopMouthpiece_C::Set_BringTrophiesToHBC_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Obj_BringTrophiestoHBC_ObjVar) == 0x000550, "Member 'UMission_PandorasNextTopMouthpiece_C::Obj_BringTrophiestoHBC_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Set_KillMouthpiece_ObjSetVar) == 0x000558, "Member 'UMission_PandorasNextTopMouthpiece_C::Set_KillMouthpiece_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Obj_KillMouthpiece_ObjVar) == 0x000560, "Member 'UMission_PandorasNextTopMouthpiece_C::Obj_KillMouthpiece_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Set_StopPandorasNextTopMouthpiece_ObjSetVar) == 0x000568, "Member 'UMission_PandorasNextTopMouthpiece_C::Set_StopPandorasNextTopMouthpiece_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Obj_StopPandorasNextTopMouthpiece_ObjVar) == 0x000570, "Member 'UMission_PandorasNextTopMouthpiece_C::Obj_StopPandorasNextTopMouthpiece_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Set_DepositTrophies_ObjSetVar) == 0x000578, "Member 'UMission_PandorasNextTopMouthpiece_C::Set_DepositTrophies_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Obj_DepositTrophies_ObjVar) == 0x000580, "Member 'UMission_PandorasNextTopMouthpiece_C::Obj_DepositTrophies_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Set_PlayOrgan_ObjSetVar) == 0x000588, "Member 'UMission_PandorasNextTopMouthpiece_C::Set_PlayOrgan_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Obj_PlayOrgan_ObjVar) == 0x000590, "Member 'UMission_PandorasNextTopMouthpiece_C::Obj_PlayOrgan_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Set_TurnInVaughn_ObjSetVar) == 0x000598, "Member 'UMission_PandorasNextTopMouthpiece_C::Set_TurnInVaughn_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Obj_TurnInVaughn_ObjVar) == 0x0005A0, "Member 'UMission_PandorasNextTopMouthpiece_C::Obj_TurnInVaughn_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, TrophyLineCount) == 0x0005A8, "Member 'UMission_PandorasNextTopMouthpiece_C::TrophyLineCount' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Set_FindSecretStash_ObjSetVar) == 0x0005B0, "Member 'UMission_PandorasNextTopMouthpiece_C::Set_FindSecretStash_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Obj_FindSecretStash_ObjVar) == 0x0005B8, "Member 'UMission_PandorasNextTopMouthpiece_C::Obj_FindSecretStash_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_PandorasNextTopMouthpiece_C, Obj_LootClan3Treasure_Nag_ObjVar) == 0x0005C0, "Member 'UMission_PandorasNextTopMouthpiece_C::Obj_LootClan3Treasure_Nag_ObjVar' has a wrong offset!");
