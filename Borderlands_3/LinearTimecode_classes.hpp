...
public:
	...
	UMulticastDelegateProperty_                   OnTimecodeChange;                                  // 0x02F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULinearTimecodeComponent) == 0x000340, "Wrong size on ULinearTimecodeComponent");
static_assert(offsetof(ULinearTimecodeComponent, MediaPlayer) == 0x0002D0, "Member 'ULinearTimecodeComponent::MediaPlayer' has a wrong offset!");
static_assert(offsetof(ULinearTimecodeComponent, DropTimecode) == 0x0002D8, "Member 'ULinearTimecodeComponent::DropTimecode' has a wrong offset!");
static_assert(offsetof(ULinearTimecodeComponent, OnTimecodeChange) == 0x0002F8, "Member 'ULinearTimecodeComponent::OnTimecodeChange' has a wrong offset!");
