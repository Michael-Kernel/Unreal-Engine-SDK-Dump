...
#include "HitReactionLayer_Spiderant_CarpaceHitDowngrade_classes.hpp"
#include "HitReactionLayer_Spiderant_CarpaceHitDowngrade_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_Spiderant_CarpaceHitDowngrade_C::EvaluateTag(class UDamageComponent* Receiver, class UDamageCauserComponent* Causer, float DamageAmount, const class UGbxDamageType* DamageType, const class UDamageSource* DamageSource, class UHitRegionData* HitRegion, float Force, class UHitReactionTag* PreviousTag) const
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HitReactionLayer_Spiderant_CarpaceHitDowngrade_C", "EvaluateTag");

	Params::HitReactionLayer_Spiderant_CarpaceHitDowngrade_C_EvaluateTag Parms{};
