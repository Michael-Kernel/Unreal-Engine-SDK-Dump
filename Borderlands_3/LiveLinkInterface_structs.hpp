...
static_assert(alignof(FLiveLinkCurveElement) == 0x000008, "Wrong alignment on FLiveLinkCurveElement");
...
static_assert(alignof(FLiveLinkSubjectName) == 0x000008, "Wrong alignment on FLiveLinkSubjectName");
