...
#include "LightProjectile_JAK_BirdofPrey_Child_classes.hpp"
#include "LightProjectile_JAK_BirdofPrey_Child_parameters.hpp"
...
void ULightProjectile_JAK_BirdofPrey_Child_C::HomeIn(class UOakLightProjectile* Projectile)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("LightProjectile_JAK_BirdofPrey_Child_C", "HomeIn");

	Params::LightProjectile_JAK_BirdofPrey_Child_C_HomeIn Parms{};
...
void ULightProjectile_JAK_BirdofPrey_Child_C::OnRicochet(class ULightProjectile* Projectile, const struct FHitResult& Hit, const struct FVector& ImpactVelocity) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LightProjectile_JAK_BirdofPrey_Child_C", "OnRicochet");

	Params::LightProjectile_JAK_BirdofPrey_Child_C_OnRicochet Parms{};
