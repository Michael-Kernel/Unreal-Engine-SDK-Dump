...
#include "BP_Challenge_CharacterSpecific_ClassMod_parameters.hpp"
...
void UBP_Challenge_CharacterSpecific_ClassMod_C::ExecuteUbergraph_BP_Challenge_CharacterSpecific_ClassMod(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Challenge_CharacterSpecific_ClassMod_C", "ExecuteUbergraph_BP_Challenge_CharacterSpecific_ClassMod");

	Params::BP_Challenge_CharacterSpecific_ClassMod_C_ExecuteUbergraph_BP_Challenge_CharacterSpecific_ClassMod Parms{};
...
void UBP_Challenge_CharacterSpecific_ClassMod_C::CheckClassMod(class AActor* EquippedActor, class UInventorySlotData* SlotData)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_Challenge_CharacterSpecific_ClassMod_C", "CheckClassMod");

	Params::BP_Challenge_CharacterSpecific_ClassMod_C_CheckClassMod Parms{};
...
void UBP_Challenge_CharacterSpecific_ClassMod_C::SetBinds(class AOakCharacter* Character, bool* BindSet)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_Challenge_CharacterSpecific_ClassMod_C", "SetBinds");

	Params::BP_Challenge_CharacterSpecific_ClassMod_C_SetBinds Parms{};
