...
void URichTextBlock::SetColorAndOpacity(const struct FSlateColor& InColorAndOpacity)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("RichTextBlock", "SetColorAndOpacity");

	Params::RichTextBlock_SetColorAndOpacity Parms{};
...
void UComboBoxString::SetSelectedOptionByIndex(int32 Index_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ComboBoxString", "SetSelectedOptionByIndex");

	Params::ComboBoxString_SetSelectedOptionByIndex Parms{};
...
float UScrollBox::GetPhysicalScrollOffset() const
{
	static class UFunction* Func = nullptr;
