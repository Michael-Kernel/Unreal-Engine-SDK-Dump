...
#include "HitReactionLayer_HitByVehicle_classes.hpp"
#include "HitReactionLayer_HitByVehicle_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_HitByVehicle_C::EvaluateTag(class UDamageComponent* Receiver, class UDamageCauserComponent* Causer, float DamageAmount, const class UGbxDamageType* DamageType, const class UDamageSource* DamageSource, class UHitRegionData* HitRegion, float Force, class UHitReactionTag* PreviousTag) const
{
	...
	Params::HitReactionLayer_HitByVehicle_C_EvaluateTag Parms{};
