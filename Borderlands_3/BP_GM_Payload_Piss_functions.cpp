...
#include "BP_GM_Payload_Piss_classes.hpp"
#include "BP_GM_Payload_Piss_parameters.hpp"
...
void UBP_GM_Payload_Piss_C::K2_GrenadeDamageDealt(class AGrenade* Grenade, class AGrenadeMod* GrenadeMod, struct FPayloadInstanceData& InstanceData, class AOakCharacter* Character, const struct FDamageDataEventDetails& DamageEvent) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GM_Payload_Piss_C", "K2_GrenadeDamageDealt");

	Params::BP_GM_Payload_Piss_C_K2_GrenadeDamageDealt Parms{};
...
void UBP_GM_Payload_Piss_C::K2_GrenadeExplode(class AGrenade* Grenade, class AGrenadeMod* GrenadeMod, struct FPayloadInstanceData& InstanceData) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GM_Payload_Piss_C", "K2_GrenadeExplode");

	Params::BP_GM_Payload_Piss_C_K2_GrenadeExplode Parms{};
