...
class UMission_DynastyDash_Desert_Repeatable_C final : public UBP_OakMission_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Mission_DynastyDash_Desert_Repeatable_C; // 0x0510(0x0008)(Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_Mission_DynastyDash_Desert_Repeatable(int32 EntryPoint);
	void MissionKickoff();
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Mission_DynastyDash_Desert_Repeatable_C">();
	}
	static class UMission_DynastyDash_Desert_Repeatable_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMission_DynastyDash_Desert_Repeatable_C>();
	}
};
static_assert(alignof(UMission_DynastyDash_Desert_Repeatable_C) == 0x000008, "Wrong alignment on UMission_DynastyDash_Desert_Repeatable_C");
static_assert(sizeof(UMission_DynastyDash_Desert_Repeatable_C) == 0x000578, "Wrong size on UMission_DynastyDash_Desert_Repeatable_C");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, UberGraphFrame_Mission_DynastyDash_Desert_Repeatable_C) == 0x000510, "Member 'UMission_DynastyDash_Desert_Repeatable_C::UberGraphFrame_Mission_DynastyDash_Desert_Repeatable_C' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, TimerSecondsRemaining) == 0x000518, "Member 'UMission_DynastyDash_Desert_Repeatable_C::TimerSecondsRemaining' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, TimerSecondsInitial) == 0x00051C, "Member 'UMission_DynastyDash_Desert_Repeatable_C::TimerSecondsInitial' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, TimerSecondsComputedTime) == 0x000520, "Member 'UMission_DynastyDash_Desert_Repeatable_C::TimerSecondsComputedTime' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, FastAchieved) == 0x000524, "Member 'UMission_DynastyDash_Desert_Repeatable_C::FastAchieved' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, MediumAchieved) == 0x000525, "Member 'UMission_DynastyDash_Desert_Repeatable_C::MediumAchieved' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, SlowAchieved) == 0x000526, "Member 'UMission_DynastyDash_Desert_Repeatable_C::SlowAchieved' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, SET_AcquireBurgers_ObjSetVar) == 0x000528, "Member 'UMission_DynastyDash_Desert_Repeatable_C::SET_AcquireBurgers_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, OBJ_AcquireBurgers_ObjVar) == 0x000530, "Member 'UMission_DynastyDash_Desert_Repeatable_C::OBJ_AcquireBurgers_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, SET_DeliverBurgers_ObjSetVar) == 0x000538, "Member 'UMission_DynastyDash_Desert_Repeatable_C::SET_DeliverBurgers_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, OBJ_DeliverBurgers_ObjVar) == 0x000540, "Member 'UMission_DynastyDash_Desert_Repeatable_C::OBJ_DeliverBurgers_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, OBJ_CompleteDeliveryFast_ObjVar) == 0x000548, "Member 'UMission_DynastyDash_Desert_Repeatable_C::OBJ_CompleteDeliveryFast_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, OBJ_CompleteDeliveryMed_ObjVar) == 0x000550, "Member 'UMission_DynastyDash_Desert_Repeatable_C::OBJ_CompleteDeliveryMed_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, OBJ_CompleteDeliverySlow_ObjVar) == 0x000558, "Member 'UMission_DynastyDash_Desert_Repeatable_C::OBJ_CompleteDeliverySlow_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, OBJ_SignTest_ObjVar) == 0x000560, "Member 'UMission_DynastyDash_Desert_Repeatable_C::OBJ_SignTest_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, SET_ReturnToStart_ObjSetVar) == 0x000568, "Member 'UMission_DynastyDash_Desert_Repeatable_C::SET_ReturnToStart_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_DynastyDash_Desert_Repeatable_C, OBJ_ReturnToStart_ObjVar) == 0x000570, "Member 'UMission_DynastyDash_Desert_Repeatable_C::OBJ_ReturnToStart_ObjVar' has a wrong offset!");
