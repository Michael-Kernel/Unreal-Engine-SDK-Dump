...
#include "HitReactionLayer_Death_classes.hpp"
#include "HitReactionLayer_Death_parameters.hpp"
...
void UHitReactionLayer_Death_C::CalcHealthPercent(class UOakDamageComponent* Receiver, float Damage_Amount, float* Damage_Percent)
{
	...
	Params::HitReactionLayer_Death_C_CalcHealthPercent Parms{};
...
class UHitReactionTag* UHitReactionLayer_Death_C::EvaluateTag(class UDamageComponent* Receiver, class UDamageCauserComponent* Causer, float DamageAmount, const class UGbxDamageType* DamageType, const class UDamageSource* DamageSource, class UHitRegionData* HitRegion, float Force, class UHitReactionTag* PreviousTag) const
{
	static class UFunction* Func = nullptr;
	...
	Params::HitReactionLayer_Death_C_EvaluateTag Parms{};
