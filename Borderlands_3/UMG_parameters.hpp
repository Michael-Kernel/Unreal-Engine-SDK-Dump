...
// 0x0028 (0x0028 - 0x0000)
struct RichTextBlock_SetColorAndOpacity final
{
public:
	struct FSlateColor                            InColorAndOpacity;                                 // 0x0000(0x0028)(Parm, NativeAccessSpecifierPublic)
};
static_assert(alignof(RichTextBlock_SetColorAndOpacity) == 0x000008, "Wrong alignment on RichTextBlock_SetColorAndOpacity");
static_assert(sizeof(RichTextBlock_SetColorAndOpacity) == 0x000028, "Wrong size on RichTextBlock_SetColorAndOpacity");
static_assert(offsetof(RichTextBlock_SetColorAndOpacity, InColorAndOpacity) == 0x000000, "Member 'RichTextBlock_SetColorAndOpacity::InColorAndOpacity' has a wrong offset!");
...
// 0x0004 (0x0004 - 0x0000)
struct ComboBoxString_SetSelectedOptionByIndex final
{
public:
	int32                                         Index_0;                                           // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ComboBoxString_SetSelectedOptionByIndex) == 0x000004, "Wrong alignment on ComboBoxString_SetSelectedOptionByIndex");
static_assert(sizeof(ComboBoxString_SetSelectedOptionByIndex) == 0x000004, "Wrong size on ComboBoxString_SetSelectedOptionByIndex");
static_assert(offsetof(ComboBoxString_SetSelectedOptionByIndex, Index_0) == 0x000000, "Member 'ComboBoxString_SetSelectedOptionByIndex::Index_0' has a wrong offset!");
...
static_assert(alignof(ScrollBox_GetPhysicalScrollOffset) == 0x000004, "Wrong alignment on ScrollBox_GetPhysicalScrollOffset");
static_assert(sizeof(ScrollBox_GetPhysicalScrollOffset) == 0x000004, "Wrong size on ScrollBox_GetPhysicalScrollOffset");
static_assert(offsetof(ScrollBox_GetPhysicalScrollOffset, ReturnValue) == 0x000000, "Member 'ScrollBox_GetPhysicalScrollOffset::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WidgetInteractionComponent_SetCustomHitResult) == 0x000090, "Wrong size on WidgetInteractionComponent_SetCustomHitResult");
...
static_assert(sizeof(WidgetInteractionComponent_GetLastHitResult) == 0x000090, "Wrong size on WidgetInteractionComponent_GetLastHitResult");
