...
public:
	...
	UMulticastDelegateProperty_                   OnClaimedResourcesChange;                          // 0x01E0(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayTasksComponent) == 0x0001F8, "Wrong size on UGameplayTasksComponent");
static_assert(offsetof(UGameplayTasksComponent, bIsNetDirty) == 0x000180, "Member 'UGameplayTasksComponent::bIsNetDirty' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, SimulatedTasks) == 0x000188, "Member 'UGameplayTasksComponent::SimulatedTasks' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, TaskPriorityQueue) == 0x000198, "Member 'UGameplayTasksComponent::TaskPriorityQueue' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, TickingTasks) == 0x0001B8, "Member 'UGameplayTasksComponent::TickingTasks' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, KnownTasks) == 0x0001C8, "Member 'UGameplayTasksComponent::KnownTasks' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, OnClaimedResourcesChange) == 0x0001E0, "Member 'UGameplayTasksComponent::OnClaimedResourcesChange' has a wrong offset!");
