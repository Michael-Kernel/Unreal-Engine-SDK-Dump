...
class UALI_EP04_C final : public UOakMission
{
public:
...
public:
	void ExecuteUbergraph_ALI_EP04(int32 EntryPoint);
	void SET_GoToExperiment(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_GoToExperiment(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_GoToExperiment(class UObject* Context);
	void Obj_PickUpLoaderArms(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_PickUpLoaderArms(class UObject* Context);
	void Obj_PickUpLoaderLegs(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_EnterHyperionLab(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_EnterHyperionLab(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_PickUpLoaderLegs(class UObject* Context);
	void MCE_EnterHyperionLab(class UObject* Context);
	void Obj_GoToSecretLair_Precheck(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_INV_ReachCombatSanitarium_Precheck(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_ExitSecondMemory_Precheck(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_SecureSecretLair_INV(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_INV_ExitMemory_Precheck(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_PickUpOrb3(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void INV_Obj_ReadyForOrb(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_Kickoff(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_INV_WhiteRoomSequenceEnded(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_INV_GhostsAppear(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_INV_GhostsAppear(class UObject* Context);
	void Obj_ApproachPatient(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_ApproachPatient(class UObject* Context);
	void SET_ApproachPatient(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_PickUpOrb3(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_PickUpOrb3(class UObject* Context);
	void MCE_INV_LoaderDance(class UObject* Context);
	void Obj_INV_LoaderDance(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_INV_LoaderThrownAtDoor(class UObject* Context);
	void Obj_INV_LoaderThrownAtDoor(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_KillOfficers_Precheck_2(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_KillOfficers_Precheck_1(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_INV_ProceedIn1stMemory_Precheck(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_INV_StairsBottomsMemory2(class UObject* Context);
	void Obj_INV_StairsBottomsMemory2(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_INV_To2ndDoor_Intercom(class UObject* Context);
	void Obj_INV_To2ndDoor_Intercom(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_INV_SequencerStatue(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_INV_SequencerStatue(class UObject* Context);
	void Obj_INV_MaskVisibleOnStatue(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_INV_MaskVisibleOnStatue(class UObject* Context);
	void MCE_KillConstructorChief(class UObject* Context);
	void Obj_KillConstructorChief(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_KillConstructorSergeant(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_KillConstructorSergeant(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_SecureSecretLair(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_GoToSecretLair(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_INV_OpenWhiteDoor(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_INV_OpenWhiteDoor(class UObject* Context);
	void Obj_GoToHyperionDoor(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_GoToHyperionDoor(class UObject* Context);
	void Obj_PlaceMask(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_PlaceMask(class UObject* Context);
	void SET_PlaceMask(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_FindLoaderLegs(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_StandBack(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_FindLoaderArms(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_FindLoaderArms(class UObject* Context);
	void Obj_FindChest(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_FindChest(class UObject* Context);
	void Obj_FindEye(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_FindEye(class UObject* Context);
	void Obj_PickUpEye(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_PickUpEye(class UObject* Context);
	void Obj_PickUpChest(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_AssembleLoaderBot(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_PickUpChest(class UObject* Context);
	void MissionKickoff();
	void MCE_INV_WaitForGas(class UObject* Context);
	void Obj_INV_WaitForGas(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_AssembleLoaderBot(class UObject* Context);
	void MCE_Open2ndDoor(class UObject* Context);
	void Obj_Open2ndDoor(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_To2ndDoor(class UObject* Context);
	void Obj_To2ndDoor(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_To2ndDoor(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void MCE_INV_SlamTrapDoor(class UObject* Context);
	void Obj_INV_SlamTrapDoor(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_GatherParts(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_GatherParts(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_ProceedIn1stMemory(class UObject* Context);
	void Obj_ProceedIn1stMemory(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_TurnOffPowerThwart(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_EnterWhiteRoom(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_PickUpMask(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_AssembleLeftLeg(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_OpenCage(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_TitleCardBoss(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void _Obj_AssembleLoaderBot_Objective__PROXY();
	void Obj_AssembleRightLeg(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_TitleCardBoss(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_ToBossArea(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_WaitOnTheTwoKriegs(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_WaitOnTheTwoKriegs(class UObject* Context);
	void SET_WaitOnTheTwoKriegs(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_ToKriegMoment(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_ToKriegMoment(class UObject* Context);
	void SET_ToKriegMoment(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_ExitSecondMemory(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_KillCorrosiveBadasses(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_AssembleChest(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_DeactivateGas(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_DeactivateGas(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void _Obj_AssembleLoaderBot_Objective__PROXY_0();
	void MCE_KillHyperionOfficers(class UObject* Context);
	void Obj_KillHyperionOfficers(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_KillHyperionOfficers(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_INV_AssembleArmsAndEye(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_AssembleArmsAndEye(class UObject* Context);
	void MCE_ProgressToHyperionRoom(class UObject* Context);
	void Obj_ProgressToHyperionRoom(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_ProgressToHyperionRoom(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_AssembleLeftArm(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_AssembleLeftArm(class UObject* Context);
	void MCE_DeactivateGasThwart(class UObject* Context);
	void Obj_DeactivateGasThwart(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_DeactivateGasThwart(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_AssembleRightArm(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_AssembleRightArm(class UObject* Context);
	void MCE_ToSecondMemory(class UObject* Context);
	void Obj_ToSecondMemory(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_AssembleEye(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_AssembleEye(class UObject* Context);
	void MCE_ToFirstGate(class UObject* Context);
	void Obj_ToFirstGate(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_ToFirstGate(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void MCE_ExitFirstMemory(class UObject* Context);
	void Obj_ExitFirstMemory(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_ExitFirstMemory(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void MCE_INV_ThirdPowerSource(class UObject* Context);
	void Obj_INV_ThirdPowerSource(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_INV_SecondPowerSource(class UObject* Context);
	void Obj_INV_SecondPowerSource(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_INV_FirstPowerSource(class UObject* Context);
	void Obj_INV_FirstPowerSource(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MCE_RemovePowerFromMachine(class UObject* Context);
	void Obj_RemovePowerFromMachine(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_GoToElectrifiedDoor(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_GoToElectrifiedDoor(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void Obj_FreeKrieg(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void SET_WaitForLoaderBot(EMissionObjectiveSetEvent ObjectiveSetEvent);
	void MCE_WaitForLoaderBot(class UObject* Context);
	void Obj_WaitForLoaderBot(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"ALI_EP04_C">();
	}
	static class UALI_EP04_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UALI_EP04_C>();
	}
};
static_assert(alignof(UALI_EP04_C) == 0x000008, "Wrong alignment on UALI_EP04_C");
static_assert(sizeof(UALI_EP04_C) == 0x0008E0, "Wrong size on UALI_EP04_C");
static_assert(offsetof(UALI_EP04_C, UberGraphFrame) == 0x0004F8, "Member 'UALI_EP04_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_GoToExperiment_ObjSetVar) == 0x000500, "Member 'UALI_EP04_C::SET_GoToExperiment_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_GoToExperiment_ObjVar) == 0x000508, "Member 'UALI_EP04_C::Obj_GoToExperiment_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_EnterHyperionLab_ObjSetVar) == 0x000510, "Member 'UALI_EP04_C::SET_EnterHyperionLab_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_EnterHyperionLab_ObjVar) == 0x000518, "Member 'UALI_EP04_C::Obj_EnterHyperionLab_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_FindLoaderLegs_ObjVar) == 0x000520, "Member 'UALI_EP04_C::Obj_FindLoaderLegs_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_FindLoaderArms_ObjVar) == 0x000528, "Member 'UALI_EP04_C::Obj_FindLoaderArms_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_FindChest_ObjVar) == 0x000530, "Member 'UALI_EP04_C::Obj_FindChest_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_FindEye_ObjVar) == 0x000538, "Member 'UALI_EP04_C::Obj_FindEye_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_PickUpEye_ObjVar) == 0x000540, "Member 'UALI_EP04_C::Obj_PickUpEye_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_PickUpChest_ObjVar) == 0x000548, "Member 'UALI_EP04_C::Obj_PickUpChest_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_PickUpLoaderArms_ObjVar) == 0x000550, "Member 'UALI_EP04_C::Obj_PickUpLoaderArms_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_PickUpLoaderLegs_ObjVar) == 0x000558, "Member 'UALI_EP04_C::Obj_PickUpLoaderLegs_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_PickUpOrb3_ObjSetVar) == 0x000560, "Member 'UALI_EP04_C::SET_PickUpOrb3_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_PickUpOrb3_ObjVar) == 0x000568, "Member 'UALI_EP04_C::Obj_PickUpOrb3_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_PlaceOrb_ObjSetVar) == 0x000570, "Member 'UALI_EP04_C::SET_PlaceOrb_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_PlaceOrb_ObjVar) == 0x000578, "Member 'UALI_EP04_C::Obj_PlaceOrb_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_GoToHyperionDoor_ObjSetVar) == 0x000580, "Member 'UALI_EP04_C::SET_GoToHyperionDoor_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_GoToHyperionDoor_ObjVar) == 0x000588, "Member 'UALI_EP04_C::Obj_GoToHyperionDoor_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_GatherParts_ObjSetVar) == 0x000590, "Member 'UALI_EP04_C::SET_GatherParts_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_GatherParts_ObjVar) == 0x000598, "Member 'UALI_EP04_C::Obj_GatherParts_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_AssembleLoaderBot_ObjSetVar) == 0x0005A0, "Member 'UALI_EP04_C::SET_AssembleLoaderBot_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_AssembleLoaderBot_ObjVar) == 0x0005A8, "Member 'UALI_EP04_C::Obj_AssembleLoaderBot_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_AssembleLoaderBotLegs_ObjSetVar) == 0x0005B0, "Member 'UALI_EP04_C::SET_AssembleLoaderBotLegs_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_AssembleLeftLeg_ObjVar) == 0x0005B8, "Member 'UALI_EP04_C::Obj_AssembleLeftLeg_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_AssembleRightLeg_ObjVar) == 0x0005C0, "Member 'UALI_EP04_C::Obj_AssembleRightLeg_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_AssembleChest_ObjVar) == 0x0005C8, "Member 'UALI_EP04_C::Obj_AssembleChest_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_AssembleLoaderChest_ObjSetVar) == 0x0005D0, "Member 'UALI_EP04_C::SET_AssembleLoaderChest_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_AssembleArmsAndEye_ObjVar) == 0x0005D8, "Member 'UALI_EP04_C::Obj_INV_AssembleArmsAndEye_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_AssembleLeftArm_ObjVar) == 0x0005E0, "Member 'UALI_EP04_C::Obj_AssembleLeftArm_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_AssembleRightArm_ObjVar) == 0x0005E8, "Member 'UALI_EP04_C::Obj_AssembleRightArm_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_AssembleEye_ObjVar) == 0x0005F0, "Member 'UALI_EP04_C::Obj_AssembleEye_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_WaitForLoaderBot_ObjSetVar) == 0x0005F8, "Member 'UALI_EP04_C::SET_WaitForLoaderBot_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_WaitForLoaderBot_ObjVar) == 0x000600, "Member 'UALI_EP04_C::Obj_WaitForLoaderBot_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_FreeKrieg_ObjSetVar) == 0x000608, "Member 'UALI_EP04_C::SET_FreeKrieg_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_FreeKrieg_ObjVar) == 0x000610, "Member 'UALI_EP04_C::Obj_FreeKrieg_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_GoToElectrifiedDoor_ObjSetVar) == 0x000618, "Member 'UALI_EP04_C::SET_GoToElectrifiedDoor_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_GoToElectrifiedDoor_ObjVar) == 0x000620, "Member 'UALI_EP04_C::Obj_GoToElectrifiedDoor_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_RemovePowerFromMachine_ObjSetVar) == 0x000628, "Member 'UALI_EP04_C::SET_RemovePowerFromMachine_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_RemovePowerFromMachine_ObjVar) == 0x000630, "Member 'UALI_EP04_C::Obj_RemovePowerFromMachine_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_FirstPowerSource_ObjVar) == 0x000638, "Member 'UALI_EP04_C::Obj_INV_FirstPowerSource_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_SecondPowerSource_ObjVar) == 0x000640, "Member 'UALI_EP04_C::Obj_INV_SecondPowerSource_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_ThirdPowerSource_ObjVar) == 0x000648, "Member 'UALI_EP04_C::Obj_INV_ThirdPowerSource_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_ExitFirstMemory_ObjSetVar) == 0x000650, "Member 'UALI_EP04_C::SET_ExitFirstMemory_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_ExitFirstMemory_ObjVar) == 0x000658, "Member 'UALI_EP04_C::Obj_ExitFirstMemory_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_ToFirstGate_ObjSetVar) == 0x000660, "Member 'UALI_EP04_C::SET_ToFirstGate_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_ToFirstGate_ObjVar) == 0x000668, "Member 'UALI_EP04_C::Obj_ToFirstGate_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_OpenFirstGate_ObjVar) == 0x000670, "Member 'UALI_EP04_C::Obj_OpenFirstGate_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_ToSecondMemory_ObjSetVar) == 0x000678, "Member 'UALI_EP04_C::SET_ToSecondMemory_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_ToSecondMemory_ObjVar) == 0x000680, "Member 'UALI_EP04_C::Obj_ToSecondMemory_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_DeactivateGasThwart_ObjSetVar) == 0x000688, "Member 'UALI_EP04_C::SET_DeactivateGasThwart_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_DeactivateGasThwart_ObjVar) == 0x000690, "Member 'UALI_EP04_C::Obj_DeactivateGasThwart_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_ProgressToHyperionRoom_ObjSetVar) == 0x000698, "Member 'UALI_EP04_C::SET_ProgressToHyperionRoom_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_ProgressToHyperionRoom_ObjVar) == 0x0006A0, "Member 'UALI_EP04_C::Obj_ProgressToHyperionRoom_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_KillHyperionOfficers_ObjSetVar) == 0x0006A8, "Member 'UALI_EP04_C::SET_KillHyperionOfficers_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_KillHyperionOfficers_ObjVar) == 0x0006B0, "Member 'UALI_EP04_C::Obj_KillHyperionOfficers_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_DeactivateGas_ObjSetVar) == 0x0006B8, "Member 'UALI_EP04_C::SET_DeactivateGas_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_DeactivateGas_ObjVar) == 0x0006C0, "Member 'UALI_EP04_C::Obj_DeactivateGas_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_KillBerserkPatients_ObjSetVar) == 0x0006C8, "Member 'UALI_EP04_C::SET_KillBerserkPatients_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_KillBerserkPatients_ObjVar) == 0x0006D0, "Member 'UALI_EP04_C::Obj_KillBerserkPatients_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_KillCorrosiveBadasses_ObjSetVar) == 0x0006D8, "Member 'UALI_EP04_C::SET_KillCorrosiveBadasses_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_KillCorrosiveBadasses_ObjVar) == 0x0006E0, "Member 'UALI_EP04_C::Obj_KillCorrosiveBadasses_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_ExitSecondMemory_ObjSetVar) == 0x0006E8, "Member 'UALI_EP04_C::SET_ExitSecondMemory_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_ExitSecondMemory_ObjVar) == 0x0006F0, "Member 'UALI_EP04_C::Obj_ExitSecondMemory_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_ToKriegMoment_ObjSetVar) == 0x0006F8, "Member 'UALI_EP04_C::SET_ToKriegMoment_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_ToKriegMoment_ObjVar) == 0x000700, "Member 'UALI_EP04_C::Obj_ToKriegMoment_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_WaitOnTheTwoKriegs_ObjSetVar) == 0x000708, "Member 'UALI_EP04_C::SET_WaitOnTheTwoKriegs_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_WaitOnTheTwoKriegs_ObjVar) == 0x000710, "Member 'UALI_EP04_C::Obj_WaitOnTheTwoKriegs_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_ToBossArea_ObjSetVar) == 0x000718, "Member 'UALI_EP04_C::SET_ToBossArea_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_ToBossArea_ObjVar) == 0x000720, "Member 'UALI_EP04_C::Obj_ToBossArea_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_TitleCardBoss_ObjSetVar) == 0x000728, "Member 'UALI_EP04_C::SET_TitleCardBoss_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_TitleCardBoss_ObjVar) == 0x000730, "Member 'UALI_EP04_C::Obj_TitleCardBoss_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Set_KillBoss_ObjSetVar) == 0x000738, "Member 'UALI_EP04_C::Set_KillBoss_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_KillBoss_ObjVar) == 0x000740, "Member 'UALI_EP04_C::Obj_KillBoss_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_OpenCage_ObjVar) == 0x000748, "Member 'UALI_EP04_C::Obj_OpenCage_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_PickUpMask_ObjSetVar) == 0x000750, "Member 'UALI_EP04_C::SET_PickUpMask_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_PickUpMask_ObjVar) == 0x000758, "Member 'UALI_EP04_C::Obj_PickUpMask_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_EnterWhiteRoom_ObjSetVar) == 0x000760, "Member 'UALI_EP04_C::SET_EnterWhiteRoom_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_EnterWhiteRoom_ObjVar) == 0x000768, "Member 'UALI_EP04_C::Obj_EnterWhiteRoom_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_ReturnToSanctum_ObjSetVar) == 0x000770, "Member 'UALI_EP04_C::SET_ReturnToSanctum_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_ReturnToSanctum_ObjVar) == 0x000778, "Member 'UALI_EP04_C::Obj_ReturnToSanctum_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_TurnOffPowerThwart_ObjSetVar) == 0x000780, "Member 'UALI_EP04_C::SET_TurnOffPowerThwart_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_TurnOffPowerThwart_ObjVar) == 0x000788, "Member 'UALI_EP04_C::Obj_TurnOffPowerThwart_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_ProceedIn1stMemory_ObjSetVar) == 0x000790, "Member 'UALI_EP04_C::SET_ProceedIn1stMemory_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_ProceedIn1stMemory_ObjVar) == 0x000798, "Member 'UALI_EP04_C::Obj_ProceedIn1stMemory_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_SlamTrapDoor_ObjVar) == 0x0007A0, "Member 'UALI_EP04_C::Obj_INV_SlamTrapDoor_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_To2ndDoor_ObjSetVar) == 0x0007A8, "Member 'UALI_EP04_C::SET_To2ndDoor_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_To2ndDoor_ObjVar) == 0x0007B0, "Member 'UALI_EP04_C::Obj_To2ndDoor_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_Open2ndDoor_ObjVar) == 0x0007B8, "Member 'UALI_EP04_C::Obj_Open2ndDoor_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_WaitForGas_ObjVar) == 0x0007C0, "Member 'UALI_EP04_C::Obj_INV_WaitForGas_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_TalkToKrieg_ObjSetVar) == 0x0007C8, "Member 'UALI_EP04_C::SET_TalkToKrieg_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_TalkToKrieg_ObjVar) == 0x0007D0, "Member 'UALI_EP04_C::Obj_TalkToKrieg_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_StandBack_ObjSetVar) == 0x0007D8, "Member 'UALI_EP04_C::SET_StandBack_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_StandBack_ObjVar) == 0x0007E0, "Member 'UALI_EP04_C::Obj_StandBack_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_PlaceMask_ObjSetVar) == 0x0007E8, "Member 'UALI_EP04_C::SET_PlaceMask_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_PlaceMask_ObjVar) == 0x0007F0, "Member 'UALI_EP04_C::Obj_PlaceMask_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_OpenWhiteDoor_ObjVar) == 0x0007F8, "Member 'UALI_EP04_C::Obj_INV_OpenWhiteDoor_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_GoToSecretLair_ObjSetVar) == 0x000800, "Member 'UALI_EP04_C::SET_GoToSecretLair_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_GoToSecretLair_ObjVar) == 0x000808, "Member 'UALI_EP04_C::Obj_GoToSecretLair_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_SecureSecretLair_ObjSetVar) == 0x000810, "Member 'UALI_EP04_C::SET_SecureSecretLair_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_SecureSecretLair_ObjVar) == 0x000818, "Member 'UALI_EP04_C::Obj_SecureSecretLair_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_KillConstructorSergeant_ObjSetVar) == 0x000820, "Member 'UALI_EP04_C::SET_KillConstructorSergeant_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_KillConstructorSergeant_ObjVar) == 0x000828, "Member 'UALI_EP04_C::Obj_KillConstructorSergeant_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_KillConstructorChief_ObjSetVar) == 0x000830, "Member 'UALI_EP04_C::SET_KillConstructorChief_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_KillConstructorChief_ObjVar) == 0x000838, "Member 'UALI_EP04_C::Obj_KillConstructorChief_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_MaskVisibleOnStatue_ObjVar) == 0x000840, "Member 'UALI_EP04_C::Obj_INV_MaskVisibleOnStatue_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_SequencerStatue_ObjVar) == 0x000848, "Member 'UALI_EP04_C::Obj_INV_SequencerStatue_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_To2ndDoor_Intercom_ObjVar) == 0x000850, "Member 'UALI_EP04_C::Obj_INV_To2ndDoor_Intercom_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_StairsBottomsMemory2_ObjVar) == 0x000858, "Member 'UALI_EP04_C::Obj_INV_StairsBottomsMemory2_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_ProceedIn1stMemory_Precheck_ObjVar) == 0x000860, "Member 'UALI_EP04_C::Obj_INV_ProceedIn1stMemory_Precheck_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_KillOfficers_Precheck_1_ObjVar) == 0x000868, "Member 'UALI_EP04_C::Obj_KillOfficers_Precheck_1_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_KillOfficers_Precheck_2_ObjVar) == 0x000870, "Member 'UALI_EP04_C::Obj_KillOfficers_Precheck_2_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_LoaderThrownAtDoor_ObjVar) == 0x000878, "Member 'UALI_EP04_C::Obj_INV_LoaderThrownAtDoor_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_LoaderDance_ObjVar) == 0x000880, "Member 'UALI_EP04_C::Obj_INV_LoaderDance_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_ApproachPatient_ObjSetVar) == 0x000888, "Member 'UALI_EP04_C::SET_ApproachPatient_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_ApproachPatient_ObjVar) == 0x000890, "Member 'UALI_EP04_C::Obj_ApproachPatient_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_GhostsAppear_ObjVar) == 0x000898, "Member 'UALI_EP04_C::Obj_INV_GhostsAppear_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_WhiteRoomSequenceEnded_ObjVar) == 0x0008A0, "Member 'UALI_EP04_C::Obj_INV_WhiteRoomSequenceEnded_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, SET_Kickoff_ObjSetVar) == 0x0008A8, "Member 'UALI_EP04_C::SET_Kickoff_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, INV_Obj_ReadyForOrb_ObjVar) == 0x0008B0, "Member 'UALI_EP04_C::INV_Obj_ReadyForOrb_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_ExitMemory_Precheck_ObjVar) == 0x0008B8, "Member 'UALI_EP04_C::Obj_INV_ExitMemory_Precheck_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_SecureSecretLair_INV_ObjVar) == 0x0008C0, "Member 'UALI_EP04_C::Obj_SecureSecretLair_INV_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_ExitSecondMemory_Precheck_ObjVar) == 0x0008C8, "Member 'UALI_EP04_C::Obj_ExitSecondMemory_Precheck_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_INV_ReachCombatSanitarium_Precheck_ObjVar) == 0x0008D0, "Member 'UALI_EP04_C::Obj_INV_ReachCombatSanitarium_Precheck_ObjVar' has a wrong offset!");
static_assert(offsetof(UALI_EP04_C, Obj_GoToSecretLair_Precheck_ObjVar) == 0x0008D8, "Member 'UALI_EP04_C::Obj_GoToSecretLair_Precheck_ObjVar' has a wrong offset!");
