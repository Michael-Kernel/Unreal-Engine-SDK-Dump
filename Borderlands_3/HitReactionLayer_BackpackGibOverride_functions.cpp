...
#include "HitReactionLayer_BackpackGibOverride_classes.hpp"
#include "HitReactionLayer_BackpackGibOverride_parameters.hpp"
...
void UHitReactionLayer_BackpackGibOverride_C::CalcHealthPercent(class UOakDamageComponent* Receiver, float Damage_Amount, float* Damage_Percent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HitReactionLayer_BackpackGibOverride_C", "CalcHealthPercent");

	Params::HitReactionLayer_BackpackGibOverride_C_CalcHealthPercent Parms{};
...
class UHitReactionTag* UHitReactionLayer_BackpackGibOverride_C::EvaluateTag(class UDamageComponent* Receiver, class UDamageCauserComponent* Causer, float DamageAmount, const class UGbxDamageType* DamageType, const class UDamageSource* DamageSource, class UHitRegionData* HitRegion, float Force, class UHitReactionTag* PreviousTag) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HitReactionLayer_BackpackGibOverride_C", "EvaluateTag");

	Params::HitReactionLayer_BackpackGibOverride_C_EvaluateTag Parms{};
