...
class IMediaAudioSinkProviderInterface final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MediaAudioSinkProviderInterface">();
	}
	static class IMediaAudioSinkProviderInterface* GetDefaultObj()
	{
		return GetDefaultObjImpl<IMediaAudioSinkProviderInterface>();
	}
};
static_assert(alignof(IMediaAudioSinkProviderInterface) == 0x000008, "Wrong alignment on IMediaAudioSinkProviderInterface");
static_assert(sizeof(IMediaAudioSinkProviderInterface) == 0x000028, "Wrong size on IMediaAudioSinkProviderInterface");
...
public:
	...
	TScriptInterface<class IMediaAudioSinkProviderInterface> AudioSinkProvider;                                 // 0x00F8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
public:
	...
	void SetAudioSinkProvider(TScriptInterface<class IMediaAudioSinkProviderInterface> NewSinkProvider);
...
static_assert(sizeof(UMediaPlayer) == 0x000148, "Wrong size on UMediaPlayer");
...
static_assert(offsetof(UMediaPlayer, AudioSinkProvider) == 0x0000F8, "Member 'UMediaPlayer::AudioSinkProvider' has a wrong offset!");
static_assert(offsetof(UMediaPlayer, PlayerGuid) == 0x000130, "Member 'UMediaPlayer::PlayerGuid' has a wrong offset!");
...
{
public:
	EMediaSoundChannels                           Channels;                                          // 0x0650(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_678[0x78];                                     // 0x0678(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMediaSoundComponent) == 0x0006F0, "Wrong size on UMediaSoundComponent");
static_assert(offsetof(UMediaSoundComponent, Channels) == 0x000650, "Member 'UMediaSoundComponent::Channels' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, DynamicRateAdjustment) == 0x000654, "Member 'UMediaSoundComponent::DynamicRateAdjustment' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, RateAdjustmentFactor) == 0x000658, "Member 'UMediaSoundComponent::RateAdjustmentFactor' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, RateAdjustmentRange) == 0x00065C, "Member 'UMediaSoundComponent::RateAdjustmentRange' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, MediaPlayer) == 0x000670, "Member 'UMediaSoundComponent::MediaPlayer' has a wrong offset!");
