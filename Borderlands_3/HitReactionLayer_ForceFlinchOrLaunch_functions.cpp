...
#include "HitReactionLayer_ForceFlinchOrLaunch_classes.hpp"
#include "HitReactionLayer_ForceFlinchOrLaunch_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_ForceFlinchOrLaunch_C::EvaluateTag(class UDamageComponent* Receiver, class UDamageCauserComponent* Causer, float DamageAmount, const class UGbxDamageType* DamageType, const class UDamageSource* DamageSource, class UHitRegionData* HitRegion, float Force, class UHitReactionTag* PreviousTag) const
{
	...
	Params::HitReactionLayer_ForceFlinchOrLaunch_C_EvaluateTag Parms{};
