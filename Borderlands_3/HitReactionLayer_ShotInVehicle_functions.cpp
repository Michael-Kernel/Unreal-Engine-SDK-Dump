...
#include "HitReactionLayer_ShotInVehicle_classes.hpp"
#include "HitReactionLayer_ShotInVehicle_parameters.hpp"
...
class UHitReactionTag* UHitReactionLayer_ShotInVehicle_C::EvaluateTag(class UDamageComponent* Receiver, class UDamageCauserComponent* Causer, float DamageAmount, const class UGbxDamageType* DamageType, const class UDamageSource* DamageSource, class UHitRegionData* HitRegion, float Force, class UHitReactionTag* PreviousTag) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HitReactionLayer_ShotInVehicle_C", "EvaluateTag");

	Params::HitReactionLayer_ShotInVehicle_C_EvaluateTag Parms{};
