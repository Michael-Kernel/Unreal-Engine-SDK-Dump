...
#include "BP_GM_Payload_Chupa_classes.hpp"
#include "BP_GM_Payload_Chupa_parameters.hpp"
...
void UBP_GM_Payload_Chupa_C::K2_GrenadeStuckTo(class AGrenade* Grenade, class AGrenadeMod* GrenadeMod, class AActor* StickTarget, struct FPayloadInstanceData& InstanceData, const struct FHitResult& HitResult) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GM_Payload_Chupa_C", "K2_GrenadeStuckTo");

	Params::BP_GM_Payload_Chupa_C_K2_GrenadeStuckTo Parms{};
