...
{
public:
	uint8                                         Pad_28[0x6F0];                                     // 0x0028(0x06F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x000718, "Wrong size on UAssetRegistryImpl");
