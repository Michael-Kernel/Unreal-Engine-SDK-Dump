...
static_assert(offsetof(UTimeSynchronizationSource, NumberOfExtraBufferedFrame) == 0x00002C, "Member 'UTimeSynchronizationSource::NumberOfExtraBufferedFrame' has a wrong offset!");
static_assert(offsetof(UTimeSynchronizationSource, TimeDelay) == 0x000030, "Member 'UTimeSynchronizationSource::TimeDelay' has a wrong offset!");
