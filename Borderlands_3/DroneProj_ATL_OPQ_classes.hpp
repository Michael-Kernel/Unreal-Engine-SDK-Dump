...
class ADroneProj_ATL_OPQ_C final : public AOakDroneProjectile
{
public:
...
public:
	void ExecuteUbergraph_DroneProj_ATL_OPQ(int32 EntryPoint);
	void OnBeginExplode();
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"DroneProj_ATL_OPQ_C">();
	}
	static class ADroneProj_ATL_OPQ_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ADroneProj_ATL_OPQ_C>();
	}
};
static_assert(alignof(ADroneProj_ATL_OPQ_C) == 0x000008, "Wrong alignment on ADroneProj_ATL_OPQ_C");
static_assert(sizeof(ADroneProj_ATL_OPQ_C) == 0x0007A0, "Wrong size on ADroneProj_ATL_OPQ_C");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, UberGraphFrame) == 0x000730, "Member 'ADroneProj_ATL_OPQ_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, Audio_drone_lp) == 0x000738, "Member 'ADroneProj_ATL_OPQ_C::Audio_drone_lp' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, Muzzle) == 0x000740, "Member 'ADroneProj_ATL_OPQ_C::Muzzle' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, Booster_FX) == 0x000748, "Member 'ADroneProj_ATL_OPQ_C::Booster_FX' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, MyBody) == 0x000750, "Member 'ADroneProj_ATL_OPQ_C::MyBody' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, CachedWeaponFireWwiseEvent) == 0x000758, "Member 'ADroneProj_ATL_OPQ_C::CachedWeaponFireWwiseEvent' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, DamageType) == 0x000760, "Member 'ADroneProj_ATL_OPQ_C::DamageType' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, DamageSource) == 0x000768, "Member 'ADroneProj_ATL_OPQ_C::DamageSource' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, TargetLocation) == 0x000770, "Member 'ADroneProj_ATL_OPQ_C::TargetLocation' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, BulletDamage) == 0x00077C, "Member 'ADroneProj_ATL_OPQ_C::BulletDamage' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, FireRate) == 0x000780, "Member 'ADroneProj_ATL_OPQ_C::FireRate' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, Weapon) == 0x000788, "Member 'ADroneProj_ATL_OPQ_C::Weapon' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, LoadedAmmo) == 0x000790, "Member 'ADroneProj_ATL_OPQ_C::LoadedAmmo' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, MaxAmmo) == 0x000794, "Member 'ADroneProj_ATL_OPQ_C::MaxAmmo' has a wrong offset!");
static_assert(offsetof(ADroneProj_ATL_OPQ_C, OPQWeap) == 0x000798, "Member 'ADroneProj_ATL_OPQ_C::OPQWeap' has a wrong offset!");
