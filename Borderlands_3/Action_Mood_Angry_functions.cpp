...
#include "Action_Mood_Angry_classes.hpp"
#include "Action_Mood_Angry_parameters.hpp"
...
void UAction_Mood_Angry_C::ExecuteUbergraph_Action_Mood_Angry(int32 EntryPoint)
{
	...
	Params::Action_Mood_Angry_C_ExecuteUbergraph_Action_Mood_Angry Parms{};
...
void UAction_Mood_Angry_C::OnBegin(class AActor* Actor)
{
	...
	Params::Action_Mood_Angry_C_OnBegin Parms{};
