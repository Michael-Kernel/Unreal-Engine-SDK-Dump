...
// NumValues: 0x0003
enum class EScreenSizeSelection : uint8
{
	Custom                                   = 0,
	Preset                                   = 1,
...
struct alignas(0x08) FScreenSizeSelection final
{
public:
...
static_assert(alignof(FScreenSizeSelection) == 0x000008, "Wrong alignment on FScreenSizeSelection");
static_assert(sizeof(FScreenSizeSelection) == 0x000018, "Wrong size on FScreenSizeSelection");
static_assert(offsetof(FScreenSizeSelection, Selection) == 0x000000, "Member 'FScreenSizeSelection::Selection' has a wrong offset!");
static_assert(offsetof(FScreenSizeSelection, Preset) == 0x000008, "Member 'FScreenSizeSelection::Preset' has a wrong offset!");
static_assert(offsetof(FScreenSizeSelection, ScreenSize) == 0x000010, "Member 'FScreenSizeSelection::ScreenSize' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_SkeletalControlBase) == 0x000140, "Wrong size on FAnimNode_SkeletalControlBase");
...
static_assert(offsetof(FAnimNode_SkeletalControlBase, LODThreshold) == 0x000048, "Member 'FAnimNode_SkeletalControlBase::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, ActualAlpha) == 0x00004C, "Member 'FAnimNode_SkeletalControlBase::ActualAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, AlphaInputType) == 0x000050, "Member 'FAnimNode_SkeletalControlBase::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, Alpha) == 0x000054, "Member 'FAnimNode_SkeletalControlBase::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, AlphaScaleBias) == 0x000058, "Member 'FAnimNode_SkeletalControlBase::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, bAlphaBoolEnabled) == 0x000060, "Member 'FAnimNode_SkeletalControlBase::bAlphaBoolEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, AlphaBoolBlend) == 0x000068, "Member 'FAnimNode_SkeletalControlBase::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, AlphaCurveName) == 0x0000C0, "Member 'FAnimNode_SkeletalControlBase::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, AlphaScaleBiasClamp) == 0x0000C8, "Member 'FAnimNode_SkeletalControlBase::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, LODInterpolationSpeed) == 0x000104, "Member 'FAnimNode_SkeletalControlBase::LODInterpolationSpeed' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, bBoolAlpha) == 0x000118, "Member 'FAnimNode_SkeletalControlBase::bBoolAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, bInvertAlpha) == 0x000119, "Member 'FAnimNode_SkeletalControlBase::bInvertAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, ScreenSizeThreshold) == 0x000120, "Member 'FAnimNode_SkeletalControlBase::ScreenSizeThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_SkeletalControlBase, bUseScreenSizeThreshold) == 0x000138, "Member 'FAnimNode_SkeletalControlBase::bUseScreenSizeThreshold' has a wrong offset!");
...
public:
	...
	int32                                         MaxIterations;                                     // 0x022C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_Fabrik) == 0x000240, "Wrong size on FAnimNode_Fabrik");
static_assert(offsetof(FAnimNode_Fabrik, EffectorTransform) == 0x000140, "Member 'FAnimNode_Fabrik::EffectorTransform' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, EffectorTransformSpace) == 0x000170, "Member 'FAnimNode_Fabrik::EffectorTransformSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, EffectorTransformBone) == 0x000178, "Member 'FAnimNode_Fabrik::EffectorTransformBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, EffectorTarget) == 0x000190, "Member 'FAnimNode_Fabrik::EffectorTarget' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, EffectorRotationSource) == 0x0001F0, "Member 'FAnimNode_Fabrik::EffectorRotationSource' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, TipBone) == 0x0001F8, "Member 'FAnimNode_Fabrik::TipBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, RootBone) == 0x000210, "Member 'FAnimNode_Fabrik::RootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, Precision) == 0x000228, "Member 'FAnimNode_Fabrik::Precision' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, MaxIterations) == 0x00022C, "Member 'FAnimNode_Fabrik::MaxIterations' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, bEnableDebugDraw) == 0x000230, "Member 'FAnimNode_Fabrik::bEnableDebugDraw' has a wrong offset!");
...
static_assert(sizeof(FAngularRangeLimit) == 0x000030, "Wrong size on FAngularRangeLimit");
...
static_assert(sizeof(FAnimNode_ApplyLimits) == 0x000160, "Wrong size on FAnimNode_ApplyLimits");
static_assert(offsetof(FAnimNode_ApplyLimits, AngularRangeLimits) == 0x000140, "Member 'FAnimNode_ApplyLimits::AngularRangeLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyLimits, AngularOffsets) == 0x000150, "Member 'FAnimNode_ApplyLimits::AngularOffsets' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_RotationMultiplier) == 0x000178, "Wrong size on FAnimNode_RotationMultiplier");
static_assert(offsetof(FAnimNode_RotationMultiplier, TargetBone) == 0x000140, "Member 'FAnimNode_RotationMultiplier::TargetBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationMultiplier, SourceBone) == 0x000158, "Member 'FAnimNode_RotationMultiplier::SourceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationMultiplier, Multiplier) == 0x000170, "Member 'FAnimNode_RotationMultiplier::Multiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationMultiplier, RotationAxisToRefer) == 0x000174, "Member 'FAnimNode_RotationMultiplier::RotationAxisToRefer' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationMultiplier, bIsAdditive) == 0x000175, "Member 'FAnimNode_RotationMultiplier::bIsAdditive' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ModifyCurve) == 0x000088, "Wrong size on FAnimNode_ModifyCurve");
...
static_assert(offsetof(FAnimNode_ModifyCurve, LastCurveValues) == 0x000060, "Member 'FAnimNode_ModifyCurve::LastCurveValues' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyCurve, CurveNames) == 0x000070, "Member 'FAnimNode_ModifyCurve::CurveNames' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyCurve, Alpha) == 0x000080, "Member 'FAnimNode_ModifyCurve::Alpha' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_BlendSpacePlayer) == 0x000160, "Wrong size on FAnimNode_BlendSpacePlayer");
...
static_assert(offsetof(FAnimNode_BlendSpacePlayer, bResetPlayTimeWhenBlendSpaceChanges) == 0x000088, "Member 'FAnimNode_BlendSpacePlayer::bResetPlayTimeWhenBlendSpaceChanges' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, BlendFilter) == 0x000090, "Member 'FAnimNode_BlendSpacePlayer::BlendFilter' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, BlendSampleDataCache) == 0x000120, "Member 'FAnimNode_BlendSpacePlayer::BlendSampleDataCache' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, PreviousBlendSpace) == 0x000130, "Member 'FAnimNode_BlendSpacePlayer::PreviousBlendSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, bUseRateScaleSpeed) == 0x000138, "Member 'FAnimNode_BlendSpacePlayer::bUseRateScaleSpeed' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, RateScaleSpeed) == 0x00013C, "Member 'FAnimNode_BlendSpacePlayer::RateScaleSpeed' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, GaitScalingData) == 0x000140, "Member 'FAnimNode_BlendSpacePlayer::GaitScalingData' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, SpeedBlendspaceAxis) == 0x000158, "Member 'FAnimNode_BlendSpacePlayer::SpeedBlendspaceAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer, bCalcStartPositionFromCurrentPose) == 0x000159, "Member 'FAnimNode_BlendSpacePlayer::bCalcStartPositionFromCurrentPose' has a wrong offset!");
...
public:
	...
	int32                                         LODThreshold;                                      // 0x0178(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_AimOffsetLookAt) == 0x000260, "Wrong size on FAnimNode_AimOffsetLookAt");
...
static_assert(offsetof(FAnimNode_AimOffsetLookAt, LODThreshold) == 0x000178, "Member 'FAnimNode_AimOffsetLookAt::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, bIsLODEnabled) == 0x00017C, "Member 'FAnimNode_AimOffsetLookAt::bIsLODEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, LookAtLocation) == 0x000180, "Member 'FAnimNode_AimOffsetLookAt::LookAtLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SourceSocketName) == 0x000190, "Member 'FAnimNode_AimOffsetLookAt::SourceSocketName' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, PivotSocketName) == 0x000198, "Member 'FAnimNode_AimOffsetLookAt::PivotSocketName' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SocketAxis) == 0x0001A0, "Member 'FAnimNode_AimOffsetLookAt::SocketAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, Alpha) == 0x0001AC, "Member 'FAnimNode_AimOffsetLookAt::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SocketBoneReference) == 0x0001B0, "Member 'FAnimNode_AimOffsetLookAt::SocketBoneReference' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SocketLocalTransform) == 0x0001D0, "Member 'FAnimNode_AimOffsetLookAt::SocketLocalTransform' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, PivotSocketBoneReference) == 0x000200, "Member 'FAnimNode_AimOffsetLookAt::PivotSocketBoneReference' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, PivotSocketLocalTransform) == 0x000220, "Member 'FAnimNode_AimOffsetLookAt::PivotSocketLocalTransform' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, bUseBlendSpaceWeightInterpolation) == 0x000250, "Member 'FAnimNode_AimOffsetLookAt::bUseBlendSpaceWeightInterpolation' has a wrong offset!");
...
static_assert(sizeof(FConstraint) == 0x000028, "Wrong size on FConstraint");
...
static_assert(sizeof(FAnimNode_PoseHandler) == 0x0000B0, "Wrong size on FAnimNode_PoseHandler");
static_assert(offsetof(FAnimNode_PoseHandler, PoseAsset) == 0x000068, "Member 'FAnimNode_PoseHandler::PoseAsset' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3A[0xAE];                                      // 0x003A(0x00AE)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_CopyPoseFromMesh) == 0x000008, "Wrong alignment on FAnimNode_CopyPoseFromMesh");
static_assert(sizeof(FAnimNode_CopyPoseFromMesh) == 0x0000E8, "Wrong size on FAnimNode_CopyPoseFromMesh");
...
static_assert(offsetof(FAnimNode_CopyPoseFromMesh, bCopyCurves) == 0x000039, "Member 'FAnimNode_CopyPoseFromMesh::bCopyCurves' has a wrong offset!");
...
public:
	...
	int32                                         NumSolverIterationsPreUpdate;                      // 0x01E4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumSolverIterationsPostUpdate;                     // 0x01E8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_28D[0x123];                                    // 0x028D(0x0123)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_AnimDynamics) == 0x000010, "Wrong alignment on FAnimNode_AnimDynamics");
static_assert(sizeof(FAnimNode_AnimDynamics) == 0x0003B0, "Wrong size on FAnimNode_AnimDynamics");
static_assert(offsetof(FAnimNode_AnimDynamics, SimulationSpace) == 0x000140, "Member 'FAnimNode_AnimDynamics::SimulationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, RelativeSpaceBone) == 0x000148, "Member 'FAnimNode_AnimDynamics::RelativeSpaceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bChain) == 0x000160, "Member 'FAnimNode_AnimDynamics::bChain' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, BoundBone) == 0x000168, "Member 'FAnimNode_AnimDynamics::BoundBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ChainEnd) == 0x000180, "Member 'FAnimNode_AnimDynamics::ChainEnd' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, BoxExtents) == 0x000198, "Member 'FAnimNode_AnimDynamics::BoxExtents' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, LocalJointOffset) == 0x0001A4, "Member 'FAnimNode_AnimDynamics::LocalJointOffset' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, GravityScale) == 0x0001B0, "Member 'FAnimNode_AnimDynamics::GravityScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bLinearSpring) == 0x0001B4, "Member 'FAnimNode_AnimDynamics::bLinearSpring' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bAngularSpring) == 0x0001B5, "Member 'FAnimNode_AnimDynamics::bAngularSpring' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, LinearSpringConstant) == 0x0001B8, "Member 'FAnimNode_AnimDynamics::LinearSpringConstant' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, AngularSpringConstant) == 0x0001BC, "Member 'FAnimNode_AnimDynamics::AngularSpringConstant' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bEnableWind) == 0x0001C0, "Member 'FAnimNode_AnimDynamics::bEnableWind' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bWindWasEnabled) == 0x0001C1, "Member 'FAnimNode_AnimDynamics::bWindWasEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, WindScale) == 0x0001C4, "Member 'FAnimNode_AnimDynamics::WindScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bOverrideLinearDamping) == 0x0001C8, "Member 'FAnimNode_AnimDynamics::bOverrideLinearDamping' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, LinearDampingOverride) == 0x0001CC, "Member 'FAnimNode_AnimDynamics::LinearDampingOverride' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bOverrideAngularDamping) == 0x0001D0, "Member 'FAnimNode_AnimDynamics::bOverrideAngularDamping' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, AngularDampingOverride) == 0x0001D4, "Member 'FAnimNode_AnimDynamics::AngularDampingOverride' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bOverrideAngularBias) == 0x0001D8, "Member 'FAnimNode_AnimDynamics::bOverrideAngularBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, AngularBiasOverride) == 0x0001DC, "Member 'FAnimNode_AnimDynamics::AngularBiasOverride' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bDoUpdate) == 0x0001E0, "Member 'FAnimNode_AnimDynamics::bDoUpdate' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bDoEval) == 0x0001E1, "Member 'FAnimNode_AnimDynamics::bDoEval' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, NumSolverIterationsPreUpdate) == 0x0001E4, "Member 'FAnimNode_AnimDynamics::NumSolverIterationsPreUpdate' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, NumSolverIterationsPostUpdate) == 0x0001E8, "Member 'FAnimNode_AnimDynamics::NumSolverIterationsPostUpdate' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ConstraintSetup) == 0x0001EC, "Member 'FAnimNode_AnimDynamics::ConstraintSetup' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bUsePlanarLimit) == 0x000248, "Member 'FAnimNode_AnimDynamics::bUsePlanarLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, PlanarLimits) == 0x000250, "Member 'FAnimNode_AnimDynamics::PlanarLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bUseSphericalLimits) == 0x000260, "Member 'FAnimNode_AnimDynamics::bUseSphericalLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, SphericalLimits) == 0x000268, "Member 'FAnimNode_AnimDynamics::SphericalLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, CollisionType) == 0x000278, "Member 'FAnimNode_AnimDynamics::CollisionType' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, SphereCollisionRadius) == 0x00027C, "Member 'FAnimNode_AnimDynamics::SphereCollisionRadius' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ExternalForce) == 0x000280, "Member 'FAnimNode_AnimDynamics::ExternalForce' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, bForceNoStretch) == 0x00028C, "Member 'FAnimNode_AnimDynamics::bForceNoStretch' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ApplyAdditive) == 0x000118, "Wrong size on FAnimNode_ApplyAdditive");
...
static_assert(offsetof(FAnimNode_ApplyAdditive, AlphaInputType) == 0x000074, "Member 'FAnimNode_ApplyAdditive::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, bAlphaBoolEnabled) == 0x000075, "Member 'FAnimNode_ApplyAdditive::bAlphaBoolEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, AlphaBoolBlend) == 0x000078, "Member 'FAnimNode_ApplyAdditive::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, AlphaCurveName) == 0x0000D0, "Member 'FAnimNode_ApplyAdditive::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, AlphaScaleBiasClamp) == 0x0000D8, "Member 'FAnimNode_ApplyAdditive::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, bBoolAlpha) == 0x000114, "Member 'FAnimNode_ApplyAdditive::bBoolAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, bInvertAlpha) == 0x000115, "Member 'FAnimNode_ApplyAdditive::bInvertAlpha' has a wrong offset!");
...
static_assert(sizeof(FAnimLegIKDefinition) == 0x000048, "Wrong size on FAnimLegIKDefinition");
...
static_assert(offsetof(FAnimLegIKDefinition, HingeRotationAxis) == 0x000035, "Member 'FAnimLegIKDefinition::HingeRotationAxis' has a wrong offset!");
static_assert(offsetof(FAnimLegIKDefinition, bEnableRotationLimit) == 0x000036, "Member 'FAnimLegIKDefinition::bEnableRotationLimit' has a wrong offset!");
...
static_assert(offsetof(FAnimLegIKDefinition, MaxRotationAngle) == 0x00003C, "Member 'FAnimLegIKDefinition::MaxRotationAngle' has a wrong offset!");
static_assert(offsetof(FAnimLegIKDefinition, bEnableKneeTwistCorrection) == 0x000040, "Member 'FAnimLegIKDefinition::bEnableKneeTwistCorrection' has a wrong offset!");
...
public:
	...
	int32                                         MaxIterations;                                     // 0x0144(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_LegIK) == 0x000170, "Wrong size on FAnimNode_LegIK");
static_assert(offsetof(FAnimNode_LegIK, ReachPrecision) == 0x000140, "Member 'FAnimNode_LegIK::ReachPrecision' has a wrong offset!");
static_assert(offsetof(FAnimNode_LegIK, MaxIterations) == 0x000144, "Member 'FAnimNode_LegIK::MaxIterations' has a wrong offset!");
static_assert(offsetof(FAnimNode_LegIK, LegsDefinition) == 0x000148, "Member 'FAnimNode_LegIK::LegsDefinition' has a wrong offset!");
static_assert(offsetof(FAnimNode_LegIK, LegsData) == 0x000158, "Member 'FAnimNode_LegIK::LegsData' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_BlendBoneByChannel) == 0x0000A8, "Wrong size on FAnimNode_BlendBoneByChannel");
...
static_assert(offsetof(FAnimNode_BlendBoneByChannel, bInvertAlpha) == 0x0000A0, "Member 'FAnimNode_BlendBoneByChannel::bInvertAlpha' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_MultiWayBlend) == 0x000080, "Wrong size on FAnimNode_MultiWayBlend");
...
static_assert(offsetof(FAnimNode_MultiWayBlend, bInvertAlpha) == 0x000070, "Member 'FAnimNode_MultiWayBlend::bInvertAlpha' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ModifyBone) == 0x000198, "Wrong size on FAnimNode_ModifyBone");
static_assert(offsetof(FAnimNode_ModifyBone, BoneToModify) == 0x000140, "Member 'FAnimNode_ModifyBone::BoneToModify' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, Translation) == 0x000158, "Member 'FAnimNode_ModifyBone::Translation' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, Rotation) == 0x000164, "Member 'FAnimNode_ModifyBone::Rotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, Scale) == 0x000170, "Member 'FAnimNode_ModifyBone::Scale' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, TranslationMode) == 0x00017C, "Member 'FAnimNode_ModifyBone::TranslationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, RotationMode) == 0x00017D, "Member 'FAnimNode_ModifyBone::RotationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, ScaleMode) == 0x00017E, "Member 'FAnimNode_ModifyBone::ScaleMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, TranslationSpace) == 0x00017F, "Member 'FAnimNode_ModifyBone::TranslationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, RotationSpace) == 0x000180, "Member 'FAnimNode_ModifyBone::RotationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, ScaleSpace) == 0x000181, "Member 'FAnimNode_ModifyBone::ScaleSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, BoneOverrideTag) == 0x000188, "Member 'FAnimNode_ModifyBone::BoneOverrideTag' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, bOverrideBoneToModify) == 0x000190, "Member 'FAnimNode_ModifyBone::bOverrideBoneToModify' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_BlendSpaceEvaluator) == 0x000168, "Wrong size on FAnimNode_BlendSpaceEvaluator");
static_assert(offsetof(FAnimNode_BlendSpaceEvaluator, NormalizedTime) == 0x000160, "Member 'FAnimNode_BlendSpaceEvaluator::NormalizedTime' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_RotateRootBone) == 0x0000E0, "Wrong size on FAnimNode_RotateRootBone");
...
static_assert(offsetof(FAnimNode_RotateRootBone, PitchScaleBiasClamp) == 0x000050, "Member 'FAnimNode_RotateRootBone::PitchScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotateRootBone, YawScaleBiasClamp) == 0x00008C, "Member 'FAnimNode_RotateRootBone::YawScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotateRootBone, MeshToComponent) == 0x0000C8, "Member 'FAnimNode_RotateRootBone::MeshToComponent' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotateRootBone, ActualPitch) == 0x0000D4, "Member 'FAnimNode_RotateRootBone::ActualPitch' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotateRootBone, ActualYaw) == 0x0000D8, "Member 'FAnimNode_RotateRootBone::ActualYaw' has a wrong offset!");
...
public:
	...
	uint8                                         bAffectTargetTranslationX : 1;                     // 0x01AC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetTranslationY : 1;                     // 0x01AC(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetTranslationZ : 1;                     // 0x01AC(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetRotationX : 1;                        // 0x01AC(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetRotationY : 1;                        // 0x01AC(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetRotationZ : 1;                        // 0x01AC(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetScaleX : 1;                           // 0x01AC(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetScaleY : 1;                           // 0x01AC(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetScaleZ : 1;                           // 0x01AD(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FAnimNode_BoneDrivenController) == 0x0001B8, "Wrong size on FAnimNode_BoneDrivenController");
static_assert(offsetof(FAnimNode_BoneDrivenController, SourceBone) == 0x000140, "Member 'FAnimNode_BoneDrivenController::SourceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, SourceComponent) == 0x000158, "Member 'FAnimNode_BoneDrivenController::SourceComponent' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, DrivingCurve) == 0x000160, "Member 'FAnimNode_BoneDrivenController::DrivingCurve' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, Multiplier) == 0x000168, "Member 'FAnimNode_BoneDrivenController::Multiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, bUseRange) == 0x00016C, "Member 'FAnimNode_BoneDrivenController::bUseRange' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, RangeMin) == 0x000170, "Member 'FAnimNode_BoneDrivenController::RangeMin' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, RangeMax) == 0x000174, "Member 'FAnimNode_BoneDrivenController::RangeMax' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, RemappedMin) == 0x000178, "Member 'FAnimNode_BoneDrivenController::RemappedMin' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, RemappedMax) == 0x00017C, "Member 'FAnimNode_BoneDrivenController::RemappedMax' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, DestinationMode) == 0x000180, "Member 'FAnimNode_BoneDrivenController::DestinationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, ParameterName) == 0x000188, "Member 'FAnimNode_BoneDrivenController::ParameterName' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, TargetBone) == 0x000190, "Member 'FAnimNode_BoneDrivenController::TargetBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, TargetComponent) == 0x0001A8, "Member 'FAnimNode_BoneDrivenController::TargetComponent' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, ModificationMode) == 0x0001B0, "Member 'FAnimNode_BoneDrivenController::ModificationMode' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_Constraint) == 0x000188, "Wrong size on FAnimNode_Constraint");
static_assert(offsetof(FAnimNode_Constraint, BoneToModify) == 0x000140, "Member 'FAnimNode_Constraint::BoneToModify' has a wrong offset!");
static_assert(offsetof(FAnimNode_Constraint, ConstraintSetup) == 0x000158, "Member 'FAnimNode_Constraint::ConstraintSetup' has a wrong offset!");
static_assert(offsetof(FAnimNode_Constraint, ConstraintWeights) == 0x000168, "Member 'FAnimNode_Constraint::ConstraintWeights' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_CopyBone) == 0x000178, "Wrong size on FAnimNode_CopyBone");
static_assert(offsetof(FAnimNode_CopyBone, SourceBone) == 0x000140, "Member 'FAnimNode_CopyBone::SourceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBone, TargetBone) == 0x000158, "Member 'FAnimNode_CopyBone::TargetBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBone, bCopyTranslation) == 0x000170, "Member 'FAnimNode_CopyBone::bCopyTranslation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBone, bCopyRotation) == 0x000171, "Member 'FAnimNode_CopyBone::bCopyRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBone, bCopyScale) == 0x000172, "Member 'FAnimNode_CopyBone::bCopyScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBone, ControlSpace) == 0x000173, "Member 'FAnimNode_CopyBone::ControlSpace' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_CopyBoneDelta) == 0x000180, "Wrong size on FAnimNode_CopyBoneDelta");
static_assert(offsetof(FAnimNode_CopyBoneDelta, SourceBone) == 0x000140, "Member 'FAnimNode_CopyBoneDelta::SourceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, TargetBone) == 0x000158, "Member 'FAnimNode_CopyBoneDelta::TargetBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, bCopyTranslation) == 0x000170, "Member 'FAnimNode_CopyBoneDelta::bCopyTranslation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, bCopyRotation) == 0x000171, "Member 'FAnimNode_CopyBoneDelta::bCopyRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, bCopyScale) == 0x000172, "Member 'FAnimNode_CopyBoneDelta::bCopyScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, CopyMode) == 0x000173, "Member 'FAnimNode_CopyBoneDelta::CopyMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, TranslationMultiplier) == 0x000174, "Member 'FAnimNode_CopyBoneDelta::TranslationMultiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, RotationMultiplier) == 0x000178, "Member 'FAnimNode_CopyBoneDelta::RotationMultiplier' has a wrong offset!");
static_assert(offsetof(FAnimNode_CopyBoneDelta, ScaleMultiplier) == 0x00017C, "Member 'FAnimNode_CopyBoneDelta::ScaleMultiplier' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_PoseBlendNode, SourcePose) == 0x0000B0, "Member 'FAnimNode_PoseBlendNode::SourcePose' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_HandIKRetargeting) == 0x0001B8, "Wrong size on FAnimNode_HandIKRetargeting");
static_assert(offsetof(FAnimNode_HandIKRetargeting, RightHandFK) == 0x000140, "Member 'FAnimNode_HandIKRetargeting::RightHandFK' has a wrong offset!");
static_assert(offsetof(FAnimNode_HandIKRetargeting, LeftHandFK) == 0x000158, "Member 'FAnimNode_HandIKRetargeting::LeftHandFK' has a wrong offset!");
static_assert(offsetof(FAnimNode_HandIKRetargeting, RightHandIK) == 0x000170, "Member 'FAnimNode_HandIKRetargeting::RightHandIK' has a wrong offset!");
static_assert(offsetof(FAnimNode_HandIKRetargeting, LeftHandIK) == 0x000188, "Member 'FAnimNode_HandIKRetargeting::LeftHandIK' has a wrong offset!");
static_assert(offsetof(FAnimNode_HandIKRetargeting, IKBonesToMove) == 0x0001A0, "Member 'FAnimNode_HandIKRetargeting::IKBonesToMove' has a wrong offset!");
static_assert(offsetof(FAnimNode_HandIKRetargeting, HandFKWeight) == 0x0001B0, "Member 'FAnimNode_HandIKRetargeting::HandFKWeight' has a wrong offset!");
...
public:
	...
	int32                                         LODThreshold;                                      // 0x007C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_LayeredBoneBlend) == 0x000120, "Wrong size on FAnimNode_LayeredBoneBlend");
...
static_assert(offsetof(FAnimNode_LayeredBoneBlend, LODThreshold) == 0x00007C, "Member 'FAnimNode_LayeredBoneBlend::LODThreshold' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_LayeredBoneBlend, bBoolBlendWeights) == 0x0000E0, "Member 'FAnimNode_LayeredBoneBlend::bBoolBlendWeights' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, bUseBoolBlendWeights) == 0x0000F0, "Member 'FAnimNode_LayeredBoneBlend::bUseBoolBlendWeights' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, bInvertWeight) == 0x000100, "Member 'FAnimNode_LayeredBoneBlend::bInvertWeight' has a wrong offset!");

// ScriptStruct AnimGraphRuntime.AnimNode_LayeredBoneSetBlend
// 0x0110 (0x0140 - 0x0030)
struct FAnimNode_LayeredBoneSetBlend final : public FAnimNode_Base
{
public:
	struct FPoseLink                              BasePose;                                          // 0x0030(0x0018)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	TArray<struct FPoseLink>                      BlendPoses;                                        // 0x0048(0x0010)(Edit, BlueprintVisible, EditFixedSize, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FAnimNode_LayeredBoneSetBlend) == 0x000008, "Wrong alignment on FAnimNode_LayeredBoneSetBlend");
static_assert(sizeof(FAnimNode_LayeredBoneSetBlend) == 0x000140, "Wrong size on FAnimNode_LayeredBoneSetBlend");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, BasePose) == 0x000030, "Member 'FAnimNode_LayeredBoneSetBlend::BasePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, BlendPoses) == 0x000048, "Member 'FAnimNode_LayeredBoneSetBlend::BlendPoses' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, BoneSets) == 0x000058, "Member 'FAnimNode_LayeredBoneSetBlend::BoneSets' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, BoneSetGuids) == 0x000068, "Member 'FAnimNode_LayeredBoneSetBlend::BoneSetGuids' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, BlendWeights) == 0x000078, "Member 'FAnimNode_LayeredBoneSetBlend::BlendWeights' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, CurveBlendOption) == 0x000088, "Member 'FAnimNode_LayeredBoneSetBlend::CurveBlendOption' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, bBlendRootMotionBasedOnRootBone) == 0x000089, "Member 'FAnimNode_LayeredBoneSetBlend::bBlendRootMotionBasedOnRootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, bHasRelevantPoses) == 0x00008A, "Member 'FAnimNode_LayeredBoneSetBlend::bHasRelevantPoses' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, PerBoneBlendWeights) == 0x000090, "Member 'FAnimNode_LayeredBoneSetBlend::PerBoneBlendWeights' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, SkeletonGuid) == 0x0000A0, "Member 'FAnimNode_LayeredBoneSetBlend::SkeletonGuid' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, VirtualBoneGuid) == 0x0000B0, "Member 'FAnimNode_LayeredBoneSetBlend::VirtualBoneGuid' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, bBoolBlendWeights) == 0x0000F0, "Member 'FAnimNode_LayeredBoneSetBlend::bBoolBlendWeights' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, bUseBoolBlendWeights) == 0x000100, "Member 'FAnimNode_LayeredBoneSetBlend::bUseBoolBlendWeights' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneSetBlend, bInvertWeight) == 0x000110, "Member 'FAnimNode_LayeredBoneSetBlend::bInvertWeight' has a wrong offset!");
...
static_assert(sizeof(FRandomPlayerSequenceEntry) == 0x000078, "Wrong size on FRandomPlayerSequenceEntry");
...
static_assert(offsetof(FRandomPlayerSequenceEntry, AnimAssetName) == 0x000058, "Member 'FRandomPlayerSequenceEntry::AnimAssetName' has a wrong offset!");
static_assert(offsetof(FRandomPlayerSequenceEntry, LastAnimAssetName) == 0x000060, "Member 'FRandomPlayerSequenceEntry::LastAnimAssetName' has a wrong offset!");
static_assert(offsetof(FRandomPlayerSequenceEntry, bUseRateScaleSpeed) == 0x000068, "Member 'FRandomPlayerSequenceEntry::bUseRateScaleSpeed' has a wrong offset!");
static_assert(offsetof(FRandomPlayerSequenceEntry, RateScaleSpeed) == 0x00006C, "Member 'FRandomPlayerSequenceEntry::RateScaleSpeed' has a wrong offset!");
static_assert(offsetof(FRandomPlayerSequenceEntry, Duration) == 0x000070, "Member 'FRandomPlayerSequenceEntry::Duration' has a wrong offset!");

// ScriptStruct AnimGraphRuntime.RandomPlayerInputEntryData
// 0x0040 (0x0040 - 0x0000)
struct FRandomPlayerInputEntryData final
{
public:
...
static_assert(alignof(FRandomPlayerInputEntryData) == 0x000008, "Wrong alignment on FRandomPlayerInputEntryData");
static_assert(sizeof(FRandomPlayerInputEntryData) == 0x000040, "Wrong size on FRandomPlayerInputEntryData");
static_assert(offsetof(FRandomPlayerInputEntryData, BlendIn) == 0x000000, "Member 'FRandomPlayerInputEntryData::BlendIn' has a wrong offset!");
static_assert(offsetof(FRandomPlayerInputEntryData, MinPlayTime) == 0x000038, "Member 'FRandomPlayerInputEntryData::MinPlayTime' has a wrong offset!");
static_assert(offsetof(FRandomPlayerInputEntryData, MaxPlayTime) == 0x00003C, "Member 'FRandomPlayerInputEntryData::MaxPlayTime' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_RandomPlayer) == 0x0000F8, "Wrong size on FAnimNode_RandomPlayer");
...
static_assert(offsetof(FAnimNode_RandomPlayer, IdlePose) == 0x000090, "Member 'FAnimNode_RandomPlayer::IdlePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_RandomPlayer, EntryPoseData) == 0x0000A8, "Member 'FAnimNode_RandomPlayer::EntryPoseData' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_23C[0x34];                                     // 0x023C(0x0034)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FAnimNode_LookAt) == 0x000290, "Wrong size on FAnimNode_LookAt");
static_assert(offsetof(FAnimNode_LookAt, BoneToModify) == 0x000140, "Member 'FAnimNode_LookAt::BoneToModify' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAtBone) == 0x000158, "Member 'FAnimNode_LookAt::LookAtBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAtSocket) == 0x000170, "Member 'FAnimNode_LookAt::LookAtSocket' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAtTarget) == 0x000180, "Member 'FAnimNode_LookAt::LookAtTarget' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAtLocation) == 0x0001E0, "Member 'FAnimNode_LookAt::LookAtLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAtAxis) == 0x0001EC, "Member 'FAnimNode_LookAt::LookAtAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, CustomLookAtAxis) == 0x0001F0, "Member 'FAnimNode_LookAt::CustomLookAtAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAt_Axis) == 0x0001FC, "Member 'FAnimNode_LookAt::LookAt_Axis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, bUseLookUpAxis) == 0x00020C, "Member 'FAnimNode_LookAt::bUseLookUpAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookUpAxis) == 0x00020D, "Member 'FAnimNode_LookAt::LookUpAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, CustomLookUpAxis) == 0x000210, "Member 'FAnimNode_LookAt::CustomLookUpAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookUp_Axis) == 0x00021C, "Member 'FAnimNode_LookAt::LookUp_Axis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAtClamp) == 0x00022C, "Member 'FAnimNode_LookAt::LookAtClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, InterpolationType) == 0x000230, "Member 'FAnimNode_LookAt::InterpolationType' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, InterpolationTime) == 0x000234, "Member 'FAnimNode_LookAt::InterpolationTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, InterpolationTriggerThreashold) == 0x000238, "Member 'FAnimNode_LookAt::InterpolationTriggerThreashold' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, bUseRollCorrection) == 0x000270, "Member 'FAnimNode_LookAt::bUseRollCorrection' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, RollCorrectionLookUpAxis) == 0x000274, "Member 'FAnimNode_LookAt::RollCorrectionLookUpAxis' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_MakeDynamicAdditive, bIgnoreCurves) == 0x000061, "Member 'FAnimNode_MakeDynamicAdditive::bIgnoreCurves' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ObserveBone) == 0x000180, "Wrong size on FAnimNode_ObserveBone");
static_assert(offsetof(FAnimNode_ObserveBone, BoneToObserve) == 0x000140, "Member 'FAnimNode_ObserveBone::BoneToObserve' has a wrong offset!");
static_assert(offsetof(FAnimNode_ObserveBone, DisplaySpace) == 0x000158, "Member 'FAnimNode_ObserveBone::DisplaySpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_ObserveBone, bRelativeToRefPose) == 0x000159, "Member 'FAnimNode_ObserveBone::bRelativeToRefPose' has a wrong offset!");
static_assert(offsetof(FAnimNode_ObserveBone, Translation) == 0x00015C, "Member 'FAnimNode_ObserveBone::Translation' has a wrong offset!");
static_assert(offsetof(FAnimNode_ObserveBone, Rotation) == 0x000168, "Member 'FAnimNode_ObserveBone::Rotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_ObserveBone, Scale) == 0x000174, "Member 'FAnimNode_ObserveBone::Scale' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_PoseByName) == 0x0000C0, "Wrong size on FAnimNode_PoseByName");
static_assert(offsetof(FAnimNode_PoseByName, PoseName) == 0x0000B0, "Member 'FAnimNode_PoseByName::PoseName' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseByName, PoseWeight) == 0x0000B8, "Member 'FAnimNode_PoseByName::PoseWeight' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_PoseDriver, SourcePose) == 0x0000B0, "Member 'FAnimNode_PoseDriver::SourcePose' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_PoseDriver, bOnlyDriveSelectedBones) == 0x0000D8, "Member 'FAnimNode_PoseDriver::bOnlyDriveSelectedBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, OnlyDriveBones) == 0x0000E0, "Member 'FAnimNode_PoseDriver::OnlyDriveBones' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_PoseDriver, RBFParams) == 0x000108, "Member 'FAnimNode_PoseDriver::RBFParams' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, DriveSource) == 0x000118, "Member 'FAnimNode_PoseDriver::DriveSource' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, DriveOutput) == 0x000119, "Member 'FAnimNode_PoseDriver::DriveOutput' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, PoseTargets) == 0x000120, "Member 'FAnimNode_PoseDriver::PoseTargets' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, SourceBone) == 0x000130, "Member 'FAnimNode_PoseDriver::SourceBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, TwistAxis) == 0x000148, "Member 'FAnimNode_PoseDriver::TwistAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, Type) == 0x000149, "Member 'FAnimNode_PoseDriver::Type' has a wrong offset!");
static_assert(offsetof(FAnimNode_PoseDriver, RadialScaling) == 0x00014C, "Member 'FAnimNode_PoseDriver::RadialScaling' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_SequenceEvaluator) == 0x000080, "Wrong size on FAnimNode_SequenceEvaluator");
static_assert(offsetof(FAnimNode_SequenceEvaluator, Sequence) == 0x000068, "Member 'FAnimNode_SequenceEvaluator::Sequence' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, ExplicitTime) == 0x000070, "Member 'FAnimNode_SequenceEvaluator::ExplicitTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, bShouldLoop) == 0x000074, "Member 'FAnimNode_SequenceEvaluator::bShouldLoop' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, bTeleportToExplicitTime) == 0x000075, "Member 'FAnimNode_SequenceEvaluator::bTeleportToExplicitTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, StartPosition) == 0x000078, "Member 'FAnimNode_SequenceEvaluator::StartPosition' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, ReinitializationBehavior) == 0x00007C, "Member 'FAnimNode_SequenceEvaluator::ReinitializationBehavior' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, bReinitialized) == 0x00007D, "Member 'FAnimNode_SequenceEvaluator::bReinitialized' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_RotationOffsetBlendSpace) == 0x000238, "Wrong size on FAnimNode_RotationOffsetBlendSpace");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, BasePose) == 0x000160, "Member 'FAnimNode_RotationOffsetBlendSpace::BasePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, LODThreshold) == 0x000178, "Member 'FAnimNode_RotationOffsetBlendSpace::LODThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, bIsLODEnabled) == 0x00017C, "Member 'FAnimNode_RotationOffsetBlendSpace::bIsLODEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaInputType) == 0x00017D, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, Alpha) == 0x000180, "Member 'FAnimNode_RotationOffsetBlendSpace::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBias) == 0x000184, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, ActualAlpha) == 0x00018C, "Member 'FAnimNode_RotationOffsetBlendSpace::ActualAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, bAlphaBoolEnabled) == 0x000190, "Member 'FAnimNode_RotationOffsetBlendSpace::bAlphaBoolEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaBoolBlend) == 0x000198, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaCurveName) == 0x0001F0, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBiasClamp) == 0x0001F8, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBiasClamp' has a wrong offset!");
...
// 0x0080 (0x00B0 - 0x0030)
struct alignas(0x10) FAnimNode_Slot final : public FAnimNode_Base
{
public:
...
static_assert(alignof(FAnimNode_Slot) == 0x000010, "Wrong alignment on FAnimNode_Slot");
static_assert(sizeof(FAnimNode_Slot) == 0x0000B0, "Wrong size on FAnimNode_Slot");
...
static_assert(offsetof(FAnimNode_Slot, bAlwaysEvaluateSource) == 0x000070, "Member 'FAnimNode_Slot::bAlwaysEvaluateSource' has a wrong offset!");
static_assert(offsetof(FAnimNode_Slot, CameraRefPose) == 0x000078, "Member 'FAnimNode_Slot::CameraRefPose' has a wrong offset!");
...
public:
	...
	int32                                         PointCount;                                        // 0x0174(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_SplineIK) == 0x0002E0, "Wrong size on FAnimNode_SplineIK");
static_assert(offsetof(FAnimNode_SplineIK, StartBone) == 0x000140, "Member 'FAnimNode_SplineIK::StartBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, EndBone) == 0x000158, "Member 'FAnimNode_SplineIK::EndBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, BoneAxis) == 0x000170, "Member 'FAnimNode_SplineIK::BoneAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, bAutoCalculateSpline) == 0x000171, "Member 'FAnimNode_SplineIK::bAutoCalculateSpline' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, PointCount) == 0x000174, "Member 'FAnimNode_SplineIK::PointCount' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, ControlPoints) == 0x000178, "Member 'FAnimNode_SplineIK::ControlPoints' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, Roll) == 0x000188, "Member 'FAnimNode_SplineIK::Roll' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, TwistStart) == 0x00018C, "Member 'FAnimNode_SplineIK::TwistStart' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, TwistEnd) == 0x000190, "Member 'FAnimNode_SplineIK::TwistEnd' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, TwistBlend) == 0x000198, "Member 'FAnimNode_SplineIK::TwistBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, Stretch) == 0x0001D0, "Member 'FAnimNode_SplineIK::Stretch' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, Offset) == 0x0001D4, "Member 'FAnimNode_SplineIK::Offset' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, BoneSpline) == 0x000248, "Member 'FAnimNode_SplineIK::BoneSpline' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, OriginalSplineLength) == 0x0002A8, "Member 'FAnimNode_SplineIK::OriginalSplineLength' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, CachedBoneReferences) == 0x0002B0, "Member 'FAnimNode_SplineIK::CachedBoneReferences' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, CachedBoneLengths) == 0x0002C0, "Member 'FAnimNode_SplineIK::CachedBoneLengths' has a wrong offset!");
static_assert(offsetof(FAnimNode_SplineIK, CachedOffsetRotations) == 0x0002D0, "Member 'FAnimNode_SplineIK::CachedOffsetRotations' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_173[0x35];                                     // 0x0173(0x0035)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_SpringBone) == 0x000008, "Wrong alignment on FAnimNode_SpringBone");
static_assert(sizeof(FAnimNode_SpringBone) == 0x0001A8, "Wrong size on FAnimNode_SpringBone");
static_assert(offsetof(FAnimNode_SpringBone, SpringBone) == 0x000140, "Member 'FAnimNode_SpringBone::SpringBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bLimitDisplacement) == 0x000158, "Member 'FAnimNode_SpringBone::bLimitDisplacement' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, MaxDisplacement) == 0x00015C, "Member 'FAnimNode_SpringBone::MaxDisplacement' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, SpringStiffness) == 0x000160, "Member 'FAnimNode_SpringBone::SpringStiffness' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, SpringDamping) == 0x000164, "Member 'FAnimNode_SpringBone::SpringDamping' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, ErrorResetThresh) == 0x000168, "Member 'FAnimNode_SpringBone::ErrorResetThresh' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bNoZSpring) == 0x00016C, "Member 'FAnimNode_SpringBone::bNoZSpring' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bTranslateX) == 0x00016D, "Member 'FAnimNode_SpringBone::bTranslateX' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bTranslateY) == 0x00016E, "Member 'FAnimNode_SpringBone::bTranslateY' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bTranslateZ) == 0x00016F, "Member 'FAnimNode_SpringBone::bTranslateZ' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bRotateX) == 0x000170, "Member 'FAnimNode_SpringBone::bRotateX' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bRotateY) == 0x000171, "Member 'FAnimNode_SpringBone::bRotateY' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, bRotateZ) == 0x000172, "Member 'FAnimNode_SpringBone::bRotateZ' has a wrong offset!");
...
public:
	...
	int32                                         ChainLength;                                       // 0x0158(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_Trail) == 0x0002C0, "Wrong size on FAnimNode_Trail");
static_assert(offsetof(FAnimNode_Trail, TrailBone) == 0x000140, "Member 'FAnimNode_Trail::TrailBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, ChainLength) == 0x000158, "Member 'FAnimNode_Trail::ChainLength' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, ChainBoneAxis) == 0x00015C, "Member 'FAnimNode_Trail::ChainBoneAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, bInvertChainBoneAxis) == 0x00015D, "Member 'FAnimNode_Trail::bInvertChainBoneAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, TrailRelaxation) == 0x000160, "Member 'FAnimNode_Trail::TrailRelaxation' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, TrailRelaxationSpeed) == 0x000168, "Member 'FAnimNode_Trail::TrailRelaxationSpeed' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, RelaxationSpeedScale) == 0x0001E0, "Member 'FAnimNode_Trail::RelaxationSpeedScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, RelaxationSpeedScaleInputProcessor) == 0x0001E4, "Member 'FAnimNode_Trail::RelaxationSpeedScaleInputProcessor' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, bLimitStretch) == 0x000220, "Member 'FAnimNode_Trail::bLimitStretch' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, StretchLimit) == 0x000224, "Member 'FAnimNode_Trail::StretchLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, FakeVelocity) == 0x000228, "Member 'FAnimNode_Trail::FakeVelocity' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, bActorSpaceFakeVel) == 0x000234, "Member 'FAnimNode_Trail::bActorSpaceFakeVel' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, BaseJoint) == 0x000238, "Member 'FAnimNode_Trail::BaseJoint' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_TwistCorrectiveNode) == 0x0001C8, "Wrong size on FAnimNode_TwistCorrectiveNode");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, BaseFrame) == 0x000140, "Member 'FAnimNode_TwistCorrectiveNode::BaseFrame' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, TwistFrame) == 0x000168, "Member 'FAnimNode_TwistCorrectiveNode::TwistFrame' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, TwistPlaneNormalAxis) == 0x000190, "Member 'FAnimNode_TwistCorrectiveNode::TwistPlaneNormalAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, RangeMax) == 0x0001A0, "Member 'FAnimNode_TwistCorrectiveNode::RangeMax' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, RemappedMin) == 0x0001A4, "Member 'FAnimNode_TwistCorrectiveNode::RemappedMin' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, RemappedMax) == 0x0001A8, "Member 'FAnimNode_TwistCorrectiveNode::RemappedMax' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, Curve) == 0x0001B0, "Member 'FAnimNode_TwistCorrectiveNode::Curve' has a wrong offset!");
...
public:
	...
	uint8                                         bAllowStretching : 1;                              // 0x0158(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_159[0x3];                                      // 0x0159(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         bTakeRotationFromEffectorSpace : 1;                // 0x016C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bMaintainEffectorRelRot : 1;                       // 0x016C(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_16D[0x3];                                      // 0x016D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FAnimNode_TwoBoneIK) == 0x000290, "Wrong size on FAnimNode_TwoBoneIK");
static_assert(offsetof(FAnimNode_TwoBoneIK, IKBone) == 0x000140, "Member 'FAnimNode_TwoBoneIK::IKBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, StartStretchRatio) == 0x00015C, "Member 'FAnimNode_TwoBoneIK::StartStretchRatio' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, MaxStretchScale) == 0x000160, "Member 'FAnimNode_TwoBoneIK::MaxStretchScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, StretchLimits) == 0x000164, "Member 'FAnimNode_TwoBoneIK::StretchLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorLocationSpace) == 0x000170, "Member 'FAnimNode_TwoBoneIK::EffectorLocationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorSpaceBoneName) == 0x000178, "Member 'FAnimNode_TwoBoneIK::EffectorSpaceBoneName' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorLocation) == 0x000180, "Member 'FAnimNode_TwoBoneIK::EffectorLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorTarget) == 0x000190, "Member 'FAnimNode_TwoBoneIK::EffectorTarget' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetLocationSpace) == 0x0001F0, "Member 'FAnimNode_TwoBoneIK::JointTargetLocationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetLocation) == 0x0001F4, "Member 'FAnimNode_TwoBoneIK::JointTargetLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetSpaceBoneName) == 0x000200, "Member 'FAnimNode_TwoBoneIK::JointTargetSpaceBoneName' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTarget) == 0x000210, "Member 'FAnimNode_TwoBoneIK::JointTarget' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, bAllowTwist) == 0x000270, "Member 'FAnimNode_TwoBoneIK::bAllowTwist' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, TwistAxis) == 0x000274, "Member 'FAnimNode_TwoBoneIK::TwistAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, bNoTwist) == 0x000284, "Member 'FAnimNode_TwoBoneIK::bNoTwist' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_TwoWayBlend) == 0x000120, "Wrong size on FAnimNode_TwoWayBlend");
...
static_assert(offsetof(FAnimNode_TwoWayBlend, AlphaInputType) == 0x000060, "Member 'FAnimNode_TwoWayBlend::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, Alpha) == 0x000064, "Member 'FAnimNode_TwoWayBlend::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, AlphaScaleBias) == 0x000068, "Member 'FAnimNode_TwoWayBlend::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, bAlphaBoolEnabled) == 0x000070, "Member 'FAnimNode_TwoWayBlend::bAlphaBoolEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, AlphaBoolBlend) == 0x000078, "Member 'FAnimNode_TwoWayBlend::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, AlphaCurveName) == 0x0000D0, "Member 'FAnimNode_TwoWayBlend::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, AlphaScaleBiasClamp) == 0x0000D8, "Member 'FAnimNode_TwoWayBlend::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, InternalBlendAlpha) == 0x000114, "Member 'FAnimNode_TwoWayBlend::InternalBlendAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, bAIsRelevant) == 0x000118, "Member 'FAnimNode_TwoWayBlend::bAIsRelevant' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, bBIsRelevant) == 0x000119, "Member 'FAnimNode_TwoWayBlend::bBIsRelevant' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, bResetChildOnActivation) == 0x00011A, "Member 'FAnimNode_TwoWayBlend::bResetChildOnActivation' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoWayBlend, bInvertAlpha) == 0x00011B, "Member 'FAnimNode_TwoWayBlend::bInvertAlpha' has a wrong offset!");
...
{
public:
	uint8                                         Pad_6C0[0x260];                                    // 0x06C0(0x0260)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000920, "Wrong size on FAnimSequencerInstanceProxy");
