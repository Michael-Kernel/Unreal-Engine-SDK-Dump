...
#include "Challenge_DLC2_Statues_Stat_classes.hpp"
#include "Challenge_DLC2_Statues_Stat_parameters.hpp"
...
void UChallenge_DLC2_Statues_Stat_C::ExecuteUbergraph_Challenge_DLC2_Statues_Stat(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_DLC2_Statues_Stat_C", "ExecuteUbergraph_Challenge_DLC2_Statues_Stat");

	Params::Challenge_DLC2_Statues_Stat_C_ExecuteUbergraph_Challenge_DLC2_Statues_Stat Parms{};
...
void UChallenge_DLC2_Statues_Stat_C::OnInitChallengeInstance(class UChallengesComponent* OwningChallenges, class AGbxCharacter* AssociatedCharacter)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_DLC2_Statues_Stat_C", "OnInitChallengeInstance");

	Params::Challenge_DLC2_Statues_Stat_C_OnInitChallengeInstance Parms{};
...
void UChallenge_DLC2_Statues_Stat_C::CompletedChallenge(const class AGbxPlayerController* CompletedPlayer)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_DLC2_Statues_Stat_C", "CompletedChallenge");

	Params::Challenge_DLC2_Statues_Stat_C_CompletedChallenge Parms{};
...
// Parameters:
// class AGbxPlayerController*             Player_Controller                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UChallenge_DLC2_Statues_Stat_C::PlayCompletionVO(class AGbxPlayerController* Player_Controller, const struct FDialogTimeSlotReference& TimeSlot, bool* Played_)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_DLC2_Statues_Stat_C", "PlayCompletionVO");

	Params::Challenge_DLC2_Statues_Stat_C_PlayCompletionVO Parms{};
