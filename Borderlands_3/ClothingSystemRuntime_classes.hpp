...
static_assert(sizeof(UClothingAsset) == 0x000168, "Wrong size on UClothingAsset");
...
static_assert(offsetof(UClothingAsset, LODData) == 0x000118, "Member 'UClothingAsset::LODData' has a wrong offset!");
static_assert(offsetof(UClothingAsset, LodMap) == 0x000128, "Member 'UClothingAsset::LodMap' has a wrong offset!");
static_assert(offsetof(UClothingAsset, UsedBoneNames) == 0x000138, "Member 'UClothingAsset::UsedBoneNames' has a wrong offset!");
static_assert(offsetof(UClothingAsset, UsedBoneIndices) == 0x000148, "Member 'UClothingAsset::UsedBoneIndices' has a wrong offset!");
static_assert(offsetof(UClothingAsset, ReferenceBoneIndex) == 0x000158, "Member 'UClothingAsset::ReferenceBoneIndex' has a wrong offset!");
static_assert(offsetof(UClothingAsset, CustomData) == 0x000160, "Member 'UClothingAsset::CustomData' has a wrong offset!");
