...
public:
	...
	struct FSoftClassPath                         GameInstanceClass;                                 // 0x0070(0x0018)(Edit, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FSoftClassPath                         GlobalDefaultGameMode;                             // 0x00B8(0x0018)(Edit, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FSoftClassPath                         GlobalDefaultServerGameMode;                       // 0x00D0(0x0018)(Edit, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGameMapsSettings) == 0x000108, "Wrong size on UGameMapsSettings");
...
static_assert(offsetof(UGameMapsSettings, bOffsetPlayerGamepadIds) == 0x00006B, "Member 'UGameMapsSettings::bOffsetPlayerGamepadIds' has a wrong offset!");
...
static_assert(offsetof(UGameMapsSettings, GlobalDefaultGameMode) == 0x0000B8, "Member 'UGameMapsSettings::GlobalDefaultGameMode' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, GlobalDefaultServerGameMode) == 0x0000D0, "Member 'UGameMapsSettings::GlobalDefaultServerGameMode' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, GameModeMapPrefixes) == 0x0000E8, "Member 'UGameMapsSettings::GameModeMapPrefixes' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, GameModeClassAliases) == 0x0000F8, "Member 'UGameMapsSettings::GameModeClassAliases' has a wrong offset!");
