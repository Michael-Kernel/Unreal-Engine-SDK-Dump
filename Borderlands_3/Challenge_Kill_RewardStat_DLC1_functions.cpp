...
#include "Challenge_Kill_RewardStat_DLC1_parameters.hpp"
...
void UChallenge_Kill_RewardStat_DLC1_C::ExecuteUbergraph_Challenge_Kill_RewardStat_DLC1(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Kill_RewardStat_DLC1_C", "ExecuteUbergraph_Challenge_Kill_RewardStat_DLC1");

	Params::Challenge_Kill_RewardStat_DLC1_C_ExecuteUbergraph_Challenge_Kill_RewardStat_DLC1 Parms{};
...
void UChallenge_Kill_RewardStat_DLC1_C::CompletedChallenge(const class AGbxPlayerController* CompletedPlayer)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Kill_RewardStat_DLC1_C", "CompletedChallenge");

	Params::Challenge_Kill_RewardStat_DLC1_C_CompletedChallenge Parms{};
...
void UChallenge_Kill_RewardStat_DLC1_C::OnInitChallengeInstance(class UChallengesComponent* OwningChallenges, class AGbxCharacter* AssociatedCharacter)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Kill_RewardStat_DLC1_C", "OnInitChallengeInstance");

	Params::Challenge_Kill_RewardStat_DLC1_C_OnInitChallengeInstance Parms{};
...
void UChallenge_Kill_RewardStat_DLC1_C::PlayCompletionVO(class AGbxPlayerController* PlayerController, bool* Played)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Challenge_Kill_RewardStat_DLC1_C", "PlayCompletionVO");

	Params::Challenge_Kill_RewardStat_DLC1_C_PlayCompletionVO Parms{};
