...
class UHitReactionLayer_ForceFlinch_C final : public UHitReactionLayer_Blueprint
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"HitReactionLayer_ForceFlinch_C">();
	}
	static class UHitReactionLayer_ForceFlinch_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UHitReactionLayer_ForceFlinch_C>();
	}
};
static_assert(alignof(UHitReactionLayer_ForceFlinch_C) == 0x000008, "Wrong alignment on UHitReactionLayer_ForceFlinch_C");
static_assert(sizeof(UHitReactionLayer_ForceFlinch_C) == 0x000030, "Wrong size on UHitReactionLayer_ForceFlinch_C");
