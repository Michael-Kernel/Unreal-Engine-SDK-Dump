...
// 0x0008 (0x0008 - 0x0000)
struct DestructibleComponent_SetDestructiblePoseComponent final
{
public:
	class USkinnedMeshComponent*                  NewDestructiblePoseComponent;                      // 0x0000(0x0008)(Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(DestructibleComponent_SetDestructiblePoseComponent) == 0x000008, "Wrong alignment on DestructibleComponent_SetDestructiblePoseComponent");
static_assert(sizeof(DestructibleComponent_SetDestructiblePoseComponent) == 0x000008, "Wrong size on DestructibleComponent_SetDestructiblePoseComponent");
static_assert(offsetof(DestructibleComponent_SetDestructiblePoseComponent, NewDestructiblePoseComponent) == 0x000000, "Member 'DestructibleComponent_SetDestructiblePoseComponent::NewDestructiblePoseComponent' has a wrong offset!");
