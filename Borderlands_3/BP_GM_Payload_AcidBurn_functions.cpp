...
#include "BP_GM_Payload_AcidBurn_classes.hpp"
#include "BP_GM_Payload_AcidBurn_parameters.hpp"
...
void UBP_GM_Payload_AcidBurn_C::K2_GrenadeDamageDealt(class AGrenade* Grenade, class AGrenadeMod* GrenadeMod, struct FPayloadInstanceData& InstanceData, class AOakCharacter* Character, const struct FDamageDataEventDetails& DamageEvent) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_GM_Payload_AcidBurn_C", "K2_GrenadeDamageDealt");

	Params::BP_GM_Payload_AcidBurn_C_K2_GrenadeDamageDealt Parms{};
