...
// NumValues: 0x0006
enum class EEqsTraceDrawMode : uint8
{
	None                                     = 0,
	DrawFailed                               = 1,
	DrawSucceeded                            = 2,
...
public:
	...
	uint8                                         BitPad_44_0 : 1;                                   // 0x0044(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bSuccessfullySensed : 1;                           // 0x0044(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_45[0x13];                                      // 0x0045(0x0013)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                SourceLocation;                                    // 0x0058(0x000C)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_64[0x4];                                       // 0x0064(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAIStimulus) == 0x000008, "Wrong alignment on FAIStimulus");
static_assert(sizeof(FAIStimulus) == 0x000068, "Wrong size on FAIStimulus");
...
static_assert(offsetof(FAIStimulus, SourceLocation) == 0x000058, "Member 'FAIStimulus::SourceLocation' has a wrong offset!");
...
public:
	...
	uint8                                         bCanTraceOnFlight : 1;                             // 0x002C(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FEnvQueryInstanceCache) == 0x000198, "Wrong size on FEnvQueryInstanceCache");
...
// 0x0008 (0x0008 - 0x0000)
struct alignas(0x04) FSenseMetadata final
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSenseMetadata) == 0x000004, "Wrong alignment on FSenseMetadata");
static_assert(sizeof(FSenseMetadata) == 0x000008, "Wrong size on FSenseMetadata");
...
static_assert(sizeof(FEnvQueryRequest) == 0x000078, "Wrong size on FEnvQueryRequest");
...
static_assert(alignof(FEnvNamedValue) == 0x000008, "Wrong alignment on FEnvNamedValue");
