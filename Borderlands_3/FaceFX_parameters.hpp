...
struct FaceFXComponent_GetFaceFXBlendWeight final
{
public:
...
static_assert(alignof(FaceFXComponent_GetFaceFXBlendWeight) == 0x000008, "Wrong alignment on FaceFXComponent_GetFaceFXBlendWeight");
static_assert(sizeof(FaceFXComponent_GetFaceFXBlendWeight) == 0x000018, "Wrong size on FaceFXComponent_GetFaceFXBlendWeight");
static_assert(offsetof(FaceFXComponent_GetFaceFXBlendWeight, SkeletalMeshComponent) == 0x000000, "Member 'FaceFXComponent_GetFaceFXBlendWeight::SkeletalMeshComponent' has a wrong offset!");
static_assert(offsetof(FaceFXComponent_GetFaceFXBlendWeight, DeltaTime) == 0x000008, "Member 'FaceFXComponent_GetFaceFXBlendWeight::DeltaTime' has a wrong offset!");
static_assert(offsetof(FaceFXComponent_GetFaceFXBlendWeight, BlendTime) == 0x00000C, "Member 'FaceFXComponent_GetFaceFXBlendWeight::BlendTime' has a wrong offset!");
static_assert(offsetof(FaceFXComponent_GetFaceFXBlendWeight, ReturnValue) == 0x000010, "Member 'FaceFXComponent_GetFaceFXBlendWeight::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(FaceFXComponent_Setup, IsAutoPlaySound) == 0x000018, "Member 'FaceFXComponent_Setup::IsAutoPlaySound' has a wrong offset!");
static_assert(offsetof(FaceFXComponent_Setup, IsDisableMorphTargets) == 0x000019, "Member 'FaceFXComponent_Setup::IsDisableMorphTargets' has a wrong offset!");
