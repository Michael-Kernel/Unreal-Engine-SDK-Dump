...
#include "HitReactionLayer_Heavy_DeathBackpackHit_classes.hpp"
#include "HitReactionLayer_Heavy_DeathBackpackHit_parameters.hpp"
...
void UHitReactionLayer_Heavy_DeathBackpackHit_C::CalcHealthPercent(class UOakDamageComponent* Receiver, float Damage_Amount, float* Damage_Percent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HitReactionLayer_Heavy_DeathBackpackHit_C", "CalcHealthPercent");

	Params::HitReactionLayer_Heavy_DeathBackpackHit_C_CalcHealthPercent Parms{};
