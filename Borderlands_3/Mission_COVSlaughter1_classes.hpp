...
class UMission_COVSlaughter1_C final : public UOakMissionCircleOfSlaughter
{
public:
	...
	int32                                         RoundCount;                                        // 0x05D8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FDialogConversation                    Torgue_VO_Start;                                   // 0x0618(0x000C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          Player_Used_Button_CoV;                            // 0x0630(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)

public:
	void ExecuteUbergraph_Mission_COVSlaughter1(int32 EntryPoint);
	void MCE_BC_NotAllAssembled(class UObject* Context);
	void MCE_Update_Obj_DropshipCleared(class UObject* Context);
	void Obj_DropshipCleared(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void MissionActive();
	...
	void _Obj_INVIS_PlayersDiedinRound_Objective__PROXY_3();
	...
	void Obj_OptionalObjective_5(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_OptionalObjective_4(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_OptionalObjective_3(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	void Obj_OptionalObjective_2(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void Obj_OptionalObjective_1(EMissionObjectiveEvent ObjectiveEvent, int32 ObjectiveCount);
	...
	void MCE_Update_Obj_CompleteWave_1(class UObject* Context);
	...
	void Set_Round_1(EMissionObjectiveSetEvent ObjectiveSetEvent);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"Mission_COVSlaughter1_C">();
	}
	static class UMission_COVSlaughter1_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMission_COVSlaughter1_C>();
	}
};
static_assert(alignof(UMission_COVSlaughter1_C) == 0x000008, "Wrong alignment on UMission_COVSlaughter1_C");
static_assert(sizeof(UMission_COVSlaughter1_C) == 0x000638, "Wrong size on UMission_COVSlaughter1_C");
static_assert(offsetof(UMission_COVSlaughter1_C, UberGraphFrame) == 0x000510, "Member 'UMission_COVSlaughter1_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_StartRound_1_ObjVar) == 0x000518, "Member 'UMission_COVSlaughter1_C::Obj_StartRound_1_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_Rounds_ObjVar) == 0x000520, "Member 'UMission_COVSlaughter1_C::Obj_Rounds_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_CompleteWave_1_ObjVar) == 0x000528, "Member 'UMission_COVSlaughter1_C::Obj_CompleteWave_1_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Set_TurnIn_ObjSetVar) == 0x000530, "Member 'UMission_COVSlaughter1_C::Set_TurnIn_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_TurnIn_ObjVar) == 0x000538, "Member 'UMission_COVSlaughter1_C::Obj_TurnIn_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_OptionalObjective_1_ObjVar) == 0x000540, "Member 'UMission_COVSlaughter1_C::Obj_OptionalObjective_1_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Set_Round_1_ObjSetVar) == 0x000548, "Member 'UMission_COVSlaughter1_C::Set_Round_1_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Set_Round_2_ObjSetVar) == 0x000550, "Member 'UMission_COVSlaughter1_C::Set_Round_2_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_StartRound_2_ObjVar) == 0x000558, "Member 'UMission_COVSlaughter1_C::Obj_StartRound_2_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_CompleteWave_2_ObjVar) == 0x000560, "Member 'UMission_COVSlaughter1_C::Obj_CompleteWave_2_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Set_Round_3_ObjSetVar) == 0x000568, "Member 'UMission_COVSlaughter1_C::Set_Round_3_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_StartRound_3_ObjVar) == 0x000570, "Member 'UMission_COVSlaughter1_C::Obj_StartRound_3_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_CompleteWave_3_ObjVar) == 0x000578, "Member 'UMission_COVSlaughter1_C::Obj_CompleteWave_3_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Set_Round_4_ObjSetVar) == 0x000580, "Member 'UMission_COVSlaughter1_C::Set_Round_4_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_StartRound_4_ObjVar) == 0x000588, "Member 'UMission_COVSlaughter1_C::Obj_StartRound_4_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_CompleteWave_4_ObjVar) == 0x000590, "Member 'UMission_COVSlaughter1_C::Obj_CompleteWave_4_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Set_Round_5_ObjSetVar) == 0x000598, "Member 'UMission_COVSlaughter1_C::Set_Round_5_ObjSetVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_StartRound_5_ObjVar) == 0x0005A0, "Member 'UMission_COVSlaughter1_C::Obj_StartRound_5_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_CompleteWave_5_ObjVar) == 0x0005A8, "Member 'UMission_COVSlaughter1_C::Obj_CompleteWave_5_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_OptionalObjective_2_ObjVar) == 0x0005B0, "Member 'UMission_COVSlaughter1_C::Obj_OptionalObjective_2_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_OptionalObjective_3_ObjVar) == 0x0005B8, "Member 'UMission_COVSlaughter1_C::Obj_OptionalObjective_3_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_OptionalObjective_4_ObjVar) == 0x0005C0, "Member 'UMission_COVSlaughter1_C::Obj_OptionalObjective_4_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_OptionalObjective_5_ObjVar) == 0x0005C8, "Member 'UMission_COVSlaughter1_C::Obj_OptionalObjective_5_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, SlaughterGameMode) == 0x0005D0, "Member 'UMission_COVSlaughter1_C::SlaughterGameMode' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, RoundCount) == 0x0005D8, "Member 'UMission_COVSlaughter1_C::RoundCount' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_INVIS_AssembleRound1_ObjVar) == 0x0005E0, "Member 'UMission_COVSlaughter1_C::Obj_INVIS_AssembleRound1_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_INVIS_Assemble2_ObjVar) == 0x0005E8, "Member 'UMission_COVSlaughter1_C::Obj_INVIS_Assemble2_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_INVIS_Assemble3_ObjVar) == 0x0005F0, "Member 'UMission_COVSlaughter1_C::Obj_INVIS_Assemble3_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_INVIS_Assemble4_ObjVar) == 0x0005F8, "Member 'UMission_COVSlaughter1_C::Obj_INVIS_Assemble4_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_INVIS_Assemble5_ObjVar) == 0x000600, "Member 'UMission_COVSlaughter1_C::Obj_INVIS_Assemble5_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Slaughter_Game_State) == 0x000608, "Member 'UMission_COVSlaughter1_C::Slaughter_Game_State' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_INVIS_PlayersDiedinRound_ObjVar) == 0x000610, "Member 'UMission_COVSlaughter1_C::Obj_INVIS_PlayersDiedinRound_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Torgue_VO_Start) == 0x000618, "Member 'UMission_COVSlaughter1_C::Torgue_VO_Start' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Obj_DropshipCleared_ObjVar) == 0x000628, "Member 'UMission_COVSlaughter1_C::Obj_DropshipCleared_ObjVar' has a wrong offset!");
static_assert(offsetof(UMission_COVSlaughter1_C, Player_Used_Button_CoV) == 0x000630, "Member 'UMission_COVSlaughter1_C::Player_Used_Button_CoV' has a wrong offset!");
