...
static_assert(offsetof(FLevelSequencePlayerSnapshot, CurrentShotLocalTime) == 0x000030, "Member 'FLevelSequencePlayerSnapshot::CurrentShotLocalTime' has a wrong offset!");
...
static_assert(offsetof(FLevelSequencePlayerSnapshot, ShotID) == 0x000054, "Member 'FLevelSequencePlayerSnapshot::ShotID' has a wrong offset!");
