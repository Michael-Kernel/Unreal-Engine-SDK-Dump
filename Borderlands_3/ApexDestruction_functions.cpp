...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class USkinnedMeshComponent*            NewDestructiblePoseComponent                           (Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UDestructibleComponent::SetDestructiblePoseComponent(class USkinnedMeshComponent* NewDestructiblePoseComponent)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("DestructibleComponent", "SetDestructiblePoseComponent");

	Params::DestructibleComponent_SetDestructiblePoseComponent Parms{};

	Parms.NewDestructiblePoseComponent = NewDestructiblePoseComponent;
...
class UDestructibleMesh* UDestructibleComponent::GetDestructibleMesh() const
{
	static class UFunction* Func = nullptr;
