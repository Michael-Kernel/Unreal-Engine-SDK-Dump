...
static_assert(sizeof(USignificanceManager) == 0x000130, "Wrong size on USignificanceManager");
static_assert(offsetof(USignificanceManager, SignificanceManagerClassName) == 0x000118, "Member 'USignificanceManager::SignificanceManagerClassName' has a wrong offset!");
