...
// (Final, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// class FText                             Name_0                                                 (Parm, NativeAccessSpecifierPublic)
...
void USimpleBarChart::BP_AddCategory(const class FText& Name_0, class FName* CatId)
{
	static class UFunction* Func = nullptr;
...
void USimpleBarChart::BP_AddCategoryWithId(class FName ID, const class FText& Name_0, bool* bSuccess)
{
	static class UFunction* Func = nullptr;
...
void USimpleCartesianPlot::BP_AddSeries(class FName* SeriesId, const class FText& Name_0, bool bEnabled, bool bShowPoints, bool bShowLines)
{
	static class UFunction* Func = nullptr;
...
void USimpleCartesianPlot::BP_AddSeriesWithId(bool* bSuccess, class FName ID, const class FText& Name_0, bool bEnabled, bool bShowPoints, bool bShowLines)
{
	static class UFunction* Func = nullptr;
...
void USimpleTimeSeriesPlot::BP_AddSeries(class FName* SeriesId, const class FText& Name_0, bool bEnabled, bool bShowPoints, bool bShowLines)
{
	static class UFunction* Func = nullptr;
...
void USimpleTimeSeriesPlot::BP_AddSeriesWithId(bool* bSuccess, class FName ID, const class FText& Name_0, bool bEnabled, bool bShowPoints, bool bShowLines)
{
	static class UFunction* Func = nullptr;
...
void USimpleTimeSeriesPlot::BP_SetDatapointLimit(int32 Limit)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("SimpleTimeSeriesPlot", "BP_SetDatapointLimit");

	Params::SimpleTimeSeriesPlot_BP_SetDatapointLimit Parms{};
