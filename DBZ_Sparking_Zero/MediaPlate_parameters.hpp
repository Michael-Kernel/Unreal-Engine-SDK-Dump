...
static_assert(sizeof(MediaPlateComponent_GetMediaTexture) == 0x000008, "Wrong size on MediaPlateComponent_GetMediaTexture");
static_assert(offsetof(MediaPlateComponent_GetMediaTexture, ReturnValue) == 0x000000, "Member 'MediaPlateComponent_GetMediaTexture::ReturnValue' has a wrong offset!");
