...
static_assert(offsetof(SimpleBarChart_BP_AddCategory, Name_0) == 0x000000, "Member 'SimpleBarChart_BP_AddCategory::Name_0' has a wrong offset!");
...
static_assert(offsetof(SimpleBarChart_BP_AddCategoryWithId, Name_0) == 0x000008, "Member 'SimpleBarChart_BP_AddCategoryWithId::Name_0' has a wrong offset!");
...
static_assert(offsetof(SimpleCartesianPlot_BP_AddSeries, Name_0) == 0x000008, "Member 'SimpleCartesianPlot_BP_AddSeries::Name_0' has a wrong offset!");
...
public:
	...
	class FText                                   Name_0;                                            // 0x0010(0x0018)(Parm, NativeAccessSpecifierPublic)
...
static_assert(offsetof(SimpleCartesianPlot_BP_AddSeriesWithId, Name_0) == 0x000010, "Member 'SimpleCartesianPlot_BP_AddSeriesWithId::Name_0' has a wrong offset!");
...
static_assert(offsetof(SimpleTimeSeriesPlot_BP_AddSeries, Name_0) == 0x000008, "Member 'SimpleTimeSeriesPlot_BP_AddSeries::Name_0' has a wrong offset!");
...
static_assert(offsetof(SimpleTimeSeriesPlot_BP_AddSeriesWithId, Name_0) == 0x000010, "Member 'SimpleTimeSeriesPlot_BP_AddSeriesWithId::Name_0' has a wrong offset!");
...
// 0x0004 (0x0004 - 0x0000)
struct SimpleTimeSeriesPlot_BP_SetDatapointLimit final
{
public:
...
static_assert(alignof(SimpleTimeSeriesPlot_BP_SetDatapointLimit) == 0x000004, "Wrong alignment on SimpleTimeSeriesPlot_BP_SetDatapointLimit");
static_assert(sizeof(SimpleTimeSeriesPlot_BP_SetDatapointLimit) == 0x000004, "Wrong size on SimpleTimeSeriesPlot_BP_SetDatapointLimit");
static_assert(offsetof(SimpleTimeSeriesPlot_BP_SetDatapointLimit, Limit) == 0x000000, "Member 'SimpleTimeSeriesPlot_BP_SetDatapointLimit::Limit' has a wrong offset!");
