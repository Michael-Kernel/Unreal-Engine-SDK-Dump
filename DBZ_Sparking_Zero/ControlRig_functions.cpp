...
bool UControlRig::Execute(const EControlRigState State, const class FName& InEventName)
{
	static class UFunction* Func = nullptr;
...
bool UControlRig::ExecuteEvent(const class FName& InEventName)
{
	static class UFunction* Func = nullptr;
...
bool UControlRig::ContainsEvent(const class FName& InEventName) const
{
	static class UFunction* Func = nullptr;
...
TSubclassOf<class UControlRig> IKoratControlRigCustomInterface::GetReplaceClass(const class UClass* InClass) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("KoratControlRigCustomInterface", "GetReplaceClass");

	Params::KoratControlRigCustomInterface_GetReplaceClass Parms{};
