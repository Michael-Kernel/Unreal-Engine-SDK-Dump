...
void UKantanSimpleCartesianDatasource::BP_AddSeries(const class FText& Name_0, class FName* SeriesId)
{
	static class UFunction* Func = nullptr;
...
void UKantanSimpleCartesianDatasource::BP_AddSeriesWithId(class FName ID, const class FText& Name_0, bool* bSuccess)
{
	static class UFunction* Func = nullptr;
...
void UKantanSimpleCategoryDatasource::BP_AddCategory(const class FText& Name_0, class FName* CatId)
{
	static class UFunction* Func = nullptr;
...
void UKantanSimpleCategoryDatasource::BP_AddCategoryWithId(class FName ID, const class FText& Name_0, bool* bSuccess)
{
	static class UFunction* Func = nullptr;
