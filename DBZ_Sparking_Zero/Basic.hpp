...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08511360;
	constexpr int32 AppendString      = 0x02B5E6A0;
	constexpr int32 GNames            = 0x08471C80;
	constexpr int32 GWorld            = 0x0867D8A0;
	constexpr int32 ProcessEvent      = 0x02CDEFD0;
