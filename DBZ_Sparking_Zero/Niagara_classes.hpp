...
static_assert(offsetof(ANiagaraActor, NiagaraComponent) == 0x000290, "Member 'ANiagaraActor::NiagaraComponent' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnSystemFinished;                                  // 0x0670(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNiagaraComponent, Asset) == 0x000540, "Member 'UNiagaraComponent::Asset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, TickBehavior) == 0x000548, "Member 'UNiagaraComponent::TickBehavior' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, RandomSeedOffset) == 0x00054C, "Member 'UNiagaraComponent::RandomSeedOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OverrideParameters) == 0x000550, "Member 'UNiagaraComponent::OverrideParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, MaxTimeBeforeForceUpdateTransform) == 0x000664, "Member 'UNiagaraComponent::MaxTimeBeforeForceUpdateTransform' has a wrong offset!");
...
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x000690, "Member 'UNiagaraComponent::AutoAttachLocationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x000691, "Member 'UNiagaraComponent::AutoAttachRotationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x000692, "Member 'UNiagaraComponent::AutoAttachScaleRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, SimCache) == 0x0007C8, "Member 'UNiagaraComponent::SimCache' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, CullProxy) == 0x0007D0, "Member 'UNiagaraComponent::CullProxy' has a wrong offset!");
...
static_assert(offsetof(UNiagaraCullProxyComponent, Instances) == 0x0007D8, "Member 'UNiagaraCullProxyComponent::Instances' has a wrong offset!");
...
static_assert(offsetof(UNiagaraDataInterfaceAudioPlayer, bAllowLoopingOneShotSounds) == 0x000069, "Member 'UNiagaraDataInterfaceAudioPlayer::bAllowLoopingOneShotSounds' has a wrong offset!");
...
static_assert(offsetof(ANiagaraPerfBaselineActor, Controller) == 0x000290, "Member 'ANiagaraPerfBaselineActor::Controller' has a wrong offset!");
static_assert(offsetof(ANiagaraPerfBaselineActor, Label) == 0x000298, "Member 'ANiagaraPerfBaselineActor::Label' has a wrong offset!");
...
static_assert(offsetof(ANiagaraPreviewGrid, System) == 0x000290, "Member 'ANiagaraPreviewGrid::System' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, ResetMode) == 0x000298, "Member 'ANiagaraPreviewGrid::ResetMode' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisX) == 0x0002A0, "Member 'ANiagaraPreviewGrid::PreviewAxisX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisY) == 0x0002A8, "Member 'ANiagaraPreviewGrid::PreviewAxisY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewClass) == 0x0002B0, "Member 'ANiagaraPreviewGrid::PreviewClass' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, SpacingX) == 0x0002B8, "Member 'ANiagaraPreviewGrid::SpacingX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, SpacingY) == 0x0002BC, "Member 'ANiagaraPreviewGrid::SpacingY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, NumX) == 0x0002C0, "Member 'ANiagaraPreviewGrid::NumX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, NumY) == 0x0002C4, "Member 'ANiagaraPreviewGrid::NumY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewComponents) == 0x0002C8, "Member 'ANiagaraPreviewGrid::PreviewComponents' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_AF0[0x78];                                     // 0x0AF0(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
