...
// Function ControlRig.KoratControlRigCustomInterface.GetReplaceClass
// 0x0010 (0x0010 - 0x0000)
struct KoratControlRigCustomInterface_GetReplaceClass final
{
public:
...
static_assert(alignof(KoratControlRigCustomInterface_GetReplaceClass) == 0x000008, "Wrong alignment on KoratControlRigCustomInterface_GetReplaceClass");
static_assert(sizeof(KoratControlRigCustomInterface_GetReplaceClass) == 0x000010, "Wrong size on KoratControlRigCustomInterface_GetReplaceClass");
static_assert(offsetof(KoratControlRigCustomInterface_GetReplaceClass, InClass) == 0x000000, "Member 'KoratControlRigCustomInterface_GetReplaceClass::InClass' has a wrong offset!");
static_assert(offsetof(KoratControlRigCustomInterface_GetReplaceClass, ReturnValue) == 0x000008, "Member 'KoratControlRigCustomInterface_GetReplaceClass::ReturnValue' has a wrong offset!");
