...
{
public:
	float                                         Priority;                                          // 0x02C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bEnabled : 1;                                      // 0x02CC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, Net, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_2CD[0xB];                                      // 0x02CD(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TWeakObjectPtr<class AAtomAudioVolume>> NeighbourhoodAudioVolumeArray;                     // 0x02D8(0x0010)(Edit, Net, ZeroConstructor, EditConst, RepNotify, UObjectWrapper, NativeAccessSpecifierPublic)
...
public:
	...
	class FName                                   CollisionProfile;                                  // 0x02D0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bAutoSettingEntranceVolume;                        // 0x02D8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bAutoSettingNeighbourAudioVolumeToEntranceVolume;  // 0x02D9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2DA[0x6];                                      // 0x02DA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           AudioVolumeTags;                                   // 0x02E0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	bool                                          bOverrideAtomAudioVolume;                          // 0x02F0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2F1[0x7];                                      // 0x02F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UAtomAudioVolumeSettings*               AtomAudioVolumeSettings;                           // 0x02F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAtomAudioVolumeParameters             AtomAudioVolumeSettingsOverrides;                  // 0x0300(0x0040)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TArray<class AAtomEntranceVolume*>            EntranceVolumes;                                   // 0x0340(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
...
public:
	...
	class UAtom3dRegionHandle*                    Handle;                                            // 0x0040(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	float                                         DefaultOutputVolumeScale;                          // 0x02A0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A4[0x4];                                      // 0x02A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UAtom3dRegion*                          DefaultRegion;                                     // 0x02A8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bIsAttenuationDistanceDebugSpheresVisible : 1;     // 0x02B0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_2B1[0x3];                                      // 0x02B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DefaultMinAttenuationDistance;                     // 0x02B4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DefaultMaxAttenuationDistance;                     // 0x02B8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bIsOutputInteriorPanFieldDebugSpheresVisible : 1;  // 0x02BC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_2BD[0x3];                                      // 0x02BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DefaultSourceRadius;                               // 0x02C0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DefaultInteriorDistance;                           // 0x02C4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FString>                         DefaultDistanceAisacControls;                      // 0x02C8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         DefaultOutputBasedAzimuthAngleAisacControls;       // 0x02D8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         DefaultOutputBasedElevationAngleAisacControls;     // 0x02E8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         DefaultListenerBasedAzimuthAngleAisacControls;     // 0x02F8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         DefaultListenerBasedElevationAngleAisacControls;   // 0x0308(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         bIsDebugStringsForDetailsVisible : 1;              // 0x0318(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_319[0x1F];                                     // 0x0319(0x001F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAtom3dSourceBaseComponent) == 0x000340, "Wrong size on UAtom3dSourceBaseComponent");
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultOutputVolumeScale) == 0x0002A0, "Member 'UAtom3dSourceBaseComponent::DefaultOutputVolumeScale' has a wrong offset!");
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultRegion) == 0x0002A8, "Member 'UAtom3dSourceBaseComponent::DefaultRegion' has a wrong offset!");
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultMinAttenuationDistance) == 0x0002B4, "Member 'UAtom3dSourceBaseComponent::DefaultMinAttenuationDistance' has a wrong offset!");
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultMaxAttenuationDistance) == 0x0002B8, "Member 'UAtom3dSourceBaseComponent::DefaultMaxAttenuationDistance' has a wrong offset!");
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultSourceRadius) == 0x0002C0, "Member 'UAtom3dSourceBaseComponent::DefaultSourceRadius' has a wrong offset!");
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultInteriorDistance) == 0x0002C4, "Member 'UAtom3dSourceBaseComponent::DefaultInteriorDistance' has a wrong offset!");
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultDistanceAisacControls) == 0x0002C8, "Member 'UAtom3dSourceBaseComponent::DefaultDistanceAisacControls' has a wrong offset!");
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultOutputBasedAzimuthAngleAisacControls) == 0x0002D8, "Member 'UAtom3dSourceBaseComponent::DefaultOutputBasedAzimuthAngleAisacControls' has a wrong offset!");
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultOutputBasedElevationAngleAisacControls) == 0x0002E8, "Member 'UAtom3dSourceBaseComponent::DefaultOutputBasedElevationAngleAisacControls' has a wrong offset!");
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultListenerBasedAzimuthAngleAisacControls) == 0x0002F8, "Member 'UAtom3dSourceBaseComponent::DefaultListenerBasedAzimuthAngleAisacControls' has a wrong offset!");
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultListenerBasedElevationAngleAisacControls) == 0x000308, "Member 'UAtom3dSourceBaseComponent::DefaultListenerBasedElevationAngleAisacControls' has a wrong offset!");
...
{
public:
	class AActor*                                 InputPoint;                                        // 0x0338(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FString>                         DefaultGlobalAisacs;                               // 0x0340(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         bIsInputCrossfadeFieldDebugSpheresVisible : 1;     // 0x0350(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_351[0x3];                                      // 0x0351(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DefaultDirectAudioRadius;                          // 0x0354(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DefaultCrossfadeDistance;                          // 0x0358(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAtom3dTransceiverComponent) == 0x000360, "Wrong size on UAtom3dTransceiverComponent");
static_assert(offsetof(UAtom3dTransceiverComponent, InputPoint) == 0x000338, "Member 'UAtom3dTransceiverComponent::InputPoint' has a wrong offset!");
static_assert(offsetof(UAtom3dTransceiverComponent, DefaultGlobalAisacs) == 0x000340, "Member 'UAtom3dTransceiverComponent::DefaultGlobalAisacs' has a wrong offset!");
static_assert(offsetof(UAtom3dTransceiverComponent, DefaultDirectAudioRadius) == 0x000354, "Member 'UAtom3dTransceiverComponent::DefaultDirectAudioRadius' has a wrong offset!");
static_assert(offsetof(UAtom3dTransceiverComponent, DefaultCrossfadeDistance) == 0x000358, "Member 'UAtom3dTransceiverComponent::DefaultCrossfadeDistance' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2CD[0x3];                                      // 0x02CD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   CollisionProfile;                                  // 0x02D0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         SoundStopDistance;                                 // 0x02D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsEnableAtomCompoentPack;                         // 0x02DC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2DD[0x2];                                      // 0x02DD(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bIsAutoPlaySound;                                  // 0x02DF(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsDeterminationFromVolumeBoundaryPlane;           // 0x02E0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableRepeatPlayWhenSoundStop;                    // 0x02E1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2E2[0x6];                                      // 0x02E2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UAtomComponent*>                 AtomComponents;                                    // 0x02E8(0x0010)(BlueprintVisible, ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TArray<class USoundAtomCue*>                  Sounds;                                            // 0x02F8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	bool AssociateOutputPort(const class FString& OutputPortName);
	...
	void SetAisacControlByName(const class FString& Control_name, float Control_value);
...
public:
	...
	class USoundAtomCue*                          Sound;                                             // 0x02A8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAtom3dRegion*                          Region;                                            // 0x02B0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bAutoDestroy : 1;                                  // 0x02B8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bPersistAcrossLevelTransition : 1;                 // 0x02B8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         BitPad_2B8_2 : 1;                                  // 0x02B8(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bStopWhenOwnerDestroyed : 1;                       // 0x02B8(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bIsUISound : 1;                                    // 0x02B8(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_2B9[0x3];                                      // 0x02B9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DefaultVolume;                                     // 0x02BC(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bEnableMultipleSoundPlayback : 1;                  // 0x02C0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUsePlaylist : 1;                                  // 0x02C0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	bool                                          bIsMovable;                                        // 0x02C1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCanStraddleAudioVolume;                           // 0x02C2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseAudioVolume;                                   // 0x02C3(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseAreaSoundVolume;                               // 0x02C4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C5[0x3];                                      // 0x02C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UAtomSoundObject*                       SoundObject;                                       // 0x02C8(0x0008)(Edit, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         DefaultBlockIndex;                                 // 0x02D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D4[0x4];                                      // 0x02D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FAtomAisacControlParam>         DefaultAisacControl;                               // 0x02D8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FAtomSelectorParam>             DefaultSelectorLabel;                              // 0x02E8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bIsOverrideAisacControlSettingsWithVelocity;       // 0x02F8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2F9[0x7];                                      // 0x02F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FAtomAisacControlWithVelocityParam> OverrideAisacControlSettingsWithVelocity;          // 0x0300(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	EAtomLoopSetting                              LoopSetting;                                       // 0x0310(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bOnly2DSound : 1;                                  // 0x0311(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_312[0x6];                                      // 0x0312(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnStatusChanged;                                   // 0x0318(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAudioVolumeChanged;                              // 0x0328(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAudioFinished;                                   // 0x0338(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UWorld*                                 PlayWorld;                                         // 0x0348(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGameViewportClient*                    GameViewport;                                      // 0x0350(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_358[0x28];                                     // 0x0358(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	class UAtomSoundObject*                       DefaultSoundObject;                                // 0x0380(0x0008)(ZeroConstructor, Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bOverrideAttenuation : 1;                          // 0x0388(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_389[0x7];                                      // 0x0389(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundAttenuation*                      AttenuationSettings;                               // 0x0390(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoundAttenuationSettings              AttenuationOverrides;                              // 0x0398(0x03C8)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	uint8                                         Pad_760[0xAE8];                                    // 0x0760(0x0AE8)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundAtomCueSheet*                     CueSheet;                                          // 0x1248(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1250[0x10];                                    // 0x1250(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UAtomSoundObject*                       AppliedSoundObject;                                // 0x1260(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1268[0x20];                                    // 0x1268(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnAtomBeatSyncCallback;                            // 0x1288(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAtomSequenceCallback;                            // 0x1298(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_12A8[0x88];                                    // 0x12A8(0x0088)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void RemoveOutputPort(const class FString& Port_name);
	void RemovePreferredOutputPort(const class FString& Port_name);
	...
	void SetOutputPort(const class FString& Port_name);
	void SetPitch(float Pitch);
	void SetPitchMultiplier(float NewPitchMultiplier);
	void SetPreferredOutputPort(const class FString& Port_name);
	void SetRegion(class UAtom3dRegion* InRegion);
...
static_assert(sizeof(UAtomComponent) == 0x001330, "Wrong size on UAtomComponent");
static_assert(offsetof(UAtomComponent, Sound) == 0x0002A8, "Member 'UAtomComponent::Sound' has a wrong offset!");
static_assert(offsetof(UAtomComponent, Region) == 0x0002B0, "Member 'UAtomComponent::Region' has a wrong offset!");
static_assert(offsetof(UAtomComponent, DefaultVolume) == 0x0002BC, "Member 'UAtomComponent::DefaultVolume' has a wrong offset!");
static_assert(offsetof(UAtomComponent, bIsMovable) == 0x0002C1, "Member 'UAtomComponent::bIsMovable' has a wrong offset!");
static_assert(offsetof(UAtomComponent, bCanStraddleAudioVolume) == 0x0002C2, "Member 'UAtomComponent::bCanStraddleAudioVolume' has a wrong offset!");
static_assert(offsetof(UAtomComponent, bUseAudioVolume) == 0x0002C3, "Member 'UAtomComponent::bUseAudioVolume' has a wrong offset!");
static_assert(offsetof(UAtomComponent, bUseAreaSoundVolume) == 0x0002C4, "Member 'UAtomComponent::bUseAreaSoundVolume' has a wrong offset!");
static_assert(offsetof(UAtomComponent, SoundObject) == 0x0002C8, "Member 'UAtomComponent::SoundObject' has a wrong offset!");
static_assert(offsetof(UAtomComponent, DefaultBlockIndex) == 0x0002D0, "Member 'UAtomComponent::DefaultBlockIndex' has a wrong offset!");
static_assert(offsetof(UAtomComponent, DefaultAisacControl) == 0x0002D8, "Member 'UAtomComponent::DefaultAisacControl' has a wrong offset!");
static_assert(offsetof(UAtomComponent, DefaultSelectorLabel) == 0x0002E8, "Member 'UAtomComponent::DefaultSelectorLabel' has a wrong offset!");
static_assert(offsetof(UAtomComponent, bIsOverrideAisacControlSettingsWithVelocity) == 0x0002F8, "Member 'UAtomComponent::bIsOverrideAisacControlSettingsWithVelocity' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OverrideAisacControlSettingsWithVelocity) == 0x000300, "Member 'UAtomComponent::OverrideAisacControlSettingsWithVelocity' has a wrong offset!");
static_assert(offsetof(UAtomComponent, LoopSetting) == 0x000310, "Member 'UAtomComponent::LoopSetting' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OnStatusChanged) == 0x000318, "Member 'UAtomComponent::OnStatusChanged' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OnAudioVolumeChanged) == 0x000328, "Member 'UAtomComponent::OnAudioVolumeChanged' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OnAudioFinished) == 0x000338, "Member 'UAtomComponent::OnAudioFinished' has a wrong offset!");
static_assert(offsetof(UAtomComponent, PlayWorld) == 0x000348, "Member 'UAtomComponent::PlayWorld' has a wrong offset!");
static_assert(offsetof(UAtomComponent, GameViewport) == 0x000350, "Member 'UAtomComponent::GameViewport' has a wrong offset!");
static_assert(offsetof(UAtomComponent, DefaultSoundObject) == 0x000380, "Member 'UAtomComponent::DefaultSoundObject' has a wrong offset!");
static_assert(offsetof(UAtomComponent, AttenuationSettings) == 0x000390, "Member 'UAtomComponent::AttenuationSettings' has a wrong offset!");
static_assert(offsetof(UAtomComponent, AttenuationOverrides) == 0x000398, "Member 'UAtomComponent::AttenuationOverrides' has a wrong offset!");
static_assert(offsetof(UAtomComponent, CueSheet) == 0x001248, "Member 'UAtomComponent::CueSheet' has a wrong offset!");
static_assert(offsetof(UAtomComponent, AppliedSoundObject) == 0x001260, "Member 'UAtomComponent::AppliedSoundObject' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OnAtomBeatSyncCallback) == 0x001288, "Member 'UAtomComponent::OnAtomBeatSyncCallback' has a wrong offset!");
static_assert(offsetof(UAtomComponent, OnAtomSequenceCallback) == 0x001298, "Member 'UAtomComponent::OnAtomSequenceCallback' has a wrong offset!");
...
{
public:
	struct FSoftObjectPath                        CueSheetReference;                                 // 0x02A0(0x0020)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCriFsBinderComponent*                  BinderComponent;                                   // 0x02C0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLoadCompleted;                                   // 0x02C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLoadError;                                       // 0x02D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2E8[0x30];                                     // 0x02E8(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundAtomCueSheet*                     CueSheet;                                          // 0x0318(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAtomCueSheetLoaderComponent) == 0x000350, "Wrong size on UAtomCueSheetLoaderComponent");
static_assert(offsetof(UAtomCueSheetLoaderComponent, CueSheetReference) == 0x0002A0, "Member 'UAtomCueSheetLoaderComponent::CueSheetReference' has a wrong offset!");
static_assert(offsetof(UAtomCueSheetLoaderComponent, BinderComponent) == 0x0002C0, "Member 'UAtomCueSheetLoaderComponent::BinderComponent' has a wrong offset!");
static_assert(offsetof(UAtomCueSheetLoaderComponent, OnLoadCompleted) == 0x0002C8, "Member 'UAtomCueSheetLoaderComponent::OnLoadCompleted' has a wrong offset!");
static_assert(offsetof(UAtomCueSheetLoaderComponent, OnLoadError) == 0x0002D8, "Member 'UAtomCueSheetLoaderComponent::OnLoadError' has a wrong offset!");
static_assert(offsetof(UAtomCueSheetLoaderComponent, CueSheet) == 0x000318, "Member 'UAtomCueSheetLoaderComponent::CueSheet' has a wrong offset!");
...
{
public:
	float                                         DistanceFocusLevel;                                // 0x02A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DirectionFocusLevel;                               // 0x02A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAtomListenerFocusPoint) == 0x0002B0, "Wrong size on UAtomListenerFocusPoint");
static_assert(offsetof(UAtomListenerFocusPoint, DistanceFocusLevel) == 0x0002A0, "Member 'UAtomListenerFocusPoint::DistanceFocusLevel' has a wrong offset!");
static_assert(offsetof(UAtomListenerFocusPoint, DirectionFocusLevel) == 0x0002A4, "Member 'UAtomListenerFocusPoint::DirectionFocusLevel' has a wrong offset!");
...
{
public:
	class UAtomSoundObject*                       SoundObject;                                       // 0x00A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAtom3dRegion*                          Region;                                            // 0x00A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class UAtomComponent*                         AtomComponent;                                     // 0x0290(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class USoundAtomCueSheet*                     CueSheet;                                          // 0x0290(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// 0x8050 (0x84F0 - 0x04A0)
class UAtomUnrealSoundRenderer final : public USoundWaveProcedural
{
public:
	uint8                                         Pad_4A0[0x8050];                                   // 0x04A0(0x8050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAtomUnrealSoundRenderer) == 0x0084F0, "Wrong size on UAtomUnrealSoundRenderer");
...
public:
	...
	class USoundAtomCue*                          SoundAtomCue;                                      // 0x0090(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAtomWaveInfo                          WaveInfo;                                          // 0x0098(0x0014)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	class FString                                 FilePath;                                          // 0x02A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnBindCompleted;                                   // 0x02B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnBindError;                                       // 0x02C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCriFsBinderComponent) == 0x000300, "Wrong size on UCriFsBinderComponent");
static_assert(offsetof(UCriFsBinderComponent, FilePath) == 0x0002A0, "Member 'UCriFsBinderComponent::FilePath' has a wrong offset!");
static_assert(offsetof(UCriFsBinderComponent, OnBindCompleted) == 0x0002B0, "Member 'UCriFsBinderComponent::OnBindCompleted' has a wrong offset!");
static_assert(offsetof(UCriFsBinderComponent, OnBindError) == 0x0002C0, "Member 'UCriFsBinderComponent::OnBindError' has a wrong offset!");
...
{
public:
	class UCriFsLoaderComponent*                  LoaderComponent;                                   // 0x0290(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	class FString                                 FilePath;                                          // 0x02A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLoadCompleted;                                   // 0x02B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLoadError;                                       // 0x02C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCriFsLoaderComponent) == 0x000320, "Wrong size on UCriFsLoaderComponent");
static_assert(offsetof(UCriFsLoaderComponent, FilePath) == 0x0002A0, "Member 'UCriFsLoaderComponent::FilePath' has a wrong offset!");
static_assert(offsetof(UCriFsLoaderComponent, OnLoadCompleted) == 0x0002B0, "Member 'UCriFsLoaderComponent::OnLoadCompleted' has a wrong offset!");
static_assert(offsetof(UCriFsLoaderComponent, OnLoadError) == 0x0002C0, "Member 'UCriFsLoaderComponent::OnLoadError' has a wrong offset!");
...
public:
	...
	struct FDirectoryPath                         NonAssetContentDir;                                // 0x0030(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FDirectoryPath                         AwbRootDirectory;                                  // 0x00C0(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FSoftObjectPath                        AtomConfig;                                        // 0x0148(0x0020)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_168[0x20];                                     // 0x0168(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 AcfFileName;                                       // 0x0188(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        AtomConfigDataTable;                               // 0x0198(0x0020)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B8[0x20];                                     // 0x01B8(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSoftObjectPath                        AtomOutputPortDataTable;                           // 0x01D8(0x0020)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1F8[0x20];                                     // 0x01F8(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         DistanceFactor;                                    // 0x0218(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_21C[0x4];                                      // 0x021C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	EAtomSoundRendererType                        SoundRendererTypeUI;                               // 0x0220(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SoundRendererType;                                 // 0x0224(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_228[0x8];                                      // 0x0228(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FAtomAsrRackConfigUI>           AsrRackConfigUI;                                   // 0x0230(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FAtomAsrRackConfig>             AsrRackConfig;                                     // 0x0240(0x0010)(ZeroConstructor, Config, NativeAccessSpecifierPublic)
	uint8                                         Pad_250[0x10];                                     // 0x0250(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 Hardware1;                                         // 0x0260(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Hardware2;                                         // 0x0270(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Hardware3;                                         // 0x0280(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Hardware4;                                         // 0x0290(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EconomicTickMarginDistance;                        // 0x02A0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A4[0x4];                                      // 0x02A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         EconomicTickFrequency;                             // 0x02A8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2AC[0x4];                                      // 0x02AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CullingMarginDistance;                             // 0x02B0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2B4[0x4];                                      // 0x02B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         HcaMxVoiceSamplingRate;                            // 0x02B8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2BC[0x4];                                      // 0x02BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         NumHcaMxMemoryVoices;                              // 0x02C0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C4[0x4];                                      // 0x02C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         HcaMxMemoryVoiceNumChannels;                       // 0x02C8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2CC[0x4];                                      // 0x02CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         NumHcaMxStreamingVoices;                           // 0x02D0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D4[0x4];                                      // 0x02D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         HcaMxStreamingVoiceNumChannels;                    // 0x02D8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2DC[0x4];                                      // 0x02DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          WASAPI_IsExclusive;                                // 0x02E0(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2E1[0x3];                                      // 0x02E1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         WASAPI_BitsPerSample;                              // 0x02E4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2E8[0x4];                                      // 0x02E8(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         WASAPI_SamplingRate;                               // 0x02EC(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2F0[0x4];                                      // 0x02F0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         WASAPI_NumChannels;                                // 0x02F4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2F8[0x4];                                      // 0x02F8(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          UseUnrealSoundRenderer;                            // 0x02FC(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2FD[0x1];                                      // 0x02FD(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          SmartPhone_UseSonicSYNC;                           // 0x02FE(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2FF[0x1];                                      // 0x02FF(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_ServerThreadAffinityMask;                      // 0x0300(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_304[0x4];                                      // 0x0304(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_OutputThreadAffinityMask;                      // 0x0308(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_30C[0x4];                                      // 0x030C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_ServerThreadPriority;                          // 0x0310(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_314[0x4];                                      // 0x0314(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_OutputThreadPriority;                          // 0x0318(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_31C[0x4];                                      // 0x031C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          PS4_UseAudio3d;                                    // 0x0320(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_321[0x3];                                      // 0x0321(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_NumberOfAudio3dMemoryVoices;                   // 0x0324(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_328[0x4];                                      // 0x0328(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_SamplingRateOfAudio3dMemoryVoices;             // 0x032C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_330[0x4];                                      // 0x0330(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_NumberOfAudio3dStreamingVoices;                // 0x0334(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_338[0x4];                                      // 0x0338(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS4_SamplingRateOfAudio3dStreamingVoices;          // 0x033C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_340[0x4];                                      // 0x0340(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PS5_MaxChannelPorts;                               // 0x0344(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_348[0x4];                                      // 0x0348(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Switch_NumOpusMemoryVoices;                        // 0x034C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_350[0x4];                                      // 0x0350(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Switch_OpusMemoryVoiceNumChannels;                 // 0x0354(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_358[0x4];                                      // 0x0358(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Switch_OpusMemoryVoiceSamplingRate;                // 0x035C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_360[0x4];                                      // 0x0360(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Switch_NumOpusStreamingVoices;                     // 0x0364(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_368[0x4];                                      // 0x0368(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Switch_OpusStreamingVoiceNumChannels;              // 0x036C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_370[0x4];                                      // 0x0370(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Switch_OpusStreamingVoiceSamplingRate;             // 0x0374(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_378[0x4];                                      // 0x0378(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          InitializeMana;                                    // 0x037C(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_37D[0x1];                                      // 0x037D(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          EnableDecodeSkip;                                  // 0x037E(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_37F[0x1];                                      // 0x037F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxDecoderHandles;                                 // 0x0380(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_384[0x4];                                      // 0x0384(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxManaBPS;                                        // 0x0388(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_38C[0x4];                                      // 0x038C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxManaStreams;                                    // 0x0390(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_394[0x4];                                      // 0x0394(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          UseH264Decoder;                                    // 0x0398(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_399[0x1];                                      // 0x0399(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          UseDecoderOutputBuffers;                           // 0x039A(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_39B[0x1];                                      // 0x039B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          ForceSoftwareDecodingOnXboxOne;                    // 0x039C(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_39D[0x1];                                      // 0x039D(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          ForceSoftwareDecodingOnXboxSeries;                 // 0x039E(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_39F[0x1];                                      // 0x039F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          InitializeAdxLipSync;                              // 0x03A0(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3A1[0x3];                                      // 0x03A1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxNumAnalyzerHandles;                             // 0x03A4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3A8[0x4];                                      // 0x03A8(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bUseManaStartupMovies;                             // 0x03AC(0x0001)(Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bWaitForMoviesToComplete;                          // 0x03AD(0x0001)(Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMoviesAreSkippable;                               // 0x03AE(0x0001)(Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3AF[0x1];                                      // 0x03AF(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FString>                         StartupMovies;                                     // 0x03B0(0x0010)(Edit, ZeroConstructor, Config, GlobalConfig, AdvancedDisplay, NativeAccessSpecifierPublic)
	uint8                                         Pad_3C0[0x160];                                    // 0x03C0(0x0160)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCriWarePluginSettings) == 0x000520, "Wrong size on UCriWarePluginSettings");
...
static_assert(offsetof(UCriWarePluginSettings, AcfFileName) == 0x000188, "Member 'UCriWarePluginSettings::AcfFileName' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, AtomConfigDataTable) == 0x000198, "Member 'UCriWarePluginSettings::AtomConfigDataTable' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, AtomOutputPortDataTable) == 0x0001D8, "Member 'UCriWarePluginSettings::AtomOutputPortDataTable' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, DistanceFactor) == 0x000218, "Member 'UCriWarePluginSettings::DistanceFactor' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, SoundRendererTypeUI) == 0x000220, "Member 'UCriWarePluginSettings::SoundRendererTypeUI' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, SoundRendererType) == 0x000224, "Member 'UCriWarePluginSettings::SoundRendererType' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, AsrRackConfigUI) == 0x000230, "Member 'UCriWarePluginSettings::AsrRackConfigUI' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, AsrRackConfig) == 0x000240, "Member 'UCriWarePluginSettings::AsrRackConfig' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Hardware1) == 0x000260, "Member 'UCriWarePluginSettings::Hardware1' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Hardware2) == 0x000270, "Member 'UCriWarePluginSettings::Hardware2' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Hardware3) == 0x000280, "Member 'UCriWarePluginSettings::Hardware3' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Hardware4) == 0x000290, "Member 'UCriWarePluginSettings::Hardware4' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, EconomicTickMarginDistance) == 0x0002A0, "Member 'UCriWarePluginSettings::EconomicTickMarginDistance' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, EconomicTickFrequency) == 0x0002A8, "Member 'UCriWarePluginSettings::EconomicTickFrequency' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, CullingMarginDistance) == 0x0002B0, "Member 'UCriWarePluginSettings::CullingMarginDistance' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, HcaMxVoiceSamplingRate) == 0x0002B8, "Member 'UCriWarePluginSettings::HcaMxVoiceSamplingRate' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, NumHcaMxMemoryVoices) == 0x0002C0, "Member 'UCriWarePluginSettings::NumHcaMxMemoryVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, HcaMxMemoryVoiceNumChannels) == 0x0002C8, "Member 'UCriWarePluginSettings::HcaMxMemoryVoiceNumChannels' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, NumHcaMxStreamingVoices) == 0x0002D0, "Member 'UCriWarePluginSettings::NumHcaMxStreamingVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, HcaMxStreamingVoiceNumChannels) == 0x0002D8, "Member 'UCriWarePluginSettings::HcaMxStreamingVoiceNumChannels' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, WASAPI_IsExclusive) == 0x0002E0, "Member 'UCriWarePluginSettings::WASAPI_IsExclusive' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, WASAPI_BitsPerSample) == 0x0002E4, "Member 'UCriWarePluginSettings::WASAPI_BitsPerSample' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, WASAPI_SamplingRate) == 0x0002EC, "Member 'UCriWarePluginSettings::WASAPI_SamplingRate' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, WASAPI_NumChannels) == 0x0002F4, "Member 'UCriWarePluginSettings::WASAPI_NumChannels' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, UseUnrealSoundRenderer) == 0x0002FC, "Member 'UCriWarePluginSettings::UseUnrealSoundRenderer' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, SmartPhone_UseSonicSYNC) == 0x0002FE, "Member 'UCriWarePluginSettings::SmartPhone_UseSonicSYNC' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_ServerThreadAffinityMask) == 0x000300, "Member 'UCriWarePluginSettings::PS4_ServerThreadAffinityMask' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_OutputThreadAffinityMask) == 0x000308, "Member 'UCriWarePluginSettings::PS4_OutputThreadAffinityMask' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_ServerThreadPriority) == 0x000310, "Member 'UCriWarePluginSettings::PS4_ServerThreadPriority' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_OutputThreadPriority) == 0x000318, "Member 'UCriWarePluginSettings::PS4_OutputThreadPriority' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_UseAudio3d) == 0x000320, "Member 'UCriWarePluginSettings::PS4_UseAudio3d' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_NumberOfAudio3dMemoryVoices) == 0x000324, "Member 'UCriWarePluginSettings::PS4_NumberOfAudio3dMemoryVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_SamplingRateOfAudio3dMemoryVoices) == 0x00032C, "Member 'UCriWarePluginSettings::PS4_SamplingRateOfAudio3dMemoryVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_NumberOfAudio3dStreamingVoices) == 0x000334, "Member 'UCriWarePluginSettings::PS4_NumberOfAudio3dStreamingVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS4_SamplingRateOfAudio3dStreamingVoices) == 0x00033C, "Member 'UCriWarePluginSettings::PS4_SamplingRateOfAudio3dStreamingVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, PS5_MaxChannelPorts) == 0x000344, "Member 'UCriWarePluginSettings::PS5_MaxChannelPorts' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Switch_NumOpusMemoryVoices) == 0x00034C, "Member 'UCriWarePluginSettings::Switch_NumOpusMemoryVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Switch_OpusMemoryVoiceNumChannels) == 0x000354, "Member 'UCriWarePluginSettings::Switch_OpusMemoryVoiceNumChannels' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Switch_OpusMemoryVoiceSamplingRate) == 0x00035C, "Member 'UCriWarePluginSettings::Switch_OpusMemoryVoiceSamplingRate' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Switch_NumOpusStreamingVoices) == 0x000364, "Member 'UCriWarePluginSettings::Switch_NumOpusStreamingVoices' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Switch_OpusStreamingVoiceNumChannels) == 0x00036C, "Member 'UCriWarePluginSettings::Switch_OpusStreamingVoiceNumChannels' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, Switch_OpusStreamingVoiceSamplingRate) == 0x000374, "Member 'UCriWarePluginSettings::Switch_OpusStreamingVoiceSamplingRate' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, InitializeMana) == 0x00037C, "Member 'UCriWarePluginSettings::InitializeMana' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, EnableDecodeSkip) == 0x00037E, "Member 'UCriWarePluginSettings::EnableDecodeSkip' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, MaxDecoderHandles) == 0x000380, "Member 'UCriWarePluginSettings::MaxDecoderHandles' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, MaxManaBPS) == 0x000388, "Member 'UCriWarePluginSettings::MaxManaBPS' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, MaxManaStreams) == 0x000390, "Member 'UCriWarePluginSettings::MaxManaStreams' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, UseH264Decoder) == 0x000398, "Member 'UCriWarePluginSettings::UseH264Decoder' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, UseDecoderOutputBuffers) == 0x00039A, "Member 'UCriWarePluginSettings::UseDecoderOutputBuffers' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, ForceSoftwareDecodingOnXboxOne) == 0x00039C, "Member 'UCriWarePluginSettings::ForceSoftwareDecodingOnXboxOne' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, ForceSoftwareDecodingOnXboxSeries) == 0x00039E, "Member 'UCriWarePluginSettings::ForceSoftwareDecodingOnXboxSeries' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, InitializeAdxLipSync) == 0x0003A0, "Member 'UCriWarePluginSettings::InitializeAdxLipSync' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, MaxNumAnalyzerHandles) == 0x0003A4, "Member 'UCriWarePluginSettings::MaxNumAnalyzerHandles' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, bUseManaStartupMovies) == 0x0003AC, "Member 'UCriWarePluginSettings::bUseManaStartupMovies' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, bWaitForMoviesToComplete) == 0x0003AD, "Member 'UCriWarePluginSettings::bWaitForMoviesToComplete' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, bMoviesAreSkippable) == 0x0003AE, "Member 'UCriWarePluginSettings::bMoviesAreSkippable' has a wrong offset!");
static_assert(offsetof(UCriWarePluginSettings, StartupMovies) == 0x0003B0, "Member 'UCriWarePluginSettings::StartupMovies' has a wrong offset!");
...
{
public:
	class UManaTexture*                           Movie;                                             // 0x00A0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnEventPoint;                                      // 0x00A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSubtitleChanged;                                 // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStatusChanged;                                   // 0x00C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMovieChanged;                                    // 0x00D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSeekCompleted;                                   // 0x00E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnTrackChanged;                                    // 0x00F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFrameOnTime;                                     // 0x0108(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPlayerDestroyed;                                 // 0x0118(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_128[0x18];                                     // 0x0128(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(class UManaComponent* ManaComponent)> OnRequestData;                                     // 0x0140(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_150[0x40];                                     // 0x0150(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	class UManaPlaylist*                          Playlist;                                          // 0x0190(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         PlaylistIndex;                                     // 0x0198(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_19C[0x4];                                      // 0x019C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bLoop;                                             // 0x01A0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1A1[0x3];                                      // 0x01A1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         AlphaTrack;                                        // 0x01A4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         AudioTrack;                                        // 0x01A8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         SubAudioTrack;                                     // 0x01AC(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         ExtraAudioTrack;                                   // 0x01B0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1B4[0x4];                                      // 0x01B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 AudioCategoryName;                                 // 0x01B8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 SubAudioCategoryName;                              // 0x01C8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 ExtraAudioCategoryName;                            // 0x01D8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bSubtitlesEnabled;                                 // 0x01E8(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1E9[0x3];                                      // 0x01E9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         SubtitlesChannel;                                  // 0x01EC(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EManaSubtitlesEncoding                        SubtitlesEncoding;                                 // 0x01F0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EManaFrameAction                              EndFrameAction;                                    // 0x01F1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EManaPlaybackTimer                            PlaybackTimer;                                     // 0x01F2(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EManaMaxFrameDrop                             MaxFrameDrop;                                      // 0x01F3(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1F4[0xAC];                                     // 0x01F4(0x00AC)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	int32                                         SizeX;                                             // 0x01F0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SizeY;                                             // 0x01F4(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPixelFormat                                  Format;                                            // 0x01F8(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EManaComponentTextureType                     ComponentType;                                     // 0x01F9(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETextureAddress                               AddressX;                                          // 0x01FA(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, AssetRegistrySearchable, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETextureAddress                               AddressY;                                          // 0x01FB(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, AssetRegistrySearchable, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UManaComponentTexture) == 0x000250, "Wrong size on UManaComponentTexture");
static_assert(offsetof(UManaComponentTexture, SizeX) == 0x0001F0, "Member 'UManaComponentTexture::SizeX' has a wrong offset!");
static_assert(offsetof(UManaComponentTexture, SizeY) == 0x0001F4, "Member 'UManaComponentTexture::SizeY' has a wrong offset!");
static_assert(offsetof(UManaComponentTexture, Format) == 0x0001F8, "Member 'UManaComponentTexture::Format' has a wrong offset!");
static_assert(offsetof(UManaComponentTexture, ComponentType) == 0x0001F9, "Member 'UManaComponentTexture::ComponentType' has a wrong offset!");
static_assert(offsetof(UManaComponentTexture, AddressX) == 0x0001FA, "Member 'UManaComponentTexture::AddressX' has a wrong offset!");
static_assert(offsetof(UManaComponentTexture, AddressY) == 0x0001FB, "Member 'UManaComponentTexture::AddressY' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnEventPoint;                                      // 0x00D8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UManaTexture*                           ManaTexture;                                       // 0x00E8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UManaMovie*                             ManaMovie;                                         // 0x00F0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UManaPlaylist*                          Playlist;                                          // 0x00F8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_104[0x4];                                      // 0x0104(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UManaComponent*                         ManaComponent;                                     // 0x0108(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
// 0x00B0 (0x0350 - 0x02A0)
class UManaSoundComponent final : public USceneComponent
{
public:
	...
	uint8                                         bEnableSpatialization : 1;                         // 0x02A0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideVolumeMultiplier : 1;                     // 0x02A0(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableLowPassFilter : 1;                          // 0x02A0(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_2A1[0x3];                                      // 0x02A1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         VolumeMultiplier;                                  // 0x02A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LowPassFilterFrequency;                            // 0x02A8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PanSpread;                                         // 0x02AC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinAttenuationDistance;                            // 0x02B0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxAttenuationDistance;                            // 0x02B4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FAtomAisacControlParam>         AisacControls;                                     // 0x02B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         AttachedAisacs;                                    // 0x02C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	class FString                                 AudioTrackCategory;                                // 0x02D8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 SubAudioTrackCategory;                             // 0x02E8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ExtraAudioTrackCategory;                           // 0x02F8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UManaPlayer*                            ManaPlayer;                                        // 0x0308(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	void SetAudioTrackCategory(EManaPlayerTrack Track, const class FString& CategoryName);
...
static_assert(sizeof(UManaSoundComponent) == 0x000350, "Wrong size on UManaSoundComponent");
static_assert(offsetof(UManaSoundComponent, VolumeMultiplier) == 0x0002A4, "Member 'UManaSoundComponent::VolumeMultiplier' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, LowPassFilterFrequency) == 0x0002A8, "Member 'UManaSoundComponent::LowPassFilterFrequency' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, PanSpread) == 0x0002AC, "Member 'UManaSoundComponent::PanSpread' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, MinAttenuationDistance) == 0x0002B0, "Member 'UManaSoundComponent::MinAttenuationDistance' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, MaxAttenuationDistance) == 0x0002B4, "Member 'UManaSoundComponent::MaxAttenuationDistance' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, AisacControls) == 0x0002B8, "Member 'UManaSoundComponent::AisacControls' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, AttachedAisacs) == 0x0002C8, "Member 'UManaSoundComponent::AttachedAisacs' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, AudioTrackCategory) == 0x0002D8, "Member 'UManaSoundComponent::AudioTrackCategory' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, SubAudioTrackCategory) == 0x0002E8, "Member 'UManaSoundComponent::SubAudioTrackCategory' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, ExtraAudioTrackCategory) == 0x0002F8, "Member 'UManaSoundComponent::ExtraAudioTrackCategory' has a wrong offset!");
static_assert(offsetof(UManaSoundComponent, ManaPlayer) == 0x000308, "Member 'UManaSoundComponent::ManaPlayer' has a wrong offset!");
...
public:
	...
	class UManaSource*                            MovieSource;                                       // 0x01F8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 MovieFilePath;                                     // 0x0200(0x0010)(ZeroConstructor, Deprecated, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bRenderToTexture : 1;                              // 0x0210(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_211[0x3];                                      // 0x0211(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TargetGamma;                                       // 0x0214(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bHDR : 1;                                          // 0x0218(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_219[0x3];                                      // 0x0219(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	ETextureAddress                               AddressX;                                          // 0x021C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETextureAddress                               AddressY;                                          // 0x021D(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_21E[0x2];                                      // 0x021E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           ClearColor;                                        // 0x0220(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bOverrideDimensions : 1;                           // 0x0230(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, AssetRegistrySearchable, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_231[0x3];                                      // 0x0231(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FIntPoint                              TargetDimensions;                                  // 0x0234(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPixelFormat                                  OverrideFormat;                                    // 0x023C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_23D[0x3];                                      // 0x023D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnTextureUpdated;                                  // 0x0240(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TArray<class UManaComponentTexture*>          ComponentTextures;                                 // 0x0250(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, AdvancedDisplay, Protected, NativeAccessSpecifierProtected)
	TArray<class UManaComponentTexture*>          AlphaComponentTextures;                            // 0x0260(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, AdvancedDisplay, Protected, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UManaComponent>          ManaPlayer;                                        // 0x0270(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UManaTexture) == 0x0002F0, "Wrong size on UManaTexture");
static_assert(offsetof(UManaTexture, MovieSource) == 0x0001F8, "Member 'UManaTexture::MovieSource' has a wrong offset!");
static_assert(offsetof(UManaTexture, MovieFilePath) == 0x000200, "Member 'UManaTexture::MovieFilePath' has a wrong offset!");
static_assert(offsetof(UManaTexture, TargetGamma) == 0x000214, "Member 'UManaTexture::TargetGamma' has a wrong offset!");
static_assert(offsetof(UManaTexture, AddressX) == 0x00021C, "Member 'UManaTexture::AddressX' has a wrong offset!");
static_assert(offsetof(UManaTexture, AddressY) == 0x00021D, "Member 'UManaTexture::AddressY' has a wrong offset!");
static_assert(offsetof(UManaTexture, ClearColor) == 0x000220, "Member 'UManaTexture::ClearColor' has a wrong offset!");
static_assert(offsetof(UManaTexture, TargetDimensions) == 0x000234, "Member 'UManaTexture::TargetDimensions' has a wrong offset!");
static_assert(offsetof(UManaTexture, OverrideFormat) == 0x00023C, "Member 'UManaTexture::OverrideFormat' has a wrong offset!");
static_assert(offsetof(UManaTexture, OnTextureUpdated) == 0x000240, "Member 'UManaTexture::OnTextureUpdated' has a wrong offset!");
static_assert(offsetof(UManaTexture, ComponentTextures) == 0x000250, "Member 'UManaTexture::ComponentTextures' has a wrong offset!");
static_assert(offsetof(UManaTexture, AlphaComponentTextures) == 0x000260, "Member 'UManaTexture::AlphaComponentTextures' has a wrong offset!");
static_assert(offsetof(UManaTexture, ManaPlayer) == 0x000270, "Member 'UManaTexture::ManaPlayer' has a wrong offset!");
...
{
public:
	struct FExpressionInput                       Inputs[0x5];                                       // 0x00B0(0x0028)(NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMaterialExpressionManaMovieFormatSwitch) == 0x000178, "Wrong size on UMaterialExpressionManaMovieFormatSwitch");
...
{
public:
	class UManaMovie*                             ManaMovie;                                         // 0x00A0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USoundAtomConfig) == 0x000058, "Wrong size on USoundAtomConfig");
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundAtomCueSheet*                     CueSheet;                                          // 0x0030(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class USoundAttenuation*                      AttenuationSettings;                               // 0x0058(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UAtom3dRegion*                          Region;                                            // 0x0070(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class USoundAttenuation*                      DefaultAttenuation;                                // 0x00C0(0x0008)(ZeroConstructor, Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(USoundAtomCue, bIsEnableChangingAisacValueWithComponentVelocity) == 0x000078, "Member 'USoundAtomCue::bIsEnableChangingAisacValueWithComponentVelocity' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, AisacControlSettings) == 0x000080, "Member 'USoundAtomCue::AisacControlSettings' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, bEconomicTick) == 0x000090, "Member 'USoundAtomCue::bEconomicTick' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, bOverrideEconomicTickSettings) == 0x000091, "Member 'USoundAtomCue::bOverrideEconomicTickSettings' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, EconomicTickDistanceMargin) == 0x000094, "Member 'USoundAtomCue::EconomicTickDistanceMargin' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, EconomicTickFrequency) == 0x000098, "Member 'USoundAtomCue::EconomicTickFrequency' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, bEnableDistanceCulling) == 0x00009C, "Member 'USoundAtomCue::bEnableDistanceCulling' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, bOverrideCullSettings) == 0x00009D, "Member 'USoundAtomCue::bOverrideCullSettings' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, CullDistanceMargin) == 0x0000A0, "Member 'USoundAtomCue::CullDistanceMargin' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, EconomicTickMarginDistance) == 0x0000A4, "Member 'USoundAtomCue::EconomicTickMarginDistance' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, bLoopSettingByAtomCraft) == 0x0000A8, "Member 'USoundAtomCue::bLoopSettingByAtomCraft' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, bCullingSoundPlayingProcessByDistance) == 0x0000A9, "Member 'USoundAtomCue::bCullingSoundPlayingProcessByDistance' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, bUseLegacyCullingSettings) == 0x0000AA, "Member 'USoundAtomCue::bUseLegacyCullingSettings' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, MaxProcessDistance) == 0x0000AC, "Member 'USoundAtomCue::MaxProcessDistance' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, bOverrideCullingSettings) == 0x0000B0, "Member 'USoundAtomCue::bOverrideCullingSettings' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, CullingMarginDistance) == 0x0000B4, "Member 'USoundAtomCue::CullingMarginDistance' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, bLoop) == 0x0000B8, "Member 'USoundAtomCue::bLoop' has a wrong offset!");
static_assert(offsetof(USoundAtomCue, DefaultAttenuation) == 0x0000C0, "Member 'USoundAtomCue::DefaultAttenuation' has a wrong offset!");
...
public:
	...
	struct FDirectoryPath                         AwbDirectory;                                      // 0x0058(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UDataTable*                             AdditionalData;                                    // 0x0068(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USoundAtomCueSheet) == 0x000110, "Wrong size on USoundAtomCueSheet");
