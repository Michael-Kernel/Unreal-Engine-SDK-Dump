...
static_assert(alignof(UActorSequencePlayer) == 0x000010, "Wrong alignment on UActorSequencePlayer");
static_assert(sizeof(UActorSequencePlayer) == 0x000560, "Wrong size on UActorSequencePlayer");
