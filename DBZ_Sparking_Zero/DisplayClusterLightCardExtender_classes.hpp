...
class IDisplayClusterStageActor final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(alignof(IDisplayClusterStageActor) == 0x000008, "Wrong alignment on IDisplayClusterStageActor");
static_assert(sizeof(IDisplayClusterStageActor) == 0x000028, "Wrong size on IDisplayClusterStageActor");
