...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    bInScalable                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UHorizontalBoxSlot::SetScalable(bool bInScalable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HorizontalBoxSlot", "SetScalable");

	Params::HorizontalBoxSlot_SetScalable Parms{};

	Parms.bInScalable = bInScalable;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    bInScrollLoop                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UScrollBox::SetScrollLoop(bool bInScrollLoop)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ScrollBox", "SetScrollLoop");

	Params::ScrollBox_SetScrollLoop Parms{};

	Parms.bInScrollLoop = bInScrollLoop;
...
void UVerticalBoxSlot::SetScalable(bool bInScalable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("VerticalBoxSlot", "SetScalable");

	Params::VerticalBoxSlot_SetScalable Parms{};
