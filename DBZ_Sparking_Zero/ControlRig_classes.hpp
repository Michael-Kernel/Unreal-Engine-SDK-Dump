...
public:
	...
	uint8                                         Pad_300[0xD0];                                     // 0x0300(0x00D0)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_450[0xC8];                                     // 0x0450(0x00C8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_519[0x47];                                     // 0x0519(0x0047)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool Execute(const EControlRigState State, const class FName& InEventName);
	...
	bool ContainsEvent(const class FName& InEventName) const;
...
// Class ControlRig.KoratControlRigCustomInterface
// 0x0000 (0x0028 - 0x0028)
class IKoratControlRigCustomInterface final : public IInterface
{
public:
	TSubclassOf<class UControlRig> GetReplaceClass(const class UClass* InClass) const;

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"KoratControlRigCustomInterface">();
	}
	static class IKoratControlRigCustomInterface* GetDefaultObj()
	{
		return GetDefaultObjImpl<IKoratControlRigCustomInterface>();
	}
};
static_assert(alignof(IKoratControlRigCustomInterface) == 0x000008, "Wrong alignment on IKoratControlRigCustomInterface");
static_assert(sizeof(IKoratControlRigCustomInterface) == 0x000028, "Wrong size on IKoratControlRigCustomInterface");
...
public:
	...
	uint8                                         Pad_8F[0x71];                                      // 0x008F(0x0071)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_104[0x74];                                     // 0x0104(0x0074)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_180[0x58];                                     // 0x0180(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FRigElementKey, struct FRigElementKey> PreviousNameMap;                                   // 0x01D8(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_228[0x80];                                     // 0x0228(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	TSubclassOf<class UControlRig>                ControlRigClass;                                   // 0x0540(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPreInitializeDelegate;                           // 0x0548(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostInitializeDelegate;                          // 0x0558(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPreConstructionDelegate;                         // 0x0568(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostConstructionDelegate;                        // 0x0578(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPreForwardsSolveDelegate;                        // 0x0588(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostForwardsSolveDelegate;                       // 0x0598(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TArray<struct FControlRigComponentMappedElement> UserDefinedElements;                               // 0x05A8(0x0010)(Edit, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TArray<struct FControlRigComponentMappedElement> MappedElements;                                    // 0x05B8(0x0010)(Edit, ZeroConstructor, EditConst, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bEnableLazyEvaluation;                             // 0x05C8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5C9[0x3];                                      // 0x05C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         LazyEvaluationPositionThreshold;                   // 0x05CC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LazyEvaluationRotationThreshold;                   // 0x05D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LazyEvaluationScaleThreshold;                      // 0x05D4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bResetInitialsBeforeConstruction;                  // 0x05D9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bShowDebugDrawing;                                 // 0x05DD(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5DE[0x2];                                      // 0x05DE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class UControlRig*                            ControlRig;                                        // 0x05E0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UControlRigComponent) == 0x0006A0, "Wrong size on UControlRigComponent");
static_assert(offsetof(UControlRigComponent, ControlRigClass) == 0x000540, "Member 'UControlRigComponent::ControlRigClass' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPreInitializeDelegate) == 0x000548, "Member 'UControlRigComponent::OnPreInitializeDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostInitializeDelegate) == 0x000558, "Member 'UControlRigComponent::OnPostInitializeDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPreConstructionDelegate) == 0x000568, "Member 'UControlRigComponent::OnPreConstructionDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostConstructionDelegate) == 0x000578, "Member 'UControlRigComponent::OnPostConstructionDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPreForwardsSolveDelegate) == 0x000588, "Member 'UControlRigComponent::OnPreForwardsSolveDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostForwardsSolveDelegate) == 0x000598, "Member 'UControlRigComponent::OnPostForwardsSolveDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, UserDefinedElements) == 0x0005A8, "Member 'UControlRigComponent::UserDefinedElements' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, MappedElements) == 0x0005B8, "Member 'UControlRigComponent::MappedElements' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bEnableLazyEvaluation) == 0x0005C8, "Member 'UControlRigComponent::bEnableLazyEvaluation' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, LazyEvaluationPositionThreshold) == 0x0005CC, "Member 'UControlRigComponent::LazyEvaluationPositionThreshold' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, LazyEvaluationRotationThreshold) == 0x0005D0, "Member 'UControlRigComponent::LazyEvaluationRotationThreshold' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, LazyEvaluationScaleThreshold) == 0x0005D4, "Member 'UControlRigComponent::LazyEvaluationScaleThreshold' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bResetTransformBeforeTick) == 0x0005D8, "Member 'UControlRigComponent::bResetTransformBeforeTick' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bResetInitialsBeforeConstruction) == 0x0005D9, "Member 'UControlRigComponent::bResetInitialsBeforeConstruction' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bUpdateRigOnTick) == 0x0005DA, "Member 'UControlRigComponent::bUpdateRigOnTick' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bUpdateInEditor) == 0x0005DB, "Member 'UControlRigComponent::bUpdateInEditor' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bDrawBones) == 0x0005DC, "Member 'UControlRigComponent::bDrawBones' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bShowDebugDrawing) == 0x0005DD, "Member 'UControlRigComponent::bShowDebugDrawing' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, ControlRig) == 0x0005E0, "Member 'UControlRigComponent::ControlRig' has a wrong offset!");
...
static_assert(sizeof(AControlRigShapeActor) == 0x0002D8, "Wrong size on AControlRigShapeActor");
...
public:
	...
	uint8                                         Pad_571[0x2F];                                     // 0x0571(0x002F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_360[0x68];                                     // 0x0360(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           MuteScalars;                                       // 0x03C8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<class FName>                           MuteVector2Ds;                                     // 0x03D8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneControlRigParameterSection, MuteScalars) == 0x0003C8, "Member 'UMovieSceneControlRigParameterSection::MuteScalars' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterSection, MuteVector2Ds) == 0x0003D8, "Member 'UMovieSceneControlRigParameterSection::MuteVector2Ds' has a wrong offset!");
