...
// Function UMG.HorizontalBoxSlot.SetScalable
// 0x0001 (0x0001 - 0x0000)
struct HorizontalBoxSlot_SetScalable final
{
public:
	bool                                          bInScalable;                                       // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(HorizontalBoxSlot_SetScalable) == 0x000001, "Wrong alignment on HorizontalBoxSlot_SetScalable");
static_assert(sizeof(HorizontalBoxSlot_SetScalable) == 0x000001, "Wrong size on HorizontalBoxSlot_SetScalable");
static_assert(offsetof(HorizontalBoxSlot_SetScalable, bInScalable) == 0x000000, "Member 'HorizontalBoxSlot_SetScalable::bInScalable' has a wrong offset!");
...
// Function UMG.ScrollBox.SetScrollLoop
// 0x0001 (0x0001 - 0x0000)
struct ScrollBox_SetScrollLoop final
{
public:
	bool                                          bInScrollLoop;                                     // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ScrollBox_SetScrollLoop) == 0x000001, "Wrong alignment on ScrollBox_SetScrollLoop");
static_assert(sizeof(ScrollBox_SetScrollLoop) == 0x000001, "Wrong size on ScrollBox_SetScrollLoop");
static_assert(offsetof(ScrollBox_SetScrollLoop, bInScrollLoop) == 0x000000, "Member 'ScrollBox_SetScrollLoop::bInScrollLoop' has a wrong offset!");
...
// Function UMG.VerticalBoxSlot.SetScalable
// 0x0001 (0x0001 - 0x0000)
struct VerticalBoxSlot_SetScalable final
{
public:
	bool                                          bInScalable;                                       // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(VerticalBoxSlot_SetScalable) == 0x000001, "Wrong alignment on VerticalBoxSlot_SetScalable");
static_assert(sizeof(VerticalBoxSlot_SetScalable) == 0x000001, "Wrong size on VerticalBoxSlot_SetScalable");
static_assert(offsetof(VerticalBoxSlot_SetScalable, bInScalable) == 0x000000, "Member 'VerticalBoxSlot_SetScalable::bInScalable' has a wrong offset!");
