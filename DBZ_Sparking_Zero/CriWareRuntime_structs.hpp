...
// Enum CriWareRuntime.ESpeakerType
// NumValues: 0x0003
...
// NumValues: 0x000C
enum class EAtomSoundRendererType : uint32
{
	Any                                      = 0,
	Native                                   = 1,
	Asr                                      = 2,
	...
	RESTRICTED                               = 254,
	Pad                                      = 255,
	EAtomSoundRendererType_MAX               = 196626,
};
...
static_assert(alignof(FBusSendLevelOffsetByNameParam) == 0x000008, "Wrong alignment on FBusSendLevelOffsetByNameParam");
static_assert(sizeof(FBusSendLevelOffsetByNameParam) == 0x000018, "Wrong size on FBusSendLevelOffsetByNameParam");
static_assert(offsetof(FBusSendLevelOffsetByNameParam, Name) == 0x000000, "Member 'FBusSendLevelOffsetByNameParam::Name' has a wrong offset!");
static_assert(offsetof(FBusSendLevelOffsetByNameParam, LevelOffset) == 0x000010, "Member 'FBusSendLevelOffsetByNameParam::LevelOffset' has a wrong offset!");
...
static_assert(alignof(FBusSendLevelOffsetParam) == 0x000004, "Wrong alignment on FBusSendLevelOffsetParam");
static_assert(sizeof(FBusSendLevelOffsetParam) == 0x000008, "Wrong size on FBusSendLevelOffsetParam");
static_assert(offsetof(FBusSendLevelOffsetParam, BusId) == 0x000000, "Member 'FBusSendLevelOffsetParam::BusId' has a wrong offset!");
static_assert(offsetof(FBusSendLevelOffsetParam, LevelOffset) == 0x000004, "Member 'FBusSendLevelOffsetParam::LevelOffset' has a wrong offset!");
...
static_assert(alignof(FBusSendLevelParam) == 0x000004, "Wrong alignment on FBusSendLevelParam");
static_assert(sizeof(FBusSendLevelParam) == 0x000008, "Wrong size on FBusSendLevelParam");
static_assert(offsetof(FBusSendLevelParam, BusId) == 0x000000, "Member 'FBusSendLevelParam::BusId' has a wrong offset!");
static_assert(offsetof(FBusSendLevelParam, Level) == 0x000004, "Member 'FBusSendLevelParam::Level' has a wrong offset!");
...
static_assert(alignof(FBusSendLevelByNameParam) == 0x000008, "Wrong alignment on FBusSendLevelByNameParam");
static_assert(sizeof(FBusSendLevelByNameParam) == 0x000018, "Wrong size on FBusSendLevelByNameParam");
static_assert(offsetof(FBusSendLevelByNameParam, Name) == 0x000000, "Member 'FBusSendLevelByNameParam::Name' has a wrong offset!");
static_assert(offsetof(FBusSendLevelByNameParam, Level) == 0x000010, "Member 'FBusSendLevelByNameParam::Level' has a wrong offset!");
...
static_assert(alignof(FAtomAppliedValueParam) == 0x000008, "Wrong alignment on FAtomAppliedValueParam");
static_assert(sizeof(FAtomAppliedValueParam) == 0x000080, "Wrong size on FAtomAppliedValueParam");
static_assert(offsetof(FAtomAppliedValueParam, PitchValue) == 0x000000, "Member 'FAtomAppliedValueParam::PitchValue' has a wrong offset!");
static_assert(offsetof(FAtomAppliedValueParam, BusSendLevelParam) == 0x000018, "Member 'FAtomAppliedValueParam::BusSendLevelParam' has a wrong offset!");
static_assert(offsetof(FAtomAppliedValueParam, BusSendLevelByNameParams) == 0x000020, "Member 'FAtomAppliedValueParam::BusSendLevelByNameParams' has a wrong offset!");
static_assert(offsetof(FAtomAppliedValueParam, BusSendLevelOffsetParam) == 0x000030, "Member 'FAtomAppliedValueParam::BusSendLevelOffsetParam' has a wrong offset!");
static_assert(offsetof(FAtomAppliedValueParam, BusSendLevelOffsetByNameParams) == 0x000038, "Member 'FAtomAppliedValueParam::BusSendLevelOffsetByNameParams' has a wrong offset!");
static_assert(offsetof(FAtomAppliedValueParam, BlockIndex) == 0x000048, "Member 'FAtomAppliedValueParam::BlockIndex' has a wrong offset!");
...
public:
	...
	class UAtomSoundObject*                       SoundObject;                                       // 0x0018(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundAttenuation*                      AttenuationSettings;                               // 0x0020(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAtomComponentParams) == 0x000070, "Wrong size on FAtomComponentParams");
...
static_assert(offsetof(FAtomComponentParams, Rotation) == 0x000058, "Member 'FAtomComponentParams::Rotation' has a wrong offset!");
...
public:
	...
	struct FVector                                AtomComponentLocation;                             // 0x0018(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DistanceFromListener;                              // 0x0030(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayingTime;                                       // 0x0034(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int64                                         PlayedNumSamples;                                  // 0x0038(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 PlayerState;                                       // 0x0040(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumSounds;                                         // 0x0050(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_54[0x4];                                       // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 ConcurrencyName;                                   // 0x0058(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAtomProfileItem) == 0x000088, "Wrong size on FAtomProfileItem");
...
static_assert(offsetof(FAtomProfileItem, DistanceFromListener) == 0x000030, "Member 'FAtomProfileItem::DistanceFromListener' has a wrong offset!");
static_assert(offsetof(FAtomProfileItem, PlayingTime) == 0x000034, "Member 'FAtomProfileItem::PlayingTime' has a wrong offset!");
static_assert(offsetof(FAtomProfileItem, PlayedNumSamples) == 0x000038, "Member 'FAtomProfileItem::PlayedNumSamples' has a wrong offset!");
static_assert(offsetof(FAtomProfileItem, PlayerState) == 0x000040, "Member 'FAtomProfileItem::PlayerState' has a wrong offset!");
static_assert(offsetof(FAtomProfileItem, NumSounds) == 0x000050, "Member 'FAtomProfileItem::NumSounds' has a wrong offset!");
static_assert(offsetof(FAtomProfileItem, ConcurrencyName) == 0x000058, "Member 'FAtomProfileItem::ConcurrencyName' has a wrong offset!");
...
public:
	...
	class USoundAtomCue*                          Cue;                                               // 0x0018(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	EAtomSoundRendererType                        SoundRendererTypeUI;                               // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bUseOutputPort;                                    // 0x0008(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9[0x3];                                        // 0x0009(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         UserIndex;                                         // 0x000C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAtomAsrRackConfigUI) == 0x000004, "Wrong alignment on FAtomAsrRackConfigUI");
static_assert(sizeof(FAtomAsrRackConfigUI) == 0x000010, "Wrong size on FAtomAsrRackConfigUI");
...
static_assert(offsetof(FAtomAsrRackConfigUI, bUseOutputPort) == 0x000008, "Member 'FAtomAsrRackConfigUI::bUseOutputPort' has a wrong offset!");
static_assert(offsetof(FAtomAsrRackConfigUI, UserIndex) == 0x00000C, "Member 'FAtomAsrRackConfigUI::UserIndex' has a wrong offset!");
...
static_assert(sizeof(FAtomAsrRackConfig) == 0x000010, "Wrong size on FAtomAsrRackConfig");
...
static_assert(offsetof(FAtomAsrRackConfig, bUseOutputPort) == 0x000008, "Member 'FAtomAsrRackConfig::bUseOutputPort' has a wrong offset!");
static_assert(offsetof(FAtomAsrRackConfig, UserIndex) == 0x00000C, "Member 'FAtomAsrRackConfig::UserIndex' has a wrong offset!");
...
static_assert(sizeof(FManaSubtitleTrackInfo) == 0x000030, "Wrong size on FManaSubtitleTrackInfo");
static_assert(offsetof(FManaSubtitleTrackInfo, Name) == 0x000000, "Member 'FManaSubtitleTrackInfo::Name' has a wrong offset!");
static_assert(offsetof(FManaSubtitleTrackInfo, Language) == 0x000018, "Member 'FManaSubtitleTrackInfo::Language' has a wrong offset!");
static_assert(offsetof(FManaSubtitleTrackInfo, Encoding) == 0x000028, "Member 'FManaSubtitleTrackInfo::Encoding' has a wrong offset!");

// ScriptStruct CriWareRuntime.ManaPlayerFacade
// 0x0008 (0x0008 - 0x0000)
struct FManaPlayerFacade final
{
public:
	class UManaComponent*                         ManaComponent;                                     // 0x0000(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FManaPlayerFacade) == 0x000008, "Wrong alignment on FManaPlayerFacade");
static_assert(sizeof(FManaPlayerFacade) == 0x000008, "Wrong size on FManaPlayerFacade");
static_assert(offsetof(FManaPlayerFacade, ManaComponent) == 0x000000, "Member 'FManaPlayerFacade::ManaComponent' has a wrong offset!");
