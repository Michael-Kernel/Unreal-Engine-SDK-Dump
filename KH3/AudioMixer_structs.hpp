...
struct alignas(0x116886F0) FSubmixEffectReverbSettings final
{
public:
...
static_assert(alignof(FSubmixEffectReverbSettings) == 0x116886F0, "Wrong alignment on FSubmixEffectReverbSettings");
static_assert(sizeof(FSubmixEffectReverbSettings) == 0x116886F0, "Wrong size on FSubmixEffectReverbSettings");
