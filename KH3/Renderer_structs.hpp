...
// Enum Renderer.ESQEX_BreakBlendMode
// NumValues: 0x0005
enum class ESQEX_BreakBlendMode : uint8
{
	BreakBlendMode_Overwrite                 = 0,
	BreakBlendMode_Alpha                     = 1,
	BreakBlendMode_Add                       = 2,
	BreakBlendMode_Sub                       = 3,
	BreakBlendMode_Max                       = 4,
};

// Enum Renderer.EOceanSimulationSamplerFilter
// NumValues: 0x0006
enum class EOceanSimulationSamplerFilter : uint8
{
	OSSF_Point                               = 0,
	OSSF_Bilinear                            = 1,
	OSSF_Trilinear                           = 2,
	OSSF_AnisotropicPoint                    = 3,
	OSSF_AnisotropicLinear                   = 4,
	OSSF_MAX                                 = 5,
};

// ScriptStruct Renderer.LightPropagationVolumeSettings
// 0x115A04B0 (0x115A04B0 - 0x0000)
struct alignas(0x115A04B0) FLightPropagationVolumeSettings final
{
public:
...
static_assert(alignof(FLightPropagationVolumeSettings) == 0x115A04B0, "Wrong alignment on FLightPropagationVolumeSettings");
static_assert(sizeof(FLightPropagationVolumeSettings) == 0x115A04B0, "Wrong size on FLightPropagationVolumeSettings");
...
// ScriptStruct Renderer.OceanDistanceField
// 0x115A15F0 (0x115A15F0 - 0x0000)
struct alignas(0x115A15F0) FOceanDistanceField final
{
public:
	struct FVector                                Location;                                          // 0x0000(0x000C)(Edit, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FOceanDistanceField) == 0x115A15F0, "Wrong alignment on FOceanDistanceField");
static_assert(sizeof(FOceanDistanceField) == 0x115A15F0, "Wrong size on FOceanDistanceField");
static_assert(offsetof(FOceanDistanceField, Location) == 0x000000, "Member 'FOceanDistanceField::Location' has a wrong offset!");
static_assert(offsetof(FOceanDistanceField, Radius) == 0x00000C, "Member 'FOceanDistanceField::Radius' has a wrong offset!");
