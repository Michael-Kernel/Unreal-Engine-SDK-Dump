...
// 0x115E5060 (0x115E5060 - 0x0000)
struct alignas(0x115E5060) FAutoCompleteCommand final
{
public:
...
static_assert(alignof(FAutoCompleteCommand) == 0x115E5060, "Wrong alignment on FAutoCompleteCommand");
static_assert(sizeof(FAutoCompleteCommand) == 0x115E5060, "Wrong size on FAutoCompleteCommand");
...
public:
	...
	struct FStringClassReference                  GameMode;                                          // 0x0010(0x003A)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameModeName) == 0x00003A, "Wrong alignment on FGameModeName");
static_assert(sizeof(FGameModeName) == 0x00003A, "Wrong size on FGameModeName");
