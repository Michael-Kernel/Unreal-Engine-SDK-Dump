...
// Parameters:
// class UAnimationAsset*                  Montage                                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    bInterrupted                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UPlayMontageCallbackProxy::OnMontageBlendingOut(class UAnimationAsset* Montage, bool bInterrupted)
{
	static class UFunction* Func = nullptr;
...
void UPlayMontageCallbackProxy::OnMontageEnded(class UAnimationAsset* Montage, bool bInterrupted)
{
	static class UFunction* Func = nullptr;
