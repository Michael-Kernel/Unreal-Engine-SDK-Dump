...
static_assert(sizeof(FGameplayTagSource) == 0x000018, "Wrong size on FGameplayTagSource");
...
// 0x6688 (0x6688 - 0x0000)
struct alignas(0x6688) FGameplayTagCreationWidgetHelper final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayTagCreationWidgetHelper) == 0x006688, "Wrong alignment on FGameplayTagCreationWidgetHelper");
static_assert(sizeof(FGameplayTagCreationWidgetHelper) == 0x006688, "Wrong size on FGameplayTagCreationWidgetHelper");

// ScriptStruct GameplayTags.GameplayTagQuery
// 0x115E5410 (0x115E5410 - 0x0000)
struct alignas(0x115E5410) FGameplayTagQuery final
{
public:
...
static_assert(alignof(FGameplayTagQuery) == 0x115E5410, "Wrong alignment on FGameplayTagQuery");
static_assert(sizeof(FGameplayTagQuery) == 0x115E5410, "Wrong size on FGameplayTagQuery");
...
// 0x12465 (0x12465 - 0x0000)
struct alignas(0x12465) FGameplayTagReferenceHelper final
{
public:
	uint8                                         Pad_0[0x40];                                       // 0x0000(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayTagReferenceHelper) == 0x012465, "Wrong alignment on FGameplayTagReferenceHelper");
static_assert(sizeof(FGameplayTagReferenceHelper) == 0x012465, "Wrong size on FGameplayTagReferenceHelper");
...
// 0x12466 (0x12466 - 0x0000)
struct alignas(0x12466) FGameplayTagNode final
{
public:
	uint8                                         Pad_0[0x50];                                       // 0x0000(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayTagNode) == 0x012466, "Wrong alignment on FGameplayTagNode");
static_assert(sizeof(FGameplayTagNode) == 0x012466, "Wrong size on FGameplayTagNode");

// ScriptStruct GameplayTags.GameplayTagTableRow
// 0x1D30D0 (0x115E6150 - 0x11413080)
struct alignas(0x115E6150) FGameplayTagTableRow final : public FTableRowBase
{
public:
...
static_assert(alignof(FGameplayTagTableRow) == 0x115E6150, "Wrong alignment on FGameplayTagTableRow");
static_assert(sizeof(FGameplayTagTableRow) == 0x115E6150, "Wrong size on FGameplayTagTableRow");
...
// 0x115E6590 (0x115E6590 - 0x0000)
struct alignas(0x115E6590) FGameplayTagRedirect final
{
public:
...
static_assert(alignof(FGameplayTagRedirect) == 0x115E6590, "Wrong alignment on FGameplayTagRedirect");
static_assert(sizeof(FGameplayTagRedirect) == 0x115E6590, "Wrong size on FGameplayTagRedirect");
