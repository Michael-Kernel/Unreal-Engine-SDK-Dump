...
static_assert(alignof(FProceduralFoliageInstance) == 0x112E9D50, "Wrong alignment on FProceduralFoliageInstance");
static_assert(sizeof(FProceduralFoliageInstance) == 0x112E9D50, "Wrong size on FProceduralFoliageInstance");
