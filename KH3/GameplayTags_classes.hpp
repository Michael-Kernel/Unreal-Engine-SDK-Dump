...
static_assert(sizeof(UBlueprintGameplayTagLibrary) == 0x000040, "Wrong size on UBlueprintGameplayTagLibrary");
...
{
public:
	class FString                                 ConfigFileName;                                    // 0x0040(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FGameplayTagTableRow>           GameplayTagList;                                   // 0x0050(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayTagsList) == 0x000060, "Wrong size on UGameplayTagsList");
static_assert(offsetof(UGameplayTagsList, ConfigFileName) == 0x000040, "Member 'UGameplayTagsList::ConfigFileName' has a wrong offset!");
static_assert(offsetof(UGameplayTagsList, GameplayTagList) == 0x000050, "Member 'UGameplayTagsList::GameplayTagList' has a wrong offset!");
...
{
public:
	bool                                          ImportTagsFromConfig;                              // 0x0060(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          WarnOnInvalidTags;                                 // 0x0061(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          FastReplication;                                   // 0x0078(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_79[0x7];                                       // 0x0079(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FStringAssetReference>          GameplayTagTableList;                              // 0x0080(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TArray<struct FGameplayTagRedirect>           GameplayTagRedirects;                              // 0x0090(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TArray<class FName>                           CommonlyReplicatedTags;                            // 0x00A0(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	int32                                         NumBitsForContainerSize;                           // 0x00B0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NetIndexFirstBitSegment;                           // 0x00B4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGameplayTagsSettings, ImportTagsFromConfig) == 0x000060, "Member 'UGameplayTagsSettings::ImportTagsFromConfig' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, WarnOnInvalidTags) == 0x000061, "Member 'UGameplayTagsSettings::WarnOnInvalidTags' has a wrong offset!");
...
static_assert(offsetof(UGameplayTagsSettings, FastReplication) == 0x000078, "Member 'UGameplayTagsSettings::FastReplication' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, GameplayTagTableList) == 0x000080, "Member 'UGameplayTagsSettings::GameplayTagTableList' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, GameplayTagRedirects) == 0x000090, "Member 'UGameplayTagsSettings::GameplayTagRedirects' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, CommonlyReplicatedTags) == 0x0000A0, "Member 'UGameplayTagsSettings::CommonlyReplicatedTags' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, NumBitsForContainerSize) == 0x0000B0, "Member 'UGameplayTagsSettings::NumBitsForContainerSize' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, NetIndexFirstBitSegment) == 0x0000B4, "Member 'UGameplayTagsSettings::NetIndexFirstBitSegment' has a wrong offset!");
...
static_assert(sizeof(IGameplayTagAssetInterface) == 0x000040, "Wrong size on IGameplayTagAssetInterface");

// Class GameplayTags.EditableGameplayTagQuery
// 0x115E53D0 (0x115E5410 - 0x0040)
class UEditableGameplayTagQuery final : public UObject
{
public:
	class FString                                 UserDescription;                                   // 0x0040(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_50[0x10];                                      // 0x0050(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UEditableGameplayTagQueryExpression*    RootExpression;                                    // 0x0060(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTagQuery                      TagQueryExportText_Helper;                         // 0x0068(0x115E5410)(NativeAccessSpecifierPrivate)
...
static_assert(alignof(UEditableGameplayTagQuery) == 0x115E5410, "Wrong alignment on UEditableGameplayTagQuery");
static_assert(sizeof(UEditableGameplayTagQuery) == 0x115E5410, "Wrong size on UEditableGameplayTagQuery");
static_assert(offsetof(UEditableGameplayTagQuery, UserDescription) == 0x000040, "Member 'UEditableGameplayTagQuery::UserDescription' has a wrong offset!");
static_assert(offsetof(UEditableGameplayTagQuery, RootExpression) == 0x000060, "Member 'UEditableGameplayTagQuery::RootExpression' has a wrong offset!");
static_assert(offsetof(UEditableGameplayTagQuery, TagQueryExportText_Helper) == 0x000068, "Member 'UEditableGameplayTagQuery::TagQueryExportText_Helper' has a wrong offset!");
...
static_assert(sizeof(UEditableGameplayTagQueryExpression) == 0x000040, "Wrong size on UEditableGameplayTagQueryExpression");
...
static_assert(sizeof(UEditableGameplayTagQueryExpression_AnyTagsMatch) == 0x000060, "Wrong size on UEditableGameplayTagQueryExpression_AnyTagsMatch");
static_assert(offsetof(UEditableGameplayTagQueryExpression_AnyTagsMatch, Tags) == 0x000040, "Member 'UEditableGameplayTagQueryExpression_AnyTagsMatch::Tags' has a wrong offset!");
...
static_assert(sizeof(UEditableGameplayTagQueryExpression_AllTagsMatch) == 0x000060, "Wrong size on UEditableGameplayTagQueryExpression_AllTagsMatch");
static_assert(offsetof(UEditableGameplayTagQueryExpression_AllTagsMatch, Tags) == 0x000040, "Member 'UEditableGameplayTagQueryExpression_AllTagsMatch::Tags' has a wrong offset!");
...
static_assert(sizeof(UEditableGameplayTagQueryExpression_NoTagsMatch) == 0x000060, "Wrong size on UEditableGameplayTagQueryExpression_NoTagsMatch");
static_assert(offsetof(UEditableGameplayTagQueryExpression_NoTagsMatch, Tags) == 0x000040, "Member 'UEditableGameplayTagQueryExpression_NoTagsMatch::Tags' has a wrong offset!");
...
{
public:
	TArray<class UEditableGameplayTagQueryExpression*> Expressions;                                       // 0x0040(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableGameplayTagQueryExpression_AnyExprMatch) == 0x000050, "Wrong size on UEditableGameplayTagQueryExpression_AnyExprMatch");
static_assert(offsetof(UEditableGameplayTagQueryExpression_AnyExprMatch, Expressions) == 0x000040, "Member 'UEditableGameplayTagQueryExpression_AnyExprMatch::Expressions' has a wrong offset!");
...
static_assert(sizeof(UEditableGameplayTagQueryExpression_AllExprMatch) == 0x000050, "Wrong size on UEditableGameplayTagQueryExpression_AllExprMatch");
static_assert(offsetof(UEditableGameplayTagQueryExpression_AllExprMatch, Expressions) == 0x000040, "Member 'UEditableGameplayTagQueryExpression_AllExprMatch::Expressions' has a wrong offset!");
...
static_assert(sizeof(UEditableGameplayTagQueryExpression_NoExprMatch) == 0x000050, "Wrong size on UEditableGameplayTagQueryExpression_NoExprMatch");
static_assert(offsetof(UEditableGameplayTagQueryExpression_NoExprMatch, Expressions) == 0x000040, "Member 'UEditableGameplayTagQueryExpression_NoExprMatch::Expressions' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_D0[0x68];                                      // 0x00D0(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UDataTable*>                     GameplayTagTables;                                 // 0x0138(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGameplayTagsManager) == 0x000198, "Wrong size on UGameplayTagsManager");
...
static_assert(offsetof(UGameplayTagsManager, GameplayTagTables) == 0x000138, "Member 'UGameplayTagsManager::GameplayTagTables' has a wrong offset!");
...
{
public:
	class FString                                 DeveloperConfigName;                               // 0x0040(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGameplayTagsDeveloperSettings, DeveloperConfigName) == 0x000040, "Member 'UGameplayTagsDeveloperSettings::DeveloperConfigName' has a wrong offset!");
