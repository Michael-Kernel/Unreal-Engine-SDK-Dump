...
// 0x8404 (0x8404 - 0x0000)
struct alignas(0x8404) TurnBasedMatchInterface_OnMatchEnded final
{
public:
	class FString                                 Match;                                             // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(TurnBasedMatchInterface_OnMatchEnded) == 0x008404, "Wrong alignment on TurnBasedMatchInterface_OnMatchEnded");
static_assert(sizeof(TurnBasedMatchInterface_OnMatchEnded) == 0x008404, "Wrong size on TurnBasedMatchInterface_OnMatchEnded");
