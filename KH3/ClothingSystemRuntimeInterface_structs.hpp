...
// 0x115EC8E0 (0x115EC8E0 - 0x0000)
struct alignas(0x115EC8E0) FClothCollisionPrim_SphereConnection final
{
public:
...
static_assert(alignof(FClothCollisionPrim_SphereConnection) == 0x115EC8E0, "Wrong alignment on FClothCollisionPrim_SphereConnection");
static_assert(sizeof(FClothCollisionPrim_SphereConnection) == 0x115EC8E0, "Wrong size on FClothCollisionPrim_SphereConnection");
...
// 0x115EC710 (0x115EC710 - 0x0000)
struct alignas(0x115EC710) FClothCollisionPrim_Convex final
{
public:
...
static_assert(alignof(FClothCollisionPrim_Convex) == 0x115EC710, "Wrong alignment on FClothCollisionPrim_Convex");
static_assert(sizeof(FClothCollisionPrim_Convex) == 0x115EC710, "Wrong size on FClothCollisionPrim_Convex");
