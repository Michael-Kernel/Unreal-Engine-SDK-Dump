...
{
public:
	struct FUniqueNetIdRepl                       UniqueId;                                          // 0x0000(0x1F5FEC10)(Transient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FPlayerReservation) == 0x1F5FEC10, "Wrong alignment on FPlayerReservation");
static_assert(sizeof(FPlayerReservation) == 0x1F5FEC10, "Wrong size on FPlayerReservation");
...
struct alignas(0x1EF73EE0) FBlueprintSessionResult final
{
public:
	uint8                                         Pad_0[0xB8];                                       // 0x0000(0x00B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FBlueprintSessionResult) == 0x1EF73EE0, "Wrong alignment on FBlueprintSessionResult");
static_assert(sizeof(FBlueprintSessionResult) == 0x1EF73EE0, "Wrong size on FBlueprintSessionResult");
...
public:
	...
	struct FUniqueNetIdRepl                       PartyLeader;                                       // 0x0008(0x1F5FEC10)(Transient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FPlayerReservation>             PartyMembers;                                      // 0x0020(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPartyReservation) == 0x1F5FEC10, "Wrong alignment on FPartyReservation");
static_assert(sizeof(FPartyReservation) == 0x1F5FEC10, "Wrong size on FPartyReservation");
