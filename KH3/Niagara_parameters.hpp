...
// 0x1753F (0x1753F - 0x0000)
struct alignas(0x1753F) NiagaraComponent_SetNiagaraEmitterSpawnRate final
{
public:
...
static_assert(alignof(NiagaraComponent_SetNiagaraEmitterSpawnRate) == 0x01753F, "Wrong alignment on NiagaraComponent_SetNiagaraEmitterSpawnRate");
static_assert(sizeof(NiagaraComponent_SetNiagaraEmitterSpawnRate) == 0x01753F, "Wrong size on NiagaraComponent_SetNiagaraEmitterSpawnRate");
...
// 0x17541 (0x17541 - 0x0000)
struct alignas(0x17541) NiagaraComponent_SetNiagaraVariableFloat final
{
public:
	class FString                                 InVariableName;                                    // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InValue;                                           // 0x0010(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(NiagaraComponent_SetNiagaraVariableFloat) == 0x017541, "Wrong alignment on NiagaraComponent_SetNiagaraVariableFloat");
static_assert(sizeof(NiagaraComponent_SetNiagaraVariableFloat) == 0x017541, "Wrong size on NiagaraComponent_SetNiagaraVariableFloat");
...
public:
	class FString                                 InVariableName;                                    // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              InValue;                                           // 0x0010(0x112E95F0)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(NiagaraComponent_SetNiagaraVariableVec2) == 0x112E95F0, "Wrong alignment on NiagaraComponent_SetNiagaraVariableVec2");
static_assert(sizeof(NiagaraComponent_SetNiagaraVariableVec2) == 0x112E95F0, "Wrong size on NiagaraComponent_SetNiagaraVariableVec2");
...
public:
	class FString                                 InVariableName;                                    // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector4                               InValue;                                           // 0x0010(0x112E9300)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(NiagaraComponent_SetNiagaraVariableVec4) == 0x112E9300, "Wrong alignment on NiagaraComponent_SetNiagaraVariableVec4");
static_assert(sizeof(NiagaraComponent_SetNiagaraVariableVec4) == 0x112E9300, "Wrong size on NiagaraComponent_SetNiagaraVariableVec4");
...
public:
	...
	struct FRotator                               Rotation;                                          // 0x001C(0x112E9AF0)(Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(NiagaraFunctionLibrary_SpawnEffectAtLocation) == 0x112E9AF0, "Wrong alignment on NiagaraFunctionLibrary_SpawnEffectAtLocation");
static_assert(sizeof(NiagaraFunctionLibrary_SpawnEffectAtLocation) == 0x112E9AF0, "Wrong size on NiagaraFunctionLibrary_SpawnEffectAtLocation");
...
static_assert(alignof(NiagaraFunctionLibrary_SpawnEffectAttached) == 0x112E9AF0, "Wrong alignment on NiagaraFunctionLibrary_SpawnEffectAttached");
static_assert(sizeof(NiagaraFunctionLibrary_SpawnEffectAttached) == 0x112E9AF0, "Wrong size on NiagaraFunctionLibrary_SpawnEffectAttached");
