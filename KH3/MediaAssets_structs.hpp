...
// 0x11681F60 (0x11681F60 - 0x0000)
struct alignas(0x11681F60) FMediaPlayerOverlay final
{
public:
	...
	struct FVector2D                              Position;                                          // 0x0004(0x112E95F0)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   Text;                                              // 0x0010(0x0018)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FMediaPlayerOverlay) == 0x11681F60, "Wrong alignment on FMediaPlayerOverlay");
static_assert(sizeof(FMediaPlayerOverlay) == 0x11681F60, "Wrong size on FMediaPlayerOverlay");
