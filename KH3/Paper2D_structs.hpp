...
// 0x1168C330 (0x1168C330 - 0x0000)
struct alignas(0x1168C330) FPaperSpriteAtlasSlot final
{
public:
	TSoftObjectPtr<class UPaperSprite>            SpriteRef;                                         // 0x0000(0x0020)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AtlasIndex;                                        // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         X;                                                 // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Y;                                                 // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Width;                                             // 0x002C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Height;                                            // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPaperSpriteAtlasSlot) == 0x1168C330, "Wrong alignment on FPaperSpriteAtlasSlot");
static_assert(sizeof(FPaperSpriteAtlasSlot) == 0x1168C330, "Wrong size on FPaperSpriteAtlasSlot");
...
static_assert(offsetof(FPaperSpriteAtlasSlot, AtlasIndex) == 0x000020, "Member 'FPaperSpriteAtlasSlot::AtlasIndex' has a wrong offset!");
static_assert(offsetof(FPaperSpriteAtlasSlot, X) == 0x000024, "Member 'FPaperSpriteAtlasSlot::X' has a wrong offset!");
static_assert(offsetof(FPaperSpriteAtlasSlot, Y) == 0x000028, "Member 'FPaperSpriteAtlasSlot::Y' has a wrong offset!");
static_assert(offsetof(FPaperSpriteAtlasSlot, Width) == 0x00002C, "Member 'FPaperSpriteAtlasSlot::Width' has a wrong offset!");
static_assert(offsetof(FPaperSpriteAtlasSlot, Height) == 0x000030, "Member 'FPaperSpriteAtlasSlot::Height' has a wrong offset!");

// ScriptStruct Paper2D.SpriteInstanceData
// 0x1168BE30 (0x1168BE30 - 0x0000)
struct alignas(0x1168BE30) FSpriteInstanceData final
{
public:
...
static_assert(alignof(FSpriteInstanceData) == 0x1168BE30, "Wrong alignment on FSpriteInstanceData");
static_assert(sizeof(FSpriteInstanceData) == 0x1168BE30, "Wrong size on FSpriteInstanceData");
...
// 0x1168B960 (0x1168B960 - 0x0000)
struct alignas(0x1168B960) FIntMargin final
{
public:
...
static_assert(alignof(FIntMargin) == 0x1168B960, "Wrong alignment on FIntMargin");
static_assert(sizeof(FIntMargin) == 0x1168B960, "Wrong size on FIntMargin");
...
// 0x1168C150 (0x1168C150 - 0x0000)
struct alignas(0x1168C150) FPaperSpriteSocket final
{
public:
	struct FTransform                             LocalTransform;                                    // 0x0000(0x112E9D50)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(FPaperSpriteSocket) == 0x1168C150, "Wrong alignment on FPaperSpriteSocket");
static_assert(sizeof(FPaperSpriteSocket) == 0x1168C150, "Wrong size on FPaperSpriteSocket");
...
// 0x1168BC50 (0x1168BC50 - 0x0000)
struct alignas(0x1168BC50) FPaperFlipbookKeyFrame final
{
public:
...
static_assert(alignof(FPaperFlipbookKeyFrame) == 0x1168BC50, "Wrong alignment on FPaperFlipbookKeyFrame");
static_assert(sizeof(FPaperFlipbookKeyFrame) == 0x1168BC50, "Wrong size on FPaperFlipbookKeyFrame");
...
// 0x1168C750 (0x1168C750 - 0x0000)
struct alignas(0x1168C750) FPaperTerrainMaterialRule final
{
public:
...
static_assert(alignof(FPaperTerrainMaterialRule) == 0x1168C750, "Wrong alignment on FPaperTerrainMaterialRule");
static_assert(sizeof(FPaperTerrainMaterialRule) == 0x1168C750, "Wrong size on FPaperTerrainMaterialRule");
...
struct alignas(0x1168CD60) FPaperTileInfo final
{
public:
...
static_assert(alignof(FPaperTileInfo) == 0x1168CD60, "Wrong alignment on FPaperTileInfo");
static_assert(sizeof(FPaperTileInfo) == 0x1168CD60, "Wrong size on FPaperTileInfo");
...
// 0x1168CF40 (0x1168CF40 - 0x0000)
struct alignas(0x1168CF40) FPaperTileSetTerrain final
{
public:
...
static_assert(alignof(FPaperTileSetTerrain) == 0x1168CF40, "Wrong alignment on FPaperTileSetTerrain");
static_assert(sizeof(FPaperTileSetTerrain) == 0x1168CF40, "Wrong size on FPaperTileSetTerrain");
...
public:
	...
	struct FVector2D                              BoxSize;                                           // 0x0018(0x112E95F0)(Edit, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              BoxPosition;                                       // 0x0020(0x112E95F0)(Edit, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FSpriteGeometryShape) == 0x112E95F0, "Wrong alignment on FSpriteGeometryShape");
static_assert(sizeof(FSpriteGeometryShape) == 0x112E95F0, "Wrong size on FSpriteGeometryShape");
...
// 0x1168D300 (0x1168D300 - 0x0000)
struct alignas(0x1168D300) FSpriteGeometryCollection final
{
public:
...
static_assert(alignof(FSpriteGeometryCollection) == 0x1168D300, "Wrong alignment on FSpriteGeometryCollection");
static_assert(sizeof(FSpriteGeometryCollection) == 0x1168D300, "Wrong size on FSpriteGeometryCollection");
...
public:
	...
	struct FSpriteGeometryCollection              CollisionData;                                     // 0x0008(0x1168D300)(Edit, NativeAccessSpecifierPublic)
...
static_assert(alignof(FPaperTileMetadata) == 0x1168D300, "Wrong alignment on FPaperTileMetadata");
static_assert(sizeof(FPaperTileMetadata) == 0x1168D300, "Wrong size on FPaperTileMetadata");
...
struct FSpriteDrawCallRecord final
{
public:
...
static_assert(alignof(FSpriteDrawCallRecord) == 0x000008, "Wrong alignment on FSpriteDrawCallRecord");
...
// 0x1247F (0x1247F - 0x0000)
struct alignas(0x1247F) FSpriteAssetInitParameters final
{
public:
	uint8                                         Pad_0[0x40];                                       // 0x0000(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSpriteAssetInitParameters) == 0x01247F, "Wrong alignment on FSpriteAssetInitParameters");
static_assert(sizeof(FSpriteAssetInitParameters) == 0x01247F, "Wrong size on FSpriteAssetInitParameters");
