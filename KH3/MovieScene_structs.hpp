...
public:
	...
	struct FGuid                                  Guid;                                              // 0x0008(0x112E8D20)(Edit, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FMovieSceneObjectBindingID) == 0x112E8D20, "Wrong alignment on FMovieSceneObjectBindingID");
static_assert(sizeof(FMovieSceneObjectBindingID) == 0x112E8D20, "Wrong size on FMovieSceneObjectBindingID");
...
{
public:
	struct FMovieSceneObjectBindingID             ObjectBindingId;                                   // 0x0000(0x112E8D20)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// 0x115A7CD0 (0x115A7CD0 - 0x0000)
struct alignas(0x115A7CD0) FMovieSceneEvaluationGroupLUTIndex final
{
public:
...
static_assert(alignof(FMovieSceneEvaluationGroupLUTIndex) == 0x115A7CD0, "Wrong alignment on FMovieSceneEvaluationGroupLUTIndex");
static_assert(sizeof(FMovieSceneEvaluationGroupLUTIndex) == 0x115A7CD0, "Wrong size on FMovieSceneEvaluationGroupLUTIndex");
...
// 0x115A77D0 (0x115A77D0 - 0x0000)
struct alignas(0x115A77D0) FMovieSceneTrackIdentifier final
{
public:
	uint32                                        Value;                                             // 0x0000(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FMovieSceneTrackIdentifier) == 0x115A77D0, "Wrong alignment on FMovieSceneTrackIdentifier");
static_assert(sizeof(FMovieSceneTrackIdentifier) == 0x115A77D0, "Wrong size on FMovieSceneTrackIdentifier");
...
struct alignas(0x1F5FEC10) FMovieSceneTemplateGenerationLedger final
{
public:
	struct FMovieSceneTrackIdentifier             LastTrackIdentifier;                               // 0x0000(0x115A77D0)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FMovieSceneTemplateGenerationLedger) == 0x1F5FEC10, "Wrong alignment on FMovieSceneTemplateGenerationLedger");
static_assert(sizeof(FMovieSceneTemplateGenerationLedger) == 0x1F5FEC10, "Wrong size on FMovieSceneTemplateGenerationLedger");
...
{
public:
	struct FGuid                                  ObjectGuid;                                        // 0x0000(0x112E8D20)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(alignof(FMovieSceneBinding) == 0x112E8D20, "Wrong alignment on FMovieSceneBinding");
static_assert(sizeof(FMovieSceneBinding) == 0x112E8D20, "Wrong size on FMovieSceneBinding");
...
public:
	...
	struct FFloatRange                            WorkingRange;                                      // 0x0050(0x112EFEC0)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFloatRange                            ViewRange;                                         // 0x0060(0x112EFEC0)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
// 0x5FE1 (0x5FE1 - 0x0000)
struct alignas(0x5FE1) FMovieSceneEvalTemplatePtr final
{
public:
	uint8                                         Pad_0[0x38];                                       // 0x0000(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieSceneEvalTemplatePtr) == 0x005FE1, "Wrong alignment on FMovieSceneEvalTemplatePtr");
static_assert(sizeof(FMovieSceneEvalTemplatePtr) == 0x005FE1, "Wrong size on FMovieSceneEvalTemplatePtr");
...
static_assert(alignof(FMovieSceneEvalTemplateBase) == 0x000001, "Wrong alignment on FMovieSceneEvalTemplateBase");
static_assert(sizeof(FMovieSceneEvalTemplateBase) == 0x000010, "Wrong size on FMovieSceneEvalTemplateBase");

// ScriptStruct MovieScene.MovieSceneEvalTemplate
// 0x12150 (0x12160 - 0x0010)
#pragma pack(push, 0x1)
struct alignas(0x12160) FMovieSceneEvalTemplate : public FMovieSceneEvalTemplateBase
{
public:
...
#pragma pack(pop)
static_assert(alignof(FMovieSceneEvalTemplate) == 0x012160, "Wrong alignment on FMovieSceneEvalTemplate");
static_assert(sizeof(FMovieSceneEvalTemplate) == 0x012160, "Wrong size on FMovieSceneEvalTemplate");
...
// 0xB4B7 (0xB4B7 - 0x0000)
struct alignas(0xB4B7) FMovieSceneEmptyStruct final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieSceneEmptyStruct) == 0x00B4B7, "Wrong alignment on FMovieSceneEmptyStruct");
static_assert(sizeof(FMovieSceneEmptyStruct) == 0x00B4B7, "Wrong size on FMovieSceneEmptyStruct");

// ScriptStruct MovieScene.MovieSceneSequenceID
// 0x115A6B00 (0x115A6B00 - 0x0000)
struct alignas(0x115A6B00) FMovieSceneSequenceID final
{
public:
	uint32                                        Value;                                             // 0x0000(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FMovieSceneSequenceID) == 0x115A6B00, "Wrong alignment on FMovieSceneSequenceID");
static_assert(sizeof(FMovieSceneSequenceID) == 0x115A6B00, "Wrong size on FMovieSceneSequenceID");
...
// 0x115A77D0 (0x115A77D0 - 0x0000)
#pragma pack(push, 0x1)
struct alignas(0x115A77D0) FMovieSceneEvaluationFieldTrackPtr
{
public:
	struct FMovieSceneSequenceID                  SequenceID;                                        // 0x0000(0x115A6B00)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieSceneTrackIdentifier             TrackIdentifier;                                   // 0x0004(0x115A77D0)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
#pragma pack(pop)
static_assert(alignof(FMovieSceneEvaluationFieldTrackPtr) == 0x115A77D0, "Wrong alignment on FMovieSceneEvaluationFieldTrackPtr");
static_assert(sizeof(FMovieSceneEvaluationFieldTrackPtr) == 0x115A77D0, "Wrong size on FMovieSceneEvaluationFieldTrackPtr");
...
static_assert(alignof(FMovieSceneEvaluationFieldSegmentPtr) == 0x115A77D0, "Wrong alignment on FMovieSceneEvaluationFieldSegmentPtr");
static_assert(sizeof(FMovieSceneEvaluationFieldSegmentPtr) == 0x115A77D0, "Wrong size on FMovieSceneEvaluationFieldSegmentPtr");
...
static_assert(alignof(FMovieSceneEvaluationKey) == 0x000001, "Wrong alignment on FMovieSceneEvaluationKey");
static_assert(sizeof(FMovieSceneEvaluationKey) == 0x00000C, "Wrong size on FMovieSceneEvaluationKey");

// ScriptStruct MovieScene.MovieSceneOrderedEvaluationKey
// 0x115A6EE0 (0x115A6EE0 - 0x0000)
struct alignas(0x115A6EE0) FMovieSceneOrderedEvaluationKey final
{
public:
...
static_assert(alignof(FMovieSceneOrderedEvaluationKey) == 0x115A6EE0, "Wrong alignment on FMovieSceneOrderedEvaluationKey");
static_assert(sizeof(FMovieSceneOrderedEvaluationKey) == 0x115A6EE0, "Wrong size on FMovieSceneOrderedEvaluationKey");
...
static_assert(alignof(FMovieSceneTrackImplementationPtr) == 0x000001, "Wrong alignment on FMovieSceneTrackImplementationPtr");
...
static_assert(alignof(FMovieSceneSegment) == 0x000001, "Wrong alignment on FMovieSceneSegment");
...
{
public:
	struct FGuid                                  ObjectBindingId;                                   // 0x0000(0x112E8D20)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(alignof(FMovieSceneEvaluationTrack) == 0x112E8D20, "Wrong alignment on FMovieSceneEvaluationTrack");
static_assert(sizeof(FMovieSceneEvaluationTrack) == 0x112E8D20, "Wrong size on FMovieSceneEvaluationTrack");
...
// 0x115A9740 (0x115A9740 - 0x0000)
struct alignas(0x115A9740) FMovieSceneSequenceTransform final
{
public:
...
static_assert(alignof(FMovieSceneSequenceTransform) == 0x115A9740, "Wrong alignment on FMovieSceneSequenceTransform");
static_assert(sizeof(FMovieSceneSequenceTransform) == 0x115A9740, "Wrong size on FMovieSceneSequenceTransform");
...
public:
	...
	struct FMovieSceneSequenceTransform           RootToSequenceTransform;                           // 0x0010(0x115A9740)(NoDestructor, NativeAccessSpecifierPublic)
	struct FGuid                                  SourceSequenceSignature;                           // 0x0018(0x112E8D20)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieSceneSequenceID                  DeterministicSequenceID;                           // 0x0028(0x115A6B00)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFloatRange                            PreRollRange;                                      // 0x002C(0x112EFEC0)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFloatRange                            PostRollRange;                                     // 0x003C(0x112EFEC0)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FMovieSceneSubSequenceData) == 0x115A9740, "Wrong alignment on FMovieSceneSubSequenceData");
static_assert(sizeof(FMovieSceneSubSequenceData) == 0x115A9740, "Wrong size on FMovieSceneSubSequenceData");
...
{
public:
	struct FMovieSceneSequenceID                  ParentID;                                          // 0x0000(0x115A6B00)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FMovieSceneSequenceID>          Children;                                          // 0x0008(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMovieSceneSequenceHierarchyNode) == 0x115A6B00, "Wrong alignment on FMovieSceneSequenceHierarchyNode");
static_assert(sizeof(FMovieSceneSequenceHierarchyNode) == 0x115A6B00, "Wrong size on FMovieSceneSequenceHierarchyNode");
...
struct alignas(0x1EF887C8) FMovieSceneSequenceHierarchy final
{
public:
...
static_assert(alignof(FMovieSceneSequenceHierarchy) == 0x1EF887C8, "Wrong alignment on FMovieSceneSequenceHierarchy");
static_assert(sizeof(FMovieSceneSequenceHierarchy) == 0x1EF887C8, "Wrong size on FMovieSceneSequenceHierarchy");
...
public:
	...
	struct FMovieSceneSequenceHierarchy           Hierarchy;                                         // 0x00D0(0x1EF887C8)(NativeAccessSpecifierPublic)
	struct FMovieSceneTemplateGenerationLedger    TemplateLedger;                                    // 0x0170(0x1F5FEC10)(NativeAccessSpecifierPrivate)
...
static_assert(alignof(FMovieSceneEvaluationTemplate) == 0x1F5FEC10, "Wrong alignment on FMovieSceneEvaluationTemplate");
static_assert(sizeof(FMovieSceneEvaluationTemplate) == 0x1F5FEC10, "Wrong size on FMovieSceneEvaluationTemplate");
...
static_assert(alignof(FCachedMovieSceneEvaluationTemplate) == 0x1F5FEC10, "Wrong alignment on FCachedMovieSceneEvaluationTemplate");
static_assert(sizeof(FCachedMovieSceneEvaluationTemplate) == 0x1F5FEC10, "Wrong size on FCachedMovieSceneEvaluationTemplate");

// ScriptStruct MovieScene.MovieSceneTrackImplementation
// 0x1219C (0x121AC - 0x0010)
struct alignas(0x121AC) FMovieSceneTrackImplementation final : public FMovieSceneEvalTemplateBase
{
};
static_assert(alignof(FMovieSceneTrackImplementation) == 0x0121AC, "Wrong alignment on FMovieSceneTrackImplementation");
static_assert(sizeof(FMovieSceneTrackImplementation) == 0x0121AC, "Wrong size on FMovieSceneTrackImplementation");
...
{
public:
	struct FGuid                                  Guid;                                              // 0x0000(0x112E8D20)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	struct FGuid                                  ParentGuid;                                        // 0x0028(0x112E8D20)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FMovieScenePossessable) == 0x112E8D20, "Wrong alignment on FMovieScenePossessable");
static_assert(sizeof(FMovieScenePossessable) == 0x112E8D20, "Wrong size on FMovieScenePossessable");
...
public:
	...
	struct FGuid                                  CachedSignature;                                   // 0x0008(0x112E8D20)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMovieSceneSequenceCachedSignature) == 0x112E8D20, "Wrong alignment on FMovieSceneSequenceCachedSignature");
static_assert(sizeof(FMovieSceneSequenceCachedSignature) == 0x112E8D20, "Wrong size on FMovieSceneSequenceCachedSignature");
...
// 0x1218A (0x1218A - 0x0000)
#pragma pack(push, 0x1)
struct alignas(0x1218A) FMovieSceneKeyStruct
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
#pragma pack(pop)
static_assert(alignof(FMovieSceneKeyStruct) == 0x01218A, "Wrong alignment on FMovieSceneKeyStruct");
static_assert(sizeof(FMovieSceneKeyStruct) == 0x01218A, "Wrong size on FMovieSceneKeyStruct");
...
static_assert(alignof(FMovieSceneLegacyTrackInstanceTemplate) == 0x012160, "Wrong alignment on FMovieSceneLegacyTrackInstanceTemplate");
static_assert(sizeof(FMovieSceneLegacyTrackInstanceTemplate) == 0x012160, "Wrong size on FMovieSceneLegacyTrackInstanceTemplate");
...
// 0x115AAEC0 (0x115AAEC0 - 0x0000)
struct alignas(0x115AAEC0) FMovieScenePropertySectionData final
{
public:
...
static_assert(alignof(FMovieScenePropertySectionData) == 0x115AAEC0, "Wrong alignment on FMovieScenePropertySectionData");
static_assert(sizeof(FMovieScenePropertySectionData) == 0x115AAEC0, "Wrong size on FMovieScenePropertySectionData");
...
#pragma pack(push, 0x1)
struct alignas(0x115AAEC0) FMovieScenePropertySectionTemplate : public FMovieSceneEvalTemplate
{
public:
	struct FMovieScenePropertySectionData         PropertyData;                                      // 0x0020(0x115AAEC0)(Protected, NativeAccessSpecifierProtected)
};
#pragma pack(pop)
static_assert(alignof(FMovieScenePropertySectionTemplate) == 0x115AAEC0, "Wrong alignment on FMovieScenePropertySectionTemplate");
static_assert(sizeof(FMovieScenePropertySectionTemplate) == 0x115AAEC0, "Wrong size on FMovieScenePropertySectionTemplate");
...
// 0x115AB1B0 (0x115AB1B0 - 0x0000)
struct alignas(0x115AB1B0) FMovieSceneEasingSettings final
{
public:
...
static_assert(alignof(FMovieSceneEasingSettings) == 0x115AB1B0, "Wrong alignment on FMovieSceneEasingSettings");
static_assert(sizeof(FMovieSceneEasingSettings) == 0x115AB1B0, "Wrong size on FMovieSceneEasingSettings");
...
// 0x115AB9B0 (0x115AB9B0 - 0x0000)
struct alignas(0x115AB9B0) FMovieSceneSectionParameters final
{
public:
...
static_assert(alignof(FMovieSceneSectionParameters) == 0x115AB9B0, "Wrong alignment on FMovieSceneSectionParameters");
static_assert(sizeof(FMovieSceneSectionParameters) == 0x115AB9B0, "Wrong size on FMovieSceneSectionParameters");
...
static_assert(alignof(FMovieSceneSpawnable) == 0x112E8D20, "Wrong alignment on FMovieSceneSpawnable");
static_assert(sizeof(FMovieSceneSpawnable) == 0x112E8D20, "Wrong size on FMovieSceneSpawnable");
...
static_assert(alignof(FMovieSceneTrackEvalOptions) == 0x000001, "Wrong alignment on FMovieSceneTrackEvalOptions");
