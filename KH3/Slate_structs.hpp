...
{
public:
	struct FVector2D                              Minimum;                                           // 0x0000(0x112E95F0)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              Maximum;                                           // 0x0008(0x112E95F0)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAnchors) == 0x112E95F0, "Wrong alignment on FAnchors");
static_assert(sizeof(FAnchors) == 0x112E95F0, "Wrong size on FAnchors");
...
{
public:
	struct FKey                                   Key;                                               // 0x0000(0x112F6AF0)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FInputChord) == 0x112F6AF0, "Wrong alignment on FInputChord");
static_assert(sizeof(FInputChord) == 0x112F6AF0, "Wrong size on FInputChord");
