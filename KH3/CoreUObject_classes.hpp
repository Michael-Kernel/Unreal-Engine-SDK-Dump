...
public:
	...
	class FName                                   Name;                                              // 0x0020(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UObject) == 0x000040, "Wrong size on UObject");
...
static_assert(offsetof(UObject, Class) == 0x000018, "Member 'UObject::Class' has a wrong offset!");
static_assert(offsetof(UObject, Name) == 0x000020, "Member 'UObject::Name' has a wrong offset!");
...
static_assert(sizeof(UPackage) == 0x000180, "Wrong size on UPackage");
...
{
public:
	class UField*                                 Next;                                              // 0x0040(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UField) == 0x000048, "Wrong size on UField");
static_assert(offsetof(UField, Next) == 0x000040, "Member 'UField::Next' has a wrong offset!");
...
static_assert(sizeof(UObjectRedirector) == 0x000048, "Wrong size on UObjectRedirector");
...
static_assert(sizeof(IInterface) == 0x000040, "Wrong size on IInterface");
...
static_assert(sizeof(UTextBuffer) == 0x000068, "Wrong size on UTextBuffer");
...
public:
	...
	uint8                                         Pad_5C[0x124];                                     // 0x005C(0x0124)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MinAlignemnt;                                      // 0x0180(0x0004)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UStruct) == 0x0000A0, "Wrong size on UStruct");
...
static_assert(offsetof(UStruct, MinAlignemnt) == 0x000180, "Member 'UStruct::MinAlignemnt' has a wrong offset!");
...
static_assert(sizeof(UScriptStruct) == 0x0000B0, "Wrong size on UScriptStruct");
...
static_assert(sizeof(UClass) == 0x000228, "Wrong size on UClass");
...
public:
	...
	uint32                                        FunctionFlags;                                     // 0x00A0(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UFunction) == 0x0000D0, "Wrong size on UFunction");
static_assert(offsetof(UFunction, FunctionFlags) == 0x0000A0, "Member 'UFunction::FunctionFlags' has a wrong offset!");
static_assert(offsetof(UFunction, ExecFunction) == 0x0000C8, "Member 'UFunction::ExecFunction' has a wrong offset!");
...
static_assert(sizeof(UDelegateFunction) == 0x0000D0, "Wrong size on UDelegateFunction");
...
static_assert(sizeof(UPackageMap) == 0x0000F8, "Wrong size on UPackageMap");
...
public:
	...
	class TArray<class TPair<class FName, int64>> Names;                                             // 0x0058(0x0010)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UEnum) == 0x000078, "Wrong size on UEnum");
static_assert(offsetof(UEnum, Names) == 0x000058, "Member 'UEnum::Names' has a wrong offset!");
...
{
public:
	int32                                         ArrayDim;                                          // 0x0048(0x0004)(NOT AUTO-GENERATED PROPERTY)
	int32                                         ElementSize;                                       // 0x004C(0x0004)(NOT AUTO-GENERATED PROPERTY)
	uint64                                        PropertyFlags;                                     // 0x0050(0x0008)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_58[0x10];                                      // 0x0058(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Offset;                                            // 0x0068(0x0004)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UProperty) == 0x000090, "Wrong size on UProperty");
static_assert(offsetof(UProperty, ArrayDim) == 0x000048, "Member 'UProperty::ArrayDim' has a wrong offset!");
static_assert(offsetof(UProperty, ElementSize) == 0x00004C, "Member 'UProperty::ElementSize' has a wrong offset!");
static_assert(offsetof(UProperty, PropertyFlags) == 0x000050, "Member 'UProperty::PropertyFlags' has a wrong offset!");
static_assert(offsetof(UProperty, Offset) == 0x000068, "Member 'UProperty::Offset' has a wrong offset!");
...
{
public:
	class UProperty*                              UnderlayingProperty;                               // 0x0090(0x0008)(NOT AUTO-GENERATED PROPERTY)
	class UEnum*                                  Enum;                                              // 0x0098(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UEnumProperty) == 0x0000A0, "Wrong size on UEnumProperty");
static_assert(offsetof(UEnumProperty, UnderlayingProperty) == 0x000090, "Member 'UEnumProperty::UnderlayingProperty' has a wrong offset!");
static_assert(offsetof(UEnumProperty, Enum) == 0x000098, "Member 'UEnumProperty::Enum' has a wrong offset!");

// Class CoreUObject.LinkerPlaceholderClass
// 0x01A0 (0x03C8 - 0x0228)
class ULinkerPlaceholderClass final : public UClass
{
public:
	uint8                                         Pad_228[0x1A0];                                    // 0x0228(0x01A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULinkerPlaceholderClass) == 0x0003C8, "Wrong size on ULinkerPlaceholderClass");
...
static_assert(sizeof(ULinkerPlaceholderFunction) == 0x000270, "Wrong size on ULinkerPlaceholderFunction");
...
static_assert(sizeof(UMetaData) == 0x0000E0, "Wrong size on UMetaData");
...
{
public:
	class UProperty*                              InnerProperty;                                     // 0x0090(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UArrayProperty) == 0x000098, "Wrong size on UArrayProperty");
static_assert(offsetof(UArrayProperty, InnerProperty) == 0x000090, "Member 'UArrayProperty::InnerProperty' has a wrong offset!");
...
{
public:
	class UClass*                                 PropertyClass;                                     // 0x0090(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UObjectPropertyBase) == 0x000098, "Wrong size on UObjectPropertyBase");
static_assert(offsetof(UObjectPropertyBase, PropertyClass) == 0x000090, "Member 'UObjectPropertyBase::PropertyClass' has a wrong offset!");
...
static_assert(sizeof(UAssetObjectProperty) == 0x000098, "Wrong size on UAssetObjectProperty");
...
static_assert(sizeof(UAssetClassProperty) == 0x0000A0, "Wrong size on UAssetClassProperty");
...
{
public:
	uint8                                         FieldSize;                                         // 0x0090(0x0001)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         ByteOffset;                                        // 0x0091(0x0001)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         ByteMask;                                          // 0x0092(0x0001)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         FieldMask;                                         // 0x0093(0x0001)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UBoolProperty) == 0x000098, "Wrong size on UBoolProperty");
static_assert(offsetof(UBoolProperty, FieldSize) == 0x000090, "Member 'UBoolProperty::FieldSize' has a wrong offset!");
static_assert(offsetof(UBoolProperty, ByteOffset) == 0x000091, "Member 'UBoolProperty::ByteOffset' has a wrong offset!");
static_assert(offsetof(UBoolProperty, ByteMask) == 0x000092, "Member 'UBoolProperty::ByteMask' has a wrong offset!");
static_assert(offsetof(UBoolProperty, FieldMask) == 0x000093, "Member 'UBoolProperty::FieldMask' has a wrong offset!");
...
static_assert(sizeof(UNumericProperty) == 0x000090, "Wrong size on UNumericProperty");
...
static_assert(sizeof(UByteProperty) == 0x000098, "Wrong size on UByteProperty");
static_assert(offsetof(UByteProperty, Enum) == 0x000090, "Member 'UByteProperty::Enum' has a wrong offset!");
...
static_assert(sizeof(UObjectProperty) == 0x000098, "Wrong size on UObjectProperty");
...
{
public:
	class UClass*                                 MetaClass;                                         // 0x0098(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UClassProperty) == 0x0000A0, "Wrong size on UClassProperty");
static_assert(offsetof(UClassProperty, MetaClass) == 0x000098, "Member 'UClassProperty::MetaClass' has a wrong offset!");
...
{
public:
	class UFunction*                              SignatureFunction;                                 // 0x0090(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UDelegateProperty) == 0x000098, "Wrong size on UDelegateProperty");
static_assert(offsetof(UDelegateProperty, SignatureFunction) == 0x000090, "Member 'UDelegateProperty::SignatureFunction' has a wrong offset!");
...
static_assert(sizeof(UDoubleProperty) == 0x000090, "Wrong size on UDoubleProperty");
...
static_assert(sizeof(UFloatProperty) == 0x000090, "Wrong size on UFloatProperty");
...
static_assert(sizeof(UIntProperty) == 0x000090, "Wrong size on UIntProperty");
...
static_assert(sizeof(UInt16Property) == 0x000090, "Wrong size on UInt16Property");
...
static_assert(sizeof(UInt64Property) == 0x000090, "Wrong size on UInt64Property");
...
static_assert(sizeof(UInt8Property) == 0x000090, "Wrong size on UInt8Property");
...
static_assert(sizeof(UInterfaceProperty) == 0x000098, "Wrong size on UInterfaceProperty");
...
static_assert(sizeof(ULazyObjectProperty) == 0x000098, "Wrong size on ULazyObjectProperty");
...
{
public:
	class UProperty*                              KeyProperty;                                       // 0x0090(0x0008)(NOT AUTO-GENERATED PROPERTY)
	class UProperty*                              ValueProperty;                                     // 0x0098(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UMapProperty) == 0x0000C8, "Wrong size on UMapProperty");
static_assert(offsetof(UMapProperty, KeyProperty) == 0x000090, "Member 'UMapProperty::KeyProperty' has a wrong offset!");
static_assert(offsetof(UMapProperty, ValueProperty) == 0x000098, "Member 'UMapProperty::ValueProperty' has a wrong offset!");
...
static_assert(sizeof(UMulticastDelegateProperty) == 0x000098, "Wrong size on UMulticastDelegateProperty");
...
static_assert(sizeof(UNameProperty) == 0x000090, "Wrong size on UNameProperty");
...
{
public:
	class UProperty*                              ElementProperty;                                   // 0x0090(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(USetProperty) == 0x0000B8, "Wrong size on USetProperty");
static_assert(offsetof(USetProperty, ElementProperty) == 0x000090, "Member 'USetProperty::ElementProperty' has a wrong offset!");
...
static_assert(sizeof(UStrProperty) == 0x000090, "Wrong size on UStrProperty");
...
{
public:
	class UStruct*                                Struct;                                            // 0x0090(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
static_assert(sizeof(UStructProperty) == 0x000098, "Wrong size on UStructProperty");
static_assert(offsetof(UStructProperty, Struct) == 0x000090, "Member 'UStructProperty::Struct' has a wrong offset!");
...
static_assert(sizeof(UUInt16Property) == 0x000090, "Wrong size on UUInt16Property");
...
static_assert(sizeof(UUInt32Property) == 0x000090, "Wrong size on UUInt32Property");
...
static_assert(sizeof(UUInt64Property) == 0x000090, "Wrong size on UUInt64Property");
...
static_assert(sizeof(UWeakObjectProperty) == 0x000098, "Wrong size on UWeakObjectProperty");
...
static_assert(sizeof(UTextProperty) == 0x000090, "Wrong size on UTextProperty");
