...
static_assert(alignof(FAxis) == 0x000001, "Wrong alignment on FAxis");
...
static_assert(alignof(FConstraintDescriptionEx) == 0x000001, "Wrong alignment on FConstraintDescriptionEx");
...
// 0x121A0 (0x121B0 - 0x0010)
struct alignas(0x121B0) FAimConstraintDescription final : public FConstraintDescriptionEx
{
public:
...
static_assert(alignof(FAimConstraintDescription) == 0x0121B0, "Wrong alignment on FAimConstraintDescription");
static_assert(sizeof(FAimConstraintDescription) == 0x0121B0, "Wrong size on FAimConstraintDescription");
...
static_assert(alignof(FConstraintDescriptor) == 0x000001, "Wrong alignment on FConstraintDescriptor");
...
public:
	...
	struct FTransform                             Offset;                                            // 0x0020(0x112E9D50)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FTransform                             CurrentTransform;                                  // 0x0050(0x112E9D50)(Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FConstraintData) == 0x000004, "Wrong alignment on FConstraintData");
...
static_assert(alignof(FTransformConstraintDescription) == 0x000001, "Wrong alignment on FTransformConstraintDescription");
...
public:
	...
	struct FQuat                                  Rotation;                                          // 0x0010(0x112E9D50)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FTransform                             Parent;                                            // 0x0030(0x112E9D50)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FConstraintOffset) == 0x112E9D50, "Wrong alignment on FConstraintOffset");
static_assert(sizeof(FConstraintOffset) == 0x112E9D50, "Wrong size on FConstraintOffset");
...
// 0x115AF540 (0x115AF540 - 0x0000)
struct alignas(0x115AF540) FNodeObject final
{
public:
...
static_assert(alignof(FNodeObject) == 0x115AF540, "Wrong alignment on FNodeObject");
static_assert(sizeof(FNodeObject) == 0x115AF540, "Wrong size on FNodeObject");
...
// 0x1EF73BC0 (0x1EF73BC0 - 0x0000)
struct alignas(0x1EF73BC0) FNodeHierarchyData final
{
public:
...
static_assert(alignof(FNodeHierarchyData) == 0x1EF73BC0, "Wrong alignment on FNodeHierarchyData");
static_assert(sizeof(FNodeHierarchyData) == 0x1EF73BC0, "Wrong size on FNodeHierarchyData");
...
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNodeHierarchyData                     Hierarchy;                                         // 0x0008(0x1EF73BC0)(Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FNodeHierarchyWithUserData) == 0x1EF73BC0, "Wrong alignment on FNodeHierarchyWithUserData");
static_assert(sizeof(FNodeHierarchyWithUserData) == 0x1EF73BC0, "Wrong size on FNodeHierarchyWithUserData");
