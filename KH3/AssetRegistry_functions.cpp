...
struct FStringAssetReference UAssetRegistryHelpers::ToStringReference(const struct FAssetData& InAssetData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AssetRegistryHelpers", "ToStringReference");

	Params::AssetRegistryHelpers_ToStringReference Parms{};
