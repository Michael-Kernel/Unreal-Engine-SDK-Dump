...
// 0xB95A (0xB95A - 0x0000)
struct alignas(0xB95A) GeometryCacheComponent_SetPlaybackSpeed final
{
public:
...
static_assert(alignof(GeometryCacheComponent_SetPlaybackSpeed) == 0x00B95A, "Wrong alignment on GeometryCacheComponent_SetPlaybackSpeed");
static_assert(sizeof(GeometryCacheComponent_SetPlaybackSpeed) == 0x00B95A, "Wrong size on GeometryCacheComponent_SetPlaybackSpeed");
...
struct alignas(0x624) GeometryCacheComponent_SetStartTimeOffset final
{
public:
...
static_assert(alignof(GeometryCacheComponent_SetStartTimeOffset) == 0x000624, "Wrong alignment on GeometryCacheComponent_SetStartTimeOffset");
static_assert(sizeof(GeometryCacheComponent_SetStartTimeOffset) == 0x000624, "Wrong size on GeometryCacheComponent_SetStartTimeOffset");
...
// 0xB953 (0xB953 - 0x0000)
struct alignas(0xB953) GeometryCacheComponent_GetPlaybackSpeed final
{
public:
	float                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(GeometryCacheComponent_GetPlaybackSpeed) == 0x00B953, "Wrong alignment on GeometryCacheComponent_GetPlaybackSpeed");
static_assert(sizeof(GeometryCacheComponent_GetPlaybackSpeed) == 0x00B953, "Wrong size on GeometryCacheComponent_GetPlaybackSpeed");
...
struct alignas(0xB954) GeometryCacheComponent_GetStartTimeOffset final
{
public:
	float                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(GeometryCacheComponent_GetStartTimeOffset) == 0x00B954, "Wrong alignment on GeometryCacheComponent_GetStartTimeOffset");
static_assert(sizeof(GeometryCacheComponent_GetStartTimeOffset) == 0x00B954, "Wrong size on GeometryCacheComponent_GetStartTimeOffset");
...
// 0x17515 (0x17515 - 0x0000)
struct alignas(0x17515) GeometryCacheTrack_FlipbookAnimation_AddMeshSample final
{
public:
	struct FGeometryCacheMeshData                 MeshData;                                          // 0x0000(0x6A07)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
static_assert(alignof(GeometryCacheTrack_FlipbookAnimation_AddMeshSample) == 0x017515, "Wrong alignment on GeometryCacheTrack_FlipbookAnimation_AddMeshSample");
static_assert(sizeof(GeometryCacheTrack_FlipbookAnimation_AddMeshSample) == 0x017515, "Wrong size on GeometryCacheTrack_FlipbookAnimation_AddMeshSample");
...
{
public:
	struct FGeometryCacheMeshData                 NewMeshData;                                       // 0x0000(0x6A07)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(GeometryCacheTrack_TransformAnimation_SetMesh) == 0x006A07, "Wrong alignment on GeometryCacheTrack_TransformAnimation_SetMesh");
static_assert(sizeof(GeometryCacheTrack_TransformAnimation_SetMesh) == 0x006A07, "Wrong size on GeometryCacheTrack_TransformAnimation_SetMesh");
...
static_assert(alignof(GeometryCacheTrack_TransformGroupAnimation_SetMesh) == 0x006A07, "Wrong alignment on GeometryCacheTrack_TransformGroupAnimation_SetMesh");
static_assert(sizeof(GeometryCacheTrack_TransformGroupAnimation_SetMesh) == 0x006A07, "Wrong size on GeometryCacheTrack_TransformGroupAnimation_SetMesh");
