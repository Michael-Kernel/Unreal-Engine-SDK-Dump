...
{
public:
	struct FTransform                             CurrentTransform;                                  // 0x0000(0x112E9D50)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FTransform                             ReturnValue;                                       // 0x0060(0x112E9D50)(Parm, OutParm, ReturnParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(KismetAnimationLibrary_K2_LookAt) == 0x000004, "Wrong alignment on KismetAnimationLibrary_K2_LookAt");
...
// 0x112AE (0x112AE - 0x0000)
struct alignas(0x112AE) KismetAnimationLibrary_K2_TwoBoneIK final
{
public:
...
static_assert(alignof(KismetAnimationLibrary_K2_TwoBoneIK) == 0x0112AE, "Wrong alignment on KismetAnimationLibrary_K2_TwoBoneIK");
static_assert(sizeof(KismetAnimationLibrary_K2_TwoBoneIK) == 0x0112AE, "Wrong size on KismetAnimationLibrary_K2_TwoBoneIK");
...
{
public:
	class UAnimationAsset*                        Montage;                                           // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(PlayMontageCallbackProxy_OnNotifyBeginReceived) == 0x000004, "Wrong alignment on PlayMontageCallbackProxy_OnNotifyBeginReceived");
...
static_assert(alignof(PlayMontageCallbackProxy_OnNotifyEndReceived) == 0x000004, "Wrong alignment on PlayMontageCallbackProxy_OnNotifyEndReceived");
