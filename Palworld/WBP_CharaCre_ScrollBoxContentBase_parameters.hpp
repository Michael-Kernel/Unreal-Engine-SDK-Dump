...
static_assert(offsetof(WBP_CharaCre_ScrollBoxContentBase_C_OnClosedSelectColorWindow_Internal, Param_0) == 0x000000, "Member 'WBP_CharaCre_ScrollBoxContentBase_C_OnClosedSelectColorWindow_Internal::Param_0' has a wrong offset!");
