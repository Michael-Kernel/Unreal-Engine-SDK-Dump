...
{
public:
	struct FSlateFontInfo                         Typeface;                                          // 0x0030(0x0060)(Edit, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCommonStyleSheetTypeFontTypeface) == 0x000090, "Wrong size on UCommonStyleSheetTypeFontTypeface");
...
static_assert(sizeof(UCommonActivatableWidget) == 0x0003C8, "Wrong size on UCommonActivatableWidget");
...
static_assert(offsetof(UCommonActivatableWidget, ActionDomainOverride) == 0x0002A8, "Member 'UCommonActivatableWidget::ActionDomainOverride' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, BP_OnWidgetActivated) == 0x0002D8, "Member 'UCommonActivatableWidget::BP_OnWidgetActivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, BP_OnWidgetDeactivated) == 0x0002E8, "Member 'UCommonActivatableWidget::BP_OnWidgetDeactivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, bIsActive) == 0x0002F8, "Member 'UCommonActivatableWidget::bIsActive' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, VisibilityBoundWidgets) == 0x000300, "Member 'UCommonActivatableWidget::VisibilityBoundWidgets' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, bSetVisibilityOnActivated) == 0x0003C0, "Member 'UCommonActivatableWidget::bSetVisibilityOnActivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, ActivatedVisibility) == 0x0003C1, "Member 'UCommonActivatableWidget::ActivatedVisibility' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, bSetVisibilityOnDeactivated) == 0x0003C2, "Member 'UCommonActivatableWidget::bSetVisibilityOnDeactivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatableWidget, DeactivatedVisibility) == 0x0003C3, "Member 'UCommonActivatableWidget::DeactivatedVisibility' has a wrong offset!");
...
static_assert(offsetof(UCommonButtonBase, OnSelectedChangedBase) == 0x000378, "Member 'UCommonButtonBase::OnSelectedChangedBase' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, OnButtonBaseClicked) == 0x000388, "Member 'UCommonButtonBase::OnButtonBaseClicked' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, OnButtonBaseDoubleClicked) == 0x000398, "Member 'UCommonButtonBase::OnButtonBaseDoubleClicked' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, OnButtonBaseHovered) == 0x0003A8, "Member 'UCommonButtonBase::OnButtonBaseHovered' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, OnButtonBaseUnhovered) == 0x0003B8, "Member 'UCommonButtonBase::OnButtonBaseUnhovered' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, bIsPersistentBinding) == 0x0003CC, "Member 'UCommonButtonBase::bIsPersistentBinding' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, InputModeOverride) == 0x0003CD, "Member 'UCommonButtonBase::InputModeOverride' has a wrong offset!");
static_assert(offsetof(UCommonButtonBase, SingleMaterialStyleMID) == 0x000400, "Member 'UCommonButtonBase::SingleMaterialStyleMID' has a wrong offset!");
...
static_assert(sizeof(UCommonRichTextBlock) == 0x0008D0, "Wrong size on UCommonRichTextBlock");
static_assert(offsetof(UCommonRichTextBlock, InlineIconDisplayMode) == 0x000890, "Member 'UCommonRichTextBlock::InlineIconDisplayMode' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, bTintInlineIcon) == 0x000891, "Member 'UCommonRichTextBlock::bTintInlineIcon' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, DefaultTextStyleOverrideClass) == 0x000898, "Member 'UCommonRichTextBlock::DefaultTextStyleOverrideClass' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, MobileTextBlockScale) == 0x0008A0, "Member 'UCommonRichTextBlock::MobileTextBlockScale' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, ScrollStyle) == 0x0008A8, "Member 'UCommonRichTextBlock::ScrollStyle' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, bIsScrollingEnabled) == 0x0008B0, "Member 'UCommonRichTextBlock::bIsScrollingEnabled' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, bDisplayAllCaps) == 0x0008B1, "Member 'UCommonRichTextBlock::bDisplayAllCaps' has a wrong offset!");
static_assert(offsetof(UCommonRichTextBlock, bAutoCollapseWithEmptyText) == 0x0008B2, "Member 'UCommonRichTextBlock::bAutoCollapseWithEmptyText' has a wrong offset!");
...
static_assert(sizeof(UCommonTabListWidgetBase) == 0x000388, "Wrong size on UCommonTabListWidgetBase");
...
static_assert(offsetof(UCommonTabListWidgetBase, bAutoListenForInput) == 0x000300, "Member 'UCommonTabListWidgetBase::bAutoListenForInput' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidgetBase, bDeferRebuildingTabList) == 0x000301, "Member 'UCommonTabListWidgetBase::bDeferRebuildingTabList' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidgetBase, LinkedSwitcher) == 0x000304, "Member 'UCommonTabListWidgetBase::LinkedSwitcher' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidgetBase, TabButtonGroup) == 0x000310, "Member 'UCommonTabListWidgetBase::TabButtonGroup' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidgetBase, RegisteredTabsByID) == 0x000320, "Member 'UCommonTabListWidgetBase::RegisteredTabsByID' has a wrong offset!");
