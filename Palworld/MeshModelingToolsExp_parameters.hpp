...
static_assert(alignof(BakeRenderCaptureToolProperties_GetMapPreviewNamesFunc) == 0x000008, "Wrong alignment on BakeRenderCaptureToolProperties_GetMapPreviewNamesFunc");
static_assert(sizeof(BakeRenderCaptureToolProperties_GetMapPreviewNamesFunc) == 0x000010, "Wrong size on BakeRenderCaptureToolProperties_GetMapPreviewNamesFunc");
static_assert(offsetof(BakeRenderCaptureToolProperties_GetMapPreviewNamesFunc, ReturnValue) == 0x000000, "Member 'BakeRenderCaptureToolProperties_GetMapPreviewNamesFunc::ReturnValue' has a wrong offset!");
...
static_assert(alignof(BakeRenderCaptureInputToolProperties_GetTargetUVLayerIndex) == 0x000004, "Wrong alignment on BakeRenderCaptureInputToolProperties_GetTargetUVLayerIndex");
static_assert(sizeof(BakeRenderCaptureInputToolProperties_GetTargetUVLayerIndex) == 0x000004, "Wrong size on BakeRenderCaptureInputToolProperties_GetTargetUVLayerIndex");
static_assert(offsetof(BakeRenderCaptureInputToolProperties_GetTargetUVLayerIndex, ReturnValue) == 0x000000, "Member 'BakeRenderCaptureInputToolProperties_GetTargetUVLayerIndex::ReturnValue' has a wrong offset!");
...
static_assert(alignof(BakeRenderCaptureInputToolProperties_GetTargetUVLayerNamesFunc) == 0x000008, "Wrong alignment on BakeRenderCaptureInputToolProperties_GetTargetUVLayerNamesFunc");
static_assert(sizeof(BakeRenderCaptureInputToolProperties_GetTargetUVLayerNamesFunc) == 0x000010, "Wrong size on BakeRenderCaptureInputToolProperties_GetTargetUVLayerNamesFunc");
static_assert(offsetof(BakeRenderCaptureInputToolProperties_GetTargetUVLayerNamesFunc, ReturnValue) == 0x000000, "Member 'BakeRenderCaptureInputToolProperties_GetTargetUVLayerNamesFunc::ReturnValue' has a wrong offset!");
