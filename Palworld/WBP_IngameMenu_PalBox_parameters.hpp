...
public:
	...
	class UPalPlayerDataPalStorage*               CallFunc_GetPalStorage_ReturnValue;                // 0x0018(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetPageNum_ReturnValue;                   // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_IngameMenu_PalBox_PageControl_C*   CallFunc_Create_ReturnValue;                       // 0x0040(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SetStepSize_InValue_ImplicitCast;         // 0x0060(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_IngameMenu_PalBox_C_CreatePageControlWidget) == 0x000068, "Wrong size on WBP_IngameMenu_PalBox_C_CreatePageControlWidget");
...
static_assert(offsetof(WBP_IngameMenu_PalBox_C_CreatePageControlWidget, Temp_int_Variable) == 0x000010, "Member 'WBP_IngameMenu_PalBox_C_CreatePageControlWidget::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_CreatePageControlWidget, CallFunc_GetPalStorage_ReturnValue) == 0x000018, "Member 'WBP_IngameMenu_PalBox_C_CreatePageControlWidget::CallFunc_GetPalStorage_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_CreatePageControlWidget, CallFunc_GetPageNum_ReturnValue) == 0x000020, "Member 'WBP_IngameMenu_PalBox_C_CreatePageControlWidget::CallFunc_GetPageNum_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_IngameMenu_PalBox_C_CreatePageControlWidget, CallFunc_Subtract_IntInt_ReturnValue) == 0x000028, "Member 'WBP_IngameMenu_PalBox_C_CreatePageControlWidget::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_CreatePageControlWidget, CallFunc_LessEqual_IntInt_ReturnValue) == 0x00002C, "Member 'WBP_IngameMenu_PalBox_C_CreatePageControlWidget::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_CreatePageControlWidget, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000030, "Member 'WBP_IngameMenu_PalBox_C_CreatePageControlWidget::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_CreatePageControlWidget, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000038, "Member 'WBP_IngameMenu_PalBox_C_CreatePageControlWidget::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_CreatePageControlWidget, CallFunc_Create_ReturnValue) == 0x000040, "Member 'WBP_IngameMenu_PalBox_C_CreatePageControlWidget::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_CreatePageControlWidget, CallFunc_AddChildToHorizontalBox_ReturnValue) == 0x000048, "Member 'WBP_IngameMenu_PalBox_C_CreatePageControlWidget::CallFunc_AddChildToHorizontalBox_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_CreatePageControlWidget, CallFunc_Array_Add_ReturnValue) == 0x000050, "Member 'WBP_IngameMenu_PalBox_C_CreatePageControlWidget::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_CreatePageControlWidget, CallFunc_Divide_DoubleDouble_B_ImplicitCast) == 0x000058, "Member 'WBP_IngameMenu_PalBox_C_CreatePageControlWidget::CallFunc_Divide_DoubleDouble_B_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_CreatePageControlWidget, CallFunc_SetStepSize_InValue_ImplicitCast) == 0x000060, "Member 'WBP_IngameMenu_PalBox_C_CreatePageControlWidget::CallFunc_SetStepSize_InValue_ImplicitCast' has a wrong offset!");
...
public:
	...
	class UPalIndividualCharacterSlot*            K2Node_CustomEvent_targetSlot;                     // 0x0028(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TArray<class UWBP_IngameMenu_PalBox_PalList_C*> K2Node_MakeArray_Array;                            // 0x0030(0x0010)(ReferenceParm, ContainsInstancedReference)
	class UWBP_PalCharacterSlotButtonBase_C*      K2Node_ComponentBoundEvent_createdSlot_1;          // 0x0040(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_PalCommonCharacterSlotButton_C*    K2Node_DynamicCast_AsWBP_Pal_Common_Character_Slot_Button_1; // 0x0060(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_PalCharacterSlotButtonBase_C*      K2Node_ComponentBoundEvent_Widget_6;               // 0x0080(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	EPalItemSlotPressType                         K2Node_ComponentBoundEvent_pressType;              // 0x0088(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_89[0x7];                                       // 0x0089(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalIndividualCharacterSlot*            CallFunc_GetTargetSlot_targetSlot;                 // 0x0090(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalIndividualCharacterSlot*            CallFunc_GetTargetSlot_targetSlot_1;               // 0x0098(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalIndividualCharacterSlot*            CallFunc_GetTargetSlot_targetSlot_2;               // 0x00B0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UWBP_PalCharacterSlotButtonBase_C*      K2Node_ComponentBoundEvent_Widget_4;               // 0x00B8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UPalIndividualCharacterSlot*            CallFunc_GetTargetSlot_targetSlot_3;               // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_PalCharacterSlotButtonBase_C*      K2Node_ComponentBoundEvent_Widget_2;               // 0x00E0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWBP_PalCharacterSlotButtonBase_C*      K2Node_ComponentBoundEvent_Widget_1;               // 0x00E8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWBP_PalCharacterSlotButtonBase_C*      K2Node_ComponentBoundEvent_Widget;                 // 0x00F0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UPalIndividualCharacterSlot*            CallFunc_GetTargetSlot_targetSlot_4;               // 0x00F8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalIndividualCharacterSlot*            CallFunc_GetTargetSlot_targetSlot_5;               // 0x0100(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UWBP_IngameMenu_PalBox_PageControl_C*   CallFunc_Array_Get_Item;                           // 0x0108(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class UPalIndividualCharacterSlot* Slot)> K2Node_CreateDelegate_OutputDelegate_1;            // 0x0120(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UPalIndividualCharacterSlot* TargetSlot)> K2Node_CreateDelegate_OutputDelegate_2;            // 0x0130(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalHUDService*                         CallFunc_GetHUDService_ReturnValue;                // 0x0140(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalPlayerDataStorage*                  CallFunc_GetPlayerDataStorage_ReturnValue;         // 0x0148(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                  CallFunc_Push_ReturnValue;                         // 0x0150(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPalPlayerDataPalStorage*               CallFunc_GetPalStorage_ReturnValue;                // 0x0160(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                         Temp_int_Array_Index_Variable_1;                   // 0x0168(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetPageNum_ReturnValue;                   // 0x016C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_IngameMenu_PalBox_PalList_C*       CallFunc_Array_Get_Item_1;                         // 0x0190(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox) == 0x0001A8, "Wrong size on WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox");
...
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_GetValue_ReturnValue) == 0x000004, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_GetValue_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, Temp_int_Loop_Counter_Variable) == 0x000008, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Add_IntInt_ReturnValue) == 0x00000C, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, Temp_int_Array_Index_Variable) == 0x000010, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_PlayAnimation_ReturnValue) == 0x000018, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_PlayAnimation_ReturnValue_1) == 0x000020, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_CustomEvent_targetSlot) == 0x000028, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_CustomEvent_targetSlot' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_MakeArray_Array) == 0x000030, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_ComponentBoundEvent_createdSlot_1) == 0x000040, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_ComponentBoundEvent_createdSlot_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_ComponentBoundEvent_createdSlot) == 0x000048, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_ComponentBoundEvent_createdSlot' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_DynamicCast_AsWBP_Pal_Common_Character_Slot_Button) == 0x000050, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_DynamicCast_AsWBP_Pal_Common_Character_Slot_Button' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_DynamicCast_bSuccess) == 0x000058, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_DynamicCast_AsWBP_Pal_Common_Character_Slot_Button_1) == 0x000060, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_DynamicCast_AsWBP_Pal_Common_Character_Slot_Button_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_DynamicCast_bSuccess_1) == 0x000068, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_ComponentBoundEvent_Widget_7) == 0x000070, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_ComponentBoundEvent_Widget_7' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_ComponentBoundEvent_pressType_1) == 0x000078, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_ComponentBoundEvent_pressType_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_ComponentBoundEvent_Widget_6) == 0x000080, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_ComponentBoundEvent_Widget_6' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_ComponentBoundEvent_pressType) == 0x000088, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_ComponentBoundEvent_pressType' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_GetTargetSlot_targetSlot) == 0x000090, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_GetTargetSlot_targetSlot' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_GetTargetSlot_targetSlot_1) == 0x000098, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_GetTargetSlot_targetSlot_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_CustomEvent_Slot) == 0x0000A0, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_CustomEvent_Slot' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_ComponentBoundEvent_Widget_5) == 0x0000A8, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_ComponentBoundEvent_Widget_5' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_GetTargetSlot_targetSlot_2) == 0x0000B0, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_GetTargetSlot_targetSlot_2' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_ComponentBoundEvent_Widget_4) == 0x0000B8, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_ComponentBoundEvent_Widget_4' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_GetTargetSlot_targetSlot_3) == 0x0000C0, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_GetTargetSlot_targetSlot_3' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_CreateDelegate_OutputDelegate) == 0x0000C8, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_ComponentBoundEvent_Widget_3) == 0x0000D8, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_ComponentBoundEvent_Widget_3' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_ComponentBoundEvent_Widget_2) == 0x0000E0, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_ComponentBoundEvent_Widget_2' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_ComponentBoundEvent_Widget_1) == 0x0000E8, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_ComponentBoundEvent_Widget_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_ComponentBoundEvent_Widget) == 0x0000F0, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_ComponentBoundEvent_Widget' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_GetTargetSlot_targetSlot_4) == 0x0000F8, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_GetTargetSlot_targetSlot_4' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_GetTargetSlot_targetSlot_5) == 0x000100, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_GetTargetSlot_targetSlot_5' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Array_Get_Item) == 0x000108, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Array_Length_ReturnValue) == 0x000110, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Less_IntInt_ReturnValue) == 0x000114, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, Temp_int_Loop_Counter_Variable_1) == 0x000118, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Add_IntInt_ReturnValue_1) == 0x00011C, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_CreateDelegate_OutputDelegate_1) == 0x000120, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, K2Node_CreateDelegate_OutputDelegate_2) == 0x000130, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_GetHUDService_ReturnValue) == 0x000140, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_GetHUDService_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_GetPlayerDataStorage_ReturnValue) == 0x000148, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_GetPlayerDataStorage_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Push_ReturnValue) == 0x000150, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Push_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_GetPalStorage_ReturnValue) == 0x000160, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_GetPalStorage_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, Temp_int_Array_Index_Variable_1) == 0x000168, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_GetPageNum_ReturnValue) == 0x00016C, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_GetPageNum_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Conv_IntToDouble_ReturnValue) == 0x000170, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Subtract_IntInt_ReturnValue) == 0x000178, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000180, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Round_ReturnValue) == 0x000188, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Round_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Min_ReturnValue) == 0x00018C, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Min_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Array_Get_Item_1) == 0x000190, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Array_Length_ReturnValue_1) == 0x000198, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Less_IntInt_ReturnValue_1) == 0x00019C, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox, CallFunc_Multiply_DoubleDouble_A_ImplicitCast) == 0x0001A0, "Member 'WBP_IngameMenu_PalBox_C_ExecuteUbergraph_WBP_IngameMenu_PalBox::CallFunc_Multiply_DoubleDouble_A_ImplicitCast' has a wrong offset!");
...
// Function WBP_IngameMenu_PalBox.WBP_IngameMenu_PalBox_C.OnSelectPalBoxPage__DelegateSignature
// 0x0004 (0x0004 - 0x0000)
struct WBP_IngameMenu_PalBox_C_OnSelectPalBoxPage__DelegateSignature final
{
public:
...
static_assert(alignof(WBP_IngameMenu_PalBox_C_OnSelectPalBoxPage__DelegateSignature) == 0x000004, "Wrong alignment on WBP_IngameMenu_PalBox_C_OnSelectPalBoxPage__DelegateSignature");
static_assert(sizeof(WBP_IngameMenu_PalBox_C_OnSelectPalBoxPage__DelegateSignature) == 0x000004, "Wrong size on WBP_IngameMenu_PalBox_C_OnSelectPalBoxPage__DelegateSignature");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_OnSelectPalBoxPage__DelegateSignature, Page) == 0x000000, "Member 'WBP_IngameMenu_PalBox_C_OnSelectPalBoxPage__DelegateSignature::Page' has a wrong offset!");

// Function WBP_IngameMenu_PalBox.WBP_IngameMenu_PalBox_C.Set Current Pal Box Page Num
// 0x00F0 (0x00F0 - 0x0000)
struct WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num final
{
public:
	...
	int32                                         CallFunc_GetPageNum_ReturnValue;                   // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_IngameMenu_PalBox_PageControl_C*   CallFunc_Array_Get_Item;                           // 0x00A8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class FText                                   CallFunc_GetLocalizedTextFromHandle_Text;          // 0x00B0(0x0018)()
	class FText                                   CallFunc_Format_ReturnValue;                       // 0x00C8(0x0018)()
	class UWBP_IngameMenu_PalBox_PageControl_C*   CallFunc_Array_Get_Item_1;                         // 0x00E0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num) == 0x000008, "Wrong alignment on WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num");
static_assert(sizeof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num) == 0x0000F0, "Wrong size on WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, PageNum) == 0x000000, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::PageNum' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_GetPlayerDataStorage_ReturnValue) == 0x000008, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_GetPlayerDataStorage_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_Conv_IntToDouble_ReturnValue) == 0x000010, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_GetPalStorage_ReturnValue) == 0x000018, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_GetPalStorage_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_Add_IntInt_ReturnValue) == 0x000020, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_GetPageNum_ReturnValue) == 0x000024, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_GetPageNum_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_Conv_IntToInt64_ReturnValue) == 0x000028, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_Conv_IntToInt64_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_Subtract_IntInt_ReturnValue) == 0x000030, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, K2Node_MakeStruct_FormatArgumentData) == 0x000038, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_Conv_IntToDouble_ReturnValue_1) == 0x000088, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_Conv_IntToDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, K2Node_MakeArray_Array) == 0x000090, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x0000A0, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_Array_Get_Item) == 0x0000A8, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_GetLocalizedTextFromHandle_Text) == 0x0000B0, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_GetLocalizedTextFromHandle_Text' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_Format_ReturnValue) == 0x0000C8, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_Array_Get_Item_1) == 0x0000E0, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num, CallFunc_SetValue_InValue_ImplicitCast) == 0x0000E8, "Member 'WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num::CallFunc_SetValue_InValue_ImplicitCast' has a wrong offset!");

// Function WBP_IngameMenu_PalBox.WBP_IngameMenu_PalBox_C.Set Pal Box List
// 0x0050 (0x0050 - 0x0000)
struct WBP_IngameMenu_PalBox_C_Set_Pal_Box_List final
{
public:
...
static_assert(alignof(WBP_IngameMenu_PalBox_C_Set_Pal_Box_List) == 0x000008, "Wrong alignment on WBP_IngameMenu_PalBox_C_Set_Pal_Box_List");
static_assert(sizeof(WBP_IngameMenu_PalBox_C_Set_Pal_Box_List) == 0x000050, "Wrong size on WBP_IngameMenu_PalBox_C_Set_Pal_Box_List");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Pal_Box_List, TargetSlots) == 0x000000, "Member 'WBP_IngameMenu_PalBox_C_Set_Pal_Box_List::TargetSlots' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Pal_Box_List, PageNum) == 0x000010, "Member 'WBP_IngameMenu_PalBox_C_Set_Pal_Box_List::PageNum' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Pal_Box_List, K2Node_CreateDelegate_OutputDelegate) == 0x000014, "Member 'WBP_IngameMenu_PalBox_C_Set_Pal_Box_List::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Pal_Box_List, Temp_int_Variable) == 0x000024, "Member 'WBP_IngameMenu_PalBox_C_Set_Pal_Box_List::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Pal_Box_List, CallFunc_Get_All_Children_widgets) == 0x000028, "Member 'WBP_IngameMenu_PalBox_C_Set_Pal_Box_List::CallFunc_Get_All_Children_widgets' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Pal_Box_List, CallFunc_Array_Get_Item) == 0x000038, "Member 'WBP_IngameMenu_PalBox_C_Set_Pal_Box_List::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Pal_Box_List, CallFunc_Array_Length_ReturnValue) == 0x000040, "Member 'WBP_IngameMenu_PalBox_C_Set_Pal_Box_List::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Pal_Box_List, CallFunc_Less_IntInt_ReturnValue) == 0x000044, "Member 'WBP_IngameMenu_PalBox_C_Set_Pal_Box_List::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Pal_Box_List, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000045, "Member 'WBP_IngameMenu_PalBox_C_Set_Pal_Box_List::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_C_Set_Pal_Box_List, CallFunc_Add_IntInt_ReturnValue) == 0x000048, "Member 'WBP_IngameMenu_PalBox_C_Set_Pal_Box_List::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
