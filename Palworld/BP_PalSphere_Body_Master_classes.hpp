...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_PalSphere_Body_Master_C;         // 0x0468(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(ABP_PalSphere_Body_Master_C) == 0x000470, "Wrong size on ABP_PalSphere_Body_Master_C");
static_assert(offsetof(ABP_PalSphere_Body_Master_C, UberGraphFrame_BP_PalSphere_Body_Master_C) == 0x000468, "Member 'ABP_PalSphere_Body_Master_C::UberGraphFrame_BP_PalSphere_Body_Master_C' has a wrong offset!");
