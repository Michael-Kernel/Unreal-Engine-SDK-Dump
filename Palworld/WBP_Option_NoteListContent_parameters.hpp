...
static_assert(offsetof(WBP_Option_NoteListContent_C_SetNoteList, Title_0) == 0x000000, "Member 'WBP_Option_NoteListContent_C_SetNoteList::Title_0' has a wrong offset!");
...
static_assert(offsetof(WBP_Option_NoteListContent_C_OnNoteListClicked__DelegateSignature, Title_0) == 0x000000, "Member 'WBP_Option_NoteListContent_C_OnNoteListClicked__DelegateSignature::Title_0' has a wrong offset!");
