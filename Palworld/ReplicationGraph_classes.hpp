...
public:
	...
	uint8                                         Pad_B8[0x4B8];                                     // 0x00B8(0x04B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNetReplicationGraphConnection) == 0x000380, "Wrong size on UNetReplicationGraphConnection");
...
static_assert(offsetof(UNetReplicationGraphConnection, DebugActor) == 0x000220, "Member 'UNetReplicationGraphConnection::DebugActor' has a wrong offset!");
static_assert(offsetof(UNetReplicationGraphConnection, LastGatherLocations) == 0x000230, "Member 'UNetReplicationGraphConnection::LastGatherLocations' has a wrong offset!");
static_assert(offsetof(UNetReplicationGraphConnection, ConnectionGraphNodes) == 0x000298, "Member 'UNetReplicationGraphConnection::ConnectionGraphNodes' has a wrong offset!");
static_assert(offsetof(UNetReplicationGraphConnection, TearOffNode) == 0x0002A8, "Member 'UNetReplicationGraphConnection::TearOffNode' has a wrong offset!");
...
static_assert(sizeof(AReplicationGraphDebugActor) == 0x0002A0, "Wrong size on AReplicationGraphDebugActor");
static_assert(offsetof(AReplicationGraphDebugActor, ReplicationGraph) == 0x000290, "Member 'AReplicationGraphDebugActor::ReplicationGraph' has a wrong offset!");
static_assert(offsetof(AReplicationGraphDebugActor, ConnectionManager) == 0x000298, "Member 'AReplicationGraphDebugActor::ConnectionManager' has a wrong offset!");
