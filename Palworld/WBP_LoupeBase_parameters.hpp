...
static_assert(offsetof(WBP_LoupeBase_C_GetLoupeWidgetSize, WidgetSize_0) == 0x000000, "Member 'WBP_LoupeBase_C_GetLoupeWidgetSize::WidgetSize_0' has a wrong offset!");
