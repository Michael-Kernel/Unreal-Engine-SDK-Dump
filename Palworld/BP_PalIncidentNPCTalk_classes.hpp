...
public:
	...
	void GetCharacterTalk(class FName CharacterID, bool* HasTalkData, class UDataTable** TalkData_0);
	void GetMultiTalk(class FName TalkId, bool* HasTalkData, class UDataTable** TalkData_0, class FString* TalkSequence_0);
