...
public:
	...
	struct FPalDataTableRowName_UIInputAction     ToggleEquipDisplayInputAction;                     // 0x06D8(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FPalDataTableRowName_UIInputAction     PlaySampleVoiceInInputAction;                      // 0x06E0(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FPalUIActionBindData                   PlaySampleVoiceActionHandle;                       // 0x06E8(0x0004)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	bool                                          IsCachingMakeData;                                 // 0x06EC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_6ED[0x3];                                      // 0x06ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UBP_PalPlayerDataCharacterMake_C*       CharacterMakeData;                                 // 0x06F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class FName                                   FlagName;                                          // 0x06F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          NowDisplayEquip;                                   // 0x0700(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_CharacterMake_C) == 0x000708, "Wrong size on UWBP_CharacterMake_C");
...
static_assert(offsetof(UWBP_CharacterMake_C, ToggleEquipDisplayInputAction) == 0x0006D8, "Member 'UWBP_CharacterMake_C::ToggleEquipDisplayInputAction' has a wrong offset!");
static_assert(offsetof(UWBP_CharacterMake_C, PlaySampleVoiceInInputAction) == 0x0006E0, "Member 'UWBP_CharacterMake_C::PlaySampleVoiceInInputAction' has a wrong offset!");
static_assert(offsetof(UWBP_CharacterMake_C, PlaySampleVoiceActionHandle) == 0x0006E8, "Member 'UWBP_CharacterMake_C::PlaySampleVoiceActionHandle' has a wrong offset!");
static_assert(offsetof(UWBP_CharacterMake_C, IsCachingMakeData) == 0x0006EC, "Member 'UWBP_CharacterMake_C::IsCachingMakeData' has a wrong offset!");
static_assert(offsetof(UWBP_CharacterMake_C, CharacterMakeData) == 0x0006F0, "Member 'UWBP_CharacterMake_C::CharacterMakeData' has a wrong offset!");
static_assert(offsetof(UWBP_CharacterMake_C, FlagName) == 0x0006F8, "Member 'UWBP_CharacterMake_C::FlagName' has a wrong offset!");
static_assert(offsetof(UWBP_CharacterMake_C, NowDisplayEquip) == 0x000700, "Member 'UWBP_CharacterMake_C::NowDisplayEquip' has a wrong offset!");
