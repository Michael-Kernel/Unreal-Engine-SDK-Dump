...
public:
	...
	struct FPalIndividualCharacterSaveParameter   CallFunc_GetInitializedCharacterSaveParemter_outParameter; // 0x0070(0x02A8)()
	bool                                          CallFunc_GetInitializedCharacterSaveParemter_ReturnValue; // 0x0318(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_GetIsPal_ReturnValue;                     // 0x0338(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_339[0x7];                                      // 0x0339(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalCharacterManager*                   CallFunc_GetCharacterManager_ReturnValue;          // 0x0340(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APlayerController*                      CallFunc_GetLocalPlayerController_ReturnValue;     // 0x0348(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FNetworkActorSpawnParameters           K2Node_MakeStruct_NetworkActorSpawnParameters;     // 0x0350(0x0070)(NoDestructor)
	class UPalIndividualCharacterHandle*          CallFunc_SpawnNewCharacter_ReturnValue;            // 0x03C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_PalIncidentInvaderBase_C_SpawnMemberCharacters) == 0x0003D0, "Wrong size on BP_PalIncidentInvaderBase_C_SpawnMemberCharacters");
...
static_assert(offsetof(BP_PalIncidentInvaderBase_C_SpawnMemberCharacters, CallFunc_GetInitializedCharacterSaveParemter_ReturnValue) == 0x000318, "Member 'BP_PalIncidentInvaderBase_C_SpawnMemberCharacters::CallFunc_GetInitializedCharacterSaveParemter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalIncidentInvaderBase_C_SpawnMemberCharacters, CallFunc_GetDatabaseCharacterParameter_ReturnValue) == 0x000320, "Member 'BP_PalIncidentInvaderBase_C_SpawnMemberCharacters::CallFunc_GetDatabaseCharacterParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalIncidentInvaderBase_C_SpawnMemberCharacters, K2Node_CreateDelegate_OutputDelegate) == 0x000328, "Member 'BP_PalIncidentInvaderBase_C_SpawnMemberCharacters::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_PalIncidentInvaderBase_C_SpawnMemberCharacters, CallFunc_GetIsPal_ReturnValue) == 0x000338, "Member 'BP_PalIncidentInvaderBase_C_SpawnMemberCharacters::CallFunc_GetIsPal_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalIncidentInvaderBase_C_SpawnMemberCharacters, CallFunc_GetCharacterManager_ReturnValue) == 0x000340, "Member 'BP_PalIncidentInvaderBase_C_SpawnMemberCharacters::CallFunc_GetCharacterManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalIncidentInvaderBase_C_SpawnMemberCharacters, CallFunc_GetLocalPlayerController_ReturnValue) == 0x000348, "Member 'BP_PalIncidentInvaderBase_C_SpawnMemberCharacters::CallFunc_GetLocalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalIncidentInvaderBase_C_SpawnMemberCharacters, K2Node_MakeStruct_NetworkActorSpawnParameters) == 0x000350, "Member 'BP_PalIncidentInvaderBase_C_SpawnMemberCharacters::K2Node_MakeStruct_NetworkActorSpawnParameters' has a wrong offset!");
static_assert(offsetof(BP_PalIncidentInvaderBase_C_SpawnMemberCharacters, CallFunc_SpawnNewCharacter_ReturnValue) == 0x0003C0, "Member 'BP_PalIncidentInvaderBase_C_SpawnMemberCharacters::CallFunc_SpawnNewCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalIncidentInvaderBase_C_SpawnMemberCharacters, CallFunc_Array_Add_ReturnValue) == 0x0003C8, "Member 'BP_PalIncidentInvaderBase_C_SpawnMemberCharacters::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
