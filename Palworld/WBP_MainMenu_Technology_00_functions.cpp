...
class UWidget* UWBP_MainMenu_Technology_00_C::CustomNavi_Down(EUINavigation Navigation_0)
{
	static class UFunction* Func = nullptr;
...
void UWBP_MainMenu_Technology_00_C::GetLocalPlayerLevelTechnologyFocusTarget(class UWidget** TargetWidget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_MainMenu_Technology_00_C", "GetLocalPlayerLevelTechnologyFocusTarget");

	Params::WBP_MainMenu_Technology_00_C_GetLocalPlayerLevelTechnologyFocusTarget Parms{};
