...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure, Const)
// Parameters:
// class APalCharacter*                    Trainer_0                                              (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UBP_AIAction_FunnelFollow_C::TryGetTrainer(class APalCharacter** Trainer_0) const
{
	static class UFunction* Func = nullptr;
	...
	if (Trainer_0 != nullptr)
		*Trainer_0 = Parms.Trainer_0;
}
