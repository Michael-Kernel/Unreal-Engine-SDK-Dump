...
// Function BP_AIAction_Visitor_ReturnSpawnedPoint.BP_AIAction_Visitor_ReturnSpawnedPoint_C.«¹¿à¤ÙóÈ
// 0x0008 (0x0008 - 0x0000)
struct BP_AIAction_Visitor_ReturnSpawnedPoint_C_________ final
{
public:
...
static_assert(alignof(BP_AIAction_Visitor_ReturnSpawnedPoint_C_________) == 0x000008, "Wrong alignment on BP_AIAction_Visitor_ReturnSpawnedPoint_C_________");
static_assert(sizeof(BP_AIAction_Visitor_ReturnSpawnedPoint_C_________) == 0x000008, "Wrong size on BP_AIAction_Visitor_ReturnSpawnedPoint_C_________");
static_assert(offsetof(BP_AIAction_Visitor_ReturnSpawnedPoint_C_________, VisualEffect) == 0x000000, "Member 'BP_AIAction_Visitor_ReturnSpawnedPoint_C_________::VisualEffect' has a wrong offset!");
