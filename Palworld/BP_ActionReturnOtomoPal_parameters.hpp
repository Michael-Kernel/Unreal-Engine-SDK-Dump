...
static_assert(alignof(BP_ActionReturnOtomoPal_C_CompleteDeactivateOtomo) == 0x000008, "Wrong alignment on BP_ActionReturnOtomoPal_C_CompleteDeactivateOtomo");
static_assert(sizeof(BP_ActionReturnOtomoPal_C_CompleteDeactivateOtomo) == 0x000020, "Wrong size on BP_ActionReturnOtomoPal_C_CompleteDeactivateOtomo");
static_assert(offsetof(BP_ActionReturnOtomoPal_C_CompleteDeactivateOtomo, CallFunc_GetActionCharacter_ReturnValue) == 0x000000, "Member 'BP_ActionReturnOtomoPal_C_CompleteDeactivateOtomo::CallFunc_GetActionCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ActionReturnOtomoPal_C_CompleteDeactivateOtomo, CallFunc_GetController_ReturnValue) == 0x000008, "Member 'BP_ActionReturnOtomoPal_C_CompleteDeactivateOtomo::CallFunc_GetController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ActionReturnOtomoPal_C_CompleteDeactivateOtomo, CallFunc_GetComponentByClass_ReturnValue) == 0x000010, "Member 'BP_ActionReturnOtomoPal_C_CompleteDeactivateOtomo::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ActionReturnOtomoPal_C_CompleteDeactivateOtomo, CallFunc_IsValid_ReturnValue) == 0x000018, "Member 'BP_ActionReturnOtomoPal_C_CompleteDeactivateOtomo::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
public:
	...
	class UPalIndividualCharacterHandle*          CallFunc_GetIndividualCharacterHandleByActor_ReturnValue; // 0x00B8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_ActionReturnOtomoPal_C_ExecuteUbergraph_BP_ActionReturnOtomoPal) == 0x0000C8, "Wrong size on BP_ActionReturnOtomoPal_C_ExecuteUbergraph_BP_ActionReturnOtomoPal");
...
static_assert(offsetof(BP_ActionReturnOtomoPal_C_ExecuteUbergraph_BP_ActionReturnOtomoPal, CallFunc_GetActionTarget_ReturnValue_1) == 0x0000B0, "Member 'BP_ActionReturnOtomoPal_C_ExecuteUbergraph_BP_ActionReturnOtomoPal::CallFunc_GetActionTarget_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ActionReturnOtomoPal_C_ExecuteUbergraph_BP_ActionReturnOtomoPal, CallFunc_GetIndividualCharacterHandleByActor_ReturnValue) == 0x0000B8, "Member 'BP_ActionReturnOtomoPal_C_ExecuteUbergraph_BP_ActionReturnOtomoPal::CallFunc_GetIndividualCharacterHandleByActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ActionReturnOtomoPal_C_ExecuteUbergraph_BP_ActionReturnOtomoPal, CallFunc_Delay_Duration_ImplicitCast) == 0x0000C0, "Member 'BP_ActionReturnOtomoPal_C_ExecuteUbergraph_BP_ActionReturnOtomoPal::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
