...
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_TecnologyList_C_SetInfo, Name_0) == 0x000000, "Member 'WBP_InventoryEquipment_ItemInfo_TecnologyList_C_SetInfo::Name_0' has a wrong offset!");
...
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_TecnologyList_C_SetInfo, Icon_0) == 0x000020, "Member 'WBP_InventoryEquipment_ItemInfo_TecnologyList_C_SetInfo::Icon_0' has a wrong offset!");
