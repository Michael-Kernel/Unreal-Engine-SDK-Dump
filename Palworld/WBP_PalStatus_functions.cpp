...
void UWBP_PalStatus_C::Get_Panel_Index_from_Handle(class UPalIndividualCharacterHandle* Handle, int32* Index_0, bool* IsValid)
{
	static class UFunction* Func = nullptr;
...
// Function WBP_PalStatus.WBP_PalStatus_C.ToggleFavoritePal_ByAction
// (Private, BlueprintCallable, BlueprintEvent)

void UWBP_PalStatus_C::ToggleFavoritePal_ByAction()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalStatus_C", "ToggleFavoritePal_ByAction");
