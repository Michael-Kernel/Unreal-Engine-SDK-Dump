...
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, CallFunc_IsDedicatedServer_ReturnValue) == 0x000090, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, CallFunc_K2_SetTimerDelegate_Time_ImplicitCast) == 0x000094, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::CallFunc_K2_SetTimerDelegate_Time_ImplicitCast' has a wrong offset!");
