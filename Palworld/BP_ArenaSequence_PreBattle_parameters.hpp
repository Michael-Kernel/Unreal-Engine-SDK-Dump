...
public:
	...
	class APalCharacter*                          CallFunc_GetIndividualActor_ReturnValue_2;         // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FPalArenaPlayerInfo                    CallFunc_Map_Find_Value;                           // 0x0108(0x0048)()
	...
	TArray<EPalArenaPlayerIndex>                  CallFunc_Map_Keys_Keys;                            // 0x0158(0x0010)(ReferenceParm)
	class APalCharacter*                          CallFunc_GetIndividualActor_ReturnValue_3;         // 0x0168(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	EPalArenaPlayerIndex                          CallFunc_Array_Get_Item;                           // 0x0170(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_NotEqual_ObjectObject_ReturnValue;        // 0x0185(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UBP_OtomoPalHolderComponent_C*          CallFunc_GetComponentByClass_ReturnValue;          // 0x0198(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FPalArenaPlayerInfo                    CallFunc_Map_Find_Value_1;                         // 0x01A8(0x0048)()
	...
	class APalCharacter*                          CallFunc_GetIndividualActor_ReturnValue_4;         // 0x01F8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPalArenaPlayerInfo                    CallFunc_Map_Find_Value_2;                         // 0x0200(0x0048)()
	...
	class UPalArenaInstanceModel*                 CallFunc_GetInstanceModel_ReturnValue;             // 0x0250(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalArenaLevelInstance*                 CallFunc_GetArenaLevelInstance_ReturnValue;        // 0x0258(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalIndividualCharacterParameter*       CallFunc_Array_Get_Item_1;                         // 0x0260(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_268[0x8];                                      // 0x0268(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalArenaBattleFormation               CallFunc_GetBattleFormation_ReturnValue;           // 0x0270(0x0070)()
	...
	bool                                          CallFunc_IsServer_ReturnValue;                     // 0x0390(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_391[0x7];                                      // 0x0391(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalArenaSequencer*                     CallFunc_GetOuterSequencer_ReturnValue;            // 0x0398(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TMap<EPalArenaPlayerIndex, struct FPalArenaPlayerInfo> CallFunc_GetArenaPlayerInfoMap_ReturnValue;        // 0x03A0(0x0050)(ConstParm)
};
...
static_assert(sizeof(BP_ArenaSequence_PreBattle_C_ActivatePals) == 0x0003F0, "Wrong size on BP_ArenaSequence_PreBattle_C_ActivatePals");
...
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_GetIndividualActor_ReturnValue_1) == 0x0000E0, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_GetIndividualActor_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_GetIndividualActor_ReturnValue_2) == 0x0000F0, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_GetIndividualActor_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_IsValid_ReturnValue) == 0x000100, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_Map_Find_Value) == 0x000108, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_Map_Find_ReturnValue) == 0x000150, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_Map_Keys_Keys) == 0x000158, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_Map_Keys_Keys' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_GetIndividualActor_ReturnValue_3) == 0x000168, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_GetIndividualActor_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_Array_Get_Item) == 0x000170, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_GetPalCharacterMovementComponent_ReturnValue) == 0x000178, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_GetPalCharacterMovementComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_Array_Length_ReturnValue) == 0x000180, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_Less_IntInt_ReturnValue) == 0x000184, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_NotEqual_ObjectObject_ReturnValue) == 0x000185, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_NotEqual_ObjectObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_GetPalCharacterMovementComponent_ReturnValue_1) == 0x000188, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_GetPalCharacterMovementComponent_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_GetComponentByClass_ReturnValue) == 0x000198, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_IsValid_ReturnValue_1) == 0x0001A0, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_Map_Find_Value_1) == 0x0001A8, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_Map_Find_Value_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_Map_Find_ReturnValue_1) == 0x0001F0, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_Map_Find_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_GetIndividualActor_ReturnValue_4) == 0x0001F8, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_GetIndividualActor_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_Map_Find_Value_2) == 0x000200, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_Map_Find_Value_2' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_Map_Find_ReturnValue_2) == 0x000248, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_Map_Find_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_GetInstanceModel_ReturnValue) == 0x000250, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_GetInstanceModel_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_GetArenaLevelInstance_ReturnValue) == 0x000258, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_GetArenaLevelInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_Array_Get_Item_1) == 0x000260, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_GetBattleFormation_ReturnValue) == 0x000270, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_GetBattleFormation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_Array_Length_ReturnValue_1) == 0x0002E0, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_Less_IntInt_ReturnValue_1) == 0x0002E4, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_BreakTransform_Location) == 0x0002E8, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_BreakTransform_Location' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_BreakTransform_Rotation) == 0x000300, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_BreakTransform_Rotation' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_BreakTransform_Scale) == 0x000318, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_BreakTransform_Scale' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_MakeTransform_ReturnValue) == 0x000330, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_IsServer_ReturnValue) == 0x000390, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_IsServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_GetOuterSequencer_ReturnValue) == 0x000398, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_GetOuterSequencer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_PreBattle_C_ActivatePals, CallFunc_GetArenaPlayerInfoMap_ReturnValue) == 0x0003A0, "Member 'BP_ArenaSequence_PreBattle_C_ActivatePals::CallFunc_GetArenaPlayerInfoMap_ReturnValue' has a wrong offset!");
