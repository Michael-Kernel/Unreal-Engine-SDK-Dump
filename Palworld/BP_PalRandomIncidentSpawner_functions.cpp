...
// struct FPalIncidentNotifyParameter      Parameter_0                                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)

void ABP_PalRandomIncidentSpawner_C::OnIncidentNotify(class UPalIncidentNotifyListener* Listener, EPalIncidentState IncidentState, const struct FPalIncidentNotifyParameter& Parameter_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Parameter_0 = std::move(Parameter_0);
...
// Parameters:
// class UPalIncidentBase*                 Incident                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UPalIncidentDynamicParameterRandom*Parameter_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_PalRandomIncidentSpawner_C::SetupIncident(class UPalIncidentBase* Incident, class UPalIncidentDynamicParameterRandom* Parameter_0)
{
	static class UFunction* Func = nullptr;
