...
// Function WBP_IngameMenu_PalBox.WBP_IngameMenu_PalBox_C.BndEvt__WBP_IngameMenu_PalBox_Slider_K2Node_ComponentBoundEvent_12_OnMouseCaptureEndEvent__DelegateSignature
// (BlueprintEvent)

void UWBP_IngameMenu_PalBox_C::BndEvt__WBP_IngameMenu_PalBox_Slider_K2Node_ComponentBoundEvent_12_OnMouseCaptureEndEvent__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IngameMenu_PalBox_C", "BndEvt__WBP_IngameMenu_PalBox_Slider_K2Node_ComponentBoundEvent_12_OnMouseCaptureEndEvent__DelegateSignature");
...
void UWBP_IngameMenu_PalBox_C::OnSelectPalBoxPage__DelegateSignature(int32 Page)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IngameMenu_PalBox_C", "OnSelectPalBoxPage__DelegateSignature");

	Params::WBP_IngameMenu_PalBox_C_OnSelectPalBoxPage__DelegateSignature Parms{};
...
void UWBP_IngameMenu_PalBox_C::Set_Current_Pal_Box_Page_Num(int32 PageNum)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IngameMenu_PalBox_C", "Set Current Pal Box Page Num");

	Params::WBP_IngameMenu_PalBox_C_Set_Current_Pal_Box_Page_Num Parms{};
...
void UWBP_IngameMenu_PalBox_C::Set_Pal_Box_List(TArray<class UPalIndividualCharacterSlot*>& TargetSlots, int32 PageNum)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IngameMenu_PalBox_C", "Set Pal Box List");

	Params::WBP_IngameMenu_PalBox_C_Set_Pal_Box_List Parms{};
