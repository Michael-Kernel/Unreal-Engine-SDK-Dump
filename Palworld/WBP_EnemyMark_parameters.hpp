...
struct WBP_EnemyMark_C__________0 final
{
public:
...
static_assert(alignof(WBP_EnemyMark_C__________0) == 0x000008, "Wrong alignment on WBP_EnemyMark_C__________0");
static_assert(sizeof(WBP_EnemyMark_C__________0) == 0x000008, "Wrong size on WBP_EnemyMark_C__________0");
static_assert(offsetof(WBP_EnemyMark_C__________0, TargetCharacter) == 0x000000, "Member 'WBP_EnemyMark_C__________0::TargetCharacter' has a wrong offset!");

// Function WBP_EnemyMark.WBP_EnemyMark_C.«¹¿à¤ÙóÈ_1
// 0x0008 (0x0008 - 0x0000)
struct WBP_EnemyMark_C__________1 final
{
public:
	class APalCharacter*                          TargetCharacter;                                   // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_EnemyMark_C__________1) == 0x000008, "Wrong alignment on WBP_EnemyMark_C__________1");
static_assert(sizeof(WBP_EnemyMark_C__________1) == 0x000008, "Wrong size on WBP_EnemyMark_C__________1");
static_assert(offsetof(WBP_EnemyMark_C__________1, TargetCharacter) == 0x000000, "Member 'WBP_EnemyMark_C__________1::TargetCharacter' has a wrong offset!");
