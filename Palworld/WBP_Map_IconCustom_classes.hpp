...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_WBP_Map_IconCustom_C;               // 0x0458(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_Map_IconCustom_C">();
	}
...
static_assert(alignof(UWBP_Map_IconCustom_C) == 0x000008, "Wrong alignment on UWBP_Map_IconCustom_C");
static_assert(sizeof(UWBP_Map_IconCustom_C) == 0x000470, "Wrong size on UWBP_Map_IconCustom_C");
static_assert(offsetof(UWBP_Map_IconCustom_C, UberGraphFrame_WBP_Map_IconCustom_C) == 0x000458, "Member 'UWBP_Map_IconCustom_C::UberGraphFrame_WBP_Map_IconCustom_C' has a wrong offset!");
static_assert(offsetof(UWBP_Map_IconCustom_C, Icon) == 0x000460, "Member 'UWBP_Map_IconCustom_C::Icon' has a wrong offset!");
static_assert(offsetof(UWBP_Map_IconCustom_C, WBP_PalCommonButton) == 0x000468, "Member 'UWBP_Map_IconCustom_C::WBP_PalCommonButton' has a wrong offset!");
