...
// 0x0008 (0x0008 - 0x0000)
struct WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalInvisibleButton_Sort_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature final
{
public:
	class UCommonButtonBase*                      Button;                                            // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalInvisibleButton_Sort_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature) == 0x000008, "Wrong alignment on WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalInvisibleButton_Sort_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature");
static_assert(sizeof(WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalInvisibleButton_Sort_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature) == 0x000008, "Wrong size on WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalInvisibleButton_Sort_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature");
static_assert(offsetof(WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalInvisibleButton_Sort_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature, Button) == 0x000000, "Member 'WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalInvisibleButton_Sort_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature::Button' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_4_OnHoveredSlot__DelegateSignature final
{
public:
	class UWBP_PalItemSlotButtonBase_C*           buttonBase;                                        // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_4_OnHoveredSlot__DelegateSignature) == 0x000008, "Wrong alignment on WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_4_OnHoveredSlot__DelegateSignature");
static_assert(sizeof(WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_4_OnHoveredSlot__DelegateSignature) == 0x000008, "Wrong size on WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_4_OnHoveredSlot__DelegateSignature");
static_assert(offsetof(WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_4_OnHoveredSlot__DelegateSignature, buttonBase) == 0x000000, "Member 'WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_4_OnHoveredSlot__DelegateSignature::buttonBase' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_5_OnEndHoveredSlot__DelegateSignature final
{
public:
	class UWBP_PalItemSlotButtonBase_C*           buttonBase;                                        // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_5_OnEndHoveredSlot__DelegateSignature) == 0x000008, "Wrong alignment on WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_5_OnEndHoveredSlot__DelegateSignature");
static_assert(sizeof(WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_5_OnEndHoveredSlot__DelegateSignature) == 0x000008, "Wrong size on WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_5_OnEndHoveredSlot__DelegateSignature");
static_assert(offsetof(WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_5_OnEndHoveredSlot__DelegateSignature, buttonBase) == 0x000000, "Member 'WBP_IngameMenu_Chest_C_BndEvt__WBP_IngameMenu_Chest_WBP_PalPlayerInventoryScrollList_K2Node_ComponentBoundEvent_5_OnEndHoveredSlot__DelegateSignature::buttonBase' has a wrong offset!");
...
public:
	...
	class UWBP_PalItemSlotButtonBase_C*           K2Node_ComponentBoundEvent_buttonBase;             // 0x0038(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_IngameMenu_Chest_C_ExecuteUbergraph_WBP_IngameMenu_Chest) == 0x000040, "Wrong size on WBP_IngameMenu_Chest_C_ExecuteUbergraph_WBP_IngameMenu_Chest");
...
static_assert(offsetof(WBP_IngameMenu_Chest_C_ExecuteUbergraph_WBP_IngameMenu_Chest, K2Node_ComponentBoundEvent_Button_2) == 0x000008, "Member 'WBP_IngameMenu_Chest_C_ExecuteUbergraph_WBP_IngameMenu_Chest::K2Node_ComponentBoundEvent_Button_2' has a wrong offset!");
...
static_assert(offsetof(WBP_IngameMenu_Chest_C_ExecuteUbergraph_WBP_IngameMenu_Chest, K2Node_ComponentBoundEvent_buttonBase_3) == 0x000020, "Member 'WBP_IngameMenu_Chest_C_ExecuteUbergraph_WBP_IngameMenu_Chest::K2Node_ComponentBoundEvent_buttonBase_3' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_Chest_C_ExecuteUbergraph_WBP_IngameMenu_Chest, K2Node_ComponentBoundEvent_buttonBase_2) == 0x000028, "Member 'WBP_IngameMenu_Chest_C_ExecuteUbergraph_WBP_IngameMenu_Chest::K2Node_ComponentBoundEvent_buttonBase_2' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_Chest_C_ExecuteUbergraph_WBP_IngameMenu_Chest, K2Node_ComponentBoundEvent_buttonBase_1) == 0x000030, "Member 'WBP_IngameMenu_Chest_C_ExecuteUbergraph_WBP_IngameMenu_Chest::K2Node_ComponentBoundEvent_buttonBase_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_Chest_C_ExecuteUbergraph_WBP_IngameMenu_Chest, K2Node_ComponentBoundEvent_buttonBase) == 0x000038, "Member 'WBP_IngameMenu_Chest_C_ExecuteUbergraph_WBP_IngameMenu_Chest::K2Node_ComponentBoundEvent_buttonBase' has a wrong offset!");

// Function WBP_IngameMenu_Chest.WBP_IngameMenu_Chest_C.FilteringInventoryByInventoryType
// 0x0018 (0x0018 - 0x0000)
struct WBP_IngameMenu_Chest_C_FilteringInventoryByInventoryType final
{
public:
...
static_assert(alignof(WBP_IngameMenu_Chest_C_FilteringInventoryByInventoryType) == 0x000008, "Wrong alignment on WBP_IngameMenu_Chest_C_FilteringInventoryByInventoryType");
static_assert(sizeof(WBP_IngameMenu_Chest_C_FilteringInventoryByInventoryType) == 0x000018, "Wrong size on WBP_IngameMenu_Chest_C_FilteringInventoryByInventoryType");
static_assert(offsetof(WBP_IngameMenu_Chest_C_FilteringInventoryByInventoryType, InventoryType) == 0x000000, "Member 'WBP_IngameMenu_Chest_C_FilteringInventoryByInventoryType::InventoryType' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_Chest_C_FilteringInventoryByInventoryType, CallFunc_FilteringFromInventoryType_IsEmptyDisplaySlot) == 0x000010, "Member 'WBP_IngameMenu_Chest_C_FilteringInventoryByInventoryType::CallFunc_FilteringFromInventoryType_IsEmptyDisplaySlot' has a wrong offset!");
...
static_assert(sizeof(WBP_IngameMenu_Chest_C_GetInventoryLastHoveredFocusTarget) == 0x000018, "Wrong size on WBP_IngameMenu_Chest_C_GetInventoryLastHoveredFocusTarget");
...
static_assert(offsetof(WBP_IngameMenu_Chest_C_GetInventoryLastHoveredFocusTarget, CallFunc_GetLastHoveredSlotButton_SlotButton) == 0x000008, "Member 'WBP_IngameMenu_Chest_C_GetInventoryLastHoveredFocusTarget::CallFunc_GetLastHoveredSlotButton_SlotButton' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_Chest_C_GetInventoryLastHoveredFocusTarget, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'WBP_IngameMenu_Chest_C_GetInventoryLastHoveredFocusTarget::CallFunc_IsValid_ReturnValue' has a wrong offset!");

// Function WBP_IngameMenu_Chest.WBP_IngameMenu_Chest_C.GetInventoryTopFocustTarget
// 0x0038 (0x0038 - 0x0000)
struct WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget final
{
public:
	...
	class UWBP_PalItemListBlock_C*                CallFunc_Map_Find_Value;                           // 0x0010(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget) == 0x000008, "Wrong alignment on WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget");
static_assert(sizeof(WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget) == 0x000038, "Wrong size on WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget");
static_assert(offsetof(WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget, FocusTarget) == 0x000000, "Member 'WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget::FocusTarget' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget, Temp_byte_Variable) == 0x000008, "Member 'WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget, CallFunc_Map_Find_Value) == 0x000010, "Member 'WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget, CallFunc_Map_Find_ReturnValue) == 0x000018, "Member 'WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget, CallFunc_GetAllItemSlotButtons_slotButtons) == 0x000020, "Member 'WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget::CallFunc_GetAllItemSlotButtons_slotButtons' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget, CallFunc_Array_Get_Item) == 0x000030, "Member 'WBP_IngameMenu_Chest_C_GetInventoryTopFocustTarget::CallFunc_Array_Get_Item' has a wrong offset!");
