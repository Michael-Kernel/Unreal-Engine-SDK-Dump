...
static_assert(sizeof(WBP_PickingGame_ForDisplay_C_StartForceFeedback) == 0x000030, "Wrong size on WBP_PickingGame_ForDisplay_C_StartForceFeedback");
static_assert(offsetof(WBP_PickingGame_ForDisplay_C_StartForceFeedback, CallFunc_GetOptionSubsystem_ReturnValue) == 0x000000, "Member 'WBP_PickingGame_ForDisplay_C_StartForceFeedback::CallFunc_GetOptionSubsystem_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_PickingGame_ForDisplay_C_StartForceFeedback, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'WBP_PickingGame_ForDisplay_C_StartForceFeedback::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PickingGame_ForDisplay_C_StartForceFeedback, CallFunc_GetPadSettings_ReturnValue) == 0x000014, "Member 'WBP_PickingGame_ForDisplay_C_StartForceFeedback::CallFunc_GetPadSettings_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WBP_PickingGame_ForDisplay_C_StopForceFeedback) == 0x000030, "Wrong size on WBP_PickingGame_ForDisplay_C_StopForceFeedback");
static_assert(offsetof(WBP_PickingGame_ForDisplay_C_StopForceFeedback, CallFunc_GetOptionSubsystem_ReturnValue) == 0x000000, "Member 'WBP_PickingGame_ForDisplay_C_StopForceFeedback::CallFunc_GetOptionSubsystem_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_PickingGame_ForDisplay_C_StopForceFeedback, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'WBP_PickingGame_ForDisplay_C_StopForceFeedback::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PickingGame_ForDisplay_C_StopForceFeedback, CallFunc_GetPadSettings_ReturnValue) == 0x000014, "Member 'WBP_PickingGame_ForDisplay_C_StopForceFeedback::CallFunc_GetPadSettings_ReturnValue' has a wrong offset!");
