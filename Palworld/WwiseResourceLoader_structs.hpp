...
{
public:
	float                                         AbsorptionLow;                                     // 0x0000(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AbsorptionMidLow;                                  // 0x0004(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AbsorptionMidHigh;                                 // 0x0008(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AbsorptionHigh;                                    // 0x000C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ShortId;                                           // 0x0010(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FWwiseAcousticTextureCookedData) == 0x00001C, "Wrong size on FWwiseAcousticTextureCookedData");
static_assert(offsetof(FWwiseAcousticTextureCookedData, AbsorptionLow) == 0x000000, "Member 'FWwiseAcousticTextureCookedData::AbsorptionLow' has a wrong offset!");
static_assert(offsetof(FWwiseAcousticTextureCookedData, AbsorptionMidLow) == 0x000004, "Member 'FWwiseAcousticTextureCookedData::AbsorptionMidLow' has a wrong offset!");
static_assert(offsetof(FWwiseAcousticTextureCookedData, AbsorptionMidHigh) == 0x000008, "Member 'FWwiseAcousticTextureCookedData::AbsorptionMidHigh' has a wrong offset!");
static_assert(offsetof(FWwiseAcousticTextureCookedData, AbsorptionHigh) == 0x00000C, "Member 'FWwiseAcousticTextureCookedData::AbsorptionHigh' has a wrong offset!");
