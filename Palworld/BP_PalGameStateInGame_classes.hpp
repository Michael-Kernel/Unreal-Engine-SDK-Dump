...
static_assert(sizeof(ABP_PalGameStateInGame_C) == 0x000470, "Wrong size on ABP_PalGameStateInGame_C");
static_assert(offsetof(ABP_PalGameStateInGame_C, DefaultSceneRoot) == 0x000468, "Member 'ABP_PalGameStateInGame_C::DefaultSceneRoot' has a wrong offset!");
