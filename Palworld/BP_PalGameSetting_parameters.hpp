...
public:
	...
	struct FPalOptionWorldSettings                CallFunc_GetOptionWorldSettings_ReturnValue;       // 0x0090(0x0160)(ConstParm)
	struct FFixedPoint64                          CallFunc_GetMaxHP_ReturnValue;                     // 0x01F0(0x0008)(NoDestructor)
	struct FFixedPoint64                          CallFunc_GetHP_ReturnValue;                        // 0x01F8(0x0008)(NoDestructor)
	struct FFixedPoint64                          CallFunc_Divide_FixedPoint64FixedPoint64_ReturnValue; // 0x0200(0x0008)(NoDestructor)
	int32                                         CallFunc_GetLevel_ReturnValue;                     // 0x0208(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Convert_FixedPoint64ToFloat_ReturnValue;  // 0x020C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                   CallFunc_StatusPointName_AddCaptureLevel_ReturnValue; // 0x0220(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UPalIndividualCharacterParameter*       CallFunc_TryGetIndividualParameter_ReturnValue;    // 0x0230(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_GetStatusPoint_ReturnValue;               // 0x023C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Conv_IntToDouble_ReturnValue_1;           // 0x0260(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_MultiplyMultiply_FloatFloat_ReturnValue_1; // 0x0290(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_MultiplyMultiply_FloatFloat_ReturnValue_2; // 0x0298(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_GreaterEqual_DoubleDouble_ReturnValue_1;  // 0x02F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_2F1[0x7];                                      // 0x02F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        CallFunc_MultiplyMultiply_FloatFloat_ReturnValue_3; // 0x02F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_Multiply_DoubleDouble_ReturnValue_7;      // 0x0300(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         K2Node_FunctionResult_ReturnValue_ImplicitCast_1;  // 0x030C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Multiply_DoubleDouble_B_ImplicitCast_1;   // 0x0328(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Multiply_DoubleDouble_A_ImplicitCast_2;   // 0x0340(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_PalGameSetting_C_CalcCaptureRate) == 0x000348, "Wrong size on BP_PalGameSetting_C_CalcCaptureRate");
...
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_GetMaxHP_ReturnValue) == 0x0001F0, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_GetMaxHP_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_GetHP_ReturnValue) == 0x0001F8, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_GetHP_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Divide_FixedPoint64FixedPoint64_ReturnValue) == 0x000200, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Divide_FixedPoint64FixedPoint64_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_GetLevel_ReturnValue) == 0x000208, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_GetLevel_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Convert_FixedPoint64ToFloat_ReturnValue) == 0x00020C, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Convert_FixedPoint64ToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_IsValid_ReturnValue_2) == 0x000210, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Multiply_DoubleDouble_ReturnValue_1) == 0x000218, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Multiply_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_StatusPointName_AddCaptureLevel_ReturnValue) == 0x000220, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_StatusPointName_AddCaptureLevel_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_IsValid_ReturnValue_3) == 0x000228, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_IsValid_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_TryGetIndividualParameter_ReturnValue) == 0x000230, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_TryGetIndividualParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_IsValid_ReturnValue_4) == 0x000238, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_IsValid_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_GetStatusPoint_ReturnValue) == 0x00023C, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_GetStatusPoint_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Conv_IntToDouble_ReturnValue) == 0x000240, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Multiply_DoubleDouble_ReturnValue_2) == 0x000248, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Multiply_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Multiply_DoubleDouble_ReturnValue_3) == 0x000250, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Multiply_DoubleDouble_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_FClamp_ReturnValue) == 0x000258, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_FClamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Conv_IntToDouble_ReturnValue_1) == 0x000260, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Conv_IntToDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_MultiplyMultiply_FloatFloat_ReturnValue) == 0x000268, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_MultiplyMultiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Add_IntInt_ReturnValue) == 0x000270, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Multiply_DoubleDouble_ReturnValue_4) == 0x000278, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Multiply_DoubleDouble_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Conv_IntToDouble_ReturnValue_2) == 0x000280, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Conv_IntToDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000288, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_MultiplyMultiply_FloatFloat_ReturnValue_1) == 0x000290, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_MultiplyMultiply_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_MultiplyMultiply_FloatFloat_ReturnValue_2) == 0x000298, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_MultiplyMultiply_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Multiply_DoubleDouble_ReturnValue_5) == 0x0002A0, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Multiply_DoubleDouble_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x0002A8, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Subtract_DoubleDouble_ReturnValue) == 0x0002B0, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Subtract_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_GreaterEqual_DoubleDouble_ReturnValue) == 0x0002B8, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_GreaterEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Conv_IntToFloat_ReturnValue) == 0x0002BC, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Add_DoubleDouble_ReturnValue_1) == 0x0002C0, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Add_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Subtract_DoubleDouble_ReturnValue_1) == 0x0002C8, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Subtract_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Multiply_DoubleDouble_ReturnValue_6) == 0x0002D0, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Multiply_DoubleDouble_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Add_DoubleDouble_ReturnValue_2) == 0x0002D8, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Add_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_LessEqual_DoubleDouble_ReturnValue) == 0x0002E0, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_LessEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Divide_DoubleDouble_ReturnValue_1) == 0x0002E8, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Divide_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_GreaterEqual_DoubleDouble_ReturnValue_1) == 0x0002F0, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_GreaterEqual_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_MultiplyMultiply_FloatFloat_ReturnValue_3) == 0x0002F8, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_MultiplyMultiply_FloatFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Multiply_DoubleDouble_ReturnValue_7) == 0x000300, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Multiply_DoubleDouble_ReturnValue_7' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, K2Node_FunctionResult_ReturnValue_ImplicitCast) == 0x000308, "Member 'BP_PalGameSetting_C_CalcCaptureRate::K2Node_FunctionResult_ReturnValue_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, K2Node_FunctionResult_ReturnValue_ImplicitCast_1) == 0x00030C, "Member 'BP_PalGameSetting_C_CalcCaptureRate::K2Node_FunctionResult_ReturnValue_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Multiply_DoubleDouble_A_ImplicitCast) == 0x000310, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Multiply_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Multiply_DoubleDouble_A_ImplicitCast_1) == 0x000318, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Multiply_DoubleDouble_A_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Multiply_DoubleDouble_B_ImplicitCast) == 0x000320, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Multiply_DoubleDouble_B_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Multiply_DoubleDouble_B_ImplicitCast_1) == 0x000328, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Multiply_DoubleDouble_B_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Add_DoubleDouble_A_ImplicitCast) == 0x000330, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Add_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Subtract_DoubleDouble_B_ImplicitCast) == 0x000338, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Subtract_DoubleDouble_B_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalGameSetting_C_CalcCaptureRate, CallFunc_Multiply_DoubleDouble_A_ImplicitCast_2) == 0x000340, "Member 'BP_PalGameSetting_C_CalcCaptureRate::CallFunc_Multiply_DoubleDouble_A_ImplicitCast_2' has a wrong offset!");
