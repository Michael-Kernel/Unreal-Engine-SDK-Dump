...
// 0x0008 (0x0008 - 0x0000)
struct BP_NPCCampPresetBase_C_________ final
{
public:
	class UPalIndividualCharacterHandle*          NewParam;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_NPCCampPresetBase_C_________) == 0x000008, "Wrong alignment on BP_NPCCampPresetBase_C_________");
static_assert(sizeof(BP_NPCCampPresetBase_C_________) == 0x000008, "Wrong size on BP_NPCCampPresetBase_C_________");
static_assert(offsetof(BP_NPCCampPresetBase_C_________, NewParam) == 0x000000, "Member 'BP_NPCCampPresetBase_C_________::NewParam' has a wrong offset!");
