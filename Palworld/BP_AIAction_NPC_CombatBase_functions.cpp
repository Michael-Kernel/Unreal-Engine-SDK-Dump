...
void UBP_AIAction_NPC_CombatBase_C::AddCombatState(class UClass* Class_0)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// bool                                    IsNearTarget_0                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_AIAction_NPC_CombatBase_C::MoveToTarget(bool* IsNearTarget_0)
{
	static class UFunction* Func = nullptr;
	...
	if (IsNearTarget_0 != nullptr)
		*IsNearTarget_0 = Parms.IsNearTarget_0;
}
