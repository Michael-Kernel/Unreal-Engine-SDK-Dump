...
static_assert(offsetof(WBP_OptionSettings_ListContentSwitch_C_Setup, IsOn_0) == 0x000000, "Member 'WBP_OptionSettings_ListContentSwitch_C_Setup::IsOn_0' has a wrong offset!");
...
static_assert(offsetof(WBP_OptionSettings_ListContentSwitch_C_OnSwitcherChanged__DelegateSignature, IsOn_0) == 0x000000, "Member 'WBP_OptionSettings_ListContentSwitch_C_OnSwitcherChanged__DelegateSignature::IsOn_0' has a wrong offset!");
...
static_assert(offsetof(WBP_OptionSettings_ListContentSwitch_C_IsOn, IsOn_0) == 0x000000, "Member 'WBP_OptionSettings_ListContentSwitch_C_IsOn::IsOn_0' has a wrong offset!");
