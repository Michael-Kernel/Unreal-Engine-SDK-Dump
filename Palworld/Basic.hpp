...
namespace Offsets
{
	constexpr int32 GObjects          = 0x089FFA00;
	constexpr int32 AppendString      = 0x02E66610;
	constexpr int32 GNames            = 0x08960300;
	constexpr int32 GWorld            = 0x08B6E1A8;
	constexpr int32 ProcessEvent      = 0x02FE92C0;
