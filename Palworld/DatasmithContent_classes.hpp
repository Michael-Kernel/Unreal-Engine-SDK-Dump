...
{
public:
	EComponentMobility                            Mobility;                                          // 0x0290(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDatasmithAreaLightActorType                  LightType;                                         // 0x0291(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDatasmithAreaLightActorShape                 LightShape;                                        // 0x0292(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_293[0x5];                                      // 0x0293(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              Dimensions;                                        // 0x0298(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	ELightUnits                                   IntensityUnits;                                    // 0x02AC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2AD[0x3];                                      // 0x02AD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           Color;                                             // 0x02B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Temperature;                                       // 0x02C0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C4[0x4];                                      // 0x02C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UTextureLightProfile*                   IESTexture;                                        // 0x02C8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseIESBrightness;                                 // 0x02D0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D1[0x3];                                      // 0x02D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         IESBrightnessScale;                                // 0x02D4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               Rotation;                                          // 0x02D8(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         SourceRadius;                                      // 0x02F0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SourceLength;                                      // 0x02F4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AttenuationRadius;                                 // 0x02F8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpotlightInnerAngle;                               // 0x02FC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpotlightOuterAngle;                               // 0x0300(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADatasmithAreaLightActor) == 0x000308, "Wrong size on ADatasmithAreaLightActor");
static_assert(offsetof(ADatasmithAreaLightActor, Mobility) == 0x000290, "Member 'ADatasmithAreaLightActor::Mobility' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, LightType) == 0x000291, "Member 'ADatasmithAreaLightActor::LightType' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, LightShape) == 0x000292, "Member 'ADatasmithAreaLightActor::LightShape' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Dimensions) == 0x000298, "Member 'ADatasmithAreaLightActor::Dimensions' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Intensity) == 0x0002A8, "Member 'ADatasmithAreaLightActor::Intensity' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, IntensityUnits) == 0x0002AC, "Member 'ADatasmithAreaLightActor::IntensityUnits' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Color) == 0x0002B0, "Member 'ADatasmithAreaLightActor::Color' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Temperature) == 0x0002C0, "Member 'ADatasmithAreaLightActor::Temperature' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, IESTexture) == 0x0002C8, "Member 'ADatasmithAreaLightActor::IESTexture' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, bUseIESBrightness) == 0x0002D0, "Member 'ADatasmithAreaLightActor::bUseIESBrightness' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, IESBrightnessScale) == 0x0002D4, "Member 'ADatasmithAreaLightActor::IESBrightnessScale' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Rotation) == 0x0002D8, "Member 'ADatasmithAreaLightActor::Rotation' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SourceRadius) == 0x0002F0, "Member 'ADatasmithAreaLightActor::SourceRadius' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SourceLength) == 0x0002F4, "Member 'ADatasmithAreaLightActor::SourceLength' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, AttenuationRadius) == 0x0002F8, "Member 'ADatasmithAreaLightActor::AttenuationRadius' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SpotlightInnerAngle) == 0x0002FC, "Member 'ADatasmithAreaLightActor::SpotlightInnerAngle' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SpotlightOuterAngle) == 0x000300, "Member 'ADatasmithAreaLightActor::SpotlightOuterAngle' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class UTextureLightProfile>    IESTexture;                                        // 0x0068(0x0030)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDatasmithAreaLightActorTemplate) == 0x0000C8, "Wrong size on UDatasmithAreaLightActorTemplate");
...
static_assert(offsetof(UDatasmithAreaLightActorTemplate, bUseIESBrightness) == 0x000098, "Member 'UDatasmithAreaLightActorTemplate::bUseIESBrightness' has a wrong offset!");
static_assert(offsetof(UDatasmithAreaLightActorTemplate, IESBrightnessScale) == 0x00009C, "Member 'UDatasmithAreaLightActorTemplate::IESBrightnessScale' has a wrong offset!");
static_assert(offsetof(UDatasmithAreaLightActorTemplate, Rotation) == 0x0000A0, "Member 'UDatasmithAreaLightActorTemplate::Rotation' has a wrong offset!");
static_assert(offsetof(UDatasmithAreaLightActorTemplate, SourceRadius) == 0x0000B8, "Member 'UDatasmithAreaLightActorTemplate::SourceRadius' has a wrong offset!");
static_assert(offsetof(UDatasmithAreaLightActorTemplate, SourceLength) == 0x0000BC, "Member 'UDatasmithAreaLightActorTemplate::SourceLength' has a wrong offset!");
static_assert(offsetof(UDatasmithAreaLightActorTemplate, AttenuationRadius) == 0x0000C0, "Member 'UDatasmithAreaLightActorTemplate::AttenuationRadius' has a wrong offset!");
...
static_assert(sizeof(UDatasmithCineCameraActorTemplate) == 0x000068, "Wrong size on UDatasmithCineCameraActorTemplate");
...
{
public:
	TArray<class ULevelSequence*>                 ImportedSequences;                                 // 0x0290(0x0010)(Edit, BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADatasmithImportedSequencesActor) == 0x0002A0, "Wrong size on ADatasmithImportedSequencesActor");
static_assert(offsetof(ADatasmithImportedSequencesActor, ImportedSequences) == 0x000290, "Member 'ADatasmithImportedSequencesActor::ImportedSequences' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UMaterialInterface>      ParentMaterial;                                    // 0x0030(0x0030)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TMap<class FName, TSoftObjectPtr<class UTexture>> TextureParameterValues;                            // 0x0100(0x0050)(UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDatasmithMaterialInstanceTemplate) == 0x0001A0, "Wrong size on UDatasmithMaterialInstanceTemplate");
...
static_assert(offsetof(UDatasmithMaterialInstanceTemplate, ScalarParameterValues) == 0x000060, "Member 'UDatasmithMaterialInstanceTemplate::ScalarParameterValues' has a wrong offset!");
static_assert(offsetof(UDatasmithMaterialInstanceTemplate, VectorParameterValues) == 0x0000B0, "Member 'UDatasmithMaterialInstanceTemplate::VectorParameterValues' has a wrong offset!");
static_assert(offsetof(UDatasmithMaterialInstanceTemplate, TextureParameterValues) == 0x000100, "Member 'UDatasmithMaterialInstanceTemplate::TextureParameterValues' has a wrong offset!");
static_assert(offsetof(UDatasmithMaterialInstanceTemplate, StaticParameters) == 0x000150, "Member 'UDatasmithMaterialInstanceTemplate::StaticParameters' has a wrong offset!");
...
{
public:
	class UDatasmithScene*                        Scene;                                             // 0x0290(0x0008)(Edit, ZeroConstructor, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FName, TSoftObjectPtr<class AActor>> RelatedActors;                                     // 0x0298(0x0050)(Edit, EditConst, AdvancedDisplay, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADatasmithSceneActor) == 0x0002E8, "Wrong size on ADatasmithSceneActor");
static_assert(offsetof(ADatasmithSceneActor, Scene) == 0x000290, "Member 'ADatasmithSceneActor::Scene' has a wrong offset!");
static_assert(offsetof(ADatasmithSceneActor, RelatedActors) == 0x000298, "Member 'ADatasmithSceneActor::RelatedActors' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_91[0x7];                                       // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class USceneComponent>         AttachParent;                                      // 0x0098(0x0030)(ExportObject, InstancedReference, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TSet<class FName>                             Tags;                                              // 0x00D0(0x0050)(NativeAccessSpecifierPublic)
...
static_assert(offsetof(UDatasmithSceneComponentTemplate, bVisible) == 0x0000C8, "Member 'UDatasmithSceneComponentTemplate::bVisible' has a wrong offset!");
static_assert(offsetof(UDatasmithSceneComponentTemplate, bCastShadow) == 0x0000C9, "Member 'UDatasmithSceneComponentTemplate::bCastShadow' has a wrong offset!");
static_assert(offsetof(UDatasmithSceneComponentTemplate, Tags) == 0x0000D0, "Member 'UDatasmithSceneComponentTemplate::Tags' has a wrong offset!");
