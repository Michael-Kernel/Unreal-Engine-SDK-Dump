...
// Parameters:
// double                                  Weight_Value_0                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_VisualEffect_CameraMosaic_C::Update_Mosaic(double Weight_Value_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Weight_Value_0 = Weight_Value_0;
