...
static_assert(offsetof(BP_GatlingGun_C_GetTargetPosition, TargetPosition_0) == 0x000000, "Member 'BP_GatlingGun_C_GetTargetPosition::TargetPosition_0' has a wrong offset!");
