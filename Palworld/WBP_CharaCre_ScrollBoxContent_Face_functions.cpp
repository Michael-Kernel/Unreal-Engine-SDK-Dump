...
void UWBP_CharaCre_ScrollBoxContent_Face_C::OnCloseBrowColorSelectWindow(class UPalHUDDispatchParameterBase* Param_0)
{
	static class UFunction* Func = nullptr;
...
void UWBP_CharaCre_ScrollBoxContent_Face_C::OnClosedEyeColorSelectWindow(class UPalHUDDispatchParameterBase* Param_0)
{
	static class UFunction* Func = nullptr;
