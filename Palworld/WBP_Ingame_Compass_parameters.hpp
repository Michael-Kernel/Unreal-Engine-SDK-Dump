...
static_assert(alignof(WBP_Ingame_Compass_C_Add_Custom_Marker) == 0x000008, "Wrong alignment on WBP_Ingame_Compass_C_Add_Custom_Marker");
static_assert(sizeof(WBP_Ingame_Compass_C_Add_Custom_Marker) == 0x0000D0, "Wrong size on WBP_Ingame_Compass_C_Add_Custom_Marker");
static_assert(offsetof(WBP_Ingame_Compass_C_Add_Custom_Marker, PalLocationUIData) == 0x000000, "Member 'WBP_Ingame_Compass_C_Add_Custom_Marker::PalLocationUIData' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Add_Custom_Marker, PalCustomMarkerSaveData) == 0x000040, "Member 'WBP_Ingame_Compass_C_Add_Custom_Marker::PalCustomMarkerSaveData' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Add_Custom_Marker, LocationId) == 0x000060, "Member 'WBP_Ingame_Compass_C_Add_Custom_Marker::LocationId' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Add_Custom_Marker, K2Node_MakeStruct_Anchors) == 0x000070, "Member 'WBP_Ingame_Compass_C_Add_Custom_Marker::K2Node_MakeStruct_Anchors' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Add_Custom_Marker, CallFunc_GetLocalPlayerController_ReturnValue) == 0x000090, "Member 'WBP_Ingame_Compass_C_Add_Custom_Marker::CallFunc_GetLocalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Add_Custom_Marker, CallFunc_Create_ReturnValue) == 0x000098, "Member 'WBP_Ingame_Compass_C_Add_Custom_Marker::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Add_Custom_Marker, K2Node_DynamicCast_AsWBP_Ingame_Compass_Custom_Marker) == 0x0000A0, "Member 'WBP_Ingame_Compass_C_Add_Custom_Marker::K2Node_DynamicCast_AsWBP_Ingame_Compass_Custom_Marker' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Add_Custom_Marker, K2Node_DynamicCast_bSuccess) == 0x0000A8, "Member 'WBP_Ingame_Compass_C_Add_Custom_Marker::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Add_Custom_Marker, CallFunc_AddChild_ReturnValue) == 0x0000B0, "Member 'WBP_Ingame_Compass_C_Add_Custom_Marker::CallFunc_AddChild_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Add_Custom_Marker, K2Node_DynamicCast_AsCanvas_Panel_Slot) == 0x0000B8, "Member 'WBP_Ingame_Compass_C_Add_Custom_Marker::K2Node_DynamicCast_AsCanvas_Panel_Slot' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Add_Custom_Marker, K2Node_DynamicCast_bSuccess_1) == 0x0000C0, "Member 'WBP_Ingame_Compass_C_Add_Custom_Marker::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Add_Custom_Marker, CallFunc_SetDisplayDistance_Length_ImplicitCast) == 0x0000C8, "Member 'WBP_Ingame_Compass_C_Add_Custom_Marker::CallFunc_SetDisplayDistance_Length_ImplicitCast' has a wrong offset!");
...
public:
	...
	class UPalLocationManager*                    CallFunc_GetLocationManager_ReturnValue;           // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TMap<struct FGuid, class UPalLocationBase*>   CallFunc_GetLocationMap_ReturnValue;               // 0x0060(0x0050)()
	...
	TArray<struct FGuid>                          CallFunc_Map_Keys_Keys;                            // 0x00B8(0x0010)(ReferenceParm)
	struct FGuid                                  CallFunc_Array_Get_Item;                           // 0x00C8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_Length_ReturnValue;                 // 0x00D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_DC[0x4];                                       // 0x00DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalLocationBase*                       CallFunc_Map_Find_Value;                           // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Map_Find_ReturnValue;                     // 0x00E8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsShowInCompass_ReturnValue;              // 0x00E9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(struct FGuid& LocationId, class UPalLocationBase* Location)> K2Node_CreateDelegate_OutputDelegate;              // 0x00EC(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(struct FGuid& LocationId, class UPalLocationBase* Location)> K2Node_CreateDelegate_OutputDelegate_1;            // 0x00FC(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass) == 0x000138, "Wrong size on WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass");
...
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, Temp_int_Array_Index_Variable) == 0x000004, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, K2Node_Event_MyGeometry) == 0x000008, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, K2Node_Event_InDeltaTime) == 0x000048, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_GetLocationManager_ReturnValue) == 0x000050, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_GetLocationManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000058, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_GetLocationMap_ReturnValue) == 0x000060, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_GetLocationMap_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_IsValid_ReturnValue) == 0x0000B0, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_Map_Keys_Keys) == 0x0000B8, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_Map_Keys_Keys' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_Array_Get_Item) == 0x0000C8, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_Array_Length_ReturnValue) == 0x0000D8, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_Map_Find_Value) == 0x0000E0, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_Map_Find_ReturnValue) == 0x0000E8, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_IsShowInCompass_ReturnValue) == 0x0000E9, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_IsShowInCompass_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_IsValid_ReturnValue_1) == 0x0000EA, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, K2Node_CreateDelegate_OutputDelegate) == 0x0000EC, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, K2Node_CreateDelegate_OutputDelegate_1) == 0x0000FC, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, K2Node_CreateDelegate_OutputDelegate_2) == 0x00010C, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000120, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, Temp_int_Loop_Counter_Variable) == 0x000128, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_Less_IntInt_ReturnValue) == 0x00012C, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass, CallFunc_Add_IntInt_ReturnValue) == 0x000130, "Member 'WBP_Ingame_Compass_C_ExecuteUbergraph_WBP_Ingame_Compass::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(alignof(WBP_Ingame_Compass_C_Setup_Custom_Marker) == 0x000008, "Wrong alignment on WBP_Ingame_Compass_C_Setup_Custom_Marker");
static_assert(sizeof(WBP_Ingame_Compass_C_Setup_Custom_Marker) == 0x0001C0, "Wrong size on WBP_Ingame_Compass_C_Setup_Custom_Marker");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, CallFunc_GetDataTableRowFromName_OutRow) == 0x000000, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x0000A8, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, Temp_int_Array_Index_Variable) == 0x0000AC, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, Temp_int_Loop_Counter_Variable) == 0x0000B0, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, CallFunc_Add_IntInt_ReturnValue) == 0x0000B4, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, K2Node_CreateDelegate_OutputDelegate) == 0x0000B8, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, Temp_byte_Variable) == 0x0000C8, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, CallFunc_GetLocationManager_ReturnValue) == 0x0000D0, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::CallFunc_GetLocationManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, CallFunc_GetCustomMarkers_ReturnValue) == 0x0000D8, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::CallFunc_GetCustomMarkers_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, CallFunc_Map_Find_Value) == 0x000128, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, CallFunc_Map_Find_ReturnValue) == 0x000168, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, CallFunc_Map_Keys_Keys) == 0x000170, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::CallFunc_Map_Keys_Keys' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, CallFunc_Array_Get_Item) == 0x000180, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, CallFunc_Array_Length_ReturnValue) == 0x000190, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, CallFunc_Map_Find_Value_1) == 0x000198, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::CallFunc_Map_Find_Value_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, CallFunc_Map_Find_ReturnValue_1) == 0x0001B8, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::CallFunc_Map_Find_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Setup_Custom_Marker, CallFunc_Less_IntInt_ReturnValue) == 0x0001B9, "Member 'WBP_Ingame_Compass_C_Setup_Custom_Marker::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
