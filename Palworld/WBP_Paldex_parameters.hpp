...
static_assert(offsetof(WBP_Paldex_C_ClickByIndex, Index_0) == 0x000000, "Member 'WBP_Paldex_C_ClickByIndex::Index_0' has a wrong offset!");
...
public:
	...
	EPalRandomizerType                            Temp_byte_Variable;                                // 0x0039(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3A[0x6];                                       // 0x003A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalRandomizerManager*                  CallFunc_GetWorldSubsystem_ReturnValue;            // 0x0040(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPalUIPaldexDistributionData           CallFunc_GetDataTableRowFromName_OutRow;           // 0x0048(0x0038)()
	...
	EPalRandomizerType                            CallFunc_GetRandomizerType_ReturnValue;            // 0x0081(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FPalUIPaldexDistributionData           CallFunc_GetPaldexDistributionData_OutPaldexDestributionData; // 0x0088(0x0038)()
	bool                                          CallFunc_GetPaldexDistributionData_ReturnValue;    // 0x00C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FPalUIPaldexDistributionData           K2Node_Select_Default;                             // 0x00C8(0x0038)()
	bool                                          CallFunc_SetDistributionLocations_isNoDistribution; // 0x0100(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_Paldex_C_Display_Distribution) == 0x000008, "Wrong alignment on WBP_Paldex_C_Display_Distribution");
static_assert(sizeof(WBP_Paldex_C_Display_Distribution) == 0x000108, "Wrong size on WBP_Paldex_C_Display_Distribution");
...
static_assert(offsetof(WBP_Paldex_C_Display_Distribution, Temp_byte_Variable) == 0x000039, "Member 'WBP_Paldex_C_Display_Distribution::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_C_Display_Distribution, CallFunc_GetWorldSubsystem_ReturnValue) == 0x000040, "Member 'WBP_Paldex_C_Display_Distribution::CallFunc_GetWorldSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_C_Display_Distribution, CallFunc_GetDataTableRowFromName_OutRow) == 0x000048, "Member 'WBP_Paldex_C_Display_Distribution::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_C_Display_Distribution, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x000080, "Member 'WBP_Paldex_C_Display_Distribution::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_C_Display_Distribution, CallFunc_GetRandomizerType_ReturnValue) == 0x000081, "Member 'WBP_Paldex_C_Display_Distribution::CallFunc_GetRandomizerType_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_C_Display_Distribution, K2Node_SwitchEnum_CmpSuccess) == 0x000082, "Member 'WBP_Paldex_C_Display_Distribution::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_C_Display_Distribution, CallFunc_GetPaldexDistributionData_OutPaldexDestributionData) == 0x000088, "Member 'WBP_Paldex_C_Display_Distribution::CallFunc_GetPaldexDistributionData_OutPaldexDestributionData' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_C_Display_Distribution, CallFunc_GetPaldexDistributionData_ReturnValue) == 0x0000C0, "Member 'WBP_Paldex_C_Display_Distribution::CallFunc_GetPaldexDistributionData_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_C_Display_Distribution, K2Node_SwitchEnum_CmpSuccess_1) == 0x0000C1, "Member 'WBP_Paldex_C_Display_Distribution::K2Node_SwitchEnum_CmpSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_C_Display_Distribution, K2Node_Select_Default) == 0x0000C8, "Member 'WBP_Paldex_C_Display_Distribution::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_C_Display_Distribution, CallFunc_SetDistributionLocations_isNoDistribution) == 0x000100, "Member 'WBP_Paldex_C_Display_Distribution::CallFunc_SetDistributionLocations_isNoDistribution' has a wrong offset!");
...
static_assert(offsetof(WBP_Paldex_C_FocusByIndex, Index_0) == 0x000000, "Member 'WBP_Paldex_C_FocusByIndex::Index_0' has a wrong offset!");
...
static_assert(offsetof(WBP_Paldex_C_GetFocusTargetByIndex, Index_0) == 0x000000, "Member 'WBP_Paldex_C_GetFocusTargetByIndex::Index_0' has a wrong offset!");
...
static_assert(offsetof(WBP_Paldex_C_PageSkip_Down, Navigation_0) == 0x000000, "Member 'WBP_Paldex_C_PageSkip_Down::Navigation_0' has a wrong offset!");
...
static_assert(offsetof(WBP_Paldex_C_PageSkip_Up, Navigation_0) == 0x000000, "Member 'WBP_Paldex_C_PageSkip_Up::Navigation_0' has a wrong offset!");
...
static_assert(offsetof(WBP_Paldex_C_ScrollByPanelIndex, ScrollByPanelIndex_0) == 0x000000, "Member 'WBP_Paldex_C_ScrollByPanelIndex::ScrollByPanelIndex_0' has a wrong offset!");
