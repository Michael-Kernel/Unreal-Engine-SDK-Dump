...
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_Is_Equipable_Item, Slot_0) == 0x000000, "Member 'WBP_InventoryEquipment_ItemInfo_C_Is_Equipable_Item::Slot_0' has a wrong offset!");
...
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_OnUpdateTargetSlot, Slot_0) == 0x000000, "Member 'WBP_InventoryEquipment_ItemInfo_C_OnUpdateTargetSlot::Slot_0' has a wrong offset!");
...
static_assert(sizeof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice) == 0x000078, "Wrong size on WBP_InventoryEquipment_ItemInfo_C_SetupPrice");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, CallFunc_CalcItemSellPriceBuffRate_ReturnValue) == 0x000000, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::CallFunc_CalcItemSellPriceBuffRate_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, CallFunc_GetGameSetting_ReturnValue) == 0x000008, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::CallFunc_GetGameSetting_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000010, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, CallFunc_IsEmpty_ReturnValue) == 0x000018, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::CallFunc_IsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, CallFunc_IsValid_ReturnValue) == 0x000019, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, CallFunc_GetItemId_ReturnValue) == 0x00001C, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::CallFunc_GetItemId_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, K2Node_MakeStruct_PalStaticItemIdAndNum) == 0x000044, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::K2Node_MakeStruct_PalStaticItemIdAndNum' has a wrong offset!");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, CallFunc_Greater_IntInt_ReturnValue) == 0x000050, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, CallFunc_CalcItemSellPrice_ReturnValue) == 0x000054, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::CallFunc_CalcItemSellPrice_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, CallFunc_Multiply_IntInt_ReturnValue) == 0x000058, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::CallFunc_Multiply_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, CallFunc_SelectInt_ReturnValue) == 0x00005C, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::CallFunc_SelectInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, CallFunc_Multiply_DoubleDouble_B_ImplicitCast) == 0x000060, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::CallFunc_Multiply_DoubleDouble_B_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, CallFunc_Multiply_DoubleDouble_A_ImplicitCast) == 0x000068, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::CallFunc_Multiply_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_SetupPrice, CallFunc_CalcItemSellPrice_sellRate_ImplicitCast) == 0x000070, "Member 'WBP_InventoryEquipment_ItemInfo_C_SetupPrice::CallFunc_CalcItemSellPrice_sellRate_ImplicitCast' has a wrong offset!");
