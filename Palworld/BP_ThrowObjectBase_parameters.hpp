...
static_assert(offsetof(BP_ThrowObjectBase_C_IsCountDestroy, IsDestroy_0) == 0x000000, "Member 'BP_ThrowObjectBase_C_IsCountDestroy::IsDestroy_0' has a wrong offset!");
