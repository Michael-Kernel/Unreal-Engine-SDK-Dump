...
public:
	...
	class UPocketpairUserInfo*                    LocalUserInfo;                                     // 0x0068(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_70[0x228];                                     // 0x0070(0x0228)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPocketpairUserSubsystem) == 0x000298, "Wrong size on UPocketpairUserSubsystem");
static_assert(offsetof(UPocketpairUserSubsystem, LocalUserInfo) == 0x000068, "Member 'UPocketpairUserSubsystem::LocalUserInfo' has a wrong offset!");
