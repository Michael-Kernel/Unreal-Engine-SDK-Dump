...
public:
	...
	uint8                                         Pad_550[0x98];                                     // 0x0550(0x0098)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UBakeMeshAttributeMapsToolBase) == 0x000600, "Wrong size on UBakeMeshAttributeMapsToolBase");
...
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, CachedMaps) == 0x000500, "Member 'UBakeMeshAttributeMapsToolBase::CachedMaps' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, EmptyNormalMap) == 0x0005E8, "Member 'UBakeMeshAttributeMapsToolBase::EmptyNormalMap' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, EmptyColorMapBlack) == 0x0005F0, "Member 'UBakeMeshAttributeMapsToolBase::EmptyColorMapBlack' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, EmptyColorMapWhite) == 0x0005F8, "Member 'UBakeMeshAttributeMapsToolBase::EmptyColorMapWhite' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_618[0x98];                                     // 0x0618(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UBakeMultiMeshAttributeMapsTool) == 0x0006B0, "Wrong size on UBakeMultiMeshAttributeMapsTool");
static_assert(offsetof(UBakeMultiMeshAttributeMapsTool, Settings) == 0x000600, "Member 'UBakeMultiMeshAttributeMapsTool::Settings' has a wrong offset!");
static_assert(offsetof(UBakeMultiMeshAttributeMapsTool, InputMeshSettings) == 0x000608, "Member 'UBakeMultiMeshAttributeMapsTool::InputMeshSettings' has a wrong offset!");
static_assert(offsetof(UBakeMultiMeshAttributeMapsTool, ResultSettings) == 0x000610, "Member 'UBakeMultiMeshAttributeMapsTool::ResultSettings' has a wrong offset!");
...
static_assert(alignof(UBakeRenderCaptureResults) == 0x000008, "Wrong alignment on UBakeRenderCaptureResults");
static_assert(sizeof(UBakeRenderCaptureResults) == 0x0000E0, "Wrong size on UBakeRenderCaptureResults");
static_assert(offsetof(UBakeRenderCaptureResults, BaseColorMap) == 0x0000A8, "Member 'UBakeRenderCaptureResults::BaseColorMap' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureResults, NormalMap) == 0x0000B0, "Member 'UBakeRenderCaptureResults::NormalMap' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureResults, PackedMRSMap) == 0x0000B8, "Member 'UBakeRenderCaptureResults::PackedMRSMap' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureResults, MetallicMap) == 0x0000C0, "Member 'UBakeRenderCaptureResults::MetallicMap' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureResults, RoughnessMap) == 0x0000C8, "Member 'UBakeRenderCaptureResults::RoughnessMap' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureResults, SpecularMap) == 0x0000D0, "Member 'UBakeRenderCaptureResults::SpecularMap' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureResults, EmissiveMap) == 0x0000D8, "Member 'UBakeRenderCaptureResults::EmissiveMap' has a wrong offset!");
...
static_assert(alignof(UBakeRenderCaptureToolBuilder) == 0x000008, "Wrong alignment on UBakeRenderCaptureToolBuilder");
static_assert(sizeof(UBakeRenderCaptureToolBuilder) == 0x000028, "Wrong size on UBakeRenderCaptureToolBuilder");
...
public:
	...
	uint8                                         Pad_A50[0x148];                                    // 0x0A50(0x0148)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_BE8[0x3C8];                                    // 0x0BE8(0x03C8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshGroupPaintTool) == 0x000FB0, "Wrong size on UMeshGroupPaintTool");
static_assert(offsetof(UMeshGroupPaintTool, PolygroupLayerProperties) == 0x000B98, "Member 'UMeshGroupPaintTool::PolygroupLayerProperties' has a wrong offset!");
static_assert(offsetof(UMeshGroupPaintTool, FilterProperties) == 0x000BA0, "Member 'UMeshGroupPaintTool::FilterProperties' has a wrong offset!");
static_assert(offsetof(UMeshGroupPaintTool, PaintBrushOpProperties) == 0x000BA8, "Member 'UMeshGroupPaintTool::PaintBrushOpProperties' has a wrong offset!");
static_assert(offsetof(UMeshGroupPaintTool, EraseBrushOpProperties) == 0x000BB0, "Member 'UMeshGroupPaintTool::EraseBrushOpProperties' has a wrong offset!");
static_assert(offsetof(UMeshGroupPaintTool, FreezeActions) == 0x000BB8, "Member 'UMeshGroupPaintTool::FreezeActions' has a wrong offset!");
static_assert(offsetof(UMeshGroupPaintTool, PolyLassoMechanic) == 0x000BC8, "Member 'UMeshGroupPaintTool::PolyLassoMechanic' has a wrong offset!");
static_assert(offsetof(UMeshGroupPaintTool, PreviewMeshActor) == 0x000BD0, "Member 'UMeshGroupPaintTool::PreviewMeshActor' has a wrong offset!");
static_assert(offsetof(UMeshGroupPaintTool, DynamicMeshComponent) == 0x000BD8, "Member 'UMeshGroupPaintTool::DynamicMeshComponent' has a wrong offset!");
static_assert(offsetof(UMeshGroupPaintTool, MeshElementsDisplay) == 0x000BE0, "Member 'UMeshGroupPaintTool::MeshElementsDisplay' has a wrong offset!");
...
static_assert(sizeof(UPatternToolBuilder) == 0x000028, "Wrong size on UPatternToolBuilder");
...
{
public:
	EPatternToolShape                             Shape;                                             // 0x00A8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPatternToolSingleAxis                        SingleAxis;                                        // 0x00A9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPatternToolSinglePlane                       SinglePlane;                                       // 0x00AA(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHideSources;                                      // 0x00AB(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Seed;                                              // 0x00AC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPatternToolSettings) == 0x0000B0, "Wrong size on UPatternToolSettings");
static_assert(offsetof(UPatternToolSettings, Shape) == 0x0000A8, "Member 'UPatternToolSettings::Shape' has a wrong offset!");
static_assert(offsetof(UPatternToolSettings, SingleAxis) == 0x0000A9, "Member 'UPatternToolSettings::SingleAxis' has a wrong offset!");
static_assert(offsetof(UPatternToolSettings, SinglePlane) == 0x0000AA, "Member 'UPatternToolSettings::SinglePlane' has a wrong offset!");
static_assert(offsetof(UPatternToolSettings, bHideSources) == 0x0000AB, "Member 'UPatternToolSettings::bHideSources' has a wrong offset!");
static_assert(offsetof(UPatternToolSettings, Seed) == 0x0000AC, "Member 'UPatternToolSettings::Seed' has a wrong offset!");
...
public:
	...
	bool                                          bJitter;                                           // 0x00A9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FRotator                               RotationJitterRange;                               // 0x00E0(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPatternTool_RotationSettings, RotationJitterRange) == 0x0000E0, "Member 'UPatternTool_RotationSettings::RotationJitterRange' has a wrong offset!");
...
public:
	...
	struct FVector                                TranslationJitterRange;                            // 0x00E0(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPatternTool_TranslationSettings, TranslationJitterRange) == 0x0000E0, "Member 'UPatternTool_TranslationSettings::TranslationJitterRange' has a wrong offset!");
...
{
public:
	bool                                          bUniform;                                          // 0x00A8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bJitter;                                           // 0x00AA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         ScaleJitterRange;                                  // 0x00E0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E4[0x4];                                       // 0x00E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                ScaleJitterRangeNonUniform;                        // 0x00E8(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPatternTool_ScaleSettings) == 0x000100, "Wrong size on UPatternTool_ScaleSettings");
static_assert(offsetof(UPatternTool_ScaleSettings, bUniform) == 0x0000A8, "Member 'UPatternTool_ScaleSettings::bUniform' has a wrong offset!");
...
static_assert(offsetof(UPatternTool_ScaleSettings, ScaleJitterRange) == 0x0000E0, "Member 'UPatternTool_ScaleSettings::ScaleJitterRange' has a wrong offset!");
static_assert(offsetof(UPatternTool_ScaleSettings, ScaleJitterRangeNonUniform) == 0x0000E8, "Member 'UPatternTool_ScaleSettings::ScaleJitterRangeNonUniform' has a wrong offset!");
...
public:
	...
	class UPatternTool_LinearSettings*            LinearSettings;                                    // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPatternTool_GridSettings*              GridSettings;                                      // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPatternTool_RadialSettings*            RadialSettings;                                    // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPatternTool_RotationSettings*          RotationSettings;                                  // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPatternTool_TranslationSettings*       TranslationSettings;                               // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPatternTool_ScaleSettings*             ScaleSettings;                                     // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F0[0x38];                                      // 0x00F0(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	class UPatternTool_OutputSettings*            OutputSettings;                                    // 0x0128(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTransformProxy*                        TransformProxy_End;                                // 0x0130(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCombinedTransformGizmo*                TransformGizmo_End;                                // 0x0138(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDragAlignmentMechanic*                 DragAlignmentMechanic;                             // 0x0140(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UConstructionPlaneMechanic*             PlaneMechanic;                                     // 0x0148(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_150[0x80];                                     // 0x0150(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<class UPrimitiveComponent*>              AllComponents;                                     // 0x01D0(0x0050)(ExportObject, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_220[0xA0];                                     // 0x0220(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	class UPreviewGeometry*                       PreviewGeometry;                                   // 0x02C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(alignof(UPatternTool) == 0x000008, "Wrong alignment on UPatternTool");
static_assert(sizeof(UPatternTool) == 0x0002C8, "Wrong size on UPatternTool");
static_assert(offsetof(UPatternTool, Settings) == 0x0000B8, "Member 'UPatternTool::Settings' has a wrong offset!");
static_assert(offsetof(UPatternTool, LinearSettings) == 0x0000C0, "Member 'UPatternTool::LinearSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, GridSettings) == 0x0000C8, "Member 'UPatternTool::GridSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, RadialSettings) == 0x0000D0, "Member 'UPatternTool::RadialSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, RotationSettings) == 0x0000D8, "Member 'UPatternTool::RotationSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, TranslationSettings) == 0x0000E0, "Member 'UPatternTool::TranslationSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, ScaleSettings) == 0x0000E8, "Member 'UPatternTool::ScaleSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, OutputSettings) == 0x000128, "Member 'UPatternTool::OutputSettings' has a wrong offset!");
static_assert(offsetof(UPatternTool, TransformProxy_End) == 0x000130, "Member 'UPatternTool::TransformProxy_End' has a wrong offset!");
static_assert(offsetof(UPatternTool, TransformGizmo_End) == 0x000138, "Member 'UPatternTool::TransformGizmo_End' has a wrong offset!");
static_assert(offsetof(UPatternTool, DragAlignmentMechanic) == 0x000140, "Member 'UPatternTool::DragAlignmentMechanic' has a wrong offset!");
static_assert(offsetof(UPatternTool, PlaneMechanic) == 0x000148, "Member 'UPatternTool::PlaneMechanic' has a wrong offset!");
static_assert(offsetof(UPatternTool, AllComponents) == 0x0001D0, "Member 'UPatternTool::AllComponents' has a wrong offset!");
static_assert(offsetof(UPatternTool, PreviewGeometry) == 0x0002C0, "Member 'UPatternTool::PreviewGeometry' has a wrong offset!");
...
public:
	...
	class UPolygonSelectionMechanic*              SelectionMechanic;                                 // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBakeMeshAttributeMapsTool) == 0x000670, "Wrong size on UBakeMeshAttributeMapsTool");
static_assert(offsetof(UBakeMeshAttributeMapsTool, InputMeshSettings) == 0x000600, "Member 'UBakeMeshAttributeMapsTool::InputMeshSettings' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsTool, Settings) == 0x000608, "Member 'UBakeMeshAttributeMapsTool::Settings' has a wrong offset!");
static_assert(offsetof(UBakeMeshAttributeMapsTool, ResultSettings) == 0x000610, "Member 'UBakeMeshAttributeMapsTool::ResultSettings' has a wrong offset!");
...
{
public:
	EBakeTextureResolution                        Resolution;                                        // 0x00A8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bAntiAliasing;                                     // 0x00B3(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CaptureFieldOfView;                                // 0x00B4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         NearPlaneDist;                                     // 0x00B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDeviceDepthMap;                                   // 0x00BC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(URenderCaptureProperties) == 0x000008, "Wrong alignment on URenderCaptureProperties");
static_assert(sizeof(URenderCaptureProperties) == 0x0000C0, "Wrong size on URenderCaptureProperties");
static_assert(offsetof(URenderCaptureProperties, Resolution) == 0x0000A8, "Member 'URenderCaptureProperties::Resolution' has a wrong offset!");
static_assert(offsetof(URenderCaptureProperties, bBaseColorMap) == 0x0000AC, "Member 'URenderCaptureProperties::bBaseColorMap' has a wrong offset!");
static_assert(offsetof(URenderCaptureProperties, bNormalMap) == 0x0000AD, "Member 'URenderCaptureProperties::bNormalMap' has a wrong offset!");
static_assert(offsetof(URenderCaptureProperties, bPackedMRSMap) == 0x0000AE, "Member 'URenderCaptureProperties::bPackedMRSMap' has a wrong offset!");
static_assert(offsetof(URenderCaptureProperties, bMetallicMap) == 0x0000AF, "Member 'URenderCaptureProperties::bMetallicMap' has a wrong offset!");
static_assert(offsetof(URenderCaptureProperties, bRoughnessMap) == 0x0000B0, "Member 'URenderCaptureProperties::bRoughnessMap' has a wrong offset!");
static_assert(offsetof(URenderCaptureProperties, bSpecularMap) == 0x0000B1, "Member 'URenderCaptureProperties::bSpecularMap' has a wrong offset!");
static_assert(offsetof(URenderCaptureProperties, bEmissiveMap) == 0x0000B2, "Member 'URenderCaptureProperties::bEmissiveMap' has a wrong offset!");
static_assert(offsetof(URenderCaptureProperties, bAntiAliasing) == 0x0000B3, "Member 'URenderCaptureProperties::bAntiAliasing' has a wrong offset!");
static_assert(offsetof(URenderCaptureProperties, CaptureFieldOfView) == 0x0000B4, "Member 'URenderCaptureProperties::CaptureFieldOfView' has a wrong offset!");
static_assert(offsetof(URenderCaptureProperties, NearPlaneDist) == 0x0000B8, "Member 'URenderCaptureProperties::NearPlaneDist' has a wrong offset!");
static_assert(offsetof(URenderCaptureProperties, bDeviceDepthMap) == 0x0000BC, "Member 'URenderCaptureProperties::bDeviceDepthMap' has a wrong offset!");
...
public:
	...
	EBakeTextureSamplesPerPixel                   SamplesPerPixel;                                   // 0x00C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EBakeTextureResolution                        TextureSize;                                       // 0x00CC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(UBakeRenderCaptureToolProperties) == 0x000008, "Wrong alignment on UBakeRenderCaptureToolProperties");
static_assert(sizeof(UBakeRenderCaptureToolProperties) == 0x0000D8, "Wrong size on UBakeRenderCaptureToolProperties");
static_assert(offsetof(UBakeRenderCaptureToolProperties, MapPreview) == 0x0000A8, "Member 'UBakeRenderCaptureToolProperties::MapPreview' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureToolProperties, MapPreviewNamesList) == 0x0000B8, "Member 'UBakeRenderCaptureToolProperties::MapPreviewNamesList' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureToolProperties, SamplesPerPixel) == 0x0000C8, "Member 'UBakeRenderCaptureToolProperties::SamplesPerPixel' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureToolProperties, TextureSize) == 0x0000CC, "Member 'UBakeRenderCaptureToolProperties::TextureSize' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureToolProperties, ValidSampleDepthThreshold) == 0x0000D0, "Member 'UBakeRenderCaptureToolProperties::ValidSampleDepthThreshold' has a wrong offset!");
...
static_assert(alignof(UBakeRenderCaptureInputToolProperties) == 0x000008, "Wrong alignment on UBakeRenderCaptureInputToolProperties");
static_assert(sizeof(UBakeRenderCaptureInputToolProperties) == 0x0000D0, "Wrong size on UBakeRenderCaptureInputToolProperties");
static_assert(offsetof(UBakeRenderCaptureInputToolProperties, TargetStaticMesh) == 0x0000A8, "Member 'UBakeRenderCaptureInputToolProperties::TargetStaticMesh' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureInputToolProperties, TargetUVLayer) == 0x0000B0, "Member 'UBakeRenderCaptureInputToolProperties::TargetUVLayer' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureInputToolProperties, TargetUVLayerNamesList) == 0x0000C0, "Member 'UBakeRenderCaptureInputToolProperties::TargetUVLayerNamesList' has a wrong offset!");

// Class MeshModelingToolsExp.BakeRenderCaptureTool
// 0x00E0 (0x06E0 - 0x0600)
class UBakeRenderCaptureTool final : public UBakeMeshAttributeMapsToolBase
{
public:
	TArray<class AActor*>                         Actors;                                            // 0x0600(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UBakeRenderCaptureToolProperties*       Settings;                                          // 0x0610(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class URenderCaptureProperties*               RenderCaptureProperties;                           // 0x0618(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UBakeRenderCaptureInputToolProperties*  InputMeshSettings;                                 // 0x0620(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UBakeRenderCaptureResults*              ResultSettings;                                    // 0x0628(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UTexture2D*                             EmptyEmissiveMap;                                  // 0x0630(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UTexture2D*                             EmptyPackedMRSMap;                                 // 0x0638(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UTexture2D*                             EmptyRoughnessMap;                                 // 0x0640(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UTexture2D*                             EmptyMetallicMap;                                  // 0x0648(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UTexture2D*                             EmptySpecularMap;                                  // 0x0650(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*               PreviewMaterialRC;                                 // 0x0658(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*               PreviewMaterialPackedRC;                           // 0x0660(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_668[0x10];                                     // 0x0668(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class URenderCaptureProperties*               ComputedRenderCaptureProperties;                   // 0x0678(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(alignof(UBakeRenderCaptureTool) == 0x000010, "Wrong alignment on UBakeRenderCaptureTool");
static_assert(sizeof(UBakeRenderCaptureTool) == 0x0006E0, "Wrong size on UBakeRenderCaptureTool");
static_assert(offsetof(UBakeRenderCaptureTool, Actors) == 0x000600, "Member 'UBakeRenderCaptureTool::Actors' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureTool, Settings) == 0x000610, "Member 'UBakeRenderCaptureTool::Settings' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureTool, RenderCaptureProperties) == 0x000618, "Member 'UBakeRenderCaptureTool::RenderCaptureProperties' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureTool, InputMeshSettings) == 0x000620, "Member 'UBakeRenderCaptureTool::InputMeshSettings' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureTool, ResultSettings) == 0x000628, "Member 'UBakeRenderCaptureTool::ResultSettings' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureTool, EmptyEmissiveMap) == 0x000630, "Member 'UBakeRenderCaptureTool::EmptyEmissiveMap' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureTool, EmptyPackedMRSMap) == 0x000638, "Member 'UBakeRenderCaptureTool::EmptyPackedMRSMap' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureTool, EmptyRoughnessMap) == 0x000640, "Member 'UBakeRenderCaptureTool::EmptyRoughnessMap' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureTool, EmptyMetallicMap) == 0x000648, "Member 'UBakeRenderCaptureTool::EmptyMetallicMap' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureTool, EmptySpecularMap) == 0x000650, "Member 'UBakeRenderCaptureTool::EmptySpecularMap' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureTool, PreviewMaterialRC) == 0x000658, "Member 'UBakeRenderCaptureTool::PreviewMaterialRC' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureTool, PreviewMaterialPackedRC) == 0x000660, "Member 'UBakeRenderCaptureTool::PreviewMaterialPackedRC' has a wrong offset!");
static_assert(offsetof(UBakeRenderCaptureTool, ComputedRenderCaptureProperties) == 0x000678, "Member 'UBakeRenderCaptureTool::ComputedRenderCaptureProperties' has a wrong offset!");
...
static_assert(offsetof(UBakeTransformToolProperties, bAllowNoScale) == 0x0000AB, "Member 'UBakeTransformToolProperties::bAllowNoScale' has a wrong offset!");
...
public:
	...
	int32                                         QuadSearchRounds;                                  // 0x00C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	int32                                         MinGroupSize;                                      // 0x00CC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UConvertToPolygonsToolProperties, QuadAdjacencyWeight) == 0x0000BC, "Member 'UConvertToPolygonsToolProperties::QuadAdjacencyWeight' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsToolProperties, QuadMetricClamp) == 0x0000C0, "Member 'UConvertToPolygonsToolProperties::QuadMetricClamp' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsToolProperties, QuadSearchRounds) == 0x0000C4, "Member 'UConvertToPolygonsToolProperties::QuadSearchRounds' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsToolProperties, bRespectUVSeams) == 0x0000C8, "Member 'UConvertToPolygonsToolProperties::bRespectUVSeams' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsToolProperties, bRespectHardNormals) == 0x0000C9, "Member 'UConvertToPolygonsToolProperties::bRespectHardNormals' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsToolProperties, MinGroupSize) == 0x0000CC, "Member 'UConvertToPolygonsToolProperties::MinGroupSize' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsToolProperties, bCalculateNormals) == 0x0000D0, "Member 'UConvertToPolygonsToolProperties::bCalculateNormals' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsToolProperties, bShowGroupColors) == 0x0000D1, "Member 'UConvertToPolygonsToolProperties::bShowGroupColors' has a wrong offset!");
...
static_assert(sizeof(UConvertToPolygonsTool) == 0x000110, "Wrong size on UConvertToPolygonsTool");
...
static_assert(offsetof(UConvertToPolygonsTool, CopyFromLayerProperties) == 0x0000C0, "Member 'UConvertToPolygonsTool::CopyFromLayerProperties' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsTool, OutputProperties) == 0x0000C8, "Member 'UConvertToPolygonsTool::OutputProperties' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsTool, PreviewCompute) == 0x0000D0, "Member 'UConvertToPolygonsTool::PreviewCompute' has a wrong offset!");
static_assert(offsetof(UConvertToPolygonsTool, PreviewGeometry) == 0x0000D8, "Member 'UConvertToPolygonsTool::PreviewGeometry' has a wrong offset!");
...
static_assert(offsetof(UCubeGridToolProperties, SlideSelection) == 0x000150, "Member 'UCubeGridToolProperties::SlideSelection' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_130[0x180];                                    // 0x0130(0x0180)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2B8[0x368];                                    // 0x02B8(0x0368)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UCubeGridTool, DuringActivityActions) == 0x000110, "Member 'UCubeGridTool::DuringActivityActions' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, MaterialProperties) == 0x000118, "Member 'UCubeGridTool::MaterialProperties' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, OutputTypeProperties) == 0x000120, "Member 'UCubeGridTool::OutputTypeProperties' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, Target) == 0x000128, "Member 'UCubeGridTool::Target' has a wrong offset!");
static_assert(offsetof(UCubeGridTool, Preview) == 0x0002B0, "Member 'UCubeGridTool::Preview' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_120[0x16D0];                                   // 0x0120(0x16D0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDeformMeshPolygonsTool) == 0x0017F0, "Wrong size on UDeformMeshPolygonsTool");
...
static_assert(offsetof(UDisplaceMeshTool, SelectiveTessellationProperties) == 0x0000E0, "Member 'UDisplaceMeshTool::SelectiveTessellationProperties' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshTool, ActiveContrastCurveTarget) == 0x0000E8, "Member 'UDisplaceMeshTool::ActiveContrastCurveTarget' has a wrong offset!");
...
{
public:
	class UPreviewMesh*                           PreviewMesh;                                       // 0x0280(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UDynamicMeshBrushTool) == 0x0002C0, "Wrong size on UDynamicMeshBrushTool");
static_assert(offsetof(UDynamicMeshBrushTool, PreviewMesh) == 0x000280, "Member 'UDynamicMeshBrushTool::PreviewMesh' has a wrong offset!");
...
{
public:
	class USeamSculptToolProperties*              Settings;                                          // 0x02C0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPreviewGeometry*                       PreviewGeom;                                       // 0x02C8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2D0[0xE0];                                     // 0x02D0(0x00E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USeamSculptTool) == 0x0003B0, "Wrong size on USeamSculptTool");
static_assert(offsetof(USeamSculptTool, Settings) == 0x0002C0, "Member 'USeamSculptTool::Settings' has a wrong offset!");
static_assert(offsetof(USeamSculptTool, PreviewGeom) == 0x0002C8, "Member 'USeamSculptTool::PreviewGeom' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1C8[0xE28];                                    // 0x01C8(0x0E28)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDynamicMeshSculptTool) == 0x001010, "Wrong size on UDynamicMeshSculptTool");
...
static_assert(offsetof(UDynamicMeshSculptTool, DynamicMeshComponent) == 0x0001B8, "Member 'UDynamicMeshSculptTool::DynamicMeshComponent' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, ActiveOverrideMaterial) == 0x0001C0, "Member 'UDynamicMeshSculptTool::ActiveOverrideMaterial' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, PlaneTransformGizmo) == 0x000FF0, "Member 'UDynamicMeshSculptTool::PlaneTransformGizmo' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, PlaneTransformProxy) == 0x000FF8, "Member 'UDynamicMeshSculptTool::PlaneTransformProxy' has a wrong offset!");
...
static_assert(sizeof(UEditNormalsTool) == 0x000150, "Wrong size on UEditNormalsTool");
...
public:
	...
	class UMultiTransformer*                      MultiTransformer;                                  // 0x0130(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_138[0x398];                                    // 0x0138(0x0398)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEditUVIslandsTool) == 0x0004D0, "Wrong size on UEditUVIslandsTool");
static_assert(offsetof(UEditUVIslandsTool, MaterialSettings) == 0x000100, "Member 'UEditUVIslandsTool::MaterialSettings' has a wrong offset!");
static_assert(offsetof(UEditUVIslandsTool, CheckerMaterial) == 0x000108, "Member 'UEditUVIslandsTool::CheckerMaterial' has a wrong offset!");
...
{
public:
	class UMeshAttributePaintBrushOperationProperties* BrushActionProps;                                  // 0x02C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMeshAttributePaintToolProperties*      AttribProps;                                       // 0x02C8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2D0[0x510];                                    // 0x02D0(0x0510)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMeshAttributePaintTool, BrushActionProps) == 0x0002C0, "Member 'UMeshAttributePaintTool::BrushActionProps' has a wrong offset!");
static_assert(offsetof(UMeshAttributePaintTool, AttribProps) == 0x0002C8, "Member 'UMeshAttributePaintTool::AttribProps' has a wrong offset!");
...
public:
	...
	class UExistingMeshMaterialProperties*        MaterialSettings;                                  // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_C8[0x8];                                       // 0x00C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class ULineSetComponent*                      DrawnLineSet;                                      // 0x00D8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     DefaultMaterial;                                   // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	class UMeshSelectionToolProperties*           SelectionProps;                                    // 0x02C8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshSelectionEditActions*              SelectionActions;                                  // 0x02D0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshSelectionToolActionPropertySet*    EditActions;                                       // 0x02D8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshStatisticsProperties*              MeshStatisticsProperties;                          // 0x02E0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshElementsVisualizer*                MeshElementsDisplay;                               // 0x02E8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshUVChannelProperties*               UVChannelProperties;                               // 0x02F0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPolygroupLayersProperties*             PolygroupLayerProperties;                          // 0x02F8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshSelectionSet*                      Selection;                                         // 0x0300(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class AActor*>                         SpawnedActors;                                     // 0x0308(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_318[0x378];                                    // 0x0318(0x0378)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshSelectionTool) == 0x000690, "Wrong size on UMeshSelectionTool");
static_assert(offsetof(UMeshSelectionTool, SelectionProps) == 0x0002C8, "Member 'UMeshSelectionTool::SelectionProps' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, SelectionActions) == 0x0002D0, "Member 'UMeshSelectionTool::SelectionActions' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, EditActions) == 0x0002D8, "Member 'UMeshSelectionTool::EditActions' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, MeshStatisticsProperties) == 0x0002E0, "Member 'UMeshSelectionTool::MeshStatisticsProperties' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, MeshElementsDisplay) == 0x0002E8, "Member 'UMeshSelectionTool::MeshElementsDisplay' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, UVChannelProperties) == 0x0002F0, "Member 'UMeshSelectionTool::UVChannelProperties' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, PolygroupLayerProperties) == 0x0002F8, "Member 'UMeshSelectionTool::PolygroupLayerProperties' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, Selection) == 0x000300, "Member 'UMeshSelectionTool::Selection' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, SpawnedActors) == 0x000308, "Member 'UMeshSelectionTool::SpawnedActors' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_BC8[0x918];                                    // 0x0BC8(0x0918)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshVertexSculptTool) == 0x0014E0, "Wrong size on UMeshVertexSculptTool");
static_assert(offsetof(UMeshVertexSculptTool, SculptProperties) == 0x000B98, "Member 'UMeshVertexSculptTool::SculptProperties' has a wrong offset!");
static_assert(offsetof(UMeshVertexSculptTool, AlphaProperties) == 0x000BA0, "Member 'UMeshVertexSculptTool::AlphaProperties' has a wrong offset!");
static_assert(offsetof(UMeshVertexSculptTool, BrushAlpha) == 0x000BA8, "Member 'UMeshVertexSculptTool::BrushAlpha' has a wrong offset!");
static_assert(offsetof(UMeshVertexSculptTool, SymmetryProperties) == 0x000BB0, "Member 'UMeshVertexSculptTool::SymmetryProperties' has a wrong offset!");
static_assert(offsetof(UMeshVertexSculptTool, PreviewMeshActor) == 0x000BB8, "Member 'UMeshVertexSculptTool::PreviewMeshActor' has a wrong offset!");
static_assert(offsetof(UMeshVertexSculptTool, DynamicMeshComponent) == 0x000BC0, "Member 'UMeshVertexSculptTool::DynamicMeshComponent' has a wrong offset!");
...
static_assert(offsetof(UCollisionGeometryVisualizationProperties, bRandomColors) == 0x0000AD, "Member 'UCollisionGeometryVisualizationProperties::bRandomColors' has a wrong offset!");
...
public:
	...
	int32                                         MaxHullsPerMesh;                                   // 0x00C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	EProjectedHullAxis                            SweepAxis;                                         // 0x00DC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LevelSetResolution;                                // 0x00E0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	ECollisionGeometryMode                        SetCollisionType;                                  // 0x00E8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USetCollisionGeometryToolProperties) == 0x0000F0, "Wrong size on USetCollisionGeometryToolProperties");
...
static_assert(offsetof(USetCollisionGeometryToolProperties, MaxHullsPerMesh) == 0x0000C4, "Member 'USetCollisionGeometryToolProperties::MaxHullsPerMesh' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, ConvexDecompositionSearchFactor) == 0x0000C8, "Member 'USetCollisionGeometryToolProperties::ConvexDecompositionSearchFactor' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, AddHullsErrorTolerance) == 0x0000CC, "Member 'USetCollisionGeometryToolProperties::AddHullsErrorTolerance' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, MinPartThickness) == 0x0000D0, "Member 'USetCollisionGeometryToolProperties::MinPartThickness' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, bSimplifyPolygons) == 0x0000D4, "Member 'USetCollisionGeometryToolProperties::bSimplifyPolygons' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, HullTolerance) == 0x0000D8, "Member 'USetCollisionGeometryToolProperties::HullTolerance' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, SweepAxis) == 0x0000DC, "Member 'USetCollisionGeometryToolProperties::SweepAxis' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, LevelSetResolution) == 0x0000E0, "Member 'USetCollisionGeometryToolProperties::LevelSetResolution' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, bAppendToExisting) == 0x0000E4, "Member 'USetCollisionGeometryToolProperties::bAppendToExisting' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, SetCollisionType) == 0x0000E8, "Member 'USetCollisionGeometryToolProperties::SetCollisionType' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_F8[0x158];                                     // 0x00F8(0x0158)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(USetCollisionGeometryTool, Settings) == 0x0000C0, "Member 'USetCollisionGeometryTool::Settings' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryTool, PolygroupLayerProperties) == 0x0000C8, "Member 'USetCollisionGeometryTool::PolygroupLayerProperties' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryTool, VizSettings) == 0x0000D0, "Member 'USetCollisionGeometryTool::VizSettings' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryTool, CollisionProps) == 0x0000D8, "Member 'USetCollisionGeometryTool::CollisionProps' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryTool, LineMaterial) == 0x0000E0, "Member 'USetCollisionGeometryTool::LineMaterial' has a wrong offset!");
...
static_assert(sizeof(USelfUnionMeshesTool) == 0x000148, "Wrong size on USelfUnionMeshesTool");
...
{
public:
	class USkinWeightsPaintToolProperties*        ToolProps;                                         // 0x02C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2C8[0x6E8];                                    // 0x02C8(0x06E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USkinWeightsPaintTool) == 0x0009B0, "Wrong size on USkinWeightsPaintTool");
static_assert(offsetof(USkinWeightsPaintTool, ToolProps) == 0x0002C0, "Member 'USkinWeightsPaintTool::ToolProps' has a wrong offset!");
