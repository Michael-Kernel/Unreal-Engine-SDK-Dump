...
public:
	...
	void OnBouncedBody__DelegateSignature(E_PalCaptureSphereBouncedReason ReasonType, class UPalIndividualCharacterHandle* TargetHandle_0);
	void OnFailedCapture__DelegateSignature(class UPalIndividualCharacterHandle* TargetHandle_0, EPalSphereCaptureFailedReason FailedReason);
	void OnPassingCapturePhase__DelegateSignature(int32 PhaseCount, class UPalIndividualCharacterHandle* TargetHandle_0);
	void OnShakeBody__DelegateSignature(class ABP_PalCaptureBodyBase_C* ShakedBody);
	void OnSuccessedCapture__DelegateSignature(class UPalIndividualCharacterHandle* TargetHandle_0);
