...
#include "BP_PalRichTextDecorator_ItemName_classes.hpp"
#include "BP_PalRichTextDecorator_ItemName_parameters.hpp"
...
class FString UBP_PalRichTextDecorator_ItemName_C::GetTagName()
{
	...
	Params::BP_PalRichTextDecorator_ItemName_C_GetTagName Parms{};
...
class FString UBP_PalRichTextDecorator_ItemName_C::GetTextStringInternal(const class UObject* WorldContextObject, class FName ID)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_PalRichTextDecorator_ItemName_C_GetTextStringInternal Parms{};
