...
static_assert(sizeof(BP_OilrigNPCSpawnerBase_C_Despawn) == 0x000050, "Wrong size on BP_OilrigNPCSpawnerBase_C_Despawn");
...
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Despawn, CallFunc_IsServer_ReturnValue) == 0x000008, "Member 'BP_OilrigNPCSpawnerBase_C_Despawn::CallFunc_IsServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Despawn, CallFunc_IsValid_ReturnValue) == 0x000009, "Member 'BP_OilrigNPCSpawnerBase_C_Despawn::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Despawn, K2Node_CreateDelegate_OutputDelegate) == 0x00000C, "Member 'BP_OilrigNPCSpawnerBase_C_Despawn::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Despawn, CallFunc_GetCharacterManager_ReturnValue) == 0x000020, "Member 'BP_OilrigNPCSpawnerBase_C_Despawn::CallFunc_GetCharacterManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Despawn, CallFunc_IsValid_ReturnValue_1) == 0x000028, "Member 'BP_OilrigNPCSpawnerBase_C_Despawn::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Despawn, CallFunc_GetIndividualCharacterHandleByActor_ReturnValue) == 0x000030, "Member 'BP_OilrigNPCSpawnerBase_C_Despawn::CallFunc_GetIndividualCharacterHandleByActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Despawn, K2Node_CreateDelegate_OutputDelegate_1) == 0x000038, "Member 'BP_OilrigNPCSpawnerBase_C_Despawn::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Despawn, CallFunc_GetCharacterManager_ReturnValue_1) == 0x000048, "Member 'BP_OilrigNPCSpawnerBase_C_Despawn::CallFunc_GetCharacterManager_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(BP_OilrigNPCSpawnerBase_C_RequestSpawn) == 0x000028, "Wrong size on BP_OilrigNPCSpawnerBase_C_RequestSpawn");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_RequestSpawn, CallFunc_IsServer_ReturnValue) == 0x000000, "Member 'BP_OilrigNPCSpawnerBase_C_RequestSpawn::CallFunc_IsServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_RequestSpawn, CallFunc_IsInClientConnection_ReturnValue) == 0x000001, "Member 'BP_OilrigNPCSpawnerBase_C_RequestSpawn::CallFunc_IsInClientConnection_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_RequestSpawn, K2Node_CreateDelegate_OutputDelegate) == 0x000004, "Member 'BP_OilrigNPCSpawnerBase_C_RequestSpawn::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_RequestSpawn, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000018, "Member 'BP_OilrigNPCSpawnerBase_C_RequestSpawn::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_RequestSpawn, CallFunc_ExistSpawnableCollision_Exist) == 0x000020, "Member 'BP_OilrigNPCSpawnerBase_C_RequestSpawn::CallFunc_ExistSpawnableCollision_Exist' has a wrong offset!");
...
public:
	...
	struct FNetworkActorSpawnParameters           K2Node_MakeStruct_NetworkActorSpawnParameters;     // 0x0080(0x0070)(NoDestructor)
	struct FPalIndividualCharacterSaveParameter   CallFunc_GetInitializedCharacterSaveParemter_outParameter; // 0x00F0(0x02A8)()
	...
	class UPalIndividualCharacterHandle*          CallFunc_SpawnNewCharacter_ReturnValue;            // 0x03A0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_OilrigNPCSpawnerBase_C_Spawn) == 0x000008, "Wrong alignment on BP_OilrigNPCSpawnerBase_C_Spawn");
static_assert(sizeof(BP_OilrigNPCSpawnerBase_C_Spawn) == 0x0003A8, "Wrong size on BP_OilrigNPCSpawnerBase_C_Spawn");
...
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Spawn, Level_0) == 0x000008, "Member 'BP_OilrigNPCSpawnerBase_C_Spawn::Level_0' has a wrong offset!");
...
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Spawn, CallFunc_IsInClientConnection_ReturnValue) == 0x000048, "Member 'BP_OilrigNPCSpawnerBase_C_Spawn::CallFunc_IsInClientConnection_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Spawn, K2Node_CreateDelegate_OutputDelegate) == 0x00004C, "Member 'BP_OilrigNPCSpawnerBase_C_Spawn::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Spawn, CallFunc_GetCharacterManager_ReturnValue) == 0x000060, "Member 'BP_OilrigNPCSpawnerBase_C_Spawn::CallFunc_GetCharacterManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Spawn, CallFunc_GetLocalPlayerController_ReturnValue) == 0x000068, "Member 'BP_OilrigNPCSpawnerBase_C_Spawn::CallFunc_GetLocalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Spawn, K2Node_MakeStruct_Guid) == 0x000070, "Member 'BP_OilrigNPCSpawnerBase_C_Spawn::K2Node_MakeStruct_Guid' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Spawn, K2Node_MakeStruct_NetworkActorSpawnParameters) == 0x000080, "Member 'BP_OilrigNPCSpawnerBase_C_Spawn::K2Node_MakeStruct_NetworkActorSpawnParameters' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Spawn, CallFunc_GetInitializedCharacterSaveParemter_outParameter) == 0x0000F0, "Member 'BP_OilrigNPCSpawnerBase_C_Spawn::CallFunc_GetInitializedCharacterSaveParemter_outParameter' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Spawn, CallFunc_GetInitializedCharacterSaveParemter_ReturnValue) == 0x000398, "Member 'BP_OilrigNPCSpawnerBase_C_Spawn::CallFunc_GetInitializedCharacterSaveParemter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Spawn, CallFunc_SpawnNewCharacter_ReturnValue) == 0x0003A0, "Member 'BP_OilrigNPCSpawnerBase_C_Spawn::CallFunc_SpawnNewCharacter_ReturnValue' has a wrong offset!");
