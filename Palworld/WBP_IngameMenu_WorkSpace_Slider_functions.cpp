...
// Parameters:
// int32                                   Current_0                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_IngameMenu_WorkSpace_Slider_C::SetCurrentValue(int32 Current_0)
{
	static class UFunction* Func = nullptr;
