...
static_assert(offsetof(BP_AIAction_NPC_Talking_C_GetIsTalking, IsTalking_0) == 0x000000, "Member 'BP_AIAction_NPC_Talking_C_GetIsTalking::IsTalking_0' has a wrong offset!");
