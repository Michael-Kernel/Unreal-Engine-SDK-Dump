...
public:
	void AddBuildObjectList(TArray<struct FPalBuildObjectData>& buildObjectDataArray, EPalBuildObjectTypeB TypeB_0, EPalBuildObjectTypeA TypeA_0);
	...
	void GetBuildObjectTypeB(EPalBuildObjectTypeB* TypeB_0);
