...
public:
	...
	EPalArenaPlayerIndex                          K2Node_Select_Default;                             // 0x0119(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_11A[0x6];                                      // 0x011A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalArenaPlayerInfo                    CallFunc_Map_Find_Value_1;                         // 0x0120(0x0048)()
...
static_assert(sizeof(WBP_Arena_PalSelect_C_Setup) == 0x000170, "Wrong size on WBP_Arena_PalSelect_C_Setup");
...
static_assert(offsetof(WBP_Arena_PalSelect_C_Setup, CallFunc_Map_Find_ReturnValue) == 0x000118, "Member 'WBP_Arena_PalSelect_C_Setup::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_Setup, K2Node_Select_Default) == 0x000119, "Member 'WBP_Arena_PalSelect_C_Setup::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_Setup, CallFunc_Map_Find_Value_1) == 0x000120, "Member 'WBP_Arena_PalSelect_C_Setup::CallFunc_Map_Find_Value_1' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_Setup, CallFunc_Map_Find_ReturnValue_1) == 0x000168, "Member 'WBP_Arena_PalSelect_C_Setup::CallFunc_Map_Find_ReturnValue_1' has a wrong offset!");
...
public:
	...
	EPalArenaPlayerIndex                          K2Node_Select_Default;                             // 0x00A1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_A2[0x6];                                       // 0x00A2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalArenaPlayerInfo                    CallFunc_Map_Find_Value_1;                         // 0x00A8(0x0048)()
	...
	class FString                                 CallFunc_GetNickName_outName;                      // 0x00F8(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_GetNickName_outName_1;                    // 0x0128(0x0010)(ZeroConstructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_Arena_PalSelect_C_SetupCharacterName) == 0x000158, "Wrong size on WBP_Arena_PalSelect_C_SetupCharacterName");
...
static_assert(offsetof(WBP_Arena_PalSelect_C_SetupCharacterName, CallFunc_Map_Find_ReturnValue) == 0x0000A0, "Member 'WBP_Arena_PalSelect_C_SetupCharacterName::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_SetupCharacterName, K2Node_Select_Default) == 0x0000A1, "Member 'WBP_Arena_PalSelect_C_SetupCharacterName::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_SetupCharacterName, CallFunc_Map_Find_Value_1) == 0x0000A8, "Member 'WBP_Arena_PalSelect_C_SetupCharacterName::CallFunc_Map_Find_Value_1' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_SetupCharacterName, CallFunc_Map_Find_ReturnValue_1) == 0x0000F0, "Member 'WBP_Arena_PalSelect_C_SetupCharacterName::CallFunc_Map_Find_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_SetupCharacterName, CallFunc_GetNickName_outName) == 0x0000F8, "Member 'WBP_Arena_PalSelect_C_SetupCharacterName::CallFunc_GetNickName_outName' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_SetupCharacterName, CallFunc_Conv_StringToText_ReturnValue) == 0x000108, "Member 'WBP_Arena_PalSelect_C_SetupCharacterName::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_SetupCharacterName, CallFunc_IsValid_ReturnValue) == 0x000120, "Member 'WBP_Arena_PalSelect_C_SetupCharacterName::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_SetupCharacterName, CallFunc_GetNickName_outName_1) == 0x000128, "Member 'WBP_Arena_PalSelect_C_SetupCharacterName::CallFunc_GetNickName_outName_1' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_SetupCharacterName, CallFunc_Conv_StringToText_ReturnValue_1) == 0x000138, "Member 'WBP_Arena_PalSelect_C_SetupCharacterName::CallFunc_Conv_StringToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_SetupCharacterName, CallFunc_IsValid_ReturnValue_1) == 0x000150, "Member 'WBP_Arena_PalSelect_C_SetupCharacterName::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
...
public:
	...
	struct FPalArenaPlayerInfo                    CallFunc_Map_Find_Value;                           // 0x0078(0x0048)()
...
static_assert(sizeof(WBP_Arena_PalSelect_C_ToggleSelectParty) == 0x0000D0, "Wrong size on WBP_Arena_PalSelect_C_ToggleSelectParty");
...
static_assert(offsetof(WBP_Arena_PalSelect_C_ToggleSelectParty, CallFunc_Map_Find_ReturnValue) == 0x0000C0, "Member 'WBP_Arena_PalSelect_C_ToggleSelectParty::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_ToggleSelectParty, CallFunc_Array_Length_ReturnValue_1) == 0x0000C4, "Member 'WBP_Arena_PalSelect_C_ToggleSelectParty::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_ToggleSelectParty, CallFunc_Min_ReturnValue) == 0x0000C8, "Member 'WBP_Arena_PalSelect_C_ToggleSelectParty::CallFunc_Min_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_ToggleSelectParty, CallFunc_Less_IntInt_ReturnValue) == 0x0000CC, "Member 'WBP_Arena_PalSelect_C_ToggleSelectParty::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
public:
	...
	struct FPalArenaPlayerInfo                    CallFunc_Map_Find_Value;                           // 0x00A0(0x0048)()
...
static_assert(sizeof(WBP_Arena_PalSelect_C_Update_Party_Count_UI) == 0x0000F8, "Wrong size on WBP_Arena_PalSelect_C_Update_Party_Count_UI");
static_assert(offsetof(WBP_Arena_PalSelect_C_Update_Party_Count_UI, CurrentParty_0) == 0x000000, "Member 'WBP_Arena_PalSelect_C_Update_Party_Count_UI::CurrentParty_0' has a wrong offset!");
...
static_assert(offsetof(WBP_Arena_PalSelect_C_Update_Party_Count_UI, CallFunc_Map_Find_ReturnValue) == 0x0000E8, "Member 'WBP_Arena_PalSelect_C_Update_Party_Count_UI::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_Update_Party_Count_UI, CallFunc_Array_Length_ReturnValue_1) == 0x0000EC, "Member 'WBP_Arena_PalSelect_C_Update_Party_Count_UI::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Arena_PalSelect_C_Update_Party_Count_UI, CallFunc_Min_ReturnValue) == 0x0000F0, "Member 'WBP_Arena_PalSelect_C_Update_Party_Count_UI::CallFunc_Min_ReturnValue' has a wrong offset!");
