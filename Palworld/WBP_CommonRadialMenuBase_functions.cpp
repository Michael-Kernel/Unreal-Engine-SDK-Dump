...
void UWBP_CommonRadialMenuBase_C::OnDecideIndex_forBP__DelegateSignature(int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
void UWBP_CommonRadialMenuBase_C::Set_Additional_Widget(int32 Index_0, class UUserWidget* AddWidget, class UCanvasPanelSlot** Canvas)
{
	static class UFunction* Func = nullptr;
