...
static_assert(offsetof(WBP_PalCommonCharacterSlot_C_OnUpdateSlot_Binded, TargetSlot_0) == 0x000000, "Member 'WBP_PalCommonCharacterSlot_C_OnUpdateSlot_Binded::TargetSlot_0' has a wrong offset!");
