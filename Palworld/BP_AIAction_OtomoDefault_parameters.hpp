...
static_assert(offsetof(BP_AIAction_OtomoDefault_C_SetAction, Class_0) == 0x000000, "Member 'BP_AIAction_OtomoDefault_C_SetAction::Class_0' has a wrong offset!");
...
static_assert(offsetof(BP_AIAction_OtomoDefault_C_SetActionComposite, Class_0) == 0x000000, "Member 'BP_AIAction_OtomoDefault_C_SetActionComposite::Class_0' has a wrong offset!");
