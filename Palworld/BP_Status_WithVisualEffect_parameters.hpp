...
static_assert(offsetof(BP_Status_WithVisualEffect_C__________OtherStatusAdd, StatusId_0) == 0x000008, "Member 'BP_Status_WithVisualEffect_C__________OtherStatusAdd::StatusId_0' has a wrong offset!");
