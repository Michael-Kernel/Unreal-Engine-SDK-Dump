...
public:
	...
	class UWBP_OptionSettings_ListContent_C*      WBP_OptionSettings_UI_MinFontSize;                 // 0x0330(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_OptionSettings_ListContent_C*      WBP_OptionSettings_UI_ReticleColor;                // 0x0338(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_OptionSettings_ListContent_C*      WBP_OptionSettings_UI_ReticleOutlineOpacity;       // 0x0340(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_OptionSettings_ListContent_C*      WBP_OptionSettings_UI_TutorialDisplay;             // 0x0348(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_OptionSettings_ListContent_C*      WBP_OptionSettings_Vibration;                      // 0x0350(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_OptionSettings_ListContent_C*      WBP_OptionSettings_X;                              // 0x0358(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_OptionSettings_ListContent_C*      WBP_OptionSettings_Y;                              // 0x0360(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FPalOptionAudioSettings                AudioSettingCache;                                 // 0x0368(0x001C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	uint8                                         Pad_384[0x4];                                      // 0x0384(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FDataTableRowHandle>            LevelMsgIds;                                       // 0x0388(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                          SomethingChanged;                                  // 0x0398(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_399[0x3];                                      // 0x0399(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalOptionKeyboardSettings             KeyboardSettingCache;                              // 0x039C(0x0014)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	struct FPalOptionLocalStaticSettings          LocalStaticSettingCache;                           // 0x03B0(0x00A8)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FPalOptionPadSettings                  PadSettingCache;                                   // 0x0458(0x001C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	uint8                                         Pad_474[0x4];                                      // 0x0474(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UVerticalBox*>                   VerticalBoxs;                                      // 0x0478(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	TArray<class UWBP_PalCommonButtonBase_C*>     FirstRows;                                         // 0x0488(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	int32                                         Current;                                           // 0x0498(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FPalOptionUISettings                   UISettingCache;                                    // 0x049C(0x001C)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	struct FPalOptionCommonSettings               CommonSettingCache;                                // 0x04B8(0x0030)(Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<struct FDataTableRowHandle>            ColorSelections;                                   // 0x04E8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
...
public:
	...
	void OnMinFontSizeChanged(double Value);
...
static_assert(sizeof(UWBP_Control_Settings_C) == 0x0004F8, "Wrong size on UWBP_Control_Settings_C");
...
static_assert(offsetof(UWBP_Control_Settings_C, WBP_OptionSettings_UI_MinFontSize) == 0x000330, "Member 'UWBP_Control_Settings_C::WBP_OptionSettings_UI_MinFontSize' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, WBP_OptionSettings_UI_ReticleColor) == 0x000338, "Member 'UWBP_Control_Settings_C::WBP_OptionSettings_UI_ReticleColor' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, WBP_OptionSettings_UI_ReticleOutlineOpacity) == 0x000340, "Member 'UWBP_Control_Settings_C::WBP_OptionSettings_UI_ReticleOutlineOpacity' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, WBP_OptionSettings_UI_TutorialDisplay) == 0x000348, "Member 'UWBP_Control_Settings_C::WBP_OptionSettings_UI_TutorialDisplay' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, WBP_OptionSettings_Vibration) == 0x000350, "Member 'UWBP_Control_Settings_C::WBP_OptionSettings_Vibration' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, WBP_OptionSettings_X) == 0x000358, "Member 'UWBP_Control_Settings_C::WBP_OptionSettings_X' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, WBP_OptionSettings_Y) == 0x000360, "Member 'UWBP_Control_Settings_C::WBP_OptionSettings_Y' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, AudioSettingCache) == 0x000368, "Member 'UWBP_Control_Settings_C::AudioSettingCache' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, LevelMsgIds) == 0x000388, "Member 'UWBP_Control_Settings_C::LevelMsgIds' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, SomethingChanged) == 0x000398, "Member 'UWBP_Control_Settings_C::SomethingChanged' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, KeyboardSettingCache) == 0x00039C, "Member 'UWBP_Control_Settings_C::KeyboardSettingCache' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, LocalStaticSettingCache) == 0x0003B0, "Member 'UWBP_Control_Settings_C::LocalStaticSettingCache' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, PadSettingCache) == 0x000458, "Member 'UWBP_Control_Settings_C::PadSettingCache' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, VerticalBoxs) == 0x000478, "Member 'UWBP_Control_Settings_C::VerticalBoxs' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, FirstRows) == 0x000488, "Member 'UWBP_Control_Settings_C::FirstRows' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, Current) == 0x000498, "Member 'UWBP_Control_Settings_C::Current' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, UISettingCache) == 0x00049C, "Member 'UWBP_Control_Settings_C::UISettingCache' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, CommonSettingCache) == 0x0004B8, "Member 'UWBP_Control_Settings_C::CommonSettingCache' has a wrong offset!");
static_assert(offsetof(UWBP_Control_Settings_C, ColorSelections) == 0x0004E8, "Member 'UWBP_Control_Settings_C::ColorSelections' has a wrong offset!");
