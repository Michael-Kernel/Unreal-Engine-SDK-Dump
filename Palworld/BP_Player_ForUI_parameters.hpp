...
public:
	...
	const class UWeaponAnimationInfoWrap*         CallFunc_GetCurrentWeaponAnimationInfo_ReturnValue; // 0x00B8(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class FName                                   CallFunc_GetEquipSocketName_ReturnValue;           // 0x00C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class AActor*>                         CallFunc_GetAttachedActors_OutActors;              // 0x00C8(0x0010)(ReferenceParm)
	class UAnimSequence*                          CallFunc_Map_Find_Value;                           // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class APalWeaponBase*                         K2Node_DynamicCast_AsPal_Weapon_Base;              // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_Player_ForUI_C_CopyWeapon) == 0x000110, "Wrong size on BP_Player_ForUI_C_CopyWeapon");
...
static_assert(offsetof(BP_Player_ForUI_C_CopyWeapon, CallFunc_GetEquipSocketName_ReturnValue) == 0x0000C0, "Member 'BP_Player_ForUI_C_CopyWeapon::CallFunc_GetEquipSocketName_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Player_ForUI_C_CopyWeapon, CallFunc_GetAttachedActors_OutActors) == 0x0000C8, "Member 'BP_Player_ForUI_C_CopyWeapon::CallFunc_GetAttachedActors_OutActors' has a wrong offset!");
static_assert(offsetof(BP_Player_ForUI_C_CopyWeapon, CallFunc_Map_Find_Value) == 0x0000D8, "Member 'BP_Player_ForUI_C_CopyWeapon::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(BP_Player_ForUI_C_CopyWeapon, CallFunc_Map_Find_ReturnValue) == 0x0000E0, "Member 'BP_Player_ForUI_C_CopyWeapon::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Player_ForUI_C_CopyWeapon, CallFunc_Array_Get_Item) == 0x0000E8, "Member 'BP_Player_ForUI_C_CopyWeapon::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_Player_ForUI_C_CopyWeapon, K2Node_DynamicCast_AsPal_Weapon_Base) == 0x0000F0, "Member 'BP_Player_ForUI_C_CopyWeapon::K2Node_DynamicCast_AsPal_Weapon_Base' has a wrong offset!");
static_assert(offsetof(BP_Player_ForUI_C_CopyWeapon, K2Node_DynamicCast_bSuccess_1) == 0x0000F8, "Member 'BP_Player_ForUI_C_CopyWeapon::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(BP_Player_ForUI_C_CopyWeapon, CallFunc_Array_Length_ReturnValue) == 0x0000FC, "Member 'BP_Player_ForUI_C_CopyWeapon::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Player_ForUI_C_CopyWeapon, CallFunc_Less_IntInt_ReturnValue) == 0x000100, "Member 'BP_Player_ForUI_C_CopyWeapon::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
