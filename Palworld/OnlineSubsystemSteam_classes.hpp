...
{
public:
	bool                                          bIsPassthrough;                                    // 0x33A0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_33A1[0xF];                                     // 0x33A1(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USteamNetConnection) == 0x0033B0, "Wrong size on USteamNetConnection");
static_assert(offsetof(USteamNetConnection, bIsPassthrough) == 0x0033A0, "Member 'USteamNetConnection::bIsPassthrough' has a wrong offset!");
