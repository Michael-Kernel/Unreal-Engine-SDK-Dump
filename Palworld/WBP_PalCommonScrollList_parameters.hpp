...
static_assert(offsetof(WBP_PalCommonScrollList_C_GetAllChildrenNum, Index_0) == 0x000000, "Member 'WBP_PalCommonScrollList_C_GetAllChildrenNum::Index_0' has a wrong offset!");
...
static_assert(offsetof(WBP_PalCommonScrollList_C_GetIndexFromWidget, Index_0) == 0x000008, "Member 'WBP_PalCommonScrollList_C_GetIndexFromWidget::Index_0' has a wrong offset!");
