...
static_assert(offsetof(WBP_CharaCre_C_CustomNavi_ToCategoryTop, Navigation_0) == 0x000000, "Member 'WBP_CharaCre_C_CustomNavi_ToCategoryTop::Navigation_0' has a wrong offset!");
...
static_assert(offsetof(WBP_CharaCre_C_CustomNavi_ToNameChange, Navigation_0) == 0x000000, "Member 'WBP_CharaCre_C_CustomNavi_ToNameChange::Navigation_0' has a wrong offset!");
