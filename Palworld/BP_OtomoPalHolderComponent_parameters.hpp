...
static_assert(offsetof(BP_OtomoPalHolderComponent_C_SetSelectOtomoID_Internal, Index_0) == 0x000000, "Member 'BP_OtomoPalHolderComponent_C_SetSelectOtomoID_Internal::Index_0' has a wrong offset!");
...
public:
	...
	class UPalNavigationInvokerComponent*         CallFunc_GetComponentByClass_ReturnValue_1;        // 0x0080(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UPalIndividualCharacterHandle*          CallFunc_GetOtomoIndividualHandle_ReturnValue_1;   // 0x00B8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalIndividualCharacterParameter*       CallFunc_TryGetIndividualParameter_ReturnValue;    // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(const struct FPalDeadInfo& DeadInfo)> K2Node_CreateDelegate_OutputDelegate_1;            // 0x00E0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Spawn_Character_Callback, CallFunc_GetComponentByClass_ReturnValue_2) == 0x000090, "Member 'BP_OtomoPalHolderComponent_C_Spawn_Character_Callback::CallFunc_GetComponentByClass_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Spawn_Character_Callback, CallFunc_IsValid_ReturnValue_2) == 0x000098, "Member 'BP_OtomoPalHolderComponent_C_Spawn_Character_Callback::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Spawn_Character_Callback, K2Node_CreateDelegate_OutputDelegate) == 0x00009C, "Member 'BP_OtomoPalHolderComponent_C_Spawn_Character_Callback::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Spawn_Character_Callback, CallFunc_GetOtomoIndividualHandle_ReturnValue) == 0x0000B0, "Member 'BP_OtomoPalHolderComponent_C_Spawn_Character_Callback::CallFunc_GetOtomoIndividualHandle_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Spawn_Character_Callback, CallFunc_GetOtomoIndividualHandle_ReturnValue_1) == 0x0000B8, "Member 'BP_OtomoPalHolderComponent_C_Spawn_Character_Callback::CallFunc_GetOtomoIndividualHandle_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Spawn_Character_Callback, CallFunc_TryGetIndividualParameter_ReturnValue) == 0x0000C0, "Member 'BP_OtomoPalHolderComponent_C_Spawn_Character_Callback::CallFunc_TryGetIndividualParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Spawn_Character_Callback, CallFunc_TryGetIndividualActor_ReturnValue) == 0x0000C8, "Member 'BP_OtomoPalHolderComponent_C_Spawn_Character_Callback::CallFunc_TryGetIndividualActor_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Spawn_Character_Callback, K2Node_CreateDelegate_OutputDelegate_1) == 0x0000E0, "Member 'BP_OtomoPalHolderComponent_C_Spawn_Character_Callback::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Spawn_Character_Callback, K2Node_DynamicCast_AsPal_AIController) == 0x0000F0, "Member 'BP_OtomoPalHolderComponent_C_Spawn_Character_Callback::K2Node_DynamicCast_AsPal_AIController' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Spawn_Character_Callback, K2Node_DynamicCast_bSuccess_1) == 0x0000F8, "Member 'BP_OtomoPalHolderComponent_C_Spawn_Character_Callback::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
