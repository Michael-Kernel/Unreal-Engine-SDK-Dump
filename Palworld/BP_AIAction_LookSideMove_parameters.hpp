...
static_assert(offsetof(BP_AIAction_LookSideMove_C_CheckWalkable, SelfToTarget_0) == 0x000090, "Member 'BP_AIAction_LookSideMove_C_CheckWalkable::SelfToTarget_0' has a wrong offset!");
