...
static_assert(offsetof(WBP_PalInteractiveObjectIndicatorUI_C_Update_Button_Type, CanToggle_0) == 0x000011, "Member 'WBP_PalInteractiveObjectIndicatorUI_C_Update_Button_Type::CanToggle_0' has a wrong offset!");
