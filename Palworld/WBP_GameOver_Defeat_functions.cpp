...
#include "WBP_GameOver_Defeat_classes.hpp"
#include "WBP_GameOver_Defeat_parameters.hpp"
...
void UWBP_GameOver_Defeat_C::ExecuteUbergraph_WBP_GameOver_Defeat(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::WBP_GameOver_Defeat_C_ExecuteUbergraph_WBP_GameOver_Defeat Parms{};
...
// Parameters:
// EPalOptionWorldDeathPenalty             PenaltyMode                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_GameOver_Defeat_C::SetDeathPenaltyMode(EPalOptionWorldDeathPenalty PenaltyMode)
{
	static class UFunction* Func = nullptr;
	...
	Params::WBP_GameOver_Defeat_C_SetDeathPenaltyMode Parms{};
...
void UWBP_GameOver_Defeat_C::SetDropPalInfo(TArray<struct FPalLogInfo_DropPal>& DropPalInfo)
{
	static class UFunction* Func = nullptr;
	...
	Params::WBP_GameOver_Defeat_C_SetDropPalInfo Parms{};

	Parms.DropPalInfo = std::move(DropPalInfo);

	UObject::ProcessEvent(Func, &Parms);

	DropPalInfo = std::move(Parms.DropPalInfo);
}
...
void UWBP_GameOver_Defeat_C::SetRemainingTime(int32 RemainingSecond)
{
	static class UFunction* Func = nullptr;
	...
	Params::WBP_GameOver_Defeat_C_SetRemainingTime Parms{};
