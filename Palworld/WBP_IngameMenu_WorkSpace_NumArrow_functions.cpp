...
// Function WBP_IngameMenu_WorkSpace_NumArrow.WBP_IngameMenu_WorkSpace_NumArrow_C.ArrowClicked_Progressive
// (BlueprintCallable, BlueprintEvent)

void UWBP_IngameMenu_WorkSpace_NumArrow_C::ArrowClicked_Progressive()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IngameMenu_WorkSpace_NumArrow_C", "ArrowClicked_Progressive");
...
// Function WBP_IngameMenu_WorkSpace_NumArrow.WBP_IngameMenu_WorkSpace_NumArrow_C.OnArrowPressed
// (BlueprintCallable, BlueprintEvent)

void UWBP_IngameMenu_WorkSpace_NumArrow_C::OnArrowPressed()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IngameMenu_WorkSpace_NumArrow_C", "OnArrowPressed");

	UObject::ProcessEvent(Func, nullptr);
}


// Function WBP_IngameMenu_WorkSpace_NumArrow.WBP_IngameMenu_WorkSpace_NumArrow_C.OnArrowReleased
// (BlueprintCallable, BlueprintEvent)

void UWBP_IngameMenu_WorkSpace_NumArrow_C::OnArrowReleased()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IngameMenu_WorkSpace_NumArrow_C", "OnArrowReleased");
...
void UWBP_IngameMenu_WorkSpace_NumArrow_C::OnClicked__DelegateSignature(int32 Progress)
{
	static class UFunction* Func = nullptr;
	...
	Params::WBP_IngameMenu_WorkSpace_NumArrow_C_OnClicked__DelegateSignature Parms{};
