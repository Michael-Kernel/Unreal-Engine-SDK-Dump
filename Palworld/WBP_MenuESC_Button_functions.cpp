...
// Parameters:
// E_PalEscMenuType                        MenuType_0                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_MenuESC_Button_C::OnClicked__DelegateSignature(E_PalEscMenuType MenuType_0)
{
	static class UFunction* Func = nullptr;
