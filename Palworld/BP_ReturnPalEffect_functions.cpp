...
// class APalCharacter*                    ForPlayer_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_ReturnPalEffect_C::StartReturn(class APalCharacter* ReturnPal, class APalCharacter* ForPlayer_0)
{
	static class UFunction* Func = nullptr;
