...
public:
	...
	static struct FMovieSceneObjectBindingID GetBindingID(const struct FMovieSceneBindingProxy& InBinding);
	...
	static struct FMovieSceneObjectBindingID GetPortableBindingID(class UMovieSceneSequence* MasterSequence, class UMovieSceneSequence* DestinationSequence, const struct FMovieSceneBindingProxy& InBinding);
