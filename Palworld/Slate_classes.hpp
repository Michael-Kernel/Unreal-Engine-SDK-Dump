...
// 0x0E90 (0x0EC0 - 0x0030)
class UEditableTextBoxWidgetStyle final : public USlateWidgetStyleContainerBase
{
public:
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0030(0x0E90)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextBoxWidgetStyle) == 0x000EC0, "Wrong size on UEditableTextBoxWidgetStyle");
...
{
public:
	struct FTextBlockStyle                        TextBlockStyle;                                    // 0x0030(0x0350)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTextBlockWidgetStyle) == 0x000380, "Wrong size on UTextBlockWidgetStyle");
