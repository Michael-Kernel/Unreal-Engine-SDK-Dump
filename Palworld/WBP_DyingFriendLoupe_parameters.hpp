...
static_assert(offsetof(WBP_DyingFriendLoupe_C_GetLoupeWidgetSize, WidgetSize_0) == 0x000000, "Member 'WBP_DyingFriendLoupe_C_GetLoupeWidgetSize::WidgetSize_0' has a wrong offset!");
