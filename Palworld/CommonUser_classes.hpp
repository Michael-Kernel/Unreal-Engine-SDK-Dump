...
static_assert(sizeof(UCommonSession_HostSessionRequest) == 0x0000D8, "Wrong size on UCommonSession_HostSessionRequest");
...
static_assert(offsetof(UCommonSession_HostSessionRequest, Map) == 0x000050, "Member 'UCommonSession_HostSessionRequest::Map' has a wrong offset!");
static_assert(offsetof(UCommonSession_HostSessionRequest, ExtraArgs) == 0x000080, "Member 'UCommonSession_HostSessionRequest::ExtraArgs' has a wrong offset!");
static_assert(offsetof(UCommonSession_HostSessionRequest, MaxPlayerCount) == 0x0000D0, "Member 'UCommonSession_HostSessionRequest::MaxPlayerCount' has a wrong offset!");
