...
public:
	...
	bool                                          EmptySet;                                          // 0x0458(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_PalInGameMenuItemIcon_C) == 0x000460, "Wrong size on UWBP_PalInGameMenuItemIcon_C");
...
static_assert(offsetof(UWBP_PalInGameMenuItemIcon_C, EmptySet) == 0x000458, "Member 'UWBP_PalInGameMenuItemIcon_C::EmptySet' has a wrong offset!");
