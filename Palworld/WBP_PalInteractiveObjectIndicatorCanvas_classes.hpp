...
public:
	...
	struct FPalInteractiveObjectActionInfoData    OtomoIndicatorActionInfo;                          // 0x04C0(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	bool                                          bOtomoIndicatorDisplaying;                         // 0x04D0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4D1[0x7];                                      // 0x04D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        OtomoInteractDistance;                             // 0x04D8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_PalInteractiveObjectIndicatorCanvas_C) == 0x0004E0, "Wrong size on UWBP_PalInteractiveObjectIndicatorCanvas_C");
...
static_assert(offsetof(UWBP_PalInteractiveObjectIndicatorCanvas_C, bOtomoIndicatorDisplaying) == 0x0004D0, "Member 'UWBP_PalInteractiveObjectIndicatorCanvas_C::bOtomoIndicatorDisplaying' has a wrong offset!");
static_assert(offsetof(UWBP_PalInteractiveObjectIndicatorCanvas_C, OtomoInteractDistance) == 0x0004D8, "Member 'UWBP_PalInteractiveObjectIndicatorCanvas_C::OtomoInteractDistance' has a wrong offset!");
