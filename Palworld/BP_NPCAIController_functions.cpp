...
// Parameters:
// class UPalNPCAIWeaponHandle*            WeaponHandle_0                                         (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_NPCAIController_C::GetWeaponHandle(class UPalNPCAIWeaponHandle** WeaponHandle_0)
{
	static class UFunction* Func = nullptr;
	...
	if (WeaponHandle_0 != nullptr)
		*WeaponHandle_0 = Parms.WeaponHandle_0;
}
...
// struct FF_NPC_PathWalkArray             PathWalk_0                                             (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
...
void ABP_NPCAIController_C::SetSpawnedInfo(const struct FVector& SpawnerLoc, double ReturnRadius, const struct FF_NPC_PathWalkArray& PathWalk_0, class FName Otomo)
{
	static class UFunction* Func = nullptr;
	...
	Parms.PathWalk_0 = std::move(PathWalk_0);
	Parms.Otomo = Otomo;
