...
struct FMovieSceneObjectBindingID UMovieSceneSequenceExtensions::GetBindingID(const struct FMovieSceneBindingProxy& InBinding)
{
	static class UFunction* Func = nullptr;
...
struct FMovieSceneObjectBindingID UMovieSceneSequenceExtensions::GetPortableBindingID(class UMovieSceneSequence* MasterSequence, class UMovieSceneSequence* DestinationSequence, const struct FMovieSceneBindingProxy& InBinding)
{
	static class UFunction* Func = nullptr;
