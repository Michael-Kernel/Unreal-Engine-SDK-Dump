...
void ABP_PalSphere_Body_C::OnPassingCapturePhase______0(int32 PhaseCount, class UPalIndividualCharacterHandle* TargetHandle_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_PalSphere_Body_C_OnPassingCapturePhase______0 Parms{};
