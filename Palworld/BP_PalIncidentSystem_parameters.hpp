...
static_assert(offsetof(BP_PalIncidentSystem_C_Lottery_Index_by_Weights, Index_0) == 0x000010, "Member 'BP_PalIncidentSystem_C_Lottery_Index_by_Weights::Index_0' has a wrong offset!");
