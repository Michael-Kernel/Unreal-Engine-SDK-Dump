...
struct BP_PalGamemode_C__________0 final
{
public:
...
static_assert(alignof(BP_PalGamemode_C__________0) == 0x000008, "Wrong alignment on BP_PalGamemode_C__________0");
static_assert(sizeof(BP_PalGamemode_C__________0) == 0x000028, "Wrong size on BP_PalGamemode_C__________0");
static_assert(offsetof(BP_PalGamemode_C__________0, SoundRadius) == 0x000000, "Member 'BP_PalGamemode_C__________0::SoundRadius' has a wrong offset!");
static_assert(offsetof(BP_PalGamemode_C__________0, EmitLocation) == 0x000008, "Member 'BP_PalGamemode_C__________0::EmitLocation' has a wrong offset!");
static_assert(offsetof(BP_PalGamemode_C__________0, Emitter) == 0x000020, "Member 'BP_PalGamemode_C__________0::Emitter' has a wrong offset!");
