...
static_assert(offsetof(BP_Action_GeneralWorkAttack_C_OnSpawnEffect, Effect_0) == 0x000000, "Member 'BP_Action_GeneralWorkAttack_C_OnSpawnEffect::Effect_0' has a wrong offset!");
