...
static_assert(sizeof(AChaosCacheManager) == 0x000338, "Wrong size on AChaosCacheManager");
...
static_assert(sizeof(AChaosCachePlayer) == 0x000338, "Wrong size on AChaosCachePlayer");
