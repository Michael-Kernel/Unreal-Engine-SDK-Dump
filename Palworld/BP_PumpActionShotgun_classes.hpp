...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_PumpActionShotgun_C;             // 0x05A8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UAnimMontage*                           Montage_to_Play;                                   // 0x05B0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class UAnimSequence*                          FireAnim;                                          // 0x05B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_PumpActionShotgun_C) == 0x0005C0, "Wrong size on ABP_PumpActionShotgun_C");
static_assert(offsetof(ABP_PumpActionShotgun_C, UberGraphFrame_BP_PumpActionShotgun_C) == 0x0005A8, "Member 'ABP_PumpActionShotgun_C::UberGraphFrame_BP_PumpActionShotgun_C' has a wrong offset!");
static_assert(offsetof(ABP_PumpActionShotgun_C, Montage_to_Play) == 0x0005B0, "Member 'ABP_PumpActionShotgun_C::Montage_to_Play' has a wrong offset!");
static_assert(offsetof(ABP_PumpActionShotgun_C, FireAnim) == 0x0005B8, "Member 'ABP_PumpActionShotgun_C::FireAnim' has a wrong offset!");
