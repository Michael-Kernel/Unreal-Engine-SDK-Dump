...
void UWBP_MainMenu_Pal_00_C::OnToggleFavoritePal__DelegateSignature(class UPalIndividualCharacterHandle* CharacterHandle)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_MainMenu_Pal_00_C", "OnToggleFavoritePal__DelegateSignature");

	Params::WBP_MainMenu_Pal_00_C_OnToggleFavoritePal__DelegateSignature Parms{};
...
void UWBP_MainMenu_Pal_00_C::UpdateFavorite_Binded()
{
	static class UFunction* Func = nullptr;
