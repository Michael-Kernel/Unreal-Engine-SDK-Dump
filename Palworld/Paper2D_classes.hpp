...
{
public:
	class UPaperFlipbookComponent*                Sprite;                                            // 0x0618(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(APaperCharacter) == 0x000620, "Wrong size on APaperCharacter");
static_assert(offsetof(APaperCharacter, Sprite) == 0x000618, "Member 'APaperCharacter::Sprite' has a wrong offset!");
...
static_assert(sizeof(APaperGroupedSpriteActor) == 0x000298, "Wrong size on APaperGroupedSpriteActor");
static_assert(offsetof(APaperGroupedSpriteActor, RenderComponent) == 0x000290, "Member 'APaperGroupedSpriteActor::RenderComponent' has a wrong offset!");
...
static_assert(offsetof(APaperSpriteActor, RenderComponent) == 0x000290, "Member 'APaperSpriteActor::RenderComponent' has a wrong offset!");
...
static_assert(sizeof(APaperTileMapActor) == 0x000298, "Wrong size on APaperTileMapActor");
static_assert(offsetof(APaperTileMapActor, RenderComponent) == 0x000290, "Member 'APaperTileMapActor::RenderComponent' has a wrong offset!");
...
static_assert(sizeof(APaperTerrainActor) == 0x0002A8, "Wrong size on APaperTerrainActor");
static_assert(offsetof(APaperTerrainActor, DummyRoot) == 0x000290, "Member 'APaperTerrainActor::DummyRoot' has a wrong offset!");
static_assert(offsetof(APaperTerrainActor, SplineComponent) == 0x000298, "Member 'APaperTerrainActor::SplineComponent' has a wrong offset!");
static_assert(offsetof(APaperTerrainActor, RenderComponent) == 0x0002A0, "Member 'APaperTerrainActor::RenderComponent' has a wrong offset!");
