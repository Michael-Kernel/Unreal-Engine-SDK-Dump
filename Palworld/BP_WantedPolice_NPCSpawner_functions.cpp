...
void ABP_WantedPolice_NPCSpawner_C::HasWeapon(class ABP_NPCAIController_C* NPCController, bool* HasWeapon_0)
{
	static class UFunction* Func = nullptr;
...
// bool                                    IsSelf_0                                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_WantedPolice_NPCSpawner_C::IsSelf(class UPalIndividualCharacterHandle* CharacterHandle, bool* IsSelf_0)
{
	static class UFunction* Func = nullptr;
