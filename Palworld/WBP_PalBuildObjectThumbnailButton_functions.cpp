...
// Parameters:
// struct FPalBuildObjectData              BuildObjectData_0                                      (Parm, OutParm)

void UWBP_PalBuildObjectThumbnailButton_C::GetBuildObjectData(struct FPalBuildObjectData* BuildObjectData_0)
{
	static class UFunction* Func = nullptr;
	...
	if (BuildObjectData_0 != nullptr)
		*BuildObjectData_0 = std::move(Parms.BuildObjectData_0);
}
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FPalBuildObjectData              BuildObjectData_0                                      (BlueprintVisible, BlueprintReadOnly, Parm)

void UWBP_PalBuildObjectThumbnailButton_C::Setup(const struct FPalBuildObjectData& BuildObjectData_0)
{
	static class UFunction* Func = nullptr;
