...
// Parameters:
// class UPalMapObjectGenerateEnergyModel* Model_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UWBP_PalWorkPowerPlant_C::OnUpdateEnergyStack(class UPalMapObjectGenerateEnergyModel* Model_0)
{
	static class UFunction* Func = nullptr;
