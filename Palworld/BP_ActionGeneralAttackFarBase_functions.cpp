...
void UBP_ActionGeneralAttackFarBase_C::BulletHasShooted(class APalSkillEffectBase* Effect_0)
{
	static class UFunction* Func = nullptr;
...
bool UBP_ActionGeneralAttackFarBase_C::IsSpecificEffect(class APalSkillEffectBase* Effect_0, EEffectSpawnParametersType ParametersType, int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
void UBP_ActionGeneralAttackFarBase_C::OnSpawnEffect(class APalSkillEffectBase* Effect_0)
{
	static class UFunction* Func = nullptr;
...
void UBP_ActionGeneralAttackFarBase_C::SetBulletSpeed(class APalSkillEffectBase** Effect_0)
{
	static class UFunction* Func = nullptr;
...
void UBP_ActionGeneralAttackFarBase_C::SetHomingTarget(class APalSkillEffectBase* Effect_0)
{
	static class UFunction* Func = nullptr;
