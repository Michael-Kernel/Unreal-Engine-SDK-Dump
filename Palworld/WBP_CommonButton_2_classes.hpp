...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_CommonButton_2_C">();
	}
...
static_assert(alignof(UWBP_CommonButton_2_C) == 0x000008, "Wrong alignment on UWBP_CommonButton_2_C");
static_assert(sizeof(UWBP_CommonButton_2_C) == 0x000318, "Wrong size on UWBP_CommonButton_2_C");
static_assert(offsetof(UWBP_CommonButton_2_C, UberGraphFrame) == 0x000278, "Member 'UWBP_CommonButton_2_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, Anm_NormalToFocus) == 0x000280, "Member 'UWBP_CommonButton_2_C::Anm_NormalToFocus' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, Anm_OpenFocus) == 0x000288, "Member 'UWBP_CommonButton_2_C::Anm_OpenFocus' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, Anm_Normal) == 0x000290, "Member 'UWBP_CommonButton_2_C::Anm_Normal' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, IconSlot) == 0x000298, "Member 'UWBP_CommonButton_2_C::IconSlot' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, Text_Main) == 0x0002A0, "Member 'UWBP_CommonButton_2_C::Text_Main' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, WBP_PalInvisibleButton) == 0x0002A8, "Member 'UWBP_CommonButton_2_C::WBP_PalInvisibleButton' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, OnClicked) == 0x0002B0, "Member 'UWBP_CommonButton_2_C::OnClicked' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, Is_First_Focus_Target) == 0x0002C0, "Member 'UWBP_CommonButton_2_C::Is_First_Focus_Target' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, OnHovered) == 0x0002C8, "Member 'UWBP_CommonButton_2_C::OnHovered' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, OnUnhovered) == 0x0002D8, "Member 'UWBP_CommonButton_2_C::OnUnhovered' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, InitializeMsgID) == 0x0002E8, "Member 'UWBP_CommonButton_2_C::InitializeMsgID' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, OverrideHover) == 0x0002F8, "Member 'UWBP_CommonButton_2_C::OverrideHover' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, WWiseHoverAudio) == 0x000300, "Member 'UWBP_CommonButton_2_C::WWiseHoverAudio' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, UnhoverAKAudioEvent) == 0x000308, "Member 'UWBP_CommonButton_2_C::UnhoverAKAudioEvent' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_2_C, ClickAKAudioEvent) == 0x000310, "Member 'UWBP_CommonButton_2_C::ClickAKAudioEvent' has a wrong offset!");
