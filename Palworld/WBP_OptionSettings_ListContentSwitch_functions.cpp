...
void UWBP_OptionSettings_ListContentSwitch_C::Setup(bool IsOn_0)
{
	static class UFunction* Func = nullptr;
...
void UWBP_OptionSettings_ListContentSwitch_C::OnSwitcherChanged__DelegateSignature(bool IsOn_0)
{
	static class UFunction* Func = nullptr;
