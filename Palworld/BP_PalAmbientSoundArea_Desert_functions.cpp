...
#include "BP_PalAmbientSoundArea_Desert_classes.hpp"
#include "BP_PalAmbientSoundArea_Desert_parameters.hpp"
...
class UPrimitiveComponent* ABP_PalAmbientSoundArea_Desert_C::GetAreaCollision() const
{
	...
	Params::BP_PalAmbientSoundArea_Desert_C_GetAreaCollision Parms{};
