...
static_assert(offsetof(BP_VisualEffect_CameraMosaic_C_Update_Mosaic, Weight_Value_0) == 0x000000, "Member 'BP_VisualEffect_CameraMosaic_C_Update_Mosaic::Weight_Value_0' has a wrong offset!");
