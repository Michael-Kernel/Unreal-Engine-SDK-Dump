...
public:
	...
	TMap<EPalWorkSuitability, int32>              CallFunc_GetWorkSuitabilityRank_WorkSuitabilities; // 0x0040(0x0050)()
...
static_assert(sizeof(WBP_Paldex_PalInfo_00_C_Setup) == 0x000098, "Wrong size on WBP_Paldex_PalInfo_00_C_Setup");
...
static_assert(offsetof(WBP_Paldex_PalInfo_00_C_Setup, CallFunc_GetWorkSuitabilityRank_WorkSuitabilities) == 0x000040, "Member 'WBP_Paldex_PalInfo_00_C_Setup::CallFunc_GetWorkSuitabilityRank_WorkSuitabilities' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_PalInfo_00_C_Setup, K2Node_SwitchEnum_CmpSuccess) == 0x000090, "Member 'WBP_Paldex_PalInfo_00_C_Setup::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
...
static_assert(alignof(WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo) == 0x000008, "Wrong alignment on WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo");
static_assert(sizeof(WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo) == 0x000028, "Wrong size on WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo");
static_assert(offsetof(WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo, CharacterID) == 0x000000, "Member 'WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo::CharacterID' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo, CallFunc_GetLocalRecordData_ReturnValue) == 0x000008, "Member 'WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo::CallFunc_GetLocalRecordData_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo, CallFunc_GetRecordData_Int_ReturnValue) == 0x000010, "Member 'WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo::CallFunc_GetRecordData_Int_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo, CallFunc_GetRecordData_Int_ReturnValue_1) == 0x000014, "Member 'WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo::CallFunc_GetRecordData_Int_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000018, "Member 'WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo, CallFunc_Greater_IntInt_ReturnValue) == 0x000019, "Member 'WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo, CallFunc_Min_ReturnValue) == 0x00001C, "Member 'WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo::CallFunc_Min_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo, CallFunc_BooleanAND_ReturnValue) == 0x000020, "Member 'WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo, CallFunc_SelectInt_ReturnValue) == 0x000024, "Member 'WBP_Paldex_PalInfo_00_C_SetupCaptureBonusInfo::CallFunc_SelectInt_ReturnValue' has a wrong offset!");
