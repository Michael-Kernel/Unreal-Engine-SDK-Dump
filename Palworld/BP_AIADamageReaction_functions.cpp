...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// bool                                    HasSideStep_0                                          (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_AIADamageReaction_C::HasSideStep(bool* HasSideStep_0)
{
	static class UFunction* Func = nullptr;
	...
	if (HasSideStep_0 != nullptr)
		*HasSideStep_0 = Parms.HasSideStep_0;
}
...
void UBP_AIADamageReaction_C::IsRiding(bool* IsRiding_0)
{
	static class UFunction* Func = nullptr;
