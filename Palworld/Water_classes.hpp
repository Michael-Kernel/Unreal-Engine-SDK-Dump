...
static_assert(sizeof(AWaterZone) == 0x000320, "Wrong size on AWaterZone");
...
static_assert(offsetof(AWaterZone, TessellatedWaterMeshExtent) == 0x0002D8, "Member 'AWaterZone::TessellatedWaterMeshExtent' has a wrong offset!");
static_assert(offsetof(AWaterZone, NonTessellatedLODSectionScale) == 0x0002F0, "Member 'AWaterZone::NonTessellatedLODSectionScale' has a wrong offset!");
static_assert(offsetof(AWaterZone, OverlapPriority) == 0x0002F4, "Member 'AWaterZone::OverlapPriority' has a wrong offset!");
static_assert(offsetof(AWaterZone, bEnableNonTessellatedLODMesh) == 0x0002F8, "Member 'AWaterZone::bEnableNonTessellatedLODMesh' has a wrong offset!");
...
static_assert(sizeof(AWaterBody) == 0x0002C0, "Wrong size on AWaterBody");
...
public:
	...
	uint8                                         Pad_14D8[0x50];                                    // 0x14D8(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AWaterBodyCustom) == 0x0002C0, "Wrong size on AWaterBodyCustom");
...
static_assert(offsetof(AWaterBodyExclusionVolume, bExcludeAllOverlappingWaterBodies) == 0x0002D8, "Member 'AWaterBodyExclusionVolume::bExcludeAllOverlappingWaterBodies' has a wrong offset!");
static_assert(offsetof(AWaterBodyExclusionVolume, WaterBodiesToExclude) == 0x0002E0, "Member 'AWaterBodyExclusionVolume::WaterBodiesToExclude' has a wrong offset!");
...
static_assert(sizeof(AWaterBodyLake) == 0x0002C0, "Wrong size on AWaterBodyLake");
...
static_assert(sizeof(AWaterBodyOcean) == 0x0002C0, "Wrong size on AWaterBodyOcean");
...
static_assert(sizeof(AWaterBodyRiver) == 0x0002C0, "Wrong size on AWaterBodyRiver");
