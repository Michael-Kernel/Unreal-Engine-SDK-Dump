...
#include "WBP_IngameCompass_FastTravel_classes.hpp"
#include "WBP_IngameCompass_FastTravel_parameters.hpp"
...
void UWBP_IngameCompass_FastTravel_C::SetDistanceText(double Length)
{
	...
	Params::WBP_IngameCompass_FastTravel_C_SetDistanceText Parms{};
...
void UWBP_IngameCompass_FastTravel_C::SetupTexture(TSoftObjectPtr<class UTexture2D> SoftTexture)
{
	...
	Params::WBP_IngameCompass_FastTravel_C_SetupTexture Parms{};
