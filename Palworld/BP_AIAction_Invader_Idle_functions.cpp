...
#include "BP_AIAction_Invader_Idle_classes.hpp"
#include "BP_AIAction_Invader_Idle_parameters.hpp"
...
void UBP_AIAction_Invader_Idle_C::ActionStart(class APawn* ControlledPawn)
{
	...
	Params::BP_AIAction_Invader_Idle_C_ActionStart Parms{};
...
void UBP_AIAction_Invader_Idle_C::ExecuteUbergraph_BP_AIAction_Invader_Idle(int32 EntryPoint)
{
	...
	Params::BP_AIAction_Invader_Idle_C_ExecuteUbergraph_BP_AIAction_Invader_Idle Parms{};
