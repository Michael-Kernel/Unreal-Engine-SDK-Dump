...
// Parameters:
// TMap<EPalCharacterStatusOperationName, int32>Status_0                                               (BlueprintVisible, BlueprintReadOnly, Parm)

void UWBP_Buildup_Pal_Status_C::InvokeRankup__DelegateSignature(const TMap<EPalCharacterStatusOperationName, int32>& Status_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Status_0 = std::move(Status_0);
