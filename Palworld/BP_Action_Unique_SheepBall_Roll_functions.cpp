...
// Parameters:
// class UPalAttackFilter*                 AttackFilter_0                                         (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UBP_Action_Unique_SheepBall_Roll_C::GetAttackFilter(class UPalAttackFilter** AttackFilter_0)
{
	static class UFunction* Func = nullptr;
	...
	if (AttackFilter_0 != nullptr)
		*AttackFilter_0 = Parms.AttackFilter_0;
}
