...
void UABP_NPC_Base_C::AnimGraph(struct FPoseLink* AnimGraph_0)
{
...
// struct FPoseLink                        LeftHandIK_0                                           (Parm, OutParm, NoDestructor)

void UABP_NPC_Base_C::LeftHandIK(const struct FPoseLink& InPose_LeftHand, struct FPoseLink* LeftHandIK_0)
{
	static class UFunction* Func = nullptr;
	...
	if (LeftHandIK_0 != nullptr)
		*LeftHandIK_0 = std::move(Parms.LeftHandIK_0);
}
...
void UABP_NPC_Base_C::NPC_HairClothLayer(const struct FPoseLink& InPose, struct FPoseLink* NPC_HairClothLayer_0)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct FPoseLink                        InPose                                                 (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
// struct FPoseLink                        WeaponUpper_0                                          (Parm, OutParm, NoDestructor)

void UABP_NPC_Base_C::WeaponUpper(const struct FPoseLink& InPose, struct FPoseLink* WeaponUpper_0)
{
	static class UFunction* Func = nullptr;
	...
	if (WeaponUpper_0 != nullptr)
		*WeaponUpper_0 = std::move(Parms.WeaponUpper_0);
}
