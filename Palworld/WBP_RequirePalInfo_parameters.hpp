...
static_assert(sizeof(WBP_RequirePalInfo_C_ShouldDisplayPathDetail) == 0x000068, "Wrong size on WBP_RequirePalInfo_C_ShouldDisplayPathDetail");
...
static_assert(offsetof(WBP_RequirePalInfo_C_ShouldDisplayPathDetail, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000010, "Member 'WBP_RequirePalInfo_C_ShouldDisplayPathDetail::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_RequirePalInfo_C_ShouldDisplayPathDetail, CallFunc_GetPalmi_ReturnValue) == 0x000028, "Member 'WBP_RequirePalInfo_C_ShouldDisplayPathDetail::CallFunc_GetPalmi_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_RequirePalInfo_C_ShouldDisplayPathDetail, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x000030, "Member 'WBP_RequirePalInfo_C_ShouldDisplayPathDetail::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_RequirePalInfo_C_ShouldDisplayPathDetail, CallFunc_IsValid_ReturnValue) == 0x000048, "Member 'WBP_RequirePalInfo_C_ShouldDisplayPathDetail::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_RequirePalInfo_C_ShouldDisplayPathDetail, CallFunc_Vector_Distance_ReturnValue) == 0x000050, "Member 'WBP_RequirePalInfo_C_ShouldDisplayPathDetail::CallFunc_Vector_Distance_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_RequirePalInfo_C_ShouldDisplayPathDetail, CallFunc_Less_DoubleDouble_ReturnValue) == 0x000058, "Member 'WBP_RequirePalInfo_C_ShouldDisplayPathDetail::CallFunc_Less_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_RequirePalInfo_C_ShouldDisplayPathDetail, CallFunc_Less_DoubleDouble_B_ImplicitCast) == 0x000060, "Member 'WBP_RequirePalInfo_C_ShouldDisplayPathDetail::CallFunc_Less_DoubleDouble_B_ImplicitCast' has a wrong offset!");
