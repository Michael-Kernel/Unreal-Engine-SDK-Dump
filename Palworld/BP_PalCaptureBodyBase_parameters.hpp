...
static_assert(offsetof(BP_PalCaptureBodyBase_C_GetTargetHandle, TargetHandle_0) == 0x000000, "Member 'BP_PalCaptureBodyBase_C_GetTargetHandle::TargetHandle_0' has a wrong offset!");
...
static_assert(offsetof(BP_PalCaptureBodyBase_C_OnBouncedBody__DelegateSignature, TargetHandle_0) == 0x000008, "Member 'BP_PalCaptureBodyBase_C_OnBouncedBody__DelegateSignature::TargetHandle_0' has a wrong offset!");
...
static_assert(offsetof(BP_PalCaptureBodyBase_C_OnFailedCapture__DelegateSignature, TargetHandle_0) == 0x000000, "Member 'BP_PalCaptureBodyBase_C_OnFailedCapture__DelegateSignature::TargetHandle_0' has a wrong offset!");
...
static_assert(offsetof(BP_PalCaptureBodyBase_C_OnPassingCapturePhase__DelegateSignature, TargetHandle_0) == 0x000008, "Member 'BP_PalCaptureBodyBase_C_OnPassingCapturePhase__DelegateSignature::TargetHandle_0' has a wrong offset!");
...
static_assert(offsetof(BP_PalCaptureBodyBase_C_OnSuccessedCapture__DelegateSignature, TargetHandle_0) == 0x000000, "Member 'BP_PalCaptureBodyBase_C_OnSuccessedCapture__DelegateSignature::TargetHandle_0' has a wrong offset!");
...
static_assert(offsetof(BP_PalCaptureBodyBase_C_SetTargetHandle, TargetHandle_0) == 0x000000, "Member 'BP_PalCaptureBodyBase_C_SetTargetHandle::TargetHandle_0' has a wrong offset!");
