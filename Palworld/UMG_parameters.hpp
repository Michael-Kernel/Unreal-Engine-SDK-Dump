...
static_assert(sizeof(RichTextBlock_SetDefaultTextStyle) == 0x000350, "Wrong size on RichTextBlock_SetDefaultTextStyle");
...
static_assert(sizeof(MultiLineEditableText_SetWidgetStyle) == 0x000350, "Wrong size on MultiLineEditableText_SetWidgetStyle");
...
static_assert(sizeof(MultiLineEditableTextBox_SetTextStyle) == 0x000350, "Wrong size on MultiLineEditableTextBox_SetTextStyle");
