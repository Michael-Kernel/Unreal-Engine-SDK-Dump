...
static_assert(offsetof(WBP_PalItemSlotBase_C_On_Update_Slot_Internal, Slot_0) == 0x000000, "Member 'WBP_PalItemSlotBase_C_On_Update_Slot_Internal::Slot_0' has a wrong offset!");
...
static_assert(offsetof(WBP_PalItemSlotBase_C_OnUpdateSlot__DelegateSignature, TargetSlot_0) == 0x000000, "Member 'WBP_PalItemSlotBase_C_OnUpdateSlot__DelegateSignature::TargetSlot_0' has a wrong offset!");
...
static_assert(offsetof(WBP_PalItemSlotBase_C_OnUpdateSlotCorruption_Internal, Slot_0) == 0x000000, "Member 'WBP_PalItemSlotBase_C_OnUpdateSlotCorruption_Internal::Slot_0' has a wrong offset!");
...
static_assert(offsetof(WBP_PalItemSlotBase_C_Setup, TargetSlot_0) == 0x000000, "Member 'WBP_PalItemSlotBase_C_Setup::TargetSlot_0' has a wrong offset!");
