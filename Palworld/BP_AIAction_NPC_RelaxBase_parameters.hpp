...
static_assert(offsetof(BP_AIAction_NPC_RelaxBase_C_SelfIsLeader, IsLeader_0) == 0x000000, "Member 'BP_AIAction_NPC_RelaxBase_C_SelfIsLeader::IsLeader_0' has a wrong offset!");
