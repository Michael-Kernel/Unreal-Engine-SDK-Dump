...
static_assert(sizeof(ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_DessertDrop_C) == 0x000328, "Wrong size on ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_DessertDrop_C");
static_assert(offsetof(ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_DessertDrop_C, DebugMarker) == 0x000308, "Member 'ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_DessertDrop_C::DebugMarker' has a wrong offset!");
static_assert(offsetof(ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_DessertDrop_C, Scene) == 0x000310, "Member 'ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_DessertDrop_C::Scene' has a wrong offset!");
static_assert(offsetof(ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_DessertDrop_C, Arrow) == 0x000318, "Member 'ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_DessertDrop_C::Arrow' has a wrong offset!");
static_assert(offsetof(ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_DessertDrop_C, VisualActor) == 0x000320, "Member 'ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_DessertDrop_C::VisualActor' has a wrong offset!");
