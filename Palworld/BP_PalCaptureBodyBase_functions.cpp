...
void ABP_PalCaptureBodyBase_C::OnBouncedBody__DelegateSignature(E_PalCaptureSphereBouncedReason ReasonType, class UPalIndividualCharacterHandle* TargetHandle_0)
{
	static class UFunction* Func = nullptr;
...
void ABP_PalCaptureBodyBase_C::OnFailedCapture__DelegateSignature(class UPalIndividualCharacterHandle* TargetHandle_0, EPalSphereCaptureFailedReason FailedReason)
{
	static class UFunction* Func = nullptr;
...
void ABP_PalCaptureBodyBase_C::OnPassingCapturePhase__DelegateSignature(int32 PhaseCount, class UPalIndividualCharacterHandle* TargetHandle_0)
{
	static class UFunction* Func = nullptr;
...
void ABP_PalCaptureBodyBase_C::OnSuccessedCapture__DelegateSignature(class UPalIndividualCharacterHandle* TargetHandle_0)
{
	static class UFunction* Func = nullptr;
