...
// Parameters:
// class AActor*                           Owner                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// EPalFootType                            FootType_0                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FTransform                       NewTransform                                           (Parm, OutParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_AnimNotify_FootStep_C::Get_Foot_Transform(class AActor* Owner, EPalFootType FootType_0, struct FTransform* NewTransform) const
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class AActor*                           Owner                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                                    IsFootStepRun_0                                        (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_AnimNotify_FootStep_C::IsFootStepRun(class AActor* Owner, bool* IsFootStepRun_0) const
{
	static class UFunction* Func = nullptr;
	...
	if (IsFootStepRun_0 != nullptr)
		*IsFootStepRun_0 = Parms.IsFootStepRun_0;
}
...
void UBP_AnimNotify_FootStep_C::IsSwimming(class AActor* Owner, bool* IsSwimming_0) const
{
	static class UFunction* Func = nullptr;
...
void UBP_AnimNotify_FootStep_C::ProcFootStep(class AActor* Owner, EPalFootType FootType_0) const
{
	static class UFunction* Func = nullptr;
...
void UBP_AnimNotify_FootStep_C::ProcJumpLanding(class AActor* Owner, EPalFootType FootType_0) const
{
	static class UFunction* Func = nullptr;
