...
void UWBP_OptionSettings_TabButton_C::SwitchTabTo__DelegateSignature(int32 Index_0)
{
...
void UWBP_OptionSettings_TabButton_C::SetName(const class FText& Name_0, int32 Index_0)
{
	static class UFunction* Func = nullptr;
