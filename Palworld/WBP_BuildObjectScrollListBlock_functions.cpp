...
// EPalBuildObjectTypeB                    TypeB_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EPalBuildObjectTypeA                    TypeA_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_BuildObjectScrollListBlock_C::AddBuildObjectList(TArray<struct FPalBuildObjectData>& buildObjectDataArray, EPalBuildObjectTypeB TypeB_0, EPalBuildObjectTypeA TypeA_0)
{
	...
	Parms.TypeB_0 = TypeB_0;
	Parms.TypeA_0 = TypeA_0;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// EPalBuildObjectTypeB                    TypeB_0                                                (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_BuildObjectScrollListBlock_C::GetBuildObjectTypeB(EPalBuildObjectTypeB* TypeB_0)
{
	static class UFunction* Func = nullptr;
