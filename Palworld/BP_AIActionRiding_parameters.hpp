...
static_assert(offsetof(BP_AIActionRiding_C_SetRidingCharacter, RidingCharacter_0) == 0x000000, "Member 'BP_AIActionRiding_C_SetRidingCharacter::RidingCharacter_0' has a wrong offset!");
