...
static_assert(offsetof(BP_VisualEffect_PalBattleOutline_C_SetFadeAlpha, Alpha_0) == 0x000000, "Member 'BP_VisualEffect_PalBattleOutline_C_SetFadeAlpha::Alpha_0' has a wrong offset!");
