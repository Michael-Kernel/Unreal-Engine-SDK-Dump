...
public:
	...
	class APalCharacter*                          CallFunc_GetActionCharacter_ReturnValue_7;         // 0x0090(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_ActionDiscoveryLookat_C_ExecuteUbergraph_BP_ActionDiscoveryLookat) == 0x000098, "Wrong size on BP_ActionDiscoveryLookat_C_ExecuteUbergraph_BP_ActionDiscoveryLookat");
...
static_assert(offsetof(BP_ActionDiscoveryLookat_C_ExecuteUbergraph_BP_ActionDiscoveryLookat, CallFunc_GetActionCharacter_ReturnValue_7) == 0x000090, "Member 'BP_ActionDiscoveryLookat_C_ExecuteUbergraph_BP_ActionDiscoveryLookat::CallFunc_GetActionCharacter_ReturnValue_7' has a wrong offset!");
