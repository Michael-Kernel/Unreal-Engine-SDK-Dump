...
public:
	...
	EPalKeyConfigCategory                         InputType_0;                                       // 0x0020(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EPalKeyConfigAxisFilterType                   AxisType_0;                                        // 0x0021(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(BP_HUDDispatchParameter_KeyConfig_C_OnKeyChanged__DelegateSignature, ActionName_0) == 0x000000, "Member 'BP_HUDDispatchParameter_KeyConfig_C_OnKeyChanged__DelegateSignature::ActionName_0' has a wrong offset!");
...
static_assert(offsetof(BP_HUDDispatchParameter_KeyConfig_C_OnKeyChanged__DelegateSignature, InputType_0) == 0x000020, "Member 'BP_HUDDispatchParameter_KeyConfig_C_OnKeyChanged__DelegateSignature::InputType_0' has a wrong offset!");
static_assert(offsetof(BP_HUDDispatchParameter_KeyConfig_C_OnKeyChanged__DelegateSignature, AxisType_0) == 0x000021, "Member 'BP_HUDDispatchParameter_KeyConfig_C_OnKeyChanged__DelegateSignature::AxisType_0' has a wrong offset!");
