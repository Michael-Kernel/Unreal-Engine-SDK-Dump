...
struct BP_SkillEffect_WindCutterShot_C_OnDestroyed______0 final
{
public:
...
static_assert(alignof(BP_SkillEffect_WindCutterShot_C_OnDestroyed______0) == 0x000008, "Wrong alignment on BP_SkillEffect_WindCutterShot_C_OnDestroyed______0");
static_assert(sizeof(BP_SkillEffect_WindCutterShot_C_OnDestroyed______0) == 0x000008, "Wrong size on BP_SkillEffect_WindCutterShot_C_OnDestroyed______0");
static_assert(offsetof(BP_SkillEffect_WindCutterShot_C_OnDestroyed______0, DestroyedActor) == 0x000000, "Member 'BP_SkillEffect_WindCutterShot_C_OnDestroyed______0::DestroyedActor' has a wrong offset!");
