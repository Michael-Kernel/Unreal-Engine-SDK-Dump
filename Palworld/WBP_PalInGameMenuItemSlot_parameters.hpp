...
static_assert(offsetof(WBP_PalInGameMenuItemSlot_C_UpdateSlotEvent, TargetSlot_0) == 0x000000, "Member 'WBP_PalInGameMenuItemSlot_C_UpdateSlotEvent::TargetSlot_0' has a wrong offset!");
