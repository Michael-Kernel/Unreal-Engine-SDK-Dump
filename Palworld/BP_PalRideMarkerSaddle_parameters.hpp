...
// Function BP_PalRideMarkerSaddle.BP_PalRideMarkerSaddle_C.OnChangeRiding_§ŸÛ»_0
// 0x0001 (0x0001 - 0x0000)
struct BP_PalRideMarkerSaddle_C_OnChangeRiding______0 final
{
public:
...
static_assert(alignof(BP_PalRideMarkerSaddle_C_OnChangeRiding______0) == 0x000001, "Wrong alignment on BP_PalRideMarkerSaddle_C_OnChangeRiding______0");
static_assert(sizeof(BP_PalRideMarkerSaddle_C_OnChangeRiding______0) == 0x000001, "Wrong size on BP_PalRideMarkerSaddle_C_OnChangeRiding______0");
static_assert(offsetof(BP_PalRideMarkerSaddle_C_OnChangeRiding______0, IsEnable) == 0x000000, "Member 'BP_PalRideMarkerSaddle_C_OnChangeRiding______0::IsEnable' has a wrong offset!");
