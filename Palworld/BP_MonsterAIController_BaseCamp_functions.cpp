...
// Parameters:
// class UPalAIActionComponent*            AIActionComponent_0                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void ABP_MonsterAIController_BaseCamp_C::SetAction_Internal(class UPalAIActionComponent* AIActionComponent_0, class UPalAIActionBaseCampBase* NewAction)
{
	static class UFunction* Func = nullptr;
	...
	Parms.AIActionComponent_0 = AIActionComponent_0;
