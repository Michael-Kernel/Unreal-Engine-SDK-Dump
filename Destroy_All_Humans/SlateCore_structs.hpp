...
public:
	...
	struct FSlateBrush                            CheckinFreezeTitleBrush;                           // 0x0CD8(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            CheckinFreezeTitleBrush_Alternate;                 // 0x0D60(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            InactiveTitleBrush;                                // 0x0DE8(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            FlashTitleBrush;                                   // 0x0E70(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            BackgroundColor;                                   // 0x0EF8(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            OutlineBrush;                                      // 0x0F20(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            OutlineColor;                                      // 0x0FA8(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BorderBrush;                                       // 0x0FD0(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BackgroundBrush;                                   // 0x1058(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ChildBackgroundBrush;                              // 0x10E0(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWindowStyle) == 0x000008, "Wrong alignment on FWindowStyle");
static_assert(sizeof(FWindowStyle) == 0x001168, "Wrong size on FWindowStyle");
...
static_assert(offsetof(FWindowStyle, CheckinFreezeTitleBrush) == 0x000CD8, "Member 'FWindowStyle::CheckinFreezeTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, CheckinFreezeTitleBrush_Alternate) == 0x000D60, "Member 'FWindowStyle::CheckinFreezeTitleBrush_Alternate' has a wrong offset!");
static_assert(offsetof(FWindowStyle, InactiveTitleBrush) == 0x000DE8, "Member 'FWindowStyle::InactiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, FlashTitleBrush) == 0x000E70, "Member 'FWindowStyle::FlashTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundColor) == 0x000EF8, "Member 'FWindowStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineBrush) == 0x000F20, "Member 'FWindowStyle::OutlineBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineColor) == 0x000FA8, "Member 'FWindowStyle::OutlineColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BorderBrush) == 0x000FD0, "Member 'FWindowStyle::BorderBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundBrush) == 0x001058, "Member 'FWindowStyle::BackgroundBrush' has a wrong offset!");
