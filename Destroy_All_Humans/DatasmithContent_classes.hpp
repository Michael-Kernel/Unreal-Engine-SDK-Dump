...
{
public:
	EDatasmithAreaLightActorType                  LightType;                                         // 0x03D8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDatasmithAreaLightActorShape                 LightShape;                                        // 0x03D9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3DA[0x2];                                      // 0x03DA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              Dimensions;                                        // 0x03DC(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Intensity;                                         // 0x03E4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ELightUnits                                   IntensityUnits;                                    // 0x03E8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3E9[0x3];                                      // 0x03E9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           Color;                                             // 0x03EC(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Temperature;                                       // 0x03FC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTextureLightProfile*                   IESTexture;                                        // 0x0400(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseIESBrightness;                                 // 0x0408(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_409[0x3];                                      // 0x0409(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         IESBrightnessScale;                                // 0x040C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               Rotation;                                          // 0x0410(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         SourceRadius;                                      // 0x041C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SourceLength;                                      // 0x0420(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AttenuationRadius;                                 // 0x0424(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpotlightInnerAngle;                               // 0x0428(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpotlightOuterAngle;                               // 0x042C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADatasmithAreaLightActor) == 0x000430, "Wrong size on ADatasmithAreaLightActor");
static_assert(offsetof(ADatasmithAreaLightActor, LightType) == 0x0003D8, "Member 'ADatasmithAreaLightActor::LightType' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, LightShape) == 0x0003D9, "Member 'ADatasmithAreaLightActor::LightShape' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Dimensions) == 0x0003DC, "Member 'ADatasmithAreaLightActor::Dimensions' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Intensity) == 0x0003E4, "Member 'ADatasmithAreaLightActor::Intensity' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, IntensityUnits) == 0x0003E8, "Member 'ADatasmithAreaLightActor::IntensityUnits' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Color) == 0x0003EC, "Member 'ADatasmithAreaLightActor::Color' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Temperature) == 0x0003FC, "Member 'ADatasmithAreaLightActor::Temperature' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, IESTexture) == 0x000400, "Member 'ADatasmithAreaLightActor::IESTexture' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, bUseIESBrightness) == 0x000408, "Member 'ADatasmithAreaLightActor::bUseIESBrightness' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, IESBrightnessScale) == 0x00040C, "Member 'ADatasmithAreaLightActor::IESBrightnessScale' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Rotation) == 0x000410, "Member 'ADatasmithAreaLightActor::Rotation' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SourceRadius) == 0x00041C, "Member 'ADatasmithAreaLightActor::SourceRadius' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SourceLength) == 0x000420, "Member 'ADatasmithAreaLightActor::SourceLength' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, AttenuationRadius) == 0x000424, "Member 'ADatasmithAreaLightActor::AttenuationRadius' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SpotlightInnerAngle) == 0x000428, "Member 'ADatasmithAreaLightActor::SpotlightInnerAngle' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SpotlightOuterAngle) == 0x00042C, "Member 'ADatasmithAreaLightActor::SpotlightOuterAngle' has a wrong offset!");
...
// 0x0000 (0x0028 - 0x0028)
class UDatasmithDeltaGenSceneImportData final : public UDatasmithSceneImportData
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(sizeof(UDatasmithDeltaGenSceneImportData) == 0x000028, "Wrong size on UDatasmithDeltaGenSceneImportData");
...
// 0x0000 (0x0028 - 0x0028)
class UDatasmithVREDSceneImportData final : public UDatasmithSceneImportData
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(sizeof(UDatasmithVREDSceneImportData) == 0x000028, "Wrong size on UDatasmithVREDSceneImportData");
...
static_assert(offsetof(UDatasmithImportOptions, BaseOptions) == 0x000034, "Member 'UDatasmithImportOptions::BaseOptions' has a wrong offset!");
static_assert(offsetof(UDatasmithImportOptions, TessellationOptions) == 0x000048, "Member 'UDatasmithImportOptions::TessellationOptions' has a wrong offset!");
static_assert(offsetof(UDatasmithImportOptions, ReimportOptions) == 0x000058, "Member 'UDatasmithImportOptions::ReimportOptions' has a wrong offset!");
static_assert(offsetof(UDatasmithImportOptions, Filename) == 0x000060, "Member 'UDatasmithImportOptions::Filename' has a wrong offset!");
static_assert(offsetof(UDatasmithImportOptions, FilePath) == 0x000070, "Member 'UDatasmithImportOptions::FilePath' has a wrong offset!");
...
public:
	...
	TMap<class FName, TSoftObjectPtr<class UTexture>> TextureParameterValues;                            // 0x00D0(0x0050)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDatasmithMaterialInstanceTemplate) == 0x000170, "Wrong size on UDatasmithMaterialInstanceTemplate");
static_assert(offsetof(UDatasmithMaterialInstanceTemplate, ScalarParameterValues) == 0x000030, "Member 'UDatasmithMaterialInstanceTemplate::ScalarParameterValues' has a wrong offset!");
static_assert(offsetof(UDatasmithMaterialInstanceTemplate, VectorParameterValues) == 0x000080, "Member 'UDatasmithMaterialInstanceTemplate::VectorParameterValues' has a wrong offset!");
static_assert(offsetof(UDatasmithMaterialInstanceTemplate, TextureParameterValues) == 0x0000D0, "Member 'UDatasmithMaterialInstanceTemplate::TextureParameterValues' has a wrong offset!");
static_assert(offsetof(UDatasmithMaterialInstanceTemplate, StaticParameters) == 0x000120, "Member 'UDatasmithMaterialInstanceTemplate::StaticParameters' has a wrong offset!");
...
{
public:
	class UDatasmithScene*                        Scene;                                             // 0x03D8(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FName, TSoftObjectPtr<class AActor>> RelatedActors;                                     // 0x03E0(0x0050)(Edit, ZeroConstructor, EditConst, AdvancedDisplay, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ADatasmithSceneActor) == 0x000430, "Wrong size on ADatasmithSceneActor");
static_assert(offsetof(ADatasmithSceneActor, Scene) == 0x0003D8, "Member 'ADatasmithSceneActor::Scene' has a wrong offset!");
static_assert(offsetof(ADatasmithSceneActor, RelatedActors) == 0x0003E0, "Member 'ADatasmithSceneActor::RelatedActors' has a wrong offset!");
...
public:
	...
	TSet<class FName>                             Tags;                                              // 0x0090(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDatasmithSceneComponentTemplate) == 0x0000E0, "Wrong size on UDatasmithSceneComponentTemplate");
...
static_assert(offsetof(UDatasmithSceneComponentTemplate, Tags) == 0x000090, "Member 'UDatasmithSceneComponentTemplate::Tags' has a wrong offset!");
...
static_assert(sizeof(UDatasmithStaticMeshComponentTemplate) == 0x000100, "Wrong size on UDatasmithStaticMeshComponentTemplate");
static_assert(offsetof(UDatasmithStaticMeshComponentTemplate, StaticMesh) == 0x0000E0, "Member 'UDatasmithStaticMeshComponentTemplate::StaticMesh' has a wrong offset!");
static_assert(offsetof(UDatasmithStaticMeshComponentTemplate, OverrideMaterials) == 0x0000E8, "Member 'UDatasmithStaticMeshComponentTemplate::OverrideMaterials' has a wrong offset!");
