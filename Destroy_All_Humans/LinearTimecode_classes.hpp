...
{
public:
	class UMediaPlayer*                           MediaPlayer;                                       // 0x0298(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDropTimecode                          DropTimecode;                                      // 0x02A0(0x001C)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_2BC[0x4];                                      // 0x02BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	UMulticastDelegateProperty_                   OnTimecodeChange;                                  // 0x02C0(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULinearTimecodeComponent) == 0x000310, "Wrong size on ULinearTimecodeComponent");
static_assert(offsetof(ULinearTimecodeComponent, MediaPlayer) == 0x000298, "Member 'ULinearTimecodeComponent::MediaPlayer' has a wrong offset!");
static_assert(offsetof(ULinearTimecodeComponent, DropTimecode) == 0x0002A0, "Member 'ULinearTimecodeComponent::DropTimecode' has a wrong offset!");
