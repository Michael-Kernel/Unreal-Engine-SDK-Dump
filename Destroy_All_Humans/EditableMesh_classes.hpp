...
{
public:
	uint8                                         Pad_28[0x300];                                     // 0x0028(0x0300)(Fixing Size After Last Property [ Dumper-7 ])
	...
	int32                                         TextureCoordinateCount;                            // 0x0340(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_344[0x148];                                    // 0x0344(0x0148)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PendingCompactCounter;                             // 0x048C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SubdivisionCount;                                  // 0x0490(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_494[0x1EC];                                    // 0x0494(0x01EC)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEditableMesh) == 0x000680, "Wrong size on UEditableMesh");
static_assert(offsetof(UEditableMesh, Adapters) == 0x000328, "Member 'UEditableMesh::Adapters' has a wrong offset!");
static_assert(offsetof(UEditableMesh, TextureCoordinateCount) == 0x000340, "Member 'UEditableMesh::TextureCoordinateCount' has a wrong offset!");
static_assert(offsetof(UEditableMesh, PendingCompactCounter) == 0x00048C, "Member 'UEditableMesh::PendingCompactCounter' has a wrong offset!");
static_assert(offsetof(UEditableMesh, SubdivisionCount) == 0x000490, "Member 'UEditableMesh::SubdivisionCount' has a wrong offset!");
