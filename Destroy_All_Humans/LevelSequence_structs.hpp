...
static_assert(sizeof(FLevelSequencePlayerSnapshot) == 0x000098, "Wrong size on FLevelSequencePlayerSnapshot");
...
static_assert(offsetof(FLevelSequencePlayerSnapshot, Settings) == 0x000078, "Member 'FLevelSequencePlayerSnapshot::Settings' has a wrong offset!");
static_assert(offsetof(FLevelSequencePlayerSnapshot, ActiveShot) == 0x000088, "Member 'FLevelSequencePlayerSnapshot::ActiveShot' has a wrong offset!");
static_assert(offsetof(FLevelSequencePlayerSnapshot, ShotID) == 0x000090, "Member 'FLevelSequencePlayerSnapshot::ShotID' has a wrong offset!");
