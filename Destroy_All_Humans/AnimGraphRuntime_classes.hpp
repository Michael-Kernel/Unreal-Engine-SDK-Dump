...
static_assert(sizeof(UAnimCustomInstance) == 0x0002A0, "Wrong size on UAnimCustomInstance");
...
static_assert(sizeof(UAnimSequencerInstance) == 0x0002A0, "Wrong size on UAnimSequencerInstance");
...
{
public:
	UMulticastDelegateProperty_                   OnCompleted;                                       // 0x0028(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastDelegateProperty_                   OnBlendOut;                                        // 0x0040(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastDelegateProperty_                   OnInterrupted;                                     // 0x0058(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastDelegateProperty_                   OnNotifyBegin;                                     // 0x0070(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastDelegateProperty_                   OnNotifyEnd;                                       // 0x0088(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPlayMontageCallbackProxy) == 0x0000D0, "Wrong size on UPlayMontageCallbackProxy");
...
static_assert(offsetof(UPlayMontageCallbackProxy, OnNotifyEnd) == 0x000088, "Member 'UPlayMontageCallbackProxy::OnNotifyEnd' has a wrong offset!");
