...
public:
	...
	UMulticastDelegateProperty_                   OnFailure;                                         // 0x0040(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEndTurnCallbackProxy) == 0x000080, "Wrong size on UEndTurnCallbackProxy");
...
static_assert(sizeof(UAchievementQueryCallbackProxy) == 0x000070, "Wrong size on UAchievementQueryCallbackProxy");
...
static_assert(sizeof(UAchievementWriteCallbackProxy) == 0x000088, "Wrong size on UAchievementWriteCallbackProxy");
...
static_assert(sizeof(UConnectionCallbackProxy) == 0x000080, "Wrong size on UConnectionCallbackProxy");
...
static_assert(sizeof(UCreateSessionCallbackProxy) == 0x0000A0, "Wrong size on UCreateSessionCallbackProxy");
...
static_assert(sizeof(UEndMatchCallbackProxy) == 0x000088, "Wrong size on UEndMatchCallbackProxy");
...
static_assert(sizeof(UFindSessionsCallbackProxy) == 0x000098, "Wrong size on UFindSessionsCallbackProxy");
...
static_assert(sizeof(UFindTurnBasedMatchCallbackProxy) == 0x000090, "Wrong size on UFindTurnBasedMatchCallbackProxy");
...
static_assert(sizeof(UInAppPurchaseCallbackProxy) == 0x000090, "Wrong size on UInAppPurchaseCallbackProxy");
...
static_assert(offsetof(UInAppPurchaseCallbackProxy, OnFailure) == 0x000040, "Member 'UInAppPurchaseCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(UInAppPurchaseQueryCallbackProxy) == 0x0000A0, "Wrong size on UInAppPurchaseQueryCallbackProxy");
...
static_assert(offsetof(UInAppPurchaseQueryCallbackProxy, OnFailure) == 0x000040, "Member 'UInAppPurchaseQueryCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(UInAppPurchaseRestoreCallbackProxy) == 0x0000A0, "Wrong size on UInAppPurchaseRestoreCallbackProxy");
...
static_assert(offsetof(UInAppPurchaseRestoreCallbackProxy, OnFailure) == 0x000040, "Member 'UInAppPurchaseRestoreCallbackProxy::OnFailure' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_728[0x1C];                                     // 0x0728(0x001C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_754[0x14];                                     // 0x0754(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpNetDriver) == 0x000768, "Wrong size on UIpNetDriver");
static_assert(offsetof(UIpNetDriver, MaxPortCountToTry) == 0x000724, "Member 'UIpNetDriver::MaxPortCountToTry' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketReceiveBufferBytes) == 0x000744, "Member 'UIpNetDriver::ServerDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketSendBufferBytes) == 0x000748, "Member 'UIpNetDriver::ServerDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketReceiveBufferBytes) == 0x00074C, "Member 'UIpNetDriver::ClientDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketSendBufferBytes) == 0x000750, "Member 'UIpNetDriver::ClientDesiredSocketSendBufferBytes' has a wrong offset!");
...
static_assert(sizeof(UJoinSessionCallbackProxy) == 0x000138, "Wrong size on UJoinSessionCallbackProxy");
...
static_assert(sizeof(ULeaderboardFlushCallbackProxy) == 0x000078, "Wrong size on ULeaderboardFlushCallbackProxy");
...
static_assert(offsetof(ULeaderboardFlushCallbackProxy, OnFailure) == 0x000040, "Member 'ULeaderboardFlushCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(ULeaderboardQueryCallbackProxy) == 0x0000A8, "Wrong size on ULeaderboardQueryCallbackProxy");
...
static_assert(offsetof(ULeaderboardQueryCallbackProxy, OnFailure) == 0x000040, "Member 'ULeaderboardQueryCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(offsetof(ULogoutCallbackProxy, OnFailure) == 0x000048, "Member 'ULogoutCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(AOnlineBeacon) == 0x000408, "Wrong size on AOnlineBeacon");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionInitialTimeout) == 0x0003E0, "Member 'AOnlineBeacon::BeaconConnectionInitialTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionTimeout) == 0x0003E4, "Member 'AOnlineBeacon::BeaconConnectionTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, NetDriver) == 0x0003E8, "Member 'AOnlineBeacon::NetDriver' has a wrong offset!");
...
static_assert(sizeof(AOnlineBeaconClient) == 0x000458, "Wrong size on AOnlineBeaconClient");
...
static_assert(sizeof(AOnlineBeaconHost) == 0x0004C0, "Wrong size on AOnlineBeaconHost");
...
static_assert(sizeof(AOnlineBeaconHostObject) == 0x000400, "Wrong size on AOnlineBeaconHostObject");
static_assert(offsetof(AOnlineBeaconHostObject, BeaconTypeName) == 0x0003D8, "Member 'AOnlineBeaconHostObject::BeaconTypeName' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientBeaconActorClass) == 0x0003E8, "Member 'AOnlineBeaconHostObject::ClientBeaconActorClass' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientActors) == 0x0003F0, "Member 'AOnlineBeaconHostObject::ClientActors' has a wrong offset!");
...
{
public:
	uint8                                         Pad_458[0x30];                                     // 0x0458(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 DestSessionId;                                     // 0x0488(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FPartyReservation                      PendingReservation;                                // 0x0498(0x0040)(Protected, NativeAccessSpecifierProtected)
	EClientRequestType                            RequestType;                                       // 0x04D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bPendingReservationSent;                           // 0x04D9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bCancelReservation;                                // 0x04DA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4DB[0x2D];                                     // 0x04DB(0x002D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(APartyBeaconClient) == 0x000508, "Wrong size on APartyBeaconClient");
static_assert(offsetof(APartyBeaconClient, DestSessionId) == 0x000488, "Member 'APartyBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, PendingReservation) == 0x000498, "Member 'APartyBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, RequestType) == 0x0004D8, "Member 'APartyBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bPendingReservationSent) == 0x0004D9, "Member 'APartyBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bCancelReservation) == 0x0004DA, "Member 'APartyBeaconClient::bCancelReservation' has a wrong offset!");
...
static_assert(sizeof(APartyBeaconHost) == 0x000478, "Wrong size on APartyBeaconHost");
static_assert(offsetof(APartyBeaconHost, State) == 0x000400, "Member 'APartyBeaconHost::State' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, bLogoutOnSessionTimeout) == 0x000468, "Member 'APartyBeaconHost::bLogoutOnSessionTimeout' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, SessionTimeoutSecs) == 0x00046C, "Member 'APartyBeaconHost::SessionTimeoutSecs' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, TravelSessionTimeoutSecs) == 0x000470, "Member 'APartyBeaconHost::TravelSessionTimeoutSecs' has a wrong offset!");
...
static_assert(sizeof(UQuitMatchCallbackProxy) == 0x000080, "Wrong size on UQuitMatchCallbackProxy");
...
static_assert(offsetof(UShowLoginUICallbackProxy, OnFailure) == 0x000048, "Member 'UShowLoginUICallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(ATestBeaconClient) == 0x000458, "Wrong size on ATestBeaconClient");
...
static_assert(sizeof(ATestBeaconHost) == 0x000400, "Wrong size on ATestBeaconHost");
...
static_assert(sizeof(UVoipListenerSynthComponent) == 0x0006D0, "Wrong size on UVoipListenerSynthComponent");
