...
// 0x0001 (0x0001 - 0x0000)
struct OculusFunctionLibrary_GetTiledMultiresLevel final
{
public:
...
static_assert(alignof(OculusFunctionLibrary_GetTiledMultiresLevel) == 0x000001, "Wrong alignment on OculusFunctionLibrary_GetTiledMultiresLevel");
static_assert(sizeof(OculusFunctionLibrary_GetTiledMultiresLevel) == 0x000001, "Wrong size on OculusFunctionLibrary_GetTiledMultiresLevel");
static_assert(offsetof(OculusFunctionLibrary_GetTiledMultiresLevel, ReturnValue) == 0x000000, "Member 'OculusFunctionLibrary_GetTiledMultiresLevel::ReturnValue' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct OculusFunctionLibrary_SetTiledMultiresLevel final
{
public:
...
static_assert(alignof(OculusFunctionLibrary_SetTiledMultiresLevel) == 0x000001, "Wrong alignment on OculusFunctionLibrary_SetTiledMultiresLevel");
static_assert(sizeof(OculusFunctionLibrary_SetTiledMultiresLevel) == 0x000001, "Wrong size on OculusFunctionLibrary_SetTiledMultiresLevel");
static_assert(offsetof(OculusFunctionLibrary_SetTiledMultiresLevel, Level) == 0x000000, "Member 'OculusFunctionLibrary_SetTiledMultiresLevel::Level' has a wrong offset!");
