...
// Function Paper2D.PaperSprite.GetSourceTexture
// 0x0008 (0x0008 - 0x0000)
struct PaperSprite_GetSourceTexture final
{
public:
...
static_assert(alignof(PaperSprite_GetSourceTexture) == 0x000008, "Wrong alignment on PaperSprite_GetSourceTexture");
static_assert(sizeof(PaperSprite_GetSourceTexture) == 0x000008, "Wrong size on PaperSprite_GetSourceTexture");
static_assert(offsetof(PaperSprite_GetSourceTexture, ReturnValue) == 0x000000, "Member 'PaperSprite_GetSourceTexture::ReturnValue' has a wrong offset!");
