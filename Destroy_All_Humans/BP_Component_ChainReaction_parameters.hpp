...
{
public:
	class UBP_ActorComponent_ChainReactionManager_C* MyMngr_0;                                          // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BP_Component_ChainReaction_C_GetManager, MyMngr_0) == 0x000000, "Member 'BP_Component_ChainReaction_C_GetManager::MyMngr_0' has a wrong offset!");
