...
static_assert(sizeof(UBTTask_StopMovement_C) == 0x0000A8, "Wrong size on UBTTask_StopMovement_C");
static_assert(offsetof(UBTTask_StopMovement_C, UberGraphFrame) == 0x0000A0, "Member 'UBTTask_StopMovement_C::UberGraphFrame' has a wrong offset!");
