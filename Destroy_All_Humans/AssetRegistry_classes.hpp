...
{
public:
	uint8                                         Pad_28[0x7A0];                                     // 0x0028(0x07A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x0007C8, "Wrong size on UAssetRegistryImpl");
