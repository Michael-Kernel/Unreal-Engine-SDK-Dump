...
// (Final, Native, Static, Public, BlueprintCallable, BlueprintPure)
// Parameters:
// ETiledMultiResLevel                     ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
ETiledMultiResLevel UOculusFunctionLibrary::GetTiledMultiresLevel()
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("OculusFunctionLibrary", "GetTiledMultiresLevel");

	Params::OculusFunctionLibrary_GetTiledMultiresLevel Parms{};
...
void UOculusFunctionLibrary::SetTiledMultiresLevel(ETiledMultiResLevel Level)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("OculusFunctionLibrary", "SetTiledMultiresLevel");

	Params::OculusFunctionLibrary_SetTiledMultiresLevel Parms{};
