...
public:
	...
	uint8                                         Pad_2D5[0xC3];                                     // 0x02D5(0x00C3)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FActiveGameplayEffect) == 0x000008, "Wrong alignment on FActiveGameplayEffect");
static_assert(sizeof(FActiveGameplayEffect) == 0x000398, "Wrong size on FActiveGameplayEffect");
...
public:
	...
	TArray<struct FActiveGameplayEffect>          GameplayEffects_Internal;                          // 0x00E8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_F8[0x318];                                     // 0x00F8(0x0318)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FActiveGameplayEffectsContainer) == 0x000438, "Wrong size on FActiveGameplayEffectsContainer");
static_assert(offsetof(FActiveGameplayEffectsContainer, GameplayEffects_Internal) == 0x0000E8, "Member 'FActiveGameplayEffectsContainer::GameplayEffects_Internal' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffectsContainer, ApplicationImmunityQueryEffects) == 0x000410, "Member 'FActiveGameplayEffectsContainer::ApplicationImmunityQueryEffects' has a wrong offset!");
