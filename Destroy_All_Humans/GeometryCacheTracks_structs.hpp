...
static_assert(sizeof(FMovieSceneGeometryCacheParams) == 0x000038, "Wrong size on FMovieSceneGeometryCacheParams");
...
static_assert(offsetof(FMovieSceneGeometryCacheParams, StartFrameOffset) == 0x000008, "Member 'FMovieSceneGeometryCacheParams::StartFrameOffset' has a wrong offset!");
static_assert(offsetof(FMovieSceneGeometryCacheParams, EndFrameOffset) == 0x00000C, "Member 'FMovieSceneGeometryCacheParams::EndFrameOffset' has a wrong offset!");
static_assert(offsetof(FMovieSceneGeometryCacheParams, PlayRate) == 0x000010, "Member 'FMovieSceneGeometryCacheParams::PlayRate' has a wrong offset!");
static_assert(offsetof(FMovieSceneGeometryCacheParams, StartOffset) == 0x000018, "Member 'FMovieSceneGeometryCacheParams::StartOffset' has a wrong offset!");
static_assert(offsetof(FMovieSceneGeometryCacheParams, EndOffset) == 0x00001C, "Member 'FMovieSceneGeometryCacheParams::EndOffset' has a wrong offset!");
static_assert(offsetof(FMovieSceneGeometryCacheParams, GeometryCache) == 0x000020, "Member 'FMovieSceneGeometryCacheParams::GeometryCache' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneGeometryCacheSectionTemplateParameters) == 0x000040, "Wrong size on FMovieSceneGeometryCacheSectionTemplateParameters");
static_assert(offsetof(FMovieSceneGeometryCacheSectionTemplateParameters, SectionStartTime) == 0x000038, "Member 'FMovieSceneGeometryCacheSectionTemplateParameters::SectionStartTime' has a wrong offset!");
static_assert(offsetof(FMovieSceneGeometryCacheSectionTemplateParameters, SectionEndTime) == 0x00003C, "Member 'FMovieSceneGeometryCacheSectionTemplateParameters::SectionEndTime' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneGeometryCacheSectionTemplate) == 0x000060, "Wrong size on FMovieSceneGeometryCacheSectionTemplate");
