...
void UAISense_Damage::ReportDamageEventEx(class UObject* WorldContextObject, class AActor* DamagedActor, class AActor* Instigator, float DamageAmount, const struct FVector& EventLocation, const struct FVector& HitLocation, const class FName& Tag)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AISense_Damage", "ReportDamageEventEx");

	Params::AISense_Damage_ReportDamageEventEx Parms{};
