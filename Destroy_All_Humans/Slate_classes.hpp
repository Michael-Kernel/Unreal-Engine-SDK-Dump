...
static_assert(sizeof(UComboBoxWidgetStyle) == 0x000408, "Wrong size on UComboBoxWidgetStyle");
...
static_assert(sizeof(UComboButtonWidgetStyle) == 0x0003D0, "Wrong size on UComboButtonWidgetStyle");
...
static_assert(sizeof(UEditableTextBoxWidgetStyle) == 0x000820, "Wrong size on UEditableTextBoxWidgetStyle");
...
static_assert(sizeof(UEditableTextWidgetStyle) == 0x000248, "Wrong size on UEditableTextWidgetStyle");
...
static_assert(sizeof(UTextBlockWidgetStyle) == 0x000298, "Wrong size on UTextBlockWidgetStyle");
