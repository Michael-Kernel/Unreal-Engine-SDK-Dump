...
static_assert(sizeof(UMovieSceneFloatSection) == 0x000188, "Wrong size on UMovieSceneFloatSection");
static_assert(offsetof(UMovieSceneFloatSection, FloatCurve) == 0x0000E8, "Member 'UMovieSceneFloatSection::FloatCurve' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSpawnTrack) == 0x000080, "Wrong size on UMovieSceneSpawnTrack");
static_assert(offsetof(UMovieSceneSpawnTrack, Sections) == 0x000060, "Member 'UMovieSceneSpawnTrack::Sections' has a wrong offset!");
static_assert(offsetof(UMovieSceneSpawnTrack, ObjectGuid) == 0x000070, "Member 'UMovieSceneSpawnTrack::ObjectGuid' has a wrong offset!");
...
static_assert(sizeof(UMovieScene3DAttachSection) == 0x000128, "Wrong size on UMovieScene3DAttachSection");
static_assert(offsetof(UMovieScene3DAttachSection, AttachSocketName) == 0x000110, "Member 'UMovieScene3DAttachSection::AttachSocketName' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, AttachComponentName) == 0x000118, "Member 'UMovieScene3DAttachSection::AttachComponentName' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, AttachmentLocationRule) == 0x000120, "Member 'UMovieScene3DAttachSection::AttachmentLocationRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, AttachmentRotationRule) == 0x000121, "Member 'UMovieScene3DAttachSection::AttachmentRotationRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, AttachmentScaleRule) == 0x000122, "Member 'UMovieScene3DAttachSection::AttachmentScaleRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, DetachmentLocationRule) == 0x000123, "Member 'UMovieScene3DAttachSection::DetachmentLocationRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, DetachmentRotationRule) == 0x000124, "Member 'UMovieScene3DAttachSection::DetachmentRotationRule' has a wrong offset!");
static_assert(offsetof(UMovieScene3DAttachSection, DetachmentScaleRule) == 0x000125, "Member 'UMovieScene3DAttachSection::DetachmentScaleRule' has a wrong offset!");
...
static_assert(sizeof(UMovieScene3DConstraintTrack) == 0x000070, "Wrong size on UMovieScene3DConstraintTrack");
static_assert(offsetof(UMovieScene3DConstraintTrack, ConstraintSections) == 0x000060, "Member 'UMovieScene3DConstraintTrack::ConstraintSections' has a wrong offset!");
...
static_assert(sizeof(UMovieScene3DAttachTrack) == 0x000070, "Wrong size on UMovieScene3DAttachTrack");
...
static_assert(sizeof(UMovieScene3DPathTrack) == 0x000070, "Wrong size on UMovieScene3DPathTrack");
...
public:
	...
	uint8                                         Pad_735[0x3];                                      // 0x0735(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieScene3DTransformSection) == 0x000738, "Wrong size on UMovieScene3DTransformSection");
static_assert(offsetof(UMovieScene3DTransformSection, TransformMask) == 0x0000E8, "Member 'UMovieScene3DTransformSection::TransformMask' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Translation) == 0x0000F0, "Member 'UMovieScene3DTransformSection::Translation' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Rotation) == 0x0002D0, "Member 'UMovieScene3DTransformSection::Rotation' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Scale) == 0x0004B0, "Member 'UMovieScene3DTransformSection::Scale' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, ManualWeight) == 0x000690, "Member 'UMovieScene3DTransformSection::ManualWeight' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, bUseQuaternionInterpolation) == 0x000734, "Member 'UMovieScene3DTransformSection::bUseQuaternionInterpolation' has a wrong offset!");
...
public:
	...
	class FName                                   PropertyName;                                      // 0x0068(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 PropertyPath;                                      // 0x0070(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieScenePropertyTrack) == 0x000090, "Wrong size on UMovieScenePropertyTrack");
static_assert(offsetof(UMovieScenePropertyTrack, SectionToKey) == 0x000060, "Member 'UMovieScenePropertyTrack::SectionToKey' has a wrong offset!");
static_assert(offsetof(UMovieScenePropertyTrack, PropertyName) == 0x000068, "Member 'UMovieScenePropertyTrack::PropertyName' has a wrong offset!");
static_assert(offsetof(UMovieScenePropertyTrack, PropertyPath) == 0x000070, "Member 'UMovieScenePropertyTrack::PropertyPath' has a wrong offset!");
static_assert(offsetof(UMovieScenePropertyTrack, Sections) == 0x000080, "Member 'UMovieScenePropertyTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieScene3DTransformTrack) == 0x000090, "Wrong size on UMovieScene3DTransformTrack");
...
public:
	...
	TArray<class FString>                         ActorGuidStrings;                                  // 0x0208(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneActorReferenceSection) == 0x000218, "Wrong size on UMovieSceneActorReferenceSection");
...
static_assert(offsetof(UMovieSceneActorReferenceSection, ActorGuidIndexCurve) == 0x000188, "Member 'UMovieSceneActorReferenceSection::ActorGuidIndexCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneActorReferenceSection, ActorGuidStrings) == 0x000208, "Member 'UMovieSceneActorReferenceSection::ActorGuidStrings' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneActorReferenceTrack) == 0x000090, "Wrong size on UMovieSceneActorReferenceTrack");
...
public:
	...
	TDelegate<void(TArray<struct FSubtitleCue>& Subtitles, float CueDuration)> OnQueueSubtitles;                                  // 0x0258(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPrivate)
	UMulticastDelegateProperty_                   OnAudioFinished;                                   // 0x0268(0x0018)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
	UMulticastDelegateProperty_                   OnAudioPlaybackPercent;                            // 0x0280(0x0018)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneAudioSection) == 0x000298, "Wrong size on UMovieSceneAudioSection");
...
static_assert(offsetof(UMovieSceneAudioSection, bSuppressSubtitles) == 0x000248, "Member 'UMovieSceneAudioSection::bSuppressSubtitles' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bOverrideAttenuation) == 0x000249, "Member 'UMovieSceneAudioSection::bOverrideAttenuation' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AttenuationSettings) == 0x000250, "Member 'UMovieSceneAudioSection::AttenuationSettings' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnQueueSubtitles) == 0x000258, "Member 'UMovieSceneAudioSection::OnQueueSubtitles' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnAudioFinished) == 0x000268, "Member 'UMovieSceneAudioSection::OnAudioFinished' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnAudioPlaybackPercent) == 0x000280, "Member 'UMovieSceneAudioSection::OnAudioPlaybackPercent' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneAudioTrack) == 0x000070, "Wrong size on UMovieSceneAudioTrack");
static_assert(offsetof(UMovieSceneAudioTrack, AudioSections) == 0x000060, "Member 'UMovieSceneAudioTrack::AudioSections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneBoolTrack) == 0x000090, "Wrong size on UMovieSceneBoolTrack");
...
static_assert(sizeof(UMovieSceneByteSection) == 0x000180, "Wrong size on UMovieSceneByteSection");
static_assert(offsetof(UMovieSceneByteSection, ByteCurve) == 0x0000E8, "Member 'UMovieSceneByteSection::ByteCurve' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneByteTrack) == 0x000098, "Wrong size on UMovieSceneByteTrack");
static_assert(offsetof(UMovieSceneByteTrack, Enum) == 0x000090, "Member 'UMovieSceneByteTrack::Enum' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraAnimTrack) == 0x000070, "Wrong size on UMovieSceneCameraAnimTrack");
static_assert(offsetof(UMovieSceneCameraAnimTrack, CameraAnimSections) == 0x000060, "Member 'UMovieSceneCameraAnimTrack::CameraAnimSections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraCutSection) == 0x000110, "Wrong size on UMovieSceneCameraCutSection");
static_assert(offsetof(UMovieSceneCameraCutSection, CameraGuid) == 0x0000E8, "Member 'UMovieSceneCameraCutSection::CameraGuid' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraCutSection, CameraBindingID) == 0x0000F8, "Member 'UMovieSceneCameraCutSection::CameraBindingID' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UCameraShake>               ShakeClass;                                        // 0x0108(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	ECameraAnimPlaySpace                          PlaySpace;                                         // 0x0114(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneCameraShakeTrack) == 0x000070, "Wrong size on UMovieSceneCameraShakeTrack");
static_assert(offsetof(UMovieSceneCameraShakeTrack, CameraShakeSections) == 0x000060, "Member 'UMovieSceneCameraShakeTrack::CameraShakeSections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCinematicShotTrack) == 0x000070, "Wrong size on UMovieSceneCinematicShotTrack");
...
static_assert(sizeof(UMovieSceneColorSection) == 0x000368, "Wrong size on UMovieSceneColorSection");
static_assert(offsetof(UMovieSceneColorSection, RedCurve) == 0x0000E8, "Member 'UMovieSceneColorSection::RedCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneColorSection, GreenCurve) == 0x000188, "Member 'UMovieSceneColorSection::GreenCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneColorSection, BlueCurve) == 0x000228, "Member 'UMovieSceneColorSection::BlueCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneColorSection, AlphaCurve) == 0x0002C8, "Member 'UMovieSceneColorSection::AlphaCurve' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneColorTrack) == 0x000098, "Wrong size on UMovieSceneColorTrack");
static_assert(offsetof(UMovieSceneColorTrack, bIsSlateColor) == 0x000090, "Member 'UMovieSceneColorTrack::bIsSlateColor' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneEnumSection) == 0x000180, "Wrong size on UMovieSceneEnumSection");
static_assert(offsetof(UMovieSceneEnumSection, EnumCurve) == 0x0000E8, "Member 'UMovieSceneEnumSection::EnumCurve' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneEnumTrack) == 0x000098, "Wrong size on UMovieSceneEnumTrack");
static_assert(offsetof(UMovieSceneEnumTrack, Enum) == 0x000090, "Member 'UMovieSceneEnumTrack::Enum' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneEulerTransformTrack) == 0x000090, "Wrong size on UMovieSceneEulerTransformTrack");
...
static_assert(sizeof(UMovieSceneEventRepeaterSection) == 0x0000F0, "Wrong size on UMovieSceneEventRepeaterSection");
static_assert(offsetof(UMovieSceneEventRepeaterSection, Event) == 0x0000E8, "Member 'UMovieSceneEventRepeaterSection::Event' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneEventTrack) == 0x000088, "Wrong size on UMovieSceneEventTrack");
static_assert(offsetof(UMovieSceneEventTrack, EventPosition) == 0x000064, "Member 'UMovieSceneEventTrack::EventPosition' has a wrong offset!");
static_assert(offsetof(UMovieSceneEventTrack, EventReceivers) == 0x000068, "Member 'UMovieSceneEventTrack::EventReceivers' has a wrong offset!");
static_assert(offsetof(UMovieSceneEventTrack, Sections) == 0x000078, "Member 'UMovieSceneEventTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneEventTriggerSection) == 0x000170, "Wrong size on UMovieSceneEventTriggerSection");
static_assert(offsetof(UMovieSceneEventTriggerSection, EventChannel) == 0x0000E8, "Member 'UMovieSceneEventTriggerSection::EventChannel' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneFloatTrack) == 0x000090, "Wrong size on UMovieSceneFloatTrack");
...
static_assert(sizeof(UMovieSceneFadeTrack) == 0x000090, "Wrong size on UMovieSceneFadeTrack");
...
static_assert(sizeof(UMovieSceneIntegerSection) == 0x000178, "Wrong size on UMovieSceneIntegerSection");
static_assert(offsetof(UMovieSceneIntegerSection, IntegerCurve) == 0x0000E8, "Member 'UMovieSceneIntegerSection::IntegerCurve' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneIntegerTrack) == 0x000090, "Wrong size on UMovieSceneIntegerTrack");
...
static_assert(sizeof(UMovieSceneLevelVisibilitySection) == 0x000100, "Wrong size on UMovieSceneLevelVisibilitySection");
static_assert(offsetof(UMovieSceneLevelVisibilitySection, Visibility) == 0x0000E8, "Member 'UMovieSceneLevelVisibilitySection::Visibility' has a wrong offset!");
static_assert(offsetof(UMovieSceneLevelVisibilitySection, LevelNames) == 0x0000F0, "Member 'UMovieSceneLevelVisibilitySection::LevelNames' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneLevelVisibilityTrack) == 0x000070, "Wrong size on UMovieSceneLevelVisibilityTrack");
static_assert(offsetof(UMovieSceneLevelVisibilityTrack, Sections) == 0x000060, "Member 'UMovieSceneLevelVisibilityTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneMaterialTrack) == 0x000070, "Wrong size on UMovieSceneMaterialTrack");
static_assert(offsetof(UMovieSceneMaterialTrack, Sections) == 0x000060, "Member 'UMovieSceneMaterialTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneMaterialParameterCollectionTrack) == 0x000078, "Wrong size on UMovieSceneMaterialParameterCollectionTrack");
static_assert(offsetof(UMovieSceneMaterialParameterCollectionTrack, MPC) == 0x000070, "Member 'UMovieSceneMaterialParameterCollectionTrack::MPC' has a wrong offset!");
...
{
public:
	int32                                         MaterialIndex;                                     // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneComponentMaterialTrack) == 0x000078, "Wrong size on UMovieSceneComponentMaterialTrack");
static_assert(offsetof(UMovieSceneComponentMaterialTrack, MaterialIndex) == 0x000070, "Member 'UMovieSceneComponentMaterialTrack::MaterialIndex' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneObjectPropertyTrack) == 0x000098, "Wrong size on UMovieSceneObjectPropertyTrack");
static_assert(offsetof(UMovieSceneObjectPropertyTrack, PropertyClass) == 0x000090, "Member 'UMovieSceneObjectPropertyTrack::PropertyClass' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneParameterSection) == 0x000118, "Wrong size on UMovieSceneParameterSection");
static_assert(offsetof(UMovieSceneParameterSection, ScalarParameterNamesAndCurves) == 0x0000E8, "Member 'UMovieSceneParameterSection::ScalarParameterNamesAndCurves' has a wrong offset!");
static_assert(offsetof(UMovieSceneParameterSection, VectorParameterNamesAndCurves) == 0x0000F8, "Member 'UMovieSceneParameterSection::VectorParameterNamesAndCurves' has a wrong offset!");
static_assert(offsetof(UMovieSceneParameterSection, ColorParameterNamesAndCurves) == 0x000108, "Member 'UMovieSceneParameterSection::ColorParameterNamesAndCurves' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneParticleParameterTrack) == 0x000070, "Wrong size on UMovieSceneParticleParameterTrack");
static_assert(offsetof(UMovieSceneParticleParameterTrack, Sections) == 0x000060, "Member 'UMovieSceneParticleParameterTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneParticleTrack) == 0x000070, "Wrong size on UMovieSceneParticleTrack");
static_assert(offsetof(UMovieSceneParticleTrack, ParticleSections) == 0x000060, "Member 'UMovieSceneParticleTrack::ParticleSections' has a wrong offset!");
...
{
public:
	int32                                         MaterialIndex;                                     // 0x0090(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieScenePrimitiveMaterialTrack) == 0x000098, "Wrong size on UMovieScenePrimitiveMaterialTrack");
static_assert(offsetof(UMovieScenePrimitiveMaterialTrack, MaterialIndex) == 0x000090, "Member 'UMovieScenePrimitiveMaterialTrack::MaterialIndex' has a wrong offset!");
...
{
public:
	struct FMovieSceneSkeletalAnimationParams     Params_0;                                          // 0x00E8(0x00D0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneSkeletalAnimationTrack) == 0x000078, "Wrong size on UMovieSceneSkeletalAnimationTrack");
static_assert(offsetof(UMovieSceneSkeletalAnimationTrack, AnimationSections) == 0x000060, "Member 'UMovieSceneSkeletalAnimationTrack::AnimationSections' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationTrack, bUseLegacySectionIndexBlend) == 0x000070, "Member 'UMovieSceneSkeletalAnimationTrack::bUseLegacySectionIndexBlend' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSlomoTrack) == 0x000090, "Wrong size on UMovieSceneSlomoTrack");
...
static_assert(sizeof(UMovieSceneSpawnSection) == 0x000180, "Wrong size on UMovieSceneSpawnSection");
...
static_assert(sizeof(UMovieSceneStringTrack) == 0x000090, "Wrong size on UMovieSceneStringTrack");
...
static_assert(sizeof(UMovieSceneTransformTrack) == 0x000090, "Wrong size on UMovieSceneTransformTrack");
...
static_assert(sizeof(UMovieSceneVectorSection) == 0x000370, "Wrong size on UMovieSceneVectorSection");
static_assert(offsetof(UMovieSceneVectorSection, Curves) == 0x0000E8, "Member 'UMovieSceneVectorSection::Curves' has a wrong offset!");
static_assert(offsetof(UMovieSceneVectorSection, ChannelsUsed) == 0x000368, "Member 'UMovieSceneVectorSection::ChannelsUsed' has a wrong offset!");
...
{
public:
	int32                                         NumChannelsUsed;                                   // 0x0090(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_94[0x4];                                       // 0x0094(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneVectorTrack) == 0x000098, "Wrong size on UMovieSceneVectorTrack");
static_assert(offsetof(UMovieSceneVectorTrack, NumChannelsUsed) == 0x000090, "Member 'UMovieSceneVectorTrack::NumChannelsUsed' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneVisibilityTrack) == 0x000090, "Wrong size on UMovieSceneVisibilityTrack");
