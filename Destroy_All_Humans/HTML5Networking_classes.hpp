...
static_assert(sizeof(UWebSocketConnection) == 0x001898, "Wrong size on UWebSocketConnection");
...
static_assert(sizeof(UWebSocketNetDriver) == 0x000730, "Wrong size on UWebSocketNetDriver");
static_assert(offsetof(UWebSocketNetDriver, WebSocketPort) == 0x000720, "Member 'UWebSocketNetDriver::WebSocketPort' has a wrong offset!");
