...
public:
	...
	uint8                                         bReverse : 1;                                      // 0x0014(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, StartFrameOffset) == 0x000008, "Member 'FMovieSceneSkeletalAnimationParams::StartFrameOffset' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, EndFrameOffset) == 0x00000C, "Member 'FMovieSceneSkeletalAnimationParams::EndFrameOffset' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, bForceCustomMode) == 0x0000C1, "Member 'FMovieSceneSkeletalAnimationParams::bForceCustomMode' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, StartOffset) == 0x0000C4, "Member 'FMovieSceneSkeletalAnimationParams::StartOffset' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, EndOffset) == 0x0000C8, "Member 'FMovieSceneSkeletalAnimationParams::EndOffset' has a wrong offset!");
...
public:
	...
	UMulticastDelegateProperty_                   OnAudioFinished;                                   // 0x0178(0x0018)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
	UMulticastDelegateProperty_                   OnAudioPlaybackPercent;                            // 0x0190(0x0018)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FMovieSceneAudioSectionTemplateData) == 0x0001A8, "Wrong size on FMovieSceneAudioSectionTemplateData");
...
static_assert(offsetof(FMovieSceneAudioSectionTemplateData, OnAudioPlaybackPercent) == 0x000190, "Member 'FMovieSceneAudioSectionTemplateData::OnAudioPlaybackPercent' has a wrong offset!");
...
{
public:
	struct FMovieSceneAudioSectionTemplateData    AudioData;                                         // 0x0020(0x01A8)(ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMovieSceneAudioSectionTemplate) == 0x000008, "Wrong alignment on FMovieSceneAudioSectionTemplate");
static_assert(sizeof(FMovieSceneAudioSectionTemplate) == 0x0001C8, "Wrong size on FMovieSceneAudioSectionTemplate");
