...
static_assert(sizeof(UMovieSceneNiagaraTrack) == 0x000070, "Wrong size on UMovieSceneNiagaraTrack");
static_assert(offsetof(UMovieSceneNiagaraTrack, Sections) == 0x000060, "Member 'UMovieSceneNiagaraTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneNiagaraSystemTrack) == 0x000070, "Wrong size on UMovieSceneNiagaraSystemTrack");
...
static_assert(sizeof(UMovieSceneNiagaraParameterTrack) == 0x0000A0, "Wrong size on UMovieSceneNiagaraParameterTrack");
static_assert(offsetof(UMovieSceneNiagaraParameterTrack, Parameter) == 0x000070, "Member 'UMovieSceneNiagaraParameterTrack::Parameter' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneNiagaraBoolParameterTrack) == 0x0000A0, "Wrong size on UMovieSceneNiagaraBoolParameterTrack");
...
static_assert(sizeof(UMovieSceneNiagaraColorParameterTrack) == 0x0000A0, "Wrong size on UMovieSceneNiagaraColorParameterTrack");
...
static_assert(sizeof(UMovieSceneNiagaraFloatParameterTrack) == 0x0000A0, "Wrong size on UMovieSceneNiagaraFloatParameterTrack");
...
static_assert(sizeof(UMovieSceneNiagaraIntegerParameterTrack) == 0x0000A0, "Wrong size on UMovieSceneNiagaraIntegerParameterTrack");
...
static_assert(sizeof(UMovieSceneNiagaraSystemSpawnSection) == 0x0000E8, "Wrong size on UMovieSceneNiagaraSystemSpawnSection");
...
{
public:
	int32                                         ChannelsUsed;                                      // 0x00A0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneNiagaraVectorParameterTrack) == 0x0000A8, "Wrong size on UMovieSceneNiagaraVectorParameterTrack");
static_assert(offsetof(UMovieSceneNiagaraVectorParameterTrack, ChannelsUsed) == 0x0000A0, "Member 'UMovieSceneNiagaraVectorParameterTrack::ChannelsUsed' has a wrong offset!");
...
{
public:
	class UNiagaraComponent*                      NiagaraComponent;                                  // 0x03D8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ANiagaraActor) == 0x0003E0, "Wrong size on ANiagaraActor");
static_assert(offsetof(ANiagaraActor, NiagaraComponent) == 0x0003D8, "Member 'ANiagaraActor::NiagaraComponent' has a wrong offset!");

// Class Niagara.NiagaraComponent
// 0x01D8 (0x0840 - 0x0668)
class UNiagaraComponent final : public UPrimitiveComponent
{
public:
	class UNiagaraSystem*                         Asset;                                             // 0x0668(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FNiagaraUserRedirectionParameterStore  OverrideParameters;                                // 0x0670(0x0138)(Edit, NativeAccessSpecifierPrivate)
	uint8                                         bForceSolo : 1;                                    // 0x07A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         BitPad_7A8_1 : 7;                                  // 0x07A8(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         Pad_7A9[0x27];                                     // 0x07A9(0x0027)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bAutoDestroy : 1;                                  // 0x07D0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bRenderingEnabled : 1;                             // 0x07D0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAutoManageAttachment : 1;                         // 0x07D0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_7D1[0x7];                                      // 0x07D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	UMulticastDelegateProperty_                   OnSystemFinished;                                  // 0x07D8(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class USceneComponent>         AutoAttachParent;                                  // 0x07F0(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   AutoAttachSocketName;                              // 0x07F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachLocationRule;                            // 0x0800(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachRotationRule;                            // 0x0801(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachScaleRule;                               // 0x0802(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_803[0x3D];                                     // 0x0803(0x003D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraComponent) == 0x000840, "Wrong size on UNiagaraComponent");
static_assert(offsetof(UNiagaraComponent, Asset) == 0x000668, "Member 'UNiagaraComponent::Asset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OverrideParameters) == 0x000670, "Member 'UNiagaraComponent::OverrideParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OnSystemFinished) == 0x0007D8, "Member 'UNiagaraComponent::OnSystemFinished' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachParent) == 0x0007F0, "Member 'UNiagaraComponent::AutoAttachParent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachSocketName) == 0x0007F8, "Member 'UNiagaraComponent::AutoAttachSocketName' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x000800, "Member 'UNiagaraComponent::AutoAttachLocationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x000801, "Member 'UNiagaraComponent::AutoAttachRotationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x000802, "Member 'UNiagaraComponent::AutoAttachScaleRule' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_418[0x150];                                    // 0x0418(0x0150)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVMExecutableData               CachedScriptVM;                                    // 0x0568(0x0168)(NativeAccessSpecifierPrivate)
	TArray<class UNiagaraParameterCollection*>    CachedParameterCollectionReferences;               // 0x06D0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FNiagaraScriptDataInterfaceInfo> CachedDefaultDataInterfaces;                       // 0x06E0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraScript) == 0x0006F0, "Wrong size on UNiagaraScript");
...
static_assert(offsetof(UNiagaraScript, CachedScriptVM) == 0x000568, "Member 'UNiagaraScript::CachedScriptVM' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, CachedParameterCollectionReferences) == 0x0006D0, "Member 'UNiagaraScript::CachedParameterCollectionReferences' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, CachedDefaultDataInterfaces) == 0x0006E0, "Member 'UNiagaraScript::CachedDefaultDataInterfaces' has a wrong offset!");
