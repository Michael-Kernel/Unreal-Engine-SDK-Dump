...
{
public:
	TArray<class UBP_Component_ChainReaction_C*>  RegisteredComponents_0;                            // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor)
};
...
static_assert(offsetof(BP_ActorComponent_ChainReactionManager_C_GetRegisteredChainReactionComponents, RegisteredComponents_0) == 0x000000, "Member 'BP_ActorComponent_ChainReactionManager_C_GetRegisteredChainReactionComponents::RegisteredComponents_0' has a wrong offset!");
