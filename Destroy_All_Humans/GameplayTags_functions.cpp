...
// Parameters:
// struct FGameplayTagContainer            _tagContainer                                          (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void IGameplayTagAssetInterface::SetOwnedGameplayTags(const struct FGameplayTagContainer& _tagContainer)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GameplayTagAssetInterface", "SetOwnedGameplayTags");

	Params::GameplayTagAssetInterface_SetOwnedGameplayTags Parms{};
