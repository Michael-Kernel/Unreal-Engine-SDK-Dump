...
{
public:
	UMulticastDelegateProperty_                   OnPermissionsGrantedDynamicDelegate;               // 0x0028(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
