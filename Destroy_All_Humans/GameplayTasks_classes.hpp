...
public:
	...
	TArray<class UGameplayTask*>                  SimulatedTasks;                                    // 0x0138(0x0010)(Net, ZeroConstructor, RepNotify, Protected, NativeAccessSpecifierProtected)
	TArray<class UGameplayTask*>                  TaskPriorityQueue;                                 // 0x0148(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_158[0x10];                                     // 0x0158(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UGameplayTask*>                  TickingTasks;                                      // 0x0168(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<class UGameplayTask*>                  KnownTasks;                                        // 0x0178(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	UMulticastDelegateProperty_                   OnClaimedResourcesChange;                          // 0x0188(0x0018)(BlueprintVisible, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGameplayTasksComponent, SimulatedTasks) == 0x000138, "Member 'UGameplayTasksComponent::SimulatedTasks' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, TaskPriorityQueue) == 0x000148, "Member 'UGameplayTasksComponent::TaskPriorityQueue' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, TickingTasks) == 0x000168, "Member 'UGameplayTasksComponent::TickingTasks' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, KnownTasks) == 0x000178, "Member 'UGameplayTasksComponent::KnownTasks' has a wrong offset!");
...
{
public:
	UMulticastDelegateProperty_                   Success;                                           // 0x0068(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastDelegateProperty_                   DidNotSpawn;                                       // 0x0080(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	UMulticastDelegateProperty_                   OnFinished;                                        // 0x0068(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastDelegateProperty_                   OnTimeExpired;                                     // 0x0080(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	UMulticastDelegateProperty_                   OnFinish;                                          // 0x0068(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
