...
public:
	...
	bool                                          bUseAsOccluder;                                    // 0x0043(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FGrassVariety, bUseAsOccluder) == 0x000043, "Member 'FGrassVariety::bUseAsOccluder' has a wrong offset!");
