...
// Function NavigationSystem.NavMeshBoundsVolume.ApplyToWorldSettingsMBPBounds
// (Final, Native, Public)

void ANavMeshBoundsVolume::ApplyToWorldSettingsMBPBounds()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NavMeshBoundsVolume", "ApplyToWorldSettingsMBPBounds");
