...
// Function AIModule.AISense_Damage.ReportDamageEventEx
// 0x0040 (0x0040 - 0x0000)
struct AISense_Damage_ReportDamageEventEx final
{
public:
	class UObject*                                WorldContextObject;                                // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class AActor*                                 DamagedActor;                                      // 0x0008(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FVector                                EventLocation;                                     // 0x001C(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                HitLocation;                                       // 0x0028(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   Tag;                                               // 0x0034(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(AISense_Damage_ReportDamageEventEx) == 0x000008, "Wrong alignment on AISense_Damage_ReportDamageEventEx");
static_assert(sizeof(AISense_Damage_ReportDamageEventEx) == 0x000040, "Wrong size on AISense_Damage_ReportDamageEventEx");
static_assert(offsetof(AISense_Damage_ReportDamageEventEx, WorldContextObject) == 0x000000, "Member 'AISense_Damage_ReportDamageEventEx::WorldContextObject' has a wrong offset!");
static_assert(offsetof(AISense_Damage_ReportDamageEventEx, DamagedActor) == 0x000008, "Member 'AISense_Damage_ReportDamageEventEx::DamagedActor' has a wrong offset!");
static_assert(offsetof(AISense_Damage_ReportDamageEventEx, Instigator) == 0x000010, "Member 'AISense_Damage_ReportDamageEventEx::Instigator' has a wrong offset!");
static_assert(offsetof(AISense_Damage_ReportDamageEventEx, DamageAmount) == 0x000018, "Member 'AISense_Damage_ReportDamageEventEx::DamageAmount' has a wrong offset!");
static_assert(offsetof(AISense_Damage_ReportDamageEventEx, EventLocation) == 0x00001C, "Member 'AISense_Damage_ReportDamageEventEx::EventLocation' has a wrong offset!");
static_assert(offsetof(AISense_Damage_ReportDamageEventEx, HitLocation) == 0x000028, "Member 'AISense_Damage_ReportDamageEventEx::HitLocation' has a wrong offset!");
static_assert(offsetof(AISense_Damage_ReportDamageEventEx, Tag) == 0x000034, "Member 'AISense_Damage_ReportDamageEventEx::Tag' has a wrong offset!");
