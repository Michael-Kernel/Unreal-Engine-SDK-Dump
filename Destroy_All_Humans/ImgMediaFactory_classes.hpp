...
static_assert(sizeof(UImgMediaSettings) == 0x000060, "Wrong size on UImgMediaSettings");
...
static_assert(offsetof(UImgMediaSettings, ExrDecoderThreads) == 0x000040, "Member 'UImgMediaSettings::ExrDecoderThreads' has a wrong offset!");
static_assert(offsetof(UImgMediaSettings, DefaultProxy) == 0x000048, "Member 'UImgMediaSettings::DefaultProxy' has a wrong offset!");
static_assert(offsetof(UImgMediaSettings, UseDefaultProxy) == 0x000058, "Member 'UImgMediaSettings::UseDefaultProxy' has a wrong offset!");
