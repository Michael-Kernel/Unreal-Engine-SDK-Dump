...
// Function GameplayTags.GameplayTagAssetInterface.SetOwnedGameplayTags
// 0x0020 (0x0020 - 0x0000)
struct GameplayTagAssetInterface_SetOwnedGameplayTags final
{
public:
	struct FGameplayTagContainer                  _tagContainer;                                     // 0x0000(0x0020)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(GameplayTagAssetInterface_SetOwnedGameplayTags) == 0x000008, "Wrong alignment on GameplayTagAssetInterface_SetOwnedGameplayTags");
static_assert(sizeof(GameplayTagAssetInterface_SetOwnedGameplayTags) == 0x000020, "Wrong size on GameplayTagAssetInterface_SetOwnedGameplayTags");
static_assert(offsetof(GameplayTagAssetInterface_SetOwnedGameplayTags, _tagContainer) == 0x000000, "Member 'GameplayTagAssetInterface_SetOwnedGameplayTags::_tagContainer' has a wrong offset!");
