...
class ABP_GameMode_C final : public ABFGGameMode
{
public:
...
static_assert(sizeof(ABP_GameMode_C) == 0x000520, "Wrong size on ABP_GameMode_C");
static_assert(offsetof(ABP_GameMode_C, DefaultSceneRoot) == 0x000518, "Member 'ABP_GameMode_C::DefaultSceneRoot' has a wrong offset!");
