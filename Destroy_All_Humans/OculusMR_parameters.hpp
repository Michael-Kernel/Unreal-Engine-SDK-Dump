...
static_assert(sizeof(OculusMRFunctionLibrary_SetTrackingReferenceComponent) == 0x000008, "Wrong size on OculusMRFunctionLibrary_SetTrackingReferenceComponent");
...
// 0x0001 (0x0001 - 0x0000)
struct OculusMR_Settings_GetDepthQuality final
{
public:
	EOculusMR_DepthQuality                        ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(OculusMR_Settings_GetDepthQuality) == 0x000001, "Wrong alignment on OculusMR_Settings_GetDepthQuality");
static_assert(sizeof(OculusMR_Settings_GetDepthQuality) == 0x000001, "Wrong size on OculusMR_Settings_GetDepthQuality");
static_assert(offsetof(OculusMR_Settings_GetDepthQuality, ReturnValue) == 0x000000, "Member 'OculusMR_Settings_GetDepthQuality::ReturnValue' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct OculusMR_Settings_GetUseDynamicLighting final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(OculusMR_Settings_GetUseDynamicLighting) == 0x000001, "Wrong alignment on OculusMR_Settings_GetUseDynamicLighting");
static_assert(sizeof(OculusMR_Settings_GetUseDynamicLighting) == 0x000001, "Wrong size on OculusMR_Settings_GetUseDynamicLighting");
static_assert(offsetof(OculusMR_Settings_GetUseDynamicLighting, ReturnValue) == 0x000000, "Member 'OculusMR_Settings_GetUseDynamicLighting::ReturnValue' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct OculusMR_Settings_SetDepthQuality final
{
public:
	EOculusMR_DepthQuality                        Val;                                               // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(OculusMR_Settings_SetDepthQuality) == 0x000001, "Wrong alignment on OculusMR_Settings_SetDepthQuality");
static_assert(sizeof(OculusMR_Settings_SetDepthQuality) == 0x000001, "Wrong size on OculusMR_Settings_SetDepthQuality");
static_assert(offsetof(OculusMR_Settings_SetDepthQuality, Val) == 0x000000, "Member 'OculusMR_Settings_SetDepthQuality::Val' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct OculusMR_Settings_SetUseDynamicLighting final
{
public:
	bool                                          Val;                                               // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(OculusMR_Settings_SetUseDynamicLighting) == 0x000001, "Wrong alignment on OculusMR_Settings_SetUseDynamicLighting");
static_assert(sizeof(OculusMR_Settings_SetUseDynamicLighting) == 0x000001, "Wrong size on OculusMR_Settings_SetUseDynamicLighting");
static_assert(offsetof(OculusMR_Settings_SetUseDynamicLighting, Val) == 0x000000, "Member 'OculusMR_Settings_SetUseDynamicLighting::Val' has a wrong offset!");
